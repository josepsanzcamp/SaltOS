...
foreach($images as $image) {
	...
	$image=str_replace("bcdef1",$colorb,$image);
	$image=str_replace("cdef12",$colorc,$image);
	$image=str_replace("def123",$colord,$image);
	$image=str_replace("ef1234",$colore,$image);
	$image=str_replace("f12345",$colorf,$image);
	$image=str_replace("123457",$colorg,$image);
	$image=str_replace("234568",$colorh,$image);
	$image=str_replace("345679",$colori,$image);
...
$buffer=str_replace("bcdef1",$colorb,$buffer);
$buffer=str_replace("cdef12",$colorc,$buffer);
$buffer=str_replace("def123",$colord,$buffer);
$buffer=str_replace("ef1234",$colore,$buffer);
$buffer=str_replace("f12345",$colorf,$buffer);
$buffer=str_replace("123457",$colorg,$buffer);
$buffer=str_replace("234568",$colorh,$buffer);
$buffer=str_replace("345679",$colori,$buffer);
...
$buffer=str_replace(__rgb2rgba("bcdef1"),__rgb2rgba($colorb),$buffer);
$buffer=str_replace(__rgb2rgba("cdef12"),__rgb2rgba($colorc),$buffer);
$buffer=str_replace(__rgb2rgba("def123"),__rgb2rgba($colord),$buffer);
$buffer=str_replace(__rgb2rgba("ef1234"),__rgb2rgba($colore),$buffer);
$buffer=str_replace(__rgb2rgba("f12345"),__rgb2rgba($colorf),$buffer);
$buffer=str_replace(__rgb2rgba("123457"),__rgb2rgba($colorg),$buffer);
$buffer=str_replace(__rgb2rgba("234568"),__rgb2rgba($colorh),$buffer);
$buffer=str_replace(__rgb2rgba("345679"),__rgb2rgba($colori),$buffer);
