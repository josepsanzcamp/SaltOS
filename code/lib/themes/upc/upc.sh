...
rm -rf upc/multi/light/jquery-ui
rm -rf upc/multi/dark/jquery-ui

php scripts/jquery-ui.themeroller2.php upc/multi/light \
	...
	336699 ffffff
php scripts/jquery-ui.themeroller2.php upc/multi/dark \
