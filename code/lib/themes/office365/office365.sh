...
rm -rf office365/multi/light/jquery-ui
rm -rf office365/multi/dark/jquery-ui

php scripts/jquery-ui.themeroller4.php office365/multi/light \
...
php scripts/jquery-ui.themeroller4.php office365/multi/dark \
