...
0&&e.disconnect()}}}:function(){this.maxSamplerate=48E3;this.defaultSamplerate=44100;this.env="nop";this.play=function(){};this.pause=function(){}},b=(new r).bind(K),F=h;"node"===j||"undefined"!==typeof module&&module.exports?module.exports=global.timbre=F:"browser"===j&&(F.noConflict=function(){var a=window.timbre,b=window.T;return function(f){window.T===F&&(window.T=b);f&&window.timbre===F&&(window.timbre=a);return F}}(),window.timbre=window.T=F);(function(){if(!(b.impl.env!=="nop"||j!=="browser"||
l)){var a=navigator,f;try{f=a.plugins&&a.mimeTypes&&a.mimeTypes.length?a.plugins["Shockwave Flash"].description.match(/([0-9]+)/)[0]:(new ActiveXObject("ShockwaveFlash.ShockwaveFlash")).GetVariable("$version").match(/([0-9]+)/)[0]}catch(c){f=-1}if(!(f<10)){var d,e=function(){var a=document.getElementsByTagName("script");if(a&&a.length)for(var b,f=0,c=a.length;f<c;++f)if(b=/^(.*\/)timbre(?:\.dev)?\.js$/i.exec(a[f].src))return b[1]+"timbre.swf"}();window.timbrejs_flashfallback_init=function(){b.bind(function(a){var b=
0;this.defaultSamplerate=this.maxSamplerate=44100;this.env="flash";this.play=function(){var f,c=Array(a.streamsize*a.channels),j=a.streammsec,l=0,p=a.streamsize/a.samplerate*1E3,g=Date.now();f=function(){if(!(l>Date.now()-g)){var b=a.strmL,f=a.strmR,j=c.length,e=b.length;for(a.process();e--;){c[--j]=f[e]*32768|0;c[--j]=b[e]*32768|0}d.writeAudio(c.join(" "));l=l+p}};if(d.setup){d.setup(a.channels,a.samplerate);b=setInterval(f,j)}else console.warn("Cannot find "+e)};this.pause=function(){if(b!==0){d.cancel();
clearInterval(b);b=0}}});delete window.timbrejs_flashfallback_init};f=e+"?"+ +new Date;var p=document.createElement("div");p.id="TimbreFlashPlayerDiv";p.style.display="inline";p.width=p.height=1;if(a.plugins&&a.mimeTypes&&a.mimeTypes.length){a=document.createElement("object");a.id="TimbreFlashPlayer";a.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";a.width=a.height=1;a.setAttribute("data",f);a.setAttribute("type","application/x-shockwave-flash");f=document.createElement("param");f.setAttribute("name",
"allowScriptAccess");f.setAttribute("value","always");a.appendChild(f);p.appendChild(a)}else p.innerHTML='<object id="TimbreFlashPlayer" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1" height="1"><param name="movie" value="'+f+'" /><param name="bgcolor" value="#FFFFFF" /><param name="quality" value="high" /><param name="allowScriptAccess" value="always" /></object>';window.addEventListener("load",function(){document.body.appendChild(p);d=document.TimbreFlashPlayer})}}})()})();
...
a.segnoIndex;else break;b=c[d++];switch(b.name){case "@":f.push([g,3,b.val]);break;case "n":i=e.t||120;null!==b.len?(k=b.len,v=b.dot||0):(k=e.l,v=b.dot||e.dot);i=1E3*60/i*(4/k);i*=2-1/Math.pow(2,v);v=e.v<<3;if(e.tie){for(b=f.length;b--;)if(f[b][2]){f.splice(b,1);break}b=a.prevNote}else b=a.prevNote=b.val+12*(e.o+1),f.push([g,1,b,v,i]);if(0<k){k=e.q/8;if(1>k){k=g+i*k;f.push([k,2,b,v]);b=0;for(w=t.length;b<w;++b)f.push([k,2,t[b],v])}t=[];g+=i;if(!e.tie)break a}else t.push(b);e.tie=!1;break;case "r":i=
e.t||120;null!==b.len?(k=b.len,v=b.dot||0):(k=e.l,v=b.dot||e.dot);0<k&&(i=1E3*60/i*(4/k),i*=2-1/Math.pow(2,v),g+=i);break;case "l":e.l=b.val;e.dot=b.dot;break;case "o":e.o=b.val;break;case "<":9>e.o&&(e.o+=1);break;case ">":0<e.o&&(e.o-=1);break;case "v":e.v=b.val;break;case "(":15>e.v&&(e.v+=1);break;case ")":0<e.v&&(e.v-=1);break;case "q":e.q=b.val;break;case "&":e.tie=!0;break;case "$":a.segnoIndex=d;break;case "[":h.push([d,null,null]);break;case "|":if((i=h[h.length-1])&&1===i[1])h.pop(),d=i[2];
break;case "]":if(i=h[h.length-1])null===i[1]&&(i[1]=b.count,i[2]=d),i[1]-=1,0===i[1]?h.pop():d=i[0];break;case "t":e.t=null===b.val?120:b.val;break;case "EOF":f.push([g,0])}}a.index=d;a.queueTime=g},a=function(a){var b,c,d,e,g,h,i,k=Array(a.length),s=[];g=0;for(h=f.length;g<h;++g){b=f[g];for(c=b.re;d=c.exec(a);){if(!k[d.index]){e=0;for(i=d[0].length;e<i;++e)k[d.index+e]=!0;if(e=b.func?b.func(d):{name:d[0]})e.index=d.index,e.origin=d[0],s.push(e)}for(;c.lastIndex<a.length&&k[c.lastIndex];)++c.lastIndex}}s.sort(function(a,
