...
"inline-block":"none"}).on("click",c);e.each(function(c){!b&&t(c)?d3.select(this).append("a").attr("href",t).attr("class",d3.functor(a.classes)).append("span"):d3.select(this).append("span");d3.select(this).select("span").attr("class",d3.functor(a.classes)).text(function(b){return a.format?b[a.key]?a.format(b[a.key]):"-":b[a.key]||"-"})});if(a.showCount){e.append("span").attr("class","nv-childrenCount");C.selectAll("span.nv-childrenCount").text(function(a){return a.values&&a.values.length||a._values&&
a._values.length?"("+(a.values&&a.values.filter(function(a){return i?i(a):true}).length||a._values&&a._values.filter(function(a){return i?i(a):true}).length||0)+")":""})}});C.order().on("click",function(a){q.elementClick({row:this,data:a,pos:[a.x,a.y]})}).on("dblclick",function(a){q.elementDblclick({row:this,data:a,pos:[a.x,a.y]})}).on("mouseover",function(a){q.elementMouseover({row:this,data:a,pos:[a.x,a.y]})}).on("mouseout",function(a){q.elementMouseout({row:this,data:a,pos:[a.x,a.y]})})});return a}
var b={top:0,right:0,bottom:0,left:0},g=960,k=500,j=c.utils.defaultColor(),f=Math.floor(Math.random()*1E4),e=true,i=false,h="No Data Available.",p=20,n=[{key:"key",label:"Name",type:"text"}],l=null,r="images/grey-plus.png",o="images/grey-minus.png",q=d3.dispatch("elementClick","elementDblclick","elementMouseover","elementMouseout"),t=function(a){return a.url},B=0;a.options=c.utils.optionsFunc.bind(a);a.margin=function(c){if(!arguments.length)return b;b.top=typeof c.top!="undefined"?c.top:b.top;b.right=
typeof c.right!="undefined"?c.right:b.right;b.bottom=typeof c.bottom!="undefined"?c.bottom:b.bottom;b.left=typeof c.left!="undefined"?c.left:b.left;return a};a.width=function(b){if(!arguments.length)return g;g=b;return a};a.height=function(b){if(!arguments.length)return k;k=b;return a};a.color=function(b){if(!arguments.length)return j;j=c.utils.getColor(b);scatter.color(j);return a};a.id=function(b){if(!arguments.length)return f;f=b;return a};a.header=function(b){if(!arguments.length)return e;e=b;
return a};a.noData=function(b){if(!arguments.length)return h;h=b;return a};a.filterZero=function(b){if(!arguments.length)return i;i=b;return a};a.columns=function(b){if(!arguments.length)return n;n=b;return a};a.tableClass=function(b){if(!arguments.length)return l;l=b;return a};a.iconOpen=function(b){if(!arguments.length)return r;r=b;return a};a.iconClose=function(b){if(!arguments.length)return o;o=b;return a};a.getUrl=function(b){if(!arguments.length)return t;t=b;return a};return a};c.models.legend=
function(){function a(l){l.each(function(a){var l=g-b.left-b.right,q=d3.select(this).selectAll("g.nv-legend").data([a]);q.enter().append("g").attr("class","nvd3 nv-legend").append("g");var t=q.select("g");q.attr("transform","translate("+b.left+","+b.top+")");var q=t.selectAll(".nv-series").data(function(a){return a}),B=q.enter().append("g").attr("class","nv-series").on("mouseover",function(a,b){n.legendMouseover(a,b)}).on("mouseout",function(a,b){n.legendMouseout(a,b)}).on("click",function(b,c){n.legendClick(b,
c);if(h){if(p){a.forEach(function(a){a.disabled=true});b.disabled=false}else{b.disabled=!b.disabled;a.every(function(a){return a.disabled})&&a.forEach(function(a){a.disabled=false})}n.stateChange({disabled:a.map(function(a){return!!a.disabled})})}}).on("dblclick",function(b,c){n.legendDblclick(b,c);if(h){a.forEach(function(a){a.disabled=true});b.disabled=false;n.stateChange({disabled:a.map(function(a){return!!a.disabled})})}});B.append("circle").style("stroke-width",2).attr("class","nv-legend-symbol").attr("r",
5);B.append("text").attr("text-anchor","start").attr("class","nv-legend-text").attr("dy",".32em").attr("dx","8");q.classed("disabled",function(a){return a.disabled});q.exit().remove();q.select("circle").style("fill",function(a,b){return a.color||f(a,b)}).style("stroke",function(a,b){return a.color||f(a,b)});q.select("text").text(j);if(e){var D=[];q.each(function(){var a=d3.select(this).select("text"),b;try{b=a.getComputedTextLength();if(b<=0)throw Error();}catch(e){b=c.utils.calcApproxTextWidth(a)}D.push(b+
28)});for(var A=0,s=0,B=[];s<l&&A<D.length;){B[A]=D[A];s=s+D[A++]}for(A===0&&(A=1);s>l&&A>1;){B=[];A--;for(s=0;s<D.length;s++)if(D[s]>(B[s%A]||0))B[s%A]=D[s];s=B.reduce(function(a,b){return a+b})}for(var z=[],w=l=0;l<A;l++){z[l]=w;w=w+B[l]}q.attr("transform",function(a,b){return"translate("+z[b%A]+","+(5+Math.floor(b/A)*20)+")"});i?t.attr("transform","translate("+(g-b.right-s)+","+b.top+")"):t.attr("transform","translate(0,"+b.top+")");k=b.top+b.bottom+Math.ceil(D.length/A)*20}else{var x=5,m=5,u=
0,v;q.attr("transform",function(){var a=d3.select(this).select("text").node().getComputedTextLength()+28;v=m;if(g<b.left+b.right+v+a){m=v=5;x=x+20}m=m+a;m>u&&(u=m);return"translate("+v+","+x+")"});t.attr("transform","translate("+(g-b.right-u)+","+b.top+")");k=b.top+b.bottom+x+15}});return a}var b={top:5,right:0,bottom:5,left:0},g=400,k=20,j=function(a){return a.key},f=c.utils.defaultColor(),e=true,i=true,h=true,p=false,n=d3.dispatch("legendClick","legendDblclick","legendMouseover","legendMouseout",
"stateChange");a.dispatch=n;a.options=c.utils.optionsFunc.bind(a);a.margin=function(c){if(!arguments.length)return b;b.top=typeof c.top!="undefined"?c.top:b.top;b.right=typeof c.right!="undefined"?c.right:b.right;b.bottom=typeof c.bottom!="undefined"?c.bottom:b.bottom;b.left=typeof c.left!="undefined"?c.left:b.left;return a};a.width=function(b){if(!arguments.length)return g;g=b;return a};a.height=function(b){if(!arguments.length)return k;k=b;return a};a.key=function(b){if(!arguments.length)return j;
j=b;return a};a.color=function(b){if(!arguments.length)return f;f=c.utils.getColor(b);return a};a.align=function(b){if(!arguments.length)return e;e=b;return a};a.rightAlign=function(b){if(!arguments.length)return i;i=b;return a};a.updateState=function(b){if(!arguments.length)return h;h=b;return a};a.radioButtonMode=function(b){if(!arguments.length)return p;p=b;return a};return a};c.models.line=function(){function a(B){B.each(function(a){var B=k-g.left-g.right,s=j-g.top-g.bottom,z=d3.select(this);
l=b.xScale();r=b.yScale();q=q||l;t=t||r;var a=z.selectAll("g.nv-wrap.nv-line").data([a]),w=a.enter().append("g").attr("class","nvd3 nv-wrap nv-line"),z=w.append("defs"),x=w.append("g"),w=a.select("g");x.append("g").attr("class","nv-groups");x.append("g").attr("class","nv-scatterWrap");a.attr("transform","translate("+g.left+","+g.top+")");b.width(B).height(s);x=a.select(".nv-scatterWrap");x.transition().call(b);z.append("clipPath").attr("id","nv-edge-clip-"+b.id()).append("rect");a.select("#nv-edge-clip-"+
b.id()+" rect").attr("width",B).attr("height",s>0?s:0);w.attr("clip-path",n?"url(#nv-edge-clip-"+b.id()+")":"");x.attr("clip-path",n?"url(#nv-edge-clip-"+b.id()+")":"");B=a.select(".nv-groups").selectAll(".nv-group").data(function(a){return a},function(a){return a.key});B.enter().append("g").style("stroke-opacity",1.0E-6).style("fill-opacity",1.0E-6);B.exit().remove();B.attr("class",function(a,b){return"nv-group nv-series-"+b}).classed("hover",function(a){return a.hover}).style("fill",function(a,
b){return f(a,b)}).style("stroke",function(a,b){return f(a,b)});B.transition().style("stroke-opacity",1).style("fill-opacity",0.5);s=B.selectAll("path.nv-area").data(function(a){return p(a)?[a]:[]});s.enter().append("path").attr("class","nv-area").attr("d",function(a){return d3.svg.area().interpolate(o).defined(h).x(function(a,b){return c.utils.NaNtoZero(q(e(a,b)))}).y0(function(a,b){return c.utils.NaNtoZero(t(i(a,b)))}).y1(function(){return t(r.domain()[0]<=0?r.domain()[1]>=0?0:r.domain()[1]:r.domain()[0])}).apply(this,
[a.values])});B.exit().selectAll("path.nv-area").remove();s.transition().attr("d",function(a){return d3.svg.area().interpolate(o).defined(h).x(function(a,b){return c.utils.NaNtoZero(l(e(a,b)))}).y0(function(a,b){return c.utils.NaNtoZero(r(i(a,b)))}).y1(function(){return r(r.domain()[0]<=0?r.domain()[1]>=0?0:r.domain()[1]:r.domain()[0])}).apply(this,[a.values])});B=B.selectAll("path.nv-line").data(function(a){return[a.values]});B.enter().append("path").attr("class","nv-line").attr("d",d3.svg.line().interpolate(o).defined(h).x(function(a,
b){return c.utils.NaNtoZero(q(e(a,b)))}).y(function(a,b){return c.utils.NaNtoZero(t(i(a,b)))}));B.transition().attr("d",d3.svg.line().interpolate(o).defined(h).x(function(a,b){return c.utils.NaNtoZero(l(e(a,b)))}).y(function(a,b){return c.utils.NaNtoZero(r(i(a,b)))}));q=l.copy();t=r.copy()});return a}var b=c.models.scatter(),g={top:0,right:0,bottom:0,left:0},k=960,j=500,f=c.utils.defaultColor(),e=function(a){return a.x},i=function(a){return a.y},h=function(a,b){return!isNaN(i(a,b))&&i(a,b)!==null},
p=function(a){return a.area},n=false,l,r,o="linear";b.size(16).sizeDomain([16,256]);var q,t;a.dispatch=b.dispatch;a.scatter=b;d3.rebind(a,b,"id","interactive","size","xScale","yScale","zScale","xDomain","yDomain","xRange","yRange","sizeDomain","forceX","forceY","forceSize","clipVoronoi","useVoronoi","clipRadius","padData","highlightPoint","clearHighlights");a.options=c.utils.optionsFunc.bind(a);a.margin=function(b){if(!arguments.length)return g;g.top=typeof b.top!="undefined"?b.top:g.top;g.right=
typeof b.right!="undefined"?b.right:g.right;g.bottom=typeof b.bottom!="undefined"?b.bottom:g.bottom;g.left=typeof b.left!="undefined"?b.left:g.left;return a};a.width=function(b){if(!arguments.length)return k;k=b;return a};a.height=function(b){if(!arguments.length)return j;j=b;return a};a.x=function(c){if(!arguments.length)return e;e=c;b.x(c);return a};a.y=function(c){if(!arguments.length)return i;i=c;b.y(c);return a};a.clipEdge=function(b){if(!arguments.length)return n;n=b;return a};a.color=function(e){if(!arguments.length)return f;
f=c.utils.getColor(e);b.color(f);return a};a.interpolate=function(b){if(!arguments.length)return o;o=b;return a};a.defined=function(b){if(!arguments.length)return h;h=b;return a};a.isArea=function(b){if(!arguments.length)return p;p=d3.functor(b);return a};return a};c.models.lineChart=function(){function a(u){u.each(function(v){var u=d3.select(this),G=this,C=(h||parseInt(u.style("width"))||960)-e.left-e.right,F=(p||parseInt(u.style("height"))||400)-e.top-e.bottom;a.update=function(){u.transition().duration(m).call(a)};
