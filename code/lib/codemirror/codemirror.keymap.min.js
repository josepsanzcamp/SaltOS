(function(){function M(c){v.push(c);50<v.length&&v.shift()}function y(c){return v[v.length-(c?Math.min(c,1):1)]||""}function l(){1<v.length&&v.pop();return y()}function K(c,f,g,i,j){null==j&&(j=c.getRange(f,g));i&&G&&G.cm==c&&f.line==G.pos.line&&f.ch==G.pos.ch&&c.isClean(G.gen)?v.length?v[v.length-1]+=j:M(j):M(j);c.replaceRange("",f,g,"+delete");G=i?{cm:c,pos:f,gen:c.changeGeneration()}:null}function u(c,f,g){return c.findPosH(f,g,"char",!0)}function B(c,f,g){return c.findPosH(f,g,"word",!0)}function s(c,
f,g){return c.findPosV(f,g,"line",c.doc.sel.goalColumn)}function q(c,f,g){return c.findPosV(f,g,"page",c.doc.sel.goalColumn)}function I(c,f,g){for(var i=f.line,j=c.getLine(i),f=/\S/.test(0>g?j.slice(0,f.ch):j.slice(f.ch)),k=c.firstLine(),l=c.lastLine();;){i+=g;if(i<k||i>l)return c.clipPos(z(i-g,0>g?0:null));j=c.getLine(i);if(/\S/.test(j))f=!0;else if(f)return z(i,0)}}function w(c,f,g){for(var i=f.line,j=f.ch,f=c.getLine(f.line),k=!1;;){var l=f.charAt(j+(0>g?-1:0));if(l){if(k&&/[!?.]/.test(l))return z(i,
j+(0<g?1:0));k||(k=/\w/.test(l));j+=g}else{if(i==(0>g?c.firstLine():c.lastLine()))return z(i,j);f=c.getLine(i+g);if(!/\S/.test(f))return z(i,j);i+=g;j=0>g?f.length:0}}}function A(c,f,g){var i;if(c.findMatchingBracket&&(i=c.findMatchingBracket(f,!0))&&i.match&&(i.forward?1:-1)==g)return 0<g?z(i.to.line,i.to.ch+1):i.to;for(var j=!0;;j=!1){var k=c.getTokenAt(f);i=z(f.line,0>g?k.start:k.end);if(j&&0<g&&k.end==f.ch||!/\w/.test(k.string)){j=c.findPosH(i,g,"char");if(i.line==j.line&&i.ch==j.ch)return f;
f=j}else return i}}function N(c,f){var g=c.state.emacsPrefix;if(!g)return f?null:1;r(c);return"-"==g?-1:Number(g)}function t(c){var f="string"==typeof c?function(f){f.execCommand(c)}:c;return function(c){var i=N(c);f(c);for(var j=1;j<i;++j)f(c)}}function P(c,f,g){var i=c.getCursor(),j=N(c);0>j&&(g=-g,j=-j);for(var k=0;k<j;++k){var l=f(c,i,g);if(l.line==i.line&&l.ch==i.ch)break;i=l}return i}function k(c,f){var g=function(i){i.extendSelection(P(i,c,f))};g.motion=!0;return g}function J(c,f,g){K(c,c.getCursor(),
P(c,f,g),!0)}function Y(c,f){c.state.emacsPrefix?"-"!=f&&(c.state.emacsPrefix+=f):(c.state.emacsPrefix=f,c.on("keyHandled",E),c.on("inputRead",Z))}function E(c,f){!c.state.emacsPrefixMap&&!Q.hasOwnProperty(f)&&r(c)}function r(c){c.state.emacsPrefix=null;c.off("keyHandled",E);c.off("inputRead",Z)}function Z(c,f){var g=N(c);if(1<g&&"+input"==f.origin){for(var i=f.text.join("\n"),j="",k=1;k<g;++k)j+=i;c.replaceSelection(j,"end","+input")}}function x(c,f){"string"==typeof f&&(/^\d$/.test(f)||"Ctrl-U"==
...
c.setSelection(f,c.getCursor())},"Alt-Y":function(c){c.replaceSelection(l())},"Ctrl-Space":T,"Ctrl-Shift-2":T,"Ctrl-F":k(u,1),"Ctrl-B":k(u,-1),Right:k(u,1),Left:k(u,-1),"Ctrl-D":function(c){J(c,u,1)},Delete:function(c){J(c,u,1)},"Ctrl-H":function(c){J(c,u,-1)},Backspace:function(c){J(c,u,-1)},"Alt-F":k(B,1),"Alt-B":k(B,-1),"Alt-D":function(c){J(c,B,1)},"Alt-Backspace":function(c){J(c,B,-1)},"Ctrl-N":k(s,1),"Ctrl-P":k(s,-1),Down:k(s,1),Up:k(s,-1),"Ctrl-A":"goLineStart","Ctrl-E":"goLineEnd",End:"goLineEnd",
...
c.getCursor(),w(c,c.getCursor(),1),!0)},auto:"emacs",nofallthrough:!0,disableInput:!0};CodeMirror.keyMap["emacs-Alt-G"]={G:function(c){var f=N(c,!0);if(null!=f&&0<f)return c.setCursor(f-1);L(c,"Goto line",function(f){var i;f&&(!isNaN(i=Number(f))&&i==i|0&&0<i)&&c.setCursor(i-1)})},auto:"emacs",nofallthrough:!0,disableInput:!0};CodeMirror.keyMap["emacs-Ctrl-Q"]={Tab:t("insertTab"),auto:"emacs",nofallthrough:!0};for(var R={"Ctrl-G":r},U=0;10>U;++U)S(""+U);S("-")})();
(function(){function M(l,K){var u=l.getCursor("head"),B=l.getCursor("anchor");l.operation(function(){var s;var q=Math.min(u.line,B.line),I=Math.max(u.line,B.line);if(!K||q>I)s=0;else{s=l.clipPos(y(q,0));var w=l.clipPos(y(I)),I=l.getRange(s,w);q<=l.firstLine()?l.replaceRange("",s,y(w.line+1,0)):l.replaceRange("",y(s.line-1),w);q=s.line+K;q<=l.firstLine()?(l.replaceRange(I+"\n",y(q,0)),s=l.firstLine()-s.line):(q=l.clipPos(y(q-1)),l.replaceRange("\n"+I,q),s=q.line+1-s.line)}l.setSelection(y(B.line+s,
B.ch),y(u.line+s,u.ch))})}var y=CodeMirror.Pos;CodeMirror.commands.moveLinesUp=function(l){M(l,-1)};CodeMirror.commands.moveLinesDown=function(l){M(l,1)};CodeMirror.keyMap["default"]["Alt-Up"]="moveLinesUp";CodeMirror.keyMap["default"]["Alt-Down"]="moveLinesDown"})();
...
type:"search",searchArgs:{forward:!0,querySrc:"wordUnderCursor",toJumplist:!0}},{keys:["#"],type:"search",searchArgs:{forward:!1,querySrc:"wordUnderCursor",toJumplist:!0}},{keys:[":"],type:"ex"}],y=function(){function l(a,b){var d=a.state.vim;!d.insertMode&&!d.exMode&&(d=b.head,d.ch&&d.ch==a.doc.getLine(d.line).length&&d.ch--)}function K(a){var b=a.state.vim;b.onPasteFn||(b.onPasteFn=function(){b.insertMode||(a.setCursor(k(a.getCursor(),0,1)),ca.enterInsertMode(a,{},b))});return b.onPasteFn}function u(a,
b){for(var d=[],e=a;e<a+b;e++)d.push(String.fromCharCode(e));return d}function B(a){return/^[A-Z]$/.test(a)}function s(a,b){for(var d=0;d<b.length;d++)if(b[d]==a)return!0;return!1}function q(a){a.state.vim||(a.state.vim={inputState:new w,lastEditInputState:void 0,lastEditActionCommand:void 0,lastHPos:-1,lastHSPos:-1,lastMotion:null,marks:{},insertMode:!1,insertModeRepeat:void 0,visualMode:!1,visualLine:!1});return a.state.vim}function I(){p={searchQuery:null,searchIsReversed:!1,jumpList:za(),macroModeState:Aa(),
...
ch:b}}function P(a){var b={},d;for(d in a)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}function k(a,b,d){return{line:a.line+b,ch:a.ch+d}}function J(a,b){for(var d=0;d<a.length;d++)if(a[d]!=b[d]&&"character"!=b[d])return!1;return!0}function Y(a,b,d){return function(){for(var e=0;e<d;e++)b(a)}}function E(a,b){return a.ch==b.ch&&a.line==b.line}function r(a,b){return a.line<b.line||a.line==b.line&&a.ch<b.ch?!0:!1}function Z(a,b,d){a=r(a,b);b=r(b,d);return a&&b}function x(a,b){return a.getLine(b).length}
...
function v(a,b,d,e){for(var n=a.getCursor(),c=n.ch,h,C=0;C<b;C++){h=a.getLine(n.line);var f=e,i=void 0;h=i=d?h.indexOf(f,c+1):h.lastIndexOf(f,c-1);if(-1==h)return null;c=h}return{line:a.getCursor().line,ch:h}}function G(a,b,d,e){s(d,Da)&&(b.marks[d]&&b.marks[d].clear(),b.marks[d]=a.setBookmark(e))}function Q(a){return"string"===a||"comment"===a?1:0}function $(a,b,d){var e=b.line,n=b.ch,d=d?d:a.getLine(e).charAt(n),c=a.getTokenAt({line:e,ch:n+1}).type,c=Q(c),h={"(":")",")":"(","[":"]","]":"[","{":"}",
"}":"{"}[d];if(!h)return b;for(var f={"(":1,"{":1,"[":1}[d]||-1,o=1===f?a.lineCount():-1,i=1,g=d,j=n,n=a.getLine(e);e!==o&&0<i;){j+=f;g=n.charAt(j);g||(e+=f,n=a.getLine(e)||"",0<f?j=0:(g=n.length,j=0<g?g-1:0),g=n.charAt(j));var m=a.getTokenAt({line:e,ch:j+1}).type,m=Q(m);c>=m&&(g===d?i++:g===h&&i--)}return g?{line:e,ch:j}:b}function R(a,b,d){var e=a.getCursor(),b=$(a,e,b),a=$(a,b);a.ch+=d?1:0;b.ch+=d?0:1;return{start:a,end:b}}function U(a,b,d){var e=a.getCursor(),a=a.getLine(e.line).split(""),n,c,
h,f;h=a.indexOf(b);e.ch<h?e.ch=h:h<e.ch&&a[e.ch]==b&&(c=e.ch,--e.ch);if(a[e.ch]==b&&!c)n=e.ch+1;else for(h=e.ch;-1<h&&!n;h--)a[h]==b&&(n=h+1);if(n&&!c){h=n;for(f=a.length;h<f&&!c;h++)a[h]==b&&(c=h)}if(!n||!c)return{start:e,end:e};d&&(--n,++c);return{start:{line:e.line,ch:n},end:{line:e.line,ch:c}}}function c(){}function f(a){a=a.state.vim;return a.searchState_||(a.searchState_=new c)}function g(a){for(var b=!1,d=[],e=0;e<a.length;e++){var n=a.charAt(e);!b&&"/"==n&&d.push(e);b="\\"==n}return d}function i(a,
b){a.openNotification?a.openNotification('<span style="color: red">'+b+"</span>",{bottom:!0,duration:5E3}):alert(b)}function j(a,b){var d=(b.prefix||"")+" "+(b.desc||""),e=b.prefix,n=b.desc,c="";e&&(c+='<span style="font-family: monospace">'+e+"</span>");c+='<input type="text"/> <span style="color: #888">';n&&(c=c+'<span style="color: #888">'+n+"</span>");e=b.onClose;a.openDialog?a.openDialog(c,e,{bottom:!0,value:b.value,onKeyDown:b.onKeyDown,onKeyUp:b.onKeyUp}):e(prompt(d,""))}function ba(a,b,d,
e){if(b){var n=f(a);d=!!d;e=!!e;if(!(b instanceof RegExp)){var c=g(b),h,C;c.length?(h=b.substring(0,c[0]),C=-1!=b.substring(c[0]).indexOf("i")):h=b;h?(e&&(d=/^[^A-Z]*$/.test(h)),b=RegExp(h,d||C?"i":void 0)):b=null}if(b){na(a,b);a:if(a=n.getQuery(),b instanceof RegExp&&a instanceof RegExp){C=["global","multiline","ignoreCase","source"];for(d=0;d<C.length;d++)if(e=C[d],b[e]!==a[e]){a=!1;break a}a=!0}else a=!1;if(a)return b;n.setQuery(b);return b}}}function ya(a){if("^"==a.source.charAt(0))var b=!0;
return{token:function(d){if(b&&!d.sol())d.skipToEnd();else{var e=d.match(a,!1);if(e){if(0==e[0].length)return d.next(),"searching";if(!d.sol()&&(d.backUp(1),!a.exec(d.next()+e[0])))return d.next(),null;d.match(a);return"searching"}for(;!d.eol()&&!(d.next(),d.match(a,!1)););}},query:a}}function na(a,b){var d=f(a).getOverlay();if(!d||b!=d.query)d&&a.removeOverlay(d),d=ya(b),a.addOverlay(d),f(a).setOverlay(d)}function oa(a,b,d,e){void 0===e&&(e=1);return a.operation(function(){for(var n=a.getCursor(),
c=a.getSearchCursor(d,n),h=0;h<e;h++){var f=c.find(b);0==h&&(f&&E(c.from(),n))&&(f=c.find(b));if(!f&&(c=a.getSearchCursor(d,b?{line:a.lastLine()}:{line:a.firstLine(),ch:0}),!c.find(b)))return}return c.from()})}function ja(a){a.removeOverlay(f(a).getOverlay());f(a).setOverlay(null)}function ka(a){var b=a.getScrollInfo(),d=a.coordsChar({left:0,top:6+b.top},"local"),a=a.coordsChar({left:0,top:b.clientHeight-10+b.top},"local");return{top:d.line,bottom:a.line}}function da(a){for(var b,d,e=[];a;){d=/<\w+-.+?>|<\w+>|./.exec(a);
if(null===d)break;b=d[0];a=a.substring(d.index+b.length);e.push(b)}return e}function Ea(a,b,d,e,n,c,h){function f(){a.operation(function(){for(;!m;)o(),g();ia()})}function o(){var b=a.getRange(n.from(),n.to()).replace(c,h);n.replace(b)}function g(){if(n.findNext()){var b;b=n.from();var c=d,h=e;"number"!=typeof b&&(b=b.line);b=c instanceof Array?s(b,c):h?b>=c&&b<=h:b==c;b?(a.scrollIntoView(n.from(),30),a.setSelection(n.from(),n.to()),ea=n.from(),m=!1):m=!0}else m=!0}function ia(b){b&&b();a.focus();
ea&&(a.setCursor(ea),b=a.state.vim,b.exMode=!1,b.lastHPos=b.lastHSPos=ea.ch)}function k(b,d,e){CodeMirror.e_stop(b);switch(CodeMirror.keyName(b)){case "Y":o();g();break;case "N":g();break;case "A":a.operation(f);break;case "L":o();case "Q":case "Esc":case "Ctrl-C":case "Ctrl-[":ia(e)}m&&ia(e)}a.state.vim.exMode=!0;var m=!1,ea=n.from();g();m?i(a,"No matches for "+c.source):b?j(a,{prefix:"replace with <strong>"+h+"</strong> (y/n/a/q/l)",onKeyDown:k}):f()}function fa(a){var b=a.state.vim,d=p.macroModeState.inReplay;
d||(a.off("change",pa),a.off("cursorActivity",qa),CodeMirror.off(a.getInputField(),"keydown",ra));!d&&1<b.insertModeRepeat&&(sa(a,b,b.insertModeRepeat-1,!0),b.lastEditInputState.repeatOverride=b.insertModeRepeat);delete b.insertModeRepeat;a.setCursor(a.getCursor().line,a.getCursor().ch-1,!0);b.insertMode=!1;a.setOption("keyMap","vim");a.setOption("disableInput",!0);a.toggleOverwrite(!1);CodeMirror.signal(a,"vim-mode-change",{mode:"normal"})}function pa(a,b){for(var d=p.macroModeState.lastInsertModeChanges;b;){d.expectCursorActivityForChange=
!0;if("+input"==b.origin||"paste"==b.origin||void 0===b.origin){var e=b.text.join("\n");d.changes.push(e)}b=b.next}}function qa(){var a=p.macroModeState.lastInsertModeChanges;a.expectCursorActivityForChange?a.expectCursorActivityForChange=!1:a.changes=[]}function la(a){this.keyName=a}function ra(a){function b(){d.changes.push(new la(e));return!0}var d=p.macroModeState.lastInsertModeChanges,e=CodeMirror.keyName(a);(-1!=e.indexOf("Delete")||-1!=e.indexOf("Backspace"))&&CodeMirror.lookupKey(e,["vim-insert"],
b)}function sa(a,b,d,e){function n(){f?V.processAction(a,b,b.lastEditActionCommand):V.evalInput(a,b)}function c(d){0<h.lastInsertModeChanges.changes.length&&(d=!b.lastEditActionCommand?1:d,Fa(a,d,h))}var h=p.macroModeState;h.inReplay=!0;var f=!!b.lastEditActionCommand,o=b.inputState;b.inputState=b.lastEditInputState;if(f&&b.lastEditActionCommand.interlaceInsertRepeat)for(var i=0;i<d;i++)n(),c(1);else e||n(),c(d);b.inputState=o;b.insertMode&&!e&&fa(a);h.inReplay=!1}function Fa(a,b,d){function e(b){if("string"==
typeof b)CodeMirror.commands[b](a);else b(a);return!0}for(var d=d.lastInsertModeChanges,n=0;n<b;n++)for(var c=0;c<d.changes.length;c++){var h=d.changes[c];if(h instanceof la)CodeMirror.lookupKey(h.keyName,["vim-insert"],e);else{var f=a.getCursor();a.replaceRange(h,f,f)}}}CodeMirror.defineOption("vimMode",!1,function(a,b){if(b){a.setOption("keyMap","vim");a.setOption("disableInput",true);CodeMirror.signal(a,"vim-mode-change",{mode:"normal"});a.on("beforeSelectionChange",l);q(a);CodeMirror.on(a.getInputField(),
"paste",K(a))}else if(a.state.vim){a.setOption("keyMap","default");a.setOption("disableInput",false);a.off("beforeSelectionChange",l);CodeMirror.off(a.getInputField(),"paste",K(a));a.state.vim=null}});var Ga=/[\d]/,Ha=[/\w/,/[^\w\s]/],Ia=[/\S/],aa=u(65,26),ga=u(97,26),ha=u(48,10),ma="~`!@#$%^&*()_-+=[{}]\\|/?.,<>:;\"'".split(""),ta="Left Right Up Down Space Backspace Esc Home End PageUp PageDown Enter".split(" "),Da=[].concat(aa,ga,ha,["<",">"]),Ja=[].concat(aa,ga,ha,["-",'"']),za=function(){var a=
...
expectCursorActivityForChange:!1},enteredMacroMode:void 0,isMacroPlaying:!1,toggle:function(a,b){this.enteredMacroMode?(this.enteredMacroMode(),this.enteredMacroMode=void 0):(this.latestRegister=b,this.enteredMacroMode=a.openDialog("(recording)["+b+"]",null,{bottom:!0}))}}},p,ga={buildKeyMap:function(){},getRegisterController:function(){return p.registerController},resetVimGlobalState_:I,getVimGlobalState_:function(){return p},maybeInitVimState_:q,InsertModeKey:la,map:function(a,b,d){W.map(a,b,d)},
defineEx:function(a,b,d){if(0!==a.indexOf(b))throw Error('(Vim.defineEx) "'+b+'" is not a prefix of "'+a+'", command not registered');ua[a]=d;W.commandMap_[b]={name:a,shortName:b,type:"api"}},handleKey:function(a,b){var d,e=q(a),c=p.macroModeState;if(c.enteredMacroMode&&"q"==b)ca.exitMacroRecordMode(),e.inputState=new w;else if("<Esc>"==b)e.inputState=new w,e.visualMode&&L(a);else{!e.visualMode&&!E(a.getCursor("head"),a.getCursor("anchor"))&&(e.visualMode=!0,e.visualLine=!1,CodeMirror.signal(a,"vim-mode-change",
...
b,d)},processAction:function(a,b,d){var e=b.inputState,c=e.getRepeat(),f=!!c,h=P(d.actionArgs)||{};e.selectedCharacter&&(h.selectedCharacter=e.selectedCharacter);d.operator&&this.processOperator(a,b,d);d.motion&&this.processMotion(a,b,d);(d.motion||d.operator)&&this.evalInput(a,b);h.repeat=c||1;h.repeatIsExplicit=f;h.registerName=e.registerName;b.inputState=new w;b.lastMotion=null;d.isEdit&&this.recordLastEdit(b,e,d);ca[d.action](a,h,b)},processSearch:function(a,b,d){function e(e,c,n){try{ba(a,e,
c,n)}catch(h){i(a,"Invalid regex: "+e);return}V.processMotion(a,b,{type:"motion",motion:"findNext",motionArgs:{forward:!0,toJumplist:d.searchArgs.toJumplist}})}function c(b){a.scrollTo(k.left,k.top);e(b,!0,!0)}function Ba(b,d){var e;try{e=ba(a,d,!0,!0)}catch(c){}e?a.scrollIntoView(oa(a,!g,e),30):(ja(a),a.scrollTo(k.left,k.top))}function h(b,d,e){d=CodeMirror.keyName(b);if("Esc"==d||"Ctrl-C"==d||"Ctrl-["==d)ba(a,Ca),ja(a),a.scrollTo(k.left,k.top),CodeMirror.e_stop(b),e(),a.focus()}if(a.getSearchCursor){var g=
d.searchArgs.forward;f(a).setReversed(!g);var o=g?"/":"?",Ca=f(a).getQuery(),k=a.getScrollInfo();switch(d.searchArgs.querySrc){case "prompt":j(a,{onClose:c,prefix:o,desc:Ka,onKeyUp:Ba,onKeyDown:h});break;case "wordUnderCursor":var o=S(a,!1,!0,!1,!0),l=!0;o||(o=S(a,!1,!0,!1,!1),l=!1);if(!o)break;var m=a.getLine(o.start.line).substring(o.start.ch,o.end.ch),m=l?"\\b"+m+"\\b":m.replace(/([.?*+$\[\]\/\\(){}|\-])/g,"\\$1");p.jumpList.cachedCursor=a.getCursor();a.setCursor(o.start);e(m,!0,!1)}}},processEx:function(a,
...
ch:o.ch},k={line:j.line,ch:j.ch},m,l;f&&this.recordLastEdit(b,d);l=void 0!==d.repeatOverride?d.repeatOverride:d.getRepeat();if(0<l&&c.explicitRepeat)c.repeatIsExplicit=!0;else if(c.noRepeat||!c.explicitRepeat&&0===l)l=1,c.repeatIsExplicit=!1;d.selectedCharacter&&(c.selectedCharacter=h.selectedCharacter=d.selectedCharacter);c.repeat=l;b.inputState=new w;if(e){m=X[e](a,c,b);b.lastMotion=X[e];if(!m)return;c.toJumplist&&(e=p.jumpList,(d=e.cachedCursor)?(E(d,m)||p.jumpList.add(a,d,m),delete e.cachedCursor):
E(k,m)||p.jumpList.add(a,k,m));m instanceof Array&&(j=m[0],m=m[1]);m||(m={ch:j.ch,line:j.line});if(b.visualMode){if(r(g,o)&&(E(g,m)||r(m,g)))g.ch+=1;else if(r(o,g)&&(E(g,m)||r(g,m)))g.ch-=1;o=m;b.visualLine&&(r(g,o)?(g.ch=0,e=a.lastLine(),o.line>e&&(o.line=e),o.ch=x(a,o.line)):(o.ch=0,g.ch=x(a,g.line)));a.setSelection(g,o);G(a,b,"<",r(g,o)?g:o);G(a,b,">",r(g,o)?o:g)}else f||(m=t(a,m),a.setCursor(m.line,m.ch))}if(f){e=!1;b.lastMotion=null;h.repeat=l;b.visualMode&&(j=g,m=o,c.inclusive=!0);r(m,j)&&(o=
j,j=m,m=o,e=!0);c.inclusive&&(!b.visualMode||!e)&&m.ch++;if(o=c.linewise||b.visualMode&&b.visualLine)c=m,j.ch=0,c.ch=0,c.line++;else if(c.forward&&(c=m,g=a.getRange(j,c),/\n\s*$/.test(g))){g=g.split("\n");g.pop();for(l=g.pop();0<g.length&&l&&/^\s*$/.test(l);l=g.pop())c.line--,c.ch=0;l?(c.line--,c.ch=x(a,c.line)):c.ch=0}h.registerName=i;h.linewise=o;La[f](a,h,b,j,m,k);b.visualMode&&L(a)}},recordLastEdit:function(a,b,d){var e=p.macroModeState;e.inReplay||(a.lastEditInputState=b,a.lastEditActionCommand=
d,e.lastInsertModeChanges.changes=[],e.lastInsertModeChanges.expectCursorActivityForChange=!1)}},X={moveToTopLine:function(a,b){var d=ka(a).top+b.repeat-1;return{line:d,ch:F(a.getLine(d))}},moveToMiddleLine:function(a){var b=ka(a),b=Math.floor(0.5*(b.top+b.bottom));return{line:b,ch:F(a.getLine(b))}},moveToBottomLine:function(a,b){var d=ka(a).bottom-b.repeat+1;return{line:d,ch:F(a.getLine(d))}},expandToLine:function(a,b){return{line:a.getCursor().line+b.repeat-1,ch:Infinity}},findNext:function(a,b){var d=
f(a),e=d.getQuery();if(e){var c=!b.forward,c=d.isReversed()?!c:c;na(a,e);return oa(a,c,e,b.repeat)}},goToMark:function(a,b,d){return(a=d.marks[b.selectedCharacter])?a.find():null},jumpToMark:function(a,b,d){for(var e=a.getCursor(),c=0;c<b.repeat;c++){var f=e,h;for(h in d.marks)if(/^[a-z]$/.test(h)){var g=d.marks[h].find();if(!(b.forward?r(g,f):r(f,g))&&!(b.linewise&&g.line==f.line)){var i=E(f,e),j=b.forward?Z(f,g,e):Z(e,g,f);if(i||j)e=g}}}b.linewise&&(e.ch=F(a.getLine(e.line)));return e},moveByCharacters:function(a,
...
ch:h+c.length-1})},repeatLastEdit:function(a,b,d){if(d.lastEditInputState){var c=b.repeat;c&&b.repeatIsExplicit?d.lastEditInputState.repeatOverride=c:c=d.lastEditInputState.repeatOverride||c;sa(a,d,c,!1)}}},wa={w:function(a,b){return S(a,b,!0,!1)},W:function(a,b){return S(a,b,!0,!0)},"{":function(a,b){return R(a,"}",b)},"(":function(a,b){return R(a,")",b)},"[":function(a,b){return R(a,"]",b)},"'":function(a,b){return U(a,"'",b)},'"':function(a,b){return U(a,'"',b)}},Ma={"(":"bracket",")":"bracket",
...
{};for(var a=0;a<xa.length;a++){var b=xa[a];this.commandMap_[b.shortName||b.name]=b}},map:function(a,b,d){if(":"!=a&&":"==a.charAt(0)){if(d)throw Error("Mode not supported for ex mappings");d=a.substring(1);this.commandMap_[d]=":"!=b&&":"==b.charAt(0)?{name:d,type:"exToEx",toInput:b.substring(1)}:{name:d,type:"exToKey",toKeys:da(b)}}else b=":"!=b&&":"==b.charAt(0)?{keys:da(a),type:"keyToEx",exArgs:{input:b.substring(1)}}:{keys:da(a),type:"keyToKey",toKeys:da(b)},d&&(b.context=d),M.unshift(b)}};var ua=
...
a.match(/\/.*\//)&&"patterns not supported"}}}();if(j)i(a,j+": "+b.argString);else{var j=b.line||a.firstLine(),k=b.lineEnd||b.line||a.lastLine();if(j!=k){var j={line:j,ch:0},k={line:k,ch:x(a,k)},l=a.getRange(j,k).split("\n"),p="decimal"==h?/(-?)([\d]+)/:"hex"==h?/(-?)(?:0x)?([0-9a-f]+)/i:"octal"==h?/([0-7]+)/:null,s="decimal"==h?10:"hex"==h?16:"octal"==h?8:null,m=[],r=[];if(h)for(var q=0;q<l.length;q++)p.exec(l[q])?m.push(l[q]):r.push(l[q]);else r=l;m.sort(c);r.sort(c);l=!e?r.concat(m):m.concat(r);
if(g)for(var m=l,t,l=[],q=0;q<m.length;q++)m[q]!=t&&l.push(m[q]),t=m[q];a.replaceRange(l.join("\n"),j,k)}}},substitute:function(a,b){if(!a.getSearchCursor)throw Error("Search feature not available. Requires searchcursor.js or any other getSearchCursor implementation.");var c=b.argString,e=g(c);if(0!==e[0])i(a,"Substitutions should be of the form :s/pattern/replace/");else{var j=c.substring(e[0]+1,e[1]),k="",h,l,o=!1;e[1]&&(k=c.substring(e[1]+1,e[2]));e[2]&&(l=c.substring(e[2]+1).split(" "),h=l[0],
l=parseInt(l[1]));h&&(-1!=h.indexOf("c")&&(o=!0,h.replace("c","")),j=j+"/"+h);if(j)try{ba(a,j,!0,!0)}catch(p){i(a,"Invalid regex: "+j);return}j=f(a).getQuery();h=void 0!==b.line?b.line:a.getCursor().line;c=b.lineEnd||h;l&&(h=c,c=h+l-1);l=t(a,{line:h,ch:0});l=a.getSearchCursor(j,l);Ea(a,o,h,c,l,j,k)}},redo:CodeMirror.commands.redo,undo:CodeMirror.commands.undo,write:function(a){CodeMirror.commands.save?CodeMirror.commands.save(a):a.save()},nohlsearch:function(a){ja(a)},delmarks:function(a,b){if(!b.argString||
!T(b.argString))i(a,"Argument required");else for(var c=a.state.vim,e=new CodeMirror.StringStream(T(b.argString));!e.eol();){e.eatSpace();var f=e.pos;if(!e.match(/[a-zA-Z]/,!1)){i(a,"Invalid argument: "+b.argString.substring(f));break}var g=e.next();if(e.match("-",!0)){if(!e.match(/[a-zA-Z]/,!1)){i(a,"Invalid argument: "+b.argString.substring(f));break}var h=e.next();if(/^[a-z]$/.test(g)&&/^[a-z]$/.test(h)||B(g)&&B(h)){g=g.charCodeAt(0);h=h.charCodeAt(0);if(g>=h){i(a,"Invalid argument: "+b.argString.substring(f));
break}for(f=0;f<=h-g;f++){var j=String.fromCharCode(g+f);delete c.marks[j]}}else{i(a,"Invalid argument: "+g+"-");break}}else delete c.marks[g]}}},W=new y.ExCommandDispatcher;CodeMirror.keyMap.vim=function(){function a(a){return function(b){CodeMirror.Vim.handleKey(b,a)}}function b(b,f){for(var g=0;g<b.length;g++){var h=b[g];!f&&s(h,ma)&&(h="'"+h+"'");var i=f,j=b[g];B(j)&&("Shift"==i?i=null:j=j.toLowerCase());i&&(j=i.charAt(0)+"-"+j);j=(i={Enter:"CR",Backspace:"BS",Delete:"Del"}[j])?i:j;j=1<j.length?
"<"+j+">":j;c[f?f+"-"+h:h]=a(j)}}var c={nofallthrough:!0,style:"fat-cursor"};b(aa);b(aa,"Shift");b(aa,"Ctrl");b(ma);b(ma,"Ctrl");b(ha);b(ha,"Ctrl");b(ta);b(ta,"Ctrl");return c}();CodeMirror.keyMap["vim-insert"]={Esc:fa,"Ctrl-[":fa,"Ctrl-C":fa,"Ctrl-N":"autocomplete","Ctrl-P":"autocomplete",Enter:function(a){(CodeMirror.commands.newlineAndIndentContinueComment||CodeMirror.commands.newlineAndIndent)(a)},fallthrough:["default"]};CodeMirror.keyMap["vim-replace"]={Backspace:"goCharLeft",fallthrough:["vim-insert"]};
I();return ga};CodeMirror.Vim=y()})();
