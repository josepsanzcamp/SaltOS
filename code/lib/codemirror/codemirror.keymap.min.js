...
(function(){function M(m,K){var u=m.getCursor("head"),B=m.getCursor("anchor");m.operation(function(){var s;var q=Math.min(u.line,B.line),I=Math.max(u.line,B.line);if(!K||q>I)s=0;else{s=m.clipPos(y(q,0));var w=m.clipPos(y(I)),I=m.getRange(s,w);q<=m.firstLine()?m.replaceRange("",s,y(w.line+1,0)):m.replaceRange("",y(s.line-1),w);q=s.line+K;q<=m.firstLine()?(m.replaceRange(I+"\n",y(q,0)),s=m.firstLine()-s.line):(q=m.clipPos(y(q-1)),m.replaceRange("\n"+I,q),s=q.line+1-s.line)}m.setSelection(y(B.line+s,
B.ch),y(u.line+s,u.ch))})}var y=CodeMirror.Pos;CodeMirror.commands.moveLinesUp=function(m){M(m,-1)};CodeMirror.commands.moveLinesDown=function(m){M(m,1)};CodeMirror.keyMap["default"]["Alt-Up"]="moveLinesUp";CodeMirror.keyMap["default"]["Alt-Down"]="moveLinesDown"})();
...
b,d,e){if(b){var n=f(a);d=!!d;e=!!e;if(!(b instanceof RegExp)){var c=g(b),h,C;c.length?(h=b.substring(0,c[0]),C=-1!=b.substring(c[0]).indexOf("i")):h=b;h?(e&&(d=/^[^A-Z]*$/.test(h)),b=RegExp(h,d||C?"i":void 0)):b=null}if(b){na(a,b);a:if(a=n.getQuery(),b instanceof RegExp&&a instanceof RegExp){C=["global","multiline","ignoreCase","source"];for(d=0;d<C.length;d++)if(e=C[d],b[e]!==a[e]){a=!1;break a}a=!0}else a=!1;if(a)return b;n.setQuery(b);return b}}}function ya(a){if("^"==a.source.charAt(0))var b=
...
d.searchArgs.forward;f(a).setReversed(!g);var o=g?"/":"?",Ca=f(a).getQuery(),k=a.getScrollInfo();switch(d.searchArgs.querySrc){case "prompt":j(a,{onClose:c,prefix:o,desc:Ka,onKeyUp:Ba,onKeyDown:h});break;case "wordUnderCursor":var o=S(a,!1,!0,!1,!0),m=!0;o||(o=S(a,!1,!0,!1,!1),m=!1);if(!o)break;var l=a.getLine(o.start.line).substring(o.start.ch,o.end.ch),l=m?"\\b"+l+"\\b":l.replace(/([.?*+$\[\]\/\\(){}|\-])/g,"\\$1");p.jumpList.cachedCursor=a.getCursor();a.setCursor(o.start);e(l,!0,!1)}}},processEx:function(a,
...
E(k,l)||p.jumpList.add(a,k,l));l instanceof Array&&(j=l[0],l=l[1]);l||(l={ch:j.ch,line:j.line});if(b.visualMode){if(r(g,o)&&(E(g,l)||r(l,g)))g.ch+=1;else if(r(o,g)&&(E(g,l)||r(g,l)))g.ch-=1;o=l;b.visualLine&&(r(g,o)?(g.ch=0,e=a.lastLine(),o.line>e&&(o.line=e),o.ch=x(a,o.line)):(o.ch=0,g.ch=x(a,g.line)));a.setSelection(g,o);G(a,b,"<",r(g,o)?g:o);G(a,b,">",r(g,o)?o:g)}else f||(l=t(a,l),a.setCursor(l.line,l.ch))}if(f){e=!1;b.lastMotion=null;h.repeat=m;b.visualMode&&(j=g,l=o,c.inclusive=!0);r(l,j)&&(o=
j,j=l,l=o,e=!0);c.inclusive&&(!b.visualMode||!e)&&l.ch++;if(o=c.linewise||b.visualMode&&b.visualLine)c=l,j.ch=0,c.ch=0,c.line++;else if(c.forward&&(c=l,g=a.getRange(j,c),/\n\s*$/.test(g))){g=g.split("\n");g.pop();for(m=g.pop();0<g.length&&m&&/^\s*$/.test(m);m=g.pop())c.line--,c.ch=0;m?(c.line--,c.ch=x(a,c.line)):c.ch=0}h.registerName=i;h.linewise=o;La[f](a,h,b,j,l,k);b.visualMode&&L(a)}},recordLastEdit:function(a,b,d){var e=p.macroModeState;e.inReplay||(a.lastEditInputState=b,a.lastEditActionCommand=
...
(c=b.repeat)||(c=e.clientHeight/(2*a.defaultTextHeight()));var f=a.charCoords(a.getCursor(),"local");b.repeat=c;c=X.moveByDisplayLines(a,b,d);if(!c)return null;b=a.charCoords(c,"local");a.scrollTo(null,e.top+b.top-f.top);return c},moveByWords:function(a,b){var d;var e=b.repeat;d=!!b.forward;var c=!!b.wordEnd,f=!!b.bigWord,h=a.getCursor(),g=h.line,i=h.ch,j=[];(d&&!c||!d&&c)&&e++;for(var k=!(d&&c),m=0;m<e;m++){var l;b:{l=a;var p=d,s=f,t=k,D=h.line,H=h.ch,O=l.getLine(D),r=p?1:-1,s=s?Ia:Ha;if(t&&""==
O){D+=r;O=l.getLine(D);if(!(D>=l.firstLine()&&D<=l.lastLine())){l=null;break b}H=p?0:O.length}for(;;){if(t&&""==O){l={from:0,to:0,line:D};break b}for(var q=p=0<r?O.length:-1,u=p;H!=p;){for(var w=!1,v=0;v<s.length&&!w;++v)if(s[v].test(O.charAt(H))){for(q=H;H!=p&&s[v].test(O.charAt(H));)H+=r;u=H;w=q!=u;if(!(q==h.ch&&D==h.line&&u==q+r)){l={from:Math.min(q,u+1),to:Math.max(q,u),line:D};break b}}w||(H+=r)}D+=r;if(!(D>=l.firstLine()&&D<=l.lastLine())){l=null;break b}O=l.getLine(D);H=0<r?0:O.length}throw Error("The impossible happened.");
...
s=k.charAt(r+1),s="\\"==s||"/"==s;"\\"!==l||p||!s?(q.push(l),p=!1):p=!0}k=q.join("")}e[2]&&(m=c.substring(e[2]+1).split(" "),h=m[0],m=parseInt(m[1]));h&&(-1!=h.indexOf("c")&&(o=!0,h.replace("c","")),j=j+"/"+h);if(j)try{ba(a,j,!0,!0)}catch(u){i(a,"Invalid regex: "+j);return}j=f(a).getQuery();h=void 0!==b.line?b.line:a.getCursor().line;c=b.lineEnd||h;m&&(h=c,c=h+m-1);m=t(a,{line:h,ch:0});m=a.getSearchCursor(j,m);Ea(a,o,h,c,m,j,k)}},redo:CodeMirror.commands.redo,undo:CodeMirror.commands.undo,write:function(a){CodeMirror.commands.save?
CodeMirror.commands.save(a):a.save()},nohlsearch:function(a){ja(a)},delmarks:function(a,b){if(!b.argString||!T(b.argString))i(a,"Argument required");else for(var c=a.state.vim,e=new CodeMirror.StringStream(T(b.argString));!e.eol();){e.eatSpace();var f=e.pos;if(!e.match(/[a-zA-Z]/,!1)){i(a,"Invalid argument: "+b.argString.substring(f));break}var g=e.next();if(e.match("-",!0)){if(!e.match(/[a-zA-Z]/,!1)){i(a,"Invalid argument: "+b.argString.substring(f));break}var h=e.next();if(/^[a-z]$/.test(g)&&/^[a-z]$/.test(h)||
B(g)&&B(h)){g=g.charCodeAt(0);h=h.charCodeAt(0);if(g>=h){i(a,"Invalid argument: "+b.argString.substring(f));break}for(f=0;f<=h-g;f++){var j=String.fromCharCode(g+f);delete c.marks[j]}}else{i(a,"Invalid argument: "+g+"-");break}}else delete c.marks[g]}}},W=new y.ExCommandDispatcher;CodeMirror.keyMap.vim=function(){function a(a){return function(b){CodeMirror.Vim.handleKey(b,a)}}function b(b,f){for(var g=0;g<b.length;g++){var h=b[g];!f&&s(h,ma)&&(h="'"+h+"'");var i=f,j=b[g];B(j)&&("Shift"==i?i=null:
j=j.toLowerCase());i&&(j=i.charAt(0)+"-"+j);j=(i={Enter:"CR",Backspace:"BS",Delete:"Del"}[j])?i:j;j=1<j.length?"<"+j+">":j;c[f?f+"-"+h:h]=a(j)}}var c={nofallthrough:!0,style:"fat-cursor"};b(aa);b(aa,"Shift");b(aa,"Ctrl");b(ma);b(ma,"Ctrl");b(ha);b(ha,"Ctrl");b(ta);b(ta,"Ctrl");return c}();CodeMirror.keyMap["vim-insert"]={Esc:fa,"Ctrl-[":fa,"Ctrl-C":fa,"Ctrl-N":"autocomplete","Ctrl-P":"autocomplete",Enter:function(a){(CodeMirror.commands.newlineAndIndentContinueComment||CodeMirror.commands.newlineAndIndent)(a)},
fallthrough:["default"]};CodeMirror.keyMap["vim-replace"]={Backspace:"goCharLeft",fallthrough:["vim-insert"]};I();return ga};CodeMirror.Vim=y()})();
