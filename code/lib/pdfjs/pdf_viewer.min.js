...
t.onContinue=e;this.renderTask.promise.then(function(){a(null);n&&m.pdfPage.getTextContent({normalizeWhitespace:true}).then(function(a){n.setTextContent(a);n.render(200)})},function(b){a(b)});this.annotationLayerFactory&&(this.annotationLayer||(this.annotationLayer=this.annotationLayerFactory.createAnnotationLayerBuilder(f,this.pdfPage,this.renderInteractiveForms)),this.annotationLayer.render(this.viewport,"display"));f.setAttribute("data-loaded",!0);if(m.onBeforeDraw)m.onBeforeDraw();return d},setPageLabel:function(a){this.pageLabel=
"string"===typeof a?a:null;null!==this.pageLabel?this.div.setAttribute("data-page-label",this.pageLabel):this.div.removeAttribute("data-page-label")}};return c}();c.PDFPageView=d});(function(c,d){d(c.pdfjsWebTextLayerBuilder={},c.pdfjsWebDOMEvents,c.pdfjsWebPDFJS)})(this,function(c,d,j){function a(){}var k=function(){function a(c){this.textLayerDiv=c.textLayerDiv;this.eventBus=c.eventBus||d.getGlobalEventBus();this.textContent=null;this.renderingDone=!1;this.pageIdx=c.pageIndex;this.pageNumber=this.pageIdx+
1;this.matches=[];this.viewport=c.viewport;this.textDivs=[];this.findController=c.findController||null;this.textLayerRenderTask=null;this.enhanceTextSelection=c.enhanceTextSelection;this._bindMouse()}a.prototype={_finishRendering:function(){this.renderingDone=!0;if(!this.enhanceTextSelection){var a=document.createElement("div");a.className="endOfContent";this.textLayerDiv.appendChild(a)}this.eventBus.dispatch("textlayerrendered",{source:this,pageNumber:this.pageNumber,numTextDivs:this.textDivs.length})},
render:function(a){if(this.textContent&&!this.renderingDone){this.cancel();this.textDivs=[];var b=document.createDocumentFragment();this.textLayerRenderTask=j.renderTextLayer({textContent:this.textContent,container:b,viewport:this.viewport,textDivs:this.textDivs,timeout:a,enhanceTextSelection:this.enhanceTextSelection});this.textLayerRenderTask.promise.then(function(){this.textLayerDiv.appendChild(b);this._finishRendering();this.updateMatches()}.bind(this),function(){})}},cancel:function(){this.textLayerRenderTask&&
(this.textLayerRenderTask.cancel(),this.textLayerRenderTask=null)},setTextContent:function(a){this.cancel();this.textContent=a},convertMatches:function(a,b){var c=0,d=0,h=this.textContent.items,f=h.length-1,i=null===this.findController?0:this.findController.state.query.length,j=[];if(!a)return j;for(var k=0,n=a.length;k<n;k++){for(var w=a[k];c!==f&&w>=d+h[c].str.length;)d+=h[c].str.length,c++;c===h.length&&console.error("Could not find a matching mapping");for(var o={begin:{divIdx:c,offset:w-d}},
w=b?w+b[k]:w+i;c!==f&&w>d+h[c].str.length;)d+=h[c].str.length,c++;o.end={divIdx:c,offset:w-d};j.push(o)}return j},renderMatches:function(a){function b(a,b){var e=a.divIdx;h[e].textContent="";c(e,0,a.offset,b)}function c(a,b,e,f){var g=h[a],a=d[a].str.substring(b,e),a=document.createTextNode(a);f?(b=document.createElement("span"),b.className=f,b.appendChild(a),g.appendChild(b)):g.appendChild(a)}if(0!==a.length){var d=this.textContent.items,h=this.textDivs,f=null,i=this.pageIdx,j=null===this.findController?
!1:i===this.findController.selected.pageIdx,k=null===this.findController?-1:this.findController.selected.matchIdx,n=k,o=n+1;if(null===this.findController?0:this.findController.state.highlightAll)n=0,o=a.length;else if(!j)return;for(;n<o;n++){var x=a[n],l=x.begin,x=x.end,u=j&&n===k?" selected":"";this.findController&&this.findController.updateMatchPosition(i,n,h,l.divIdx);!f||l.divIdx!==f.divIdx?(null!==f&&c(f.divIdx,f.offset,void 0),b(l)):c(f.divIdx,f.offset,l.offset);if(l.divIdx===x.divIdx)c(l.divIdx,
l.offset,x.offset,"highlight"+u);else{c(l.divIdx,l.offset,void 0,"highlight begin"+u);f=l.divIdx+1;for(l=x.divIdx;f<l;f++)h[f].className="highlight middle"+u;b(x,"highlight end"+u)}f=x}f&&c(f.divIdx,f.offset,void 0)}},updateMatches:function(){if(this.renderingDone){for(var a=this.matches,b=this.textDivs,c=this.textContent.items,d=-1,h=0,f=a.length;h<f;h++){for(var i=a[h],d=Math.max(d,i.begin.divIdx),j=i.end.divIdx;d<=j;d++){var k=b[d];k.textContent=c[d].str;k.className=""}d=i.end.divIdx+1}if(null!==
this.findController&&this.findController.active){var n,o;null!==this.findController&&(n=this.findController.pageMatches[this.pageIdx]||null,o=this.findController.pageMatchesLength?this.findController.pageMatchesLength[this.pageIdx]||null:null);this.matches=this.convertMatches(n,o);this.renderMatches(this.matches)}}},_bindMouse:function(){var a=this.textLayerDiv,b=this,c=null;a.addEventListener("mousedown",function(d){if(b.enhanceTextSelection&&b.textLayerRenderTask)b.textLayerRenderTask.expandTextDivs(!0),
c&&(clearTimeout(c),c=null);else{var h=a.querySelector(".endOfContent");if(h){var f=d.target!==a;if(f=f&&"none"!==window.getComputedStyle(h).getPropertyValue("-moz-user-select"))f=a.getBoundingClientRect(),d=Math.max(0,(d.pageY-f.top)/f.height),h.style.top=(100*d).toFixed(2)+"%";h.classList.add("active")}}});a.addEventListener("mouseup",function(){if(b.enhanceTextSelection&&b.textLayerRenderTask)c=setTimeout(function(){b.textLayerRenderTask&&b.textLayerRenderTask.expandTextDivs(!1);c=null},300);else{var d=
a.querySelector(".endOfContent");d&&(d.style.top="",d.classList.remove("active"))}})}};return a}();a.prototype={createTextLayerBuilder:function(a,c,b,d){return new k({textLayerDiv:a,pageIndex:c,viewport:b,enhanceTextSelection:d})}};c.TextLayerBuilder=k;c.DefaultTextLayerFactory=a});(function(c,d){d(c.pdfjsWebAnnotationLayerBuilder={},c.pdfjsWebUIUtils,c.pdfjsWebPDFLinkService,c.pdfjsWebPDFJS)})(this,function(c,d,j,a){function k(){}var i=d.mozL10n,e=j.SimpleLinkService,b=function(){function b(a){this.pageDiv=
a.pageDiv;this.pdfPage=a.pdfPage;this.renderInteractiveForms=a.renderInteractiveForms;this.linkService=a.linkService;this.downloadManager=a.downloadManager;this.div=null}b.prototype={render:function(b,c){var f=this,d={intent:void 0===c?"display":c};this.pdfPage.getAnnotations(d).then(function(c){b=b.clone({dontFlip:!0});d={viewport:b,div:f.div,annotations:c,page:f.pdfPage,renderInteractiveForms:f.renderInteractiveForms,linkService:f.linkService,downloadManager:f.downloadManager};f.div?a.AnnotationLayer.update(d):
0!==c.length&&(f.div=document.createElement("div"),f.div.className="annotationLayer",f.pageDiv.appendChild(f.div),d.div=f.div,a.AnnotationLayer.render(d),"undefined"!==typeof i&&i.translate(f.div))})},hide:function(){this.div&&this.div.setAttribute("hidden","true")}};return b}();k.prototype={createAnnotationLayerBuilder:function(a,c,d){return new b({pageDiv:a,pdfPage:c,renderInteractiveForms:d,linkService:new e})}};c.AnnotationLayerBuilder=b;c.DefaultAnnotationLayerFactory=k});(function(c,d){d(c.pdfjsWebPDFViewer=
{},c.pdfjsWebUIUtils,c.pdfjsWebPDFPageView,c.pdfjsWebPDFRenderingQueue,c.pdfjsWebTextLayerBuilder,c.pdfjsWebAnnotationLayerBuilder,c.pdfjsWebPDFLinkService,c.pdfjsWebDOMEvents,c.pdfjsWebPDFJS)})(this,function(c,d,j,a,k,i,e,b,g){var n=d.UNKNOWN_SCALE,h=d.SCROLLBAR_PADDING,f=d.VERTICAL_PADDING,o=d.MAX_AUTO_SCALE,t=d.CSS_UNITS,v=d.DEFAULT_SCALE,z=d.DEFAULT_SCALE_VALUE,w=d.scrollIntoView,x=d.watchScroll,l=d.getVisibleElements,u=j.PDFPageView,p=a.RenderingStates,s=a.PDFRenderingQueue,B=k.TextLayerBuilder,
C=i.AnnotationLayerBuilder,A=e.SimpleLinkService,y={UNKNOWN:0,NORMAL:1,CHANGING:2,FULLSCREEN:3},d=function(){function a(b){var c=[];this.push=function(a){var d=c.indexOf(a);0<=d&&c.splice(d,1);c.push(a);c.length>b&&c.shift().destroy()};this.resize=function(a){for(b=a;c.length>b;)c.shift().destroy()}}function c(a){this.container=a.container;this.viewer=a.viewer||a.container.firstElementChild;this.eventBus=a.eventBus||b.getGlobalEventBus();this.linkService=a.linkService||new A;this.downloadManager=
a.downloadManager||null;this.removePageBorders=a.removePageBorders||!1;this.enhanceTextSelection=a.enhanceTextSelection||!1;this.renderInteractiveForms=a.renderInteractiveForms||!1;(this.defaultRenderingQueue=!a.renderingQueue)?(this.renderingQueue=new s,this.renderingQueue.setViewer(this)):this.renderingQueue=a.renderingQueue;this.scroll=x(this.container,this._scrollUpdate.bind(this));this.presentationModeState=y.UNKNOWN;this._resetView();this.removePageBorders&&this.viewer.classList.add("removePageBorders")}
...
n?this._currentScale:v},set currentScale(a){if(isNaN(a))throw Error("Invalid numeric scale");this.pdfDocument?this._setScale(a,!1):(this._currentScale=a,this._currentScaleValue=a!==n?a.toString():null)},get currentScaleValue(){return this._currentScaleValue},set currentScaleValue(a){this.pdfDocument?this._setScale(a,!1):(this._currentScale=isNaN(a)?n:a,this._currentScaleValue=a.toString())},get pagesRotation(){return this._pagesRotation},set pagesRotation(a){if(!("number"===typeof a&&0===a%90))throw Error("Invalid pages rotation angle.");
this._pagesRotation=a;if(this.pdfDocument){for(var b=0,c=this._pages.length;b<c;b++){var d=this._pages[b];d.update(d.scale,a)}this._setScale(this._currentScaleValue,!0);this.defaultRenderingQueue&&this.update()}},setDocument:function(a){this.pdfDocument&&(this._cancelRendering(),this._resetView());if(this.pdfDocument=a){var b=a.numPages,c=this,d,f=new Promise(function(a){d=a});this.pagesPromise=f;f.then(function(){c._pageViewsReady=true;c.eventBus.dispatch("pagesloaded",{source:c,pagesCount:b})});
var e=!1,h=null,i=new Promise(function(a){h=a});this.onePageRendered=i;var j=function(a){a.onBeforeDraw=function(){c._buffer.push(this)};a.onAfterDraw=function(){if(!e){e=true;h()}}};this.firstPagePromise=f=a.getPage(1);return f.then(function(f){for(var e=this.currentScale,f=f.getViewport(e*t),h=1;h<=b;++h){var k=null;g.PDFJS.disableTextLayer||(k=this);k=new u({container:this.viewer,eventBus:this.eventBus,id:h,scale:e,defaultViewport:f.clone(),renderingQueue:this.renderingQueue,textLayerFactory:k,
annotationLayerFactory:this,enhanceTextSelection:this.enhanceTextSelection,renderInteractiveForms:this.renderInteractiveForms});j(k);this._pages.push(k)}var D=this.linkService;i.then(function(){if(g.PDFJS.disableAutoFetch)d();else for(var f=b,e=1;e<=b;++e)a.getPage(e).then(function(a,b){var e=c._pages[a-1];e.pdfPage||e.setPdfPage(b);D.cachePageRef(a,b.ref);f--;f||d()}.bind(null,e))});c.eventBus.dispatch("pagesinit",{source:c});this.defaultRenderingQueue&&this.update();this.findController&&this.findController.resolveFirstPage()}.bind(this))}},
setPageLabels:function(a){if(this.pdfDocument){a?a instanceof Array&&this.pdfDocument.numPages===a.length?this._pageLabels=a:(this._pageLabels=null,console.error("PDFViewer_setPageLabels: Invalid page labels.")):this._pageLabels=null;for(var a=0,b=this._pages.length;a<b;a++)this._pages[a].setPageLabel(this._pageLabels&&this._pageLabels[a])}},_resetView:function(){this._pages=[];this._currentPageNumber=1;this._currentScale=n;this._pageLabels=this._currentScaleValue=null;this._buffer=new a(10);this._location=
null;this._pagesRotation=0;this._pagesRequests=[];this._pageViewsReady=!1;this.viewer.textContent=""},_scrollUpdate:function(){if(0!==this.pagesCount){this.update();for(var a=0,b=this._pages.length;a<b;a++)this._pages[a].updatePosition()}},_setScaleDispatchEvent:function(a,b,c){a={source:this,scale:a,presetValue:c?b:void 0};this.eventBus.dispatch("scalechanging",a);this.eventBus.dispatch("scalechange",a)},_setScaleUpdatePages:function(a,b,c,d){this._currentScaleValue=b.toString();var f;f=this._currentScale;
f=a===f?!0:1.0E-15>Math.abs(a-f)?!0:!1;if(f)d&&this._setScaleDispatchEvent(a,b,!0);else{f=0;for(var e=this._pages.length;f<e;f++)this._pages[f].update(a);this._currentScale=a;if(!c){var c=this._currentPageNumber,h;this._location&&(!g.PDFJS.ignoreCurrentPositionOnZoom&&!this.isInPresentationMode&&!this.isChangingPresentationMode)&&(c=this._location.pageNumber,h=[null,{name:"XYZ"},this._location.left,this._location.top,null]);this.scrollPageIntoView({pageNumber:c,destArray:h,allowNegativeOffset:!0})}this._setScaleDispatchEvent(a,
b,d);this.defaultRenderingQueue&&this.update()}},_setScale:function(a,b){var c=parseFloat(a);if(0<c)this._setScaleUpdatePages(c,a,b,!1);else if(c=this._pages[this._currentPageNumber-1]){var d=(this.container.clientWidth-(this.isInPresentationMode||this.removePageBorders?0:h))/c.width*c.scale,e=(this.container.clientHeight-(this.isInPresentationMode||this.removePageBorders?0:f))/c.height*c.scale;switch(a){case "page-actual":c=1;break;case "page-width":c=d;break;case "page-height":c=e;break;case "page-fit":c=
Math.min(d,e);break;case "auto":c=c.width>c.height?Math.min(e,d):d;c=Math.min(o,c);break;default:console.error('PDFViewer_setScale: "'+a+'" is an unknown zoom value.');return}this._setScaleUpdatePages(c,a,b,!0)}},_resetCurrentPageView:function(){this.isInPresentationMode&&this._setScale(this._currentScaleValue,!0);w(this._pages[this._currentPageNumber-1].div)},scrollPageIntoView:function(a){if(this.pdfDocument){if(1<arguments.length||"number"===typeof a){console.warn("Call of scrollPageIntoView() with obsolete signature.");
var b={};"number"===typeof a&&(b.pageNumber=a);arguments[1]instanceof Array&&(b.destArray=arguments[1]);a=b}var c=a.pageNumber||0,d=a.destArray||null,b=a.allowNegativeOffset||!1;if(this.isInPresentationMode||!d)this._setCurrentPageNumber(c,!0);else if(c=this._pages[c-1]){var e=0,g=0,i=0,j=0,k,l;l=0===c.rotation%180?!1:!0;k=(l?c.height:c.width)/c.scale/t;l=(l?c.width:c.height)/c.scale/t;var m=0;switch(d[1].name){case "XYZ":e=d[2];g=d[3];m=d[4];e=null!==e?e:0;g=null!==g?g:l;break;case "Fit":case "FitB":m=
"page-fit";break;case "FitH":case "FitBH":g=d[2];m="page-width";null===g&&this._location&&(e=this._location.left,g=this._location.top);break;case "FitV":case "FitBV":e=d[2];i=k;j=l;m="page-height";break;case "FitR":e=d[2];g=d[3];i=d[4]-e;j=d[5]-g;l=this.removePageBorders?0:f;k=(this.container.clientWidth-(this.removePageBorders?0:h))/i/t;l=(this.container.clientHeight-l)/j/t;m=Math.min(Math.abs(k),Math.abs(l));break;default:console.error("PDFViewer_scrollPageIntoView: '"+d[1].name+"' is not a valid destination type.");
return}m&&m!==this._currentScale?this.currentScaleValue=m:this._currentScale===n&&(this.currentScaleValue=z);"page-fit"===m&&!d[4]?w(c.div):(e=[c.viewport.convertToViewportPoint(e,g),c.viewport.convertToViewportPoint(e+i,g+j)],d=Math.min(e[0][0],e[1][0]),e=Math.min(e[0][1],e[1][1]),b||(d=Math.max(d,0),e=Math.max(e,0)),w(c.div,{left:d,top:e}))}else console.error('PDFViewer_scrollPageIntoView: Invalid "pageNumber" parameter.')}},_updateLocation:function(a){var b=this._currentScale,c=this._currentScaleValue,
...
b,c){return new C({pageDiv:a,pdfPage:b,renderInteractiveForms:c,linkService:this.linkService,downloadManager:this.downloadManager})},setFindController:function(a){this.findController=a},getPagesOverview:function(){return this._pages.map(function(a){a=a.pdfPage.getViewport(1);return{width:a.width,height:a.height}})}};return c}();c.PresentationModeState=y;c.PDFViewer=d})}).call(o);var n=t.PDFJS;n.PDFViewer=o.pdfjsWebPDFViewer.PDFViewer;n.PDFPageView=o.pdfjsWebPDFPageView.PDFPageView;n.PDFLinkService=
o.pdfjsWebPDFLinkService.PDFLinkService;n.TextLayerBuilder=o.pdfjsWebTextLayerBuilder.TextLayerBuilder;n.DefaultTextLayerFactory=o.pdfjsWebTextLayerBuilder.DefaultTextLayerFactory;n.AnnotationLayerBuilder=o.pdfjsWebAnnotationLayerBuilder.AnnotationLayerBuilder;n.DefaultAnnotationLayerFactory=o.pdfjsWebAnnotationLayerBuilder.DefaultAnnotationLayerFactory;n.PDFHistory=o.pdfjsWebPDFHistory.PDFHistory;n.PDFFindController=o.pdfjsWebPDFFindController.PDFFindController;n.EventBus=o.pdfjsWebUIUtils.EventBus;
n.DownloadManager=o.pdfjsWebDownloadManager.DownloadManager;n.ProgressBar=o.pdfjsWebUIUtils.ProgressBar;z.PDFJS=n});
