...
a;this.pdfPageRotate=a.rotate;this.viewport=a.getViewport(this.scale*i,(this.rotation+this.pdfPageRotate)%360);this.stats=a.stats;this.reset()},destroy:function(){this.reset();this.pdfPage&&this.pdfPage.cleanup()},_resetZoomLayer:function(a){if(this.zoomLayer){var c=this.zoomLayer.firstChild;this.paintedViewportMap.delete(c);c.width=0;c.height=0;a&&this.zoomLayer.remove();this.zoomLayer=null}},reset:function(a,c){this.cancelRendering();var b=this.div;b.style.width=Math.floor(this.viewport.width)+
"px";b.style.height=Math.floor(this.viewport.height)+"px";for(var d=b.childNodes,f=a&&this.zoomLayer||null,h=c&&this.annotationLayer&&this.annotationLayer.div||null,l=d.length-1;0<=l;l--){var e=d[l];f===e||h===e||b.removeChild(e)}b.removeAttribute("data-loaded");h?this.annotationLayer.hide():this.annotationLayer=null;f||(this.canvas&&(this.paintedViewportMap.delete(this.canvas),this.canvas.width=0,this.canvas.height=0,delete this.canvas),this._resetZoomLayer());this.svg&&(this.paintedViewportMap.delete(this.svg),
delete this.svg);this.loadingIconDiv=document.createElement("div");this.loadingIconDiv.className="loadingIcon";b.appendChild(this.loadingIconDiv)},update:function(a,c){this.scale=a||this.scale;"undefined"!==typeof c&&(this.rotation=c);this.viewport=this.viewport.clone({scale:this.scale*i,rotation:(this.rotation+this.pdfPageRotate)%360});if(this.svg)this.cssTransform(this.svg,!0),this.eventBus.dispatch("pagerendered",{source:this,pageNumber:this.id,cssTransform:!0});else{var d=!1;if(this.canvas&&0<
b.PDFJS.maxCanvasPixels){var f=this.outputScale;(Math.floor(this.viewport.width)*f.sx|0)*(Math.floor(this.viewport.height)*f.sy|0)>b.PDFJS.maxCanvasPixels&&(d=!0)}if(this.canvas){if(b.PDFJS.useOnlyCssZoom||this.hasRestrictedScaling&&d){this.cssTransform(this.canvas,!0);this.eventBus.dispatch("pagerendered",{source:this,pageNumber:this.id,cssTransform:!0});return}this.zoomLayer||(this.zoomLayer=this.canvas.parentNode,this.zoomLayer.style.position="absolute")}this.zoomLayer&&this.cssTransform(this.zoomLayer.firstChild);
this.reset(!0,!0)}},cancelRendering:function(){this.paintTask&&(this.paintTask.cancel(),this.paintTask=null);this.renderingState=m.INITIAL;this.resume=null;this.textLayer&&(this.textLayer.cancel(),this.textLayer=null)},updatePosition:function(){this.textLayer&&this.textLayer.render(200)},cssTransform:function(a,c){var d=b.CustomStyle,f=this.viewport.width,h=this.viewport.height,l=this.div;a.style.width=a.parentNode.style.width=l.style.width=Math.floor(f)+"px";a.style.height=a.parentNode.style.height=
l.style.height=Math.floor(h)+"px";var l=this.viewport.rotation-this.paintedViewportMap.get(a).rotation,e=Math.abs(l),m=1,i=1;if(90===e||270===e)m=h/f,i=f/h;d.setProp("transform",a,"rotate("+l+"deg) scale("+m+","+i+")");if(this.textLayer){e=this.textLayer.viewport;h=Math.abs(this.viewport.rotation-e.rotation);l=f/e.width;if(90===h||270===h)l=f/e.height;var f=this.textLayer.textLayerDiv,g,t;switch(h){case 0:g=t=0;break;case 90:g=0;t="-"+f.style.height;break;case 180:g="-"+f.style.width;t="-"+f.style.height;
break;case 270:g="-"+f.style.width;t=0;break;default:console.error("Bad rotation value.")}d.setProp("transform",f,"rotate("+h+"deg) scale("+l+", "+l+") translate("+g+", "+t+")");d.setProp("transformOrigin",f,"0% 0%")}c&&this.annotationLayer&&this.annotationLayer.render(this.viewport,"display")},get width(){return this.viewport.width},get height(){return this.viewport.height},getPagePoint:function(a,c){return this.viewport.convertToPdfPoint(a,c)},draw:function(){this.renderingState!==m.INITIAL&&(console.error("Must be in new state before drawing"),
...
c?b-1:0,a.wrapped=!0},updateMatch:function(c){var a=j.FIND_NOTFOUND,b=this.offset.wrapped;this.offset.wrapped=!1;c&&(c=this.selected.pageIdx,this.selected.pageIdx=this.offset.pageIdx,this.selected.matchIdx=this.offset.matchIdx,a=b?j.FIND_WRAPPED:j.FIND_FOUND,-1!==c&&c!==this.selected.pageIdx&&this.updatePage(c));this.updateUIState(a,this.state.findPrevious);-1!==this.selected.pageIdx&&this.updatePage(this.selected.pageIdx)},updateUIResultsCount:function(){if(this.onUpdateResultsCount)this.onUpdateResultsCount(this.matchCount)},
updateUIState:function(c,a){if(this.onUpdateState)this.onUpdateState(c,a,this.matchCount)}};return d}();e.FindStates=j;e.PDFFindController=g},function(g,e,d){function k(b){this.linkService=b.linkService;this.eventBus=b.eventBus||j.getGlobalEventBus();this.initialized=!1;this.initialBookmark=this.initialDestination=null}var j=d(2);k.prototype={initialize:function(b){function d(){e.previousHash=window.location.hash.slice(1);e._pushToHistory({hash:e.previousHash},!1,!0);e._updatePreviousBookmark()}function c(a,
c){function b(){window.removeEventListener("popstate",b);window.addEventListener("popstate",d);e._pushToHistory(a,!1,!0);history.forward()}function d(){window.removeEventListener("popstate",d);e.allowHashChange=!0;e.historyUnlocked=!0;c()}e.historyUnlocked=!1;e.allowHashChange=!1;window.addEventListener("popstate",b);history.back()}function a(){var c=e._getPreviousParams(null,!0);c&&(e._pushToHistory(c,!1,!e.current.dest&&e.current.hash!==e.previousHash),e._updatePreviousBookmark());window.removeEventListener("beforeunload",
...
y=j.RenderingStates,r=j.PDFRenderingQueue,w=b.TextLayerBuilder,v=i.AnnotationLayerBuilder,B=c.SimpleLinkService,x={UNKNOWN:0,NORMAL:1,CHANGING:2,FULLSCREEN:3},d=function(){function c(a){var b=[];this.push=function(c){var d=b.indexOf(c);0<=d&&b.splice(d,1);b.push(c);b.length>a&&b.shift().destroy()};this.resize=function(c){for(a=c;b.length>a;)b.shift().destroy()}}function b(c){this.container=c.container;this.viewer=c.viewer||c.container.firstElementChild;this.eventBus=c.eventBus||a.getGlobalEventBus();
this.linkService=c.linkService||new B;this.downloadManager=c.downloadManager||null;this.removePageBorders=c.removePageBorders||!1;this.enhanceTextSelection=c.enhanceTextSelection||!1;this.renderInteractiveForms=c.renderInteractiveForms||!1;this.enablePrintAutoRotate=c.enablePrintAutoRotate||!1;this.renderer=c.renderer||n.CANVAS;(this.defaultRenderingQueue=!c.renderingQueue)?(this.renderingQueue=new r,this.renderingQueue.setViewer(this)):this.renderingQueue=c.renderingQueue;this.scroll=s(this.container,
...
if(this.pdfDocument=a){var c=a.numPages,b=this,d,e=new Promise(function(a){d=a});this.pagesPromise=e;e.then(function(){b._pageViewsReady=true;b.eventBus.dispatch("pagesloaded",{source:b,pagesCount:c})});var f=!1,g=null,h=new Promise(function(a){g=a});this.onePageRendered=h;var j=function(a){a.onBeforeDraw=function(){b._buffer.push(this)};a.onAfterDraw=function(){if(!f){f=true;g()}}};this.firstPagePromise=e=a.getPage(1);return e.then(function(e){for(var f=this.currentScale,e=e.getViewport(f*p),g=1;g<=
c;++g){var i=null;l.PDFJS.disableTextLayer||(i=this);i=new u({container:this.viewer,eventBus:this.eventBus,id:g,scale:f,defaultViewport:e.clone(),renderingQueue:this.renderingQueue,textLayerFactory:i,annotationLayerFactory:this,enhanceTextSelection:this.enhanceTextSelection,renderInteractiveForms:this.renderInteractiveForms,renderer:this.renderer});j(i);this._pages.push(i)}var k=this.linkService;h.then(function(){if(l.PDFJS.disableAutoFetch)d();else for(var e=c,f=1;f<=c;++f)a.getPage(f).then(function(a,
c){var f=b._pages[a-1];f.pdfPage||f.setPdfPage(c);k.cachePageRef(a,c.ref);e--;e||d()}.bind(null,f))});b.eventBus.dispatch("pagesinit",{source:b});this.defaultRenderingQueue&&this.update();this.findController&&this.findController.resolveFirstPage()}.bind(this))}},setPageLabels:function(a){if(this.pdfDocument){a?a instanceof Array&&this.pdfDocument.numPages===a.length?this._pageLabels=a:(this._pageLabels=null,console.error("PDFViewer_setPageLabels: Invalid page labels.")):this._pageLabels=null;for(var a=
0,c=this._pages.length;a<c;a++)this._pages[a].setPageLabel(this._pageLabels&&this._pageLabels[a])}},_resetView:function(){this._pages=[];this._currentPageNumber=1;this._currentScale=h;this._pageLabels=this._currentScaleValue=null;this._buffer=new c(10);this._location=null;this._pagesRotation=0;this._pagesRequests=[];this._pageViewsReady=!1;this.viewer.textContent=""},_scrollUpdate:function(){if(0!==this.pagesCount){this.update();for(var a=0,c=this._pages.length;a<c;a++)this._pages[a].updatePosition()}},
_setScaleDispatchEvent:function(a,c,b){a={source:this,scale:a,presetValue:b?c:void 0};this.eventBus.dispatch("scalechanging",a);this.eventBus.dispatch("scalechange",a)},_setScaleUpdatePages:function(a,c,b,d){this._currentScaleValue=c.toString();var e;e=this._currentScale;e=a===e?!0:1.0E-15>Math.abs(a-e)?!0:!1;if(e)d&&this._setScaleDispatchEvent(a,c,!0);else{e=0;for(var f=this._pages.length;e<f;e++)this._pages[e].update(a);this._currentScale=a;if(!b){var b=this._currentPageNumber,g;this._location&&
(!l.PDFJS.ignoreCurrentPositionOnZoom&&!this.isInPresentationMode&&!this.isChangingPresentationMode)&&(b=this._location.pageNumber,g=[null,{name:"XYZ"},this._location.left,this._location.top,null]);this.scrollPageIntoView({pageNumber:b,destArray:g,allowNegativeOffset:!0})}this._setScaleDispatchEvent(a,c,d);this.defaultRenderingQueue&&this.update()}},_setScale:function(a,c){var b=parseFloat(a);if(0<b)this._setScaleUpdatePages(b,a,c,!1);else if(b=this._pages[this._currentPageNumber-1]){var d=(this.container.clientWidth-
(this.isInPresentationMode||this.removePageBorders?0:f))/b.width*b.scale,e=(this.container.clientHeight-(this.isInPresentationMode||this.removePageBorders?0:m))/b.height*b.scale;switch(a){case "page-actual":b=1;break;case "page-width":b=d;break;case "page-height":b=e;break;case "page-fit":b=Math.min(d,e);break;case "auto":b=b.width>b.height?Math.min(e,d):d;b=Math.min(t,b);break;default:console.error('PDFViewer_setScale: "'+a+'" is an unknown zoom value.');return}this._setScaleUpdatePages(b,a,c,!0)}},
_resetCurrentPageView:function(){this.isInPresentationMode&&this._setScale(this._currentScaleValue,!0);o(this._pages[this._currentPageNumber-1].div)},scrollPageIntoView:function(a){if(this.pdfDocument){if(1<arguments.length||"number"===typeof a){console.warn("Call of scrollPageIntoView() with obsolete signature.");var c={};"number"===typeof a&&(c.pageNumber=a);arguments[1]instanceof Array&&(c.destArray=arguments[1]);a=c}var b=a.pageNumber||0,d=a.destArray||null,c=a.allowNegativeOffset||!1;if(this.isInPresentationMode||
!d)this._setCurrentPageNumber(b,!0);else if(b=this._pages[b-1]){var e=0,g=0,i=0,j=0,k,l;l=0===b.rotation%180?!1:!0;k=(l?b.height:b.width)/b.scale/p;l=(l?b.width:b.height)/b.scale/p;var n=0;switch(d[1].name){case "XYZ":e=d[2];g=d[3];n=d[4];e=null!==e?e:0;g=null!==g?g:l;break;case "Fit":case "FitB":n="page-fit";break;case "FitH":case "FitBH":g=d[2];n="page-width";null===g&&this._location&&(e=this._location.left,g=this._location.top);break;case "FitV":case "FitBV":e=d[2];i=k;j=l;n="page-height";break;
case "FitR":e=d[2];g=d[3];i=d[4]-e;j=d[5]-g;l=this.removePageBorders?0:m;k=(this.container.clientWidth-(this.removePageBorders?0:f))/i/p;l=(this.container.clientHeight-l)/j/p;n=Math.min(Math.abs(k),Math.abs(l));break;default:console.error("PDFViewer_scrollPageIntoView: '"+d[1].name+"' is not a valid destination type.");return}n&&n!==this._currentScale?this.currentScaleValue=n:this._currentScale===h&&(this.currentScaleValue=A);"page-fit"===n&&!d[4]?o(b.div):(e=[b.viewport.convertToViewportPoint(e,
g),b.viewport.convertToViewportPoint(e+i,g+j)],d=Math.min(e[0][0],e[1][0]),e=Math.min(e[0][1],e[1][1]),c||(d=Math.max(d,0),e=Math.max(e,0)),o(b.div,{left:d,top:e}))}else console.error('PDFViewer_scrollPageIntoView: Invalid "pageNumber" parameter.')}},_updateLocation:function(a){var b=this._currentScale,c=this._currentScaleValue,b=parseFloat(c)===b?Math.round(1E4*b)/100:c,c=a.id,d;d="#page="+c+("&zoom="+b);var e=this.container,e=this._pages[c-1].getPagePoint(e.scrollLeft-a.x,e.scrollTop-a.y),a=Math.round(e[0]),
