...
k,{configurable:!1,enumerable:!0,get:g})};d.n=function(b){var k=b&&b.__esModule?function(){return b["default"]}:function(){return b};d.d(k,"a",k);return k};d.o=function(b,d){return Object.prototype.hasOwnProperty.call(b,d)};d.p="";return d(d.s=62)}([function(f,d,b){function l(c){p>=i.warnings&&console.log("Warning: "+c)}function k(c){throw Error(c);}function g(c,B){c||k(B)}function m(c){g("string"===typeof c,"Invalid argument for stringToBytes");for(var B=c.length,e=new Uint8Array(B),n=0;n<B;++n)e[n]=
c.charCodeAt(n)&255;return e}function a(c){if(void 0!==c.length)return c.length;g(void 0!==c.byteLength);return c.byteLength}function r(){var c={};c.promise=new Promise(function(e,a){c.resolve=e;c.reject=a});return c}function j(c,e){var a=2<arguments.length&&void 0!==arguments[2]?arguments[2]:null;return!c?Promise.resolve(void 0):new Promise(function(n){n(c.apply(a,e))})}function q(a){if("object"!==("undefined"===typeof a?"undefined":o(a)))return a;switch(a.name){case "AbortException":return new z(a.message);
case "MissingPDFException":return new c(a.message);case "UnexpectedResponseException":return new e(a.message,a.status);default:return new A(a.message,a.details)}}function v(c,a,e){a?c.resolve():c.reject(e)}function h(c){return Promise.resolve(c).catch(function(){})}function t(a,B,i){var n=this;this.sourceName=a;this.targetName=B;this.comObj=i;this.streamId=this.callbackId=1;this.postMessageTransfers=!0;this.streamSinks=Object.create(null);this.streamControllers=Object.create(null);var J=this.callbacksCapabilities=
Object.create(null),x=this.actionHandler=Object.create(null);this._onComObjOnMessage=function(a){var B=a.data;if(B.targetName===n.sourceName)if(B.stream)n._processStreamMessage(B);else if(B.isReply)if(a=B.callbackId,B.callbackId in J){var b=J[a];delete J[a];"error"in B?b.reject(q(B.error)):b.resolve(B.data)}else throw Error("Cannot resolve callback "+a);else if(B.action in x){var N=x[B.action];if(B.callbackId){var j=n.sourceName,p=B.sourceName;Promise.resolve().then(function(){return N[0].call(N[1],
B.data)}).then(function(n){i.postMessage({sourceName:j,targetName:p,isReply:!0,callbackId:B.callbackId,data:n})},function(n){i.postMessage({sourceName:j,targetName:p,isReply:!0,callbackId:B.callbackId,error:!(n instanceof Error)||n instanceof z||n instanceof c||n instanceof e||n instanceof A?n:new A(n.message,n.toString())})})}else B.streamId?n._createStreamSink(B):N[0].call(N[1],B.data)}else throw Error("Unknown action from worker: "+B.action);};i.addEventListener("message",this._onComObjOnMessage)}
...
d.AnnotationFlag=d.AnnotationFieldFlag=d.AnnotationBorderStyleType=d.UNSUPPORTED_FEATURES=d.VERBOSITY_LEVELS=d.OPS=d.IDENTITY_MATRIX=d.FONT_IDENTITY_MATRIX=void 0;var o="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(c){return typeof c}:function(c){return c&&"function"===typeof Symbol&&c.constructor===Symbol&&c!==Symbol.prototype?"symbol":typeof c};b(63);var u=b(112),i={errors:0,warnings:1,infos:5},p=i.warnings,f=function(){function c(a,e){this.name="PasswordException";this.message=
a;this.code=e}c.prototype=Error();return c.constructor=c}(),A=function(){function c(a,e){this.name="UnknownErrorException";this.message=a;this.details=e}c.prototype=Error();return c.constructor=c}(),b=function(){function c(a){this.name="InvalidPDFException";this.message=a}c.prototype=Error();return c.constructor=c}(),c=function(){function c(a){this.name="MissingPDFException";this.message=a}c.prototype=Error();return c.constructor=c}(),e=function(){function c(a,e){this.name="UnexpectedResponseException";
this.message=a;this.status=e}c.prototype=Error();return c.constructor=c}(),y=function(){function c(a){this.message=a}c.prototype=Error();c.prototype.name="NotImplementedException";return c.constructor=c}(),w=function(){function c(a,e){this.begin=a;this.end=e;this.message="Missing data ["+a+", "+e+")"}c.prototype=Error();c.prototype.name="MissingDataException";return c.constructor=c}(),C=function(){function c(a){this.message=a}c.prototype=Error();c.prototype.name="XRefParseException";return c.constructor=
c}(),s=function(){function c(a){this.message=a}c.prototype=Error();c.prototype.name="FormatError";return c.constructor=c}(),z=function(){function c(a){this.name="AbortException";this.message=a}c.prototype=Error();return c.constructor=c}(),F=/\x00/g,I=function(){function c(){}var a=["rgb(",0,",",0,",",0,")"];c.makeCssRgb=function(n,c,e){a[1]=n;a[3]=c;a[5]=e;return a.join("")};c.transform=function(n,c){return[n[0]*c[0]+n[2]*c[1],n[1]*c[0]+n[3]*c[1],n[0]*c[2]+n[2]*c[3],n[1]*c[2]+n[3]*c[3],n[0]*c[4]+
n[2]*c[5]+n[4],n[1]*c[4]+n[3]*c[5]+n[5]]};c.applyTransform=function(n,c){return[n[0]*c[0]+n[1]*c[2]+c[4],n[0]*c[1]+n[1]*c[3]+c[5]]};c.applyInverseTransform=function(n,c){var a=c[0]*c[3]-c[1]*c[2];return[(n[0]*c[3]-n[1]*c[2]+c[2]*c[5]-c[4]*c[3])/a,(-n[0]*c[1]+n[1]*c[0]+c[4]*c[1]-c[5]*c[0])/a]};c.getAxialAlignedBoundingBox=function(n,J){var a=c.applyTransform(n,J),e=c.applyTransform(n.slice(2,4),J),B=c.applyTransform([n[0],n[3]],J),i=c.applyTransform([n[2],n[1]],J);return[Math.min(a[0],e[0],B[0],i[0]),
Math.min(a[1],e[1],B[1],i[1]),Math.max(a[0],e[0],B[0],i[0]),Math.max(a[1],e[1],B[1],i[1])]};c.inverseTransform=function(n){var c=n[0]*n[3]-n[1]*n[2];return[n[3]/c,-n[1]/c,-n[2]/c,n[0]/c,(n[2]*n[5]-n[4]*n[3])/c,(n[4]*n[1]-n[5]*n[0])/c]};c.apply3dTransform=function(n,c){return[n[0]*c[0]+n[1]*c[1]+n[2]*c[2],n[3]*c[0]+n[4]*c[1]+n[5]*c[2],n[6]*c[0]+n[7]*c[1]+n[8]*c[2]]};c.singularValueDecompose2dScale=function(c){var a=[c[0],c[2],c[1],c[3]],e=c[0]*a[0]+c[1]*a[2],B=c[2]*a[1]+c[3]*a[3],i=(e+B)/2,c=Math.sqrt((e+
B)*(e+B)-4*(e*B-(c[2]*a[0]+c[3]*a[2])*(c[0]*a[1]+c[1]*a[3])))/2,a=i-c||1;return[Math.sqrt(i+c||1),Math.sqrt(a)]};c.normalizeRect=function(c){var a=c.slice(0);c[0]>c[2]&&(a[0]=c[2],a[2]=c[0]);c[1]>c[3]&&(a[1]=c[3],a[3]=c[1]);return a};c.intersect=function(n,a){function e(c,n){return c-n}var B=[n[0],n[2],a[0],a[2]].sort(e),i=[n[1],n[3],a[1],a[3]].sort(e),b=[],n=c.normalizeRect(n),a=c.normalizeRect(a);if(B[0]===n[0]&&B[1]===a[0]||B[0]===a[0]&&B[1]===n[0])b[0]=B[1],b[2]=B[2];else return!1;if(i[0]===n[1]&&
i[1]===a[1]||i[0]===a[1]&&i[1]===n[1])b[1]=i[1],b[3]=i[2];else return!1;return b};var e=" C CC CCC CD D DC DCC DCCC CM  X XX XXX XL L LX LXX LXXX XC  I II III IV V VI VII VIII IX".split(" ");c.toRoman=function(c,a){g(Number.isInteger(c)&&0<c,"The number should be a positive integer.");for(var B,i=[];1E3<=c;)c-=1E3,i.push("M");B=c/100|0;c%=100;i.push(e[B]);B=c/10|0;c%=10;i.push(e[10+B]);i.push(e[20+c]);B=i.join("");return a?B.toLowerCase():B};c.appendToArray=function(c,a){Array.prototype.push.apply(c,
a)};c.prependToArray=function(c,a){Array.prototype.unshift.apply(c,a)};c.extendObj=function(c,a){for(var e in a)c[e]=a[e]};c.getInheritableProperty=function(c,a,e){for(;c&&!c.has(a);)c=c.get("Parent");return!c?null:e?c.getArray(a):c.get(a)};c.inherit=function(c,a,e){c.prototype=Object.create(a.prototype);c.prototype.constructor=c;for(var B in e)c.prototype[B]=e[B]};c.loadScript=function(c,a){var e=document.createElement("script"),B=!1;e.setAttribute("src",c);a&&(e.onload=function(){B||a();B=!0});
document.getElementsByTagName("head")[0].appendChild(e)};return c}(),K=function(){function c(a,e,n,i,b,j){this.viewBox=a;this.scale=e;this.rotation=n;this.offsetX=i;this.offsetY=b;var p=(a[2]+a[0])/2,d=(a[3]+a[1])/2,g,s,h,n=n%360;switch(0>n?n+360:n){case 180:n=-1;s=g=0;h=1;break;case 90:n=0;s=g=1;h=0;break;case 270:n=0;s=g=-1;h=0;break;default:n=1,s=g=0,h=-1}j&&(s=-s,h=-h);0===n?(i=Math.abs(d-a[1])*e+i,b=Math.abs(p-a[0])*e+b,j=Math.abs(a[3]-a[1])*e,a=Math.abs(a[2]-a[0])*e):(i=Math.abs(p-a[0])*e+i,
b=Math.abs(d-a[1])*e+b,j=Math.abs(a[2]-a[0])*e,a=Math.abs(a[3]-a[1])*e);this.transform=[n*e,g*e,s*e,h*e,i-n*e*p-s*e*d,b-g*e*p-h*e*d];this.width=j;this.height=a;this.fontScale=e}c.prototype={clone:function(a){var a=a||{},e="scale"in a?a.scale:this.scale,n="rotation"in a?a.rotation:this.rotation;return new c(this.viewBox.slice(),e,n,this.offsetX,this.offsetY,a.dontFlip)},convertToViewportPoint:function(c,a){return I.applyTransform([c,a],this.transform)},convertToViewportRectangle:function(c){var a=
...
reason:c,streamId:i});return a.promise}},e)},_createStreamSink:function(c){var a=this,e=this,n=this.actionHandler[c.action],i=c.streamId,b=c.desiredSize,p=this.sourceName,g=c.sourceName,d=function(c){a.postMessage({sourceName:p,targetName:g,stream:c.stream,streamId:i,chunk:c.chunk,success:c.success,reason:c.reason},c.transfers)},b={enqueue:function(c){var a=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1,n=arguments[2];if(!this.isCancelled){var e=this.desiredSize;this.desiredSize-=a;0<e&&
0>=this.desiredSize&&(this.sinkCapability=r(),this.ready=this.sinkCapability.promise);d({stream:"enqueue",chunk:c,transfers:n})}},close:function(){this.isCancelled||(this.isCancelled=!0,d({stream:"close"}),delete e.streamSinks[i])},error:function(c){this.isCancelled||(this.isCancelled=!0,d({stream:"error",reason:c}))},sinkCapability:r(),onPull:null,onCancel:null,isCancelled:!1,desiredSize:b,ready:null};b.sinkCapability.resolve();b.ready=b.sinkCapability.promise;this.streamSinks[i]=b;j(n[0],[c.data,
b],n[1]).then(function(){d({stream:"start_complete",success:!0})},function(c){d({stream:"start_complete",success:!1,reason:c})})},_processStreamMessage:function(c){var a=this,e=this.sourceName,n=c.sourceName,i=c.streamId,b=function(c){a.comObj.postMessage({sourceName:e,targetName:n,stream:c.stream,success:c.success,streamId:i,reason:c.reason})},p=function(){Promise.all([a.streamControllers[c.streamId].startCall,a.streamControllers[c.streamId].pullCall,a.streamControllers[c.streamId].cancelCall].map(function(c){return c&&
...
SCREEN:21,PRINTERMARK:22,TRAPNET:23,WATERMARK:24,THREED:25,REDACT:26};d.FontType={UNKNOWN:0,TYPE1:1,TYPE1C:2,CIDFONTTYPE0:3,CIDFONTTYPE0C:4,TRUETYPE:5,CIDFONTTYPE2:6,TYPE3:7,OPENTYPE:8,TYPE0:9,MMTYPE1:10};d.ImageKind={GRAYSCALE_1BPP:1,RGB_24BPP:2,RGBA_32BPP:3};d.CMapCompressionType={NONE:0,BINARY:1,STREAM:2};d.AbortException=z;d.InvalidPDFException=b;d.MessageHandler=t;d.MissingDataException=w;d.MissingPDFException=c;d.NativeImageDecoding={NONE:"none",DECODE:"decode",DISPLAY:"display"};d.NotImplementedException=
y;d.PageViewport=K;d.PasswordException=f;d.PasswordResponses={NEED_PASSWORD:1,INCORRECT_PASSWORD:2};d.StreamType={UNKNOWN:0,FLATE:1,LZW:2,DCT:3,JPX:4,JBIG:5,A85:6,AHX:7,CCF:8,RL:9};d.TextRenderingMode={FILL:0,STROKE:1,FILL_STROKE:2,INVISIBLE:3,FILL_ADD_TO_PATH:4,STROKE_ADD_TO_PATH:5,FILL_STROKE_ADD_TO_PATH:6,ADD_TO_PATH:7,FILL_STROKE_MASK:3,ADD_TO_PATH_FLAG:4};d.UnexpectedResponseException=e;d.UnknownErrorException=A;d.Util=I;d.XRefParseException=C;d.FormatError=s;d.arrayByteLength=a;d.arraysToBytes=
...
c[g]+j,"string"===typeof d[p])return b[a]=p;return b[a]="undefined"};a.setProp=function(c,a,b){c=this.getProp(c);"undefined"!==c&&(a.style[c]=b)};return a}(),t=function(){function a(c,b){this.message=c;this.type=b}a.prototype=Error();a.prototype.name="RenderingCancelledException";return a.constructor=a}(),o={NONE:0,SELF:1,BLANK:2,PARENT:3,TOP:4},u=["","_self","_blank","_parent","_top"],i=function(){function a(){var c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:!0;l(this,a);this.enabled=
...
a,d){b&&!k(b=d?b:b.prototype,g)&&l(b,g,{configurable:!0,value:a})}},function(f,d,b){var l=b(9),k=b(88),g=b(89),m=b(6),a=b(28),r=b(90),j={},q={},f=f.exports=function(b,d,t,o,u){var u=u?function(){return b}:r(b),t=l(t,o,d?2:1),o=0,i,p;if("function"!=typeof u)throw TypeError(b+" is not iterable!");if(g(u))for(i=a(b.length);i>o;o++){if(u=d?t(m(p=b[o])[0],p[1]):t(b[o]),u===j||u===q)return u}else for(o=u.call(b);!(p=o.next()).done;)if(u=k(o,t,p.value,d),u===j||u===q)return u};f.BREAK=j;f.RETURN=q},function(f,
...
l(this)+"]"},!0)},function(f,d,b){var l=b(47),k=b(4),g=b(8),m=b(11),a=b(7),r=b(19),j=b(81),q=b(22),v=b(84),h=b(2)("iterator"),t=!([].keys&&"next"in[].keys()),o=function(){return this};f.exports=function(b,i,d,A,c,e,f){j(d,i,A);var A=function(c){return!t&&c in z?z[c]:function(){return new d(this,c)}},w=i+" Iterator",C="values"==c,s=!1,z=b.prototype,F=z[h]||z["@@iterator"]||c&&z[c],I=F||A(c),K=c?!C?I:A("entries"):void 0,E="Array"==i?z.entries||F:F,H,L;E&&(b=v(E.call(new b)),b!==Object.prototype&&b.next&&
(q(b,w,!0),!l&&!a(b,h)&&m(b,h,o)));C&&(F&&"values"!==F.name)&&(s=!0,I=function(){return F.call(this)});(!l||f)&&(t||s||!z[h])&&m(z,h,I);r[i]=I;r[w]=o;if(c)if(H={values:C?I:A("values"),keys:e?I:A("keys"),entries:K},f)for(L in H)L in z||g(z,L,H[L]);else k(k.P+k.F*(t||s),i,H);return H}},function(f){f.exports=!1},function(f,d,b){d=b(3).document;f.exports=d&&d.documentElement},function(f,d,b){for(var f=b(85),l=b(21),d=b(8),k=b(3),g=b(11),m=b(19),a=b(2),b=a("iterator"),a=a("toStringTag"),r=m.Array,j={CSSRuleList:!0,
CSSStyleDeclaration:!1,CSSValueList:!1,ClientRectList:!1,DOMRectList:!1,DOMStringList:!1,DOMTokenList:!0,DataTransferItemList:!1,FileList:!1,HTMLAllCollection:!1,HTMLCollection:!1,HTMLFormElement:!1,HTMLSelectElement:!1,MediaList:!0,MimeTypeArray:!1,NamedNodeMap:!1,NodeList:!0,PaintRequestList:!1,Plugin:!1,PluginArray:!1,SVGLengthList:!1,SVGNumberList:!1,SVGPathSegList:!1,SVGPointList:!1,SVGStringList:!1,SVGTransformList:!1,SourceBufferList:!1,StyleSheetList:!0,TextTrackCueList:!1,TextTrackList:!1,
TouchList:!1},l=l(j),q=0;q<l.length;q++){var v=l[q],h=j[v],t=k[v],t=t&&t.prototype,o;if(t&&(t[b]||g(t,b,r),t[a]||g(t,a,v),m[v]=r,h))for(o in f)t[o]||d(t,o,f[o],!0)}},function(f,d,b){var l=b(6),k=b(16),g=b(2)("species");f.exports=function(b,a){var d=l(b).constructor,j;return void 0===d||void 0==(j=l(d)[g])?a:k(j)}},function(f,d,b){var l=b(9),k=b(91),g=b(48),m=b(24),a=b(3),r=a.process,d=a.setImmediate,j=a.clearImmediate,q=a.MessageChannel,v=a.Dispatch,h=0,t={},o,u=function(){var a=+this;if(t.hasOwnProperty(a)){var b=
t[a];delete t[a];b()}},i=function(a){u.call(a.data)};if(!d||!j)d=function(a){for(var b=[],c=1;arguments.length>c;)b.push(arguments[c++]);t[++h]=function(){k("function"==typeof a?a:Function(a),b)};o(h);return h},j=function(a){delete t[a]},"process"==b(18)(r)?o=function(a){r.nextTick(l(u,a,1))}:v&&v.now?o=function(a){v.now(l(u,a,1))}:q?(b=new q,q=b.port2,b.port1.onmessage=i,o=l(q.postMessage,q,1)):a.addEventListener&&"function"==typeof postMessage&&!a.importScripts?(o=function(b){a.postMessage(b+"",
"*")},a.addEventListener("message",i,!1)):o="onreadystatechange"in m("script")?function(a){g.appendChild(m("script")).onreadystatechange=function(){g.removeChild(this);u.call(a)}}:function(a){setTimeout(l(u,a,1),0)};f.exports={set:d,clear:j}},function(f){f.exports=function(d){try{return{e:!1,v:d()}}catch(b){return{e:!0,v:b}}}},function(f,d,b){var l=b(6),k=b(1),g=b(35);f.exports=function(b,a){l(b);if(k(a)&&a.constructor===b)return a;var d=g.f(b),j=d.resolve;j(a);return d.promise}},function(f,d,b){var l=
b(2)("iterator"),k=!1;try{var g=[7][l]();g["return"]=function(){k=!0};Array.from(g,function(){throw 2;})}catch(m){}f.exports=function(a,b){if(!b&&!k)return!1;var d=!1;try{var g=[7],m=g[l]();m.next=function(){return{done:d=!0}};g[l]=function(){return m};a(g)}catch(h){}return d}},function(f,d,b){var l=b(9),k=b(26),g=b(33),m=b(28),a=b(98);f.exports=function(b,d){var q=1==b,v=2==b,h=3==b,t=4==b,o=6==b,u=5==b||o,i=d||a;return function(a,d,c){for(var e=g(a),j=k(e),d=l(d,c,3),c=m(j.length),f=0,a=q?i(a,c):
v?i(a,0):void 0,C,s;c>f;f++)if(u||f in j)if(C=j[f],s=d(C,f,e),b)if(q)a[f]=s;else if(s)switch(b){case 3:return!0;case 5:return C;case 6:return f;case 2:a.push(C)}else if(t)return!1;return o?-1:h||t?t:a}}},function(f,d,b){var l=b(1);f.exports=function(b,d){if(!l(b)||b._t!==d)throw TypeError("Incompatible receiver, "+d+" required!");return b}},function(f,d,b){function l(c,b,e,d){if(c.destroyed)return Promise.reject(Error("Worker was destroyed"));b.disableRange=(0,a.getDefaultSetting)("disableRange");
b.disableAutoFetch=(0,a.getDefaultSetting)("disableAutoFetch");b.disableStream=(0,a.getDefaultSetting)("disableStream");e&&(b.length=e.length,b.initialData=e.initialData);return c.messageHandler.sendWithPromise("GetDocRequest",{docId:d,apiVersion:"2.0.207",source:{data:b.data,url:b.url,password:b.password,disableAutoFetch:b.disableAutoFetch,rangeChunkSize:b.rangeChunkSize,length:b.length},maxImageSize:(0,a.getDefaultSetting)("maxImageSize"),disableFontFace:(0,a.getDefaultSetting)("disableFontFace"),
...
this.annotationsIntent!==c){this.annotationsPromise=this.transport.getAnnotations(this.pageIndex,c);this.annotationsIntent=c}return this.annotationsPromise},render:function(c){var b=this,i=this._stats;i.time("Overall");this.pendingCleanup=false;var e=c.intent==="print"?"print":"display",n=c.canvasFactory||new a.DOMCanvasFactory,d=new t.WebGLContext({enable:!(0,a.getDefaultSetting)("disableWebGL")});this.intentStates[e]||(this.intentStates[e]=Object.create(null));var p=this.intentStates[e];if(!p.displayReadyCapability){p.receivingOperatorList=
...
e)},i)})}else this._listeners.forEach(function(a){a.call(this,{data:c})},this)}},{key:"addEventListener",value:function(c,a){this._listeners.push(a)}},{key:"removeEventListener",value:function(c,a){this._listeners.splice(this._listeners.indexOf(a),1)}},{key:"terminate",value:function(){this._listeners=[]}}]);return c}(),z=function(){function c(){if(typeof u!=="undefined")return u;if((0,a.getDefaultSetting)("workerSrc"))return(0,a.getDefaultSetting)("workerSrc");if(p)return p.replace(/(\.(?:min\.)?js)(\?.*)?$/i,
".worker$1$2");throw Error("No PDFJS.workerSrc specified");}function b(){if(n)return n.promise;n=(0,m.createPromiseCapability)();(A||function(a){m.Util.loadScript(c(),function(){a(window.pdfjsDistBuildPdfWorker.WorkerMessageHandler)})})(n.resolve);return n.promise}function e(c){return URL.createObjectURL(new Blob(["importScripts('"+c+"');"]))}function d(c,a){if(a&&J.has(a))throw Error("Cannot use more than one PDFWorker per port");this.name=c;this.destroyed=false;this.postMessageTransfers=true;this._readyCapability=
...
!i,c=new Uint8Array([c?255:0]);try{p.send("test",c,[c.buffer])}catch(b){(0,m.info)("Cannot use postMessage transfers");c[0]=0;p.send("test",c)}};h();return}catch(s){(0,m.info)("The worker has been disabled.")}}this._setupFakeWorker()},_setupFakeWorker:function(){var c=this;if(!o&&!(0,a.getDefaultSetting)("disableWorker")){(0,m.warn)("Setting up fake worker.");o=true}b().then(function(a){if(c.destroyed)c._readyCapability.reject(Error("Worker was destroyed"));else{var b=new s(Uint8Array!==Float32Array);
...
new Promise(function(c,i){var e=new Image;e.onload=function(){var a=e.width,i=e.height,d=a*i,p=d*4,d=new Uint8Array(d*b),j=document.createElement("canvas");j.width=a;j.height=i;j=j.getContext("2d");j.drawImage(e,0,0);var j=j.getImageData(0,0,a,i).data,h,s;if(b===3)for(s=h=0;h<p;h=h+4,s=s+3){d[s]=j[h];d[s+1]=j[h+1];d[s+2]=j[h+2]}else if(b===1)for(s=h=0;h<p;h=h+4,s++)d[s]=j[h];c({data:d,width:a,height:i})};e.onerror=function(){i(Error("JpegDecode failed to load image"))};e.src=a})},this);c.on("FetchBuiltInCMap",
...
d.build="546cd2b6";d.getDocument=function(b){var i=new e;if(typeof b==="string")b={url:b};else if((0,m.isArrayBuffer)(b))b={data:b};else if(b instanceof y)b={range:b};else{if((typeof b==="undefined"?"undefined":g(b))!=="object")throw Error("Invalid parameter in getDocument, need either Uint8Array, string or a parameter object");if(!b.url&&!b.data&&!b.range)throw Error("Invalid parameter object: need either .data, .range or .url");}var d={},p=null,j=null,n=a.DOMCMapReaderFactory,J;for(J in b)if(J===
"url"&&typeof window!=="undefined")d[J]=(new URL(b[J],window.location)).href;else if(J==="range")p=b[J];else if(J==="worker")j=b[J];else if(J==="data"&&!(b[J]instanceof Uint8Array)){var s=b[J];if(typeof s==="string")d[J]=(0,m.stringToBytes)(s);else if((typeof s==="undefined"?"undefined":g(s))==="object"&&s!==null&&!isNaN(s.length))d[J]=new Uint8Array(s);else if((0,m.isArrayBuffer)(s))d[J]=new Uint8Array(s);else throw Error("Invalid PDF binary data: either typed array, string or array-like object is expected in the data property.");
}else J==="CMapReaderFactory"?n=b[J]:d[J]=b[J];d.rangeChunkSize=d.rangeChunkSize||65536;d.ignoreErrors=d.stopAtErrors!==true;J=Object.values(m.NativeImageDecoding);if(d.nativeImageDecoderSupport===void 0||!J.includes(d.nativeImageDecoderSupport))d.nativeImageDecoderSupport=m.NativeImageDecoding.DECODE;if(!j){j=(J=(0,a.getDefaultSetting)("workerPort"))?z.fromPort(J):new z;i._worker=j}var o=i.docId;j.promise.then(function(){if(i.destroyed)throw Error("Loading aborted");return l(j,d,p,o).then(function(a){if(i.destroyed)throw Error("Loading aborted");
var b=void 0;p?b=new h.PDFDataTransportStream(d,p):d.data||(b=new c(d));a=new m.MessageHandler(o,a,j.port);a.postMessageTransfers=j.postMessageTransfers;b=new F(a,i,b,n);i._transport=b;a.send("Ready",null)})}).catch(i._capability.reject);return i};d.LoopbackPort=s;d.PDFDataRangeTransport=y;d.PDFWorker=z;d.PDFDocumentProxy=w;d.PDFPageProxy=C;d.setPDFNetworkStreamClass=function(a){c=a};d.version="2.0.207";d.build="546cd2b6"},function(f,d,b){Object.defineProperty(d,"__esModule",{value:!0});d.Metadata=
...
this._metadata=Object.create(null);this._parse(a)}l(b,[{key:"_repair",value:function(a){return a.replace(/>\\376\\377([^<]+)/g,function(a,b){for(var d=b.replace(/\\([0-3])([0-7])([0-7])/g,function(a,b,d,j){return String.fromCharCode(64*b+8*d+1*j)}).replace(/&(amp|apos|gt|lt|quot);/g,function(a,b){switch(b){case "amp":return"&";case "apos":return"'";case "gt":return">";case "lt":return"<";case "quot":return'"'}throw Error("_repair: "+b+" isn't defined.");}),g="",h=0,k=d.length;h<k;h+=2)var o=256*d.charCodeAt(h)+
d.charCodeAt(h+1),g=32<=o&&127>o&&60!==o&&62!==o&&38!==o?g+String.fromCharCode(o):g+("&#x"+(65536+o).toString(16).substring(1)+";");return">"+g})}},{key:"_parse",value:function(a){a=a.documentElement;if("rdf:rdf"!==a.nodeName.toLowerCase())for(a=a.firstChild;a&&"rdf:rdf"!==a.nodeName.toLowerCase();)a=a.nextSibling;var b=a?a.nodeName.toLowerCase():null;if(a&&"rdf:rdf"===b&&a.hasChildNodes())for(var a=a.childNodes,b=0,d=a.length;b<d;b++){var g=a[b];if("rdf:description"===g.nodeName.toLowerCase())for(var k=
0,h=g.childNodes.length;k<h;k++)if("#text"!==g.childNodes[k].nodeName.toLowerCase()){var m=g.childNodes[k];this._metadata[m.nodeName.toLowerCase()]=m.textContent.trim()}}}},{key:"get",value:function(a){return this._metadata[a]||null}},{key:"getAll",value:function(){return this._metadata}},{key:"has",value:function(a){return"undefined"!==typeof this._metadata[a]}}]);return b}();d.Metadata=f},function(f,d,b){function l(c,a){if(!c)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
return a&&("object"===typeof a||"function"===typeof a)?a:c}function k(c,a){if("function"!==typeof a&&null!==a)throw new TypeError("Super expression must either be null or a function, not "+typeof a);c.prototype=Object.create(a&&a.prototype,{constructor:{value:c,enumerable:!1,writable:!0,configurable:!0}});a&&(Object.setPrototypeOf?Object.setPrototypeOf(c,a):c.__proto__=a)}function g(c,a){if(!(c instanceof a))throw new TypeError("Cannot call a class as a function");}Object.defineProperty(d,"__esModule",
...
b);i&&c(a,i);return a}}(),r=b(10),j=b(0),q=function(){function b(){g(this,b)}a(b,null,[{key:"create",value:function(a){switch(a.data.annotationType){case j.AnnotationType.LINK:return new h(a);case j.AnnotationType.TEXT:return new t(a);case j.AnnotationType.WIDGET:switch(a.data.fieldType){case "Tx":return new u(a);case "Btn":return a.data.radioButton?new p(a):a.data.checkBox?new i(a):new A(a);case "Ch":return new c(a)}return new o(a);case j.AnnotationType.POPUP:return new e(a);case j.AnnotationType.LINE:return new w(a);
case j.AnnotationType.SQUARE:return new C(a);case j.AnnotationType.CIRCLE:return new s(a);case j.AnnotationType.POLYLINE:return new z(a);case j.AnnotationType.POLYGON:return new F(a);case j.AnnotationType.HIGHLIGHT:return new I(a);case j.AnnotationType.UNDERLINE:return new K(a);case j.AnnotationType.SQUIGGLY:return new E(a);case j.AnnotationType.STRIKEOUT:return new H(a);case j.AnnotationType.STAMP:return new L(a);case j.AnnotationType.FILEATTACHMENT:return new N(a);default:return new v(a)}}}]);return b}(),
v=function(){function c(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:!1,i=2<arguments.length&&void 0!==arguments[2]?arguments[2]:!1;g(this,c);this.isRenderable=b;this.data=a.data;this.layer=a.layer;this.page=a.page;this.viewport=a.viewport;this.linkService=a.linkService;this.downloadManager=a.downloadManager;this.imageResourcesPath=a.imageResourcesPath;this.renderInteractiveForms=a.renderInteractiveForms;this.svgFactory=a.svgFactory;b&&(this.container=this._createContainer(i))}
a(c,[{key:"_createContainer",value:function(){var c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:!1,a=this.data,b=this.page,i=this.viewport,d=document.createElement("section"),e=a.rect[2]-a.rect[0],p=a.rect[3]-a.rect[1];d.setAttribute("data-annotation-id",a.id);b=j.Util.normalizeRect([a.rect[0],b.view[3]-a.rect[1]+b.view[1],a.rect[2],b.view[3]-a.rect[3]+b.view[1]]);r.CustomStyle.setProp("transform",d,"matrix("+i.transform.join(",")+")");r.CustomStyle.setProp("transformOrigin",d,-b[0]+"px "+
...
"dashed";break;case j.AnnotationBorderStyleType.BEVELED:(0,j.warn)("Unimplemented border style: beveled");break;case j.AnnotationBorderStyleType.INSET:(0,j.warn)("Unimplemented border style: inset");break;case j.AnnotationBorderStyleType.UNDERLINE:d.style.borderBottomStyle="solid"}a.color?d.style.borderColor=j.Util.makeCssRgb(a.color[0]|0,a.color[1]|0,a.color[2]|0):d.style.borderWidth=0}d.style.left=b[0]+"px";d.style.top=b[1]+"px";d.style.width=e+"px";d.style.height=p+"px";return d}},{key:"_createPopup",
value:function(c,a,b){a||(a=document.createElement("div"),a.style.height=c.style.height,a.style.width=c.style.width,c.appendChild(a));a=(new y({container:c,trigger:a,color:b.color,title:b.title,contents:b.contents,hideWrapper:!0})).render();a.style.left=c.style.width;c.appendChild(a)}},{key:"render",value:function(){throw Error("Abstract method `AnnotationElement.render` called");}}]);return c}(),h=function(c){function b(c){g(this,b);var a=!(!c.data.url&&!c.data.dest&&!c.data.action);return l(this,
(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a))}k(b,c);a(b,[{key:"render",value:function(){this.container.className="linkAnnotation";var c=document.createElement("a");(0,r.addLinkAttributes)(c,{url:this.data.url,target:this.data.newWindow?r.LinkTarget.BLANK:void 0});this.data.url||(this.data.action?this._bindNamedAction(c,this.data.action):this._bindLink(c,this.data.dest));this.container.appendChild(c);return this.container}},{key:"_bindLink",value:function(c,a){var b=this;c.href=this.linkService.getDestinationHash(a);
c.onclick=function(){a&&b.linkService.navigateTo(a);return!1};a&&(c.className="internalLink")}},{key:"_bindNamedAction",value:function(c,a){var b=this;c.href=this.linkService.getAnchorUrl("");c.onclick=function(){b.linkService.executeNamedAction(a);return!1};c.className="internalLink"}}]);return b}(v),t=function(c){function b(c){g(this,b);var a=!(!c.data.hasPopup&&!c.data.title&&!c.data.contents);return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a))}k(b,c);a(b,[{key:"render",value:function(){this.container.className=
"textAnnotation";var c=document.createElement("img");c.style.height=this.container.style.height;c.style.width=this.container.style.width;c.src=this.imageResourcesPath+"annotation-"+this.data.name.toLowerCase()+".svg";c.alt="[{{type}} Annotation]";c.dataset.l10nId="text_annotation_type";c.dataset.l10nArgs=JSON.stringify({type:this.data.name});this.data.hasPopup||this._createPopup(this.container,c,this.data);this.container.appendChild(c);return this.container}}]);return b}(v),o=function(c){function b(){g(this,
b);return l(this,(b.__proto__||Object.getPrototypeOf(b)).apply(this,arguments))}k(b,c);a(b,[{key:"render",value:function(){return this.container}}]);return b}(v),u=function(c){function b(c){g(this,b);var a=c.renderInteractiveForms||!c.data.hasAppearance&&!!c.data.fieldValue;return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a))}k(b,c);a(b,[{key:"render",value:function(){var c=["left","center","right"];this.container.className="textWidgetAnnotation";var a=null;if(this.renderInteractiveForms){if(this.data.multiLine?
...
!0);this.container.appendChild(c);return this.container}}]);return b}(o),A=function(c){function b(){g(this,b);return l(this,(b.__proto__||Object.getPrototypeOf(b)).apply(this,arguments))}k(b,c);a(b,[{key:"render",value:function(){var c=m(b.prototype.__proto__||Object.getPrototypeOf(b.prototype),"render",this).call(this);c.className="buttonWidgetAnnotation pushButton";return c}}]);return b}(h),c=function(c){function b(c){g(this,b);return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,c.renderInteractiveForms))}
k(b,c);a(b,[{key:"render",value:function(){this.container.className="choiceWidgetAnnotation";var c=document.createElement("select");c.disabled=this.data.readOnly;this.data.combo||(c.size=this.data.options.length,this.data.multiSelect&&(c.multiple=!0));for(var a=0,b=this.data.options.length;a<b;a++){var i=this.data.options[a],d=document.createElement("option");d.textContent=i.displayValue;d.value=i.exportValue;0<=this.data.fieldValue.indexOf(i.displayValue)&&d.setAttribute("selected",!0);c.appendChild(d)}this.container.appendChild(c);
return this.container}}]);return b}(o),e=function(c){function b(c){g(this,b);var a=!(!c.data.title&&!c.data.contents);return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a))}k(b,c);a(b,[{key:"render",value:function(){this.container.className="popupAnnotation";if(0<=["Line","Square","Circle","PolyLine","Polygon"].indexOf(this.data.parentType))return this.container;var c=this.layer.querySelector('[data-annotation-id="'+this.data.parentId+'"]');if(!c)return this.container;var a=new y({container:this.container,
trigger:c,color:this.data.color,title:this.data.title,contents:this.data.contents}),b=parseFloat(c.style.left),i=parseFloat(c.style.width);r.CustomStyle.setProp("transformOrigin",this.container,-(b+i)+"px -"+c.style.top);this.container.style.left=b+i+"px";this.container.appendChild(a.render());return this.container}}]);return b}(v),y=function(){function c(a){g(this,c);this.container=a.container;this.trigger=a.trigger;this.color=a.color;this.title=a.title;this.contents=a.contents;this.hideWrapper=
...
"none");a.appendChild(d);this.container.append(a);this._createPopup(this.container,d,c);return this.container}}]);return b}(v),F=function(c){function a(c){g(this,a);c=l(this,(a.__proto__||Object.getPrototypeOf(a)).call(this,c));c.containerClassName="polygonAnnotation";c.svgElementName="svg:polygon";return c}k(a,c);return a}(z),I=function(c){function b(c){g(this,b);var a=!(!c.data.hasPopup&&!c.data.title&&!c.data.contents);return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a,!0))}k(b,
c);a(b,[{key:"render",value:function(){this.container.className="highlightAnnotation";this.data.hasPopup||this._createPopup(this.container,null,this.data);return this.container}}]);return b}(v),K=function(c){function b(c){g(this,b);var a=!(!c.data.hasPopup&&!c.data.title&&!c.data.contents);return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a,!0))}k(b,c);a(b,[{key:"render",value:function(){this.container.className="underlineAnnotation";this.data.hasPopup||this._createPopup(this.container,
null,this.data);return this.container}}]);return b}(v),E=function(c){function b(c){g(this,b);var a=!(!c.data.hasPopup&&!c.data.title&&!c.data.contents);return l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,a,!0))}k(b,c);a(b,[{key:"render",value:function(){this.container.className="squigglyAnnotation";this.data.hasPopup||this._createPopup(this.container,null,this.data);return this.container}}]);return b}(v),H=function(c){function b(c){g(this,b);var a=!(!c.data.hasPopup&&!c.data.title&&
...
"stampAnnotation";this.data.hasPopup||this._createPopup(this.container,null,this.data);return this.container}}]);return b}(v),N=function(c){function b(c){g(this,b);var c=l(this,(b.__proto__||Object.getPrototypeOf(b)).call(this,c,!0)),a=c.data.file;c.filename=(0,r.getFilenameFromUrl)(a.filename);c.content=a.content;c.linkService.onFileAttachmentAnnotation({id:(0,j.stringToPDFString)(a.filename),filename:a.filename,content:a.content});return c}k(b,c);a(b,[{key:"render",value:function(){this.container.className=
"fileAttachmentAnnotation";var c=document.createElement("div");c.style.height=this.container.style.height;c.style.width=this.container.style.width;c.addEventListener("dblclick",this._download.bind(this));!this.data.hasPopup&&(this.data.title||this.data.contents)&&this._createPopup(this.container,c,this.data);this.container.appendChild(c);return this.container}},{key:"_download",value:function(){this.downloadManager?this.downloadManager.downloadData(this.content,this.filename,""):(0,j.warn)("Download cannot be started due to unavailable download manager")}}]);
return b}(v),f=function(){function c(){g(this,c)}a(c,null,[{key:"render",value:function(c){for(var a=0,b=c.annotations.length;a<b;a++){var i=c.annotations[a];i&&(i=q.create({data:i,layer:c.div,page:c.page,viewport:c.viewport,linkService:c.linkService,downloadManager:c.downloadManager,imageResourcesPath:c.imageResourcesPath||(0,r.getDefaultSetting)("imageResourcesPath"),renderInteractiveForms:c.renderInteractiveForms||!1,svgFactory:new r.DOMSVGFactory}),i.isRenderable&&c.div.appendChild(i.render()))}}},
{key:"update",value:function(c){for(var a=0,b=c.annotations.length;a<b;a++){var i=c.div.querySelector('[data-annotation-id="'+c.annotations[a].id+'"]');i&&r.CustomStyle.setProp("transform",i,"matrix("+c.viewport.transform.join(",")+")")}c.div.removeAttribute("hidden")}}]);return c}();d.AnnotationLayer=f},function(f,d,b){Object.defineProperty(d,"__esModule",{value:!0});d.renderTextLayer=void 0;var l=b(0),k=b(10),f=function(){function b(a){if(!a._canceled){var d=a._textDivs,j=a._capability,i=d.length;
if(!(i>q)&&!a._textContentStream)for(var p=0;p<i;p++)a._layoutText(d[p]);a._renderingDone=!0;j.resolve()}}function d(b){for(var j=b._bounds,h=b._viewport,h=a(h.width,h.height,j),i=0;i<h.length;i++){var p=j[i].div,g=b._textDivProperties.get(p);if(0===g.angle)g.paddingLeft=j[i].left-h[i].left,g.paddingTop=j[i].top-h[i].top,g.paddingRight=h[i].right-j[i].right,g.paddingBottom=h[i].bottom-j[i].bottom;else{var c=h[i],e=j[i],k=e.m,m=k[0],f=k[1],e=[[0,0],[0,e.size[1]],[e.size[0],0],e.size],s=new Float64Array(64);
e.forEach(function(a,b){var i=l.Util.applyTransform(a,k);s[b+0]=m&&(c.left-i[0])/m;s[b+4]=f&&(c.top-i[1])/f;s[b+8]=m&&(c.right-i[0])/m;s[b+12]=f&&(c.bottom-i[1])/f;s[b+16]=f&&(c.left-i[0])/-f;s[b+20]=m&&(c.top-i[1])/m;s[b+24]=f&&(c.right-i[0])/-f;s[b+28]=m&&(c.bottom-i[1])/m;s[b+32]=m&&(c.left-i[0])/-m;s[b+36]=f&&(c.top-i[1])/-f;s[b+40]=m&&(c.right-i[0])/-m;s[b+44]=f&&(c.bottom-i[1])/-f;s[b+48]=f&&(c.left-i[0])/f;s[b+52]=m&&(c.top-i[1])/-m;s[b+56]=f&&(c.right-i[0])/f;s[b+60]=m&&(c.bottom-i[1])/-m});
var e=function(c,a,b){for(var i=0,d=0;d<b;d++){var e=c[a++];0<e&&(i=i?Math.min(e,i):e)}return i},z=1+Math.min(Math.abs(m),Math.abs(f));g.paddingLeft=e(s,32,16)/z;g.paddingTop=e(s,48,16)/z;g.paddingRight=e(s,0,16)/z;g.paddingBottom=e(s,16,16)/z}b._textDivProperties.set(p,g)}}function a(a,b,d){var i=d.map(function(a,c){return{x1:a.left,y1:a.top,x2:a.right,y2:a.bottom,index:c,x1New:void 0,x2New:void 0}});f(a,i);var j=Array(d.length);i.forEach(function(a){j[a.index]={left:a.x1New,top:0,right:a.x2New,
bottom:0}});d.map(function(b,c){var d=j[c],h=i[c];h.x1=b.top;h.y1=a-d.right;h.x2=b.bottom;h.y2=a-d.left;h.index=c;h.x1New=void 0;h.x2New=void 0});f(b,i);i.forEach(function(a){var c=a.index;j[c].top=a.x1New;j[c].bottom=a.x2New});return j}function f(a,b){b.sort(function(a,b){return a.x1-b.x1||a.index-b.index});var d=[{start:-Infinity,end:Infinity,boundary:{x1:-Infinity,y1:-Infinity,x2:0,y2:Infinity,index:-1,x1New:0,x2New:0}}];b.forEach(function(a){for(var b=0;b<d.length&&d[b].end<=a.y1;)b++;for(var j=
d.length-1;0<=j&&d[j].start>=a.y2;)j--;var c,e,h,g=-Infinity;for(h=b;h<=j;h++){c=d[h];e=c.boundary;var k;k=e.x2>a.x1?e.index>a.index?e.x1New:a.x1:void 0===e.x2New?(e.x2+a.x1)/2:e.x2New;k>g&&(g=k)}a.x1New=g;for(h=b;h<=j;h++)c=d[h],e=c.boundary,void 0===e.x2New?e.x2>a.x1?e.index>a.index&&(e.x2New=e.x2):e.x2New=g:e.x2New>g&&(e.x2New=Math.max(g,e.x2));k=[];var s=null;for(h=b;h<=j;h++)c=d[h],e=c.boundary,e=e.x2>a.x2?e:a,s===e?k[k.length-1].end=c.end:(k.push({start:c.start,end:c.end,boundary:e}),s=e);d[b].start<
a.y1&&(k[0].start=a.y1,k.unshift({start:d[b].start,end:a.y1,boundary:d[b].boundary}));a.y2<d[j].end&&(k[k.length-1].end=a.y2,k.push({start:a.y2,end:d[j].end,boundary:d[j].boundary}));for(h=b;h<=j;h++)if(c=d[h],e=c.boundary,void 0===e.x2New){c=!1;for(a=b-1;!c&&0<=a&&d[a].start>=e.y1;a--)c=d[a].boundary===e;for(a=j+1;!c&&a<d.length&&d[a].end<=e.y2;a++)c=d[a].boundary===e;for(a=0;!c&&a<k.length;a++)c=k[a].boundary===e;c||(e.x2New=g)}Array.prototype.splice.apply(d,[b,j-b+1].concat(k))});d.forEach(function(b){b=
b.boundary;void 0===b.x2New&&(b.x2New=Math.max(a,b.x2))})}function j(a){var b=a.textContentStream,d=a.container,i=a.viewport,j=a.textDivs,h=a.textContentItemsStr,c=a.enhanceTextSelection;this._textContent=a.textContent;this._textContentStream=b;this._container=d;this._viewport=i;this._textDivs=j||[];this._textContentItemsStr=h||[];this._enhanceTextSelection=!!c;this._layoutTextCtx=this._layoutTextLastFontFamily=this._layoutTextLastFontSize=this._reader=null;this._textDivProperties=new WeakMap;this._canceled=
this._renderingDone=!1;this._capability=(0,l.createPromiseCapability)();this._renderTimer=null;this._bounds=[]}var q=1E5,v=/\S/,h=["left: ",0,"px; top: ",0,"px; font-size: ",0,"px; font-family: ","",";"];j.prototype={get promise(){return this._capability.promise},cancel:function(){this._reader&&(this._reader.cancel(new l.AbortException("text layer task cancelled")),this._reader=null);this._canceled=!0;null!==this._renderTimer&&(clearTimeout(this._renderTimer),this._renderTimer=null);this._capability.reject("canceled")},
_processItems:function(a,b){for(var d=0,i=a.length;d<i;d++){this._textContentItemsStr.push(a[d].str);var j=a[d],g=b,c=document.createElement("div"),e={style:null,angle:0,canvasWidth:0,isWhitespace:!1,originalTransform:null,paddingBottom:0,paddingLeft:0,paddingRight:0,paddingTop:0,scale:1};this._textDivs.push(c);if(v.test(j.str)){var m=l.Util.transform(this._viewport.transform,j.transform),f=Math.atan2(m[1],m[0]),q=g[j.fontName];q.vertical&&(f+=Math.PI/2);var s=Math.sqrt(m[2]*m[2]+m[3]*m[3]),z=s;q.ascent?
z*=q.ascent:q.descent&&(z*=1+q.descent);var r=g=void 0;0===f?(g=m[4],r=m[5]-z):(g=m[4]+z*Math.sin(f),r=m[5]-z*Math.cos(f));h[1]=g;h[3]=r;h[5]=s;h[7]=q.fontFamily;e.style=h.join("");c.setAttribute("style",e.style);c.textContent=j.str;if((0,k.getDefaultSetting)("pdfBug"))c.dataset.fontName=j.fontName;0!==f&&(e.angle=f*(180/Math.PI));1<j.str.length&&(e.canvasWidth=q.vertical?j.height*this._viewport.scale:j.width*this._viewport.scale);this._textDivProperties.set(c,e);this._textContentStream&&this._layoutText(c);
this._enhanceTextSelection&&(e=1,m=0,0!==f&&(e=Math.cos(f),m=Math.sin(f)),j=(q.vertical?j.height:j.width)*this._viewport.scale,z=q=void 0,0!==f?(q=[e,m,-m,e,g,r],z=l.Util.getAxialAlignedBoundingBox([0,0,j,s],q)):z=[g,r,g+j,r+s],this._bounds.push({left:z[0],top:z[1],right:z[2],bottom:z[3],div:c,size:[j,s],m:q}))}else e.isWhitespace=!0,this._textDivProperties.set(c,e)}},_layoutText:function(a){var b=this._container,d=this._textDivProperties.get(a);if(!d.isWhitespace){var i=a.style.fontSize,j=a.style.fontFamily;
if(i!==this._layoutTextLastFontSize||j!==this._layoutTextLastFontFamily)this._layoutTextCtx.font=i+" "+j,this._lastFontSize=i,this._lastFontFamily=j;i=this._layoutTextCtx.measureText(a.textContent).width;j="";0!==d.canvasWidth&&0<i&&(d.scale=d.canvasWidth/i,j="scaleX("+d.scale+")");0!==d.angle&&(j="rotate("+d.angle+"deg) "+j);""!==j&&(d.originalTransform=j,k.CustomStyle.setProp("transform",a,j));this._textDivProperties.set(a,d);b.appendChild(a)}},_render:function(a){var d=this,j=(0,l.createPromiseCapability)(),
i=Object.create(null),h=document.createElement("canvas");h.mozOpaque=!0;this._layoutTextCtx=h.getContext("2d",{alpha:!1});if(this._textContent)this._processItems(this._textContent.items,this._textContent.styles),j.resolve();else if(this._textContentStream)this._reader=this._textContentStream.getReader(),function c(){d._reader.read().then(function(a){var b=a.value;a.done?j.resolve():(l.Util.extendObj(i,b.styles),d._processItems(b.items,i),c())},j.reject)}();else throw Error('Neither "textContent" nor "textContentStream" parameters specified.');
j.promise.then(function(){i=null;a?d._renderTimer=setTimeout(function(){b(d);d._renderTimer=null},a):b(d)},this._capability.reject)},expandTextDivs:function(a){if(this._enhanceTextSelection&&this._renderingDone){null!==this._bounds&&(d(this),this._bounds=null);for(var b=0,j=this._textDivs.length;b<j;b++){var i=this._textDivs[b],h=this._textDivProperties.get(i);if(!h.isWhitespace)if(a){var g="",c="";1!==h.scale&&(g="scaleX("+h.scale+")");0!==h.angle&&(g="rotate("+h.angle+"deg) "+g);0!==h.paddingLeft&&
(c+=" padding-left: "+h.paddingLeft/h.scale+"px;",g+=" translateX("+-h.paddingLeft/h.scale+"px)");0!==h.paddingTop&&(c+=" padding-top: "+h.paddingTop+"px;",g+=" translateY("+-h.paddingTop+"px)");0!==h.paddingRight&&(c+=" padding-right: "+h.paddingRight/h.scale+"px;");0!==h.paddingBottom&&(c+=" padding-bottom: "+h.paddingBottom+"px;");""!==c&&i.setAttribute("style",h.style+c);""!==g&&k.CustomStyle.setProp("transform",i,g)}else i.style.padding=0,k.CustomStyle.setProp("transform",i,h.originalTransform||
"")}}}};return function(a){var b=new j({textContent:a.textContent,textContentStream:a.textContentStream,container:a.container,viewport:a.viewport,textDivs:a.textDivs,textContentItemsStr:a.textContentItemsStr,enhanceTextSelection:a.enhanceTextSelection});b._render(a.timeout);return b}}();d.renderTextLayer=f},function(f,d,b){var l,k;Object.defineProperty(d,"__esModule",{value:!0});d.SVGGraphics=void 0;var g=b(0),m=b(10),f=function(){throw Error("Not implemented: SVGGraphics");};l="normal";k="#000000";
var a=function(){function a(b,i,j,h){var c=h,e=i.length;j[c]=e>>24&255;j[c+1]=e>>16&255;j[c+2]=e>>8&255;j[c+3]=e&255;c+=4;j[c]=b.charCodeAt(0)&255;j[c+1]=b.charCodeAt(1)&255;j[c+2]=b.charCodeAt(2)&255;j[c+3]=b.charCodeAt(3)&255;c+=4;j.set(i,c);c+=i.length;b=-1;for(h+=4;h<c;h++)b=b>>>8^d[(b^j[h])&255];h=b^-1;j[c]=h>>24&255;j[c+1]=h>>16&255;j[c+2]=h>>8&255;j[c+3]=h&255}for(var b=new Uint8Array([137,80,78,71,13,10,26,10]),d=new Int32Array(256),h=0;256>h;h++){for(var k=h,m=0;8>m;m++)k=k&1?3988292384^
k>>1&2147483647:k>>1&2147483647;d[h]=k}return function(d,i,h){var k=void 0===d.kind?g.ImageKind.GRAYSCALE_1BPP:d.kind,c=d.width,e=d.height,m,f,o,s=d.data;switch(k){case g.ImageKind.GRAYSCALE_1BPP:f=0;m=1;o=c+7>>3;break;case g.ImageKind.RGB_24BPP:f=2;m=8;o=3*c;break;case g.ImageKind.RGBA_32BPP:f=6;m=8;o=4*c;break;default:throw Error("invalid format");}var d=new Uint8Array((1+o)*e),z=0,l=0,v;for(v=0;v<e;++v)d[z++]=0,d.set(s.subarray(l,l+o),z),l+=o,z+=o;if(k===g.ImageKind.GRAYSCALE_1BPP&&h)for(v=z=0;v<
e;v++){z++;for(h=0;h<o;h++)d[z++]^=255}var c=new Uint8Array([c>>24&255,c>>16&255,c>>8&255,c&255,e>>24&255,e>>16&255,e>>8&255,e&255,m,f,0,0,0]),r;a:{if((0,g.isNodeJS)())try{var t;t=8<=parseInt(process.versions.node)?d:new Buffer(d);var H=require("zlib").deflateSync(t,{level:9});r=H instanceof Uint8Array?H:new Uint8Array(H);break a}catch(L){(0,g.warn)("Not compressing PNG because zlib.deflateSync is unavailable: "+L)}H=d.length;r=Math.ceil(H/65535);r=new Uint8Array(2+H+5*r+4);t=0;r[t++]=120;r[t++]=
156;for(e=0;65535<H;)r[t++]=0,r[t++]=255,r[t++]=255,r[t++]=0,r[t++]=0,r.set(d.subarray(e,e+65535),t),t+=65535,e+=65535,H-=65535;r[t++]=1;r[t++]=H&255;r[t++]=H>>8&255;r[t++]=~H&255;r[t++]=(~H&65535)>>8&255;r.set(d.subarray(e),t);t+=d.length-e;H=1;for(h=e=0;h<d.length;++h)H=(H+(d[h]&255))%65521,e=(e+H)%65521;d=e<<16|H;r[t++]=d>>24&255;r[t++]=d>>16&255;r[t++]=d>>8&255;r[t++]=d&255}d=new Uint8Array(b.length+36+c.length+r.length);t=0;d.set(b,t);t+=b.length;a("IHDR",c,d,t);t+=12+c.length;a("IDATA",r,d,
t);t+=12+r.length;a("IEND",new Uint8Array(0),d,t);return(0,g.createObjectURL)(d,"image/png",i)}}(),r=function(){function a(){this.fontSizeScale=1;this.fontWeight=l;this.fontSize=0;this.textMatrix=g.IDENTITY_MATRIX;this.fontMatrix=g.FONT_IDENTITY_MATRIX;this.wordSpacing=this.charSpacing=this.lineY=this.lineX=this.y=this.x=this.leading=0;this.textHScale=1;this.textRise=0;this.fillColor=k;this.strokeColor="#000000";this.lineWidth=this.strokeAlpha=this.fillAlpha=1;this.lineCap=this.lineJoin="";this.miterLimit=
0;this.dashArray=[];this.dashPhase=0;this.dependencies=[];this.clipGroup=this.activeClipUrl=null;this.maskId=""}a.prototype={clone:function(){return Object.create(this)},setCurrentPoint:function(a,b){this.x=a;this.y=b}};return a}();d.SVGGraphics=f=function(){function b(a){if(Number.isInteger(a))return a.toString();var a=a.toFixed(10),d=a.length-1;if("0"!==a[d])return a;do d--;while("0"===a[d]);return a.substr(0,"."===a[d]?d:d+1)}function d(a){if(0===a[4]&&0===a[5]){if(0===a[1]&&0===a[2])return 1===
...
null;this.embedFonts=this.pendingEOFill=!1;this.embeddedFonts=Object.create(null);this.cssStyle=null;this.forceDataSchema=!!d}var h=["butt","round","square"],t=["miter","round","bevel"],o=0,u=0;f.prototype={save:function(){this.transformStack.push(this.transformMatrix);var a=this.current;this.extraStack.push(a);this.current=a.clone()},restore:function(){this.transformMatrix=this.transformStack.pop();this.current=this.extraStack.pop();this.tgrp=this.pendingClip=null},group:function(a){this.save();
this.executeOpTree(a);this.restore()},loadDependencies:function(a){for(var b=this,d=a.fnArray,c=d.length,a=a.argsArray,e=0;e<c;e++)if(g.OPS.dependency===d[e])for(var h=a[e],j=0,k=h.length;j<k;j++){var s=h[j];this.current.dependencies.push("g_"===s.substring(0,2)?new Promise(function(c){b.commonObjs.get(s,c)}):new Promise(function(c){b.objs.get(s,c)}))}return Promise.all(this.current.dependencies)},transform:function(a,b,d,c,e,h){this.transformMatrix=g.Util.transform(this.transformMatrix,[a,b,d,c,
e,h]);this.tgrp=null},getSVG:function(a,b){var d=this;this.viewport=b;var c=this._initialize(b);return this.loadDependencies(a).then(function(){d.transformMatrix=g.IDENTITY_MATRIX;var b=d.convertOpList(a);d.executeOpTree(b);return c})},convertOpList:function(a){var b=a.argsArray,d=a.fnArray,c=d.length,e=[],a=[],h;for(h in g.OPS)e[g.OPS[h]]=h;for(h=0;h<c;h++){var j=d[h];a.push({fnId:j,fn:e[j],args:b[h]})}b=[];d=[];c=a.length;for(e=0;e<c;e++)"save"===a[e].fn?(b.push({fnId:92,fn:"group",items:[]}),d.push(b),
b=b[b.length-1].items):"restore"===a[e].fn?b=d.pop():b.push(a[e]);return b},executeOpTree:function(a){for(var b=a.length,d=0;d<b;d++){var c=a[d].fn,e=a[d].args;switch(a[d].fnId|0){case g.OPS.beginText:this.beginText();break;case g.OPS.setLeading:this.setLeading(e);break;case g.OPS.setLeadingMoveText:this.setLeadingMoveText(e[0],e[1]);break;case g.OPS.setFont:this.setFont(e);break;case g.OPS.showText:this.showText(e[0]);break;case g.OPS.showSpacedText:this.showText(e[0]);break;case g.OPS.endText:this.endText();
break;case g.OPS.moveText:this.moveText(e[0],e[1]);break;case g.OPS.setCharSpacing:this.setCharSpacing(e[0]);break;case g.OPS.setWordSpacing:this.setWordSpacing(e[0]);break;case g.OPS.setHScale:this.setHScale(e[0]);break;case g.OPS.setTextMatrix:this.setTextMatrix(e[0],e[1],e[2],e[3],e[4],e[5]);break;case g.OPS.setTextRise:this.setTextRise(e[0]);break;case g.OPS.setLineWidth:this.setLineWidth(e[0]);break;case g.OPS.setLineJoin:this.setLineJoin(e[0]);break;case g.OPS.setLineCap:this.setLineCap(e[0]);
break;case g.OPS.setMiterLimit:this.setMiterLimit(e[0]);break;case g.OPS.setFillRGBColor:this.setFillRGBColor(e[0],e[1],e[2]);break;case g.OPS.setStrokeRGBColor:this.setStrokeRGBColor(e[0],e[1],e[2]);break;case g.OPS.setDash:this.setDash(e[0],e[1]);break;case g.OPS.setGState:this.setGState(e[0]);break;case g.OPS.fill:this.fill();break;case g.OPS.eoFill:this.eoFill();break;case g.OPS.stroke:this.stroke();break;case g.OPS.fillStroke:this.fillStroke();break;case g.OPS.eoFillStroke:this.eoFillStroke();
break;case g.OPS.clip:this.clip("nonzero");break;case g.OPS.eoClip:this.clip("evenodd");break;case g.OPS.paintSolidColorImageMask:this.paintSolidColorImageMask();break;case g.OPS.paintJpegXObject:this.paintJpegXObject(e[0],e[1],e[2]);break;case g.OPS.paintImageXObject:this.paintImageXObject(e[0]);break;case g.OPS.paintInlineImageXObject:this.paintInlineImageXObject(e[0]);break;case g.OPS.paintImageMaskXObject:this.paintImageMaskXObject(e[0]);break;case g.OPS.paintFormXObjectBegin:this.paintFormXObjectBegin(e[0],
e[1]);break;case g.OPS.paintFormXObjectEnd:this.paintFormXObjectEnd();break;case g.OPS.closePath:this.closePath();break;case g.OPS.closeStroke:this.closeStroke();break;case g.OPS.closeFillStroke:this.closeFillStroke();break;case g.OPS.nextLine:this.nextLine();break;case g.OPS.transform:this.transform(e[0],e[1],e[2],e[3],e[4],e[5]);break;case g.OPS.constructPath:this.constructPath(e[0],e[1]);break;case g.OPS.endPath:this.endPath();break;case 92:this.group(a[d].items);break;default:(0,g.warn)("Unimplemented operator "+
c)}}},setWordSpacing:function(a){this.current.wordSpacing=a},setCharSpacing:function(a){this.current.charSpacing=a},nextLine:function(){this.moveText(0,this.current.leading)},setTextMatrix:function(a,d,h,c,e,g){var k=this.current;this.current.textMatrix=this.current.lineMatrix=[a,d,h,c,e,g];this.current.x=this.current.lineX=0;this.current.y=this.current.lineY=0;k.xcoords=[];k.tspan=this.svgFactory.createElement("svg:tspan");k.tspan.setAttributeNS(null,"font-family",k.fontFamily);k.tspan.setAttributeNS(null,
"font-size",b(k.fontSize)+"px");k.tspan.setAttributeNS(null,"y",b(-k.y));k.txtElement=this.svgFactory.createElement("svg:text");k.txtElement.appendChild(k.tspan)},beginText:function(){this.current.x=this.current.lineX=0;this.current.y=this.current.lineY=0;this.current.textMatrix=g.IDENTITY_MATRIX;this.current.lineMatrix=g.IDENTITY_MATRIX;this.current.tspan=this.svgFactory.createElement("svg:tspan");this.current.txtElement=this.svgFactory.createElement("svg:text");this.current.txtgrp=this.svgFactory.createElement("svg:g");
this.current.xcoords=[]},moveText:function(a,d){var h=this.current;this.current.x=this.current.lineX+=a;this.current.y=this.current.lineY+=d;h.xcoords=[];h.tspan=this.svgFactory.createElement("svg:tspan");h.tspan.setAttributeNS(null,"font-family",h.fontFamily);h.tspan.setAttributeNS(null,"font-size",b(h.fontSize)+"px");h.tspan.setAttributeNS(null,"y",b(-h.y))},showText:function(a){var h=this.current,m=h.font,c=h.fontSize;if(0!==c){var e=h.charSpacing,f=h.wordSpacing,o=h.fontDirection,t=h.textHScale*
o,s=a.length,z=m.vertical,r=c*h.fontMatrix[0],v=0,u;for(u=0;u<s;++u){var E=a[u];if(null===E)v+=o*f;else if((0,g.isNum)(E))v+=0.001*-E*c;else{var H=E.fontChar,L=E.width*r+((E.isSpace?f:0)+e)*o;if(E.isInFont||m.missingFile)h.xcoords.push(h.x+v*t),h.tspan.textContent+=H;v+=L}}z?h.y-=v*t:h.x+=v*t;h.tspan.setAttributeNS(null,"x",h.xcoords.map(b).join(" "));h.tspan.setAttributeNS(null,"y",b(-h.y));h.tspan.setAttributeNS(null,"font-family",h.fontFamily);h.tspan.setAttributeNS(null,"font-size",b(h.fontSize)+
"px");"normal"!==h.fontStyle&&h.tspan.setAttributeNS(null,"font-style",h.fontStyle);h.fontWeight!==l&&h.tspan.setAttributeNS(null,"font-weight",h.fontWeight);h.fillColor!==k&&h.tspan.setAttributeNS(null,"fill",h.fillColor);a=h.textMatrix;0!==h.textRise&&(a=a.slice(),a[5]+=h.textRise);h.txtElement.setAttributeNS(null,"transform",d(a)+" scale(1, -1)");h.txtElement.setAttributeNS("http://www.w3.org/XML/1998/namespace","xml:space","preserve");h.txtElement.appendChild(h.tspan);h.txtgrp.appendChild(h.txtElement);
this._ensureTransformGroup().appendChild(h.txtElement)}},setLeadingMoveText:function(a,b){this.setLeading(-b);this.moveText(a,b)},addFontStyle:function(a){this.cssStyle||(this.cssStyle=this.svgFactory.createElement("svg:style"),this.cssStyle.setAttributeNS(null,"type","text/css"),this.defs.appendChild(this.cssStyle));var b=(0,g.createObjectURL)(a.data,a.mimetype,this.forceDataSchema);this.cssStyle.textContent+='@font-face { font-family: "'+a.loadedName+'"; src: url('+b+"); }\n"},setFont:function(a){var d=
this.current,h=this.commonObjs.get(a[0]),a=a[1];this.current.font=h;this.embedFonts&&(h.data&&!this.embeddedFonts[h.loadedName])&&(this.addFontStyle(h),this.embeddedFonts[h.loadedName]=h);d.fontMatrix=h.fontMatrix?h.fontMatrix:g.FONT_IDENTITY_MATRIX;var c=h.black?h.bold?"bolder":"bold":h.bold?"bold":"normal",e=h.italic?"italic":"normal";0>a?(a=-a,d.fontDirection=-1):d.fontDirection=1;d.fontSize=a;d.fontFamily=h.loadedName;d.fontWeight=c;d.fontStyle=e;d.tspan=this.svgFactory.createElement("svg:tspan");
d.tspan.setAttributeNS(null,"y",b(-d.y));d.xcoords=[]},endText:function(){},setLineWidth:function(a){this.current.lineWidth=a},setLineCap:function(a){this.current.lineCap=h[a]},setLineJoin:function(a){this.current.lineJoin=t[a]},setMiterLimit:function(a){this.current.miterLimit=a},setStrokeAlpha:function(a){this.current.strokeAlpha=a},setStrokeRGBColor:function(a,b,d){this.current.strokeColor=g.Util.makeCssRgb(a,b,d)},setFillAlpha:function(a){this.current.fillAlpha=a},setFillRGBColor:function(a,b,
d){this.current.fillColor=g.Util.makeCssRgb(a,b,d);this.current.tspan=this.svgFactory.createElement("svg:tspan");this.current.xcoords=[]},setDash:function(a,b){this.current.dashArray=a;this.current.dashPhase=b},constructPath:function(a,d){var h=this.current,c=h.x,e=h.y;h.path=this.svgFactory.createElement("svg:path");for(var k=[],m=a.length,f=0,s=0;f<m;f++)switch(a[f]|0){case g.OPS.rectangle:var c=d[s++],e=d[s++],z=d[s++],o=d[s++],z=c+z,o=e+o;k.push("M",b(c),b(e),"L",b(z),b(e),"L",b(z),b(o),"L",b(c),
b(o),"Z");break;case g.OPS.moveTo:c=d[s++];e=d[s++];k.push("M",b(c),b(e));break;case g.OPS.lineTo:c=d[s++];e=d[s++];k.push("L",b(c),b(e));break;case g.OPS.curveTo:c=d[s+4];e=d[s+5];k.push("C",b(d[s]),b(d[s+1]),b(d[s+2]),b(d[s+3]),b(c),b(e));s+=6;break;case g.OPS.curveTo2:c=d[s+2];e=d[s+3];k.push("C",b(c),b(e),b(d[s]),b(d[s+1]),b(d[s+2]),b(d[s+3]));s+=4;break;case g.OPS.curveTo3:c=d[s+2];e=d[s+3];k.push("C",b(d[s]),b(d[s+1]),b(c),b(e),b(c),b(e));s+=4;break;case g.OPS.closePath:k.push("Z")}h.path.setAttributeNS(null,
"d",k.join(" "));h.path.setAttributeNS(null,"fill","none");this._ensureTransformGroup().appendChild(h.path);h.element=h.path;h.setCurrentPoint(c,e)},endPath:function(){if(this.pendingClip){var a=this.current,b="clippath"+o;o++;var h=this.svgFactory.createElement("svg:clipPath");h.setAttributeNS(null,"id",b);h.setAttributeNS(null,"transform",d(this.transformMatrix));var c=a.element.cloneNode();"evenodd"===this.pendingClip?c.setAttributeNS(null,"clip-rule","evenodd"):c.setAttributeNS(null,"clip-rule",
"nonzero");this.pendingClip=null;h.appendChild(c);this.defs.appendChild(h);a.activeClipUrl&&(a.clipGroup=null,this.extraStack.forEach(function(c){c.clipGroup=null}));a.activeClipUrl="url(#"+b+")";this.tgrp=null}},clip:function(a){this.pendingClip=a},closePath:function(){var a=this.current;if(a.path){var b=a.path.getAttributeNS(null,"d");a.path.setAttributeNS(null,"d",b+"Z")}},setLeading:function(a){this.current.leading=-a},setTextRise:function(a){this.current.textRise=a},setHScale:function(a){this.current.textHScale=
a/100},setGState:function(a){for(var b=0,d=a.length;b<d;b++){var c=a[b],e=c[0],c=c[1];switch(e){case "LW":this.setLineWidth(c);break;case "LC":this.setLineCap(c);break;case "LJ":this.setLineJoin(c);break;case "ML":this.setMiterLimit(c);break;case "D":this.setDash(c[0],c[1]);break;case "Font":this.setFont(c);break;case "CA":this.setStrokeAlpha(c);break;case "ca":this.setFillAlpha(c);break;default:(0,g.warn)("Unimplemented graphic state "+e)}}},fill:function(){var a=this.current;a.element&&(a.element.setAttributeNS(null,
...
this.stroke()},closeFillStroke:function(){this.closePath();this.fillStroke()},paintSolidColorImageMask:function(){var a=this.current,b=this.svgFactory.createElement("svg:rect");b.setAttributeNS(null,"x","0");b.setAttributeNS(null,"y","0");b.setAttributeNS(null,"width","1px");b.setAttributeNS(null,"height","1px");b.setAttributeNS(null,"fill",a.fillColor);this._ensureTransformGroup().appendChild(b)},paintJpegXObject:function(a,d,h){var a=this.objs.get(a),c=this.svgFactory.createElement("svg:image");
c.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",a.src);c.setAttributeNS(null,"width",b(d));c.setAttributeNS(null,"height",b(h));c.setAttributeNS(null,"x","0");c.setAttributeNS(null,"y",b(-h));c.setAttributeNS(null,"transform","scale("+b(1/d)+" "+b(-1/h)+")");this._ensureTransformGroup().appendChild(c)},paintImageXObject:function(a){(a=this.objs.get(a))?this.paintInlineImageXObject(a):(0,g.warn)("Dependent image isn't ready yet")},paintInlineImageXObject:function(d,h){var g=d.width,c=
d.height,e=a(d,this.forceDataSchema,!!h),k=this.svgFactory.createElement("svg:rect");k.setAttributeNS(null,"x","0");k.setAttributeNS(null,"y","0");k.setAttributeNS(null,"width",b(g));k.setAttributeNS(null,"height",b(c));this.current.element=k;this.clip("nonzero");k=this.svgFactory.createElement("svg:image");k.setAttributeNS("http://www.w3.org/1999/xlink","xlink:href",e);k.setAttributeNS(null,"x","0");k.setAttributeNS(null,"y",b(-c));k.setAttributeNS(null,"width",b(g)+"px");k.setAttributeNS(null,"height",
b(c)+"px");k.setAttributeNS(null,"transform","scale("+b(1/g)+" "+b(-1/c)+")");h?h.appendChild(k):this._ensureTransformGroup().appendChild(k)},paintImageMaskXObject:function(a){var d=this.current,h=a.width,c=a.height,e=d.fillColor;d.maskId="mask"+u++;var g=this.svgFactory.createElement("svg:mask");g.setAttributeNS(null,"id",d.maskId);var k=this.svgFactory.createElement("svg:rect");k.setAttributeNS(null,"x","0");k.setAttributeNS(null,"y","0");k.setAttributeNS(null,"width",b(h));k.setAttributeNS(null,
"height",b(c));k.setAttributeNS(null,"fill",e);k.setAttributeNS(null,"mask","url(#"+d.maskId+")");this.defs.appendChild(g);this._ensureTransformGroup().appendChild(k);this.paintInlineImageXObject(a,g)},paintFormXObjectBegin:function(a,d){Array.isArray(a)&&6===a.length&&this.transform(a[0],a[1],a[2],a[3],a[4],a[5]);if(Array.isArray(d)&&4===d.length){var h=d[2]-d[0],c=d[3]-d[1],e=this.svgFactory.createElement("svg:rect");e.setAttributeNS(null,"x",d[0]);e.setAttributeNS(null,"y",d[1]);e.setAttributeNS(null,
"width",b(h));e.setAttributeNS(null,"height",b(c));this.current.element=e;this.clip("nonzero");this.endPath()}},paintFormXObjectEnd:function(){},_initialize:function(a){var b=this.svgFactory.create(a.width,a.height),h=this.svgFactory.createElement("svg:defs");b.appendChild(h);this.defs=h;h=this.svgFactory.createElement("svg:g");h.setAttributeNS(null,"transform",d(a.transform));b.appendChild(h);this.svg=h;return b},_ensureClipGroup:function(){if(!this.current.clipGroup){var a=this.svgFactory.createElement("svg:g");
a.setAttributeNS(null,"clip-path",this.current.activeClipUrl);this.svg.appendChild(a);this.current.clipGroup=a}return this.current.clipGroup},_ensureTransformGroup:function(){this.tgrp||(this.tgrp=this.svgFactory.createElement("svg:g"),this.tgrp.setAttributeNS(null,"transform",d(this.transformMatrix)),this.current.activeClipUrl?this._ensureClipGroup().appendChild(this.tgrp):this.svg.appendChild(this.tgrp));return this.tgrp}};return f}();d.SVGGraphics=f},function(f,d,b){var f=b(0),l=b(114),k=b(57),
g=b(60),m=b(59),a=b(10),r=b(61),b=f.isNodeJS()?b(120).PDFNodeStream:"undefined"!==typeof Response&&"body"in Response.prototype&&"undefined"!==typeof ReadableStream?b(121).PDFFetchStream:b(122).PDFNetworkStream;k.setPDFNetworkStreamClass(b);d.PDFJS=l.PDFJS;d.build=k.build;d.version=k.version;d.getDocument=k.getDocument;d.LoopbackPort=k.LoopbackPort;d.PDFDataRangeTransport=k.PDFDataRangeTransport;d.PDFWorker=k.PDFWorker;d.renderTextLayer=g.renderTextLayer;d.AnnotationLayer=m.AnnotationLayer;d.CustomStyle=
a.CustomStyle;d.createPromiseCapability=f.createPromiseCapability;d.PasswordResponses=f.PasswordResponses;d.InvalidPDFException=f.InvalidPDFException;d.MissingPDFException=f.MissingPDFException;d.SVGGraphics=r.SVGGraphics;d.NativeImageDecoding=f.NativeImageDecoding;d.UnexpectedResponseException=f.UnexpectedResponseException;d.OPS=f.OPS;d.UNSUPPORTED_FEATURES=f.UNSUPPORTED_FEATURES;d.createValidAbsoluteUrl=f.createValidAbsoluteUrl;d.createObjectURL=f.createObjectURL;d.removeNullCharacters=f.removeNullCharacters;
d.shadow=f.shadow;d.createBlob=f.createBlob;d.RenderingCancelledException=a.RenderingCancelledException;d.getFilenameFromUrl=a.getFilenameFromUrl;d.addLinkAttributes=a.addLinkAttributes},function(f,d,b){var l="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};if("undefined"===typeof PDFJS||!PDFJS.compatibilityChecked){var k=b(14),g="undefined"!==
typeof navigator&&navigator.userAgent||"",m=/Android/.test(g),a=/Android\s[0-4][^\d]/.test(g),r=0<=g.indexOf("Chrom"),f=0<=g.indexOf("CriOS"),d=0<=g.indexOf("Trident"),j=/\b(iPad|iPhone|iPod)(?=;)/.test(g),q=/Safari\//.test(g)&&!/(Chrome\/|Android\s)/.test(g),v="object"===("undefined"===typeof window?"undefined":l(window))&&"object"===("undefined"===typeof document?"undefined":l(document));"undefined"===typeof PDFJS&&(k.PDFJS={});PDFJS.compatibilityChecked=!0;k.URL||(k.URL=k.webkitURL);(function(){if(typeof XMLHttpRequest!==
...
{get:function(){if(this.responseType!=="arraybuffer")return this.responseText;var a=this.responseText,b,d=a.length,h=new Uint8Array(d);for(b=0;b<d;++b)h[b]=a.charCodeAt(b)&255;return h.buffer}})}}})();(function(){v&&("dataset"in document.createElement("div")||Object.defineProperty(HTMLElement.prototype,"dataset",{get:function(){if(this._dataset)return this._dataset;for(var a={},b=0,d=this.attributes.length;b<d;b++){var j=this.attributes[b];if(j.name.substring(0,5)==="data-"){var i=j.name.substring(5).replace(/\-([a-z])/g,
function(a,b){return b.toUpperCase()});a[i]=j.value}}Object.defineProperty(this,"_dataset",{value:a,writable:false,enumerable:false});return a},enumerable:true}))})();if(d||f)PDFJS.disableCreateObjectURL=!0;"undefined"!==typeof navigator&&!("language"in navigator)&&(PDFJS.locale=navigator.userLanguage||"en-US");if(q||j)PDFJS.disableRange=!0,PDFJS.disableStream=!0;(function(){if(v)if(window.CanvasPixelArray){if(typeof window.CanvasPixelArray.prototype.set!=="function")window.CanvasPixelArray.prototype.set=
function(a){for(var b=0,d=this.length;b<d;b++)this[b]=a[b]}}else{var b=false;if(r)b=(b=g.match(/Chrom(e|ium)\/([0-9]+)\./))&&parseInt(b[2])<21;else if(m)b=a;else if(q)b=(b=g.match(/Version\/([0-9]+)\.([0-9]+)\.([0-9]+) Safari\//))&&parseInt(b[1])<6;if(b){var b=window.CanvasRenderingContext2D.prototype,d=b.createImageData;b.createImageData=function(a,b){var h=d.call(this,a,b);h.data.set=function(a){for(var b=0,c=this.length;b<c;b++)this[b]=a[b]};return h};b=null}}})();if(j||m)PDFJS.maxCanvasPixels=
5242880;v&&(d&&window.parent!==window)&&(PDFJS.disableFullscreen=!0);(function(){v&&("currentScript"in document||Object.defineProperty(document,"currentScript",{get:function(){var a=document.getElementsByTagName("script");return a[a.length-1]},enumerable:true,configurable:true}))})();(function(){if(v){var a=document.createElement("input");try{a.type="number"}catch(b){var a=a.constructor.prototype,d=Object.getOwnPropertyDescriptor(a,"type");Object.defineProperty(a,"type",{get:function(){return d.get.call(this)},
set:function(a){d.set.call(this,a==="number"?"text":a)},enumerable:true,configurable:true})}}})();(function(){if(v&&document.attachEvent){var a=document.constructor.prototype,b=Object.getOwnPropertyDescriptor(a,"readyState");Object.defineProperty(a,"readyState",{get:function(){var a=b.get.call(this);return a==="interactive"?"loading":a},set:function(a){b.set.call(this,a)},enumerable:true,configurable:true})}})();(function(){if(v&&typeof Element.prototype.remove==="undefined")Element.prototype.remove=
function(){this.parentNode&&this.parentNode.removeChild(this)}})();Object.values||(Object.values=b(64));Array.prototype.includes||(Array.prototype.includes=b(69));Math.log2||(Math.log2=b(71));Number.isNaN||(Number.isNaN=b(73));Number.isInteger||(Number.isInteger=b(75));k.Promise||(k.Promise=b(78));k.WeakMap||(k.WeakMap=b(96));(function(){function a(c){if(c===""){i.call(this);this._isInvalid=true}return c.toLowerCase()}function b(c){var a=c.charCodeAt(0);return a>32&&a<127&&[34,35,60,62,63,96].indexOf(a)===
-1?c:encodeURIComponent(c)}function d(c){var a=c.charCodeAt(0);return a>32&&a<127&&[34,35,60,62,96].indexOf(a)===-1?c:encodeURIComponent(c)}function j(c,e,g){function k(c){p.push(c)}var m=e||"scheme start",l=0,q="",u=false,n=false,p=[];a:for(;(c[l-1]!==r||l===0)&&!this._isInvalid;){var x=c[l];switch(m){case "scheme start":if(x&&s.test(x)){q=q+x.toLowerCase();m="scheme"}else if(e){k("Invalid scheme.");break a}else{q="";m="no scheme";continue}break;case "scheme":if(x&&z.test(x))q=q+x.toLowerCase();
else if(x===":"){this._scheme=q;q="";if(e)break a;if(f[this._scheme]!==void 0)this._isRelative=true;m=this._scheme==="file"?"relative":this._isRelative&&g&&g._scheme===this._scheme?"relative or authority":this._isRelative?"authority first slash":"scheme data"}else if(e){x!==r&&k("Code point not allowed in scheme: "+x);break a}else{q="";l=0;m="no scheme";continue}break;case "scheme data":if(x==="?"){this._query="?";m="query"}else if(x==="#"){this._fragment="#";m="fragment"}else if(x!==r&&x!=="\t"&&
x!=="\n"&&x!=="\r")this._schemeData=this._schemeData+b(x);break;case "no scheme":if(!g||f[g._scheme]===void 0){k("Missing scheme.");i.call(this);this._isInvalid=true}else{m="relative";continue}break;case "relative or authority":if(x==="/"&&c[l+1]==="/")m="authority ignore slashes";else{k("Expected /, got: "+x);m="relative";continue}break;case "relative":this._isRelative=true;if(this._scheme!=="file")this._scheme=g._scheme;if(x===r){this._host=g._host;this._port=g._port;this._path=g._path.slice();
this._query=g._query;this._username=g._username;this._password=g._password;break a}else if(x==="/"||x==="\\"){x==="\\"&&k("\\ is an invalid code point.");m="relative slash"}else if(x==="?"){this._host=g._host;this._port=g._port;this._path=g._path.slice();this._query="?";this._username=g._username;this._password=g._password;m="query"}else if(x==="#"){this._host=g._host;this._port=g._port;this._path=g._path.slice();this._query=g._query;this._fragment="#";this._username=g._username;this._password=g._password;
m="fragment"}else{var m=c[l+1],F=c[l+2];if(this._scheme!=="file"||!s.test(x)||m!==":"&&m!=="|"||F!==r&&F!=="/"&&F!=="\\"&&F!=="?"&&F!=="#"){this._host=g._host;this._port=g._port;this._username=g._username;this._password=g._password;this._path=g._path.slice();this._path.pop()}m="relative path";continue}break;case "relative slash":if(x==="/"||x==="\\"){x==="\\"&&k("\\ is an invalid code point.");m=this._scheme==="file"?"file host":"authority ignore slashes"}else{if(this._scheme!=="file"){this._host=
g._host;this._port=g._port;this._username=g._username;this._password=g._password}m="relative path";continue}break;case "authority first slash":if(x==="/")m="authority second slash";else{k("Expected '/', got: "+x);m="authority ignore slashes";continue}break;case "authority second slash":m="authority ignore slashes";if(x!=="/"){k("Expected '/', got: "+x);continue}break;case "authority ignore slashes":if(x!=="/"&&x!=="\\"){m="authority";continue}else k("Expected authority, got: "+x);break;case "authority":if(x===
"@"){if(u){k("@ already seen.");q=q+"%40"}u=true;for(x=0;x<q.length;x++){F=q[x];if(F==="\t"||F==="\n"||F==="\r")k("Invalid whitespace in authority.");else if(F===":"&&this._password===null)this._password="";else{F=b(F);this._password!==null?this._password=this._password+F:this._username=this._username+F}}q=""}else if(x===r||x==="/"||x==="\\"||x==="?"||x==="#"){l=l-q.length;q="";m="host";continue}else q=q+x;break;case "file host":if(x===r||x==="/"||x==="\\"||x==="?"||x==="#"){if(q.length===2&&s.test(q[0])&&
(q[1]===":"||q[1]==="|"))m="relative path";else{if(q.length!==0){this._host=a.call(this,q);q=""}m="relative path start"}continue}else x==="\t"||x==="\n"||x==="\r"?k("Invalid whitespace in file host."):q=q+x;break;case "host":case "hostname":if(x===":"&&!n){this._host=a.call(this,q);q="";m="port";if(e==="hostname")break a}else if(x===r||x==="/"||x==="\\"||x==="?"||x==="#"){this._host=a.call(this,q);q="";m="relative path start";if(e)break a;continue}else if(x!=="\t"&&x!=="\n"&&x!=="\r"){x==="["?n=true:
x==="]"&&(n=false);q=q+x}else k("Invalid code point in host/hostname: "+x);break;case "port":if(/[0-9]/.test(x))q=q+x;else if(x===r||x==="/"||x==="\\"||x==="?"||x==="#"||e){if(q!==""){q=parseInt(q,10);if(q!==f[this._scheme])this._port=q+"";q=""}if(e)break a;m="relative path start";continue}else if(x==="\t"||x==="\n"||x==="\r")k("Invalid code point in port: "+x);else{i.call(this);this._isInvalid=true}break;case "relative path start":x==="\\"&&k("'\\' not allowed in path.");m="relative path";if(x!==
"/"&&x!=="\\")continue;break;case "relative path":if(x===r||x==="/"||x==="\\"||!e&&(x==="?"||x==="#")){x==="\\"&&k("\\ not allowed in relative path.");if(F=v[q.toLowerCase()])q=F;if(q===".."){this._path.pop();x!=="/"&&x!=="\\"&&this._path.push("")}else if(q==="."&&x!=="/"&&x!=="\\")this._path.push("");else if(q!=="."){this._scheme==="file"&&(this._path.length===0&&q.length===2&&s.test(q[0])&&q[1]==="|")&&(q=q[0]+":");this._path.push(q)}q="";if(x==="?"){this._query="?";m="query"}else if(x==="#"){this._fragment=
"#";m="fragment"}}else x!=="\t"&&(x!=="\n"&&x!=="\r")&&(q=q+b(x));break;case "query":if(!e&&x==="#"){this._fragment="#";m="fragment"}else if(x!==r&&x!=="\t"&&x!=="\n"&&x!=="\r")this._query=this._query+d(x);break;case "fragment":if(x!==r&&x!=="\t"&&x!=="\n"&&x!=="\r")this._fragment=this._fragment+x}l++}}function i(){this._username=this._schemeData=this._scheme="";this._password=null;this._port=this._host="";this._path=[];this._fragment=this._query="";this._isRelative=this._isInvalid=false}function g(c,
a){a!==void 0&&!(a instanceof g)&&(a=new g(""+a));this._url=c;i.call(this);var b=c.replace(/^[ \t\r\n\f]+|[ \t\r\n\f]+$/g,"");j.call(this,b,null,a)}var m=false;try{if(typeof URL==="function"&&l(URL.prototype)==="object"&&"origin"in URL.prototype){var c=new URL("b","http://a");c.pathname="c%20d";m=c.href==="http://a/c%20d"}}catch(e){}if(!m){var f=Object.create(null);f.ftp=21;f.file=0;f.gopher=70;f.http=80;f.https=443;f.ws=80;f.wss=443;var v=Object.create(null);v["%2e"]=".";v[".%2e"]="..";v["%2e."]=
"..";v["%2e%2e"]="..";var r,s=/[a-zA-Z]/,z=/[a-zA-Z0-9\+\-\.]/;g.prototype={toString:function(){return this.href},get href(){if(this._isInvalid)return this._url;var c="";if(this._username!==""||this._password!==null)c=this._username+(this._password!==null?":"+this._password:"")+"@";return this.protocol+(this._isRelative?"//"+c+this.host:"")+this.pathname+this._query+this._fragment},set href(c){i.call(this);j.call(this,c)},get protocol(){return this._scheme+":"},set protocol(c){this._isInvalid||j.call(this,
c+":","scheme start")},get host(){return this._isInvalid?"":this._port?this._host+":"+this._port:this._host},set host(c){!this._isInvalid&&this._isRelative&&j.call(this,c,"host")},get hostname(){return this._host},set hostname(c){!this._isInvalid&&this._isRelative&&j.call(this,c,"hostname")},get port(){return this._port},set port(c){!this._isInvalid&&this._isRelative&&j.call(this,c,"port")},get pathname(){return this._isInvalid?"":this._isRelative?"/"+this._path.join("/"):this._schemeData},set pathname(c){if(!this._isInvalid&&
this._isRelative){this._path=[];j.call(this,c,"relative path start")}},get search(){return this._isInvalid||!this._query||this._query==="?"?"":this._query},set search(c){if(!this._isInvalid&&this._isRelative){this._query="?";c[0]==="?"&&(c=c.slice(1));j.call(this,c,"query")}},get hash(){return this._isInvalid||!this._fragment||this._fragment==="#"?"":this._fragment},set hash(c){if(!this._isInvalid){this._fragment="#";c[0]==="#"&&(c=c.slice(1));j.call(this,c,"fragment")}},get origin(){var c;if(this._isInvalid||
!this._scheme)return"";switch(this._scheme){case "data":case "file":case "javascript":case "mailto":return"null";case "blob":try{return(new g(this._schemeData)).origin||"null"}catch(a){}return"null"}c=this.host;return!c?"":this._scheme+"://"+c}};var q=k.URL;if(q){g.createObjectURL=function(c){return q.createObjectURL.apply(q,arguments)};g.revokeObjectURL=function(c){q.revokeObjectURL(c)}}k.URL=g}})()}},function(f,d,b){b(65);f.exports=b(5).Object.values},function(f,d,b){var f=b(4),l=b(66)(!1);f(f.S,
"Object",{values:function(b){return l(b)}})},function(f,d,b){var l=b(21),k=b(17),g=b(31).f;f.exports=function(b){return function(a){for(var a=k(a),d=l(a),j=d.length,f=0,v=[],h;j>f;)if(g.call(a,h=d[f++]))v.push(b?[h,a[h]]:a[h]);return v}}},function(f,d,b){var l=b(7),k=b(17),g=b(41)(!1),m=b(30)("IE_PROTO");f.exports=function(a,b){var d=k(a),f=0,v=[],h;for(h in d)h!=m&&l(d,h)&&v.push(h);for(;b.length>f;)if(l(d,h=b[f++]))~g(v,h)||v.push(h);return v}},function(f,d,b){var l=b(29),k=Math.max,g=Math.min;
f.exports=function(b,a){b=l(b);return 0>b?k(b+a,0):g(b,a)}},function(f,d,b){b(70);f.exports=b(5).Array.includes},function(f,d,b){var f=b(4),l=b(41)(!0);f(f.P,"Array",{includes:function(b){return l(this,b,1<arguments.length?arguments[1]:void 0)}});b(44)("includes")},function(f,d,b){b(72);f.exports=b(5).Math.log2},function(f,d,b){f=b(4);f(f.S,"Math",{log2:function(b){return Math.log(b)/Math.LN2}})},function(f,d,b){b(74);f.exports=b(5).Number.isNaN},function(f,d,b){f=b(4);f(f.S,"Number",{isNaN:function(b){return b!=
b}})},function(f,d,b){b(76);f.exports=b(5).Number.isInteger},function(f,d,b){f=b(4);f(f.S,"Number",{isInteger:b(77)})},function(f,d,b){var l=b(1),k=Math.floor;f.exports=function(b){return!l(b)&&isFinite(b)&&k(b)===b}},function(f,d,b){b(45);b(79);b(49);b(87);b(94);b(95);f.exports=b(5).Promise},function(f,d,b){var l=b(80)(!0);b(46)(String,"String",function(b){this._t=""+b;this._i=0},function(){var b=this._t,d=this._i;if(d>=b.length)return{value:void 0,done:!0};b=l(b,d);this._i+=b.length;return{value:b,
done:!1}})},function(f,d,b){var l=b(29),k=b(27);f.exports=function(b){return function(d,a){var f=""+k(d),j=l(a),q=f.length,v,h;if(0>j||j>=q)return b?"":void 0;v=f.charCodeAt(j);return 55296>v||56319<v||j+1===q||56320>(h=f.charCodeAt(j+1))||57343<h?b?f.charAt(j):v:b?f.slice(j,j+2):(v-55296<<10)+(h-56320)+65536}}},function(f,d,b){var l=b(82),k=b(25),g=b(22),m={};b(11)(m,b(2)("iterator"),function(){return this});f.exports=function(a,b,d){a.prototype=l(m,{next:k(1,d)});g(a,b+" Iterator")}},function(f,
d,b){var l=b(6),k=b(83),g=b(43),m=b(30)("IE_PROTO"),a=function(){},r=function(){var a=b(24)("iframe"),d=g.length;a.style.display="none";b(48).appendChild(a);a.src="javascript:";a=a.contentWindow.document;a.open();a.write("<script>document.F=Object<\/script>");a.close();for(r=a.F;d--;)delete r.prototype[g[d]];return r()};f.exports=Object.create||function(b,d){var g;null!==b?(a.prototype=l(b),g=new a,a.prototype=null,g[m]=b):g=r();return void 0===d?g:k(g,d)}},function(f,d,b){var l=b(15),k=b(6),g=b(21);
f.exports=b(12)?Object.defineProperties:function(b,a){k(b);for(var d=g(a),j=d.length,f=0,v;j>f;)l.f(b,v=d[f++],a[v]);return b}},function(f,d,b){var l=b(7),k=b(33),g=b(30)("IE_PROTO"),m=Object.prototype;f.exports=Object.getPrototypeOf||function(a){a=k(a);return l(a,g)?a[g]:"function"==typeof a.constructor&&a instanceof a.constructor?a.constructor.prototype:a instanceof Object?m:null}},function(f,d,b){var d=b(44),l=b(86),k=b(19),g=b(17);f.exports=b(46)(Array,"Array",function(b,a){this._t=g(b);this._i=
0;this._k=a},function(){var b=this._t,a=this._k,d=this._i++;return!b||d>=b.length?(this._t=void 0,l(1)):"keys"==a?l(0,d):"values"==a?l(0,b[d]):l(0,[d,b[d]])},"values");k.Arguments=k.Array;d("keys");d("values");d("entries")},function(f){f.exports=function(d,b){return{value:b,done:!!d}}},function(f,d,b){var l=b(47),k=b(3),g=b(9),m=b(32),f=b(4),a=b(1),r=b(16),j=b(34),q=b(23),v=b(50),h=b(51).set,t=b(92)(),d=b(35),o=b(52),u=b(53),i=k.TypeError,p=k.process,A=k.Promise,c="process"==m(p),e=function(){},y,
w,C,s,z=w=d.f,m=!!function(){try{var a=A.resolve(1),d=(a.constructor={})[b(2)("species")]=function(c){c(e,e)};return(c||"function"==typeof PromiseRejectionEvent)&&a.then(e)instanceof d}catch(h){}}(),F=function(c){var b;return a(c)&&"function"==typeof(b=c.then)?b:!1},I=function(c,a){if(!c._n){c._n=!0;var b=c._c;t(function(){for(var d=c._v,e=1==c._s,h=0;b.length>h;){var g=b[h++],j=e?g.ok:g.fail,k=g.resolve,s=g.reject,m=g.domain,f=void 0,z=void 0;try{j?(e||(2==c._h&&H(c),c._h=1),!0===j?f=d:(m&&m.enter(),
f=j(d),m&&m.exit()),f===g.promise?s(i("Promise-chain cycle")):(z=F(f))?z.call(f,k,s):k(f)):s(d)}catch(l){s(l)}}c._c=[];c._n=!1;a&&!c._h&&K(c)})}},K=function(a){h.call(k,function(){var b=a._v,d=E(a),e,h,i;d&&(e=o(function(){c?p.emit("unhandledRejection",b,a):(h=k.onunhandledrejection)?h({promise:a,reason:b}):(i=k.console)&&i.error&&i.error("Unhandled promise rejection",b)}),a._h=c||E(a)?2:1);a._a=void 0;if(d&&e.e)throw e.v;})},E=function M(c){if(1==c._h)return!1;for(var c=c._a||c._c,a=0,b;c.length>
a;)if(b=c[a++],b.fail||!M(b.promise))return!1;return!0},H=function(a){h.call(k,function(){var b;c?p.emit("rejectionHandled",a):(b=k.onrejectionhandled)&&b({promise:a,reason:a._v})})},L=function(c){var a=this;a._d||(a._d=!0,a=a._w||a,a._v=c,a._s=2,a._a||(a._a=a._c.slice()),I(a,!0))},N=function n(c){var a=this,b;if(!a._d){a._d=!0;a=a._w||a;try{if(a===c)throw i("Promise can't be resolved itself");(b=F(c))?t(function(){var d={_w:a,_d:!1};try{b.call(c,g(n,d,1),g(L,d,1))}catch(e){L.call(d,e)}}):(a._v=c,
a._s=1,I(a,!1))}catch(d){L.call({_w:a,_d:!1},d)}}};m||(A=function(c){j(this,A,"Promise","_h");r(c);y.call(this);try{c(g(N,this,1),g(L,this,1))}catch(a){L.call(this,a)}},y=function(){this._c=[];this._a=void 0;this._s=0;this._d=!1;this._v=void 0;this._h=0;this._n=!1},y.prototype=b(36)(A.prototype,{then:function(a,b){var d=z(v(this,A));d.ok="function"==typeof a?a:!0;d.fail="function"==typeof b&&b;d.domain=c?p.domain:void 0;this._c.push(d);this._a&&this._a.push(d);this._s&&I(this,!1);return d.promise},
"catch":function(c){return this.then(void 0,c)}}),C=function(){var c=new y;this.promise=c;this.resolve=g(N,c,1);this.reject=g(L,c,1)},d.f=z=function(c){return c===A||c===s?new C(c):w(c)});f(f.G+f.W+f.F*!m,{Promise:A});b(22)(A,"Promise");b(93)("Promise");s=b(5).Promise;f(f.S+f.F*!m,"Promise",{reject:function(c){var a=z(this),b=a.reject;b(c);return a.promise}});f(f.S+f.F*(l||!m),"Promise",{resolve:function(c){return u(l&&this===s?A:this,c)}});f(f.S+f.F*!(m&&b(54)(function(c){A.all(c)["catch"](e)})),
"Promise",{all:function(c){var a=this,b=z(a),d=b.resolve,e=b.reject,h=o(function(){var b=[],h=0,i=1;q(c,false,function(c){var g=h++,j=false;b.push(void 0);i++;a.resolve(c).then(function(c){if(!j){j=true;b[g]=c;--i||d(b)}},e)});--i||d(b)});h.e&&e(h.v);return b.promise},race:function(c){var a=this,b=z(a),d=b.reject,e=o(function(){q(c,false,function(c){a.resolve(c).then(b.resolve,d)})});e.e&&d(e.v);return b.promise}})},function(f,d,b){var l=b(6);f.exports=function(b,d,m,a){try{return a?d(l(m)[0],m[1]):
...
else if(g){var t=!0,o=document.createTextNode("");(new g(h)).observe(o,{characterData:!0});f=function(){o.data=t=!t}}else if(a&&a.resolve){var u=a.resolve();f=function(){u.then(h)}}else f=function(){k.call(l,h)};return function(a){a={fn:a,next:void 0};d&&(d.next=a);b||(b=a,f());d=a}}},function(f,d,b){var l=b(3),k=b(15),g=b(12),m=b(2)("species");f.exports=function(a){a=l[a];g&&(a&&!a[m])&&k.f(a,m,{configurable:!0,get:function(){return this}})}},function(f,d,b){var f=b(4),l=b(5),k=b(3),g=b(50),m=b(53);
f(f.P+f.R,"Promise",{"finally":function(a){var b=g(this,l.Promise||k.Promise),d="function"==typeof a;return this.then(d?function(d){return m(b,a()).then(function(){return d})}:a,d?function(d){return m(b,a()).then(function(){throw d;})}:a)}})},function(f,d,b){var f=b(4),l=b(35),k=b(52);f(f.S,"Promise",{"try":function(b){var d=l.f(this),b=k(b);(b.e?d.reject:d.resolve)(b.v);return d.promise}})},function(f,d,b){b(45);b(49);b(97);b(108);b(110);f.exports=b(5).WeakMap},function(f,d,b){var d=b(55)(0),l=b(8),
k=b(37),g=b(101),m=b(103),a=b(1),r=b(13),j=b(56),q=k.getWeak,v=Object.isExtensible,h=m.ufstore,t={},o,u=function(a){return function(){return a(this,0<arguments.length?arguments[0]:void 0)}},i={get:function(b){if(a(b)){var c=q(b);return!0===c?h(j(this,"WeakMap")).get(b):c?c[this._i]:void 0}},set:function(a,c){return m.def(j(this,"WeakMap"),a,c)}},p=f.exports=b(104)("WeakMap",u,i,m,!0,!0);r(function(){return 7!=(new p).set((Object.freeze||Object)(t),7).get(t)})&&(o=m.getConstructor(u,"WeakMap"),g(o.prototype,
i),k.NEED=!0,d(["delete","has","get","set"],function(b){var c=p.prototype,d=c[b];l(c,b,function(c,h){if(a(c)&&!v(c)){this._f||(this._f=new o);var i=this._f[b](c,h);return"set"==b?this:i}return d.call(this,c,h)})}))},function(f,d,b){var l=b(99);f.exports=function(b,d){return new (l(b))(d)}},function(f,d,b){var l=b(1),k=b(100),g=b(2)("species");f.exports=function(b){var a;if(k(b)){a=b.constructor;if("function"==typeof a&&(a===Array||k(a.prototype)))a=void 0;l(a)&&(a=a[g],null===a&&(a=void 0))}return void 0===
a?Array:a}},function(f,d,b){var l=b(18);f.exports=Array.isArray||function(b){return"Array"==l(b)}},function(f,d,b){var l=b(21),k=b(102),g=b(31),m=b(33),a=b(26),r=Object.assign;f.exports=!r||b(13)(function(){var a={},b={},d=Symbol();a[d]=7;"abcdefghijklmnopqrst".split("").forEach(function(a){b[a]=a});return 7!=r({},a)[d]||"abcdefghijklmnopqrst"!=Object.keys(r({},b)).join("")})?function(b,d){for(var f=m(b),h=arguments.length,t=1,o=k.f,r=g.f;h>t;)for(var i=a(arguments[t++]),p=o?l(i).concat(o(i)):l(i),
A=p.length,c=0,e;A>c;)if(r.call(i,e=p[c++]))f[e]=i[e];return f}:r},function(f,d){d.f=Object.getOwnPropertySymbols},function(f,d,b){var l=b(36),k=b(37).getWeak,g=b(6),m=b(1),a=b(34),r=b(23),d=b(55),j=b(7),q=b(56),v=d(5),h=d(6),t=0,o=function(a){return a._l||(a._l=new u)},u=function(){this.a=[]},i=function(a,b){return v(a.a,function(c){return c[0]===b})};u.prototype={get:function(a){if(a=i(this,a))return a[1]},has:function(a){return!!i(this,a)},set:function(a,b){var c=i(this,a);c?c[1]=b:this.a.push([a,
b])},"delete":function(a){var b=h(this.a,function(c){return c[0]===a});~b&&this.a.splice(b,1);return!!~b}};f.exports={getConstructor:function(b,d,c,e){var h=b(function(b,i){a(b,h,d,"_i");b._t=d;b._i=t++;b._l=void 0;void 0!=i&&r(i,c,b[e],b)});l(h.prototype,{"delete":function(c){if(!m(c))return!1;var a=k(c);return!0===a?o(q(this,d))["delete"](c):a&&j(a,this._i)&&delete a[this._i]},has:function(c){if(!m(c))return!1;var a=k(c);return!0===a?o(q(this,d)).has(c):a&&j(a,this._i)}});return h},def:function(a,
b,c){var d=k(g(b),!0);!0===d?o(a).set(b,c):d[a._i]=c;return a},ufstore:o}},function(f,d,b){var l=b(3),k=b(4),g=b(8),m=b(36),a=b(37),r=b(23),j=b(34),q=b(1),v=b(13),h=b(54),t=b(22),o=b(105);f.exports=function(b,d,f,A,c,e){var y=l[b],w=y,C=c?"set":"add",s=w&&w.prototype,z={},F=function(c){var a=s[c];g(s,c,"delete"==c?function(c){return e&&!q(c)?!1:a.call(this,0===c?0:c)}:"has"==c?function(c){return e&&!q(c)?!1:a.call(this,0===c?0:c)}:"get"==c?function(c){return e&&!q(c)?void 0:a.call(this,0===c?0:c)}:
"add"==c?function(c){a.call(this,0===c?0:c);return this}:function(c,b){a.call(this,0===c?0:c,b);return this})};if("function"!=typeof w||!(e||s.forEach&&!v(function(){(new w).entries().next()})))w=A.getConstructor(d,b,c,C),m(w.prototype,f),a.NEED=!0;else{var I=new w,f=I[C](e?{}:-0.0,1)!=I,K=v(function(){I.has(1)}),E=h(function(c){new w(c)}),H=!e&&v(function(){for(var c=new w,a=5;a--;)c[C](a,a);return!c.has(-0.0)});E||(w=d(function(a,d){j(a,w,b);var e=o(new y,a,w);void 0!=d&&r(d,c,e[C],e);return e}),
w.prototype=s,s.constructor=w);if(K||H)F("delete"),F("has"),c&&F("get");(H||f)&&F(C);e&&s.clear&&delete s.clear}t(w,b);z[b]=w;k(k.G+k.W+k.F*(w!=y),z);e||A.setStrong(w,b,c);return w}},function(f,d,b){var l=b(1),k=b(106).set;f.exports=function(b,d,a){var d=d.constructor,f;d!==a&&("function"==typeof d&&(f=d.prototype)!==a.prototype&&l(f)&&k)&&k(b,f);return b}},function(f,d,b){var l=b(1),k=b(6),g=function(b,a){k(b);if(!l(a)&&null!==a)throw TypeError(a+": can't set as prototype!");};f.exports={set:Object.setPrototypeOf||
("__proto__"in{}?function(d,a,k){try{k=b(9)(Function.call,b(107).f(Object.prototype,"__proto__").set,2),k(d,[]),a=!(d instanceof Array)}catch(j){a=!0}return function(b,d){g(b,d);a?b.__proto__=d:k(b,d);return b}}({},!1):void 0),check:g}},function(f,d,b){var l=b(31),k=b(25),g=b(17),m=b(40),a=b(7),r=b(39),j=Object.getOwnPropertyDescriptor;d.f=b(12)?j:function(b,d){b=g(b);d=m(d,!0);if(r)try{return j(b,d)}catch(h){}if(a(b,d))return k(!l.f.call(b,d),b[d])}},function(f,d,b){b(109)("WeakMap")},function(f,
d,b){var l=b(4);f.exports=function(b){l(l.S,b,{of:function(){for(var b=arguments.length,d=Array(b);b--;)d[b]=arguments[b];return new this(d)}})}},function(f,d,b){b(111)("WeakMap")},function(f,d,b){var l=b(4),k=b(16),g=b(9),m=b(23);f.exports=function(a){l(l.S,a,{from:function(a,b,d){var f,h,l,o;k(this);(f=void 0!==b)&&k(b);if(void 0==a)return new this;h=[];f?(l=0,o=g(b,d,2),m(a,!1,function(a){h.push(o(a,l++))})):m(a,!1,h.push,h);return new this(h)}})}},function(f,d,b){f=!1;if("undefined"!==typeof ReadableStream)try{new ReadableStream({start:function(b){b.close()}}),
f=!0}catch(l){}d.ReadableStream=f?ReadableStream:b(113).ReadableStream},function(f,d){var b="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(b){return typeof b}:function(b){return b&&"function"===typeof Symbol&&b.constructor===Symbol&&b!==Symbol.prototype?"symbol":typeof b};(function(b,d){for(var g in d)b[g]=d[g]})(d,function(b){function d(f){if(g[f])return g[f].exports;var a=g[f]={i:f,l:!1,exports:{}};b[f].call(a.exports,a,a.exports,d);a.l=!0;return a.exports}var g={};d.m=b;
...
var e=!1;"erroring"===b&&(e=!0,c=void 0);b=new Promise(function(b,d){a._pendingAbortRequest={_resolve:b,_reject:d,_reason:c,_wasAlreadyErroring:e}});!1===e&&t(a,d);return b}function v(a){D(!0===j(a));D("writable"===a._state);return new Promise(function(c,b){a._writeRequests.push({_resolve:c,_reject:b})})}function h(a,c){var b=a._state;"writable"===b?t(a,c):(D("erroring"===b),o(a))}function t(a,c){D(void 0===a._storedError,"stream._storedError === undefined");D("writable"===a._state,"state must be writable");
var b=a._writableStreamController;D(void 0!==b,"controller must not be undefined");a._state="erroring";a._storedError=c;var d=a._writer;void 0!==d&&s(d,c);!1===i(a)&&!0===b._started&&o(a)}function o(a){D("erroring"===a._state,"stream._state === erroring");D(!1===i(a),"WritableStreamHasOperationMarkedInFlight(stream) === false");a._state="errored";a._writableStreamController.__errorSteps();for(var b=a._storedError,d=0;d<a._writeRequests.length;d++)a._writeRequests[d]._reject(b);a._writeRequests=[];
if(void 0===a._pendingAbortRequest)c(a);else{var e=a._pendingAbortRequest;a._pendingAbortRequest=void 0;!0===e._wasAlreadyErroring?(e._reject(b),c(a)):a._writableStreamController.__abortSteps(e._reason).then(function(){e._resolve();c(a)},function(b){e._reject(b);c(a)})}}function u(a){return void 0===a._closeRequest&&void 0===a._inFlightCloseRequest?!1:!0}function i(a){return void 0===a._inFlightWriteRequest&&void 0===a._inFlightCloseRequest?!1:!0}function p(a){D(void 0===a._inFlightCloseRequest);
D(void 0!==a._closeRequest);a._inFlightCloseRequest=a._closeRequest;a._closeRequest=void 0}function A(a){D(void 0===a._inFlightWriteRequest,"there must be no pending write request");D(0!==a._writeRequests.length,"writeRequests must not be empty");a._inFlightWriteRequest=a._writeRequests.shift()}function c(a){D("errored"===a._state,'_stream_.[[state]] is `"errored"`');void 0!==a._closeRequest&&(D(void 0===a._inFlightCloseRequest),a._closeRequest._reject(a._storedError),a._closeRequest=void 0);var c=
a._writer;void 0!==c&&(J(c,a._storedError),c._closedPromise.catch(function(){}))}function e(a,c){D("writable"===a._state);D(!1===u(a));var b=a._writer;void 0!==b&&c!==a._backpressure&&(!0===c?ia(b):(D(!1===c),U(b)));a._backpressure=c}function y(a){return!S(a)||!Object.prototype.hasOwnProperty.call(a,"_ownerWritableStream")?!1:!0}function w(a){var c=a._ownerWritableStream;D(void 0!==c);var b=c._state;if("closed"===b||"errored"===b)return Promise.reject(new TypeError("The stream (in "+b+" state) is not in the writable state and cannot be closed"));
D("writable"===b||"erroring"===b);D(!1===u(c));var d=new Promise(function(a,b){c._closeRequest={_resolve:a,_reject:b}});!0===c._backpressure&&"writable"===b&&U(a);I(c._writableStreamController);return d}function C(a,c){"pending"===a._closedPromiseState?J(a,c):x(a,c);a._closedPromise.catch(function(){})}function s(a,c){"pending"===a._readyPromiseState?ha(a,c):ja(a,c);a._readyPromise.catch(function(){})}function z(a){var c=a._ownerWritableStream;D(void 0!==c);D(c._writer===a);var b=new TypeError("Writer was released and can no longer be used to monitor the stream's closedness");
s(a,b);C(a,b);c._writer=void 0;a._ownerWritableStream=void 0}function F(a,c){var b=a._ownerWritableStream;D(void 0!==b);var d=b._writableStreamController,h;var i=d._strategySize;if(void 0===i)h=1;else try{h=i(c)}catch(g){"writable"===d._controlledWritableStream._state&&L(d,g),h=1}if(b!==a._ownerWritableStream)return Promise.reject(M("write to"));i=b._state;if("errored"===i)return Promise.reject(b._storedError);if(!0===u(b)||"closed"===i)return Promise.reject(new TypeError("The stream is closing or closed and cannot be written to"));
if("erroring"===i)return Promise.reject(b._storedError);D("writable"===i);b=v(b);a:{i={chunk:c};try{Z(d,i,h)}catch(j){"writable"===d._controlledWritableStream._state&&L(d,j);break a}h=d._controlledWritableStream;!1===u(h)&&"writable"===h._state&&e(h,0>=d._strategyHWM-d._queueTotalSize);K(d)}return b}function I(a){Z(a,"close",0);K(a)}function K(a){var c=a._controlledWritableStream;if(!1!==a._started&&void 0===c._inFlightWriteRequest){var b=c._state;"closed"===b||"errored"===b||("erroring"===b?o(c):
...
IsWritableStream:r,IsWritableStreamLocked:j,WritableStream:g,WritableStreamAbort:q,WritableStreamDefaultControllerError:L,WritableStreamDefaultWriterCloseWithErrorPropagation:function(a){var c=a._ownerWritableStream;D(void 0!==c);var b=c._state;if(!0===u(c)||"closed"===b)return Promise.resolve();if("errored"===b)return Promise.reject(c._storedError);D("writable"===b||"erroring"===b);return w(a)},WritableStreamDefaultWriterRelease:z,WritableStreamDefaultWriterWrite:F,WritableStreamCloseQueuedOrInFlight:u};
var pa=function(){function a(c){f(this,a);if(!1===r(c))throw new TypeError("WritableStreamDefaultWriter can only be constructed with a WritableStream instance");if(!0===j(c))throw new TypeError("This stream has already been locked for exclusive writing by another writer");this._ownerWritableStream=c;c._writer=this;var b=c._state;"writable"===b?(!1===u(c)&&!0===c._backpressure?da(this):Y(this),n(this)):"erroring"===b?(ea(this,c._storedError),this._readyPromise.catch(function(){}),n(this)):"closed"===
b?(Y(this),this._closedPromise=Promise.resolve(void 0),this._closedPromise_reject=this._closedPromise_resolve=void 0,this._closedPromiseState="resolved"):(D("errored"===b,"state must be errored"),c=c._storedError,ea(this,c),this._readyPromise.catch(function(){}),this._closedPromise=Promise.reject(c),this._closedPromise_reject=this._closedPromise_resolve=void 0,this._closedPromiseState="rejected",this._closedPromise.catch(function(){}))}T(a,[{key:"abort",value:function(a){if(!1===y(this))return Promise.reject(B("abort"));
if(void 0===this._ownerWritableStream)return Promise.reject(M("abort"));var c=this._ownerWritableStream;D(void 0!==c);return q(c,a)}},{key:"close",value:function(){if(!1===y(this))return Promise.reject(B("close"));var a=this._ownerWritableStream;return void 0===a?Promise.reject(M("close")):!0===u(a)?Promise.reject(new TypeError("cannot close an already-closing stream")):w(this)}},{key:"releaseLock",value:function(){if(!1===y(this))throw B("releaseLock");var a=this._ownerWritableStream;void 0!==a&&
(D(void 0!==a._writer),z(this))}},{key:"write",value:function(a){return!1===y(this)?Promise.reject(B("write")):void 0===this._ownerWritableStream?Promise.reject(M("write to")):F(this,a)}},{key:"closed",get:function(){return!1===y(this)?Promise.reject(B("closed")):this._closedPromise}},{key:"desiredSize",get:function(){if(!1===y(this))throw B("desiredSize");if(void 0===this._ownerWritableStream)throw M("desiredSize");var a;a=this._ownerWritableStream;var c=a._state;a="errored"===c||"erroring"===c?
null:"closed"===c?0:a._writableStreamController._strategyHWM-a._writableStreamController._queueTotalSize;return a}},{key:"ready",get:function(){return!1===y(this)?Promise.reject(B("ready")):this._readyPromise}}]);return a}(),qa=function(){function a(c,b,d,h){f(this,a);if(!1===r(c))throw new TypeError("WritableStreamDefaultController can only be constructed with a WritableStream instance");if(void 0!==c._writableStreamController)throw new TypeError("WritableStreamDefaultController instances can only be created by the WritableStream constructor");
...
(!1===d.canceled1&&L(c,e),!1===d.canceled2&&L(b,e))})}return a}function v(){function a(c){var b=a._stream,d=a._teeState;d.canceled1=!0;d.reason1=c;!0===d.canceled2&&(c=ta([d.reason1,d.reason2]),b=u(b,c),d._resolve(b));return d.promise}return a}function h(){function a(c){var b=a._stream,d=a._teeState;d.canceled2=!0;d.reason2=c;!0===d.canceled1&&(c=ta([d.reason1,d.reason2]),b=u(b,c),d._resolve(b));return d.promise}return a}function t(a){G(!0===y(a._reader));G("readable"===a._state||"closed"===a._state);
return new Promise(function(c,b){a._reader._readIntoRequests.push({_resolve:c,_reject:b})})}function o(a){G(!0===w(a._reader));G("readable"===a._state);return new Promise(function(c,b){a._reader._readRequests.push({_resolve:c,_reject:b})})}function u(a,c){a._disturbed=!0;if("closed"===a._state)return Promise.resolve(void 0);if("errored"===a._state)return Promise.reject(a._storedError);i(a);return a._readableStreamController.__cancelSteps(c).then(function(){})}function i(a){G("readable"===a._state);
...
if(void 0!==d){if(!0===w(d)){for(var e=0;e<d._readRequests.length;e++)d._readRequests[e]._reject(b);d._readRequests=[]}else{G(y(d),"reader must be ReadableStreamBYOBReader");for(e=0;e<d._readIntoRequests.length;e++)d._readIntoRequests[e]._reject(b);d._readIntoRequests=[]}va(d,b);d._closedPromise.catch(function(){})}}function A(a,c,b){a=a._reader;G(0<a._readRequests.length);a._readRequests.shift()._resolve(X(c,b))}function c(a){a=a._reader;return void 0===a||!1===y(a)?!1:!0}function e(a){a=a._reader;
return void 0===a||!1===w(a)?!1:!0}function y(a){return!$(a)||!Object.prototype.hasOwnProperty.call(a,"_readIntoRequests")?!1:!0}function w(a){return!$(a)||!Object.prototype.hasOwnProperty.call(a,"_readRequests")?!1:!0}function C(a,c){a._ownerReadableStream=c;c._reader=a;"readable"===c._state?ma(a):"closed"===c._state?qa(a):(G("errored"===c._state,"state must be errored"),pa(a,c._storedError),a._closedPromise.catch(function(){}))}function s(a,c){var b=a._ownerReadableStream;G(void 0!==b);return u(b,
c)}function z(a){G(void 0!==a._ownerReadableStream);G(a._ownerReadableStream._reader===a);"readable"===a._ownerReadableStream._state?va(a,new TypeError("Reader was released and can no longer be used to monitor the stream's closedness")):ya(a,new TypeError("Reader was released and can no longer be used to monitor the stream's closedness"));a._closedPromise.catch(function(){});a._ownerReadableStream._reader=void 0;a._ownerReadableStream=void 0}function F(a){a=a._ownerReadableStream;G(void 0!==a);a._disturbed=
...
a._pendingPullIntos[0]===b);U(a);b.bytesFilled+=c}function ja(a){G("readable"===a._controlledReadableStream._state);0===a._queueTotalSize&&!0===a._closeRequested?i(a._controlledReadableStream):x(a)}function U(a){void 0!==a._byobRequest&&(a._byobRequest._associatedReadableByteStreamController=void 0,a._byobRequest._view=void 0,a._byobRequest=void 0)}function T(a){for(G(!1===a._closeRequested);0<a._pendingPullIntos.length&&0!==a._queueTotalSize;){var c=a._pendingPullIntos[0];!0===ha(a,c)&&(P(a),da(a._controlledReadableStream,
c))}}function O(a,c){var b=a._controlledReadableStream,d=1;c.constructor!==DataView&&(d=c.constructor.BYTES_PER_ELEMENT);d={buffer:c.buffer,byteOffset:c.byteOffset,byteLength:c.byteLength,bytesFilled:0,elementSize:d,ctor:c.constructor,readerType:"byob"};if(0<a._pendingPullIntos.length)return d.buffer=ga(d.buffer),a._pendingPullIntos.push(d),t(b);if("closed"===b._state)return b=new c.constructor(d.buffer,d.byteOffset,0),Promise.resolve(X(b,!0));if(0<a._queueTotalSize){if(!0===ha(a,d))return b=ea(d),
ja(a),Promise.resolve(X(b,!1));if(!0===a._closeRequested)return b=new TypeError("Insufficient bytes to fill elements in the given buffer"),D(a,b),Promise.reject(b)}d.buffer=ga(d.buffer);a._pendingPullIntos.push(d);b=t(b);x(a);return b}function R(a,b){var d=a._pendingPullIntos[0],e=a._controlledReadableStream;if("closed"===e._state){if(0!==b)throw new TypeError("bytesWritten must be 0 when calling respond() on a closed stream");d.buffer=ga(d.buffer);G(0===d.bytesFilled,"bytesFilled must be 0");d=a._controlledReadableStream;
...
if(!0===Ia(c))return Promise.reject(new TypeError("ReadableStream.prototype.pipeTo cannot be used on a locked WritableStream"));var g=new ra(this),j=Ga(c),f=!1,s=Promise.resolve();return new Promise(function(a,d){function k(){s=Promise.resolve();return!0===f?Promise.resolve():j._readyPromise.then(function(){return F(g).then(function(a){var c=a.value;!0!==a.done&&(s=Ma(j,c).catch(function(){}))})}).then(k)}function m(){var a=s;return s.then(function(){return a!==s?m():void 0})}function o(a,c,b){"errored"===
a._state?b(a._storedError):c.catch(b).catch(V)}function l(a,b,d){function e(){a().then(function(){return t(b,d)},function(a){return t(!0,a)}).catch(V)}!0!==f&&(f=!0,"writable"===c._state&&!1===ua(c)?m().then(e):e())}function n(a,b){!0!==f&&(f=!0,"writable"===c._state&&!1===ua(c)?m().then(function(){return t(a,b)}).catch(V):t(a,b))}function t(c,b){La(j);z(g);c?d(b):a(void 0)}o(b,g._closedPromise,function(a){!1===h?l(function(){return Ja(c,a)},!0,a):n(!0,a)});o(c,j._closedPromise,function(a){!1===i?
l(function(){return u(b,a)},!0,a):n(!0,a)});(function(a,c,b){"closed"===a._state?b():c.then(b).catch(V)})(b,g._closedPromise,function(){!1===e?l(function(){return Ka(j)}):n()});if(!0===ua(c)||"closed"===c._state){var v=new TypeError("the destination writable stream closed before all data could be piped to it");!1===i?l(function(){return u(b,v)},!0,v):n(!0,v)}k().catch(function(a){s=Promise.resolve();V(a)})})}},{key:"tee",value:function(){if(!1===a(this))throw W("tee");var c=j(this,!1);return ta(c)}},
...
if(void 0!==this._ownerReadableStream){if(0<this._readRequests.length)throw new TypeError("Tried to release a reader lock when that reader has pending read() calls un-settled");z(this)}}},{key:"closed",get:function(){return!1===w(this)?Promise.reject(ba("closed")):this._closedPromise}}]);return c}(),Pa=function(){function c(b){f(this,c);if(!a(b))throw new TypeError("ReadableStreamBYOBReader can only be constructed with a ReadableStream instance given a byte source");if(!1===n(b._readableStreamController))throw new TypeError("Cannot construct a ReadableStreamBYOBReader for a stream not constructed with a byte source");
if(r(b))throw new TypeError("This stream has already been locked for exclusive reading by another reader");C(this,b);this._readIntoRequests=[]}aa(c,[{key:"cancel",value:function(a){return!y(this)?Promise.reject(ka("cancel")):void 0===this._ownerReadableStream?Promise.reject(Z("cancel")):s(this,a)}},{key:"read",value:function(a){if(!y(this))return Promise.reject(ka("read"));if(void 0===this._ownerReadableStream)return Promise.reject(Z("read from"));if(!ArrayBuffer.isView(a))return Promise.reject(new TypeError("view must be an array buffer view"));
if(0===a.byteLength)return Promise.reject(new TypeError("view must have non-zero byteLength"));var c=this._ownerReadableStream;G(void 0!==c);c._disturbed=!0;a="errored"===c._state?Promise.reject(c._storedError):O(c._readableStreamController,a);return a}},{key:"releaseLock",value:function(){if(!y(this))throw ka("releaseLock");if(void 0!==this._ownerReadableStream){if(0<this._readIntoRequests.length)throw new TypeError("Tried to release a reader lock when that reader has pending read() calls un-settled");
z(this)}}},{key:"closed",get:function(){return!y(this)?Promise.reject(ka("closed")):this._closedPromise}}]);return c}(),Oa=function(){function c(b,d,e,h){f(this,c);if(!1===a(b))throw new TypeError("ReadableStreamDefaultController can only be constructed with a ReadableStream instance");if(void 0!==b._readableStreamController)throw new TypeError("ReadableStreamDefaultController instances can only be created by the ReadableStream constructor");this._controlledReadableStream=b;this._underlyingSource=
d;this._queueTotalSize=this._queue=void 0;ca(this);this._pulling=this._pullAgain=this._closeRequested=this._started=!1;b=Da(e,h);this._strategySize=b.size;this._strategyHWM=b.highWaterMark;var i=this,d=xa(d,"start",[this]);Promise.resolve(d).then(function(){i._started=!0;G(!1===i._pulling);G(!1===i._pullAgain);K(i)},function(a){B(i,a)}).catch(V)}aa(c,[{key:"close",value:function(){if(!1===I(this))throw la("close");if(!0===this._closeRequested)throw new TypeError("The stream has already been closed; do not close it again!");
...
this._autoAllocateChunkSize=e;this._pendingPullIntos=[];var h=this,d=xa(d,"start",[this]);Promise.resolve(d).then(function(){h._started=!0;G(!1===h._pulling);G(!1===h._pullAgain);x(h)},function(a){"readable"===c._state&&D(h,a)}).catch(V)}aa(b,[{key:"close",value:function(){if(!1===n(this))throw fa("close");if(!0===this._closeRequested)throw new TypeError("The stream has already been closed; do not close it again!");var a=this._controlledReadableStream._state;if("readable"!==a)throw new TypeError("The stream (in "+
...
a._errored)return Promise.reject(a._storedError);!1===a._readableClosed&&r(a);return Promise.resolve()}).catch(function(c){j(a,c);return Promise.reject(a._storedError)})}}]);return a}(),B=function(){function a(c,b){f(this,a);this._transformStream=c;this._startPromise=b}c(a,[{key:"start",value:function(a){var c=this._transformStream;c._readableController=a;return this._startPromise.then(function(){e(void 0!==c._backpressureChangePromise,"_backpressureChangePromise should have been initialized");if(!0===
...
!0;q(a,new TypeError("Readable side canceled"))}}]);return a}(),M=function(){function b(a){f(this,b);if(!1===i(a))throw new TypeError("TransformStreamDefaultController can only be constructed with a TransformStream instance");if(void 0!==a._transformStreamController)throw new TypeError("TransformStreamDefaultController instances can only be created by the TransformStream constructor");this._controlledTransformStream=a}c(b,[{key:"enqueue",value:function(c){if(!1===u(this))throw p("enqueue");a(this._controlledTransformStream,
c)}},{key:"close",value:function(){if(!1===u(this))throw p("close");var a=this._controlledTransformStream;if(!0===a._errored)throw new TypeError("TransformStream is already errored");if(!0===a._readableClosed)throw new TypeError("Readable side is already closed");r(a)}},{key:"error",value:function(a){if(!1===u(this))throw p("error");var c=this._controlledTransformStream;if(!0===c._errored)throw new TypeError("TransformStream is already errored");q(c,a)}},{key:"desiredSize",get:function(){if(!1===
u(this))throw p("desiredSize");return E(this._controlledTransformStream._readableController)}}]);return b}(),g=function(){function a(){var c=0<arguments.length&&void 0!==arguments[0]?arguments[0]:{};f(this,a);this._transformer=c;var b=c.readableStrategy,d=c.writableStrategy;this._errored=this._transforming=!1;this._transformStreamController=this._readableController=this._writableController=this._storedError=void 0;this._readableClosed=this._writableDone=!1;this._backpressureChangePromise_resolve=
this._backpressureChangePromise=this._backpressure=void 0;this._transformStreamController=new M(this);var i=void 0,g=new Promise(function(a){i=a}),j=new B(this,g);this._readable=new z(j,b);b=new N(this,g);this._writable=new H(b,d);e(void 0!==this._writableController);e(void 0!==this._readableController);d=E(this._readableController);h(this,0>=d);var s=this,c=y(c,"start",[s._transformStreamController]);i(c);g.catch(function(a){!1===s._errored&&(s._errored=!0,s._storedError=a)})}c(a,[{key:"readable",
get:function(){if(!1===i(this))throw A("readable");return this._readable}},{key:"writable",get:function(){if(!1===i(this))throw A("writable");return this._writable}}]);return a}();b.exports={TransformStream:g}},function(b,d,g){b.exports=g(5)}]))},function(f,d,b){Object.defineProperty(d,"__esModule",{value:!0});d.PDFJS=d.globalScope=void 0;var f=b(10),l=b(0),k=b(57),g=b(59),m=b(14),m=m&&m.__esModule?m:{"default":m},a=b(58),r=b(60),b=b(61);m.default.PDFJS||(m.default.PDFJS={});var j=m.default.PDFJS;
j.version="2.0.207";j.build="546cd2b6";j.pdfBug=!1;void 0!==j.verbosity&&(0,l.setVerbosityLevel)(j.verbosity);delete j.verbosity;Object.defineProperty(j,"verbosity",{get:function(){return(0,l.getVerbosityLevel)()},set:function(a){(0,l.setVerbosityLevel)(a)},enumerable:!0,configurable:!0});j.VERBOSITY_LEVELS=l.VERBOSITY_LEVELS;j.OPS=l.OPS;j.UNSUPPORTED_FEATURES=l.UNSUPPORTED_FEATURES;j.isValidUrl=f.isValidUrl;j.shadow=l.shadow;j.createBlob=l.createBlob;j.createObjectURL=function(a,b){return(0,l.createObjectURL)(a,
...
configurable:!0});l.prototype.addNativeFontFace=function(b){this.nativeFontFaces.push(b);document.fonts.add(b)};l.prototype.bind=function(b,a){for(var d=[],g=[],f=[],v=function(a){return a.loaded.catch(function(c){(0,k.warn)('Failed to load font "'+a.family+'": '+c)})},h=l.isFontLoadingAPISupported&&!l.isSyncFontLoadingSupported,t=0,o=b.length;t<o;t++){var u=b[t];if(!(u.attached||!1===u.loading))if(u.attached=!0,h){if(u=u.createNativeFontFace())this.addNativeFontFace(u),f.push(v(u))}else{var i=u.createFontFaceRule();
i&&(this.insertRule(i),d.push(i),g.push(u))}}var p=this.queueLoadingCallback(a);h?Promise.all(f).then(function(){p.complete()}):0<d.length&&!l.isSyncFontLoadingSupported?this.prepareFontLoadEvent(d,g,p):p.complete()};l.prototype.queueLoadingCallback=function(b){var a=this.loadingContext,d={id:"pdfjs-font-loading-"+a.nextRequestId++,complete:function(){(0,k.assert)(!d.end,"completeRequest() cannot be called twice");for(d.end=Date.now();0<a.requests.length&&a.requests[0].end;){var b=a.requests.shift();
setTimeout(b.callback,0)}},callback:b,started:Date.now()};a.requests.push(d);return d};l.prototype.prepareFontLoadEvent=function(b,a,d){function g(a,b){return a.charCodeAt(b)<<24|a.charCodeAt(b+1)<<16|a.charCodeAt(b+2)<<8|a.charCodeAt(b+3)&255}function f(a,b,d,h){var i=a.substr(0,b),a=a.substr(b+d);return i+h+a}function l(a,b){u++;30<u?((0,k.warn)("Load test font never loaded."),b()):(o.font="30px "+a,o.fillText(".",0,20),0<o.getImageData(0,0,1,1).data[3]?b():setTimeout(l.bind(null,a,b)))}var h,t,
b=document.createElement("canvas");b.width=1;b.height=1;var o=b.getContext("2d"),u=0,b="lt"+Date.now()+this.loadTestFontId++,i=this.loadTestFont,i=f(i,976,b.length,b),p=g(i,16);h=0;for(t=b.length-3;h<t;h+=4)p=p-1482184792+g(b,h)|0;h<b.length&&(p=p-1482184792+g(b+"XXX",h)|0);i=f(i,16,4,(0,k.string32)(p));h="url(data:font/opentype;base64,"+btoa(i)+");";this.insertRule('@font-face { font-family:"'+b+'";src:'+h+"}");i=[];h=0;for(t=a.length;h<t;h++)i.push(a[h].loadedName);i.push(b);var A=document.createElement("div");
A.setAttribute("style","visibility: hidden;width: 10px; height: 10px;position: absolute; top: 0px; left: 0px;");h=0;for(t=i.length;h<t;++h)a=document.createElement("span"),a.textContent="Hi",a.style.fontFamily=i[h],A.appendChild(a);document.body.appendChild(A);l(b,function(){document.body.removeChild(A);d.complete()})};l.isFontLoadingAPISupported="undefined"!==typeof document&&!!document.fonts;Object.defineProperty(l,"isSyncFontLoadingSupported",{get:function(){var b=(0,k.shadow),a;if("undefined"===
...
i;l[m-c]!==l[m]&&(j[f]=l[m]?1:8,++e);r=(l[m]?4:0)+(l[m-c]?8:0);for(g=1;g<b;g++)r=(r>>2)+(l[m+1]?4:0)+(l[m-c+1]?8:0),k[r]&&(j[f+g]=k[r],++e),m++;l[m-c]!==l[m]&&(j[f+g]=l[m]?2:4,++e);if(1E3<e)return null}m=c*(d-1);f=a*i;0!==l[m]&&(j[f]=8,++e);for(g=1;g<b;g++)l[m]!==l[m+1]&&(j[f+g]=l[m]?4:8,++e),m++;0!==l[m]&&(j[f+g]=4,++e);if(1E3<e)return null;for(var k=new Int32Array([0,i,-1,0,-i,0,0,0,1]),s=[],a=0;e&&a<=d;a++){c=a*i;for(l=c+b;c<l&&!j[c];)c++;if(c!==l){l=[c%i,a];m=j[c];g=c;do{f=k[m];do c+=f;while(!j[c]);
f=j[c];5!==f&&10!==f?(m=f,j[c]=0):(m=f&51*m>>4,j[c]&=m>>2|m<<2);l.push(c%i);l.push(c/i|0);--e}while(g!==c);s.push(l);--a}}return function(a){a.save();a.scale(1/b,-1/d);a.translate(0,-d);a.beginPath();for(var c=0,e=s.length;c<e;c++){var g=s[c];a.moveTo(g[0],g[1]);for(var i=2,f=g.length;i<f;i=i+2)a.lineTo(g[i],g[i+1])}a.fill();a.beginPath();a.restore()}}Object.defineProperty(d,"__esModule",{value:!0});d.CanvasGraphics=void 0;var g=b(0),m=b(117),a=16,r={get value(){return(0,g.shadow)(r,"value",(0,g.isLittleEndian)())}},
...
this.cachedGetSinglePixelWidth=null}function d(c,b){if("undefined"!==typeof ImageData&&b instanceof ImageData)c.putImageData(b,0,0);else{var e=b.height,h=b.width,i=e%a,e=(e-i)/a,f=0===i?e:e+1,j=c.createImageData(h,a),k=0,l,m=b.data,o=j.data,t,q,v;if(b.kind===g.ImageKind.GRAYSCALE_1BPP){var u=m.byteLength,o=new Uint32Array(o.buffer,0,o.byteLength>>2),p=o.length,y=h+7>>3,w=r.value?4278190080:255;for(t=0;t<f;t++){v=t<e?a:i;for(q=l=0;q<v;q++){for(var A=u-k,C=0,A=A>y?h:8*A-7,U=A&-8,T=0,O=0;C<U;C+=8)O=
m[k++],o[l++]=O&128?4294967295:w,o[l++]=O&64?4294967295:w,o[l++]=O&32?4294967295:w,o[l++]=O&16?4294967295:w,o[l++]=O&8?4294967295:w,o[l++]=O&4?4294967295:w,o[l++]=O&2?4294967295:w,o[l++]=O&1?4294967295:w;for(;C<A;C++)0===T&&(O=m[k++],T=128),o[l++]=O&T?4294967295:w,T>>=1}for(;l<p;)o[l++]=0;c.putImageData(j,0,t*a)}}else if(b.kind===g.ImageKind.RGBA_32BPP){q=0;v=4*h*a;for(t=0;t<e;t++)o.set(m.subarray(k,k+v)),k+=v,c.putImageData(j,0,q),q+=a;t<f&&(o.set(m.subarray(k,k+4*h*i)),c.putImageData(j,0,q))}else if(b.kind===
g.ImageKind.RGB_24BPP){v=a;v*=h;for(t=0;t<f;t++){t>=e&&(v=i,v*=h);l=0;for(q=v;q--;)o[l++]=m[k++],o[l++]=m[k++],o[l++]=m[k++],o[l++]=255;c.putImageData(j,0,t*a)}}else throw Error("bad image kind: "+b.kind);}}function f(c,b){for(var d=b.height,e=b.width,h=d%a,d=(d-h)/a,g=0===h?d:d+1,i=c.createImageData(e,a),j=0,k=b.data,l=i.data,m=0;m<g;m++){for(var o=m<d?a:h,t=3,r=0;r<o;r++)for(var q=0,v=0;v<e;v++){if(!q)var u=k[j++],q=128;l[t]=u&q?0:255;t+=4;q>>=1}c.putImageData(i,0,m*a)}}function o(a,c){for(var b=
"strokeStyle fillStyle fillRule globalAlpha lineWidth lineCap lineJoin miterLimit globalCompositeOperation font".split(" "),d=0,e=b.length;d<e;d++){var h=b[d];void 0!==a[h]&&(c[h]=a[h])}void 0!==a.setLineDash&&(c.setLineDash(a.getLineDash()),c.lineDashOffset=a.lineDashOffset)}function u(a){a.strokeStyle="#000000";a.fillStyle="#000000";a.fillRule="nonzero";a.globalAlpha=1;a.lineWidth=1;a.lineCap="butt";a.lineJoin="miter";a.miterLimit=10;a.globalCompositeOperation="source-over";a.font="10px sans-serif";
void 0!==a.setLineDash&&(a.setLineDash([]),a.lineDashOffset=0)}function i(a,c,b){for(var d=a.length,e=1/255,h=3;h<d;h+=4)c[h]=c[h]*(b?b[a[h]]:a[h])*e|0}function p(a,c,b){for(var d=a.length,e=3;e<d;e+=4){var h=77*a[e-3]+152*a[e-2]+28*a[e-1];c[e]=b?c[e]*b[h>>8]>>8:c[e]*h>>16}}function A(a,c,b,d){var e=c.canvas,h=c.context;a.setTransform(c.scaleX,0,0,c.scaleY,c.offsetX,c.offsetY);var g=c.backdrop||null;if(!c.transferMap&&d.isEnabled)b=d.composeSMask({layer:b.canvas,mask:e,properties:{subtype:c.subtype,
backdrop:g}}),a.setTransform(1,0,0,1,0,0),a.drawImage(b,c.offsetX,c.offsetY);else{for(var d=e.width,f=e.height,j=c.transferMap,k=!!g,l=k?g[0]:0,m=k?g[1]:0,g=k?g[2]:0,c="Luminosity"===c.subtype?p:i,o=Math.min(f,Math.ceil(1048576/d)),t=0;t<f;t+=o){var q=Math.min(o,f-t),r=h.getImageData(0,t,d,q),q=b.getImageData(0,t,d,q);if(k)for(var v=r.data,u=l,w=m,y=g,A=v.length,C=3;C<A;C+=4){var O=v[C];if(0===O)v[C-3]=u,v[C-2]=w,v[C-1]=y;else if(255>O){var R=255-O;v[C-3]=v[C-3]*O+u*R>>8;v[C-2]=v[C-2]*O+w*R>>8;v[C-
1]=v[C-1]*O+y*R>>8}}c(r.data,q.data,j);h.putImageData(q,0,t)}a.drawImage(e,0,0)}}var c=["butt","round","square"],e=["miter","round","bevel"],y={},w={};b.prototype={beginDrawing:function(a){var c=a.transform,b=a.viewport,d=a.transparency,a=a.background,a=void 0===a?null:a,e=this.ctx.canvas.width,h=this.ctx.canvas.height;this.ctx.save();this.ctx.fillStyle=a||"rgb(255, 255, 255)";this.ctx.fillRect(0,0,e,h);this.ctx.restore();d&&(d=this.cachedCanvases.getCanvas("transparent",e,h,!0),this.compositeCtx=
this.ctx,this.transparentCanvas=d.canvas,this.ctx=d.context,this.ctx.save(),this.ctx.transform.apply(this.ctx,this.compositeCtx.mozCurrentTransform));this.ctx.save();u(this.ctx);c&&this.ctx.transform.apply(this.ctx,c);this.ctx.transform.apply(this.ctx,b.transform);this.baseTransform=this.ctx.mozCurrentTransform.slice();this.imageLayer&&this.imageLayer.beginLayout()},executeOperatorList:function(a,c,b,d){var e=a.argsArray,a=a.fnArray,c=c||0,h=e.length;if(h===c)return c;for(var i=10<h-c&&"function"===
typeof b,f=i?Date.now()+15:0,j=0,k=this.commonObjs,l=this.objs,m;;){if(void 0!==d&&c===d.nextBreakPoint)return d.breakIt(c,b),c;m=a[c];if(m!==g.OPS.dependency)this[m].apply(this,e[c]);else{m=e[c];for(var o=0,t=m.length;o<t;o++){var q=m[o],r="g"===q[0]&&"_"===q[1]?k:l;if(!r.isResolved(q))return r.get(q,b),c}}c++;if(c===h)return c;if(i&&10<++j){if(Date.now()>f)return b(),c;j=0}}},endDrawing:function(){null!==this.current.activeSMask&&this.endSMaskGroup();this.ctx.restore();this.transparentCanvas&&(this.ctx=
...
f=c.wordSpacing,j=c.fontDirection,k=c.textHScale*j,l=a.length,m=b.vertical,o=m?1:-1,t=b.defaultVMetrics,q=d*c.fontMatrix[0],r=c.textRenderingMode===g.TextRenderingMode.FILL&&!b.disableFontFace&&!c.patternFill;e.save();var v=void 0;if(c.patternFill){e.save();var u=c.fillColor.getPattern(e,this),v=e.mozCurrentTransform;e.restore();e.fillStyle=u}e.transform.apply(e,c.textMatrix);e.translate(c.x,c.y+c.textRise);0<j?e.scale(k,-1):e.scale(k,1);var u=c.lineWidth,p=c.textMatrixScale;if(0===p||0===u){if(p=
c.textRenderingMode&g.TextRenderingMode.FILL_STROKE_MASK,p===g.TextRenderingMode.STROKE||p===g.TextRenderingMode.FILL_STROKE)this.cachedGetSinglePixelWidth=null,u=0.65*this.getSinglePixelWidth()}else u/=p;1!==h&&(e.scale(h,h),u/=h);e.lineWidth=u;for(p=u=0;p<l;++p){var w=a[p];if((0,g.isNum)(w))u+=o*w*d/1E3;else{var y=!1,A=(w.isSpace?f:0)+i,C=w.fontChar,R=w.accent,P,S,D=w.width;if(m){var Q;P=w.vmetric||t;Q=w.vmetric?P[1]:0.5*D;Q=-Q*q;S=P[2]*q;D=P?-P[0]:D;P=Q/h;S=(u+S)/h}else P=u/h,S=0;b.remeasure&&
0<D&&(Q=1E3*e.measureText(C).width/d*h,D<Q&&this.isFontSubpixelAAEnabled?(Q=D/Q,y=!0,e.save(),e.scale(Q,1),P/=Q):D!==Q&&(P+=(D-Q)/2E3*d/h));if(w.isInFont||b.missingFile)r&&!R?e.fillText(C,P,S):(this.paintChar(C,P,S,v),R&&(w=P+R.offset.x/h,C=S-R.offset.y/h,this.paintChar(R.fontChar,w,C,v)));u+=D*q+A*j;y&&e.restore()}}m?c.y-=u*k:c.x+=u*k;e.restore()}},showType3Text:function(a){var c=this.ctx,b=this.current,d=b.font,e=b.fontSize,h=b.fontDirection,i=d.vertical?1:-1,f=b.charSpacing,j=b.wordSpacing,k=b.textHScale*
h,l=b.fontMatrix||g.FONT_IDENTITY_MATRIX,m=a.length,o;if(!(b.textRenderingMode===g.TextRenderingMode.INVISIBLE||0===e)){this.cachedGetSinglePixelWidth=null;c.save();c.transform.apply(c,b.textMatrix);c.translate(b.x,b.y);c.scale(k,h);for(h=0;h<m;++h)if(o=a[h],(0,g.isNum)(o))o=i*o*e/1E3,this.ctx.translate(o,0),b.x+=o*k;else{var t=(o.isSpace?j:0)+f,q=d.charProcOperatorList[o.operatorListId];q?(this.processingType3=o,this.save(),c.scale(e,e),c.transform.apply(c,l),this.executeOperatorList(q),this.restore(),
o=g.Util.applyTransform([o.width,0],l)[0]*e+t,c.translate(o,0),b.x+=o*k):(0,g.warn)('Type3 character "'+o.operatorListId+'" is not available.')}c.restore();this.processingType3=null}},setCharWidth:function(){},setCharWidthAndBounds:function(a,c,b,d,e,h){this.ctx.rect(b,d,e-b,h-d);this.clip();this.endPath()},getColorN_Pattern:function(a){var c=this;if("TilingPattern"===a[0])var d=a[1],e=this.baseTransform||this.ctx.mozCurrentTransform.slice(),a=new m.TilingPattern(a,d,this.ctx,{createCanvasGraphics:function(a){return new b(a,
...
0,0,b,d[f],d[f+1]],x:0,y:0,w:e,h:h});this.paintInlineImageXObjectGroup(a,i)}else(0,g.warn)("Dependent image isn't ready yet")},paintInlineImageXObject:function(a){var c=a.width,b=a.height,e=this.ctx;this.save();e.scale(1/c,-1/b);var i=e.mozCurrentTransformInverse,f=i[0],g=i[1],f=Math.max(Math.sqrt(f*f+g*g),1),g=i[2],j=i[3],g=Math.max(Math.sqrt(g*g+j*j),1),k;if(a instanceof HTMLElement||!a.data)j=a;else{k=this.cachedCanvases.getCanvas("inlineImage",c,b);var l=k.context;d(l,a);j=k.canvas}for(var m=
c,o=b,t="prescale1";2<f&&1<m||2<g&&1<o;){var q=m,r=o;2<f&&1<m&&(q=Math.ceil(m/2),f/=m/q);2<g&&1<o&&(r=Math.ceil(o/2),g/=o/r);k=this.cachedCanvases.getCanvas(t,q,r);l=k.context;l.clearRect(0,0,q,r);l.drawImage(j,0,0,m,o,0,0,q,r);j=k.canvas;m=q;o=r;t="prescale1"===t?"prescale2":"prescale1"}e.drawImage(j,0,0,m,o,0,-b,c,b);this.imageLayer&&(e=this.getCanvasPosition(0,-b),this.imageLayer.appendImage({imgData:a,left:e[0],top:e[1],width:c/i[0],height:b/i[3]}));this.restore()},paintInlineImageXObjectGroup:function(a,
c){var b=this.ctx,e=a.width,i=a.height,f=this.cachedCanvases.getCanvas("inlineImage",e,i);d(f.context,a);for(var g=0,j=c.length;g<j;g++){var k=c[g];b.save();b.transform.apply(b,k.transform);b.scale(1,-1);b.drawImage(f.canvas,k.x,k.y,k.w,k.h,0,-1,1,1);this.imageLayer&&(k=this.getCanvasPosition(k.x,k.y),this.imageLayer.appendImage({imgData:a,left:k[0],top:k[1],width:e,height:i}));b.restore()}},paintSolidColorImageMask:function(){this.ctx.fillRect(0,0,1,1)},paintXObject:function(){(0,g.warn)("Unsupported 'paintXObject' command.")},
...
Math.sqrt(Math.max(a[0]*a[0]+a[1]*a[1],a[2]*a[2]+a[3]*a[3]))}return this.cachedGetSinglePixelWidth},getCanvasPosition:function(a,c){var b=this.ctx.mozCurrentTransform;return[b[0]*a+b[2]*c+b[4],b[1]*a+b[3]*c+b[5]]}};for(var C in g.OPS)b.prototype[g.OPS[C]]=b.prototype[C];return b}();d.CanvasGraphics=f},function(f,d,b){Object.defineProperty(d,"__esModule",{value:!0});d.TilingPattern=d.getShadingPatternFromIR=void 0;var l=b(0),k={RadialAxial:{fromIR:function(b){var a=b[1],d=b[2],f=b[3],g=b[4],k=b[5],
h=b[6];return{type:"Pattern",getPattern:function(b){var l;"axial"===a?l=b.createLinearGradient(f[0],f[1],g[0],g[1]):"radial"===a&&(l=b.createRadialGradient(f[0],f[1],k,g[0],g[1],h));for(var b=0,m=d.length;b<m;++b){var i=d[b];l.addColorStop(i[0],i[1])}return l}}}}},g=function(){function b(a,d,f,g,k,h,l,m){var u=d.coords,i=d.colors,p=a.data,a=4*a.width,A;u[f+1]>u[g+1]&&(A=f,f=g,g=A,A=h,h=l,l=A);u[g+1]>u[k+1]&&(A=g,g=k,k=A,A=l,l=m,m=A);u[f+1]>u[g+1]&&(A=f,f=g,g=A,A=h,h=l,l=A);A=(u[f]+d.offsetX)*d.scaleX;
var f=(u[f+1]+d.offsetY)*d.scaleY,c=(u[g]+d.offsetX)*d.scaleX,g=(u[g+1]+d.offsetY)*d.scaleY,e=(u[k]+d.offsetX)*d.scaleX,d=(u[k+1]+d.offsetY)*d.scaleY;if(!(f>=d))for(var k=i[h],u=i[h+1],h=i[h+2],y=i[l],w=i[l+1],l=i[l+2],C=i[m],s=i[m+1],m=i[m+2],z=Math.round(f),i=Math.round(d),F,I,K,E,H,L,N,B,M=z;M<=i;M++){M<g?(B=M<f?0:f===g?1:(f-M)/(f-g),z=A-(A-c)*B,F=k-(k-y)*B,I=u-(u-w)*B,K=h-(h-l)*B):(B=M>d?1:g===d?0:(g-M)/(g-d),z=c-(c-e)*B,F=y-(y-C)*B,I=w-(w-s)*B,K=l-(l-m)*B);B=M<f?0:M>d?1:(f-M)/(f-d);E=A-(A-e)*
B;H=k-(k-C)*B;L=u-(u-s)*B;N=h-(h-m)*B;B=Math.round(Math.min(z,E));for(var n=Math.round(Math.max(z,E)),J=a*M+4*B,x=B;x<=n;x++)B=(z-x)/(z-E),B=0>B?0:1<B?1:B,p[J++]=F-(F-H)*B|0,p[J++]=I-(I-L)*B|0,p[J++]=K-(K-N)*B|0,p[J++]=255}}return function(a,d,f,g,k,h,l,o){var u=Math.floor(a[0]),i=Math.floor(a[1]),p=Math.ceil(a[2])-u,a=Math.ceil(a[3])-i,A=Math.min(Math.ceil(Math.abs(1.1*p*d[0])),3E3),d=Math.min(Math.ceil(Math.abs(1.1*a*d[1])),3E3),p=p/A,a=a/d,f={coords:f,colors:g,offsetX:-u,offsetY:-i,scaleX:1/p,
scaleY:1/a},g=A+4,c=d+4;if(o.isEnabled)k=o.drawFigures({width:A,height:d,backgroundColor:h,figures:k,context:f}),l=l.getCanvas("mesh",g,c,!1),l.context.drawImage(k,2,2);else{l=l.getCanvas("mesh",g,c,!1);o=l.context;d=o.createImageData(A,d);if(h){c=d.data;A=0;for(g=c.length;A<g;A+=4)c[A]=h[0],c[A+1]=h[1],c[A+2]=h[2],c[A+3]=255}for(A=0;A<k.length;A++){var h=d,e=k[A],g=f,c=e.coords,y=e.colors,w=void 0,C=void 0;switch(e.type){case "lattice":for(var e=e.verticesPerRow,C=Math.floor(c.length/e)-1,s=e-1,
w=0;w<C;w++)for(var z=w*e,F=0;F<s;F++,z++)b(h,g,c[z],c[z+1],c[z+e],y[z],y[z+1],y[z+e]),b(h,g,c[z+e+1],c[z+1],c[z+e],y[z+e+1],y[z+1],y[z+e]);break;case "triangles":w=0;for(C=c.length;w<C;w+=3)b(h,g,c[w],c[w+1],c[w+2],y[w],y[w+1],y[w+2]);break;default:throw Error("illegal figure");}}o.putImageData(d,2,2)}k=l.canvas;return{canvas:k,offsetX:u-2*p,offsetY:i-2*a,scaleX:p,scaleY:a}}}();k.Mesh={fromIR:function(b){var a=b[2],d=b[3],f=b[4],k=b[5],v=b[6],h=b[8];return{type:"Pattern",getPattern:function(b,m,
u){var i;if(u)i=l.Util.singularValueDecompose2dScale(b.mozCurrentTransform);else if(i=l.Util.singularValueDecompose2dScale(m.baseTransform),v){var p=l.Util.singularValueDecompose2dScale(v);i=[i[0]*p[0],i[1]*p[1]]}i=g(k,i,a,d,f,u?null:h,m.cachedCanvases,m.webGLContext);u||(b.setTransform.apply(b,m.baseTransform),v&&b.transform.apply(b,v));b.translate(i.offsetX,i.offsetY);b.scale(i.scaleX,i.scaleY);return b.createPattern(i.canvas,"no-repeat")}}}};k.Dummy={fromIR:function(){return{type:"Pattern",getPattern:function(){return"hotpink"}}}};
f=function(){function b(a,d,f,g,k){this.operatorList=a[2];this.matrix=a[3]||[1,0,0,1,0,0];this.bbox=a[4];this.xstep=a[5];this.ystep=a[6];this.paintType=a[7];this.tilingType=a[8];this.color=d;this.canvasGraphicsFactory=g;this.baseTransform=k;this.type="Pattern";this.ctx=f}b.prototype={createPatternCanvas:function(a){var b=this.operatorList,d=this.bbox,f=this.xstep,g=this.ystep,h=this.paintType,k=this.tilingType,m=this.color,u=this.canvasGraphicsFactory;(0,l.info)("TilingType: "+k);var k=d[0],i=d[1],
p=d[2],A=d[3],c=[k,i],e=[k+f,i+g],y=e[0]-c[0],e=e[1]-c[1],w=l.Util.singularValueDecompose2dScale(this.matrix),C=l.Util.singularValueDecompose2dScale(this.baseTransform),w=[w[0]*C[0],w[1]*C[1]],y=Math.min(Math.ceil(Math.abs(y*w[0])),3E3),e=Math.min(Math.ceil(Math.abs(e*w[1])),3E3),w=a.cachedCanvases.getCanvas("pattern",y,e,!0),u=u.createCanvasGraphics(w.context);u.groupLevel=a.groupLevel;this.setFillAndStrokeStyleToContext(u,h,m);this.setScale(y,e,f,g);this.transformToScale(u);u.transform.apply(u,
[1,0,0,1,-c[0],-c[1]]);this.clipBbox(u,d,k,i,p,A);u.executeOperatorList(b);return w.canvas},setScale:function(a,b,d,f){this.scale=[a/d,b/f]},transformToScale:function(a){var b=this.scale;a.transform.apply(a,[b[0],0,0,b[1],0,0])},scaleToContext:function(){var a=this.scale;this.ctx.scale(1/a[0],1/a[1])},clipBbox:function(a,b,d,f,g,h){Array.isArray(b)&&4===b.length&&(a.ctx.rect(d,f,g-d,h-f),a.clip(),a.endPath())},setFillAndStrokeStyleToContext:function(a,b,d){var f=a.ctx,a=a.current;switch(b){case 1:b=
...
var g,k,h=null,l=null;return{tryInitGL:function(){try{return f(),!!g}catch(a){}return!1},composeSMask:function(l,t,i){var p=l.width,A=l.height;if(!h){var c,e;f();c=k;k=null;e=g;g=null;var y=b(e,"  attribute vec2 a_position;                                      attribute vec2 a_texCoord;                                                                                                      uniform vec2 u_resolution;                                                                                                      varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec2 clipSpace = (a_position / u_resolution) * 2.0 - 1.0;       gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_texCoord = a_texCoord;                                      }                                                             ",
e.VERTEX_SHADER),w=b(e,"  precision mediump float;                                                                                                        uniform vec4 u_backdrop;                                        uniform int u_subtype;                                          uniform sampler2D u_image;                                      uniform sampler2D u_mask;                                                                                                       varying vec2 v_texCoord;                                                                                                        void main() {                                                     vec4 imageColor = texture2D(u_image, v_texCoord);               vec4 maskColor = texture2D(u_mask, v_texCoord);                 if (u_backdrop.a > 0.0) {                                         maskColor.rgb = maskColor.rgb * maskColor.a +                                   u_backdrop.rgb * (1.0 - maskColor.a);         }                                                               float lum;                                                      if (u_subtype == 0) {                                             lum = maskColor.a;                                            } else {                                                          lum = maskColor.r * 0.3 + maskColor.g * 0.59 +                        maskColor.b * 0.11;                                     }                                                               imageColor.a *= lum;                                            imageColor.rgb *= imageColor.a;                                 gl_FragColor = imageColor;                                    }                                                             ",
e.FRAGMENT_SHADER),C=a(e,[y,w]);e.useProgram(C);y={};y.gl=e;y.canvas=c;y.resolutionLocation=e.getUniformLocation(C,"u_resolution");y.positionLocation=e.getAttribLocation(C,"a_position");y.backdropLocation=e.getUniformLocation(C,"u_backdrop");y.subtypeLocation=e.getUniformLocation(C,"u_subtype");c=e.getAttribLocation(C,"a_texCoord");var w=e.getUniformLocation(C,"u_image"),C=e.getUniformLocation(C,"u_mask"),s=e.createBuffer();e.bindBuffer(e.ARRAY_BUFFER,s);e.bufferData(e.ARRAY_BUFFER,new Float32Array([0,
0,1,0,0,1,0,1,1,0,1,1]),e.STATIC_DRAW);e.enableVertexAttribArray(c);e.vertexAttribPointer(c,2,e.FLOAT,!1,0,0);e.uniform1i(w,0);e.uniform1i(C,1);h=y}e=h;y=e.canvas;c=e.gl;y.width=p;y.height=A;c.viewport(0,0,c.drawingBufferWidth,c.drawingBufferHeight);c.uniform2f(e.resolutionLocation,p,A);i.backdrop?c.uniform4f(e.resolutionLocation,i.backdrop[0],i.backdrop[1],i.backdrop[2],1):c.uniform4f(e.resolutionLocation,0,0,0,0);c.uniform1i(e.subtypeLocation,"Luminosity"===i.subtype?1:0);l=d(c,l,c.TEXTURE0);t=
d(c,t,c.TEXTURE1);i=c.createBuffer();c.bindBuffer(c.ARRAY_BUFFER,i);c.bufferData(c.ARRAY_BUFFER,new Float32Array([0,0,p,0,0,A,0,A,p,0,p,A]),c.STATIC_DRAW);c.enableVertexAttribArray(e.positionLocation);c.vertexAttribPointer(e.positionLocation,2,c.FLOAT,!1,0,0);c.clearColor(0,0,0,0);c.enable(c.BLEND);c.blendFunc(c.ONE,c.ONE_MINUS_SRC_ALPHA);c.clear(c.COLOR_BUFFER_BIT);c.drawArrays(c.TRIANGLES,0,6);c.flush();c.deleteTexture(l);c.deleteTexture(t);c.deleteBuffer(i);return y},drawFigures:function(d,h,i,
p,r){if(!l){var c,e;f();c=k;k=null;e=g;g=null;var y=b(e,"  attribute vec2 a_position;                                      attribute vec3 a_color;                                                                                                         uniform vec2 u_resolution;                                      uniform vec2 u_scale;                                           uniform vec2 u_offset;                                                                                                          varying vec4 v_color;                                                                                                           void main() {                                                     vec2 position = (a_position + u_offset) * u_scale;              vec2 clipSpace = (position / u_resolution) * 2.0 - 1.0;         gl_Position = vec4(clipSpace * vec2(1, -1), 0, 1);                                                                              v_color = vec4(a_color / 255.0, 1.0);                         }                                                             ",
e.VERTEX_SHADER),w=b(e,"  precision mediump float;                                                                                                        varying vec4 v_color;                                                                                                           void main() {                                                     gl_FragColor = v_color;                                       }                                                             ",e.FRAGMENT_SHADER),y=a(e,[y,
w]);e.useProgram(y);w={};w.gl=e;w.canvas=c;w.resolutionLocation=e.getUniformLocation(y,"u_resolution");w.scaleLocation=e.getUniformLocation(y,"u_scale");w.offsetLocation=e.getUniformLocation(y,"u_offset");w.positionLocation=e.getAttribLocation(y,"a_position");w.colorLocation=e.getAttribLocation(y,"a_color");l=w}c=l;e=c.canvas;y=c.gl;e.width=d;e.height=h;y.viewport(0,0,y.drawingBufferWidth,y.drawingBufferHeight);y.uniform2f(c.resolutionLocation,d,h);var d=0,C,s,z;C=0;for(s=p.length;C<s;C++)switch(p[C].type){case "lattice":z=
p[C].coords.length/p[C].verticesPerRow|0;d+=6*(z-1)*(p[C].verticesPerRow-1);break;case "triangles":d+=p[C].coords.length}var w=new Float32Array(2*d),h=new Uint8Array(3*d),F=r.coords,I=r.colors,K=0,E=0;C=0;for(s=p.length;C<s;C++){z=p[C];var H=z.coords,L=z.colors;switch(z.type){case "lattice":var N=z.verticesPerRow;z=H.length/N|0;for(var B=1;B<z;B++)for(var M=B*N+1,n=1;n<N;n++,M++)w[K]=F[H[M-N-1]],w[K+1]=F[H[M-N-1]+1],w[K+2]=F[H[M-N]],w[K+3]=F[H[M-N]+1],w[K+4]=F[H[M-1]],w[K+5]=F[H[M-1]+1],h[E]=I[L[M-
N-1]],h[E+1]=I[L[M-N-1]+1],h[E+2]=I[L[M-N-1]+2],h[E+3]=I[L[M-N]],h[E+4]=I[L[M-N]+1],h[E+5]=I[L[M-N]+2],h[E+6]=I[L[M-1]],h[E+7]=I[L[M-1]+1],h[E+8]=I[L[M-1]+2],w[K+6]=w[K+2],w[K+7]=w[K+3],w[K+8]=w[K+4],w[K+9]=w[K+5],w[K+10]=F[H[M]],w[K+11]=F[H[M]+1],h[E+9]=h[E+3],h[E+10]=h[E+4],h[E+11]=h[E+5],h[E+12]=h[E+6],h[E+13]=h[E+7],h[E+14]=h[E+8],h[E+15]=I[L[M]],h[E+16]=I[L[M]+1],h[E+17]=I[L[M]+2],K+=12,E+=18;break;case "triangles":z=0;for(N=H.length;z<N;z++)w[K]=F[H[z]],w[K+1]=F[H[z]+1],h[E]=I[L[z]],h[E+1]=
I[L[z]+1],h[E+2]=I[L[z]+2],K+=2,E+=3}}i?y.clearColor(i[0]/255,i[1]/255,i[2]/255,1):y.clearColor(0,0,0,0);y.clear(y.COLOR_BUFFER_BIT);i=y.createBuffer();y.bindBuffer(y.ARRAY_BUFFER,i);y.bufferData(y.ARRAY_BUFFER,w,y.STATIC_DRAW);y.enableVertexAttribArray(c.positionLocation);y.vertexAttribPointer(c.positionLocation,2,y.FLOAT,!1,0,0);p=y.createBuffer();y.bindBuffer(y.ARRAY_BUFFER,p);y.bufferData(y.ARRAY_BUFFER,h,y.STATIC_DRAW);y.enableVertexAttribArray(c.colorLocation);y.vertexAttribPointer(c.colorLocation,
3,y.UNSIGNED_BYTE,!1,0,0);y.uniform2f(c.scaleLocation,r.scaleX,r.scaleY);y.uniform2f(c.offsetLocation,r.offsetX,r.offsetY);y.drawArrays(y.TRIANGLES,0,d);y.flush();y.deleteBuffer(i);y.deleteBuffer(p);return e},cleanup:function(){h&&h.canvas&&(h.canvas.width=0,h.canvas.height=0);l&&l.canvas&&(l.canvas.width=0,l.canvas.height=0);l=h=null}}}();d.WebGLContext=f},function(f,d,b){function l(a,b){if(!a)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return b&&("object"===
...
host:a.hostname,port:a.port,path:a.path,method:"GET",headers:b}}Object.defineProperty(d,"__esModule",{value:!0});d.PDFNodeStream=void 0;var a=function(){function a(b,c){for(var d=0;d<c.length;d++){var h=c[d];h.enumerable=h.enumerable||!1;h.configurable=!0;"value"in h&&(h.writable=!0);Object.defineProperty(b,h.key,h)}}return function(b,d,h){d&&a(b.prototype,d);h&&a(b,h);return b}}(),r=b(0),j=b(38),q=require("fs"),v=require("http"),h=require("https"),t=require("url"),f=function(){function b(a){g(this,
b);this.source=a;this.url=t.parse(a.url);this.isHttp="http:"===this.url.protocol||"https:"===this.url.protocol;this.isFsUrl="file:"===this.url.protocol||!this.url.host;this.httpHeaders=this.isHttp&&a.httpHeaders||{};this._fullRequest=null;this._rangeRequestReaders=[]}a(b,[{key:"getFullReader",value:function(){(0,r.assert)(!this._fullRequest);return this._fullRequest=this.isFsUrl?new p(this):new u(this)}},{key:"getRangeReader",value:function(a,b){var c=this.isFsUrl?new A(this,a,b):new i(this,a,b);
