...
if(this.operatorListIdx===this.operatorList.argsArray.length){this.running=false;if(this.operatorList.lastChunk){this.gfx.endDrawing();this._canvas&&c.delete(this._canvas);this.callback()}}}}};return a}();d.version="2.0.288";d.build="f0216484";d.getDocument=function(a){var c=new t;if(typeof a==="string")a={url:a};else if((0,m.isArrayBuffer)(a))a={data:a};else if(a instanceof n)a={range:a};else{if((typeof a==="undefined"?"undefined":e(a))!=="object")throw Error("Invalid parameter in getDocument, need either Uint8Array, string or a parameter object");
...
w;d.PDFDataRangeTransport=n;d.PDFWorker=p;d.PDFDocumentProxy=z;d.PDFPageProxy=A;d.setPDFNetworkStreamFactory=function(a){u=a};d.version="2.0.288";d.build="f0216484"},function(f,d,c){Object.defineProperty(d,"__esModule",{value:!0});d.Metadata=void 0;var l=function(){function c(b,d){for(var e=0;e<d.length;e++){var o=d[e];o.enumerable=o.enumerable||!1;o.configurable=!0;"value"in o&&(o.writable=!0);Object.defineProperty(b,o.key,o)}}return function(b,d,e){d&&c(b.prototype,d);e&&c(b,e);return b}}(),j=c(0),
