...
c.bytesFilled%e,f=Math.min(a._queueTotalSize,c.byteLength-c.bytesFilled),d=c.bytesFilled+f,d=d-d%e,e=!1;d>b&&(f=d-c.bytesFilled,e=!0);for(b=a._queue;0<f;){var d=b[0],j=Math.min(f,d.byteLength);Ba(c.buffer,c.byteOffset+c.bytesFilled,d.buffer,d.byteOffset,j);d.byteLength===j?b.shift():(d.byteOffset+=j,d.byteLength-=j);a._queueTotalSize-=j;Z(a,j,c);f-=j}!1===e&&(G(0===a._queueTotalSize,"queue must be empty"),G(0<c.bytesFilled),G(c.bytesFilled<c.elementSize));return e}function Z(a,c,e){G(0===a._pendingPullIntos.length||
a._pendingPullIntos[0]===e);X(a);e.bytesFilled+=c}function $(a){G("readable"===a._controlledReadableStream._state);0===a._queueTotalSize&&!0===a._closeRequested?c(a._controlledReadableStream):O(a)}function X(a){void 0!==a._byobRequest&&(a._byobRequest._associatedReadableByteStreamController=void 0,a._byobRequest._view=void 0,a._byobRequest=void 0)}function Y(a){for(G(!1===a._closeRequested);0<a._pendingPullIntos.length&&0!==a._queueTotalSize;){var c=a._pendingPullIntos[0];!0===Q(a,c)&&(P(a),V(a._controlledReadableStream,
c))}}function U(a,c){var e=a._controlledReadableStream,b=1;c.constructor!==DataView&&(b=c.constructor.BYTES_PER_ELEMENT);b={buffer:c.buffer,byteOffset:c.byteOffset,byteLength:c.byteLength,bytesFilled:0,elementSize:b,ctor:c.constructor,readerType:"byob"};if(0<a._pendingPullIntos.length)return b.buffer=ja(b.buffer),a._pendingPullIntos.push(b),t(e);if("closed"===e._state)return e=new c.constructor(b.buffer,b.byteOffset,0),Promise.resolve(da(e,!0));if(0<a._queueTotalSize){if(!0===Q(a,b))return e=M(b),
$(a),Promise.resolve(da(e,!1));if(!0===a._closeRequested)return e=new TypeError("Insufficient bytes to fill elements in the given buffer"),C(a,e),Promise.reject(e)}b.buffer=ja(b.buffer);a._pendingPullIntos.push(b);e=t(e);O(a);return e}function R(a,c){var e=a._pendingPullIntos[0],b=a._controlledReadableStream;if("closed"===b._state){if(0!==c)throw new TypeError("bytesWritten must be 0 when calling respond() on a closed stream");e.buffer=ja(e.buffer);G(0===e.bytesFilled,"bytesFilled must be 0");e=a._controlledReadableStream;
...
arguments[0]:{},e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},b=e.size,e=e.highWaterMark;o(this,a);this._state="readable";this._storedError=this._reader=void 0;this._disturbed=!1;this._readableStreamController=void 0;var f=c.type;if("bytes"===""+f)void 0===e&&(e=0),this._readableStreamController=new Na(this,c,e);else if(void 0===f)void 0===e&&(e=1),this._readableStreamController=new Oa(this,c,b,e);else throw new RangeError("Invalid type is specified");}ga(a,[{key:"cancel",value:function(a){return!1===
r(this)?Promise.reject(ca("cancel")):!0===w(this)?Promise.reject(new TypeError("Cannot cancel a stream that already has a reader")):f(this,a)}},{key:"getReader",value:function(){var a=(0<arguments.length&&void 0!==arguments[0]?arguments[0]:{}).mode;if(!1===r(this))throw ca("getReader");if(void 0===a)return new ra(this);if("byob"===""+a)return new Pa(this);throw new RangeError("Invalid mode is specified");}},{key:"pipeThrough",value:function(a,c){var e=a.readable,b=this.pipeTo(a.writable,c);za(b);
...
a._state?e(a._storedError):c.catch(e).catch(ba)}function m(c,e,b){function f(){c().then(function(){return I(e,b)},function(a){return I(!0,a)}).catch(ba)}!0!==h&&(h=!0,"writable"===a._state&&!1===ua(a)?u().then(f):f())}function t(c,e){!0!==h&&(h=!0,"writable"===a._state&&!1===ua(a)?u().then(function(){return I(c,e)}).catch(ba):I(c,e))}function I(a,c){La(y);E(k);a?p(c):e(void 0)}q(c,k._closedPromise,function(c){!1===d?m(function(){return Ja(a,c)},!0,c):t(!0,c)});q(a,y._closedPromise,function(a){!1===
j?m(function(){return f(c,a)},!0,a):t(!0,a)});(function(a,c,e){"closed"===a._state?e():c.then(e).catch(ba)})(c,k._closedPromise,function(){!1===b?m(function(){return Ka(y)}):t()});if(!0===ua(a)||"closed"===a._state){var i=new TypeError("the destination writable stream closed before all data could be piped to it");!1===j?m(function(){return f(c,i)},!0,i):t(!0,i)}n().catch(function(a){g=Promise.resolve();ba(a)})})}},{key:"tee",value:function(){if(!1===r(this))throw ca("tee");var a=s(this,!1);return ta(a)}},
{key:"locked",get:function(){if(!1===r(this))throw ca("locked");return w(this)}}]);return a}();a.exports={ReadableStream:sa,IsReadableStreamDisturbed:function(a){G(!0===r(a),"IsReadableStreamDisturbed should only be used on known readable streams");return a._disturbed},ReadableStreamDefaultControllerClose:z,ReadableStreamDefaultControllerEnqueue:D,ReadableStreamDefaultControllerError:H,ReadableStreamDefaultControllerGetDesiredSize:K};var ra=function(){function a(c){o(this,a);if(!1===r(c))throw new TypeError("ReadableStreamDefaultReader can only be constructed with a ReadableStream instance");
...
a._errored)return Promise.reject(a._storedError);!1===a._readableClosed&&w(a);return Promise.resolve()}).catch(function(c){s(a,c);return Promise.reject(a._storedError)})}}]);return a}(),A=function(){function a(c,e){o(this,a);this._transformStream=c;this._startPromise=e}k(a,[{key:"start",value:function(a){var c=this._transformStream;c._readableController=a;return this._startPromise.then(function(){p(void 0!==c._backpressureChangePromise,"_backpressureChangePromise should have been initialized");if(!0===
...
"symbol":typeof a};return f(a)}function c(a,c,e,b){if(a.destroyed)return Promise.reject(Error("Worker was destroyed"));e&&(c.length=e.length,c.initialData=e.initialData);return a.messageHandler.sendWithPromise("GetDocRequest",{docId:b,apiVersion:"2.2.107",source:{data:c.data,url:c.url,password:c.password,disableAutoFetch:c.disableAutoFetch,rangeChunkSize:c.rangeChunkSize,length:c.length},maxImageSize:c.maxImageSize,disableFontFace:c.disableFontFace,disableCreateObjectURL:c.disableCreateObjectURL,
...
a,d,j)}):Promise.resolve(e).then(function(a){k.value=a;d(k)},function(a){return c("throw",a,d,j)})}}var e;this._invoke=function(a,b){function f(){return new Promise(function(e,f){c(a,b,e,f)})}return e=e?e.then(f,f):f()}}function h(a,c,e){var b=F;return function(d,j){if(b===z)throw Error("Generator is already running");if(b===D){if("throw"===d)throw j;return p()}e.method=d;for(e.arg=j;;){var k=e.delegate;if(k&&(k=f(k,e))){if(k===H)continue;return k}if("next"===e.method)e.sent=e._sent=e.arg;else if("throw"===
e.method){if(b===F)throw b=D,e.arg;e.dispatchException(e.arg)}else"return"===e.method&&e.abrupt("return",e.arg);b=z;k=g(a,c,e);if("normal"===k.type){if(b=e.done?D:B,k.arg!==H)return{value:k.arg,done:e.done}}else"throw"===k.type&&(b=D,e.method="throw",e.arg=k.arg)}}}function f(a,c){var e=a.iterator[c.method];if(e===q){c.delegate=null;if("throw"===c.method){if(a.iterator["return"]&&(c.method="return",c.arg=q,f(a,c),"throw"===c.method))return H;c.method="throw";c.arg=new TypeError("The iterator does not provide a 'throw' method")}return H}e=
...
{};c.type="normal";delete c.arg;a.completion=c}function e(a){this.tryEntries=[{tryLoc:"root"}];a.forEach(c,this);this.reset(!0)}function k(a){if(a){var c=a[E];if(c)return c.call(a);if("function"===typeof a.next)return a;if(!isNaN(a.length)){var e=-1,c=function M(){for(;++e<a.length;)if(n.call(a,e))return M.value=a[e],M.done=!1,M;M.value=q;M.done=!0;return M};return c.next=c}}return{next:p}}function p(){return{value:q,done:!0}}var u=Object.prototype,n=u.hasOwnProperty,q,y="function"===typeof Symbol?
Symbol:{},E=y.iterator||"@@iterator",J=y.asyncIterator||"@@asyncIterator",I=y.toStringTag||"@@toStringTag";a.wrap=d;var F="suspendedStart",B="suspendedYield",z="executing",D="completed",H={},y={};y[E]=function(){return this};var A=Object.getPrototypeOf;(A=A&&A(A(k([]))))&&(A!==u&&n.call(A,E))&&(y=A);var K=x.prototype=i.prototype=Object.create(y);m.prototype=K.constructor=x;x.constructor=m;x[I]=m.displayName="GeneratorFunction";a.isGeneratorFunction=function(a){return(a="function"===typeof a&&a.constructor)?
a===m||"GeneratorFunction"===(a.displayName||a.name):!1};a.mark=function(a){Object.setPrototypeOf?Object.setPrototypeOf(a,x):(a.__proto__=x,I in a||(a[I]="GeneratorFunction"));a.prototype=Object.create(K);return a};a.awrap=function(a){return{__await:a}};v(t.prototype);t.prototype[J]=function(){return this};a.AsyncIterator=t;a.async=function(c,e,b,f){var j=new t(d(c,e,b,f));return a.isGeneratorFunction(e)?j:j.next().then(function(a){return a.done?a.value:j.next()})};v(K);K[I]="Generator";K[E]=function(){return this};
K.toString=function(){return"[object Generator]"};a.keys=function(a){var c=[],e;for(e in a)c.push(e);c.reverse();return function M(){for(;c.length;){var e=c.pop();if(e in a)return M.value=e,M.done=!1,M}M.done=!0;return M}};a.values=k;e.prototype={constructor:e,reset:function(a){this.next=this.prev=0;this.sent=this._sent=q;this.done=!1;this.delegate=null;this.method="next";this.arg=q;this.tryEntries.forEach(j);if(!a)for(var c in this)"t"===c.charAt(0)&&(n.call(this,c)&&!isNaN(+c.slice(1)))&&(this[c]=
...
this.tryEntries.length-1;0<=c;--c){var e=this.tryEntries[c];if(e.tryLoc===a){a=e.completion;if("throw"===a.type){var b=a.arg;j(e)}return b}}throw Error("illegal catch attempt");},delegateYield:function(a,c,e){this.delegate={iterator:k(a),resultName:c,nextLoc:e};"next"===this.method&&(this.arg=q);return H}};return a}("object"===b(a)?a.exports:{});try{regeneratorRuntime=a}catch(d){Function("r","regeneratorRuntime = r")(a)}}).call(this,a(150)(d))},function(d){d.exports=function(b){b.webpackPolyfill||
(b.deprecate=function(){},b.paths=[],b.children||(b.children=[]),Object.defineProperty(b,"loaded",{enumerable:!0,get:function(){return b.l}}),Object.defineProperty(b,"id",{enumerable:!0,get:function(){return b.i}}),b.webpackPolyfill=1);return b}},function(d,b,a){function i(a,c,b,e,d,g,h){try{var n=a[g](h),q=n.value}catch(y){b(y);return}n.done?c(q):Promise.resolve(q).then(e,d)}function l(a){return function(){var c=this,b=arguments;return new Promise(function(e,d){function g(a){i(n,e,d,g,h,"next",a)}
function h(a){i(n,e,d,g,h,"throw",a)}var n=a.apply(c,b);g(void 0)})}}function g(a,c){if(!(a instanceof c))throw new TypeError("Cannot call a class as a function");}function o(a,c){for(var b=0;b<c.length;b++){var e=c[b];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}function r(a,c,b){c&&o(a.prototype,c);b&&o(a,b);return a}function w(){return"undefined"!==typeof fetch&&"undefined"!==typeof Response&&"body"in Response.prototype&&"undefined"!==
typeof ReadableStream}function s(a,c){try{var b=(c?new x.URL(a,c):new x.URL(a)).protocol;return"http:"===b||"https:"===b}catch(e){return!1}}Object.defineProperty(b,"__esModule",{value:!0});b.addLinkAttributes=function(a){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{},b=c.url,e=c.target,c=c.rel;a.href=a.title=b?(0,x.removeNullCharacters)(b):"";b&&(b=Object.values(t).includes(e)?e:t.NONE,a.target=h[b],a.rel="string"===typeof c?c:v)};b.getFilenameFromUrl=function(a){var c=a.indexOf("#"),
b=a.indexOf("?"),c=Math.min(0<c?c:a.length,0<b?b:a.length);return a.substring(a.lastIndexOf("/",c)+1,c)};b.isFetchSupported=w;b.isValidFetchUrl=s;b.loadScript=function(a){return new Promise(function(c,b){var e=document.createElement("script");e.src=a;e.onload=c;e.onerror=function(){b(Error("Cannot load script at: ".concat(e.src)))};(document.head||document.documentElement).appendChild(e)})};b.deprecated=function(a){console.log("Deprecated API usage: "+a)};b.releaseImageResources=function(a){(0,x.assert)(a instanceof
Image,"Invalid `img` parameter.");var c=a.src;"string"===typeof c&&(c.startsWith("blob:")&&x.URL.revokeObjectURL)&&x.URL.revokeObjectURL(c);a.removeAttribute("src")};b.DummyStatTimer=b.StatTimer=b.DOMSVGFactory=b.DOMCMapReaderFactory=b.DOMCanvasFactory=b.DEFAULT_LINK_REL=b.LinkTarget=b.RenderingCancelledException=b.PageViewport=void 0;var m=function(a){return a&&a.__esModule?a:{"default":a}}(a(148)),x=a(1),v="noopener noreferrer nofollow";b.DEFAULT_LINK_REL=v;d=function(){function a(){g(this,a)}r(a,
...
"binary ":"")+"CMap at: ".concat(f));}));case 10:case "end":return e.stop()}},e,this)}));return function(e){return a.apply(this,arguments)}}())}]);return a}();b.DOMCMapReaderFactory=d;d=function(){function a(){g(this,a)}r(a,[{key:"create",value:function(a,b){(0,x.assert)(0<a&&0<b,"Invalid SVG dimensions");var e=document.createElementNS("http://www.w3.org/2000/svg","svg:svg");e.setAttribute("version","1.1");e.setAttribute("width",a+"px");e.setAttribute("height",b+"px");e.setAttribute("preserveAspectRatio",
"none");e.setAttribute("viewBox","0 0 "+a+" "+b);return e}},{key:"createElement",value:function(a){(0,x.assert)("string"===typeof a,"Invalid SVG element type");return document.createElementNS("http://www.w3.org/2000/svg",a)}}]);return a}();b.DOMSVGFactory=d;d=function(){function a(c){var b=c.viewBox,e=c.scale,d=c.rotation,h=c.offsetX,u=void 0===h?0:h,h=c.offsetY,n=void 0===h?0:h,c=c.dontFlip,q=void 0===c?!1:c;g(this,a);this.viewBox=b;this.scale=e;this.rotation=d;this.offsetX=u;this.offsetY=n;var c=
(b[2]+b[0])/2,h=(b[3]+b[1])/2,y,E,m,d=d%360;switch(0>d?d+360:d){case 180:d=-1;E=y=0;m=1;break;case 90:d=0;E=y=1;m=0;break;case 270:d=0;E=y=-1;m=0;break;default:d=1,E=y=0,m=-1}q&&(E=-E,m=-m);0===d?(u=Math.abs(h-b[1])*e+u,n=Math.abs(c-b[0])*e+n,q=Math.abs(b[3]-b[1])*e,b=Math.abs(b[2]-b[0])*e):(u=Math.abs(c-b[0])*e+u,n=Math.abs(h-b[1])*e+n,q=Math.abs(b[2]-b[0])*e,b=Math.abs(b[3]-b[1])*e);this.transform=[d*e,y*e,E*e,m*e,u-d*e*c-E*e*h,n-y*e*c-m*e*h];this.width=q;this.height=b}r(a,[{key:"clone",value:function(){var c=
...
a[3]],this.transform);return[b[0],b[1],a[0],a[1]]}},{key:"convertToPdfPoint",value:function(a,b){return x.Util.applyInverseTransform([a,b],this.transform)}}]);return a}();b.PageViewport=d;d=function(){function a(c,b){this.message=c;this.type=b}a.prototype=Error();a.prototype.name="RenderingCancelledException";return a.constructor=a}();b.RenderingCancelledException=d;var t={NONE:0,SELF:1,BLANK:2,PARENT:3,TOP:4};b.LinkTarget=t;var h=["","_self","_blank","_parent","_top"],d=function(){function a(){var c=
0<arguments.length&&void 0!==arguments[0]?arguments[0]:!0;g(this,a);this.enabled=!!c;this.started=Object.create(null);this.times=[]}r(a,[{key:"time",value:function(a){this.enabled&&(a in this.started&&(0,x.warn)("Timer is already running for "+a),this.started[a]=Date.now())}},{key:"timeEnd",value:function(a){this.enabled&&(a in this.started||(0,x.warn)("Timer has not been started for "+a),this.times.push({name:a,start:this.started[a],end:Date.now()}),delete this.started[a])}},{key:"toString",value:function(){var a=
"",b=0,e=!0,f=!1,d=void 0;try{for(var h=this.times[Symbol.iterator](),g;!(e=(g=h.next()).done);e=!0){var m=g.value.name;m.length>b&&(b=m.length)}}catch(y){f=!0,d=y}finally{try{!e&&null!=h.return&&h.return()}finally{if(f)throw d;}}e=!0;f=!1;d=void 0;try{for(var E=this.times[Symbol.iterator](),J;!(e=(J=E.next()).done);e=!0)var I=J.value,i=I.end-I.start,a=a+"".concat(I.name.padEnd(b)," ").concat(i,"ms\n")}catch(t){f=!0,d=t}finally{try{!e&&null!=E.return&&E.return()}finally{if(f)throw d;}}return a}}]);
return a}();b.StatTimer=d;d=function(){function a(){g(this,a);(0,x.unreachable)("Cannot initialize DummyStatTimer.")}r(a,null,[{key:"time",value:function(){}},{key:"timeEnd",value:function(){}},{key:"toString",value:function(){return""}}]);return a}();b.DummyStatTimer=d},function(d,b,a){function i(a){i="function"===typeof Symbol&&"symbol"===typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"===typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a};
return i(a)}function l(a){l=Object.setPrototypeOf?Object.getPrototypeOf:function(a){return a.__proto__||Object.getPrototypeOf(a)};return l(a)}function g(a,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function");a.prototype=Object.create(b&&b.prototype,{constructor:{value:a,writable:!0,configurable:!0}});b&&o(a,b)}function o(a,b){o=Object.setPrototypeOf||function(a,c){a.__proto__=c;return a};return o(a,b)}function r(a,b,e,f,d,h,g){try{var m=a[h](g),
y=m.value}catch(E){e(E);return}m.done?b(y):Promise.resolve(y).then(f,d)}function w(a){return function(){var b=this,e=arguments;return new Promise(function(f,d){function h(a){r(m,f,d,h,g,"next",a)}function g(a){r(m,f,d,h,g,"throw",a)}var m=a.apply(b,e);h(void 0)})}}function s(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}function m(a,b){for(var e=0;e<b.length;e++){var f=b[e];f.enumerable=f.enumerable||!1;f.configurable=!0;"value"in f&&(f.writable=!0);Object.defineProperty(a,
f.key,f)}}function x(a,b,e){b&&m(a.prototype,b);e&&m(a,e);return a}Object.defineProperty(b,"__esModule",{value:!0});b.FontLoader=b.FontFaceObject=void 0;var v=function(a){return a&&a.__esModule?a:{"default":a}}(a(148)),t=a(1),d=function(){function a(b){var e=b.docId,b=b.onUnsupportedFeature;s(this,a);this.constructor===a&&(0,t.unreachable)("Cannot initialize BaseFontLoader.");this.docId=e;this._onUnsupportedFeature=b;this.nativeFontFaces=[];this.styleElement=null}x(a,[{key:"addNativeFontFace",value:function(a){this.nativeFontFaces.push(a);
...
arguments)}}()},{key:"_queueLoadingCallback",value:function(){(0,t.unreachable)("Abstract method `_queueLoadingCallback`.")}},{key:"_prepareFontLoadEvent",value:function(){(0,t.unreachable)("Abstract method `_prepareFontLoadEvent`.")}},{key:"isFontLoadingAPISupported",get:function(){(0,t.unreachable)("Abstract method `isFontLoadingAPISupported`.")}},{key:"isSyncFontLoadingSupported",get:function(){(0,t.unreachable)("Abstract method `isSyncFontLoadingSupported`.")}},{key:"_loadTestFont",get:function(){(0,
t.unreachable)("Abstract method `_loadTestFont`.")}}]);return a}(),h;b.FontLoader=h;b.FontLoader=h=function(a){function b(a){s(this,b);a=l(b).call(this,a);if(!a||!("object"===i(a)||"function"===typeof a)){if(void 0===this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");a=this}a.loadingContext={requests:[],nextRequestId:0};a.loadTestFontId=0;return a}g(b,a);x(b,[{key:"_queueLoadingCallback",value:function(a){var c=this.loadingContext,b={id:"pdfjs-font-loading-".concat(c.nextRequestId++),
done:!1,complete:function(){(0,t.assert)(!b.done,"completeRequest() cannot be called twice.");for(b.done=!0;0<c.requests.length&&c.requests[0].done;){var a=c.requests.shift();setTimeout(a.callback,0)}},callback:a};c.requests.push(b);return b}},{key:"_prepareFontLoadEvent",value:function(a,c,b){function f(a,c){return a.charCodeAt(c)<<24|a.charCodeAt(c+1)<<16|a.charCodeAt(c+2)<<8|a.charCodeAt(c+3)&255}function d(a,c,e,b){var f=a.substring(0,c),a=a.substring(c+e);return f+b+a}function j(a,c){i++;30<
i?((0,t.warn)("Load test font never loaded."),c()):(m.font="30px "+a,m.fillText(".",0,20),0<m.getImageData(0,0,1,1).data[3]?c():setTimeout(j.bind(null,a,c)))}var h,g,a=document.createElement("canvas");a.width=1;a.height=1;var m=a.getContext("2d"),i=0,a="lt".concat(Date.now()).concat(this.loadTestFontId++),F=this._loadTestFont,F=d(F,976,a.length,a),r=f(F,16);h=0;for(g=a.length-3;h<g;h+=4)r=r-1482184792+f(a,h)|0;h<a.length&&(r=r-1482184792+f(a+"XXX",h)|0);F=d(F,16,4,(0,t.string32)(r));h="url(data:font/opentype;base64,".concat(btoa(F),
");");this.insertRule('@font-face {font-family:"'.concat(a,'";src:').concat(h,"}"));F=[];h=0;for(g=c.length;h<g;h++)F.push(c[h].loadedName);F.push(a);var w=document.createElement("div");w.setAttribute("style","visibility: hidden;width: 10px; height: 10px;position: absolute; top: 0px; left: 0px;");h=0;for(g=F.length;h<g;++h)c=document.createElement("span"),c.textContent="Hi",c.style.fontFamily=F[h],w.appendChild(c);document.body.appendChild(w);j(a,function(){document.body.removeChild(w);b.complete()})}},
{key:"isFontLoadingAPISupported",get:function(){var a="undefined"!==typeof document&&!!document.fonts;if(a&&"undefined"!==typeof navigator){var c=/Mozilla\/5.0.*?rv:(\d+).*? Gecko/.exec(navigator.userAgent);c&&63>c[1]&&(a=!1)}return(0,t.shadow)(this,"isFontLoadingAPISupported",a)}},{key:"isSyncFontLoadingSupported",get:function(){var a=!1;if("undefined"===typeof navigator)a=!0;else{var c=/Mozilla\/5.0.*?rv:(\d+).*? Gecko/.exec(navigator.userAgent);c&&14<=c[1]&&(a=!0)}return(0,t.shadow)(this,"isSyncFontLoadingSupported",
...
!(!l.default.FontInspector||!l.default.FontInspector.enabled);this._layoutTextCtx=this._layoutTextLastFontFamily=this._layoutTextLastFontSize=this._reader=null;this._textDivProperties=new WeakMap;this._canceled=this._renderingDone=!1;this._capability=(0,i.createPromiseCapability)();this._renderTimer=null;this._bounds=[];this._capability.promise.finally(function(){b._layoutTextCtx&&(b._layoutTextCtx.canvas.width=0,b._layoutTextCtx.canvas.height=0,b._layoutTextCtx=null)})}var m=1E5,x=/\S/,v=["left: ",
0,"px; top: ",0,"px; font-size: ",0,"px; font-family: ","",";"];s.prototype={get promise(){return this._capability.promise},cancel:function(){this._canceled=!0;this._reader&&(this._reader.cancel(new i.AbortException("TextLayer task cancelled.")),this._reader=null);null!==this._renderTimer&&(clearTimeout(this._renderTimer),this._renderTimer=null);this._capability.reject(Error("TextLayer task cancelled."))},_processItems:function(a,b){for(var d=0,c=a.length;d<c;d++){this._textContentItemsStr.push(a[d].str);
