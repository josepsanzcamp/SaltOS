...
b=CKEDITOR.dom.element.createFromHtml(f.output({id:a.id,name:b,langDir:a.lang.dir,langCode:a.langCode,voiceLabel:"",topHtml:h?'<span id="'+a.ui.spaceId("top")+'" class="cke_top cke_reset_all" role="presentation" style="height:auto">'+h+"</span>":"",contentId:a.ui.spaceId("contents"),bottomHtml:i?'<span id="'+a.ui.spaceId("bottom")+'" class="cke_bottom cke_reset_all" role="presentation">'+i+"</span>":"",outerEl:CKEDITOR.env.ie?"span":"div"}));if(n==CKEDITOR.ELEMENT_MODE_REPLACE){c.hide();
...
delete c.startsWithEOL;delete c.endsWithEOL},null,null,6);b.on("paste",function(a){a=a.data;b.insertHtml(a.dataValue,a.type);setTimeout(function(){b.fire("afterPaste")},0)},null,null,1E3);b.on("pasteDialog",function(a){setTimeout(function(){b.openDialog("paste",a.data)},0)})}})})();(function(){CKEDITOR.plugins.add("codemirror",{icons:"searchcode,autoformat,commentselectedrange,uncommentselectedrange,autocomplete",version:1.11,init:function(a){function f(){var b=[e+"js/codemirror.addons.min.js"];switch(d.mode){case "bbcode":b.push(e+"js/codemirror.mode.bbcode.min.js");break;case "bbcodemixed":b.push(e+"js/codemirror.mode.bbcodemixed.min.js");break;case "htmlmixed":b.push(e+"js/codemirror.mode.htmlmixed.min.js");break;case "text/html":b.push(e+"js/codemirror.mode.htmlmixed.min.js");
break;case "application/x-httpd-php":b.push(e+"js/codemirror.mode.php.min.js");break;case "text/javascript":b.push(e+"js/codemirror.mode.javascript.min.js");break;default:b.push(e+"js/codemirror.mode.htmlmixed.min.js")}d.useBeautify&&b.push(e+"js/beautify.min.js");d.enableSearchTools&&b.push(e+"js/codemirror.addons.search.min.js");return b}function g(b){var a=b.ui.space("contents").getDocument().createElement("textarea");a.setStyles(CKEDITOR.tools.extend({width:CKEDITOR.env.ie7Compat?"99%":"100%",
height:"100%",resize:"none",outline:"none","text-align":"left"},CKEDITOR.tools.cssVendorPrefix("tab-size",b.config.sourceAreaTabSize||4)));var e=[b.lang.editor,b.name].join();a.setAttributes({dir:"ltr",tabIndex:CKEDITOR.env.webkit?-1:b.tabIndex,role:"textbox","aria-label":e});a.addClass("cke_source cke_reset cke_enable_context_menu");b.ui.space("contents").append(a);window["editable_"+b.id]=b.editable(new c(b,a));window["editable_"+b.id].setData(b.getData(1));window["editable_"+b.id].editorID=b.id;
b.fire("ariaWidget",this);var f,a=window["editable_"+b.id],e=a.getParent();d.lineNumbers&&d.enableCodeFolding&&(window["foldFunc_"+b.id]=CodeMirror.newFoldFunction(CodeMirror.tagRangeFinder));window["codemirror_"+b.id]=CodeMirror.fromTextArea(a.$,{mode:d.mode,matchBrackets:d.matchBrackets,matchTags:d.matchTags,workDelay:300,workTime:35,readOnly:b.config.readOnly,lineNumbers:d.lineNumbers,lineWrapping:d.lineWrapping,autoCloseTags:d.autoCloseTags,autoCloseBrackets:d.autoCloseBrackets,highlightSelectionMatches:d.highlightMatches,
continueComments:d.continueComments,indentWithTabs:d.indentWithTabs,theme:d.theme,showTrailingSpace:d.showTrailingSpace,showCursorWhenSelecting:!0,extraKeys:{"Ctrl-Q":function(a){window["foldFunc_"+b.id](a,a.getCursor().line)}},onKeyEvent:function(a,c){if(d.enableCodeFormatting){var k=window["codemirror_"+b.id].getCursor(!0),e=window["codemirror_"+b.id].getCursor(!1);"keydown"===c.type&&c.ctrlKey&&75===c.keyCode&&!c.shiftKey&&!c.altKey?window["codemirror_"+b.id].commentRange(!0,k,e):"keydown"===c.type&&
c.ctrlKey&&75===c.keyCode&&c.shiftKey&&!c.altKey?(window["codemirror_"+b.id].commentRange(!1,k,e),d.autoFormatOnUncomment&&window["codemirror_"+b.id].autoFormatRange(k,e)):"keydown"===c.type&&(c.ctrlKey&&75===c.keyCode&&!c.shiftKey&&c.altKey)&&window["codemirror_"+b.id].autoFormatRange(k,e)}}});a=0==e.$.clientHeight?b.ui.space("contents").getStyle("height"):e.$.clientHeight+"px";window["codemirror_"+b.id].config=d;d.autoFormatOnStart&&(d.useBeautify?(e=window["codemirror_"+b.id].getValue(),window["codemirror_"+
b.id].setValue(html_beautify(e,4," ",120,"collapse"))):window["codemirror_"+b.id].autoFormatAll({line:0,ch:0},{line:window["codemirror_"+b.id].lineCount(),ch:0}));window["codemirror_"+b.id].on("change",function(){clearTimeout(f);f=setTimeout(function(){var a=window["codemirror_"+b.id];a&&a.save()},300)});window["codemirror_"+b.id].setSize(null,a);if(d.lineNumbers&&d.enableCodeFolding)window["codemirror_"+b.id].on("gutterClick",window["foldFunc_"+b.id]);d.highlightActiveLine&&(window["codemirror_"+
b.id].hlLine=window["codemirror_"+b.id].addLineClass(0,"background","activeline"),window["codemirror_"+b.id].on("cursorActivity",function(){try{var a=window["codemirror_"+b.id].getLineHandle(window["codemirror_"+b.id].getCursor().line)}catch(d){a=null}finally{if(a!=null&&a!=window["codemirror_"+b.id].hlLine){window["codemirror_"+b.id].removeLineClass(window["codemirror_"+b.id].hlLine,"background","activeline");window["codemirror_"+b.id].hlLine=window["codemirror_"+b.id].addLineClass(a,"background",
"activeline")}}}));if("function"===typeof d.onLoad)d.onLoad(window["codemirror_"+b.id],b)}var e=this.path,d=CKEDITOR.tools.extend({autoCloseBrackets:!0,autoCloseTags:!0,autoFormatOnStart:!1,autoFormatOnUncomment:!0,continueComments:!0,enableCodeFolding:!0,enableCodeFormatting:!0,enableSearchTools:!0,highlightActiveLine:!0,highlightMatches:!0,indentWithTabs:!1,lineNumbers:!0,lineWrapping:!0,mode:"htmlmixed",matchBrackets:!0,matchTags:!0,showAutoCompleteButton:!0,showCommentButton:!0,showFormatButton:!0,
showSearchButton:!0,showTrailingSpace:!0,showUncommentButton:!0,theme:"default",useBeautify:!1},a.config.codemirror||{},!0),h=a.lang.codemirror;a.config.codemirror_theme&&(d.theme=a.config.codemirror_theme);a.config.codemirror_autoFormatOnStart&&(d.autoFormatOnStart=a.config.codemirror_autoFormatOnStart);a.plugins.bbcode&&0>=d.mode.indexOf("bbcode")&&(d.mode="bbcode");if(a.elementMode===CKEDITOR.ELEMENT_MODE_INLINE)CKEDITOR.dialog.add("sourcedialog",function(b){function a(b,c){var e;window["codemirror_"+
b.id]=CodeMirror.fromTextArea(c,{mode:d.mode,matchBrackets:d.matchBrackets,matchTags:d.matchTags,workDelay:300,workTime:35,readOnly:b.config.readOnly,lineNumbers:d.lineNumbers,lineWrapping:d.lineWrapping,autoCloseTags:d.autoCloseTags,autoCloseBrackets:d.autoCloseBrackets,highligctionMatches:d.highlightMatches,continueComments:d.continueComments,indentWithTabs:d.indentWithTabs,theme:d.theme,showTrailingSpace:d.showTrailingSpace,showCursorWhenSelecting:true,viewportMargin:Infinity,extraKeys:{"Ctrl-Q":function(a){window["foldFunc_"+
b.id](a,a.getCursor().line)}},onKeyEvent:function(a,c){if(d.enableCodeFormatting){var e=window["codemirror_"+b.id].getCursor(true),f=window["codemirror_"+b.id].getCursor(false);if(c.type==="keydown"&&c.ctrlKey&&c.keyCode===75&&!c.shiftKey&&!c.altKey)window["codemirror_"+b.id].commentRange(true,e,f);else if(c.type==="keydown"&&c.ctrlKey&&c.keyCode===75&&c.shiftKey&&!c.altKey){window["codemirror_"+b.id].commentRange(false,e,f);d.autoFormatOnUncomment&&window["codemirror_"+b.id].autoFormatRange(e,f)}else c.type===
"keydown"&&(c.ctrlKey&&c.keyCode===75&&!c.shiftKey&&c.altKey)&&window["codemirror_"+b.id].autoFormatRange(e,f)}}});var f=j+"px",m=g+"px";window["codemirror_"+b.id].config=d;if(d.autoFormatOnStart)if(d.useBeautify){var h=window["codemirror_"+b.id].getValue();window["codemirror_"+b.id].setValue(html_beautify(h,4," ",120,"collapse"))}else window["codemirror_"+b.id].autoFormatAll({line:0,ch:0},{line:window["codemirror_"+b.id].lineCount(),ch:0});window["codemirror_"+b.id].on("change",function(){clearTimeout(e);
e=setTimeout(function(){var a=window["codemirror_"+b.id];a&&a.save()},300)});window["codemirror_"+b.id].setSize(m,f);if(d.lineNumbers&&d.enableCodeFolding)window["codemirror_"+b.id].on("gutterClick",window["foldFunc_"+b.id]);if(d.highlightActiveLine){window["codemirror_"+b.id].hlLine=window["codemirror_"+b.id].addLineClass(0,"background","activeline");window["codemirror_"+b.id].on("cursorActivity",function(){var a=window["codemirror_"+b.id].getLineHandle(window["codemirror_"+b.id].getCursor().line);
if(a!=window["codemirror_"+b.id].hlLine){window["codemirror_"+b.id].removeLineClass(window["codemirror_"+b.id].hlLine,"background","activeline");window["codemirror_"+b.id].hlLine=window["codemirror_"+b.id].addLineClass(a,"background","activeline")}})}if(typeof d.onLoad==="function")d.onLoad(window["codemirror_"+b.id],b)}var c=CKEDITOR.document.getWindow().getViewPaneSize(),g=Math.min(c.width-70,800),j=c.height/1.5,l;return{title:b.lang.sourcedialog.title,minWidth:g,minHeight:j,resizable:CKEDITOR.DIALOG_RESIZE_NONE,
onShow:function(){this.getContentElement("main","data").focus();this.getContentElement("main","AutoComplete").setValue(d.autoCloseTags,true);var c=this.getContentElement("main","data").getInputElement().$;this.setValueOf("main","data",l=b.getData());if(typeof CodeMirror=="undefined"){CKEDITOR.document.appendStyleSheet(e+"css/codemirror.min.css");d.theme.length&&d.theme!="default"&&CKEDITOR.document.appendStyleSheet(e+"theme/"+d.theme+".css");CKEDITOR.scriptLoader.load(e+"js/codemirror.min.js",function(){CKEDITOR.scriptLoader.load(f(),
function(){a(b,c)})})}else a(b,c)},onCancel:function(a){if(a.data.hide){window["codemirror_"+b.id].toTextArea();window["codemirror_"+b.id]=null}},onOk:function(){function a(c){var d=this;b.setData(c,function(){d.hide();var a=b.createRange();a.moveToElementEditStart(b.editable());a.select()})}return function(){window["codemirror_"+b.id].toTextArea();window["codemirror_"+b.id]=null;var c=this.getValueOf("main","data").replace(/\r/g,"");if(c===l)return true;CKEDITOR.env.ie?CKEDITOR.tools.setTimeout(a,
0,this,c):a.call(this,c);return false}}(),contents:[{id:"main",label:b.lang.sourcedialog.title,elements:[{type:"hbox",style:"width: 80px;margin:0;",widths:["20px","20px","20px","20px"],children:[{type:"button",id:"searchCode",label:"",title:h.searchCode,"class":"searchCodeButton",onClick:function(){CodeMirror.commands.find(window["codemirror_"+b.id])}},{type:"button",id:"autoFormat",label:"",title:h.autoFormat,"class":"autoFormat",onClick:function(){var a=window["codemirror_"+b.id].getCursor(true),
c=window["codemirror_"+b.id].getCursor(false);window["codemirror_"+b.id].autoFormatRange(a,c)}},{type:"button",id:"CommentSelectedRange",label:"",title:h.commentSelectedRange,"class":"CommentSelectedRange",onClick:function(){var a=window["codemirror_"+b.id].getCursor(true),c=window["codemirror_"+b.id].getCursor(false);window["codemirror_"+b.id].commentRange(true,a,c)}},{type:"button",id:"UncommentSelectedRange",label:"",title:h.uncommentSelectedRange,"class":"UncommentSelectedRange",onClick:function(){var a=
window["codemirror_"+b.id].getCursor(true),c=window["codemirror_"+b.id].getCursor(false);window["codemirror_"+b.id].commentRange(false,a,c);window["codemirror_"+b.id].config.autoFormatOnUncomment&&window["codemirror_"+b.id].autoFormatRange(a,c)}}]},{type:"checkbox",id:"AutoComplete",label:h.autoCompleteToggle,title:h.autoCompleteToggle,onChange:function(){window["codemirror_"+b.id].setOption("autoCloseTags",this.getValue())}},{type:"textarea",id:"data",dir:"ltr",inputStyle:"cursor:auto;width:"+g+
"px;height:"+j+"px;tab-size:4;text-align:left;","class":"cke_source cke_enable_context_menu"}]}]}});else{a.commands.find&&(a.commands.find.modes={wysiwyg:1,source:1},a.commands.find.exec=function(){a.mode==="wysiwyg"?a.openDialog("find"):CodeMirror.commands.find(window["codemirror_"+a.id])});a.commands.replace&&(a.commands.replace.modes={wysiwyg:1,source:1},a.commands.replace.exec=function(){a.mode==="wysiwyg"?a.openDialog("replace"):CodeMirror.commands.replace(window["codemirror_"+a.id])});var j=
CKEDITOR.plugins.sourcearea;j.commands.searchCode||(CKEDITOR.plugins.sourcearea.commands={source:{modes:{wysiwyg:1,source:1},editorFocus:!1,readOnly:1,exec:function(b){b.mode==="wysiwyg"&&b.fire("saveSnapshot");b.getCommand("source").setState(CKEDITOR.TRISTATE_DISABLED);b.setMode(b.mode==="source"?"wysiwyg":"source")},canUndo:!1},searchCode:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(b){CodeMirror.commands.find(window["codemirror_"+b.id])},canUndo:!0},autoFormat:{modes:{wysiwyg:0,
source:1},editorFocus:!1,readOnly:1,exec:function(b){var a=window["codemirror_"+b.id].getCursor(true),c=window["codemirror_"+b.id].getCursor(false);window["codemirror_"+b.id].autoFormatRange(a,c)},canUndo:!0},commentSelectedRange:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(b){var a=window["codemirror_"+b.id].getCursor(true),c=window["codemirror_"+b.id].getCursor(false);window["codemirror_"+b.id].commentRange(true,a,c)},canUndo:!0},uncommentSelectedRange:{modes:{wysiwyg:0,source:1},
editorFocus:!1,readOnly:1,exec:function(b){var a=window["codemirror_"+b.id].getCursor(true),c=window["codemirror_"+b.id].getCursor(false);window["codemirror_"+b.id].commentRange(false,a,c);window["codemirror_"+b.id].config.autoFormatOnUncomment&&window["codemirror_"+b.id].autoFormatRange(a,c)},canUndo:!0},autoCompleteToggle:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(a){this.state==CKEDITOR.TRISTATE_ON?window["codemirror_"+a.id].setOption("autoCloseTags",false):this.state==
CKEDITOR.TRISTATE_OFF&&window["codemirror_"+a.id].setOption("autoCloseTags",true);this.toggleState()},canUndo:!0}});a.addMode("source",function(b){if(typeof CodeMirror=="undefined"){CKEDITOR.document.appendStyleSheet(e+"css/codemirror.min.css");d.theme.length&&d.theme!="default"&&CKEDITOR.document.appendStyleSheet(e+"theme/"+d.theme+".css");CKEDITOR.scriptLoader.load(e+"js/codemirror.min.js",function(){CKEDITOR.scriptLoader.load(f(),function(){g(a);b()})})}else{g(a);b()}});a.addCommand("source",j.commands.source);
a.ui.addButton&&a.ui.addButton("Source",{label:a.lang.codemirror.toolbar,command:"source",toolbar:"mode,10"});d.enableCodeFormatting&&(a.addCommand("searchCode",j.commands.searchCode),a.addCommand("autoFormat",j.commands.autoFormat),a.addCommand("commentSelectedRange",j.commands.commentSelectedRange),a.addCommand("uncommentSelectedRange",j.commands.uncommentSelectedRange),a.addCommand("autoCompleteToggle",j.commands.autoCompleteToggle),a.ui.addButton&&((d.showFormatButton||d.showCommentButton||d.showUncommentButton||
d.showSearchButton)&&a.ui.add("-",CKEDITOR.UI_SEPARATOR,{toolbar:"mode,30"}),d.showFormatButton&&a.ui.addButton("autoFormat",{label:h.autoFormat,command:"autoFormat",toolbar:"mode,50"}),d.showCommentButton&&a.ui.addButton("CommentSelectedRange",{label:h.commentSelectedRange,command:"commentSelectedRange",toolbar:"mode,60"}),d.showUncommentButton&&a.ui.addButton("UncommentSelectedRange",{label:h.uncommentSelectedRange,command:"uncommentSelectedRange",toolbar:"mode,70"}),d.showAutoCompleteButton&&a.ui.addButton("AutoComplete",
{label:h.autoCompleteToggle,command:"autoCompleteToggle",toolbar:"mode,80"})));a.on("beforeModeUnload",function(b){if(a.mode==="source"&&a.plugins.textselection){var c=a.getTextSelection();c.startOffset=LineChannelToOffSet(window["codemirror_"+a.id],window["codemirror_"+a.id].getCursor(true));c.endOffset=LineChannelToOffSet(window["codemirror_"+a.id],window["codemirror_"+a.id].getCursor(false));delete c.element;c.createBookmark();sourceBookmark=true;b.data=c.content}});a.on("mode",function(){a.getCommand("source").setState(a.mode===
"source"?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF);if(a.mode==="source"){a.getCommand("autoCompleteToggle").setState(window["codemirror_"+a.id].config.autoCloseTags?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF);if(a.plugins.textselection&&textRange){var b,c;b=OffSetToLineChannel(window["codemirror_"+a.id],textRange.startOffset);if(typeof textRange.endOffset=="undefined"){window["codemirror_"+a.id].focus();window["codemirror_"+a.id].setCursor(b)}else{window["codemirror_"+a.id].focus();c=OffSetToLineChannel(window["codemirror_"+
a.id],textRange.endOffset);window["codemirror_"+a.id].setSelection(b,c)}}}});a.on("resize",function(){if(window["editable_"+a.id]&&a.mode==="source"){var b=window["editable_"+a.id].getParent();window["codemirror_"+a.id].setSize(b.$.clientWidth+"px",b.$.clientHeight+"px")}});a.on("readOnly",function(){window["editable_"+a.id]&&a.mode==="source"&&window["codemirror_"+a.id].setOption("readOnly",this.readOnly)});a.on("instanceReady",function(){var b=a.commands.selectAll;if(b!=null)b.exec=function(){if(a.mode===
"source")window["codemirror_"+a.id].setSelection({line:0,ch:0},{line:window["codemirror_"+a.id].lineCount(),ch:0});else{var b=a.editable();if(b.is("body"))a.document.$.execCommand("SelectAll",false,null);else{var c=a.createRange();c.selectNodeContents(b);c.select()}a.forceNextSelectionCheck();a.selectionChange()}}});if("undefined"!=typeof jQuery&&$('a[data-toggle="tab"]')&&window["codemirror_"+a.id])$('a[data-toggle="tab"]').on("shown.bs.tab",function(){window["codemirror_"+a.id].refresh()});a.on("setData",
function(b){window["editable_"+a.id]&&a.mode==="source"&&window["codemirror_"+a.id].setValue(b.data.dataValue)})}}});var c=CKEDITOR.tools.createClass({base:CKEDITOR.editable,proto:{setData:function(a){this.setValue(a);null!=this.codeMirror&&this.codeMirror.setValue(a);this.editor.fire("dataReady")},getData:function(){return this.getValue()},insertHtml:function(){},insertElement:function(){},insertText:function(){},setReadOnly:function(a){this[(a?"set":"remove")+"Attribute"]("readOnly","readonly")},
editorID:null,detach:function(){window["codemirror_"+this.editorID].toTextArea();window["editable_"+this.editorID]=null;window["codemirror_"+this.editorID]=null;c.baseProto.detach.call(this);this.clearCustomData();this.remove()}}})})();
CKEDITOR.plugins.sourcearea={commands:{source:{modes:{wysiwyg:1,source:1},editorFocus:!1,readOnly:1,exec:function(c){"wysiwyg"===c.mode&&c.fire("saveSnapshot");c.getCommand("source").setState(CKEDITOR.TRISTATE_DISABLED);c.setMode("source"===c.mode?"wysiwyg":"source")},canUndo:!1},searchCode:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(c){CodeMirror.commands.find(window["codemirror_"+c.id])},canUndo:!0},autoFormat:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(c){var a=
window["codemirror_"+c.id].getCursor(!0),f=window["codemirror_"+c.id].getCursor(!1);window["codemirror_"+c.id].autoFormatRange(a,f)},canUndo:!0},commentSelectedRange:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(c){var a=window["codemirror_"+c.id].getCursor(!0),f=window["codemirror_"+c.id].getCursor(!1);window["codemirror_"+c.id].commentRange(!0,a,f)},canUndo:!0},uncommentSelectedRange:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(c){var a=window["codemirror_"+
c.id].getCursor(!0),f=window["codemirror_"+c.id].getCursor(!1);window["codemirror_"+c.id].commentRange(!1,a,f);window["codemirror_"+c.id].config.autoFormatOnUncomment&&window["codemirror_"+c.id].autoFormatRange(a,f)},canUndo:!0},autoCompleteToggle:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(c){this.state==CKEDITOR.TRISTATE_ON?window["codemirror_"+c.id].setOption("autoCloseTags",!1):this.state==CKEDITOR.TRISTATE_OFF&&window["codemirror_"+c.id].setOption("autoCloseTags",!0);
this.toggleState()},canUndo:!0}}};function LineChannelToOffSet(c,a){var f=a.line,g=f+a.ch;for(i=0;i<f;i++)g+=c.getLine(i).length;return g}function OffSetToLineChannel(c,a){var f=0,g=0,e=0;for(i=0;i<c.lineCount();i++){len=c.getLine(i).length;if(a<e+len){f=i;g=a-e;break}len++;e+=len}return{line:f,ch:g}};CKEDITOR.plugins.add("panelbutton",{requires:"button",onLoad:function(){function e(c){var a=this._;a.state!=CKEDITOR.TRISTATE_DISABLED&&(this.createPanel(c),a.on?a.panel.hide():a.panel.showBlock(this._.id,this.document.getById(this._.id),4))}CKEDITOR.ui.panelButton=CKEDITOR.tools.createClass({base:CKEDITOR.ui.button,$:function(c){var a=c.panel||{};delete c.panel;this.base(c);this.document=a.parent&&a.parent.getDocument()||CKEDITOR.document;a.block={attributes:a.attributes};this.hasArrow=a.toolbarRelated=
...
CKEDITOR.config.disableNativeTableHandles=!0;CKEDITOR.config.disableNativeSpellChecker=!0;CKEDITOR.config.contentsCss=CKEDITOR.getUrl("contents.css");CKEDITOR.plugins.add("docprops",{requires:"wysiwygarea,dialog,colordialog",init:function(a){var b=new CKEDITOR.dialogCommand("docProps");b.modes={wysiwyg:a.config.fullPage};b.allowedContent={body:{styles:"*",attributes:"dir"},html:{attributes:"lang,xml:lang"}};b.requiredContent="body";a.addCommand("docProps",b);CKEDITOR.dialog.add("docProps",this.path+"dialogs/docprops.js");a.ui.addButton&&a.ui.addButton("DocProps",{label:a.lang.docprops.label,command:"docProps",toolbar:"document,30"})}});(function(){function l(c,e,b){b=c.config.forceEnterMode||b;"wysiwyg"==c.mode&&(e||(e=c.activeEnterMode),c.elementPath().isContextFor("p")||(e=CKEDITOR.ENTER_BR,b=1),c.fire("saveSnapshot"),e==CKEDITOR.ENTER_BR?o(c,e,null,b):p(c,e,null,b),c.fire("saveSnapshot"))}function q(c){for(var c=c.getSelection().getRanges(!0),e=c.length-1;0<e;e--)c[e].deleteContents();return c[0]}CKEDITOR.plugins.add("enterkey",{init:function(c){c.addCommand("enter",{modes:{wysiwyg:1},editorFocus:!1,exec:function(c){l(c)}});
...
cleanup:function(){var a,d;for(d in this.visible)a=this.visible[d],a.getCustomData("hash")!==this.hash&&this.hideLine(a)},queryViewport:function(){this.winPane=this.win.getViewPaneSize();this.winTopScroll=this.winTop.getScrollPosition();this.winTopPane=this.winTop.getViewPaneSize();this.rect=this.inline?this.editable.getClientRect():this.frame.getClientRect()}};var o={left:1,right:1,center:1},r={absolute:1,fixed:1};CKEDITOR.plugins.lineutils={finder:k,locator:l,liner:m}})();(function(){function m(c){return c.replace(/'/g,"\\$&")}function n(c){for(var b,a=c.length,f=[],e=0;e<a;e++)b=c.charCodeAt(e),f.push(b);return"String.fromCharCode("+f.join(",")+")"}function o(c,b){var a=c.plugins.link,f=a.compiledProtectionFunction.params,e,d;d=[a.compiledProtectionFunction.name,"("];for(var g=0;g<f.length;g++)a=f[g].toLowerCase(),e=b[a],0<g&&d.push(","),d.push("'",e?m(encodeURIComponent(b[a])):"","'");d.push(")");return d.join("")}function l(c){var c=c.config.emailProtection||"",
...
null},getClassesArray:function(){var a=this._.definition.attributes&&this._.definition.attributes["class"];return a?CKEDITOR.tools.trim(a).split(/\s+/):null},applyToRange:a,removeFromRange:a,applyToObject:a})})();CKEDITOR.plugins.widget=k;k.repository=o;k.nestedEditable=q})();(function(){CKEDITOR.plugins.add("placeholder",{requires:"widget,dialog",onLoad:function(){CKEDITOR.addCss(".cke_placeholder{background-color:#ff0}")},init:function(a){var b=a.lang.placeholder;CKEDITOR.dialog.add("placeholder",this.path+"dialogs/placeholder.js");a.widgets.add("placeholder",{dialog:"placeholder",pathName:b.pathName,template:'<span class="cke_placeholder">[[]]</span>',downcast:function(){return new CKEDITOR.htmlParser.text("[["+this.data.name+"]]")},init:function(){this.setData("name",
...
this.setState(CKEDITOR.TRISTATE_DISABLED)}},reset:function(){f={};i=[]}})}})})();(function(){function h(b,e,c){var i=[],g=[],a;for(a=0;a<b.styleSheets.length;a++){var d=b.styleSheets[a];if(!(d.ownerNode||d.owningElement).getAttribute("data-cke-temp")&&!(d.href&&"chrome://"==d.href.substr(0,9)))try{for(var f=d.cssRules||d.rules,d=0;d<f.length;d++)g.push(f[d].selectorText)}catch(h){}}a=g.join(" ");a=a.replace(/(,|>|\+|~)/g," ");a=a.replace(/\[[^\]]*/g,"");a=a.replace(/#[^\s]*/g,"");a=a.replace(/\:{1,2}[^\s]*/g,"");a=a.replace(/\s+/g," ");a=a.split(" ");b=[];for(g=0;g<a.length;g++)f=
...
r);a:{for(var c=0,g=b.length;c<g;c++){var d=b[c];if(f>=d.x&&f<=d.x+d.width){f=d;break a}}f=null}f&&(!h&&(h=new A(a)),h.attachTo(f))}}})})}})})();(function(){CKEDITOR.plugins.add("templates",{requires:"dialog",init:function(a){CKEDITOR.dialog.add("templates",CKEDITOR.getUrl(this.path+"dialogs/templates.js"));a.addCommand("templates",new CKEDITOR.dialogCommand("templates"));a.ui.addButton&&a.ui.addButton("Templates",{label:a.lang.templates.button,command:"templates",toolbar:"doctools,10"})}});var c={},f={};CKEDITOR.addTemplates=function(a,d){c[a]=d};CKEDITOR.getTemplates=function(a){return c[a]};CKEDITOR.loadTemplates=function(a,d){for(var e=
