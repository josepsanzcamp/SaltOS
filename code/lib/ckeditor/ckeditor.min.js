...
*/
(function(){if(!window.CKEDITOR||!window.CKEDITOR.dom)window.CKEDITOR||(window.CKEDITOR=function(){var a=/(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,f={timestamp:"EASI",version:"4.4.7 DEV",revision:"45e0cea",rnd:Math.floor(900*Math.random())+100,_:{pending:[],basePathSrcPattern:a},status:"unloaded",basePath:function(){var b=window.CKEDITOR_BASEPATH||"";if(!b)for(var g=document.getElementsByTagName("script"),c=0;c<g.length;c++){var d=g[c].src.match(a);if(d){b=d[1];break}}-1==b.indexOf(":/")&&"//"!=b.slice(0,
...
a=a+b.x;c=c+b.y}}if(!document.documentElement.getBoundingClientRect&&CKEDITOR.env.gecko&&!f){a=a+(this.$.clientLeft?1:0);c=c+(this.$.clientTop?1:0)}return{x:a,y:c}},scrollIntoView:function(b){var a=this.getParent();if(a){do{(a.$.clientWidth&&a.$.clientWidth<a.$.scrollWidth||a.$.clientHeight&&a.$.clientHeight<a.$.scrollHeight)&&!a.is("body")&&this.scrollIntoParent(a,b,1);if(a.is("html")){var c=a.getWindow();try{var d=c.$.frameElement;d&&(a=new CKEDITOR.dom.element(d))}catch(e){}}}while(a=a.getParent())
...
(a=this.getWindow());f=a.getDocument();var n=f.$.compatMode=="BackCompat";a instanceof CKEDITOR.dom.window&&(a=n?f.getBody():f.getDocumentElement());f=a.getWindow();h=o(this,f);var m=o(a,f),q=this.$.offsetHeight;d=this.$.offsetWidth;var r=a.$.clientHeight,t=a.$.clientWidth;f=h.x-p(this,"left")-m.x||0;k=h.y-p(this,"top")-m.y||0;d=h.x+d+p(this,"right")-(m.x+t)||0;h=h.y+q+p(this,"bottom")-(m.y+r)||0;if(k<0||h>0)l(0,c===true?k:c===false?h:k<0?k:h);if(e&&(f<0||d>0))l(f<0?f:d,0)},setState:function(a,c,
...
new CKEDITOR.dom.range(this.root);f=this.root;j.setStartAt(f,CKEDITOR.POSITION_AFTER_START);j.setEnd(this.startContainer,this.startOffset);j=new CKEDITOR.dom.walker(j);var C,J,G=CKEDITOR.dom.walker.blockBoundary(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?{br:1}:null),E=null,D=function(a){if(a.type==CKEDITOR.NODE_ELEMENT&&a.getAttribute("contenteditable")=="false")if(E){if(E.equals(a)){E=null;return}}else E=a;else if(E)return;var b=G(a);b||(C=a);return b},e=function(a){var b=D(a);!b&&(a.is&&a.is("br"))&&
(J=a);return b};j.guard=D;j=j.lastBackward();C=C||f;this.setStartAt(C,!C.is("br")&&(!j&&this.checkStartOfBlock()||j&&C.contains(j))?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_AFTER_END);if(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS){j=this.clone();j=new CKEDITOR.dom.walker(j);var I=CKEDITOR.dom.walker.whitespaces(),L=CKEDITOR.dom.walker.bookmark();j.evaluator=function(a){return!I(a)&&!L(a)};if((j=j.previous())&&j.type==CKEDITOR.NODE_ELEMENT&&j.is("br"))break}j=this.clone();j.collapse();j.setEndAt(f,
...
if(!this._.started){var m=this.range.clone();i=m.startPath();var q=m.endPath(),r=!m.collapsed&&e(m,i.block),t=!m.collapsed&&e(m,q.block,1);m.shrink(CKEDITOR.SHRINK_ELEMENT,true);r&&m.setStartAt(i.block,CKEDITOR.POSITION_BEFORE_END);t&&m.setEndAt(q.block,CKEDITOR.POSITION_AFTER_START);i=m.endContainer.hasAscendant("pre",true)||m.startContainer.hasAscendant("pre",true);m.enlarge(this.forceBrBreak&&!i||!this.enlargeBr?CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:CKEDITOR.ENLARGE_BLOCK_CONTENTS);if(!m.collapsed){i=
new CKEDITOR.dom.walker(m.clone());q=CKEDITOR.dom.walker.bookmark(true,true);i.evaluator=q;this._.nextNode=i.next();i=new CKEDITOR.dom.walker(m.clone());i.evaluator=q;i=i.previous();this._.lastNode=i.getNextSourceNode(true,null,m.root);if(this._.lastNode&&this._.lastNode.type==CKEDITOR.NODE_TEXT&&!CKEDITOR.tools.trim(this._.lastNode.getText())&&this._.lastNode.getParent().isBlockBoundary()){q=this.range.clone();q.moveToPosition(this._.lastNode,CKEDITOR.POSITION_AFTER_END);if(q.checkEndOfBlock()){q=
new CKEDITOR.dom.elementPath(q.endContainer,q.root);this._.lastNode=(q.block||q.blockLimit).getNextSourceNode(true)}}if(!this._.lastNode||!m.root.contains(this._.lastNode)){this._.lastNode=this._.docEndMarker=m.document.createText("");this._.lastNode.insertAfter(i)}m=null}this._.started=1;i=m}q=this._.nextNode;m=this._.lastNode;for(this._.nextNode=null;q;){var r=0,t=q.hasAscendant("pre"),u=q.type!=CKEDITOR.NODE_ELEMENT,v=0;if(u)q.type==CKEDITOR.NODE_TEXT&&b.test(q.getText())&&(u=0);else{var x=q.getName();
if(CKEDITOR.dtd.$block[x]&&q.getAttribute("contenteditable")=="false"){f=q;c(this,a,f);break}else if(q.isBlockBoundary(this.forceBrBreak&&!t&&{br:1})){if(x=="br")u=1;else if(!i&&!q.getChildCount()&&x!="hr"){f=q;o=q.equals(m);break}if(i){i.setEndAt(q,CKEDITOR.POSITION_BEFORE_START);if(x!="br")this._.nextNode=q}r=1}else{if(q.getFirst()){if(!i){i=this.range.clone();i.setStartAt(q,CKEDITOR.POSITION_BEFORE_START)}q=q.getFirst();continue}u=1}}if(u&&!i){i=this.range.clone();i.setStartAt(q,CKEDITOR.POSITION_BEFORE_START)}o=
(!r||u)&&q.equals(m);if(i&&!r)for(;!q.getNext(d)&&!o;){x=q.getParent();if(x.isBlockBoundary(this.forceBrBreak&&!t&&{br:1})){r=1;u=0;o||x.equals(m);i.setEndAt(x,CKEDITOR.POSITION_BEFORE_END);break}q=x;u=1;o=q.equals(m);v=1}u&&i.setEndAt(q,CKEDITOR.POSITION_AFTER_END);q=this._getNextSourceNode(q,v,m);if((o=!q)||r&&i)break}if(!f){if(!i){this._.docEndMarker&&this._.docEndMarker.remove();return this._.nextNode=null}f=new CKEDITOR.dom.elementPath(i.startContainer,i.root);q=f.blockLimit;r={div:1,th:1,td:1};
...
f.equals(m)?null:this._getNextSourceNode(i.getBoundaryNodes().endNode,1,m)}if(p)(p=f.getPrevious())&&p.type==CKEDITOR.NODE_ELEMENT&&(p.getName()=="br"?p.remove():p.getLast()&&p.getLast().$.nodeName.toLowerCase()=="br"&&p.getLast().remove());if(n)(p=f.getLast())&&p.type==CKEDITOR.NODE_ELEMENT&&p.getName()=="br"&&(!CKEDITOR.env.needsBrFiller||p.getPrevious(g)||p.getNext(g))&&p.remove();if(!this._.nextNode)this._.nextNode=o||f.equals(m)||!m?null:this._getNextSourceNode(f,1,m);return f},_getNextSourceNode:function(a,
...
allStyles:false,hadInvalidAttribute:false,hadInvalidClass:false,hadInvalidStyle:false};var r,t;if(!a&&!h)a=null;else{o(b);if(i){r=0;for(t=i.length;r<t;++r)if(e(i[r],b,n)===false){a=null;break a}}if(j){r=0;for(t=j.length;r<t;++r)e(j[r],b,n)}if(a){r=0;for(t=a.length;r<t;++r)f(a[r],b,n,k)}if(h){r=0;for(t=h.length;r<t;++r)f(h[r],b,n,k)}a=n}}if(!a){c.push(b);return A}if(!a.valid){c.push(b);return A}t=a.validAttributes;var l=a.validStyles;h=a.validClasses;var i=b.attributes,v=b.styles,j=b.classes,k=b.classBackup,
G=b.styleBackup,w,E,u=[];n=[];var s=/^data-cke-/;r=false;delete i.style;delete i["class"];delete b.classBackup;delete b.styleBackup;if(!a.allAttributes)for(w in i)if(!t[w])if(s.test(w)){if(w!=(E=w.replace(/^data-cke-saved-/,""))&&!t[E]){delete i[w];r=true}}else{delete i[w];r=true}if(!a.allStyles||a.hadInvalidStyle){for(w in v)a.allStyles||l[w]?u.push(w+":"+v[w]):r=true;if(u.length)i.style=u.sort().join("; ")}else if(G)i.style=G;if(!a.allClasses||a.hadInvalidClass){for(w=0;w<j.length;++w)(a.allClasses||
...
c;a.classes.length&&(b["class"]=a.classes.sort().join(" "))}function q(a){switch(a.name){case "a":if(!a.children.length&&!a.attributes.name)return false;break;case "img":if(!a.attributes.src)return false}return true}function r(a){if(!a)return false;if(a===true)return true;var b=n(a);return function(c){return c in a||b&&c.match(b)}}function t(){return new CKEDITOR.htmlParser.element("br")}function u(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.name=="br"||B.$block[a.name])}function v(a,b,c){var d=a.name;
...
b||(b=CKEDITOR);var d=c.length,h=[],j=[],k=function(a){e&&(i?e.call(b,a):e.call(b,h,j))};if(d===0)k(true);else{var l=function(a,b){(b?h:j).push(a);if(--d<=0){g&&CKEDITOR.document.getDocumentElement().removeStyle("cursor");k(b)}},o=function(b,c){a[b]=1;var d=f[b];delete f[b];for(var e=0;e<d.length;e++)d[e](b,c)},p=function(b){if(a[b])l(b,true);else{var c=f[b]||(f[b]=[]);c.push(l);if(!(c.length>1)){var d=new CKEDITOR.dom.element("script");d.setAttributes({type:"text/javascript",src:b});if(e)if(CKEDITOR.env.ie&&
...
function(g,i,d){function h(a){var b;if(q.length>0)for(var c=0;c<q.length;c++){var d=q[c],e=d.name,g=CKEDITOR.dtd[e],f=t.name&&CKEDITOR.dtd[t.name];if((!f||f[e])&&(!a||!g||g[a]||!CKEDITOR.dtd[a])){if(!b){j();b=1}d=d.clone();d.parent=t;t=d;q.splice(c,1);c--}else if(e==t.name){l(t,t.parent,1);c--}}}function j(){for(;r.length;)l(r.shift(),t)}function k(a){if(a._.isBlockLike&&a.name!="pre"&&a.name!="textarea"){var b=a.children.length,c=a.children[b-1],d;if(c&&c.type==CKEDITOR.NODE_TEXT)(d=CKEDITOR.tools.rtrim(c.value))?
c.value=d:a.children.length=b-1}}function l(b,c,e){var c=c||t||m,g=t;if(b.previous===void 0){if(o(c,b)){t=c;n.onTagOpen(d,{});b.returnPoint=c=t}k(b);(!a(b)||b.children.length)&&c.add(b);b.name=="pre"&&(v=false);b.name=="textarea"&&(u=false)}if(b.returnPoint){t=b.returnPoint;delete b.returnPoint}else t=e?c:g}function o(a,b){if((a==m||a.name=="body")&&d&&(!a.name||CKEDITOR.dtd[a.name][d])){var c,e;return(c=b.attributes&&(e=b.attributes["data-cke-real-element-type"])?e:b.name)&&c in CKEDITOR.dtd.$inline&&
!(c in CKEDITOR.dtd.head)&&!b.isOrphan||b.type==CKEDITOR.NODE_TEXT}}function p(a,b){return a in CKEDITOR.dtd.$listItem||a in CKEDITOR.dtd.$tableContent?a==b||a=="dt"&&b=="dd"||a=="dd"&&b=="dt":false}var n=new CKEDITOR.htmlParser,m=i instanceof CKEDITOR.htmlParser.element?i:typeof i=="string"?new CKEDITOR.htmlParser.element(i):new CKEDITOR.htmlParser.fragment,q=[],r=[],t=m,u=m.name=="textarea",v=m.name=="pre";n.onTagOpen=function(b,d,g,i){d=new CKEDITOR.htmlParser.element(b,d);if(d.isUnknown&&g)d.isEmpty=
true;d.isOptionalClose=i;if(a(d))q.push(d);else{if(b=="pre")v=true;else{if(b=="br"&&v){t.add(new CKEDITOR.htmlParser.text("\n"));return}b=="textarea"&&(u=true)}if(b=="br")r.push(d);else{for(;;){i=(g=t.name)?CKEDITOR.dtd[g]||(t._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):e;if(!d.isUnknown&&!t.isUnknown&&!i[b])if(t.isOptionalClose)n.onTagClose(g);else if(b in c&&g in c){g=t.children;(g=g[g.length-1])&&g.name=="li"||l(g=new CKEDITOR.htmlParser.element("li"),t);!d.returnPoint&&(d.returnPoint=t);
t=g}else if(b in CKEDITOR.dtd.$listItem&&!p(b,g))n.onTagOpen(b=="li"?"ul":"dl",{},0,1);else if(g in f&&!p(b,g)){!d.returnPoint&&(d.returnPoint=t);t=t.parent}else{g in CKEDITOR.dtd.$inline&&q.unshift(t);if(t.parent)l(t,t.parent,1);else{d.isOrphan=1;break}}else break}h(b);j();d.parent=t;d.isEmpty?l(d):t=d}}};n.onTagClose=function(a){for(var b=q.length-1;b>=0;b--)if(a==q[b].name){q.splice(b,1);return}for(var c=[],e=[],g=t;g!=m&&g.name!=a;){g._.isBlockLike||e.unshift(g);c.push(g);g=g.returnPoint||g.parent}if(g!=
m){for(b=0;b<c.length;b++){var f=c[b];l(f,f.parent)}t=g;g._.isBlockLike&&j();l(g,g.parent);if(g==t)t=t.parent;q=q.concat(e)}a=="body"&&(d=false)};n.onText=function(a){if((!t._.hasInlineStarted||r.length)&&!v&&!u){a=CKEDITOR.tools.ltrim(a);if(a.length===0)return}var c=t.name,g=c?CKEDITOR.dtd[c]||(t._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):e;if(!u&&!g["#"]&&c in f){n.onTagOpen(b[c]||"");n.onText(a)}else{j();h();!v&&!u&&(a=a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g," "));a=new CKEDITOR.htmlParser.text(a);
if(o(t,a))this.onTagOpen(d,{},0,1);t.add(a)}};n.onCDATA=function(a){t.add(new CKEDITOR.htmlParser.cdata(a))};n.onComment=function(a){j();h();t.add(new CKEDITOR.htmlParser.comment(a))};n.parse(g);for(j();t!=m;)l(t,t.parent,1);k(m);return m};CKEDITOR.htmlParser.fragment.prototype={type:CKEDITOR.NODE_DOCUMENT_FRAGMENT,add:function(a,b){isNaN(b)&&(b=this.children.length);var c=b>0?this.children[b-1]:null;if(c){if(a._.isBlockLike&&c.type==CKEDITOR.NODE_TEXT){c.value=CKEDITOR.tools.rtrim(c.value);if(c.value.length===
...
if(!r)if((c=a.previous)&&c.name=="br"||!c||g(c))return true}return false}var k={elements:{}},r=d=="html",n=CKEDITOR.tools.extend({},v),l;for(l in n)"#"in t[l]||delete n[l];for(l in n)k.elements[l]=h(r,a.config.fillEmptyBlocks);k.root=h(r,false);k.elements.br=function(a){return function(c){if(c.parent.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var d=c.attributes;if("data-cke-bogus"in d||"data-cke-eol"in d)delete d["data-cke-bogus"];else{for(d=c.next;d&&b(d);)d=d.next;var h=e(c);!d&&g(c.parent)?i(c.parent,
...
function(a,b){return A.test(b)&&c.indexOf("data-cke-saved-"+b)==-1?" data-cke-saved-"+a+" data-cke-"+CKEDITOR.rnd+"-"+a:a})+">"})}function k(a,b){return a.replace(b,function(a,b,c){a.indexOf("<textarea")===0&&(a=b+p(c).replace(/</g,"&lt;").replace(/>/g,"&gt;")+"</textarea>");return"<cke:encoded>"+encodeURIComponent(a)+"</cke:encoded>"})}function l(a){return a.replace(J,function(a,b){return decodeURIComponent(b)})}function o(a){return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g,function(a){return"<\!--"+
...
this._.editable=a?a instanceof CKEDITOR.editable?a:new CKEDITOR.editable(this,a):(b&&b.detach(),null);return b};var k=CKEDITOR.dom.walker.bogus(),l=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,o=CKEDITOR.dom.walker.whitespaces(true),p=CKEDITOR.dom.walker.bookmark(false,true);CKEDITOR.on("instanceLoaded",function(b){var c=b.editor;c.on("insertElement",function(a){a=a.data;if(a.type==CKEDITOR.NODE_ELEMENT&&(a.is("input")||
...
1);e&&d(e,b[b.length-1]);if(f&&d(f,b[0])){c.setEnd(c.endContainer,c.endOffset-1);c.collapse()}}var j=CKEDITOR.dtd,k={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,ul:1,ol:1,li:1,pre:1,dl:1,blockquote:1},n={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1},l=CKEDITOR.tools.extend({},j.$inline);delete l.br;return function(k,m,p){var o=k.editor,s=o.getSelection().getRanges()[0],G=false;if(m=="unfiltered_html"){m="html";G=true}if(!s.checkReadOnly()){var E=(new CKEDITOR.dom.elementPath(s.startContainer,s.root)).blockLimit||
s.root,m={type:m,dontFilter:G,editable:k,editor:o,range:s,blockLimit:E,mergeCandidates:[],zombies:[]},o=m.range,G=m.mergeCandidates,D,I,L,H;if(m.type=="text"&&o.shrink(CKEDITOR.SHRINK_ELEMENT,true,false)){D=CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>",o.document);o.insertNode(D);o.setStartAfter(D)}I=new CKEDITOR.dom.elementPath(o.startContainer);m.endPath=L=new CKEDITOR.dom.elementPath(o.endContainer);if(!o.collapsed){var E=L.block||L.blockLimit,Q=o.getCommonAncestor();E&&(!E.equals(Q)&&
!E.contains(Q)&&o.checkEndOfBlock())&&m.zombies.push(E);o.deleteContents()}for(;(H=a(o.startContainer)&&o.startContainer.getChild(o.startOffset-1))&&a(H)&&H.isBlockBoundary()&&I.contains(H);)o.moveToPosition(H,CKEDITOR.POSITION_BEFORE_END);f(o,m.blockLimit,I,L);if(D){o.setEndBefore(D);o.collapse();D.remove()}D=o.startPath();if(E=D.contains(d,false,1)){o.splitElement(E);m.inlineStylesRoot=E;m.inlineStylesPeak=D.lastElement}D=o.createBookmark();(E=D.startNode.getPrevious(e))&&a(E)&&d(E)&&G.push(E);
(E=D.startNode.getNext(e))&&a(E)&&d(E)&&G.push(E);for(E=D.startNode;(E=E.getParent())&&d(E);)G.push(E);o.moveToBookmark(D);if(D=p){D=m.range;if(m.type=="text"&&m.inlineStylesRoot){H=m.inlineStylesPeak;o=H.getDocument().createText("{cke-peak}");for(G=m.inlineStylesRoot.getParent();!H.equals(G);){o=o.appendTo(H.clone());H=H.getParent()}p=o.getOuterHtml().split("{cke-peak}").join(p)}H=m.blockLimit.getName();if(/^\s+|\s+$/.test(p)&&"span"in CKEDITOR.dtd[H])var O='<span data-cke-marker="1">&nbsp;</span>',
p=O+p+O;p=m.editor.dataProcessor.toHtml(p,{context:null,fixForBody:false,dontFilter:m.dontFilter,filter:m.editor.activeFilter,enterMode:m.editor.activeEnterMode});H=D.document.createElement("body");H.setHtml(p);if(O){H.getFirst().remove();H.getLast().remove()}if((O=D.startPath().block)&&!(O.getChildCount()==1&&O.getBogus()))a:{var M;if(H.getChildCount()==1&&a(M=H.getFirst())&&M.is(n)){O=M.getElementsByTag("*");D=0;for(G=O.count();D<G;D++){o=O.getItem(D);if(!o.is(l))break a}M.moveChildren(M.getParent(1));
M.remove()}}m.dataWrapper=H;D=p}if(D){M=m.range;var O=M.document,K,p=m.blockLimit;D=0;var R;H=[];var N,T,G=o=0,P,V;I=M.startContainer;var E=m.endPath.elements[0],W;L=E.getPosition(I);Q=!!E.getCommonAncestor(I)&&L!=CKEDITOR.POSITION_IDENTICAL&&!(L&CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED);I=b(m.dataWrapper,m);for(g(I,M);D<I.length;D++){L=I[D];if(K=L.isLineBreak){K=M;P=p;var S=void 0,Y=void 0;if(L.hasBlockSibling)K=1;else{S=K.startContainer.getAscendant(j.$block,1);if(!S||!S.is({div:1,
...
R.remove();M.moveToPosition(T,CKEDITOR.POSITION_BEFORE_END)}if((K=M.startPath().block)&&!K.equals(N)){if(R=K.getBogus()){R.remove();H.push(K)}N=K}L.firstNotAllowed&&(o=1);if(o&&L.isElement){K=M.startContainer;for(P=null;K&&!j[K.getName()][L.name];){if(K.equals(p)){K=null;break}P=K;K=K.getParent()}if(K){if(P){V=M.splitElement(P);m.zombies.push(V);m.zombies.push(P)}}else{P=p.getName();W=!D;K=D==I.length-1;P=c(L.node,P);for(var S=[],Y=P.length,Z=0,ba=void 0,X=0,aa=-1;Z<Y;Z++){ba=P[Z];if(ba==" "){if(!X&&
...
c.setEndBefore(d);c.collapsed&&a.splice(b--,1);if(!(d.getPosition(h.endContainer)&CKEDITOR.POSITION_CONTAINS)){e.setStartAfter(d);e.collapsed||a.splice(b+1,0,e)}return true}return false};d.next()}}return a}var p,n,m=CKEDITOR.dom.walker.invisible(1),q=function(){function a(b){return function(a){var c=a.editor.createRange();c.moveToClosestEditablePosition(a.selected,b)&&a.editor.getSelection().selectRanges([c]);return false}}function b(a){return function(b){var c=b.editor,d=c.createRange(),e;if(!(e=
...
"blur",function(){d.lockSelection(t);q=1},null,null,-1);h.attachListener(h,"mousedown",function(){q=0})}if(CKEDITOR.env.ie&&!n){var m;h.attachListener(h,"mousedown",function(a){if(a.data.$.button==2){a=d.document.getSelection();if(!a||a.getType()==CKEDITOR.SELECTION_NONE)m=d.window.getScrollPosition()}});h.attachListener(h,"mouseup",function(a){if(a.data.$.button==2&&m){d.document.$.documentElement.scrollLeft=m.x;d.document.$.documentElement.scrollTop=m.y}m=null});if(e.$.compatMode!="BackCompat"){if(CKEDITOR.env.ie7Compat||
...
r?function(){function a(b){return(new CKEDITOR.dom.node(b)).getIndex()}var b=function(b,c){b=b.duplicate();b.collapse(c);var d=b.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var e=d.children,f,g,h=b.duplicate(),j=0,i=e.length-1,k=-1,n,l;j<=i;){k=Math.floor((j+i)/2);f=e[k];h.moveToElementText(f);n=h.compareEndPoints("StartToStart",b);if(n>0)i=k-1;else if(n<0)j=k+1;else return{container:d,offset:a(f)}}if(k==-1||k==e.length-1&&n<0){h.moveToElementText(d);h.setEndPoint("StartToStart",
b);h=h.text.replace(/(\r\n|\r)/g,"\n").length;e=d.childNodes;if(!h){f=e[e.length-1];return f.nodeType!=CKEDITOR.NODE_TEXT?{container:d,offset:e.length}:{container:f,offset:f.nodeValue.length}}for(d=e.length;h>0&&d>0;){g=e[--d];if(g.nodeType==CKEDITOR.NODE_TEXT){l=g;h=h-g.nodeValue.length}}return{container:l,offset:-h}}h.collapse(n>0?true:false);h.setEndPoint(n>0?"StartToStart":"EndToStart",b);h=h.text.replace(/(\r\n|\r)/g,"\n").length;if(!h)return{container:d,offset:a(f)+(n>0?0:1)};for(;h>0;)try{g=
f[n>0?"previousSibling":"nextSibling"];if(g.nodeType==CKEDITOR.NODE_TEXT){h=h-g.nodeValue.length;l=g}f=g}catch(q){return{container:d,offset:a(f)}}return{container:l,offset:n>0?-h:l.nodeValue.length+h}};return function(){var a=this.getNative(),c=a&&a.createRange(),d=this.getType();if(!a)return[];if(d==CKEDITOR.SELECTION_TEXT){a=new CKEDITOR.dom.range(this.root);d=b(c,true);a.setStart(new CKEDITOR.dom.node(d.container),d.offset);d=b(c);a.setEnd(new CKEDITOR.dom.node(d.container),d.offset);a.endContainer.getPosition(a.startContainer)&
...
if(!k){h=true;k=CKEDITOR.dtd.span}b.enlarge(CKEDITOR.ENLARGE_INLINE,1);b.trim();var n=b.createBookmark(),l=n.startNode,r=n.endNode,t=l,m;if(!j){var o=b.getCommonAncestor(),j=a(l,o),o=a(r,o);j&&(t=j.getNextSourceNode(true));o&&(r=o)}for(t.getPosition(r)==CKEDITOR.POSITION_FOLLOWING&&(t=0);t;){j=false;if(t.equals(r)){t=null;j=true}else{var u=t.type==CKEDITOR.NODE_ELEMENT?t.getName():null,o=u&&t.getAttribute("contentEditable")=="false",v=u&&t.getAttribute("data-nostyle");if(u&&t.data("cke-bookmark")){t=
t.getNextSourceNode(true);continue}if(o&&i&&CKEDITOR.dtd.$block[u])for(var x=t,s=e(x),w=void 0,z=s.length,y=0,x=z&&new CKEDITOR.dom.range(x.getDocument());y<z;++y){var w=s[y],A=CKEDITOR.filter.instances[w.data("cke-filter")];if(A?A.check(this):1){x.selectNodeContents(w);f.call(this,x)}}s=u?!k[u]||v?0:o&&!i?0:(t.getPosition(r)|F)==F&&(!g.childRule||g.childRule(t)):1;if(s)if((s=t.getParent())&&((s.getDtd()||CKEDITOR.dtd.span)[d]||h)&&(!g.parentRule||g.parentRule(s))){if(!m&&(!u||!CKEDITOR.dtd.$removeEmpty[u]||
(t.getPosition(r)|F)==F)){m=b.clone();m.setStartBefore(t)}u=t.type;if(u==CKEDITOR.NODE_TEXT||o||u==CKEDITOR.NODE_ELEMENT&&!t.getChildCount()){for(var u=t,aa;(j=!u.getNext(B))&&(aa=u.getParent(),k[aa.getName()])&&(aa.getPosition(l)|C)==C&&(!g.childRule||g.childRule(aa));)u=aa;m.setEndAfter(u)}}else j=true;else j=true;t=t.getNextSourceNode(v||o)}if(j&&m&&!m.collapsed){for(var j=q(this,c),o=j.hasAttributes(),v=m.getCommonAncestor(),u={},s={},w={},z={},U,$,ca;j&&v;){if(v.getName()==d){for(U in g.attributes)if(!z[U]&&
(ca=v.getAttribute($)))j.getAttribute(U)==ca?s[U]=1:z[U]=1;for($ in g.styles)if(!w[$]&&(ca=v.getStyle($)))j.getStyle($)==ca?u[$]=1:w[$]=1}v=v.getParent()}for(U in s)j.removeAttribute(U);for($ in u)j.removeStyle($);o&&!j.hasAttributes()&&(j=null);if(j){m.extractContents().appendTo(j);m.insertNode(j);p.call(this,j);j.mergeSiblings();CKEDITOR.env.ie||j.$.normalize()}else{j=new CKEDITOR.dom.element("span");m.extractContents().appendTo(j);m.insertNode(j);p.call(this,j);j.remove(true)}m=null}}b.moveToBookmark(n);
...
d=c.attributes,c=c.styles,e=u(this)[a.getName()],f=CKEDITOR.tools.isEmpty(d)&&CKEDITOR.tools.isEmpty(c),g;for(g in d)if(!((g=="class"||this._.definition.fullMatch)&&a.getAttribute(g)!=v(g,d[g]))&&!(b&&g.slice(0,5)=="data-")){f=a.hasAttribute(g);a.removeAttribute(g)}for(var h in c)if(!(this._.definition.fullMatch&&a.getStyle(h)!=v(h,c[h],true))){f=f||!!a.getStyle(h);a.removeStyle(h)}n(a,e,w[a.getName()]);f&&(this._.definition.alwaysRemoveElement?m(a,1):!CKEDITOR.dtd.$block[a.getName()]||this._.enterMode==
CKEDITOR.ENTER_BR&&!a.hasAttributes()?m(a):a.renameNode(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))}function p(a){for(var b=u(this),c=a.getElementsByTag(this.element),d,e=c.count();--e>=0;){d=c.getItem(e);d.isReadOnly()||o.call(this,d,true)}for(var f in b)if(f!=this.element){c=a.getElementsByTag(f);for(e=c.count()-1;e>=0;e--){d=c.getItem(e);d.isReadOnly()||n(d,b[f])}}}function n(a,b,c){if(b=b&&b.attributes)for(var d=0;d<b.length;d++){var e=b[d][0],f;if(f=a.getAttribute(e)){var g=b[d][1];(g===null||
...
c.type,id:f,type:c.type};if(c.validate)this.validate=c.validate;if(c.maxLength)g.maxlength=c.maxLength;if(c.size)g.size=c.size;if(c.inputStyle)g.style=c.inputStyle;var i=this,p=false;b.on("load",function(){i.getInputElement().on("keydown",function(a){a.data.getKeystroke()==13&&(p=true)});i.getInputElement().on("keyup",function(a){if(a.data.getKeystroke()==13&&p){b.getButton("ok")&&setTimeout(function(){b.getButton("ok").click()},0);p=false}},null,null,1E3)});CKEDITOR.ui.dialog.labeledElement.call(this,
...
c.includeLabel=true;CKEDITOR.ui.dialog.labeledElement.call(this,b,c,e,function(){for(var a=[],e=[],j=(c.id?c.id:CKEDITOR.tools.getNextId())+"_radio",m=0;m<c.items.length;m++){var q=c.items[m],r=q[2]!==void 0?q[2]:q[0],t=q[1]!==void 0?q[1]:q[0],u=CKEDITOR.tools.getNextId()+"_radio_input",v=u+"_label",u=CKEDITOR.tools.extend({},c,{id:u,title:null,type:null},true),r=CKEDITOR.tools.extend({},u,{title:r},true),x={type:"radio","class":"cke_dialog_ui_radio_input",name:j,value:t,"aria-labelledby":v},w=[];
if(g._["default"]==t)x.checked="checked";i(u);i(r);if(typeof u.inputStyle!="undefined")u.style=u.inputStyle;u.keyboardFocusable=true;f.push(new CKEDITOR.ui.dialog.uiElement(b,u,w,"input",null,x));w.push(" ");new CKEDITOR.ui.dialog.uiElement(b,r,w,"label",null,{id:v,"for":x.id},q[0]);a.push(w.join(""))}new CKEDITOR.ui.dialog.hbox(b,f,a,e);return e.join("")});this._.children=f}},button:function(b,c,e){if(arguments.length){typeof c=="function"&&(c=c(b.getParentEditor()));a.call(this,c,{disabled:c.disabled||
...
c[1].toLowerCase(),a[f]);return this},reset:function(){function a(){c.$.open();var d="";e.size&&(d=e.size-(CKEDITOR.env.ie?7:0));var r=b.frameId+"_input";c.$.write(['<html dir="'+n+'" lang="'+m+'"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">','<form enctype="multipart/form-data" method="POST" dir="'+n+'" lang="'+m+'" action="',CKEDITOR.tools.htmlEncode(e.action),'"><label id="',b.labelId,'" for="',r,'" style="display:none">',CKEDITOR.tools.htmlEncode(e.label),
...
CKEDITOR.dialog=function(c,d){function h(){var a=w._.focusList;a.sort(function(a,b){return a.tabIndex!=b.tabIndex?b.tabIndex-a.tabIndex:a.focusIndex-b.focusIndex});for(var b=a.length,c=0;c<b;c++)a[c].focusIndex=c}function i(a){var b=w._.focusList,a=a||0;if(!(b.length<1)){var c=w._.currentFocusIndex;try{b[c].getInputElement().$.blur()}catch(d){}for(var e=c=(c+a+b.length)%b.length;a&&!b[e].isFocusable();){e=(e+a+b.length)%b.length;if(e==c)break}b[e].focus();b[e].type=="text"&&b[e].select()}}function n(b){if(w==
CKEDITOR.dialog._.currentTop){var d=b.data.getKeystroke(),e=c.lang.dir=="rtl";o=x=0;if(d==9||d==CKEDITOR.SHIFT+9){d=d==CKEDITOR.SHIFT+9;if(w._.tabBarMode){d=d?a.call(w):f.call(w);w.selectPage(d);w._.tabs[d][0].focus()}else i(d?-1:1);o=1}else if(d==CKEDITOR.ALT+121&&!w._.tabBarMode&&w.getPageCount()>1){w._.tabBarMode=true;w._.tabs[w._.currentTabId][0].focus();o=1}else if((d==37||d==39)&&w._.tabBarMode){d=d==(e?39:37)?a.call(w):f.call(w);w.selectPage(d);w._.tabs[d][0].focus();o=1}else if((d==13||d==
32)&&w._.tabBarMode){this.selectPage(this._.currentTabId);this._.tabBarMode=false;this._.currentFocusIndex=-1;i(1);o=1}else if(d==13){d=b.data.getTarget();if(!d.is("a","button","select","textarea")&&(!d.is("input")||d.$.type!="button")){(d=this.getButton("ok"))&&CKEDITOR.tools.setTimeout(d.click,0,d);o=1}x=1}else if(d==27){(d=this.getButton("cancel"))?CKEDITOR.tools.setTimeout(d.click,0,d):this.fire("cancel",{hide:true}).hide!==false&&this.hide();x=1}else return;t(b)}}function t(a){o?a.data.preventDefault(1):
x&&a.data.stopPropagation()}var r=CKEDITOR.dialog._.dialogDefinitions[d],l=CKEDITOR.tools.clone(q),m=c.config.dialog_buttonsOrder||"OS",u=c.lang.dir,p={},o,x;(m=="OS"&&CKEDITOR.env.mac||m=="rtl"&&u=="ltr"||m=="ltr"&&u=="rtl")&&l.buttons.reverse();r=CKEDITOR.tools.extend(r(c),l);r=CKEDITOR.tools.clone(r);r=new v(this,r);l=g(c);this._={editor:c,element:l.element,name:d,contentSize:{width:0,height:0},size:{width:0,height:0},contents:{},buttons:{},accessKeyMap:{},tabs:{},tabIdList:[],currentTabId:null,
currentTabIndex:null,pageCount:0,lastTab:null,tabBarMode:false,focusList:[],currentFocusIndex:0,hasFocus:false};this.parts=l.parts;CKEDITOR.tools.setTimeout(function(){c.fire("ariaWidget",this.parts.contents)},0,this);l={position:CKEDITOR.env.ie6Compat?"absolute":"fixed",top:0,visibility:"hidden"};l[u=="rtl"?"right":"left"]=0;this.parts.dialog.setStyles(l);CKEDITOR.event.call(this);this.definition=r=CKEDITOR.fire("dialogDefinition",{name:d,definition:r},c).definition;if(!("removeDialogTabs"in c._)&&
c.config.removeDialogTabs){l=c.config.removeDialogTabs.split(";");for(u=0;u<l.length;u++){m=l[u].split(":");if(m.length==2){var s=m[0];p[s]||(p[s]=[]);p[s].push(m[1])}}c._.removeDialogTabs=p}if(c._.removeDialogTabs&&(p=c._.removeDialogTabs[d]))for(u=0;u<p.length;u++)r.removeContents(p[u]);if(r.onLoad)this.on("load",r.onLoad);if(r.onShow)this.on("show",r.onShow);if(r.onHide)this.on("hide",r.onHide);if(r.onOk)this.on("ok",function(a){c.fire("saveSnapshot");setTimeout(function(){c.fire("saveSnapshot")},
0);if(r.onOk.call(this,a)===false)a.data.hide=false});if(r.onCancel)this.on("cancel",function(a){if(r.onCancel.call(this,a)===false)a.data.hide=false});var w=this,z=function(a){var b=w._.contents,c=false,d;for(d in b)for(var e in b[d])if(c=a.call(this,b[d][e]))return};this.on("ok",function(a){z(function(b){if(b.validate){var c=b.validate(this),d=typeof c=="string"||c===false;if(d){a.data.hide=false;a.stop()}e.call(b,!d,typeof c=="string"?c:void 0);return d}})},this,null,0);this.on("cancel",function(a){z(function(b){if(b.isChanged()){if(!c.config.dialog_noConfirmCancel&&
!confirm(c.lang.common.confirmCancel))a.data.hide=false;return true}})},this,null,0);this.parts.close.on("click",function(a){this.fire("cancel",{hide:true}).hide!==false&&this.hide();a.data.preventDefault()},this);this.changeFocus=i;var y=this._.element;c.focusManager.add(y,1);this.on("show",function(){y.on("keydown",n,this);if(CKEDITOR.env.gecko)y.on("keypress",t,this)});this.on("hide",function(){y.removeListener("keydown",n);CKEDITOR.env.gecko&&y.removeListener("keypress",t);z(function(a){b.apply(a)})});
this.on("iframeAdded",function(a){(new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on("keydown",n,this,null,0)});this.on("show",function(){h();if(c.config.dialog_startupFocusTab&&w._.pageCount>1){w._.tabBarMode=true;w._.tabs[w._.currentTabId][0].focus()}else if(!this._.hasFocus){this._.currentFocusIndex=-1;if(r.onFocus){var a=r.onFocus.call(this);a&&a.focus()}else i(1)}},this,null,4294967295);if(CKEDITOR.env.ie6Compat)this.on("load",function(){var a=this.getElement(),b=a.getFirst();
b.remove();b.appendTo(a)},this);j(this);k(this);(new CKEDITOR.dom.text(r.title,CKEDITOR.document)).appendTo(this.parts.title);for(u=0;u<r.contents.length;u++)(p=r.contents[u])&&this.addPage(p);this.parts.tabs.on("click",function(a){var b=a.data.getTarget();if(b.hasClass("cke_dialog_tab")){b=b.$.id;this.selectPage(b.substring(4,b.lastIndexOf("_")));if(this._.tabBarMode){this._.tabBarMode=false;this._.currentFocusIndex=-1;i(1)}a.data.preventDefault()}},this);u=[];p=CKEDITOR.dialog._.uiElementBuilders.hbox.build(this,
{type:"hbox",className:"cke_dialog_footer_buttons",widths:[],children:r.buttons},u).getChild();this.parts.footer.setHtml(u.join(""));for(u=0;u<p.length;u++)this._.buttons[p[u].id]=p[u]};CKEDITOR.dialog.prototype={destroy:function(){this.hide();this._.element.remove()},resize:function(){return function(a,b){if(!this._.contentSize||!(this._.contentSize.width==a&&this._.contentSize.height==b)){CKEDITOR.dialog.fire("resize",{dialog:this,width:a,height:b},this._.editor);this.fire("resize",{width:a,height:b},
...
CKEDITOR.tools.getNextId()+"_uiElement";if(b.requiredContent&&!a.getParentEditor().filter.check(b.requiredContent)){j.display="none";this.notAllowed=true}k.id=r;var t={};b.type&&(t["cke_dialog_ui_"+b.type]=1);b.className&&(t[b.className]=1);if(b.disabled)t.cke_disabled=1;for(var q=k["class"]&&k["class"].split?k["class"].split(" "):[],r=0;r<q.length;r++)q[r]&&(t[q[r]]=1);q=[];for(r in t)q.push(r);k["class"]=q.join(" ");if(b.title)k.title=b.title;t=(b.style||"").split(";");if(b.align){q=b.align;j["margin-left"]=
q=="left"?0:"auto";j["margin-right"]=q=="right"?0:"auto"}for(r in j)t.push(r+":"+j[r]);b.hidden&&t.push("display:none");for(r=t.length-1;r>=0;r--)t[r]===""&&t.splice(r,1);if(t.length>0)k.style=(k.style?k.style+"; ":"")+t.join("; ");for(r in k)i.push(r+'="'+CKEDITOR.tools.htmlEncode(k[r])+'" ');i.push(">",n,"</",h,">");c.push(i.join(""));(this._||(this._={})).dialog=a;if(typeof b.isChanged=="boolean")this.isChanged=function(){return b.isChanged};if(typeof b.isChanged=="function")this.isChanged=b.isChanged;
...
4)){this._||(this._={});var f=this._.children=b,g=e&&e.widths||null,h=e&&e.height||null,i,j={role:"presentation"};e&&e.align&&(j.align=e.align);CKEDITOR.ui.dialog.uiElement.call(this,a,e||{type:"hbox"},d,"table",{},j,function(){var a=['<tbody><tr class="cke_dialog_ui_hbox">'];for(i=0;i<c.length;i++){var b="cke_dialog_ui_hbox_child",d=[];i===0&&(b="cke_dialog_ui_hbox_first");i==c.length-1&&(b="cke_dialog_ui_hbox_last");a.push('<td class="',b,'" role="presentation" ');g?g[i]&&d.push("width:"+n(g[i])):
d.push("width:"+Math.floor(100/c.length)+"%");h&&d.push("height:"+n(h));e&&e.padding!==void 0&&d.push("padding:"+n(e.padding));CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&f[i].align)&&d.push("text-align:"+f[i].align);d.length>0&&a.push('style="'+d.join("; ")+'" ');a.push(">",c[i],"</td>")}a.push("</tr></tbody>");return a.join("")})}},vbox:function(a,b,c,d,e){if(!(arguments.length<3)){this._||(this._={});var f=this._.children=b,g=e&&e.width||null,h=e&&e.heights||null;CKEDITOR.ui.dialog.uiElement.call(this,
...
CKEDITOR.TRISTATE_OFF)}c=(b.block||b.blockLimit||a.editable()).getDirection(1);if(c!=(a._.selDir||a.lang.dir)){a._.selDir=c;a.fire("contentDirChanged",c)}},exec:function(d){var e=d.getSelection(),h=d.config.enterMode,i=e.getRanges();if(i&&i.length){for(var j={},q=e.createBookmarks(),i=i.createIterator(),r,t=0;r=i.getNextRange(1);){var u=r.getEnclosedNode();if(!u||u&&!(u.type==CKEDITOR.NODE_ELEMENT&&u.getName()in g))u=f(r,b,h);u&&a(u,c,d,j);var v=new CKEDITOR.dom.walker(r),x=q[t].startNode,w=q[t++].endNode;
v.evaluator=function(a){var c=h==CKEDITOR.ENTER_P?"p":"div",d;if(d=a?a.type==CKEDITOR.NODE_ELEMENT:false)if(d=a.getName()in b){if(c=a.is(c))c=((c=a.getParent())?c.type==CKEDITOR.NODE_ELEMENT:false)&&a.getParent().is("blockquote");d=!c&&a.getPosition(x)&CKEDITOR.POSITION_FOLLOWING&&(a.getPosition(w)&CKEDITOR.POSITION_PRECEDING+CKEDITOR.POSITION_CONTAINS)==CKEDITOR.POSITION_PRECEDING}return!!d};for(;u=v.next();)a(u,c,d,j);r=r.createIterator();for(r.enlargeBr=h!=CKEDITOR.ENTER_BR;u=r.getNextParagraph(h==
...
b.data.preventDefault();t(b);o("paste")||a.openDialog("paste")}});if(CKEDITOR.env.ie){c.on("contextmenu",g,null,null,0);c.on("beforepaste",function(a){a.data&&(!a.data.$.ctrlKey&&!a.data.$.shiftKey)&&g()},null,null,0)}c.on("beforecut",function(){!x&&n(a)});var d;c.attachListener(CKEDITOR.env.ie?c:a.document.getDocumentElement(),"mouseup",function(){d=setTimeout(function(){u()},0)});a.on("destroy",function(){clearTimeout(d)});c.on("keyup",u)}function c(b){return{type:b,canUndo:b=="cut",startDisabled:true,
...
"data-cke-temp":"1"});var r=0,d=d.getWindow();if(CKEDITOR.env.webkit){e.append(k);k.addClass("cke_editable");if(!e.is("body")){r=e.getComputedStyle("position")!="static"?e:CKEDITOR.dom.element.get(e.$.offsetParent);r=r.getDocumentPosition().y}}else e.getAscendant(CKEDITOR.env.ie?"body":"html",1).append(k);k.setStyles({position:"absolute",top:d.getScrollPosition().y-r+10+"px",width:"1px",height:Math.max(1,d.getViewPaneSize().height-20)+"px",overflow:"hidden",margin:0,padding:0});CKEDITOR.env.safari&&
k.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select","text"));if(r=k.getParent().isReadOnly()){k.setOpacity(0);k.setAttribute("contenteditable",true)}else k.setStyle(a.config.contentsLangDirection=="ltr"?"left":"right","-1000px");a.on("selectionChange",f,null,null,0);if(CKEDITOR.env.webkit||CKEDITOR.env.gecko)g=e.once("blur",f,null,null,-100);r&&k.focus();r=new CKEDITOR.dom.range(k);r.selectNodeContents(k);var t=r.select();CKEDITOR.env.ie&&(g=e.once("blur",function(){a.lockSelection(t)}));var n=
CKEDITOR.document.getWindow().getScrollPosition().y;setTimeout(function(){if(CKEDITOR.env.webkit)CKEDITOR.document.getBody().$.scrollTop=n;g&&g.removeListener();CKEDITOR.env.ie&&e.focus();h.selectBookmarks(j);k.remove();var b;if(CKEDITOR.env.webkit&&(b=k.getFirst())&&b.is&&b.hasClass("Apple-style-span"))k=b;a.removeListener("selectionChange",f);c(k.getHtml())},0)}}function q(){if(CKEDITOR.env.ie){a.focus();f();var b=a.focusManager;b.lock();if(a.editable().fire(y)&&!o("paste")){b.unlock();return false}b.unlock()}else try{if(a.editable().fire(y)&&
...
null,null,1E3);if(q()===false){a.removeListener("paste",d);if(g&&a.fire("pasteDialog",f)){a.on("pasteDialogCommit",e);a.on("dialogHide",function(a){a.removeListener();a.data.removeListener("pasteDialogCommit",e);setTimeout(function(){j||c(null)},10)})}else c(null)}}}function f(a){if(CKEDITOR.env.webkit){if(!a.match(/^[^<]*$/g)&&!a.match(/^(<div><br( ?\/)?><\/div>|<div>[^<]*<\/div>)*$/gi))return"html"}else if(CKEDITOR.env.ie){if(!a.match(/^([^<]|<br( ?\/)?>)*$/gi)&&!a.match(/^(<p>([^<]|<br( ?\/)?>)*<\/p>|(\r\n))*$/gi))return"html"}else if(CKEDITOR.env.gecko){if(!a.match(/^([^<]|<br( ?\/)?>)*$/gi))return"html"}else return"html";
...
a;var l={id:d,button:this,editor:a,focus:function(){CKEDITOR.document.getById(d).focus()},execute:function(){this.button.click(a)},attach:function(a){this.button.attach(a)}},o=CKEDITOR.tools.addFunction(function(a){if(l.onkey){a=new CKEDITOR.dom.event(a);return l.onkey(l,a.getKeystroke())!==false}}),p=CKEDITOR.tools.addFunction(function(a){var b;l.onfocus&&(b=l.onfocus(l,new CKEDITOR.dom.event(a))!==false);return b}),n=0;l.clickFn=k=CKEDITOR.tools.addFunction(function(){if(n){a.unlockSelection(1);
n=0}l.execute();i.iOS&&a.focus()});if(this.modes){var m={};a.on("beforeModeUnload",function(){if(a.mode&&this._.state!=CKEDITOR.TRISTATE_DISABLED)m[a.mode]=this._.state},this);a.on("activeFilterChange",g,this);a.on("mode",g,this);!this.readOnly&&a.on("readOnly",g,this)}else if(j)if(j=a.getCommand(j)){j.on("state",function(){this.setState(j.state)},this);h=h+(j.state==CKEDITOR.TRISTATE_ON?"on":j.state==CKEDITOR.TRISTATE_DISABLED?"disabled":"off")}if(this.directional)a.on("contentDirChanged",function(b){var c=
CKEDITOR.document.getById(this._.id),d=c.getFirst(),b=b.data;b!=a.lang.dir?c.addClass("cke_"+b):c.removeClass("cke_ltr").removeClass("cke_rtl");d.setAttribute("style",CKEDITOR.skin.getIconStyle(r,b=="rtl",this.icon,this.iconOffset))},this);j||(h=h+"off");var q=this.name||this.command,r=q;if(this.icon&&!/\./.test(this.icon)){r=this.icon;this.icon=null}h={id:d,name:q,iconName:r,label:this.label,cls:this.className||"",state:h,ariaDisabled:h=="disabled"?"true":"false",title:this.title,titleJs:i.gecko&&
!i.hc?"":(this.title||"").replace("'",""),hasArrow:this.hasArrow?"true":"false",keydownFn:o,focusFn:p,clickFn:k,style:CKEDITOR.skin.getIconStyle(r,a.lang.dir=="rtl",this.icon,this.iconOffset),arrowHtml:this.hasArrow?f.output():""};c.output(h,b);if(this.onRender)this.onRender();return l},setState:function(a){if(this._.state==a)return false;this._.state=a;var b=CKEDITOR.document.getById(this._.id);if(b){b.setState(a,"cke_button");a==CKEDITOR.TRISTATE_DISABLED?b.setAttribute("aria-disabled",true):b.removeAttribute("aria-disabled");
...
c},proto:{render:function(a,f,i){var d=a.id+(""+f),h=typeof this.state=="undefined"?CKEDITOR.TRISTATE_OFF:this.state,j="",k=h==CKEDITOR.TRISTATE_ON?"on":h==CKEDITOR.TRISTATE_DISABLED?"disabled":"off";this.role in{menuitemcheckbox:1,menuitemradio:1}&&(j=' aria-checked="'+(h==CKEDITOR.TRISTATE_ON?"true":"false")+'"');var l=this.getItems,o="&#"+(this.editor.lang.dir=="rtl"?"9668":"9658")+";",p=this.name;if(this.icon&&!/\./.test(this.icon))p=this.icon;a={id:d,name:this.name,iconName:p,label:this.label,
cls:this.className||"",state:k,hasPopup:l?"true":"false",disabled:h==CKEDITOR.TRISTATE_DISABLED,title:this.label,href:"javascript:void('"+(this.label||"").replace("'")+"')",hoverFn:a._.itemOverFn,moveOutFn:a._.itemOutFn,clickFn:a._.itemClickFn,index:f,iconStyle:CKEDITOR.skin.getIconStyle(p,this.editor.lang.dir=="rtl",p==this.icon?null:this.icon,this.iconOffset),arrowHtml:l?e.output({label:o}):"",role:this.role?this.role:"menuitem",ariaChecked:j};c.output(a,i)}}})}(),CKEDITOR.config.menu_groups="clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,table,anchor,link,image,flash,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea,div",
...
n=g.checkStartOfBlock(),m=g.checkEndOfBlock(),q=a.elementPath(g.startContainer),r=q.block,t=d==CKEDITOR.ENTER_DIV?"div":"p",u;if(n&&m){if(r&&(r.is("li")||r.getParent().is("li"))){r.is("li")||(r=r.getParent());g=r.getParent();u=g.getParent();var o=!r.hasPrevious(),v=!r.hasNext(),t=a.getSelection(),x=t.createBookmarks(),n=r.getDirection(1),m=r.getAttribute("class"),w=r.getAttribute("style"),s=u.getDirection(1)!=n,a=a.enterMode!=CKEDITOR.ENTER_BR||s||w||m;if(u.is("li"))if(o||v)r[o?"insertBefore":"insertAfter"](u);
else r.breakParent(u);else{if(a){if(q.block.is("li")){u=p.createElement(d==CKEDITOR.ENTER_P?"p":"div");s&&u.setAttribute("dir",n);w&&u.setAttribute("style",w);m&&u.setAttribute("class",m);r.moveChildren(u)}else u=q.block;if(o||v)u[o?"insertBefore":"insertAfter"](g);else{r.breakParent(g);u.insertAfter(g)}}else{r.appendBogus(true);if(o||v)for(;p=r[o?"getFirst":"getLast"]();)p[o?"insertBefore":"insertAfter"](g);else for(r.breakParent(g);p=r.getLast();)p.insertAfter(g)}r.remove()}t.selectBookmarks(x);
return}if(r&&r.getParent().is("blockquote")){r.breakParent(r.getParent());r.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1))||r.getPrevious().remove();r.getNext().getFirst(CKEDITOR.dom.walker.invisible(1))||r.getNext().remove();g.moveToElementEditStart(r);g.select();return}}else if(r&&r.is("pre")&&!m){i(a,d,g,o);return}if(n=g.splitBlock(t)){d=n.previousBlock;r=n.nextBlock;q=n.wasStartOfBlock;a=n.wasEndOfBlock;if(r){x=r.getParent();if(x.is("li")){r.breakParent(x);r.move(r.getNext(),1)}}else if(d&&
(x=d.getParent())&&x.is("li")){d.breakParent(x);x=d.getNext();g.moveToElementEditStart(x);d.move(d.getPrevious())}if(!q&&!a){if(r.is("li")){u=g.clone();u.selectNodeContents(r);u=new CKEDITOR.dom.walker(u);u.evaluator=function(a){return!(b(a)||e(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.getName()in CKEDITOR.dtd.$inline&&!(a.getName()in CKEDITOR.dtd.$empty))};(x=u.next())&&(x.type==CKEDITOR.NODE_ELEMENT&&x.is("ul","ol"))&&(CKEDITOR.env.needsBrFiller?p.createElement("br"):p.createText(" ")).insertBefore(x)}r&&
g.moveToElementEditStart(r)}else{if(d){if(d.is("li")||!h.test(d.getName())&&!d.is("pre"))u=d.clone()}else r&&(u=r.clone());if(u)o&&!u.is("li")&&u.renameNode(t);else if(x&&x.is("li"))u=x;else{u=p.createElement(t);d&&(v=d.getDirection())&&u.setAttribute("dir",v)}if(p=n.elementPath){o=0;for(t=p.elements.length;o<t;o++){x=p.elements[o];if(x.equals(p.block)||x.equals(p.blockLimit))break;if(CKEDITOR.dtd.$removeEmpty[x.getName()]){x=x.clone();u.moveChildren(x);u.append(x)}}}u.appendBogus();u.getParent()||
g.insertNode(u);u.is("li")&&u.removeAttribute("value");if(CKEDITOR.env.ie&&q&&(!a||!d.getChildCount())){g.moveToElementEditStart(a?d:u);g.select()}g.moveToElementEditStart(q&&!a?r:u)}g.select();g.scrollIntoView()}}},enterBr:function(a,b,c,e){if(c=c||f(a)){var g=c.document,i=c.checkEndOfBlock(),m=new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),q=m.block,r=q&&m.block.getName();if(!e&&r=="li")d(a,b,c,e);else{if(!e&&i&&h.test(r))if(i=q.getDirection()){g=g.createElement("div");g.setAttribute("dir",
i);g.insertAfter(q);c.setStart(g,0)}else{g.createElement("br").insertAfter(q);CKEDITOR.env.gecko&&g.createText("").insertAfter(q);c.setStartAt(q.getNext(),CKEDITOR.env.ie?CKEDITOR.POSITION_BEFORE_START:CKEDITOR.POSITION_AFTER_START)}else{a=r=="pre"&&CKEDITOR.env.ie&&CKEDITOR.env.version<8?g.createText("\r"):g.createElement("br");c.deleteContents();c.insertNode(a);if(CKEDITOR.env.needsBrFiller){g.createText("﻿").insertAfter(a);i&&(q||m.blockLimit).appendBogus();a.getNext().$.nodeValue="";c.setStartAt(a.getNext(),
...
this.getDialog();a.getParentEditor()._.filebrowserSe=this;return!a.getContentElement(this["for"][0],this["for"][1]).getInputElement().$.value||!a.getContentElement(this["for"][0],this["for"][1]).getAction()?false:true}function b(b,c,d){var e=d.params||{};e.CKEditor=b.name;e.CKEditorFuncNum=b._.filebrowserFn;if(!e.langCode)e.langCode=b.langCode;c.action=a(d.url,e);c.filebrowser=d}function g(a,d,i,l){if(l&&l.length)for(var o,p=l.length;p--;){o=l[p];(o.type=="hbox"||o.type=="vbox"||o.type=="fieldset")&&
g(a,d,i,o.children);if(o.filebrowser){if(typeof o.filebrowser=="string")o.filebrowser={action:o.type=="fileButton"?"QuickUpload":"Browse",target:o.filebrowser};if(o.filebrowser.action=="Browse"){var n=o.filebrowser.url;if(n===void 0){n=a.config["filebrowser"+f(d)+"BrowseUrl"];if(n===void 0)n=a.config.filebrowserBrowseUrl}if(n){o.onClick=c;o.filebrowser.url=n;o.hidden=false}}else if(o.filebrowser.action=="QuickUpload"&&o["for"]){n=o.filebrowser.url;if(n===void 0){n=a.config["filebrowser"+f(d)+"UploadUrl"];
if(n===void 0)n=a.config.filebrowserUploadUrl}if(n){var m=o.onClick;o.onClick=function(a){var b=a.sender;return m&&m.call(b,a)===false?false:e.call(b,a)};o.filebrowser.url=n;o.hidden=false;b(a,i.getContents(o["for"][0]).get(o["for"][1]),o.filebrowser)}}}}}function i(a,b,c){if(c.indexOf(";")!==-1){for(var c=c.split(";"),d=0;d<c.length;d++)if(i(a,b,c[d]))return true;return false}return(a=a.getContents(b).get(c).filebrowser)&&a.url}function d(a,b){var c=this._.filebrowserSe.getDialog(),d=this._.filebrowserSe["for"],
...
switch(a){case "top":d("absolute","top",b.y-t-x);break;case "pin":d("fixed","top",s);break;case "bottom":d("absolute","top",b.y+(q.height||q.bottom-q.top)+x)}j=a}var j,k,m,q,r,t,u,v=b.floatSpaceDockedOffsetX||0,x=b.floatSpaceDockedOffsetY||0,w=b.floatSpacePinnedOffsetX||0,s=b.floatSpacePinnedOffsetY||0;return function(b){if(k=a.editable()){b&&b.name=="focus"&&h.show();h.removeStyle("left");h.removeStyle("right");m=h.getClientRect();q=k.getClientRect();r=f.getViewPaneSize();t=m.height;u="pageXOffset"in
f.$?f.$.pageXOffset:CKEDITOR.document.$.documentElement.scrollLeft;if(j){t+x<=q.top?g("top"):t+x>r.height-q.bottom?g("pin"):g("bottom");var b=r.width/2,b=q.left>0&&q.right<r.width&&q.width>m.width?a.config.contentsLangDirection=="rtl"?"right":"left":b-q.left>q.right-b?"left":"right",d;if(m.width>r.width){b="left";d=0}else{d=b=="left"?q.left>0?q.left:0:q.right<r.width?r.width-q.right:0;if(d+m.width>r.width){b=b=="left"?"right":"left";d=0}}h.setStyle(b,c((j=="pin"?w:v)+d+(j=="pin"?0:b=="left"?u:-u)))}else{j=
...
CKEDITOR.ui.prototype.addRichCombo=function(a,e){this.add(a,CKEDITOR.UI_RICHCOMBO,e)}}(),function(){function a(a,e,b,g,i,d,h,j){for(var k=a.config,l=new CKEDITOR.style(h),o=i.split(";"),i=[],p={},n=0;n<o.length;n++){var m=o[n];if(m){var m=m.split("/"),q={},r=o[n]=m[0];q[b]=i[n]=m[1]||r;p[r]=new CKEDITOR.style(h,q);p[r]._.definition.name=r}else o.splice(n--,1)}a.ui.addRichCombo(e,{label:g.label,title:g.panelTitle,toolbar:"styles,"+j,allowedContent:l,requiredContent:l,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(k.contentsCss),
multiSelect:false,attributes:{"aria-label":g.panelTitle}},init:function(){this.startGroup(g.panelTitle);for(var a=0;a<o.length;a++){var b=o[a];this.add(b,p[b].buildPreview(),b)}},onClick:function(b){a.focus();a.fire("saveSnapshot");var d=this.getValue(),e=p[b];if(d&&b!=d){var g=p[d],h=a.getSelection().getRanges()[0];if(h.collapsed){var i=a.elementPath(),j=i.contains(function(a){return g.checkElementRemovable(a)});if(j){var k=h.checkBoundaryOfElement(j,CKEDITOR.START),r=h.checkBoundaryOfElement(j,
CKEDITOR.END);if(k&&r){for(k=h.createBookmark();i=j.getFirst();)i.insertBefore(j);j.remove();h.moveToBookmark(k)}else if(k)h.moveToPosition(j,CKEDITOR.POSITION_BEFORE_START);else if(r)h.moveToPosition(j,CKEDITOR.POSITION_AFTER_END);else{h.splitElement(j);h.moveToPosition(j,CKEDITOR.POSITION_AFTER_END);f(h,i.elements.slice(),j)}a.getSelection().selectRanges([h])}}else a.removeStyle(g)}a[d==b?"removeStyle":"applyStyle"](e);a.fire("saveSnapshot")},onRender:function(){a.on("selectionChange",function(b){for(var e=
this.getValue(),b=b.data.path.elements,f=0,g;f<b.length;f++){g=b[f];for(var h in p)if(p[h].checkElementMatch(g,true,a)){h!=e&&this.setValue(h);return}}this.setValue("",d)},this)},refresh:function(){a.activeFilter.check(l)||this.setState(CKEDITOR.TRISTATE_DISABLED)}})}function f(a,e,b){var g=e.pop();if(g){if(b)return f(a,e,g.equals(b)?null:b);b=g.clone();a.insertNode(b);a.moveToPosition(b,CKEDITOR.POSITION_AFTER_START);f(a,e)}}CKEDITOR.plugins.add("font",{requires:"richcombo",init:function(c){var e=
...
function(){function a(a){function b(f){for(var h=p.startContainer,n=p.endContainer;h&&!h.getParent().equals(f);)h=h.getParent();for(;n&&!n.getParent().equals(f);)n=n.getParent();if(!h||!n)return false;for(var m=h,h=[],o=false;!o;){m.equals(n)&&(o=true);h.push(m);m=m.getNext()}if(h.length<1)return false;m=f.getParents(true);for(n=0;n<m.length;n++)if(m[n].getName&&i[m[n].getName()]){f=m[n];break}for(var m=e.isIndent?1:-1,n=h[0],h=h[h.length-1],o=CKEDITOR.plugins.list.listToArray(f,g),x=o[h.getCustomData("listarray_index")].indent,
n=n.getCustomData("listarray_index");n<=h.getCustomData("listarray_index");n++){o[n].indent=o[n].indent+m;if(m>0){var w=o[n].parent;o[n].parent=new CKEDITOR.dom.element(w.getName(),w.getDocument())}}for(n=h.getCustomData("listarray_index")+1;n<o.length&&o[n].indent>x;n++)o[n].indent=o[n].indent+m;h=CKEDITOR.plugins.list.arrayToList(o,g,null,a.config.enterMode,f.getDirection());if(!e.isIndent){var s;if((s=f.getParent())&&s.is("li"))for(var m=h.listNode.getChildren(),y=[],z,n=m.count()-1;n>=0;n--)(z=
m.getItem(n))&&(z.is&&z.is("li"))&&y.push(z)}h&&h.listNode.replace(f);if(y&&y.length)for(n=0;n<y.length;n++){for(z=f=y[n];(z=z.getNext())&&z.is&&z.getName()in i;){CKEDITOR.env.needsNbspFiller&&!f.getFirst(c)&&f.append(p.document.createText(" "));f.append(z)}f.insertAfter(s)}h&&a.fire("contentDomInvalidated");return true}for(var e=this,g=this.database,i=this.context,o=a.getSelection(),o=(o&&o.getRanges()).createIterator(),p;p=o.getNextRange();){for(var n=p.getCommonAncestor();n&&!(n.type==CKEDITOR.NODE_ELEMENT&&
i[n.getName()]);)n=n.getParent();n||(n=p.startPath().contains(i))&&p.setEndAt(n,CKEDITOR.POSITION_BEFORE_END);if(!n){var m=p.getEnclosedNode();if(m&&m.type==CKEDITOR.NODE_ELEMENT&&m.getName()in i){p.setStartAt(m,CKEDITOR.POSITION_AFTER_START);p.setEndAt(m,CKEDITOR.POSITION_BEFORE_END);n=m}}if(n&&p.startContainer.type==CKEDITOR.NODE_ELEMENT&&p.startContainer.getName()in i){m=new CKEDITOR.dom.walker(p);m.evaluator=f;p.startContainer=m.next()}if(n&&p.endContainer.type==CKEDITOR.NODE_ELEMENT&&p.endContainer.getName()in
i){m=new CKEDITOR.dom.walker(p);m.evaluator=f;p.endContainer=m.previous()}if(n)return b(n)}return 0}function f(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.is("li")}function c(a){return e(a)&&b(a)}var e=CKEDITOR.dom.walker.whitespaces(true),b=CKEDITOR.dom.walker.bookmark(false,true),g=CKEDITOR.TRISTATE_DISABLED,i=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentlist",{requires:"indent",init:function(b){function c(b){e.specificDefinition.apply(this,arguments);this.requiredContent=["ul","ol"];b.on("key",
function(a){if(b.mode=="wysiwyg"&&a.data.keyCode==this.indentKey){var c=this.getContext(b.elementPath());if(c&&(!this.isIndent||!CKEDITOR.plugins.indentList.firstItemInPath(this.context,b.elementPath(),c))){b.execCommand(this.relatedGlobal);a.cancel()}}},this);this.jobs[this.isIndent?10:30]={refresh:this.isIndent?function(a,b){var c=this.getContext(b),d=CKEDITOR.plugins.indentList.firstItemInPath(this.context,b,c);return!c||!this.isIndent||d?g:i}:function(a,b){return!this.getContext(b)||this.isIndent?
g:i},exec:CKEDITOR.tools.bind(a,this)}}var e=CKEDITOR.plugins.indent;e.registerCommands(b,{indentlist:new c(b,"indentlist",true),outdentlist:new c(b,"outdentlist")});CKEDITOR.tools.extend(c.prototype,e.specificDefinition.prototype,{context:{ol:1,ul:1}})}});CKEDITOR.plugins.indentList={};CKEDITOR.plugins.indentList.firstItemInPath=function(a,b,c){var e=b.contains(f);c||(c=b.contains(a));return c&&e&&e.equals(c.getFirst(f))}}(),function(){function a(a,b,c){if(!a.getCustomData("indent_processed")){var e=
...
a.getAttribute("style")===""&&a.removeAttribute("style")}CKEDITOR.dom.element.setMarker(this.database,a,"indent_processed",1)}}function f(a,b){return(b||a.getComputedStyle("direction"))=="ltr"?"margin-left":"margin-right"}var c=CKEDITOR.dtd.$listItem,e=CKEDITOR.dtd.$list,b=CKEDITOR.TRISTATE_DISABLED,g=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentblock",{requires:"indent",init:function(i){function d(){h.specificDefinition.apply(this,arguments);this.allowedContent={"div h1 h2 h3 h4 h5 h6 ol p pre ul":{propertiesOnly:true,
styles:!j?"margin-left,margin-right":null,classes:j||null}};if(this.enterBr)this.allowedContent.div=true;this.requiredContent=(this.enterBr?"div":"p")+(j?"("+j.join(",")+")":"{margin-left}");this.jobs={20:{refresh:function(a,d){var e=d.block||d.blockLimit;e.is(c)||(e=e.getAscendant(c)||e);e.is(c)&&(e=e.getParent());if(!this.enterBr&&!this.getContext(d))return b;if(j){var h;h=j;var e=e.$.className.match(this.classNameRegex),i=this.isIndent;h=e?i?e[1]!=h.slice(-1):true:i;return h?g:b}return this.isIndent?
g:e?CKEDITOR[(parseInt(e.getStyle(f(e)),10)||0)<=0?"TRISTATE_DISABLED":"TRISTATE_OFF"]:b},exec:function(b){var c=b.getSelection(),c=c&&c.getRanges()[0],d;if(d=b.elementPath().contains(e))a.call(this,d,j);else{c=c.createIterator();b=b.config.enterMode;c.enforceRealBlocks=true;for(c.enlargeBr=b!=CKEDITOR.ENTER_BR;d=c.getNextParagraph(b==CKEDITOR.ENTER_P?"p":"div");)d.isReadOnly()||a.call(this,d,j)}return true}}}}var h=CKEDITOR.plugins.indent,j=i.config.indentClasses;h.registerCommands(i,{indentblock:new d(i,
...
d;d=f.next();)if(d.type==CKEDITOR.NODE_ELEMENT)if(!d.equals(a.data.node)&&d.getDirection()){c.setStartAfter(d);f=new CKEDITOR.dom.walker(c)}else{var h=b.config.justifyClasses;if(h)if(d.hasClass(h[0])){d.removeClass(h[0]);d.addClass(h[2])}else if(d.hasClass(h[2])){d.removeClass(h[2]);d.addClass(h[0])}h=d.getStyle("text-align");h=="left"?d.setStyle("text-align","right"):h=="right"&&d.setStyle("text-align","left")}}f.prototype={exec:function(c){var b=c.getSelection(),f=c.config.enterMode;if(b){for(var i=
b.createBookmarks(),d=b.getRanges(),h=this.cssClassName,j,k,l=c.config.useComputedState,l=l===void 0||l,o=d.length-1;o>=0;o--){j=d[o].createIterator();for(j.enlargeBr=f!=CKEDITOR.ENTER_BR;k=j.getNextParagraph(f==CKEDITOR.ENTER_P?"p":"div");)if(!k.isReadOnly()){k.removeAttribute("align");k.removeStyle("text-align");var p=h&&(k.$.className=CKEDITOR.tools.ltrim(k.$.className.replace(this.cssClassRegex,""))),n=this.state==CKEDITOR.TRISTATE_OFF&&(!l||a(k,true)!=this.value);h?n?k.addClass(h):p||k.removeAttribute("class"):
n&&k.setStyle("text-align",this.value)}}c.focus();c.forceNextSelectionCheck();b.selectBookmarks(i)}},refresh:function(c,b){var f=b.block||b.blockLimit;this.setState(f.getName()!="body"&&a(f,this.editor.config.useComputedState)==this.value?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF)}};CKEDITOR.plugins.add("justify",{init:function(a){if(!a.blockless){var b=new f(a,"justifyleft","left"),g=new f(a,"justifycenter","center"),i=new f(a,"justifyright","right"),d=new f(a,"justifyblock","justify");a.addCommand("justifyleft",
b);a.addCommand("justifycenter",g);a.addCommand("justifyright",i);a.addCommand("justifyblock",d);if(a.ui.addButton){a.ui.addButton("JustifyLeft",{label:a.lang.justify.left,command:"justifyleft",toolbar:"align,10"});a.ui.addButton("JustifyCenter",{label:a.lang.justify.center,command:"justifycenter",toolbar:"align,20"});a.ui.addButton("JustifyRight",{label:a.lang.justify.right,command:"justifyright",toolbar:"align,30"});a.ui.addButton("JustifyBlock",{label:a.lang.justify.block,command:"justifyblock",
...
e(a)},afterInit:function(a){a.dataProcessor.dataFilter.addRules({elements:{a:function(b){return!b.attributes.name?null:!b.children.length?a.createFakeParserElement(b,"cke_anchor","anchor"):null}}});var b=a._.elementsPath&&a._.elementsPath.filters;b&&b.push(function(b,c){if(c=="a"&&(CKEDITOR.plugins.link.tryRestoreFakeAnchor(a,b)||b.getAttribute("name")&&(!b.getAttribute("href")||!b.getChildCount())))return"anchor"})}});var b=/^javascript:/,g=/^mailto:([^?]+)(?:\?(.+))?$/,i=/subject=([^;?:@&=$,\/]*)/,
d=/body=([^;?:@&=$,\/]*)/,h=/^#(.*)$/,j=/^((?:http|https|ftp|news):\/\/)?(.*)$/,k=/^(_(?:self|top|parent|blank))$/,l=/^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/,o=/^javascript:([^(]+)\(([^)]+)\)$/,p=/\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/,n=/(?:^|,)([^=]+)=(\d+|yes|no)/gi,m={id:"advId",dir:"advLangDir",accessKey:"advAccessKey",name:"advName",lang:"advLangCode",tabindex:"advTabIndex",title:"advTitle",
...
parseLinkAttributes:function(a,c){var e=c&&(c.data("cke-saved-href")||c.getAttribute("href"))||"",f=a.plugins.link.compiledProtectionFunction,v=a.config.emailProtection,x,w={};e.match(b)&&(v=="encode"?e=e.replace(l,function(a,b,c){return"mailto:"+String.fromCharCode.apply(String,b.split(","))+(c&&c.replace(/\\'/g,"'"))}):v&&e.replace(o,function(a,b,c){if(b==f.name){w.type="email";for(var a=w.email={},b=/(^')|('$)/g,c=c.match(/[^,\s]+/g),d=c.length,e,g,h=0;h<d;h++){e=decodeURIComponent;g=c[h].replace(b,
"").replace(/\\'/g,"'");g=e(g);e=f.params[h].toLowerCase();a[e]=g}a.address=[a.name,a.domain].join("@")}}));if(!w.type)if(v=e.match(h)){w.type="anchor";w.anchor={};w.anchor.name=w.anchor.id=v[1]}else if(v=e.match(g)){x=e.match(i);e=e.match(d);w.type="email";var s=w.email={};s.address=v[1];x&&(s.subject=decodeURIComponent(x[1]));e&&(s.body=decodeURIComponent(e[1]))}else if(e&&(x=e.match(j))){w.type="url";w.url={};w.url.protocol=x[1];w.url.url=x[2]}if(c){if(e=c.getAttribute("target"))w.target={type:e.match(k)?
...
j,k;d(true);d();i.replace(b.root);a.fire("contentDomInvalidated")}function f(a,b){this.name=a;this.context=this.type=b;this.allowedContent=b+" li";this.requiredContent=b}function c(a,b,c,d){for(var e,f;e=a[d?"getLast":"getFirst"](p);){(f=e.getDirection(1))!==b.getDirection(1)&&e.setAttribute("dir",f);e.remove();c?e[d?"insertBefore":"insertAfter"](c):b.append(e,d)}}function e(a){function b(d){var e=a[d?"getPrevious":"getNext"](k);if(e&&e.type==CKEDITOR.NODE_ELEMENT&&e.is(a.getName())){c(a,e,null,!d);
a.remove();a=e}}b();b(1)}function b(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.getName()in CKEDITOR.dtd.$block||a.getName()in CKEDITOR.dtd.$listItem)&&CKEDITOR.dtd[a.getName()]["#"]}function g(a,b,d){a.fire("saveSnapshot");d.enlarge(CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS);var f=d.extractContents();b.trim(false,true);var g=b.createBookmark(),h=new CKEDITOR.dom.elementPath(b.startContainer),j=h.block,h=h.lastElement.getAscendant("li",1)||j,p=new CKEDITOR.dom.elementPath(d.startContainer),o=p.contains(CKEDITOR.dtd.$listItem),
p=p.contains(CKEDITOR.dtd.$list);if(j)(j=j.getBogus())&&j.remove();else if(p)(j=p.getPrevious(k))&&l(j)&&j.remove();(j=f.getLast())&&(j.type==CKEDITOR.NODE_ELEMENT&&j.is("br"))&&j.remove();(j=b.startContainer.getChild(b.startOffset))?f.insertBefore(j):b.startContainer.append(f);if(o)if(f=i(o))if(h.contains(o)){c(f,o.getParent(),o);f.remove()}else h.append(f);for(;d.checkStartOfBlock()&&d.checkEndOfBlock();){p=d.startPath();f=p.block;if(!f)break;if(f.is("li")){h=f.getParent();f.equals(h.getLast(k))&&
...
j=CKEDITOR.dom.walker.bookmark(),k=function(a){return!(h(a)||j(a))},l=CKEDITOR.dom.walker.bogus();CKEDITOR.plugins.list={listToArray:function(a,b,c,e,f){if(!d[a.getName()])return[];e||(e=0);c||(c=[]);for(var g=0,h=a.getChildCount();g<h;g++){var i=a.getChild(g);i.type==CKEDITOR.NODE_ELEMENT&&i.getName()in CKEDITOR.dtd.$list&&CKEDITOR.plugins.list.listToArray(i,b,c,e+1);if(i.$.nodeName.toLowerCase()=="li"){var j={parent:a,indent:e,element:i,contents:[]};if(f)j.grandparent=f;else{j.grandparent=a.getParent();
if(j.grandparent&&j.grandparent.$.nodeName.toLowerCase()=="li")j.grandparent=j.grandparent.getParent()}b&&CKEDITOR.dom.element.setMarker(b,i,"listarray_index",c.length);c.push(j);for(var k=0,l=i.getChildCount(),p;k<l;k++){p=i.getChild(k);p.type==CKEDITOR.NODE_ELEMENT&&d[p.getName()]?CKEDITOR.plugins.list.listToArray(p,b,c,e+1,j.grandparent):j.contents.push(p)}}}return c},arrayToList:function(a,b,c,e,f){c||(c=0);if(!a||a.length<c+1)return null;for(var g,h=a[c].parent.getDocument(),i=new CKEDITOR.dom.documentFragment(h),
l=null,p=c,o=Math.max(a[c].indent,0),z=null,B,A,F=e==CKEDITOR.ENTER_P?"p":"div";;){var C=a[p];g=C.grandparent;B=C.element.getDirection(1);if(C.indent==o){if(!l||a[p].parent.getName()!=l.getName()){l=a[p].parent.clone(false,1);f&&l.setAttribute("dir",f);i.append(l)}z=l.append(C.element.clone(0,1));B!=l.getDirection(1)&&z.setAttribute("dir",B);for(g=0;g<C.contents.length;g++)z.append(C.contents[g].clone(1,1));p++}else if(C.indent==Math.max(o,0)+1){C=a[p-1].element.getDirection(1);p=CKEDITOR.plugins.list.arrayToList(a,
null,p,e,C!=B?B:null);!z.getChildCount()&&(CKEDITOR.env.needsNbspFiller&&h.$.documentMode<=7)&&z.append(h.createText(" "));z.append(p.listNode);p=p.nextIndex}else if(C.indent==-1&&!c&&g){if(d[g.getName()]){z=C.element.clone(false,true);B!=g.getDirection(1)&&z.setAttribute("dir",B)}else z=new CKEDITOR.dom.documentFragment(h);var l=g.getDirection(1)!=B,J=C.element,G=J.getAttribute("class"),E=J.getAttribute("style"),D=z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&(e!=CKEDITOR.ENTER_BR||l||E||G),I,L=C.contents.length,
H;for(g=0;g<L;g++){I=C.contents[g];if(j(I)&&L>1)D?H=I.clone(1,1):z.append(I.clone(1,1));else if(I.type==CKEDITOR.NODE_ELEMENT&&I.isBlockBoundary()){l&&!I.getDirection()&&I.setAttribute("dir",B);A=I;var Q=J.getAttribute("style");Q&&A.setAttribute("style",Q.replace(/([^;])$/,"$1;")+(A.getAttribute("style")||""));G&&I.addClass(G);A=null;if(H){z.append(H);H=null}z.append(I.clone(1,1))}else if(D){if(!A){A=h.createElement(F);z.append(A);l&&A.setAttribute("dir",B)}E&&A.setAttribute("style",E);G&&A.setAttribute("class",
G);if(H){A.append(H);H=null}A.append(I.clone(1,1))}else z.append(I.clone(1,1))}if(H){(A||z).append(H);H=null}if(z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&p!=a.length-1){if(CKEDITOR.env.needsBrFiller)(B=z.getLast())&&(B.type==CKEDITOR.NODE_ELEMENT&&B.is("br"))&&B.remove();B=z.getLast(k);(!B||!(B.type==CKEDITOR.NODE_ELEMENT&&B.is(CKEDITOR.dtd.$block)))&&z.append(h.createElement("br"))}B=z.$.nodeName.toLowerCase();(B=="div"||B=="p")&&z.appendBogus();i.append(z);l=null;p++}else return null;A=null;if(a.length<=
p||Math.max(a[p].indent,0)<o)break}if(b)for(a=i.getFirst();a;){if(a.type==CKEDITOR.NODE_ELEMENT){CKEDITOR.dom.element.clearMarkers(b,a);if(a.getName()in CKEDITOR.dtd.$listItem){c=a;h=f=e=void 0;if(e=c.getDirection()){for(f=c.getParent();f&&!(h=f.getDirection());)f=f.getParent();e==h&&c.removeAttribute("dir")}}}a=a.getNextSourceNode()}return{listNode:i,nextIndex:p}}};var o=/^h[1-6]$/,p=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_ELEMENT);f.prototype={exec:function(b){this.refresh(b,b.elementPath());
var c=b.config,f=b.getSelection(),g=f&&f.getRanges();if(this.state==CKEDITOR.TRISTATE_OFF){var h=b.editable();if(h.getFirst(k)){var i=g.length==1&&g[0];(c=i&&i.getEnclosedNode())&&(c.is&&this.type==c.getName())&&this.setState(CKEDITOR.TRISTATE_ON)}else{c.enterMode==CKEDITOR.ENTER_BR?h.appendBogus():g[0].fixBlock(1,c.enterMode==CKEDITOR.ENTER_P?"p":"div");f.selectRanges(g)}}for(var c=f.createBookmarks(true),h=[],j={},g=g.createIterator(),l=0;(i=g.getNextRange())&&++l;){var p=i.getBoundaryNodes(),s=
p.startNode,y=p.endNode;s.type==CKEDITOR.NODE_ELEMENT&&s.getName()=="td"&&i.setStartAt(p.startNode,CKEDITOR.POSITION_AFTER_START);y.type==CKEDITOR.NODE_ELEMENT&&y.getName()=="td"&&i.setEndAt(p.endNode,CKEDITOR.POSITION_BEFORE_END);i=i.createIterator();for(i.forceBrBreak=this.state==CKEDITOR.TRISTATE_OFF;p=i.getNextParagraph();)if(!p.getCustomData("list_block")){CKEDITOR.dom.element.setMarker(j,p,"list_block",1);for(var z=b.elementPath(p),s=z.elements,y=0,z=z.blockLimit,B,A=s.length-1;A>=0&&(B=s[A]);A--)if(d[B.getName()]&&
z.contains(B)){z.removeCustomData("list_group_object_"+l);if(s=B.getCustomData("list_group_object"))s.contents.push(p);else{s={root:B,contents:[p]};h.push(s);CKEDITOR.dom.element.setMarker(j,B,"list_group_object",s)}y=1;break}if(!y){y=z;if(y.getCustomData("list_group_object_"+l))y.getCustomData("list_group_object_"+l).contents.push(p);else{s={root:y,contents:[p]};CKEDITOR.dom.element.setMarker(j,y,"list_group_object_"+l,s);h.push(s)}}}}for(B=[];h.length>0;){s=h.shift();if(this.state==CKEDITOR.TRISTATE_OFF)if(d[s.root.getName()]){g=
b;l=s;s=j;i=B;y=CKEDITOR.plugins.list.listToArray(l.root,s);z=[];for(p=0;p<l.contents.length;p++){A=l.contents[p];if((A=A.getAscendant("li",true))&&!A.getCustomData("list_item_processed")){z.push(A);CKEDITOR.dom.element.setMarker(s,A,"list_item_processed",true)}}for(var A=l.root.getDocument(),F=void 0,C=void 0,p=0;p<z.length;p++){var J=z[p].getCustomData("listarray_index"),F=y[J].parent;if(!F.is(this.type)){C=A.createElement(this.type);F.copyAttributes(C,{start:1,type:1});C.removeStyle("list-style-type");
y[J].parent=C}}s=CKEDITOR.plugins.list.arrayToList(y,s,null,g.config.enterMode);y=void 0;z=s.listNode.getChildCount();for(p=0;p<z&&(y=s.listNode.getChild(p));p++)y.getName()==this.type&&i.push(y);s.listNode.replace(l.root);g.fire("contentDomInvalidated")}else{y=b;p=s;i=B;z=p.contents;g=p.root.getDocument();l=[];if(z.length==1&&z[0].equals(p.root)){s=g.createElement("div");z[0].moveChildren&&z[0].moveChildren(s);z[0].append(s);z[0]=s}p=p.contents[0].getParent();for(A=0;A<z.length;A++)p=p.getCommonAncestor(z[A].getParent());
F=y.config.useComputedState;y=s=void 0;F=F===void 0||F;for(A=0;A<z.length;A++)for(C=z[A];J=C.getParent();){if(J.equals(p)){l.push(C);!y&&C.getDirection()&&(y=1);C=C.getDirection(F);s!==null&&(s=s&&s!=C?null:C);break}C=J}if(!(l.length<1)){z=l[l.length-1].getNext();A=g.createElement(this.type);i.push(A);for(F=i=void 0;l.length;){i=l.shift();F=g.createElement("li");if(i.is("pre")||o.test(i.getName())||i.getAttribute("contenteditable")=="false")i.appendTo(F);else{i.copyAttributes(F);if(s&&i.getDirection()){F.removeStyle("direction");
F.removeAttribute("dir")}i.moveChildren(F);i.remove()}F.appendTo(A)}s&&y&&A.setAttribute("dir",s);z?A.insertBefore(z):A.appendTo(p)}}else this.state==CKEDITOR.TRISTATE_ON&&d[s.root.getName()]&&a.call(this,b,s,j)}for(A=0;A<B.length;A++)e(B[A]);CKEDITOR.dom.element.clearAllMarkers(j);f.selectBookmarks(c);b.focus()},refresh:function(a,b){var c=b.contains(d,1),e=b.blockLimit||b.root;c&&e.contains(c)?this.setState(c.is(this.type)?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF):this.setState(CKEDITOR.TRISTATE_OFF)}};
...
f;if(a.mode=="wysiwyg"&&e in{8:1,46:1}){var h=a.getSelection().getRanges()[0],j=h&&h.startPath();if(h&&h.collapsed){var p=e==8,o=a.editable(),w=new CKEDITOR.dom.walker(h.clone());w.evaluator=function(a){return k(a)&&!l(a)};w.guard=function(a,b){return!(b&&a.type==CKEDITOR.NODE_ELEMENT&&a.is("table"))};e=h.clone();if(p){var s;if((s=j.contains(d))&&h.checkBoundaryOfElement(s,CKEDITOR.START)&&(s=s.getParent())&&s.is("li")&&(s=i(s))){f=s;s=s.getPrevious(k);e.moveToPosition(s&&l(s)?s:f,CKEDITOR.POSITION_BEFORE_START)}else{w.range.setStartAt(o,
CKEDITOR.POSITION_AFTER_START);w.range.setEnd(h.startContainer,h.startOffset);if((s=w.previous())&&s.type==CKEDITOR.NODE_ELEMENT&&(s.getName()in d||s.is("li"))){if(!s.is("li")){w.range.selectNodeContents(s);w.reset();w.evaluator=b;s=w.previous()}f=s;e.moveToElementEditEnd(f)}}if(f){g(a,e,h);c.cancel()}else if((e=j.contains(d))&&h.checkBoundaryOfElement(e,CKEDITOR.START)){f=e.getFirst(k);if(h.checkBoundaryOfElement(f,CKEDITOR.START)){s=e.getPrevious(k);if(i(f)){if(s){h.moveToElementEditEnd(s);h.select()}}else a.execCommand("outdent");
c.cancel()}}}else if(f=j.contains("li")){w.range.setEndAt(o,CKEDITOR.POSITION_BEFORE_END);f=(j=f.getLast(k))&&b(j)?j:f;o=0;if((s=w.next())&&s.type==CKEDITOR.NODE_ELEMENT&&s.getName()in d&&s.equals(j)){o=1;s=w.next()}else h.checkBoundaryOfElement(f,CKEDITOR.END)&&(o=1);if(o&&s){h=h.clone();h.moveToElementEditStart(s);g(a,e,h);c.cancel()}}else{w.range.setEndAt(o,CKEDITOR.POSITION_BEFORE_END);if((s=w.next())&&s.type==CKEDITOR.NODE_ELEMENT&&s.is(d)){s=s.getFirst(k);if(j.block&&h.checkStartOfBlock()&&
h.checkEndOfBlock()){j.block.remove();h.moveToElementEditStart(s);h.select()}else if(i(s)){h.moveToElementEditStart(s);h.select()}else{h=h.clone();h.moveToElementEditStart(s);g(a,e,h)}c.cancel()}}setTimeout(function(){a.selectionChange(1)})}}})}}})}(),function(){CKEDITOR.plugins.liststyle={requires:"dialog,contextmenu",init:function(a){if(!a.blockless){var f;f=new CKEDITOR.dialogCommand("numberedListStyle",{requiredContent:"ol",allowedContent:"ol{list-style-type}[start]"});f=a.addCommand("numberedListStyle",
...
a[1];this.set.apply(this,a.slice(2))}function c(a){var b=a.element;if(b&&k(b))if((b=b.getAscendant(a.triggers,true))&&a.editable.contains(b)){var c=g(b);if(c.getAttribute("contenteditable")=="true")return b;if(c.is(a.triggers))return c}return null}function e(a,b,c){u(a,b);u(a,c);a=b.size.bottom;c=c.size.top;return a&&c?0|(a+c)/2:a||c}function b(a,b,c){return b=b[c?"getPrevious":"getNext"](function(b){return b&&b.type==CKEDITOR.NODE_TEXT&&!Y(b)||k(b)&&!l(b)&&!j(a,b)})}function g(a,b){if(a.data("cke-editable"))return null;
for(b||(a=a.getParent());a;){if(a.data("cke-editable"))break;if(a.hasAttribute("contenteditable"))return a;a=a.getParent()}return null}function i(a){var b=a.doc,c=z('<span contenteditable="false" style="'+P+"position:absolute;border-top:1px dashed "+a.boxColor+'"></span>',b),e=CKEDITOR.getUrl(this.path+"images/"+(B.hidpi?"hidpi/":"")+"icon"+(a.rtl?"-rtl":"")+".png");s(c,{attach:function(){this.wrap.getParent()||this.wrap.appendTo(a.editable,true);return this},lineChildren:[s(z('<span title="'+a.editor.lang.magicline.title+
...
"0px 0px 2px 2px",1)]}),s(z(W,b),{base:V+"left:0px;border-left-color:"+a.boxColor+";",looks:["border-width:8px 0 8px 8px;top:-8px","border-width:8px 0 0 8px;top:-8px","border-width:0 0 8px 8px;top:0px"]}),s(z(W,b),{base:V+"right:0px;border-right-color:"+a.boxColor+";",looks:["border-width:8px 8px 8px 0;top:-8px","border-width:8px 8px 0 0;top:-8px","border-width:0 8px 8px 0;top:0px"]})],detach:function(){this.wrap.getParent()&&this.wrap.remove();return this},mouseNear:function(){u(a,this);var b=a.holdDistance,
c=this.size;return c&&a.mouse.y>c.top-b&&a.mouse.y<c.bottom+b&&a.mouse.x>c.left-b&&a.mouse.x<c.right+b?true:false},place:function(){var b=a.view,c=a.editable,d=a.trigger,e=d.upper,f=d.lower,g=e||f,h=g.getParent(),i={};this.trigger=d;e&&u(a,e,true);f&&u(a,f,true);u(a,h,true);a.inInlineMode&&v(a,true);if(h.equals(c)){i.left=b.scroll.x;i.right=-b.scroll.x;i.width=""}else{i.left=g.size.left-g.size.margin.left+b.scroll.x-(a.inInlineMode?b.editable.left+b.editable.border.left:0);i.width=g.size.outerWidth+
...
!b.is(K)});if(!b)return false;u(a,b);return c?b.size.top>a.mouse.y:b.size.bottom<a.mouse.y}function q(a){var b=a.editable,c=a.mouse,d=a.view,e=a.triggerOffset;v(a);var g=c.y>(a.inInlineMode?d.editable.top+d.editable.height/2:Math.min(d.editable.height,d.pane.height)/2),b=b[g?"getLast":"getFirst"](function(a){return!(Y(a)||Z(a))});if(!b)return null;j(a,b)&&(b=a.line.wrap[g?"getPrevious":"getNext"](function(a){return!(Y(a)||Z(a))}));if(!k(b)||l(b)||!p(a,b))return null;u(a,b);if(!g&&b.size.top>=0&&c.y>
0&&c.y<b.size.top+e){a=a.inInlineMode||d.scroll.y===0?L:Q;return new f([null,b,J,D,a])}if(g&&b.size.bottom<=d.pane.height&&c.y>b.size.bottom-e&&c.y<d.pane.height){a=a.inInlineMode||b.size.bottom>d.pane.height-e&&b.size.bottom<d.pane.height?H:Q;return new f([b,null,G,D,a])}return null}function r(a){var d=a.mouse,e=a.view,g=a.triggerOffset,h=c(a);if(!h)return null;u(a,h);var g=Math.min(g,0|h.size.outerHeight/2),i=[],j,n;if(d.y>h.size.top-1&&d.y<h.size.top+g)n=false;else if(d.y>h.size.bottom-g&&d.y<
h.size.bottom+1)n=true;else return null;if(l(h)||m(a,h,n)||h.getParent().is(M))return null;var r=b(a,h,!n);if(r){if(r&&r.type==CKEDITOR.NODE_TEXT)return null;if(k(r)){if(l(r)||!p(a,r)||r.getParent().is(M))return null;i=[r,h][n?"reverse":"concat"]().concat([E,D])}}else{if(h.equals(a.editable[n?"getLast":"getFirst"](a.isRelevant))){v(a);n&&d.y>h.size.bottom-g&&d.y<e.pane.height&&h.size.bottom>e.pane.height-g&&h.size.bottom<e.pane.height?j=H:d.y>0&&d.y<h.size.top+g&&(j=L)}else j=Q;i=[null,h][n?"reverse":
...
c.inline;f(d)}function b(a){if(!a.editable().isInline()){var b=CKEDITOR.instances,c;for(c in b){var e=b[c];if(e.mode=="wysiwyg"&&!e.readOnly){e=e.document.getBody();e.setAttribute("contentEditable",false);e.setAttribute("contentEditable",true)}}if(a.editable().hasFocus){a.toolbox.focus();a.focus()}}}CKEDITOR.plugins.add("maximize",{init:function(a){function f(){var b=j.getViewPaneSize();a.resize(b.width,b.height,null,true)}if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){var d=a.lang,h=CKEDITOR.document,
j=h.getWindow(),k,l,o,p=CKEDITOR.TRISTATE_OFF;a.addCommand("maximize",{modes:{wysiwyg:!CKEDITOR.env.iOS,source:!CKEDITOR.env.iOS},readOnly:1,editorFocus:false,exec:function(){var n=a.container.getFirst(function(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasClass("cke_inner")}),m=a.ui.space("contents");if(a.mode=="wysiwyg"){var q=a.getSelection();k=q&&q.getRanges();l=j.getScrollPosition()}else{var r=a.editable().$;k=!CKEDITOR.env.ie&&[r.selectionStart,r.selectionEnd];l=[r.scrollLeft,r.scrollTop]}if(this.state==
CKEDITOR.TRISTATE_OFF){j.on("resize",f);o=j.getScrollPosition();for(q=a.container;q=q.getParent();){q.setCustomData("maximize_saved_styles",c(q));q.setStyle("z-index",a.config.baseFloatZIndex-5)}m.setCustomData("maximize_saved_styles",c(m,true));n.setCustomData("maximize_saved_styles",c(n,true));m={overflow:CKEDITOR.env.webkit?"":"hidden",width:0,height:0};h.getDocumentElement().setStyles(m);!CKEDITOR.env.gecko&&h.getDocumentElement().setStyle("position","fixed");(!CKEDITOR.env.gecko||!CKEDITOR.env.quirks)&&
h.getBody().setStyles(m);CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(0,0)},0):j.$.scrollTo(0,0);n.setStyle("position",CKEDITOR.env.gecko&&CKEDITOR.env.quirks?"fixed":"absolute");n.$.offsetLeft;n.setStyles({"z-index":a.config.baseFloatZIndex-5,left:"0px",top:"0px"});n.addClass("cke_maximized");f();m=n.getDocumentPosition();n.setStyles({left:-1*m.x+"px",top:-1*m.y+"px"});CKEDITOR.env.gecko&&b(a)}else if(this.state==CKEDITOR.TRISTATE_ON){j.removeListener("resize",f);m=[m,n];for(q=0;q<m.length;q++){e(m[q],
m[q].getCustomData("maximize_saved_styles"));m[q].removeCustomData("maximize_saved_styles")}for(q=a.container;q=q.getParent();){e(q,q.getCustomData("maximize_saved_styles"));q.removeCustomData("maximize_saved_styles")}CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(o.x,o.y)},0):j.$.scrollTo(o.x,o.y);n.removeClass("cke_maximized");if(CKEDITOR.env.webkit){n.setStyle("display","inline");setTimeout(function(){n.setStyle("display","block")},0)}a.fire("resize")}this.toggleState();if(q=this.uiItems[0]){m=
this.state==CKEDITOR.TRISTATE_OFF?d.maximize.maximize:d.maximize.minimize;q=CKEDITOR.document.getById(q._.id);q.getChild(1).setHtml(m);q.setAttribute("title",m);q.setAttribute("href",'javascript:void("'+m+'");')}if(a.mode=="wysiwyg")if(k){CKEDITOR.env.gecko&&b(a);a.getSelection().selectRanges(k);(r=a.getSelection().getStartElement())&&r.scrollIntoView(true)}else j.$.scrollTo(l.x,l.y);else{if(k){r.selectionStart=k[0];r.selectionEnd=k[1]}r.scrollLeft=l[0];r.scrollTop=l[1]}k=l=null;p=this.state;a.fire("maximize",
...
CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign",CKEDITOR.plugins.add("resize",{init:function(a){var f,c,e,b;function g(g){var h=f,i=c,k=h+(g.data.$.screenX-e)*(j=="rtl"?-1:1),g=i+(g.data.$.screenY-b);l&&(h=Math.max(d.resize_minWidth,Math.min(k,d.resize_maxWidth)));o&&(i=Math.max(d.resize_minHeight,Math.min(g,d.resize_maxHeight)));a.resize(l?h:null,i)}function i(){CKEDITOR.document.removeListener("mousemove",g);CKEDITOR.document.removeListener("mouseup",i);
if(a.document){a.document.removeListener("mousemove",g);a.document.removeListener("mouseup",i)}}var d=a.config,h=a.ui.spaceId("resizer"),j=a.element?a.element.getDirection(1):"ltr";!d.resize_dir&&(d.resize_dir="vertical");d.resize_maxWidth===void 0&&(d.resize_maxWidth=3E3);d.resize_maxHeight===void 0&&(d.resize_maxHeight=3E3);d.resize_minWidth===void 0&&(d.resize_minWidth=750);d.resize_minHeight===void 0&&(d.resize_minHeight=250);if(d.resize_enabled!==false){var k=null,l=(d.resize_dir=="both"||d.resize_dir==
"horizontal")&&d.resize_minWidth!=d.resize_maxWidth,o=(d.resize_dir=="both"||d.resize_dir=="vertical")&&d.resize_minHeight!=d.resize_maxHeight,p=CKEDITOR.tools.addFunction(function(h){k||(k=a.getResizable());f=k.$.offsetWidth||0;c=k.$.offsetHeight||0;e=h.screenX;b=h.screenY;d.resize_minWidth>f&&(d.resize_minWidth=f);d.resize_minHeight>c&&(d.resize_minHeight=c);CKEDITOR.document.on("mousemove",g);CKEDITOR.document.on("mouseup",i);if(a.document){a.document.on("mousemove",g);a.document.on("mouseup",
i)}h.preventDefault&&h.preventDefault()});a.on("destroy",function(){CKEDITOR.tools.removeFunction(p)});a.on("uiSpace",function(b){if(b.data.space=="bottom"){var c="";l&&!o&&(c=" cke_resizer_horizontal");!l&&o&&(c=" cke_resizer_vertical");var d='<span id="'+h+'" class="cke_resizer'+c+" cke_resizer_"+j+'" title="'+CKEDITOR.tools.htmlEncode(a.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+p+', event)">'+(j=="ltr"?"◢":"◣")+"</span>";j=="ltr"&&c=="ltr"?b.data.html=b.data.html+d:b.data.html=
...
e,'" class="cke_voice_label">',b.lang.toolbar.toolbars,"</span>",'<span id="'+b.ui.spaceId("toolbox")+'" class="cke_toolbox" role="group" aria-labelledby="',e,'" onmousedown="return false;">'],e=b.config.toolbarStartupExpanded!==false,g,l;b.config.toolbarCanCollapse&&b.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE&&f.push('<span class="cke_toolbox_main"'+(e?">":' style="display:none">'));for(var o=b.toolbox.toolbars,p=a(b),n=0;n<p.length;n++){var m,q=0,r,t=p[n],u;if(t){if(g){f.push("</span>");l=g=0}if(t===
"/")f.push('<span class="cke_toolbar_break"></span>');else{u=t.items||t;for(var v=0;v<u.length;v++){var x=u[v],w;if(x)if(x.type==CKEDITOR.UI_SEPARATOR)l=g&&x;else{w=x.canGroup!==false;if(!q){m=CKEDITOR.tools.getNextId();q={id:m,items:[]};r=t.name&&(b.lang.toolbar.toolbarGroups[t.name]||t.name);f.push('<span id="',m,'" class="cke_toolbar"',r?' aria-labelledby="'+m+'_label"':"",' role="toolbar">');r&&f.push('<span id="',m,'_label" class="cke_voice_label">',r,"</span>");f.push('<span class="cke_toolbar_start"></span>');
var s=o.push(q)-1;if(s>0){q.previous=o[s-1];q.previous.next=q}}if(w){if(!g){f.push('<span class="cke_toolgroup" role="presentation">');g=1}}else if(g){f.push("</span>");g=0}m=function(a){a=a.render(b,f);s=q.items.push(a)-1;if(s>0){a.previous=q.items[s-1];a.previous.next=a}a.toolbar=q;a.onkey=i;a.onfocus=function(){b.toolbox.focusCommandExecuted||b.focus()}};if(l){m(l);l=0}m(x)}}if(g){f.push("</span>");l=g=0}q&&f.push('<span class="cke_toolbar_end"></span></span>')}}}b.config.toolbarCanCollapse&&f.push("</span>");
