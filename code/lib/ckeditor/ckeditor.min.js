...
*/
(function(){if(!window.CKEDITOR||!window.CKEDITOR.dom)window.CKEDITOR||(window.CKEDITOR=function(){var a=/(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,f={timestamp:"E8IJ",version:"4.4.5 DEV",revision:"131c832",rnd:Math.floor(900*Math.random())+100,_:{pending:[],basePathSrcPattern:a},status:"unloaded",basePath:function(){var b=window.CKEDITOR_BASEPATH||"";if(!b)for(var g=document.getElementsByTagName("script"),e=0;e<g.length;e++){var d=g[e].src.match(a);if(d){b=d[1];break}}-1==b.indexOf(":/")&&"//"!=b.slice(0,
...
a&&a._load?a():f&&setTimeout(function(){CKEDITOR.loadFullCore&&CKEDITOR.loadFullCore()},f*1E3)}})})();CKEDITOR.status="basic_loaded"}(),CKEDITOR.dom={},function(){var a=[],f=CKEDITOR.env.gecko?"-moz-":CKEDITOR.env.webkit?"-webkit-":CKEDITOR.env.ie?"-ms-":"",c=/&/g,e=/>/g,b=/</g,g=/"/g,i=/&amp;/g,d=/&gt;/g,h=/&lt;/g,j=/&quot;/g;CKEDITOR.on("reset",function(){a=[]});CKEDITOR.tools={arrayCompare:function(b,a){if(!b&&!a)return true;if(!b||!a||b.length!=a.length)return false;for(var g=0;g<b.length;g++)if(b[g]!=
...
basefont:1,big:1,font:1,isindex:1,strike:1,style:1,tt:1});a(e,b,c,h);f={a:f(c,{a:1,button:1}),abbr:c,address:e,area:i,article:a({style:1},e),aside:a({style:1},e),audio:a({source:1,track:1},e),b:c,base:i,bdi:c,bdo:c,blockquote:e,body:e,br:i,button:f(c,{a:1,button:1}),canvas:c,caption:e,cite:c,code:c,col:i,colgroup:{col:1},command:i,datalist:a({option:1},c),dd:e,del:c,details:a({summary:1},e),dfn:c,div:a({style:1},e),dl:{dt:1,dd:1},dt:e,em:c,embed:i,fieldset:a({legend:1},e),figcaption:e,figure:a({figcaption:1},
e),footer:e,form:e,h1:c,h2:c,h3:c,h4:c,h5:c,h6:c,head:a({title:1,base:1},g),header:e,hgroup:{h1:1,h2:1,h3:1,h4:1,h5:1,h6:1},hr:i,html:a({head:1,body:1},e,g),i:c,iframe:d,img:i,input:i,ins:c,kbd:c,keygen:i,label:c,legend:c,li:e,link:i,map:e,mark:c,menu:a({li:1},e),meta:i,meter:f(c,{meter:1}),nav:e,noscript:a({link:1,meta:1,style:1},c),object:a({param:1},c),ol:{li:1},optgroup:{option:1},option:d,output:c,p:c,param:i,pre:c,progress:f(c,{progress:1}),q:c,rp:c,rt:c,ruby:a({rp:1,rt:1},c),s:c,samp:c,script:d,
section:a({style:1},e),select:{optgroup:1,option:1},small:c,source:i,span:c,strong:c,style:d,sub:c,summary:c,sup:c,table:{caption:1,colgroup:1,thead:1,tfoot:1,tbody:1,tr:1},tbody:{tr:1},td:e,textarea:d,tfoot:{tr:1},th:e,thead:{tr:1},time:f(c,{time:1}),title:d,tr:{th:1,td:1},track:i,u:c,ul:{li:1},"var":c,video:a({source:1,track:1},e),wbr:i,acronym:c,applet:a({param:1},e),basefont:i,big:c,center:e,dialog:i,dir:{li:1},font:c,isindex:i,noframes:e,strike:c,tt:c};a(f,{$block:a({audio:1,dd:1,dt:1,figcaption:1,
...
appendBogus:1,getFirst:1,getLast:1,getParent:1,getNext:1,getPrevious:1,appendTo:1,moveChildren:1,insertBefore:1,insertAfterNode:1,replace:1,trim:1,type:1,ltrim:1,rtrim:1,getDocument:1,getChildCount:1,getChild:1,getChildren:1}),function(){function a(a,b){var c=this.range;if(this._.end)return null;if(!this._.start){this._.start=1;if(c.collapsed){this.end();return null}c.optimize()}var d,e=c.startContainer;d=c.endContainer;var k=c.startOffset,g=c.endOffset,f,h=this.guard,i=this.type,j=a?"getPreviousSourceNode":
...
(a.type!=CKEDITOR.NODE_ELEMENT||!b||!a.equals(c.root))}}var A=a?this._.guardRTL:this._.guardLTR;f=h?function(a,b){return A(a,b)===false?false:h(a,b)}:A;if(this.current)d=this.current[j](false,i,f);else{if(a)d.type==CKEDITOR.NODE_ELEMENT&&(d=g>0?d.getChild(g-1):f(d,true)===false?null:d.getPreviousSourceNode(true,i,f));else{d=e;if(d.type==CKEDITOR.NODE_ELEMENT&&!(d=d.getChild(k)))d=f(e,true)===false?null:e.getNextSourceNode(true,i,f)}d&&f(d)===false&&(d=null)}for(;d&&!this._.end;){this.current=d;if(!this.evaluator||
...
CKEDITOR.tools.trim(e.getText()).length)||e.type==CKEDITOR.NODE_ELEMENT&&!e.is(g)?false:true}}function f(a){var b=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.dom.walker.bookmark(1);return function(d){return c(d)||b(d)?true:!a&&i(d)||d.type==CKEDITOR.NODE_ELEMENT&&d.is(CKEDITOR.dtd.$removeEmpty)}}function c(a){return function(){var b;return this[a?"getPreviousNode":"getNextNode"](function(a){!b&&j(a)&&(b=a);return h(a)&&!(i(a)&&a.equals(b))})}}var e=function(a){a.collapsed=a.startContainer&&a.endContainer&&
a.startContainer.equals(a.endContainer)&&a.startOffset==a.endOffset},b=function(a,b,c,d){a.optimizeBookmark();var e=a.startContainer,g=a.endContainer,f=a.startOffset,h=a.endOffset,i,j;if(g.type==CKEDITOR.NODE_TEXT)g=g.split(h);else if(g.getChildCount()>0)if(h>=g.getChildCount()){g=g.append(a.document.createText(""));j=true}else g=g.getChild(h);if(e.type==CKEDITOR.NODE_TEXT){e.split(f);e.equals(g)&&(g=e.getNext())}else if(f)if(f>=e.getChildCount()){e=e.append(a.document.createText(""));i=true}else e=
e.getChild(f).getPrevious();else{e=e.append(a.document.createText(""),1);i=true}var f=e.getParents(),h=g.getParents(),v,x,w;for(v=0;v<f.length;v++){x=f[v];w=h[v];if(!x.equals(w))break}for(var t=c,y,z,A,B=v;B<f.length;B++){y=f[B];t&&!y.equals(e)&&(z=t.append(y.clone()));for(y=y.getNext();y;){if(y.equals(h[B])||y.equals(g))break;A=y.getNext();if(b==2)t.append(y.clone(true));else{y.remove();b==1&&t.append(y)}y=A}t&&(t=z)}t=c;for(c=v;c<h.length;c++){y=h[c];b>0&&!y.equals(g)&&(z=t.append(y.clone()));if(!f[c]||
...
1;case CKEDITOR.ENLARGE_ELEMENT:if(this.collapsed)break;var g=this.getCommonAncestor(),f=this.root,h,i,j,v,x,w=false,t,y;t=this.startContainer;var z=this.startOffset;if(t.type==CKEDITOR.NODE_TEXT){if(z){t=!CKEDITOR.tools.trim(t.substring(0,z)).length&&t;w=!!t}if(t&&!(v=t.getPrevious()))j=t.getParent()}else{z&&(v=t.getChild(z-1)||t.getLast());v||(j=t)}for(j=c(j);j||v;){if(j&&!v){!x&&j.equals(g)&&(x=true);if(e?j.isBlockBoundary():!f.contains(j))break;if(!w||j.getComputedStyle("display")!="inline"){w=
false;x?h=j:this.setStartBefore(j)}v=j.getPrevious()}for(;v;){t=false;if(v.type==CKEDITOR.NODE_COMMENT)v=v.getPrevious();else{if(v.type==CKEDITOR.NODE_TEXT){y=v.getText();d.test(y)&&(v=null);t=/[\s\ufeff]$/.test(y)}else if((v.$.offsetWidth>(CKEDITOR.env.webkit?1:0)||b&&v.is("br"))&&!v.data("cke-bookmark"))if(w&&CKEDITOR.dtd.$removeEmpty[v.getName()]){y=v.getText();if(d.test(y))v=null;else for(var z=v.$.getElementsByTagName("*"),A=0,B;B=z[A++];)if(!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]){v=
null;break}v&&(t=!!y.length)}else v=null;t&&(w?x?h=j:j&&this.setStartBefore(j):w=true);if(v){t=v.getPrevious();if(!j&&!t){j=v;v=null;break}v=t}else j=null}}j&&(j=c(j.getParent()))}t=this.endContainer;z=this.endOffset;j=v=null;x=w=false;var G=function(a,b){var c=new CKEDITOR.dom.range(f);c.setStart(a,b);c.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);var c=new CKEDITOR.dom.walker(c),e;for(c.guard=function(a){return!(a.type==CKEDITOR.NODE_ELEMENT&&a.isBlockBoundary())};e=c.next();){if(e.type!=CKEDITOR.NODE_TEXT)return false;
y=e!=a?e.getText():e.substring(b);if(d.test(y))return false}return true};if(t.type==CKEDITOR.NODE_TEXT)if(CKEDITOR.tools.trim(t.substring(z)).length)w=true;else{w=!t.getLength();if(z==t.getLength()){if(!(v=t.getNext()))j=t.getParent()}else G(t,z)&&(j=t.getParent())}else(v=t.getChild(z))||(j=t);for(;j||v;){if(j&&!v){!x&&j.equals(g)&&(x=true);if(e?j.isBlockBoundary():!f.contains(j))break;if(!w||j.getComputedStyle("display")!="inline"){w=false;x?i=j:j&&this.setEndAfter(j)}v=j.getNext()}for(;v;){t=false;
if(v.type==CKEDITOR.NODE_TEXT){y=v.getText();G(v,0)||(v=null);t=/^[\s\ufeff]/.test(y)}else if(v.type==CKEDITOR.NODE_ELEMENT){if((v.$.offsetWidth>0||b&&v.is("br"))&&!v.data("cke-bookmark"))if(w&&CKEDITOR.dtd.$removeEmpty[v.getName()]){y=v.getText();if(d.test(y))v=null;else{z=v.$.getElementsByTagName("*");for(A=0;B=z[A++];)if(!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]){v=null;break}}v&&(t=!!y.length)}else v=null}else t=1;t&&w&&(x?i=j:this.setEndAfter(j));if(v){t=v.getNext();if(!j&&!t){j=v;
v=null;break}v=t}else j=null}j&&(j=c(j.getParent()))}if(h&&i){g=h.contains(i)?i:h;this.setStartBefore(g);this.setEndAfter(g)}break;case CKEDITOR.ENLARGE_BLOCK_CONTENTS:case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:j=new CKEDITOR.dom.range(this.root);f=this.root;j.setStartAt(f,CKEDITOR.POSITION_AFTER_START);j.setEnd(this.startContainer,this.startOffset);j=new CKEDITOR.dom.walker(j);var C,J,D=CKEDITOR.dom.walker.blockBoundary(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?{br:1}:null),F=null,E=function(a){if(a.type==
CKEDITOR.NODE_ELEMENT&&a.getAttribute("contenteditable")=="false")if(F){if(F.equals(a)){F=null;return}}else F=a;else if(F)return;var b=D(a);b||(C=a);return b},e=function(a){var b=E(a);!b&&(a.is&&a.is("br"))&&(J=a);return b};j.guard=E;j=j.lastBackward();C=C||f;this.setStartAt(C,!C.is("br")&&(!j&&this.checkStartOfBlock()||j&&C.contains(j))?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_AFTER_END);if(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS){j=this.clone();j=new CKEDITOR.dom.walker(j);var I=CKEDITOR.dom.walker.whitespaces(),
L=CKEDITOR.dom.walker.bookmark();j.evaluator=function(a){return!I(a)&&!L(a)};if((j=j.previous())&&j.type==CKEDITOR.NODE_ELEMENT&&j.is("br"))break}j=this.clone();j.collapse();j.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);j=new CKEDITOR.dom.walker(j);j.guard=a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?e:E;C=F=J=null;j=j.lastForward();C=C||f;this.setEndAt(C,!j&&this.checkEndOfBlock()||j&&C.contains(j)?CKEDITOR.POSITION_BEFORE_END:CKEDITOR.POSITION_BEFORE_START);J&&this.setEndAfter(J)}},shrink:function(a,b,c){if(!this.collapsed){var a=
a||CKEDITOR.SHRINK_TEXT,d=this.clone(),e=this.startContainer,g=this.endContainer,f=this.startOffset,h=this.endOffset,i=1,j=1;if(e&&e.type==CKEDITOR.NODE_TEXT)if(f)if(f>=e.getLength())d.setStartAfter(e);else{d.setStartBefore(e);i=0}else d.setStartBefore(e);if(g&&g.type==CKEDITOR.NODE_TEXT)if(h)if(h>=g.getLength())d.setEndAfter(g);else{d.setEndAfter(g);j=0}else d.setEndBefore(g);var d=new CKEDITOR.dom.walker(d),v=CKEDITOR.dom.walker.bookmark();d.evaluator=function(b){return b.type==(a==CKEDITOR.SHRINK_ELEMENT?
CKEDITOR.NODE_ELEMENT:CKEDITOR.NODE_TEXT)};var x;d.guard=function(b,d){if(v(b))return true;if(a==CKEDITOR.SHRINK_ELEMENT&&b.type==CKEDITOR.NODE_TEXT||d&&b.equals(x)||c===false&&b.type==CKEDITOR.NODE_ELEMENT&&b.isBlockBoundary()||b.type==CKEDITOR.NODE_ELEMENT&&b.hasAttribute("contenteditable"))return false;!d&&b.type==CKEDITOR.NODE_ELEMENT&&(x=b);return true};if(i)(e=d[a==CKEDITOR.SHRINK_ELEMENT?"lastForward":"next"]())&&this.setStartAt(e,b?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_BEFORE_START);
...
b,c,d,e){var g,f,a=[];for(g in b){f=b[g];f=typeof f=="boolean"?{}:typeof f=="function"?{match:f}:G(f);if(g.charAt(0)!="$")f.elements=g;if(c)f.featureName=c.toLowerCase();var h=f;h.elements=i(h.elements,/\s+/)||null;h.propertiesOnly=h.propertiesOnly||h.elements===true;var j=/\s*,\s*/,q=void 0;for(q in F){h[q]=i(h[q],j)||null;var n=h,s=E[q],k=i(h[E[q]],j),x=h[q],u=[],m=true,l=void 0;k?m=false:k={};for(l in x)if(l.charAt(0)=="!"){l=l.slice(1);u.push(l);k[l]=true;m=false}for(;l=u.pop();){x[l]=x["!"+l];
delete x["!"+l]}n[s]=(m?false:k)||null}h.match=h.match||null;d.push(f);a.push(f)}for(var b=e.elements,e=e.generic,v,c=0,d=a.length;c<d;++c){g=G(a[c]);f=g.classes===true||g.styles===true||g.attributes===true;h=g;q=s=j=void 0;for(j in F)h[j]=p(h[j]);n=true;for(q in E){j=E[q];s=h[j];k=[];x=void 0;for(x in s)x.indexOf("*")>-1?k.push(RegExp("^"+x.replace(/\*/g,".*")+"$")):k.push(x);s=k;if(s.length){h[j]=s;n=false}}h.nothingRequired=n;h.noProperties=!(h.attributes||h.classes||h.styles);if(g.elements===
...
false;d.hadInvalidClass=a||d.hadInvalidClass}}function b(a,b){if(!a)return false;var c=false,d=a===true,e;for(e in b)if(d||a(e)){delete b[e];c=true}return c}function g(a,b,c){if(a.disabled||a.customConfig&&!c||!b)return false;a._.cachedChecks={};return true}function i(a,b){if(!a)return false;if(a===true)return a;if(typeof a=="string"){a=C(a);return a=="*"?true:CKEDITOR.tools.convertArrayToObject(a.split(b))}if(CKEDITOR.tools.isArray(a))return a.length?CKEDITOR.tools.convertArrayToObject(a):false;
...
check:function(a,b,c){if(this.disabled)return true;if(CKEDITOR.tools.isArray(a)){for(var d=a.length;d--;)if(this.check(a[d],b,c))return true;return false}var e,g;if(typeof a=="string"){g=a+"<"+(b===false?"0":"1")+(c?"1":"0")+">";if(g in this._.cachedChecks)return this._.cachedChecks[g];d=k(a).$1;e=d.styles;var f=d.classes;d.name=d.elements;d.classes=f=f?f.split(/\s*,\s*/):[];d.styles=j(e);d.attributes=j(d.attributes);d.children=[];f.length&&(d.attributes["class"]=f.join(" "));if(e)d.attributes.style=
CKEDITOR.tools.writeCssText(d.styles);e=d}else{d=a.getDefinition();e=d.styles;f=d.attributes||{};if(e){e=G(e);f.style=CKEDITOR.tools.writeCssText(e,true)}else e={};e={name:d.element,attributes:f,classes:f["class"]?f["class"].split(/\s+/):[],styles:e,children:[]}}var f=CKEDITOR.tools.clone(e),h=[],i;if(b!==false&&(i=this._.transformations[e.name])){for(d=0;d<i.length;++d)x(this,e,i[d]);m(e)}r(this,f,h,{doFilter:true,doTransform:b!==false,skipRequired:!c,skipFinalValidation:!c});b=h.length>0?false:
...
a,e=f.toLowerCase().match(/([a-z]+)(?:-([a-z]+))?/),b=e[1],e=e[2];c[b+"-"+e]?b=b+"-"+e:c[b]||(b=null);CKEDITOR.lang.detect=b?function(){return b}:function(a){return a};return b||a}}}(),CKEDITOR.scriptLoader=function(){var a={},f={};return{load:function(c,e,b,g){var i=typeof c=="string";i&&(c=[c]);b||(b=CKEDITOR);var d=c.length,h=[],j=[],k=function(a){e&&(i?e.call(b,a):e.call(b,h,j))};if(d===0)k(true);else{var l=function(a,b){(b?h:j).push(a);if(--d<=0){g&&CKEDITOR.document.getDocumentElement().removeStyle("cursor");
...
!b[j]){var k=this.getFilePath(j);g.push(k);k in i||(i[k]=[]);i[k].push(j)}else d[j]=this.get(j)}CKEDITOR.scriptLoader.load(g,function(a,b){if(b.length)throw'[CKEDITOR.resourceManager.load] Resource name "'+i[b[0]].join(",")+'" was not found at "'+b[0]+'".';for(var g=0;g<a.length;g++)for(var h=i[a[g]],j=0;j<h.length;j++){var q=h[j];d[q]=this.get(q);e[q]=1}f.call(c,d)},this)}},CKEDITOR.plugins=new CKEDITOR.resourceManager("plugins/","plugin"),CKEDITOR.plugins.load=CKEDITOR.tools.override(CKEDITOR.plugins.load,
...
b||!g(a))&&a.fireOnce("customConfigLoaded")}else CKEDITOR.scriptLoader.queue(b,function(){c.fn=CKEDITOR.editorConfig?CKEDITOR.editorConfig:function(){};g(a)});return true}function i(a,b){a.on("customConfigLoaded",function(){if(b){if(b.on)for(var c in b.on)a.on(c,b.on[c]);CKEDITOR.tools.extend(a.config,b,true);delete a.config.on}c=a.config;a.readOnly=!(!c.readOnly&&!(a.elementMode==CKEDITOR.ELEMENT_MODE_INLINE?a.element.is("textarea")?a.element.hasAttribute("disabled"):a.element.isReadOnly():a.elementMode==
...
parse:function(c){for(var e,b,g=0,i;e=this._.htmlPartsRegex.exec(c);){b=e.index;if(b>g){g=c.substring(g,b);if(i)i.push(g);else this.onText(g)}g=this._.htmlPartsRegex.lastIndex;if(b=e[1]){b=b.toLowerCase();if(i&&CKEDITOR.dtd.$cdata[b]){this.onCDATA(i.join(""));i=null}if(!i){this.onTagClose(b);continue}}if(i)i.push(e[0]);else if(b=e[3]){b=b.toLowerCase();if(!/="/.test(b)){var d={},h;e=e[4];var j=!!(e&&e.charAt(e.length-1)=="/");if(e)for(;h=a.exec(e);){var k=h[1].toLowerCase();h=h[2]||h[3]||h[4]||"";
d[k]=!h&&f[k]?k:CKEDITOR.tools.htmlDecodeAttr(h)}this.onTagOpen(b,d,j);!i&&CKEDITOR.dtd.$cdata[b]&&(i=[])}}else if(b=e[2])this.onComment(b)}if(c.length>g)this.onText(c.substring(g,c.length))}}}(),CKEDITOR.htmlParser.basicWriter=CKEDITOR.tools.createClass({$:function(){this._={output:[]}},proto:{openTag:function(a){this._.output.push("<",a)},openTagClose:function(a,f){f?this._.output.push(" />"):this._.output.push(">")},attribute:function(a,f){typeof f=="string"&&(f=CKEDITOR.tools.htmlEncodeAttr(f));
...
ul:1,ol:1,dl:1},CKEDITOR.dtd.table,CKEDITOR.dtd.ul,CKEDITOR.dtd.ol,CKEDITOR.dtd.dl),c={ol:1,ul:1},e=CKEDITOR.tools.extend({},{html:1},CKEDITOR.dtd.html,CKEDITOR.dtd.body,CKEDITOR.dtd.head,{style:1,script:1}),b={ul:"li",ol:"li",dl:"dd",table:"tbody",tbody:"tr",thead:"tr",tfoot:"tr",tr:"td"};CKEDITOR.htmlParser.fragment.fromHtml=function(g,i,d){function h(a){var b;if(q.length>0)for(var c=0;c<q.length;c++){var d=q[c],e=d.name,g=CKEDITOR.dtd[e],f=s.name&&CKEDITOR.dtd[s.name];if((!f||f[e])&&(!a||!g||g[a]||
!CKEDITOR.dtd[a])){if(!b){j();b=1}d=d.clone();d.parent=s;s=d;q.splice(c,1);c--}else if(e==s.name){l(s,s.parent,1);c--}}}function j(){for(;p.length;)l(p.shift(),s)}function k(a){if(a._.isBlockLike&&a.name!="pre"&&a.name!="textarea"){var b=a.children.length,c=a.children[b-1],d;if(c&&c.type==CKEDITOR.NODE_TEXT)(d=CKEDITOR.tools.rtrim(c.value))?c.value=d:a.children.length=b-1}}function l(b,c,e){var c=c||s||m,g=s;if(b.previous===void 0){if(o(c,b)){s=c;n.onTagOpen(d,{});b.returnPoint=c=s}k(b);(!a(b)||b.children.length)&&
...
a=="dd"&&b=="dt":false}var n=new CKEDITOR.htmlParser,m=i instanceof CKEDITOR.htmlParser.element?i:typeof i=="string"?new CKEDITOR.htmlParser.element(i):new CKEDITOR.htmlParser.fragment,q=[],p=[],s=m,u=m.name=="textarea",v=m.name=="pre";n.onTagOpen=function(b,d,g,i){d=new CKEDITOR.htmlParser.element(b,d);if(d.isUnknown&&g)d.isEmpty=true;d.isOptionalClose=i;if(a(d))q.push(d);else{if(b=="pre")v=true;else{if(b=="br"&&v){s.add(new CKEDITOR.htmlParser.text("\n"));return}b=="textarea"&&(u=true)}if(b=="br")p.push(d);
else{for(;;){i=(g=s.name)?CKEDITOR.dtd[g]||(s._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):e;if(!d.isUnknown&&!s.isUnknown&&!i[b])if(s.isOptionalClose)n.onTagClose(g);else if(b in c&&g in c){g=s.children;(g=g[g.length-1])&&g.name=="li"||l(g=new CKEDITOR.htmlParser.element("li"),s);!d.returnPoint&&(d.returnPoint=s);s=g}else if(b in CKEDITOR.dtd.$listItem&&!r(b,g))n.onTagOpen(b=="li"?"ul":"dl",{},0,1);else if(g in f&&!r(b,g)){!d.returnPoint&&(d.returnPoint=s);s=s.parent}else{g in CKEDITOR.dtd.$inline&&
q.unshift(s);if(s.parent)l(s,s.parent,1);else{d.isOrphan=1;break}}else break}h(b);j();d.parent=s;d.isEmpty?l(d):s=d}}};n.onTagClose=function(a){for(var b=q.length-1;b>=0;b--)if(a==q[b].name){q.splice(b,1);return}for(var c=[],e=[],g=s;g!=m&&g.name!=a;){g._.isBlockLike||e.unshift(g);c.push(g);g=g.returnPoint||g.parent}if(g!=m){for(b=0;b<c.length;b++){var f=c[b];l(f,f.parent)}s=g;g._.isBlockLike&&j();l(g,g.parent);if(g==s)s=s.parent;q=q.concat(e)}a=="body"&&(d=false)};n.onText=function(a){if((!s._.hasInlineStarted||
p.length)&&!v&&!u){a=CKEDITOR.tools.ltrim(a);if(a.length===0)return}var c=s.name,g=c?CKEDITOR.dtd[c]||(s._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):e;if(!u&&!g["#"]&&c in f){n.onTagOpen(b[c]||"");n.onText(a)}else{j();h();!v&&!u&&(a=a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g," "));a=new CKEDITOR.htmlParser.text(a);if(o(s,a))this.onTagOpen(d,{},0,1);s.add(a)}};n.onCDATA=function(a){s.add(new CKEDITOR.htmlParser.cdata(a))};n.onComment=function(a){j();h();s.add(new CKEDITOR.htmlParser.comment(a))};n.parse(g);
for(j();s!=m;)l(s,s.parent,1);k(m);return m};CKEDITOR.htmlParser.fragment.prototype={type:CKEDITOR.NODE_DOCUMENT_FRAGMENT,add:function(a,b){isNaN(b)&&(b=this.children.length);var c=b>0?this.children[b-1]:null;if(c){if(a._.isBlockLike&&c.type==CKEDITOR.NODE_TEXT){c.value=CKEDITOR.tools.rtrim(c.value);if(c.value.length===0){this.children.pop();this.add(a);return}}c.next=a}a.previous=c;a.parent=this;this.children.splice(b,0,a);if(!this._.hasInlineStarted)this._.hasInlineStarted=a.type==CKEDITOR.NODE_TEXT||
...
g)},findIndex:function(a){for(var e=this.rules,b=e.length-1;b>=0&&a<e[b].priority;)b--;return b+1},exec:function(a,e){var b=e instanceof CKEDITOR.htmlParser.node||e instanceof CKEDITOR.htmlParser.fragment,g=Array.prototype.slice.call(arguments,1),f=this.rules,d=f.length,h,j,k,l;for(l=0;l<d;l++){if(b){h=e.type;j=e.name}k=f[l];if(!(a.nonEditable&&!k.options.applyToAll||a.nestedEditable&&k.options.excludeNestedEditable)){k=k.value.apply(null,g);if(k===false||b&&k&&(k.name!=j||k.type!=h))return k;k!=
...
d.addRules(t);d.addRules(y,{applyToAll:true});d.addRules(a(b,"html"),{applyToAll:true});b.on("toHtml",function(a){var a=a.data,c=a.dataValue,c=m(c,b),c=k(c,C),c=j(c),c=k(c,G),c=c.replace(D,"$1cke:$2"),c=c.replace(E,"<cke:$1$2></cke:$1>"),c=c.replace(/(<pre\b[^>]*>)(\r\n|\n)/g,"$1$2$2"),c=c.replace(/([^a-z0-9<\-])(on\w{3,})(?!>)/gi,"$1data-cke-"+CKEDITOR.rnd+"-$2"),d=a.context||b.editable().getName(),e;if(CKEDITOR.env.ie&&CKEDITOR.env.version<9&&d=="pre"){d="div";c="<pre>"+c+"</pre>";e=1}d=b.document.createElement(d);
...
CKEDITOR.fire("inline",f)!==false&&CKEDITOR.inline(a,f.config)}}};CKEDITOR.domReady(function(){!CKEDITOR.disableAutoInline&&CKEDITOR.inlineAll()})}(),CKEDITOR.replaceClass="ckeditor",function(){function a(a,b,g,i){if(!CKEDITOR.env.isCompatible)return null;a=CKEDITOR.dom.element.get(a);if(a.getEditor())throw'The editor instance "'+a.getEditor().name+'" is already attached to the provided element.';var d=new CKEDITOR.editor(b,a,i);if(i==CKEDITOR.ELEMENT_MODE_REPLACE){a.setStyle("visibility","hidden");
d._.required=a.hasAttribute("required");a.removeAttribute("required")}g&&d.setData(g,null,true);d.on("loaded",function(){c(d);i==CKEDITOR.ELEMENT_MODE_REPLACE&&(d.config.autoUpdateElement&&a.$.form)&&d._attachToForm();d.setMode(d.config.startupMode,function(){d.resetDirty();d.status="ready";d.fireOnce("instanceReady");CKEDITOR.fire("instanceReady",null,d)})});d.on("destroy",f);return d}function f(){var a=this.container,b=this.element;if(a){a.clearCustomData();a.remove()}if(b){b.clearCustomData();
if(this.elementMode==CKEDITOR.ELEMENT_MODE_REPLACE){b.show();this._.required&&b.setAttribute("required","required")}delete this.element}}function c(a){var b=a.name,c=a.element,f=a.elementMode,d=a.fire("uiSpace",{space:"top",html:""}).html,h=a.fire("uiSpace",{space:"bottom",html:""}).html,j=new CKEDITOR.template('<{outerEl} id="cke_{name}" class="{id} cke cke_reset cke_chrome cke_editor_{name} cke_{langDir} '+CKEDITOR.env.cssClass+'"  dir="{langDir}" lang="{langCode}" role="application"'+(a.title?
' aria-labelledby="cke_{name}_arialbl"':"")+">"+(a.title?'<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>':"")+'<{outerEl} class="cke_inner cke_reset" role="presentation">{topHtml}<{outerEl} id="{contentId}" class="cke_contents cke_reset" role="presentation"></{outerEl}>{bottomHtml}</{outerEl}></{outerEl}>'),b=CKEDITOR.dom.element.createFromHtml(j.output({id:a.id,name:b,langDir:a.lang.dir,langCode:a.langCode,voiceLabel:a.title,topHtml:d?'<span id="'+a.ui.spaceId("top")+'" class="cke_top cke_reset_all" role="presentation" style="height:auto">'+
...
"(?:$|\\s)").test(f.className))continue}else if(typeof arguments[0]=="function"){c={};if(arguments[0](f,c)===false)continue}this.replace(f,c)}}};CKEDITOR.editor.prototype.addMode=function(a,b){(this._.modes||(this._.modes={}))[a]=b};CKEDITOR.editor.prototype.setMode=function(a,b){var c=this,f=this._.modes;if(!(a==c.mode||!f||!f[a])){c.fire("beforeSetMode",a);if(c.mode){var d=c.checkDirty(),f=c._.previousModeData,h,j=0;c.fire("beforeModeUnload");c.editable(0);c._.previousMode=c.mode;c._.previousModeData=
h=c.getData(1);if(c.mode=="source"&&f==h){c.fire("lockSnapshot",{forceUpdate:true});j=1}c.ui.space("contents").setHtml("");c.mode=""}else c._.previousModeData=c.getData(1);this._.modes[a](function(){c.mode=a;d!==void 0&&!d&&c.resetDirty();j?c.fire("unlockSnapshot"):a=="wysiwyg"&&c.fire("saveSnapshot");setTimeout(function(){c.fire("mode");b&&b.call(c)},0)})}};CKEDITOR.editor.prototype.resize=function(a,b,c,f){var d=this.container,h=this.ui.space("contents"),j=CKEDITOR.env.webkit&&this.document&&this.document.getWindow().$.frameElement,
f=f?this.container.getFirst(function(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasClass("cke_inner")}):d;f.setSize("width",a,true);j&&(j.style.width="1%");h.setStyle("height",Math.max(b-(c?0:(f.$.offsetHeight||0)-(h.$.clientHeight||0)),0)+"px");j&&(j.style.width="100%");this.fire("resize")};CKEDITOR.editor.prototype.getResizable=function(a){return a?this.ui.space("contents"):this.container};CKEDITOR.domReady(function(){CKEDITOR.replaceClass&&CKEDITOR.replaceAll(CKEDITOR.replaceClass)})}(),CKEDITOR.config.startupMode=
"wysiwyg",function(){function a(a){var b=a.editor,c=a.data.path,d=c.blockLimit,g=a.data.selection,h=g.getRanges()[0],j;if(CKEDITOR.env.gecko||CKEDITOR.env.ie&&CKEDITOR.env.needsBrFiller)if(g=f(g,c)){g.appendBogus();j=CKEDITOR.env.ie}if(i(b,c.block,d)&&h.collapsed&&!h.getCommonAncestor().isReadOnly()){c=h.clone();c.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS);d=new CKEDITOR.dom.walker(c);d.guard=function(a){return!e(a)||a.type==CKEDITOR.NODE_COMMENT||a.isReadOnly()};if(!d.checkForward()||c.checkStartOfBlock()&&
c.checkEndOfBlock()){b=h.fixBlock(true,b.activeEnterMode==CKEDITOR.ENTER_DIV?"div":"p");if(!CKEDITOR.env.needsBrFiller)(b=b.getFirst(e))&&(b.type==CKEDITOR.NODE_TEXT&&CKEDITOR.tools.trim(b.getText()).match(/^(?:&nbsp;|\xa0)$/))&&b.remove();j=1;a.cancel()}}j&&h.select()}function f(a,b){if(a.isFake)return 0;var c=b.block||b.blockLimit,d=c&&c.getLast(e);if(c&&c.isBlockBoundary()&&(!d||!(d.type==CKEDITOR.NODE_ELEMENT&&d.isBlockBoundary()))&&!c.is("pre")&&!c.getBogus())return c}function c(a){var b=a.data.getTarget();
...
dl:1};if(d.startPath().contains(f)){var g=d.clone();g.collapse(1);g.setStartAt(a,CKEDITOR.POSITION_AFTER_START);a=new CKEDITOR.dom.walker(g);a.guard=b();a.checkBackward();if(c){g=d.clone();g.collapse();g.setEndAt(c,CKEDITOR.POSITION_AFTER_END);a=new CKEDITOR.dom.walker(g);a.guard=b(true);c=false;a.checkForward();return c}}return null}function i(a,b,c){return a.config.autoParagraph!==false&&a.activeEnterMode!=CKEDITOR.ENTER_BR&&a.editable().equals(c)&&!b||b&&b.getAttribute("contenteditable")=="true"}
...
a.data,b=(new CKEDITOR.dom.elementPath(a.getTarget(),this)).contains("a");b&&(a.$.button!=2&&b.isReadOnly())&&a.preventDefault()});var h={8:1,46:1};this.attachListener(a,"key",function(b){if(a.readOnly)return true;var c=b.data.domEvent.getKey(),d;if(c in h){var b=a.getSelection(),e,f=b.getRanges()[0],j=f.startPath(),i,k,s,c=c==8;if(CKEDITOR.env.ie&&CKEDITOR.env.version<11&&(e=b.getSelectedElement())||(e=g(b))){a.fire("saveSnapshot");f.moveToPosition(e,CKEDITOR.POSITION_BEFORE_START);e.remove();f.select();
a.fire("saveSnapshot");d=1}else if(f.collapsed)if((i=j.block)&&(s=i[c?"getPrevious":"getNext"](o))&&s.type==CKEDITOR.NODE_ELEMENT&&s.is("table")&&f[c?"checkStartOfBlock":"checkEndOfBlock"]()){a.fire("saveSnapshot");f[c?"checkEndOfBlock":"checkStartOfBlock"]()&&i.remove();f["moveToElementEdit"+(c?"End":"Start")](s);f.select();a.fire("saveSnapshot");d=1}else if(j.blockLimit&&j.blockLimit.is("td")&&(k=j.blockLimit.getAscendant("table"))&&f.checkBoundaryOfElement(k,c?CKEDITOR.START:CKEDITOR.END)&&(s=
k[c?"getPrevious":"getNext"](o))){a.fire("saveSnapshot");f["moveToElementEdit"+(c?"End":"Start")](s);f.checkStartOfBlock()&&f.checkEndOfBlock()?s.remove():f.select();a.fire("saveSnapshot");d=1}else if((k=j.contains(["td","th","caption"]))&&f.checkBoundaryOfElement(k,c?CKEDITOR.START:CKEDITOR.END))d=1}return!d});a.blockless&&(CKEDITOR.env.ie&&CKEDITOR.env.needsBrFiller)&&this.attachListener(this,"keyup",function(b){if(b.data.getKeystroke()in h&&!this.getFirst(e)){this.appendBogus();b=a.createRange();
...
e+'" class="cke_voice_label">'+d+"</span>");c.append(d);a.changeAttr("aria-describedby",e)}}})});CKEDITOR.addCss(".cke_editable{cursor:text}.cke_editable img,.cke_editable input,.cke_editable textarea{cursor:default}");var n=function(){function a(b){return b.type==CKEDITOR.NODE_ELEMENT}function b(c,d){var e,f,g,h,i=[],k=d.range.startContainer;e=d.range.startPath();for(var k=j[k.getName()],s=0,n=c.getChildren(),l=n.count(),u=-1,v=-1,x=0,m=e.contains(j.$list);s<l;++s){e=n.getItem(s);if(a(e)){g=e.getName();
if(m&&g in CKEDITOR.dtd.$list)i=i.concat(b(e,d));else{h=!!k[g];if(g=="br"&&e.data("cke-eol")&&(!s||s==l-1)){x=(f=s?i[s-1].node:n.getItem(s+1))&&(!a(f)||!f.is("br"));f=f&&a(f)&&j.$block[f.getName()]}u==-1&&!h&&(u=s);h||(v=s);i.push({isElement:1,isLineBreak:x,isBlock:e.isBlockBoundary(),hasBlockSibling:f,node:e,name:g,allowed:h});f=x=0}}else i.push({isElement:0,node:e,allowed:1})}if(u>-1)i[u].firstNotAllowed=1;if(v>-1)i[v].lastNotAllowed=1;return i}function c(b,d){var e=[],f=b.getChildren(),g=f.count(),
h,i=0,k=j[d],n=!b.is(j.$inline)||b.is("br");for(n&&e.push(" ");i<g;i++){h=f.getItem(i);a(h)&&!h.is(k)?e=e.concat(c(h,d)):e.push(h)}n&&e.push(" ");return e}function d(b){return b&&a(b)&&(b.is(j.$removeEmpty)||b.is("a")&&!b.isBlockBoundary())}function f(b,c,d,e){var g=b.clone(),h,j;g.setEndAt(c,CKEDITOR.POSITION_BEFORE_END);if((h=(new CKEDITOR.dom.walker(g)).next())&&a(h)&&k[h.getName()]&&(j=h.getPrevious())&&a(j)&&!j.getParent().equals(b.startContainer)&&d.contains(j)&&e.contains(h)&&h.isIdentical(j)){h.moveChildren(j);
h.remove();f(b,c,d,e)}}function g(b,c){function d(b,c){if(c.isBlock&&c.isElement&&!c.node.is("br")&&a(b)&&b.is("br")){b.remove();return 1}}var e=c.endContainer.getChild(c.endOffset),f=c.endContainer.getChild(c.endOffset-1);e&&d(e,b[b.length-1]);if(f&&d(f,b[0])){c.setEnd(c.endContainer,c.endOffset-1);c.collapse()}}var j=CKEDITOR.dtd,k={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,ul:1,ol:1,li:1,pre:1,dl:1,blockquote:1},n={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1},l=CKEDITOR.tools.extend({},j.$inline);delete l.br;
...
new CKEDITOR.dom.selection(d.getSelection());l.lock()}function c(){h.removeListener("mouseup",c);n.removeListener("mouseup",c);var a=CKEDITOR.document.$.selection,b=a.createRange();a.type!="None"&&b.parentElement().ownerDocument==e.$&&b.select()}var e=d.document,h=CKEDITOR.document,i=d.editable(),k=e.getBody(),n=e.getDocumentElement(),s=i.isInline(),p,l;CKEDITOR.env.gecko&&i.attachListener(i,"focus",function(a){a.removeListener();if(p!==0)if((a=d.getSelection().getNative())&&a.isCollapsed&&a.anchorNode==
i.$){a=d.createRange();a.moveToElementEditStart(i);a.select()}},null,null,-2);i.attachListener(i,CKEDITOR.env.webkit?"DOMFocusIn":"focus",function(){p&&CKEDITOR.env.webkit&&(p=d._.previousActive&&d._.previousActive.equals(e.getActive()));d.unlockSelection(p);p=0},null,null,-1);i.attachListener(i,"mousedown",function(){p=0});if(CKEDITOR.env.ie||s){m?i.attachListener(i,"beforedeactivate",b,null,null,-1):i.attachListener(d,"selectionCheck",b,null,null,-1);i.attachListener(i,CKEDITOR.env.webkit?"DOMFocusOut":
"blur",function(){d.lockSelection(l);p=1},null,null,-1);i.attachListener(i,"mousedown",function(){p=0})}if(CKEDITOR.env.ie&&!s){var D;i.attachListener(i,"mousedown",function(a){if(a.data.$.button==2){a=d.document.getSelection();if(!a||a.getType()==CKEDITOR.SELECTION_NONE)D=d.window.getScrollPosition()}});i.attachListener(i,"mouseup",function(a){if(a.data.$.button==2&&D){d.document.$.documentElement.scrollLeft=D.x;d.document.$.documentElement.scrollTop=D.y}D=null});if(e.$.compatMode!="BackCompat"){if(CKEDITOR.env.ie7Compat||
...
a.$.clientY)}catch(e){}var f=d.duplicate();n.on("mousemove",b);h.on("mouseup",c);n.on("mouseup",c)}});if(CKEDITOR.env.version>7&&CKEDITOR.env.version<11)n.on("mousedown",function(a){if(a.data.getTarget().is("html")){h.on("mouseup",c);n.on("mouseup",c)}})}}i.attachListener(i,"selectionchange",a,d);i.attachListener(i,"keyup",f,d);i.attachListener(i,CKEDITOR.env.webkit?"DOMFocusIn":"focus",function(){d.forceNextSelectionCheck();d.selectionChange(1)});if(s&&(CKEDITOR.env.webkit||CKEDITOR.env.gecko)){var q;
i.attachListener(i,"mousedown",function(){q=1});i.attachListener(e.getDocumentElement(),"mouseup",function(){q&&f.call(d);q=0})}else i.attachListener(CKEDITOR.env.ie?i:e.getDocumentElement(),"mouseup",f,d);CKEDITOR.env.webkit&&i.attachListener(e,"keydown",function(a){switch(a.data.getKey()){case 13:case 33:case 34:case 35:case 36:case 37:case 39:case 8:case 45:case 46:g(i)}},null,null,-1);i.attachListener(i,"keydown",j(d),null,null,-1)});d.on("setData",function(){d.unlockSelection();CKEDITOR.env.webkit&&
...
n[a.data.keyCode];if(c)return c({editor:d,selected:b.getSelectedElement(),selection:b,keyEvent:a})}}})});CKEDITOR.on("instanceReady",function(a){function c(){var a=e.editable();if(a)if(a=b(a)){var d=e.document.$.defaultView.getSelection();d.type=="Caret"&&d.anchorNode==a.$&&(h=1);f=a.getText();a.setText(i(f))}}function d(){var a=e.editable();if(a)if(a=b(a)){a.setText(f);if(h){e.document.$.defaultView.getSelection().setPosition(a.$,a.getLength());h=0}}}var e=a.editor;if(CKEDITOR.env.webkit){e.on("selectionChange",
...
CKEDITOR.SELECTION_ELEMENT}return a.type=b},getRanges:function(){var a=m?function(){function a(b){return(new CKEDITOR.dom.node(b)).getIndex()}var b=function(b,c){b=b.duplicate();b.collapse(c);var d=b.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var e=d.children,f,g,h=b.duplicate(),j=0,i=e.length-1,k=-1,n,p;j<=i;){k=Math.floor((j+i)/2);f=e[k];h.moveToElementText(f);n=h.compareEndPoints("StartToStart",b);if(n>0)i=k-1;else if(n<0)j=k+1;else return{container:d,offset:a(f)}}if(k==
...
CKEDITOR.document.getActive();this.unlock();this.selectRanges(a);this.lock();f&&!f.equals(this.root)&&f.focus()}else{var h;a:{var j,i;if(a.length==1&&!(i=a[0]).collapsed&&(h=i.getEnclosedNode())&&h.type==CKEDITOR.NODE_ELEMENT){i=i.clone();i.shrink(CKEDITOR.SHRINK_ELEMENT,true);if((j=i.getEnclosedNode())&&j.type==CKEDITOR.NODE_ELEMENT)h=j;if(h.getAttribute("contenteditable")=="false")break a}h=void 0}if(h)this.fake(h);else{if(m){i=CKEDITOR.dom.walker.whitespaces(true);j=/\ufeff|\u00a0/;b={table:1,
...
h.createBookmark();b=l.startNode;if(!a)f=l.endNode;l=h.document.$.body.createTextRange();l.moveToElementText(b.$);l.moveStart("character",1);if(f){j=h.document.$.body.createTextRange();j.moveToElementText(f.$);l.setEndPoint("EndToEnd",j);l.moveEnd("character",-1)}else{k=b.getNext(i);n=b.hasAscendant("pre");k=!(k&&k.getText&&k.getText().match(j))&&(n||!b.hasPrevious()||b.getPrevious().is&&b.getPrevious().is("br"));n=h.document.createElement("span");n.setHtml("&#65279;");n.insertBefore(b);k&&h.document.createText("﻿").insertBefore(b)}h.setStartBefore(b);
b.remove();if(a){if(k){l.moveStart("character",-1);l.select();h.document.$.selection.clear()}else l.select();h.moveToPosition(n,CKEDITOR.POSITION_BEFORE_START);n.remove()}else{h.setEndBefore(f);f.remove();l.select()}}else{f=this.getNative();if(!f)return;this.removeAllRanges();for(l=0;l<a.length;l++){if(l<a.length-1){k=a[l];n=a[l+1];j=k.clone();j.setStart(k.endContainer,k.endOffset);j.setEnd(n.startContainer,n.startOffset);if(!j.collapsed){j.shrink(CKEDITOR.NODE_ELEMENT,true);h=j.getCommonAncestor();
j=j.getEnclosedNode();if(h.isReadOnly()||j&&j.isReadOnly()){n.setStart(k.startContainer,k.startOffset);a.splice(l--,1);continue}}}h=a[l];n=this.document.$.createRange();if(h.collapsed&&CKEDITOR.env.webkit&&e(h)){k=this.root;g(k,false);j=k.getDocument().createText("​");k.setCustomData("cke-fillingChar",j);h.insertNode(j);if((k=j.getNext())&&!j.getPrevious()&&k.type==CKEDITOR.NODE_ELEMENT&&k.getName()=="br"){g(this.root);h.moveToPosition(k,CKEDITOR.POSITION_BEFORE_START)}else h.moveToPosition(j,CKEDITOR.POSITION_AFTER_END)}n.setStart(h.startContainer.$,
...
g=this._.definition,h,j=g.ignoreReadonly,i=j||g.includeReadonly;i==null&&(i=b.root.getCustomData("cke_includeReadonly"));var k=CKEDITOR.dtd[d];if(!k){h=true;k=CKEDITOR.dtd.span}b.enlarge(CKEDITOR.ENLARGE_INLINE,1);b.trim();var n=b.createBookmark(),l=n.startNode,p=n.endNode,s=l,m;if(!j){var o=b.getCommonAncestor(),j=a(l,o),o=a(p,o);j&&(s=j.getNextSourceNode(true));o&&(p=o)}for(s.getPosition(p)==CKEDITOR.POSITION_FOLLOWING&&(s=0);s;){j=false;if(s.equals(p)){s=null;j=true}else{var u=s.type==CKEDITOR.NODE_ELEMENT?
s.getName():null,o=u&&s.getAttribute("contentEditable")=="false",v=u&&s.getAttribute("data-nostyle");if(u&&s.data("cke-bookmark")){s=s.getNextSourceNode(true);continue}if(o&&i&&CKEDITOR.dtd.$block[u])for(var x=s,w=e(x),t=void 0,z=w.length,y=0,x=z&&new CKEDITOR.dom.range(x.getDocument());y<z;++y){var t=w[y],B=CKEDITOR.filter.instances[t.data("cke-filter")];if(B?B.check(this):1){x.selectNodeContents(t);f.call(this,x)}}w=u?!k[u]||v?0:o&&!i?0:(s.getPosition(p)|G)==G&&(!g.childRule||g.childRule(s)):1;
if(w)if((w=s.getParent())&&((w.getDtd()||CKEDITOR.dtd.span)[d]||h)&&(!g.parentRule||g.parentRule(w))){if(!m&&(!u||!CKEDITOR.dtd.$removeEmpty[u]||(s.getPosition(p)|G)==G)){m=b.clone();m.setStartBefore(s)}u=s.type;if(u==CKEDITOR.NODE_TEXT||o||u==CKEDITOR.NODE_ELEMENT&&!s.getChildCount()){for(var u=s,aa;(j=!u.getNext(A))&&(aa=u.getParent(),k[aa.getName()])&&(aa.getPosition(l)|C)==C&&(!g.childRule||g.childRule(aa));)u=aa;m.setEndAfter(u)}}else j=true;else j=true;s=s.getNextSourceNode(v||o)}if(j&&m&&!m.collapsed){for(var j=
q(this,c),o=j.hasAttributes(),v=m.getCommonAncestor(),u={},w={},t={},z={},U,$,ca;j&&v;){if(v.getName()==d){for(U in g.attributes)if(!z[U]&&(ca=v.getAttribute($)))j.getAttribute(U)==ca?w[U]=1:z[U]=1;for($ in g.styles)if(!t[$]&&(ca=v.getStyle($)))j.getStyle($)==ca?u[$]=1:t[$]=1}v=v.getParent()}for(U in w)j.removeAttribute(U);for($ in u)j.removeStyle($);o&&!j.hasAttributes()&&(j=null);if(j){m.extractContents().appendTo(j);m.insertNode(j);r.call(this,j);j.mergeSiblings();CKEDITOR.env.ie||j.$.normalize()}else{j=
new CKEDITOR.dom.element("span");m.extractContents().appendTo(j);m.insertNode(j);r.call(this,j);j.remove(true)}m=null}}b.moveToBookmark(n);b.shrink(CKEDITOR.SHRINK_TEXT);b.shrink(CKEDITOR.NODE_ELEMENT,true)}}function c(a){function b(){for(var a=new CKEDITOR.dom.elementPath(d.getParent()),c=new CKEDITOR.dom.elementPath(i.getParent()),e=null,f=null,g=0;g<a.elements.length;g++){var h=a.elements[g];if(h==a.block||h==a.blockLimit)break;k.checkElementRemovable(h)&&(e=h)}for(g=0;g<c.elements.length;g++){h=
c.elements[g];if(h==c.block||h==c.blockLimit)break;k.checkElementRemovable(h)&&(f=h)}f&&i.breakParent(f);e&&d.breakParent(e)}a.enlarge(CKEDITOR.ENLARGE_INLINE,1);var c=a.createBookmark(),d=c.startNode;if(a.collapsed){for(var e=new CKEDITOR.dom.elementPath(d.getParent(),a.root),f,g=0,h;g<e.elements.length&&(h=e.elements[g]);g++){if(h==e.block||h==e.blockLimit)break;if(this.checkElementRemovable(h)){var j;if(a.collapsed&&(a.checkBoundaryOfElement(h,CKEDITOR.END)||(j=a.checkBoundaryOfElement(h,CKEDITOR.START)))){f=
h;f.match=j?"start":"end"}else{h.mergeSiblings();h.is(this.element)?o.call(this,h):n(h,u(this)[h.getName()])}}}if(f){h=d;for(g=0;;g++){j=e.elements[g];if(j.equals(f))break;else if(j.match)continue;else j=j.clone();j.append(h);h=j}h[f.match=="start"?"insertBefore":"insertAfter"](f)}}else{var i=c.endNode,k=this;b();for(e=d;!e.equals(i);){f=e.getNextSourceNode();if(e.type==CKEDITOR.NODE_ELEMENT&&this.checkElementRemovable(e)){e.getName()==this.element?o.call(this,e):n(e,u(this)[e.getName()]);if(f.type==
...
a.root)).contains(this.element,1)){var b=this._.definition,c=b.attributes;if(c)for(var d in c)a.removeAttribute(d,c[d]);if(b.styles)for(var e in b.styles)b.styles.hasOwnProperty(e)&&a.removeStyle(e)}}function i(a){var b=a.createBookmark(true),c=a.createIterator();c.enforceRealBlocks=true;if(this._.enterMode)c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,e=a.document,f;d=c.getNextParagraph();)if(!d.isReadOnly()&&(c.activeFilter?c.activeFilter.check(this):1)){f=q(this,e,d);h(d,f)}a.moveToBookmark(b)}
...
b.is("pre"),e=a.is("pre"),f=!d&&e;if(d&&!e){e=b;(f=a.getBogus())&&f.remove();f=a.getHtml();f=k(f,/(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g,"");f=f.replace(/[ \t\r\n]*(<br[^>]*>)[ \t\r\n]*/gi,"$1");f=f.replace(/([ \t\n\r]+|&nbsp;)/g," ");f=f.replace(/<br\b[^>]*>/gi,"\n");if(CKEDITOR.env.ie){var g=a.getDocument().createElement("div");g.append(e);e.$.outerHTML="<pre>"+f+"</pre>";e.copyAttributes(g.getFirst());e=g.getFirst().remove()}else e.setHtml(f);b=e}else f?b=l(c?[a.getHtml()]:j(a),b):a.moveChildren(b);
b.replace(a);if(d){var c=b,h;if((h=c.getPrevious(B))&&h.type==CKEDITOR.NODE_ELEMENT&&h.is("pre")){d=k(h.getHtml(),/\n$/,"")+"\n\n"+k(c.getHtml(),/^\n/,"");CKEDITOR.env.ie?c.$.outerHTML="<pre>"+d+"</pre>":c.setHtml(d);h.remove()}}else c&&m(b)}function j(a){var b=[];k(a.getOuterHtml(),/(\S\s*)\n(?:\s|(<span[^>]+data-cke-bookmark.*?\/span>))*\n(?!$)/gi,function(a,b,c){return b+"</pre>"+c+"<pre>"}).replace(/<pre\b.*?>([\s\S]*?)<\/pre>/gi,function(a,c){b.push(c)});return b}function k(a,b,c){var d="",e=
...
this.type==CKEDITOR.STYLE_INLINE?f:this.type==CKEDITOR.STYLE_BLOCK?i:this.type==CKEDITOR.STYLE_OBJECT?b:null;return this.applyToRange(a)},removeFromRange:function(a){this.removeFromRange=this.type==CKEDITOR.STYLE_INLINE?c:this.type==CKEDITOR.STYLE_BLOCK?d:this.type==CKEDITOR.STYLE_OBJECT?g:null;return this.removeFromRange(a)},applyToObject:function(a){p(a,this)},checkActive:function(a,b){switch(this.type){case CKEDITOR.STYLE_BLOCK:return this.checkElementRemovable(a.block||a.blockLimit,true,b);case CKEDITOR.STYLE_OBJECT:case CKEDITOR.STYLE_INLINE:for(var c=
...
c.type,id:f,type:c.type};if(c.validate)this.validate=c.validate;if(c.maxLength)g.maxlength=c.maxLength;if(c.size)g.size=c.size;if(c.inputStyle)g.style=c.inputStyle;var i=this,r=false;b.on("load",function(){i.getInputElement().on("keydown",function(a){a.data.getKeystroke()==13&&(r=true)});i.getInputElement().on("keyup",function(a){if(a.data.getKeystroke()==13&&r){b.getButton("ok")&&setTimeout(function(){b.getButton("ok").click()},0);r=false}},null,null,1E3)});CKEDITOR.ui.dialog.labeledElement.call(this,
...
"aria-labelledby":this._.labelId};e.push('<div class="cke_dialog_ui_input_',c.type,'" role="presentation"');c.width&&e.push('style="width:'+c.width+'" ');e.push(">");if(c.size!=void 0)j.size=c.size;if(c.multiple!=void 0)j.multiple=c.multiple;i(a);for(var m=0,q;m<c.items.length&&(q=c.items[m]);m++)g.push('<option value="',CKEDITOR.tools.htmlEncode(q[1]!==void 0?q[1]:q[0]).replace(/"/g,"&quot;"),'" /> ',CKEDITOR.tools.htmlEncode(q[0]));if(typeof a.inputStyle!="undefined")a.style=a.inputStyle;f.select=
...
this._,c=CKEDITOR.document.getById(b.frameId).getFrameDocument(),e=b.definition,f=b.buttons,g=this.formLoadedNumber,i=this.formUnloadNumber,n=b.dialog._.editor.lang.dir,m=b.dialog._.editor.langCode;if(!g){g=this.formLoadedNumber=CKEDITOR.tools.addFunction(function(){this.fire("formLoaded")},this);i=this.formUnloadNumber=CKEDITOR.tools.addFunction(function(){this.getInputElement().clearCustomData()},this);this.getDialog()._.editor.on("destroy",function(){CKEDITOR.tools.removeFunction(g);CKEDITOR.tools.removeFunction(i)})}CKEDITOR.env.gecko?
...
{32:1,13:1}&&this.fire("click")});b.on("focus",function(){this.fire("mouseover")});b.on("blur",function(){this.fire("mouseout")})}function d(a){function b(){a.layout()}var c=CKEDITOR.document.getWindow();c.on("resize",b);a.on("hide",function(){c.removeListener("resize",b)})}function h(a,b){this._={dialog:a};CKEDITOR.tools.extend(this,b)}function j(a){function b(c){var i=a.getSize(),j=CKEDITOR.document.getWindow().getViewPaneSize(),k=c.data.$.screenX,n=c.data.$.screenY,p=k-d.x,q=n-d.y;d={x:k,y:n};
...
CKEDITOR.dialog=function(c,d){function h(){var a=t._.focusList;a.sort(function(a,b){return a.tabIndex!=b.tabIndex?b.tabIndex-a.tabIndex:a.focusIndex-b.focusIndex});for(var b=a.length,c=0;c<b;c++)a[c].focusIndex=c}function i(a){var b=t._.focusList,a=a||0;if(!(b.length<1)){var c=t._.currentFocusIndex;try{b[c].getInputElement().$.blur()}catch(d){}for(var e=c=(c+a+b.length)%b.length;a&&!b[e].isFocusable();){e=(e+a+b.length)%b.length;if(e==c)break}b[e].focus();b[e].type=="text"&&b[e].select()}}function n(b){if(t==
CKEDITOR.dialog._.currentTop){var d=b.data.getKeystroke(),e=c.lang.dir=="rtl";o=x=0;if(d==9||d==CKEDITOR.SHIFT+9){d=d==CKEDITOR.SHIFT+9;if(t._.tabBarMode){d=d?a.call(t):f.call(t);t.selectPage(d);t._.tabs[d][0].focus()}else i(d?-1:1);o=1}else if(d==CKEDITOR.ALT+121&&!t._.tabBarMode&&t.getPageCount()>1){t._.tabBarMode=true;t._.tabs[t._.currentTabId][0].focus();o=1}else if((d==37||d==39)&&t._.tabBarMode){d=d==(e?39:37)?a.call(t):f.call(t);t.selectPage(d);t._.tabs[d][0].focus();o=1}else if((d==13||d==
32)&&t._.tabBarMode){this.selectPage(this._.currentTabId);this._.tabBarMode=false;this._.currentFocusIndex=-1;i(1);o=1}else if(d==13){d=b.data.getTarget();if(!d.is("a","button","select","textarea")&&(!d.is("input")||d.$.type!="button")){(d=this.getButton("ok"))&&CKEDITOR.tools.setTimeout(d.click,0,d);o=1}x=1}else if(d==27){(d=this.getButton("cancel"))?CKEDITOR.tools.setTimeout(d.click,0,d):this.fire("cancel",{hide:true}).hide!==false&&this.hide();x=1}else return;p(b)}}function p(a){o?a.data.preventDefault(1):
...
!confirm(c.lang.common.confirmCancel))a.data.hide=false;return true}})},this,null,0);this.parts.close.on("click",function(a){this.fire("cancel",{hide:true}).hide!==false&&this.hide();a.data.preventDefault()},this);this.changeFocus=i;var y=this._.element;c.focusManager.add(y,1);this.on("show",function(){y.on("keydown",n,this);if(CKEDITOR.env.gecko)y.on("keypress",p,this)});this.on("hide",function(){y.removeListener("keydown",n);CKEDITOR.env.gecko&&y.removeListener("keypress",p);z(function(a){b.apply(a)})});
...
e)}(),function(){var a={exec:function(a){var c=a.getCommand("blockquote").state,e=a.getSelection(),b=e&&e.getRanges()[0];if(b){var g=e.createBookmarks();if(CKEDITOR.env.ie){var i=g[0].startNode,d=g[0].endNode,h;if(i&&i.getParent().getName()=="blockquote")for(h=i;h=h.getNext();)if(h.type==CKEDITOR.NODE_ELEMENT&&h.isBlockBoundary()){i.move(h,true);break}if(d&&d.getParent().getName()=="blockquote")for(h=d;h=h.getPrevious();)if(h.type==CKEDITOR.NODE_ELEMENT&&h.isBlockBoundary()){d.move(h);break}}var j=
b.createIterator();j.enlargeBr=a.config.enterMode!=CKEDITOR.ENTER_BR;if(c==CKEDITOR.TRISTATE_OFF){for(i=[];c=j.getNextParagraph();)i.push(c);if(i.length<1){c=a.document.createElement(a.config.enterMode==CKEDITOR.ENTER_P?"p":"div");d=g.shift();b.insertNode(c);c.append(new CKEDITOR.dom.text("﻿",a.document));b.moveToBookmark(d);b.selectNodeContents(c);b.collapse(true);d=b.createBookmark();i.push(c);g.unshift(d)}h=i[0].getParent();b=[];for(d=0;d<i.length;d++){c=i[d];h=h.getCommonAncestor(c.getParent())}for(c=
{table:1,tbody:1,tr:1,ol:1,ul:1};c[h.getName()];)h=h.getParent();for(d=null;i.length>0;){for(c=i.shift();!c.getParent().equals(h);)c=c.getParent();c.equals(d)||b.push(c);d=c}for(;b.length>0;){c=b.shift();if(c.getName()=="blockquote"){for(d=new CKEDITOR.dom.documentFragment(a.document);c.getFirst();){d.append(c.getFirst().remove());i.push(d.getLast())}d.replace(c)}else i.push(c)}b=a.document.createElement("blockquote");for(b.insertBefore(i[0]);i.length>0;){c=i.shift();b.append(c)}}else if(c==CKEDITOR.TRISTATE_ON){d=
...
if(!b.getCustomData("blockquote_processed")){i.push(b);CKEDITOR.dom.element.setMarker(h,b,"blockquote_processed",true)}c.push(j)}CKEDITOR.dom.element.clearAllMarkers(h);for(d=i.length-1;d>=0;d--){b=i[d];a:{h=b;for(var j=0,k=h.getChildCount(),l=void 0;j<k&&(l=h.getChild(j));j++)if(l.type==CKEDITOR.NODE_ELEMENT&&l.isBlockBoundary()){h=false;break a}h=true}h&&b.remove()}if(a.config.enterMode==CKEDITOR.ENTER_BR)for(b=true;c.length;){j=c.shift();if(j.getName()=="div"){d=new CKEDITOR.dom.documentFragment(a.document);
...
h2:r,h3:r,h4:r,h5:r,h6:r,img:function(a){var a=CKEDITOR.tools.trim(a.attributes.alt||""),b=" ";a&&!a.match(/(^http|\.(jpe?g|gif|png))/i)&&(b=" ["+a+"] ");return new CKEDITOR.htmlParser.text(b)},td:o,th:o,$:function(a){var i=a.name,q;if(g[i])return false;a.attributes={};if(i=="br")return a;if(b[i])a.name="p";else if(c[i])delete a.name;else if(f[i]){q=new CKEDITOR.htmlParser.element("cke:br");q.isEmpty=true;if(CKEDITOR.dtd.$empty[i])return q;a.add(q,0);q=q.clone();q.isEmpty=true;a.add(q);delete a.name}e[a.name]||
...
CKEDITOR.env.gecko&&(b=b.replace(/(\s)<br>$/,"$1"));a.data.dataValue=b},null,null,3);g.on("paste",function(a){var a=a.data,j=a.type,k=a.dataValue,l,o=g.config.clipboard_defaultContentType||"html";l=j=="html"||a.preSniffing=="html"?"html":f(k);l=="htmlifiedtext"?k=c(g.config,k):j=="text"&&l=="html"&&(k=b(g.config,k,d||(d=e(g))));a.startsWithEOL&&(k='<br data-cke-eol="1">'+k);a.endsWithEOL&&(k=k+'<br data-cke-eol="1">');j=="auto"&&(j=l=="html"||o=="html"?"html":"text");a.type=j;a.dataValue=k;delete a.preSniffing;
...
click:a.click||function(b){b.execCommand(a.command)}});this._={}};CKEDITOR.ui.button.handler={create:function(a){return new CKEDITOR.ui.button(a)}};CKEDITOR.ui.button.prototype={render:function(a,b){var g=CKEDITOR.env,i=this._.id=CKEDITOR.tools.getNextId(),d="",h=this.command,j;this._.editor=a;var k={id:i,button:this,editor:a,focus:function(){CKEDITOR.document.getById(i).focus()},execute:function(){this.button.click(a)},attach:function(a){this.button.attach(a)}},l=CKEDITOR.tools.addFunction(function(a){if(k.onkey){a=
new CKEDITOR.dom.event(a);return k.onkey(k,a.getKeystroke())!==false}}),o=CKEDITOR.tools.addFunction(function(a){var b;k.onfocus&&(b=k.onfocus(k,new CKEDITOR.dom.event(a))!==false);return b}),r=0;k.clickFn=j=CKEDITOR.tools.addFunction(function(){if(r){a.unlockSelection(1);r=0}k.execute();g.iOS&&a.focus()});if(this.modes){var n={},m=function(){var b=a.mode;if(b){b=this.modes[b]?n[b]!=void 0?n[b]:CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED;b=a.readOnly&&!this.readOnly?CKEDITOR.TRISTATE_DISABLED:
...
CKEDITOR.document.getById(this._.id),d=c.getFirst(),b=b.data;b!=a.lang.dir?c.addClass("cke_"+b):c.removeClass("cke_ltr").removeClass("cke_rtl");d.setAttribute("style",CKEDITOR.skin.getIconStyle(q,b=="rtl",this.icon,this.iconOffset))},this);h||(d=d+"off");var q=m=this.name||this.command;if(this.icon&&!/\./.test(this.icon)){q=this.icon;this.icon=null}d={id:i,name:m,iconName:q,label:this.label,cls:this.className||"",state:d,ariaDisabled:d=="disabled"?"true":"false",title:this.title,titleJs:g.gecko&&
!g.hc?"":(this.title||"").replace("'",""),hasArrow:this.hasArrow?"true":"false",keydownFn:l,focusFn:o,clickFn:j,style:CKEDITOR.skin.getIconStyle(q,a.lang.dir=="rtl",this.icon,this.iconOffset),arrowHtml:this.hasArrow?f.output():""};c.output(d,b);if(this.onRender)this.onRender();return k},setState:function(a){if(this._.state==a)return false;this._.state=a;var b=CKEDITOR.document.getById(this._.id);if(b){b.setState(a,"cke_button");a==CKEDITOR.TRISTATE_DISABLED?b.setAttribute("aria-disabled",true):b.removeAttribute("aria-disabled");
...
a}return a};var g={editorId:e.id,id:this.id,langCode:e.langCode,dir:e.lang.dir,cls:this.className,frame:"",env:CKEDITOR.env.cssClass,"z-index":e.config.baseFloatZIndex+1};if(this.isFramed){var i=CKEDITOR.env.air?"javascript:void(0)":CKEDITOR.env.ie?"javascript:void(function(){"+encodeURIComponent("document.open();("+CKEDITOR.tools.fixDomain+")();document.close();")+"}())":"";g.frame=f.output({id:this.id+"_frame",src:i})}i=a.output(g);b&&b.push(i);return i},addBlock:function(a,b){b=this._.blocks[a]=
...
3));k.setStyle("width",a+10+"px");a=j.element.$.scrollHeight;CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&a>0)&&(a=a+((k.$.offsetHeight||0)-(k.$.clientHeight||0)+3));k.setStyle("height",a+"px");h._.currentBlock.element.setStyle("display","none").removeStyle("display")}else k.removeStyle("height");n&&(m=m-k.$.offsetWidth);k.setStyle("left",m+"px");var b=h.element.getWindow(),a=k.$.getBoundingClientRect(),b=b.getViewPaneSize(),c=a.width||a.right-a.left,e=a.height||a.bottom-a.top,f=n?a.right:b.width-a.left,
...
h);this.removeListener("cancel",h);a.name=="ok"&&g(this.getContentElement("picker","selectedColor").getValue(),f)};a.openDialog("colordialog",function(){this.on("ok",h);this.on("cancel",h)})}else{a.focus();c.hide();a.fire("saveSnapshot");a.removeStyle(new CKEDITOR.style(b["colorButton_"+f+"Style"],{color:"inherit"}));if(d){var j=b["colorButton_"+f+"Style"];j.childRule=f=="back"?function(a){return e(a)}:function(a){return!(a.is("a")||a.getElementsByTag("a").count())||e(a)};a.applyStyle(new CKEDITOR.style(j,
{color:d}))}a.fire("saveSnapshot")}});j.push('<a class="cke_colorauto" _cke_focus=1 hidefocus=true title="',g.auto,'" onclick="CKEDITOR.tools.callFunction(',r,",null,'",d,"');return false;\" href=\"javascript:void('",g.auto,'\')" role="option" aria-posinset="1" aria-setsize="',o,'"><table role="presentation" cellspacing=0 cellpadding=0 width="100%"><tr><td><span class="cke_colorbox" id="',f,'"></span></td><td colspan=7 align=center>',g.auto,'</td></tr></table></a><table role="presentation" cellspacing=0 cellpadding=0 width="100%">');
for(f=0;f<k.length;f++){f%8===0&&j.push("</tr><tr>");var n=k[f].split("/"),m=n[0],q=n[1]||m;n[1]||(m="#"+m.replace(/^(.)(.)(.)$/,"$1$1$2$2$3$3"));n=a.lang.colorbutton.colors[q]||q;j.push('<td><a class="cke_colorbox" _cke_focus=1 hidefocus=true title="',n,'" onclick="CKEDITOR.tools.callFunction(',r,",'",m,"','",d,"'); return false;\" href=\"javascript:void('",n,'\')" role="option" aria-posinset="',f+2,'" aria-setsize="',o,'"><span class="cke_colorbox" style="background-color:#',q,'"></span></a></td>')}l&&
j.push('</tr><tr><td colspan=8 align=center><a class="cke_colormore" _cke_focus=1 hidefocus=true title="',g.more,'" onclick="CKEDITOR.tools.callFunction(',r,",'?','",d,"');return false;\" href=\"javascript:void('",g.more,"')\"",' role="option" aria-posinset="',o,'" aria-setsize="',o,'">',g.more,"</a></td>");j.push("</tr></table>");return j.join("")}function e(a){return a.getAttribute("contentEditable")=="false"||a.getAttribute("data-nostyle")}var b=a.config,g=a.lang.colorbutton;if(!CKEDITOR.env.hc){f("TextColor",
...
this.editor.getSelection(),c=a&&a.getStartElement(),e=this.editor.elementPath(),d=this._.listeners;this.removeAll();for(var f=0;f<d.length;f++){var j=d[f](c,a,e);if(j)for(var k in j){var l=this.editor.getMenuItem(k);if(l&&(!l.command||this.editor.getCommand(l.command).state)){l.state=j[k];this.add(l)}}}},onClick:function(a){this.hide();if(a.onClick)a.onClick();else a.command&&this.editor.execCommand(a.command)},onEscape:function(a){var c=this.parent;c?c._.panel.hideChild(1):a==27&&this.hide(1);return false},
...
(""+a));setTimeout(function(){c.show(j,2)},0)}else this._.panel.hideChild(1)}},proto:{add:function(a){if(!a.order)a.order=this.items.length;this.items.push(a)},removeAll:function(){this.items=[]},show:function(b,c,e,d){if(!this.parent){this._.onShow();if(!this.items.length)return}var c=c||(this.editor.lang.dir=="rtl"?2:1),f=this.items,j=this.editor,k=this._.panel,l=this._.element;if(!k){k=this._.panel=new CKEDITOR.ui.floatPanel(this.editor,CKEDITOR.document.getBody(),this._.panelDefinition,this._.level);
...
c},proto:{render:function(a,f,i){var d=a.id+(""+f),h=typeof this.state=="undefined"?CKEDITOR.TRISTATE_OFF:this.state,j="",k=h==CKEDITOR.TRISTATE_ON?"on":h==CKEDITOR.TRISTATE_DISABLED?"disabled":"off";this.role in{menuitemcheckbox:1,menuitemradio:1}&&(j=' aria-checked="'+(h==CKEDITOR.TRISTATE_ON?"true":"false")+'"');var l=this.getItems,o="&#"+(this.editor.lang.dir=="rtl"?"9668":"9658")+";",r=this.name;if(this.icon&&!/\./.test(this.icon))r=this.icon;a={id:d,name:this.name,iconName:r,label:this.label,
cls:this.className||"",state:k,hasPopup:l?"true":"false",disabled:h==CKEDITOR.TRISTATE_DISABLED,title:this.label,href:"javascript:void('"+(this.label||"").replace("'")+"')",hoverFn:a._.itemOverFn,moveOutFn:a._.itemOutFn,clickFn:a._.itemClickFn,index:f,iconStyle:CKEDITOR.skin.getIconStyle(r,this.editor.lang.dir=="rtl",r==this.icon?null:this.icon,this.iconOffset),arrowHtml:l?e.output({label:o}):"",role:this.role?this.role:"menuitem",ariaChecked:j};c.output(a,i)}}})}(),CKEDITOR.config.menu_groups="clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,table,anchor,link,image,flash,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea,div",
...
1)));f.focus();return false;case 27:e.focus();return false;case 13:case 32:d(a);return false}return true});e.on("selectionChange",function(){e.editable();for(var a=[],d=l.list=[],f=[],h=l.filters,i=true,v=e.elementPath().elements,x,w=v.length;w--;){var t=v[w],y=0;x=t.data("cke-display-name")?t.data("cke-display-name"):t.data("cke-real-element-type")?t.data("cke-real-element-type"):t.getName();i=t.hasAttribute("contenteditable")?t.getAttribute("contenteditable")=="true":i;!i&&!t.hasAttribute("contenteditable")&&
(y=1);for(var z=0;z<h.length;z++){var A=h[z](t,x);if(A===false){y=1;break}x=A||x}if(!y){d.unshift(t);f.unshift(x)}}d=d.length;for(h=0;h<d;h++){x=f[h];i=e.lang.elementspath.eleTitle.replace(/%1/,x);x=b.output({id:o+h,label:i,text:x,jsTitle:"javascript:void('"+x+"')",index:h,keyDownFn:n,clickFn:r});a.unshift(x)}k||(k=CKEDITOR.document.getById(j));f=k;f.setHtml(a.join("")+c);e.fire("elementsPathUpdate",{space:f})});e.on("readOnly",h);e.on("contentDomUnload",h);e.addCommand("elementsPathFocus",a);e.setKeystroke(CKEDITOR.ALT+
...
p.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1))||p.getPrevious().remove();p.getNext().getFirst(CKEDITOR.dom.walker.invisible(1))||p.getNext().remove();g.moveToElementEditStart(p);g.select();return}}else if(p&&p.is("pre")&&!m){i(d,f,g,o);return}if(n=g.splitBlock(s)){f=n.previousBlock;p=n.nextBlock;q=n.wasStartOfBlock;d=n.wasEndOfBlock;if(p){x=p.getParent();if(x.is("li")){p.breakParent(x);p.move(p.getNext(),1)}}else if(f&&(x=f.getParent())&&x.is("li")){f.breakParent(x);x=f.getNext();g.moveToElementEditStart(x);
...
f:u);g.select()}g.moveToElementEditStart(q&&!d?p:u)}g.select();g.scrollIntoView()}}},enterBr:function(a,b,e,f){if(e=e||c(a)){var g=e.document,i=e.checkEndOfBlock(),m=new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),q=m.block,p=q&&m.block.getName();if(!f&&p=="li")d(a,b,e,f);else{if(!f&&i&&h.test(p))if(i=q.getDirection()){g=g.createElement("div");g.setAttribute("dir",i);g.insertAfter(q);e.setStart(g,0)}else{g.createElement("br").insertAfter(q);CKEDITOR.env.gecko&&g.createText("").insertAfter(q);
e.setStartAt(q.getNext(),CKEDITOR.env.ie?CKEDITOR.POSITION_BEFORE_START:CKEDITOR.POSITION_AFTER_START)}else{a=p=="pre"&&CKEDITOR.env.ie&&CKEDITOR.env.version<8?g.createText("\r"):g.createElement("br");e.deleteContents();e.insertNode(a);if(CKEDITOR.env.needsBrFiller){g.createText("﻿").insertAfter(a);i&&(q||m.blockLimit).appendBogus();a.getNext().$.nodeValue="";e.setStartAt(a.getNext(),CKEDITOR.POSITION_AFTER_START)}else e.setStartAt(a,CKEDITOR.POSITION_AFTER_END)}e.collapse(true);e.select();e.scrollIntoView()}}}};
var g=CKEDITOR.plugins.enterkey,i=g.enterBr,d=g.enterBlock,h=/^h[1-6]$/}(),function(){function a(a,c){var e={},b=[],g={nbsp:" ",shy:"­",gt:">",lt:"<",amp:"&",apos:"'",quot:'"'},a=a.replace(/\b(nbsp|shy|gt|lt|amp|apos|quot)(?:,|$)/g,function(a,d){var f=c?"&"+d+";":g[d];e[f]=c?g[d]:"&"+d+";";b.push(f);return""});if(!c&&a){var a=a.split(","),i=document.createElement("div"),d;i.innerHTML="&"+a.join(";&")+";";d=i.innerHTML;i=null;for(i=0;i<d.length;i++){var h=d.charAt(i);e[h]="&"+a[i]+";";b.push(h)}}e.regex=
...
{};e.CKEditor=b.name;e.CKEditorFuncNum=b._.filebrowserFn;if(!e.langCode)e.langCode=b.langCode;c.action=a(d.url,e);c.filebrowser=d}function g(a,d,i,l){if(l&&l.length)for(var o,r=l.length;r--;){o=l[r];(o.type=="hbox"||o.type=="vbox"||o.type=="fieldset")&&g(a,d,i,o.children);if(o.filebrowser){if(typeof o.filebrowser=="string")o.filebrowser={action:o.type=="fileButton"?"QuickUpload":"Browse",target:o.filebrowser};if(o.filebrowser.action=="Browse"){var n=o.filebrowser.url;if(n===void 0){n=a.config["filebrowser"+
f(d)+"BrowseUrl"];if(n===void 0)n=a.config.filebrowserBrowseUrl}if(n){o.onClick=c;o.filebrowser.url=n;o.hidden=false}}else if(o.filebrowser.action=="QuickUpload"&&o["for"]){n=o.filebrowser.url;if(n===void 0){n=a.config["filebrowser"+f(d)+"UploadUrl"];if(n===void 0)n=a.config.filebrowserUploadUrl}if(n){var m=o.onClick;o.onClick=function(a){var b=a.sender;return m&&m.call(b,a)===false?false:e.call(b,a)};o.filebrowser.url=n;o.hidden=false;b(a,i.getContents(o["for"][0]).get(o["for"][1]),o.filebrowser)}}}}}
...
a.fire("saveSnapshot");var c=o[b];a[this.getValue()==b?"removeStyle":"applyStyle"](c);a.fire("saveSnapshot")},onRender:function(){a.on("selectionChange",function(b){for(var c=this.getValue(),b=b.data.path.elements,d=0,e;d<b.length;d++){e=b[d];for(var g in o)if(o[g].checkElementMatch(e,true,a)){g!=c&&this.setValue(g);return}}this.setValue("",i)},this)},refresh:function(){a.activeFilter.check(k)||this.setState(CKEDITOR.TRISTATE_DISABLED)}})}CKEDITOR.plugins.add("font",{requires:"richcombo",init:function(f){var c=
...
{requires:"richcombo",init:function(a){if(!a.blockless){for(var f=a.config,c=a.lang.format,e=f.format_tags.split(";"),b={},g=0,i=[],d=0;d<e.length;d++){var h=e[d],j=new CKEDITOR.style(f["format_"+h]);if(!a.filter.customConfig||a.filter.check(j)){g++;b[h]=j;b[h]._.enterMode=a.config.enterMode;i.push(j)}}g!==0&&a.ui.addRichCombo("Format",{label:c.label,title:c.panelTitle,toolbar:"styles,20",allowedContent:i,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(f.contentsCss),multiSelect:false,attributes:{"aria-label":c.panelTitle}},
...
hiddenfield:"input[type,name,value]",imagebutton:"input[type,alt,src]{width,height,border,border-width,border-style,margin,float}"},g={checkbox:"input",radio:"input",textfield:"input",textarea:"textarea",select:"select",button:"input",form:"form",hiddenfield:"input",imagebutton:"input"},i=function(d,e,h){var i={allowedContent:b[e],requiredContent:g[e]};e=="form"&&(i.context="form");a.addCommand(e,new CKEDITOR.dialogCommand(e,i));a.ui.addButton&&a.ui.addButton(d,{label:f.common[d.charAt(0).toLowerCase()+
d.slice(1)],command:e,toolbar:"forms,"+(c=c+10)});CKEDITOR.dialog.add(e,h)},d=this.path+"dialogs/";!a.blockless&&i("Form","form",d+"form.js");i("Checkbox","checkbox",d+"checkbox.js");i("Radio","radio",d+"radio.js");i("TextField","textfield",d+"textfield.js");i("Textarea","textarea",d+"textarea.js");i("Select","select",d+"select.js");i("Button","button",d+"button.js");var h=a.plugins.image;h&&!a.plugins.image2&&i("ImageButton","imagebutton",CKEDITOR.plugins.getPath("image")+"dialogs/image.js");i("HiddenField",
"hiddenfield",d+"hiddenfield.js");if(a.addMenuItems){i={checkbox:{label:f.forms.checkboxAndRadio.checkboxTitle,command:"checkbox",group:"checkbox"},radio:{label:f.forms.checkboxAndRadio.radioTitle,command:"radio",group:"radio"},textfield:{label:f.forms.textfield.title,command:"textfield",group:"textfield"},hiddenfield:{label:f.forms.hidden.title,command:"hiddenfield",group:"hiddenfield"},button:{label:f.forms.button.title,command:"button",group:"button"},select:{label:f.forms.select.title,command:"select",
...
function(b){g=a.getSelection();i=g.createBookmarks(1);if(!b.data)b.data={};b.data.done=false},b,null,0);b.on("exec",function(){a.forceNextSelectionCheck();g.selectBookmarks(i)},b,null,100)}var f=CKEDITOR.TRISTATE_DISABLED,c=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indent",{init:function(c){var b=CKEDITOR.plugins.indent.genericDefinition;a(c,c.addCommand("indent",new b(true)));a(c,c.addCommand("outdent",new b));if(c.ui.addButton){c.ui.addButton("Indent",{label:c.lang.indent.indent,command:"indent",
directional:true,toolbar:"indent,20"});c.ui.addButton("Outdent",{label:c.lang.indent.outdent,command:"outdent",directional:true,toolbar:"indent,10"})}c.on("dirChanged",function(a){var b=c.createRange(),d=a.data.node;b.setStartBefore(d);b.setEndAfter(d);for(var f=new CKEDITOR.dom.walker(b),j;j=f.next();)if(j.type==CKEDITOR.NODE_ELEMENT)if(!j.equals(d)&&j.getDirection()){b.setStartAfter(j);f=new CKEDITOR.dom.walker(b)}else{var k=c.config.indentClasses;if(k)for(var l=a.data.dir=="ltr"?["_rtl",""]:["",
"_rtl"],o=0;o<k.length;o++)if(j.hasClass(k[o]+l[0])){j.removeClass(k[o]+l[0]);j.addClass(k[o]+l[1])}k=j.getStyle("margin-right");l=j.getStyle("margin-left");k?j.setStyle("margin-left",k):j.removeStyle("margin-left");l?j.setStyle("margin-right",l):j.removeStyle("margin-right")}})}});CKEDITOR.plugins.indent={genericDefinition:function(a){this.isIndent=!!a;this.startDisabled=!this.isIndent},specificDefinition:function(a,b,c){this.name=b;this.editor=a;this.jobs={};this.enterBr=a.config.enterMode==CKEDITOR.ENTER_BR;
...
g){q=new CKEDITOR.dom.walker(n);q.evaluator=c;n.endContainer=q.previous()}if(m)return b(m)}return 0}function f(a,b){b||(b=a.contains(this.context));return b&&a.block&&a.block.equals(b.getFirst(c))}function c(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.is("li")}function e(a){return b(a)&&g(a)}var b=CKEDITOR.dom.walker.whitespaces(true),g=CKEDITOR.dom.walker.bookmark(false,true),i=CKEDITOR.TRISTATE_DISABLED,d=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentlist",{requires:"indent",init:function(b){function c(b,
g){e.specificDefinition.apply(this,arguments);this.requiredContent=["ul","ol"];b.on("key",function(a){if(b.mode=="wysiwyg"&&a.data.keyCode==this.indentKey){var c=this.getContext(b.elementPath());if(c&&(!this.isIndent||!f.call(this,b.elementPath(),c))){b.execCommand(this.relatedGlobal);a.cancel()}}},this);this.jobs[this.isIndent?10:30]={refresh:this.isIndent?function(a,b){var c=this.getContext(b),e=f.call(this,b,c);return!c||!this.isIndent||e?i:d}:function(a,b){return!this.getContext(b)||this.isIndent?
i:d},exec:CKEDITOR.tools.bind(a,this)}}var e=CKEDITOR.plugins.indent;e.registerCommands(b,{indentlist:new c(b,"indentlist",true),outdentlist:new c(b,"outdentlist")});CKEDITOR.tools.extend(c.prototype,e.specificDefinition.prototype,{context:{ol:1,ul:1}})}})}(),function(){function a(a,b,c){if(!a.getCustomData("indent_processed")){var e=this.editor,g=this.isIndent;if(b){e=a.$.className.match(this.classNameRegex);c=0;if(e){e=e[1];c=CKEDITOR.tools.indexOf(b,e)+1}if((c=c+(g?1:-1))<0)return;c=Math.min(c,
...
"ltr"?"margin-left":"margin-right"}var c=CKEDITOR.dtd.$listItem,e=CKEDITOR.dtd.$list,b=CKEDITOR.TRISTATE_DISABLED,g=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentblock",{requires:"indent",init:function(i){function d(d,i){h.specificDefinition.apply(this,arguments);this.allowedContent={"div h1 h2 h3 h4 h5 h6 ol p pre ul":{propertiesOnly:true,styles:!j?"margin-left,margin-right":null,classes:j||null}};if(this.enterBr)this.allowedContent.div=true;this.requiredContent=(this.enterBr?"div":"p")+(j?"("+
j.join(",")+")":"{margin-left}");this.jobs={20:{refresh:function(a,d){var e=d.block||d.blockLimit;if(e.is(c))e=e.getParent();else if(e.getAscendant(c))return b;if(!this.enterBr&&!this.getContext(d))return b;if(j){var h;h=j;var e=e.$.className.match(this.classNameRegex),i=this.isIndent;h=e?i?e[1]!=h.slice(-1):true:i;return h?g:b}return this.isIndent?g:e?CKEDITOR[(parseInt(e.getStyle(f(e)),10)||0)<=0?"TRISTATE_DISABLED":"TRISTATE_OFF"]:b},exec:function(b){var c=b.getSelection(),c=c&&c.getRanges()[0],
d;if(d=b.elementPath().contains(e))a.call(this,d,j);else{c=c.createIterator();b=b.config.enterMode;c.enforceRealBlocks=true;for(c.enlargeBr=b!=CKEDITOR.ENTER_BR;d=c.getNextParagraph(b==CKEDITOR.ENTER_P?"p":"div");)d.isReadOnly()||a.call(this,d,j)}return true}}}}var h=CKEDITOR.plugins.indent,j=i.config.indentClasses;h.registerCommands(i,{indentblock:new d(i,"indentblock",true),outdentblock:new d(i,"outdentblock")});CKEDITOR.tools.extend(d.prototype,h.specificDefinition.prototype,{context:{div:1,dl:1,
...
f=new CKEDITOR.dom.walker(c)}else{var h=b.config.justifyClasses;if(h)if(d.hasClass(h[0])){d.removeClass(h[0]);d.addClass(h[2])}else if(d.hasClass(h[2])){d.removeClass(h[2]);d.addClass(h[0])}h=d.getStyle("text-align");h=="left"?d.setStyle("text-align","right"):h=="right"&&d.setStyle("text-align","left")}}f.prototype={exec:function(c){var b=c.getSelection(),f=c.config.enterMode;if(b){for(var i=b.createBookmarks(),d=b.getRanges(),h=this.cssClassName,j,k,l=c.config.useComputedState,l=l===void 0||l,o=
d.length-1;o>=0;o--){j=d[o].createIterator();for(j.enlargeBr=f!=CKEDITOR.ENTER_BR;k=j.getNextParagraph(f==CKEDITOR.ENTER_P?"p":"div");)if(!k.isReadOnly()){k.removeAttribute("align");k.removeStyle("text-align");var r=h&&(k.$.className=CKEDITOR.tools.ltrim(k.$.className.replace(this.cssClassRegex,""))),n=this.state==CKEDITOR.TRISTATE_OFF&&(!l||a(k,true)!=this.value);h?n?k.addClass(h):r||k.removeAttribute("class"):n&&k.setStyle("text-align",this.value)}}c.focus();c.forceNextSelectionCheck();b.selectBookmarks(i)}},
refresh:function(c,b){var f=b.block||b.blockLimit;this.setState(f.getName()!="body"&&a(f,this.editor.config.useComputedState)==this.value?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF)}};CKEDITOR.plugins.add("justify",{init:function(a){if(!a.blockless){var b=new f(a,"justifyleft","left"),g=new f(a,"justifycenter","center"),i=new f(a,"justifyright","right"),d=new f(a,"justifyblock","justify");a.addCommand("justifyleft",b);a.addCommand("justifycenter",g);a.addCommand("justifyright",i);a.addCommand("justifyblock",
...
e.match(g)){x=e.match(i);e=e.match(d);w.type="email";var t=w.email={};t.address=v[1];x&&(t.subject=decodeURIComponent(x[1]));e&&(t.body=decodeURIComponent(e[1]))}else if(e&&(x=e.match(j))){w.type="url";w.url={};w.url.protocol=x[1];w.url.url=x[2]}if(c){if(e=c.getAttribute("target"))w.target={type:e.match(k)?e:"frame",name:e};else if(e=(e=c.data("cke-pa-onclick")||c.getAttribute("onclick"))&&e.match(r))for(w.target={type:"popup",name:e[1]};v=n.exec(e[2]);)(v[2]=="yes"||v[2]=="1")&&!(v[1]in{height:1,
...
var f=d.extractContents();b.trim(false,true);var g=b.createBookmark(),h=new CKEDITOR.dom.elementPath(b.startContainer),j=h.block,h=h.lastElement.getAscendant("li",1)||j,r=new CKEDITOR.dom.elementPath(d.startContainer),o=r.contains(CKEDITOR.dtd.$listItem),r=r.contains(CKEDITOR.dtd.$list);if(j)(j=j.getBogus())&&j.remove();else if(r)(j=r.getPrevious(k))&&l(j)&&j.remove();(j=f.getLast())&&(j.type==CKEDITOR.NODE_ELEMENT&&j.is("br"))&&j.remove();(j=b.startContainer.getChild(b.startOffset))?f.insertBefore(j):
b.startContainer.append(f);if(o)if(f=i(o))if(h.contains(o)){c(f,o.getParent(),o);f.remove()}else h.append(f);for(;d.checkStartOfBlock()&&d.checkEndOfBlock();){r=d.startPath();f=r.block;if(!f)break;if(f.is("li")){h=f.getParent();f.equals(h.getLast(k))&&f.equals(h.getFirst(k))&&(f=h)}d.moveToPosition(f,CKEDITOR.POSITION_BEFORE_START);f.remove()}d=d.clone();f=a.editable();d.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);d=new CKEDITOR.dom.walker(d);d.evaluator=function(a){return k(a)&&!l(a)};(d=d.next())&&
...
r.type==CKEDITOR.NODE_ELEMENT&&d[r.getName()]?CKEDITOR.plugins.list.listToArray(r,b,c,e+1,j.grandparent):j.contents.push(r)}}}return c},arrayToList:function(a,b,c,e,f){c||(c=0);if(!a||a.length<c+1)return null;for(var g,h=a[c].parent.getDocument(),i=new CKEDITOR.dom.documentFragment(h),l=null,r=c,o=Math.max(a[c].indent,0),z=null,A,B,G=e==CKEDITOR.ENTER_P?"p":"div";;){var C=a[r];g=C.grandparent;A=C.element.getDirection(1);if(C.indent==o){if(!l||a[r].parent.getName()!=l.getName()){l=a[r].parent.clone(false,
1);f&&l.setAttribute("dir",f);i.append(l)}z=l.append(C.element.clone(0,1));A!=l.getDirection(1)&&z.setAttribute("dir",A);for(g=0;g<C.contents.length;g++)z.append(C.contents[g].clone(1,1));r++}else if(C.indent==Math.max(o,0)+1){C=a[r-1].element.getDirection(1);r=CKEDITOR.plugins.list.arrayToList(a,null,r,e,C!=A?A:null);!z.getChildCount()&&(CKEDITOR.env.needsNbspFiller&&!(h.$.documentMode>7))&&z.append(h.createText(" "));z.append(r.listNode);r=r.nextIndex}else if(C.indent==-1&&!c&&g){if(d[g.getName()]){z=
C.element.clone(false,true);A!=g.getDirection(1)&&z.setAttribute("dir",A)}else z=new CKEDITOR.dom.documentFragment(h);var l=g.getDirection(1)!=A,J=C.element,D=J.getAttribute("class"),F=J.getAttribute("style"),E=z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&(e!=CKEDITOR.ENTER_BR||l||F||D),I,L=C.contents.length,H;for(g=0;g<L;g++){I=C.contents[g];if(j(I)&&L>1)E?H=I.clone(1,1):z.append(I.clone(1,1));else if(I.type==CKEDITOR.NODE_ELEMENT&&I.isBlockBoundary()){l&&!I.getDirection()&&I.setAttribute("dir",A);B=
...
g(b);if(c.getAttribute("contenteditable")=="true")return b;if(c.is(a.triggers))return c}return null}function e(a,b,c){u(a,b);u(a,c);a=b.size.bottom;c=c.size.top;return a&&c?0|(a+c)/2:a||c}function b(a,b,c){return b=b[c?"getPrevious":"getNext"](function(b){return b&&b.type==CKEDITOR.NODE_TEXT&&!Y(b)||k(b)&&!l(b)&&!j(a,b)})}function g(a,b){if(a.data("cke-editable"))return null;for(b||(a=a.getParent());a;){if(a.data("cke-editable"))break;if(a.hasAttribute("contenteditable"))return a;a=a.getParent()}return null}
function i(a){var b=a.doc,c=z('<span contenteditable="false" style="'+P+"position:absolute;border-top:1px dashed "+a.boxColor+'"></span>',b),e=CKEDITOR.getUrl(this.path+"images/"+(A.hidpi?"hidpi/":"")+"icon"+(a.rtl?"-rtl":"")+".png");t(c,{attach:function(){this.wrap.getParent()||this.wrap.appendTo(a.editable,true);return this},lineChildren:[t(z('<span title="'+a.editor.lang.magicline.title+'" contenteditable="false">&#8629;</span>',b),{base:P+"height:17px;width:17px;"+(a.rtl?"left":"right")+":17px;background:url("+
...
c=a.mouse,d=a.view,e=a.triggerOffset;v(a);var g=c.y>(a.inInlineMode?d.editable.top+d.editable.height/2:Math.min(d.editable.height,d.pane.height)/2),b=b[g?"getLast":"getFirst"](function(a){return!(Y(a)||Z(a))});if(!b)return null;j(a,b)&&(b=a.line.wrap[g?"getPrevious":"getNext"](function(a){return!(Y(a)||Z(a))}));if(!k(b)||l(b)||!r(a,b))return null;u(a,b);if(!g&&b.size.top>=0&&c.y>0&&c.y<b.size.top+e){a=a.inInlineMode||d.scroll.y===0?L:Q;return new f([null,b,J,E,a])}if(g&&b.size.bottom<=d.pane.height&&
...
[]),triggers:e.magicline_everywhere?N:{table:1,hr:1,div:1,ul:1,ol:1,dl:1,form:1,blockquote:1}},r,u,w;m.isRelevant=function(a){return k(a)&&!j(m,a)&&!l(a)};a.on("contentDom",function(){var g=a.editable(),k=a.document,l=a.window;t(m,{editable:g,inInlineMode:g.isInline(),doc:k,win:l,hotNode:null},true);m.boundary=m.inInlineMode?m.editable:m.doc.getDocumentElement();if(!g.is(G.$inline)){m.inInlineMode&&!o(g)&&g.setStyles({position:"relative",top:null,left:null});i.call(this,m);x(m);g.attachListener(a,
...
c;m.lastCmdDirection=c.data("cke-magicline-dir")==="true"?true:false;return}}});this.backdoor={accessFocusSpace:d,boxTrigger:f,isLine:j,getAscendantTrigger:c,getNonEmptyNeighbour:b,getSize:s,that:m,triggerEdge:p,triggerEditable:q,triggerExpand:ba}}},this)}});var t=CKEDITOR.tools.extend,y=CKEDITOR.dom.element,z=y.createFromHtml,A=CKEDITOR.env,B=CKEDITOR.env.ie&&CKEDITOR.env.version<9,G=CKEDITOR.dtd,C={},J=128,D=64,F=32,E=16,I=8,L=4,H=2,Q=1,O=" ",M=G.$listItem,K=G.$tableContent,R=t({},G.$nonEditable,
...
CKEDITOR.instances,c;for(c in b){var e=b[c];if(e.mode=="wysiwyg"&&!e.readOnly){e=e.document.getBody();e.setAttribute("contentEditable",false);e.setAttribute("contentEditable",true)}}if(a.editable().hasFocus){a.toolbox.focus();a.focus()}}}CKEDITOR.plugins.add("maximize",{init:function(a){function f(){var b=j.getViewPaneSize();a.resize(b.width,b.height,null,true)}if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE&&!a.plugins.sharedspace){var d=a.lang,h=CKEDITOR.document,j=h.getWindow(),k,l,o,r=CKEDITOR.TRISTATE_OFF;
a.addCommand("maximize",{modes:{wysiwyg:!CKEDITOR.env.iOS,source:!CKEDITOR.env.iOS},readOnly:1,editorFocus:false,exec:function(){var n=a.container.getFirst(function(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasClass("cke_inner")}),m=a.ui.space("contents");if(a.mode=="wysiwyg"){var q=a.getSelection();k=q&&q.getRanges();l=j.getScrollPosition()}else{var p=a.editable().$;k=!CKEDITOR.env.ie&&[p.selectionStart,p.selectionEnd];l=[p.scrollLeft,p.scrollTop]}if(this.state==CKEDITOR.TRISTATE_OFF){j.on("resize",
f);o=j.getScrollPosition();for(q=a.container;q=q.getParent();){q.setCustomData("maximize_saved_styles",c(q));q.setStyle("z-index",a.config.baseFloatZIndex-5)}m.setCustomData("maximize_saved_styles",c(m,true));n.setCustomData("maximize_saved_styles",c(n,true));m={overflow:CKEDITOR.env.webkit?"":"hidden",width:0,height:0};h.getDocumentElement().setStyles(m);!CKEDITOR.env.gecko&&h.getDocumentElement().setStyle("position","fixed");(!CKEDITOR.env.gecko||!CKEDITOR.env.quirks)&&h.getBody().setStyles(m);
CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(0,0)},0):j.$.scrollTo(0,0);n.setStyle("position",CKEDITOR.env.gecko&&CKEDITOR.env.quirks?"fixed":"absolute");n.$.offsetLeft;n.setStyles({"z-index":a.config.baseFloatZIndex-5,left:"0px",top:"0px"});n.addClass("cke_maximized");f();m=n.getDocumentPosition();n.setStyles({left:-1*m.x+"px",top:-1*m.y+"px"});CKEDITOR.env.gecko&&b(a)}else if(this.state==CKEDITOR.TRISTATE_ON){j.removeListener("resize",f);m=[m,n];for(q=0;q<m.length;q++){e(m[q],m[q].getCustomData("maximize_saved_styles"));
m[q].removeCustomData("maximize_saved_styles")}for(q=a.container;q=q.getParent();){e(q,q.getCustomData("maximize_saved_styles"));q.removeCustomData("maximize_saved_styles")}CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(o.x,o.y)},0):j.$.scrollTo(o.x,o.y);n.removeClass("cke_maximized");if(CKEDITOR.env.webkit){n.setStyle("display","inline");setTimeout(function(){n.setStyle("display","block")},0)}a.fire("resize")}this.toggleState();if(q=this.uiItems[0]){m=this.state==CKEDITOR.TRISTATE_OFF?d.maximize.maximize:
d.maximize.minimize;q=CKEDITOR.document.getById(q._.id);q.getChild(1).setHtml(m);q.setAttribute("title",m);q.setAttribute("href",'javascript:void("'+m+'");')}if(a.mode=="wysiwyg")if(k){CKEDITOR.env.gecko&&b(a);a.getSelection().selectRanges(k);(p=a.getSelection().getStartElement())&&p.scrollIntoView(true)}else j.$.scrollTo(l.x,l.y);else{if(k){p.selectionStart=k[0];p.selectionEnd=k[1]}p.scrollLeft=l[0];p.scrollTop=l[1]}k=l=null;r=this.state;a.fire("maximize",this.state)},canUndo:false});a.ui.addButton&&
...
c.data.getTarget();c.is("div")&&c.hasClass("cke_pagebreak")&&a.getSelection().selectElement(c)})})}},afterInit:function(f){function c(b){CKEDITOR.tools.extend(b.attributes,a(f.lang.pagebreak.alt),true);b.children.length=0}var e=f.dataProcessor,b=e&&e.dataFilter,e=e&&e.htmlFilter,g=/page-break-after\s*:\s*always/i,i=/display\s*:\s*none/i;e&&e.addRules({attributes:{"class":function(a,b){var c=a.replace("cke_pagebreak","");if(c!=a){var e=CKEDITOR.htmlParser.fragment.fromHtml('<span style="display: none;">&nbsp;</span>').children[0];
b.children.length=0;b.add(e);e=b.attributes;delete e["aria-label"];delete e.contenteditable;delete e.title}return c}}},{applyToAll:true,priority:5});b&&b.addRules({elements:{div:function(a){if(a.attributes["data-cke-pagebreak"])c(a);else if(g.test(a.attributes.style)){var b=a.children[0];b&&(b.name=="span"&&i.test(b.attributes.style))&&c(a)}}}})}});CKEDITOR.plugins.pagebreakCmd={exec:function(f){var c=f.document.createElement("div",{attributes:a(f.lang.pagebreak.alt)});f.insertElement(c)},context:"div",
...
c.on("paste",function(f){var i=f.data,d=i.dataValue;if(d&&(e||/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(d))){var h=a(c,b,function(){if(h)c.fire("paste",i);else if(!c.config.pasteFromWordPromptCleanup||e||confirm(c.lang.pastefromword.confirmCleanup))i.dataValue=CKEDITOR.cleanWord(d,c)});h&&f.cancel()}},null,null,3)}})}(),function(){var a={canUndo:false,async:true,exec:function(f){f.getClipboardData({title:f.lang.pastetext.title},function(c){c&&f.fire("paste",{type:"text",dataValue:c.dataValue});
...
a._.removeFormatRegex||(a._.removeFormatRegex=RegExp("^(?:"+a.config.removeFormatTags.replace(/,/g,"|")+")$","i")),c=a._.removeAttributes||(a._.removeAttributes=a.config.removeFormatAttributes.split(",")),e=CKEDITOR.plugins.removeformat.filter,b=a.getSelection().getRanges(),g=b.createIterator(),i=function(a){return a.type==CKEDITOR.NODE_ELEMENT},d;d=g.getNextRange();){d.collapsed||d.enlarge(CKEDITOR.ENLARGE_ELEMENT);var h=d.createBookmark(),j=h.startNode,k=h.endNode,l=function(b){for(var c=a.elementPath(b),
d=c.elements,g=1,h;h=d[g];g++){if(h.equals(c.block)||h.equals(c.blockLimit))break;f.test(h.getName())&&e(a,h)&&b.breakParent(h)}};l(j);if(k){l(k);for(j=j.getNextSourceNode(true,CKEDITOR.NODE_ELEMENT);j;){if(j.equals(k))break;if(j.isReadOnly()){if(j.getPosition(k)&CKEDITOR.POSITION_CONTAINS)break;j=j.getNext(i)}else{l=j.getNextSourceNode(false,CKEDITOR.NODE_ELEMENT);if(!(j.getName()=="img"&&j.data("cke-realelement"))&&e(a,j))if(f.test(j.getName()))j.remove(1);else{j.removeAttributes(c);a.fire("removeFormatCleanup",
j)}j=l}}}d.moveToBookmark(h)}a.forceNextSelectionCheck();a.getSelection().selectRanges(b)}}},filter:function(a,f){for(var c=a._.removeFormatFilters||[],e=0;e<c.length;e++)if(c[e](f)===false)return false;return true}},CKEDITOR.editor.prototype.addRemoveFormatFilter=function(a){if(!this._.removeFormatFilters)this._.removeFormatFilters=[];this._.removeFormatFilters.push(a)},CKEDITOR.config.removeFormatTags="b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var",
CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign",CKEDITOR.plugins.add("resize",{init:function(a){var f,c,e,b,g=a.config,i=a.ui.spaceId("resizer"),d=a.element?a.element.getDirection(1):"ltr";!g.resize_dir&&(g.resize_dir="vertical");g.resize_maxWidth==void 0&&(g.resize_maxWidth=3E3);g.resize_maxHeight==void 0&&(g.resize_maxHeight=3E3);g.resize_minWidth==void 0&&(g.resize_minWidth=750);g.resize_minHeight==void 0&&(g.resize_minHeight=250);if(g.resize_enabled!==
false){var h=null,j=(g.resize_dir=="both"||g.resize_dir=="horizontal")&&g.resize_minWidth!=g.resize_maxWidth,k=(g.resize_dir=="both"||g.resize_dir=="vertical")&&g.resize_minHeight!=g.resize_maxHeight,l=function(h){var i=f,l=c,p=i+(h.data.$.screenX-e)*(d=="rtl"?-1:1),h=l+(h.data.$.screenY-b);j&&(i=Math.max(g.resize_minWidth,Math.min(p,g.resize_maxWidth)));k&&(l=Math.max(g.resize_minHeight,Math.min(h,g.resize_maxHeight)));a.resize(j?i:null,l)},o=function(){CKEDITOR.document.removeListener("mousemove",
...
{onLoad:function(){var a=["p","div","pre","address","blockquote","h1","h2","h3","h4","h5","h6"],c,e,b,g,i=CKEDITOR.getUrl(this.path),d=!(CKEDITOR.env.ie&&CKEDITOR.env.version<9),h=d?":not([contenteditable=false]):not(.cke_show_blocks_off)":"",j,k;for(c=e=b=g="";j=a.pop();){k=a.length?",":"";c=c+(".cke_show_blocks "+j+h+k);b=b+(".cke_show_blocks.cke_contents_ltr "+j+h+k);g=g+(".cke_show_blocks.cke_contents_rtl "+j+h+k);e=e+(".cke_show_blocks "+j+h+"{background-image:url("+CKEDITOR.getUrl(i+"images/block_"+
...
d.getParent(),c=c.getAscendant("table").$.rows[c.$.rowIndex+(a?-1:1)];return c.cells[a?c.cells.length-1:0]});if(!f&&!a){for(var j=d.getAscendant("table").$,f=d.getParent().$.cells,j=new CKEDITOR.dom.element(j.insertRow(-1),c.document),k=0,l=f.length;k<l;k++)j.append((new CKEDITOR.dom.element(f[k],c.document)).clone(false,false)).appendBogus();e.moveToElementEditStart(j)}else if(f){f=new CKEDITOR.dom.element(f);e.moveToElementEditStart(f);(!e.checkStartOfBlock()||!e.checkEndOfBlock())&&e.selectNodeContents(f)}else return true;
...
if(c)return true;var d=d[0],e=d.getParent(),f=e.getAscendant("table"),g=CKEDITOR.tools.buildTableMap(f),j=e.$.rowIndex,i=h(g,j,d),k=d.$.rowSpan,l;if(k>1){l=Math.ceil(k/2);for(var k=Math.floor(k/2),e=j+l,f=new CKEDITOR.dom.element(f.$.rows[e]),g=h(g,e),o,e=d.clone(),j=0;j<g.length;j++){o=g[j];if(o.parentNode==f.$&&j>i){e.insertBefore(new CKEDITOR.dom.element(o));break}else o=null}o||f.append(e)}else{k=l=1;f=e.clone();f.insertAfter(e);f.append(e=d.clone());o=h(g,j);for(i=0;i<o.length;i++)o[i].rowSpan++}e.appendBogus();
d.$.rowSpan=l;e.$.rowSpan=k;l==1&&d.removeAttribute("rowSpan");k==1&&e.removeAttribute("rowSpan");return e}function l(b,c){var d=a(b);if(d.length>1)return false;if(c)return true;var d=d[0],e=d.getParent(),f=e.getAscendant("table"),f=CKEDITOR.tools.buildTableMap(f),g=h(f,e.$.rowIndex,d),j=d.$.colSpan;if(j>1){e=Math.ceil(j/2);j=Math.floor(j/2)}else{for(var j=e=1,i=[],k=0;k<f.length;k++){var l=f[k];i.push(l[g]);l[g].rowSpan>1&&(k=k+(l[g].rowSpan-1))}for(f=0;f<i.length;f++)i[f].colSpan++}f=d.clone();
...
exec:function(a){a=a.getSelection();f(a)}}));m("columnDelete",h({requiredContent:"table",exec:function(b){for(var b=b.getSelection(),b=a(b),c=b[0],e=b[b.length-1],b=c.getAscendant("table"),f=CKEDITOR.tools.buildTableMap(b),g,h,j=[],i=0,k=f.length;i<k;i++)for(var l=0,n=f[i].length;l<n;l++){f[i][l]==c.$&&(g=l);f[i][l]==e.$&&(h=l)}for(i=g;i<=h;i++)for(l=0;l<f.length;l++){e=f[l];c=new CKEDITOR.dom.element(b.$.rows[l]);e=new CKEDITOR.dom.element(e[i]);if(e.$){e.$.colSpan==1?e.remove():e.$.colSpan=e.$.colSpan-
1;l=l+(e.$.rowSpan-1);c.$.cells.length||j.push(c)}}h=b.$.rows[0]&&b.$.rows[0].cells;g=new CKEDITOR.dom.element(h[g]||(g?h[g-1]:b.$.parentNode));j.length==k&&b.remove();g&&d(g,true)}}));m("columnInsertBefore",h({requiredContent:"table",exec:function(a){a=a.getSelection();b(a,true)}}));m("columnInsertAfter",h({requiredContent:"table",exec:function(a){a=a.getSelection();b(a)}}));m("cellDelete",h({requiredContent:"table",exec:function(a){a=a.getSelection();i(a)}}));m("cellMerge",h({allowedContent:"td[colspan,rowspan]",
requiredContent:"td[colspan,rowspan]",exec:function(a){d(j(a.getSelection()),true)}}));m("cellMergeRight",h({allowedContent:"td[colspan]",requiredContent:"td[colspan]",exec:function(a){d(j(a.getSelection(),"right"),true)}}));m("cellMergeDown",h({allowedContent:"td[rowspan]",requiredContent:"td[rowspan]",exec:function(a){d(j(a.getSelection(),"down"),true)}}));m("cellVerticalSplit",h({allowedContent:"td[rowspan]",requiredContent:"td[rowspan]",exec:function(a){d(k(a.getSelection()))}}));m("cellHorizontalSplit",
...
[];this.focusCommandExecuted=false};c.prototype.focus=function(){for(var a=0,c;c=this.toolbars[a++];)for(var e=0,d;d=c.items[e++];)if(d.focus){d.focus();return}};var e={modes:{wysiwyg:1,source:1},readOnly:1,exec:function(a){if(a.toolbox){a.toolbox.focusCommandExecuted=true;CKEDITOR.env.ie||CKEDITOR.env.air?setTimeout(function(){a.toolbox.focus()},100):a.toolbox.focus()}}};CKEDITOR.plugins.add("toolbar",{requires:"button",init:function(b){var f,i=function(a,c){var e,k=b.lang.dir=="rtl",l=b.config.toolbarGroupCycling,
o=k?37:39,k=k?39:37,l=l===void 0||l;switch(c){case 9:case CKEDITOR.SHIFT+9:for(;!e||!e.items.length;){e=c==9?(e?e.next:a.toolbar.next)||b.toolbox.toolbars[0]:(e?e.previous:a.toolbar.previous)||b.toolbox.toolbars[b.toolbox.toolbars.length-1];if(e.items.length)for(a=e.items[f?e.items.length-1:0];a&&!a.focus;)(a=f?a.previous:a.next)||(e=0)}a&&a.focus();return false;case o:e=a;do{e=e.next;!e&&l&&(e=a.toolbar.items[0])}while(e&&!e.focus);e?e.focus():i(a,9);return false;case 40:if(a.button&&a.button.hasArrow){b.once("panelShow",
function(a){a.data._.panel._.currentBlock.onKeyDown(40)});a.execute()}else i(a,c==40?o:k);return false;case k:case 38:e=a;do{e=e.previous;!e&&l&&(e=a.toolbar.items[a.toolbar.items.length-1])}while(e&&!e.focus);if(e)e.focus();else{f=1;i(a,CKEDITOR.SHIFT+9);f=0}return false;case 27:b.focus();return false;case 13:case 32:a.execute();return false}return true};b.on("uiSpace",function(d){if(d.data.space==b.config.toolbarLocation){d.removeListener();b.toolbox=new c;var e=CKEDITOR.tools.getNextId(),f=['<span id="',
...
var t=o.push(q)-1;if(t>0){q.previous=o[t-1];q.previous.next=q}}if(w){if(!g){f.push('<span class="cke_toolgroup" role="presentation">');g=1}}else if(g){f.push("</span>");g=0}m=function(a){a=a.render(b,f);t=q.items.push(a)-1;if(t>0){a.previous=q.items[t-1];a.previous.next=a}a.toolbar=q;a.onkey=i;a.onfocus=function(){b.toolbox.focusCommandExecuted||b.focus()}};if(l){m(l);l=0}m(x)}}if(g){f.push("</span>");l=g=0}q&&f.push('<span class="cke_toolbar_end"></span></span>')}}}b.config.toolbarCanCollapse&&f.push("</span>");
...
{8:1,46:1};CKEDITOR.plugins.add("undo",{init:function(b){function e(a){i.enabled&&a.data.command.canUndo!==false&&i.save()}function f(){i.enabled=b.readOnly?false:b.mode=="wysiwyg";i.onChange()}var i=b.undoManager=new c(b),l=i.editingHandler=new g(i),o=b.addCommand("undo",{exec:function(){if(i.undo()){b.selectionChange();this.fire("afterUndo")}},startDisabled:true,canUndo:false}),r=b.addCommand("redo",{exec:function(){if(i.redo()){b.selectionChange();this.fire("afterRedo")}},startDisabled:true,canUndo:false});
b.setKeystroke([[a[0],"undo"],[a[1],"redo"],[a[2],"redo"]]);i.onChange=function(){o.setState(i.undoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);r.setState(i.redoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED)};b.on("beforeCommandExec",e);b.on("afterCommandExec",e);b.on("saveSnapshot",function(a){i.save(a.data&&a.data.contentOnly)});b.on("contentDom",l.attachListeners,l);b.on("instanceReady",function(){b.fire("saveSnapshot")});b.on("beforeModeUnload",function(){b.mode=="wysiwyg"&&
...
b.updateSelection(new e(b.editor));b.resetType()},ignoreInputEventListener:function(){this.ignoreInputEvent=true},attachListeners:function(){var a=this.undoManager.editor.editable(),b=this;a.attachListener(a,"keydown",function(a){b.onKeydown(a);if(c.ieFunctionalKeysBug(a.data.getKey()))b.onInput()});a.attachListener(a,CKEDITOR.env.ie?"keypress":"input",b.onInput,b);a.attachListener(a,"keyup",b.onKeyup,b);a.attachListener(a,"paste",b.ignoreInputEventListener,b);a.attachListener(a,"drop",b.ignoreInputEventListener,
b);a.attachListener(a,"click",function(){b.onNavigationKey()});a.attachListener(this.undoManager.editor,"blur",function(){b.keyEventsStack.remove(9)})}};var i=CKEDITOR.plugins.undo.KeyEventsStack=function(){this.stack=[]};i.prototype={push:function(a){return this.stack[this.stack.push({keyCode:a,inputs:0})-1]},getLastIndex:function(a){if(typeof a!="number")return this.stack.length-1;for(var b=this.stack.length;b--;)if(this.stack[b].keyCode==a)return b;return-1},getLast:function(a){a=this.getLastIndex(a);
...
function(){function a(a){var c=this.editor,e=a.document,d=e.body,h=e.getElementById("cke_actscrpt");h&&h.parentNode.removeChild(h);(h=e.getElementById("cke_shimscrpt"))&&h.parentNode.removeChild(h);(h=e.getElementById("cke_basetagscrpt"))&&h.parentNode.removeChild(h);if(CKEDITOR.env.gecko){d.contentEditable=false;if(CKEDITOR.env.version<2E4){d.innerHTML=d.innerHTML.replace(/^.*<\!-- cke-content-start --\>/,"");setTimeout(function(){var a=new CKEDITOR.dom.range(new CKEDITOR.dom.document(e));a.setStart(new CKEDITOR.dom.node(d),
0);c.getSelection().selectRanges([a])},0)}}d.contentEditable=true;if(CKEDITOR.env.ie){d.hideFocus=true;d.disabled=true;d.removeAttribute("disabled")}delete this._.isLoadingData;this.$=d;e=new CKEDITOR.dom.document(e);this.setup();if(CKEDITOR.env.ie){e.getDocumentElement().addClass(e.$.compatMode);c.config.enterMode!=CKEDITOR.ENTER_P&&this.attachListener(e,"selectionchange",function(){var a=e.getBody(),b=c.getSelection(),d=b&&b.getRanges()[0];d&&(a.getHtml().match(/^<p>(?:&nbsp;|<br>)<\/p>$/i)&&d.startContainer.equals(a))&&
setTimeout(function(){d=c.getSelection().getRanges()[0];if(!d.startContainer.equals("body")){a.getFirst().remove(1);d.moveToElementEditEnd(a);d.select()}},0)})}if(CKEDITOR.env.webkit||CKEDITOR.env.ie&&CKEDITOR.env.version>10)e.getDocumentElement().on("mousedown",function(a){a.data.getTarget().is("html")&&setTimeout(function(){c.editable().focus()})});f(c);try{c.document.$.execCommand("2D-position",false,true)}catch(j){}(CKEDITOR.env.gecko||CKEDITOR.env.ie&&c.document.$.compatMode=="CSS1Compat")&&
this.attachListener(this,"keydown",function(a){var b=a.data.getKeystroke();if(b==33||b==34)if(CKEDITOR.env.ie)setTimeout(function(){c.getSelection().scrollIntoView()},0);else if(c.window.$.innerHeight>this.$.offsetHeight){var d=c.createRange();d[b==33?"moveToElementEditStart":"moveToElementEditEnd"](this);d.select();a.data.preventDefault()}});CKEDITOR.env.ie&&this.attachListener(e,"blur",function(){try{e.$.selection.empty()}catch(a){}});CKEDITOR.env.iOS&&this.attachListener(e,"touchend",function(){a.focus()});
h=c.document.getElementsByTag("title").getItem(0);h.data("cke-title",h.getText());if(CKEDITOR.env.ie)c.document.$.title=this._.docTitle;CKEDITOR.tools.setTimeout(function(){if(this.status=="unloaded")this.status="ready";c.fire("contentDom");if(this._.isPendingFocus){c.focus();this._.isPendingFocus=false}setTimeout(function(){c.fire("dataReady")},0);CKEDITOR.env.ie&&setTimeout(function(){if(c.document){var a=c.document.$.body;a.runtimeStyle.marginBottom="0px";a.runtimeStyle.marginBottom=""}},1E3)},
0,this)}function f(a){function c(){var d;a.editable().attachListener(a,"selectionChange",function(){var c=a.getSelection().getSelectedElement();if(c){if(d){d.detachEvent("onresizestart",e);d=null}c.$.attachEvent("onresizestart",e);d=c.$}})}function e(a){a.returnValue=false}if(CKEDITOR.env.gecko)try{var d=a.document.$;d.execCommand("enableObjectResizing",false,!a.config.disableObjectResizing);d.execCommand("enableInlineTableEditing",false,!a.config.disableNativeTableHandles)}catch(f){}else CKEDITOR.env.ie&&
(CKEDITOR.env.version<11&&a.config.disableObjectResizing)&&c(a)}function c(){var a=[];if(CKEDITOR.document.$.documentMode>=8){a.push("html.CSS1Compat [contenteditable=false]{min-height:0 !important}");var c=[],e;for(e in CKEDITOR.dtd.$removeEmpty)c.push("html.CSS1Compat "+e+"[contenteditable=false]");a.push(c.join(",")+"{display:inline-block}")}else if(CKEDITOR.env.gecko){a.push("html{height:100% !important}");a.push("img:-moz-broken{-moz-force-broken-image-icon:1;min-width:24px;min-height:24px}")}a.push("html{cursor:text;*cursor:auto}");
...
d=CKEDITOR.env.air?"javascript:void(0)":CKEDITOR.env.ie?"javascript:void(function(){"+encodeURIComponent(d)+"}())":"",h=CKEDITOR.dom.element.createFromHtml('<iframe src="'+d+'" frameBorder="0"></iframe>');h.setStyles({width:"100%",height:"100%"});h.addClass("cke_wysiwyg_frame cke_reset");var j=a.ui.space("contents");j.append(h);if(d=CKEDITOR.env.ie||CKEDITOR.env.gecko)h.on("load",f);var k=a.title,l=a.fire("ariaEditorHelpLabel",{}).label;if(k){CKEDITOR.env.ie&&l&&(k=k+(", "+l));h.setAttribute("title",
k)}if(l){var k=CKEDITOR.tools.getNextId(),o=CKEDITOR.dom.element.createFromHtml('<span id="'+k+'" class="cke_voice_label">'+l+"</span>");j.append(o,1);h.setAttribute("aria-describedby",k)}a.on("beforeModeUnload",function(a){a.removeListener();o&&o.remove()});h.setAttributes({tabIndex:a.tabIndex,allowTransparency:"true"});!d&&f();if(CKEDITOR.env.webkit){d=function(){j.setStyle("width","100%");h.hide();h.setSize("width",j.getSize("width"));j.removeStyle("width");h.show()};h.setCustomData("onResize",
...
proto:{setData:function(a,e){var f=this.editor;if(e){this.setHtml(a);f.fire("dataReady")}else{this._.isLoadingData=true;f._.dataStore={id:1};var d=f.config,h=d.fullPage,j=d.docType,k=CKEDITOR.tools.buildStyleHtml(c()).replace(/<style>/,'<style data-cke-temp="1">');h||(k=k+CKEDITOR.tools.buildStyleHtml(f.config.contentsCss));var l=d.baseHref?'<base href="'+d.baseHref+'" data-cke-temp="1" />':"";h&&(a=a.replace(/<!DOCTYPE[^>]*>/i,function(a){f.docType=j=a;return""}).replace(/<\?xml\s[^\?]*\?>/i,function(a){f.xmlDeclaration=
a;return""}));a=f.dataProcessor.toHtml(a);if(h){/<body[\s|>]/.test(a)||(a="<body>"+a);/<html[\s|>]/.test(a)||(a="<html>"+a+"</html>");/<head[\s|>]/.test(a)?/<title[\s|>]/.test(a)||(a=a.replace(/<head[^>]*>/,"$&<title></title>")):a=a.replace(/<html[^>]*>/,"$&<head><title></title></head>");l&&(a=a.replace(/<head[^>]*?>/,"$&"+l));a=a.replace(/<\/head\s*>/,k+"$&");a=j+a}else a=d.docType+'<html dir="'+d.contentsLangDirection+'" lang="'+(d.contentsLanguage||f.langCode)+'"><head><title>'+this._.docTitle+
...
this.clearListeners();f.fire("contentDomUnload");var o=this.getDocument();try{o.write(a)}catch(r){setTimeout(function(){o.write(a)},0)}}},getData:function(a){if(a)return this.getHtml();var a=this.editor,c=a.config,e=c.fullPage,d=e&&a.docType,f=e&&a.xmlDeclaration,j=this.getDocument(),e=e?j.getDocumentElement().getOuterHtml():j.getBody().getHtml();CKEDITOR.env.gecko&&c.enterMode!=CKEDITOR.ENTER_BR&&(e=e.replace(/<br>(?=\s*(:?$|<\/body>))/,""));e=a.dataProcessor.toDataFormat(e);f&&(e=f+"\n"+e);d&&(e=
