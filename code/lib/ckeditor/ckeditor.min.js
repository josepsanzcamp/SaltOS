...
*/
(function(){if(!window.CKEDITOR||!window.CKEDITOR.dom)window.CKEDITOR||(window.CKEDITOR=function(){var a=/(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,f={timestamp:"F5TL",version:"4.4.8 DEV",revision:"f90d0ce",rnd:Math.floor(900*Math.random())+100,_:{pending:[],basePathSrcPattern:a},status:"unloaded",basePath:function(){var b=window.CKEDITOR_BASEPATH||"";if(!b)for(var g=document.getElementsByTagName("script"),c=0;c<g.length;c++){var d=g[c].src.match(a);if(d){b=d[1];break}}-1==b.indexOf(":/")&&"//"!=b.slice(0,
...
"static")return b;b=b.getParent()}return null},getDocumentPosition:function(b){var a=0,c=0,d=this.getDocument(),e=d.getBody(),f=d.$.compatMode=="BackCompat";if(document.documentElement.getBoundingClientRect){var k=this.$.getBoundingClientRect(),l=d.$.documentElement,n=l.clientTop||e.$.clientTop||0,r=l.clientLeft||e.$.clientLeft||0,o=true;if(CKEDITOR.env.ie){o=d.getDocumentElement().contains(this);d=d.getBody().contains(this);o=f&&d||!f&&o}if(o){if(CKEDITOR.env.webkit){a=e.$.scrollLeft||l.scrollLeft;
c=e.$.scrollTop||l.scrollTop}else{c=f?e.$:l;a=c.scrollLeft;c=c.scrollTop}a=k.left+a-r;c=k.top+c-n}}else{n=this;for(r=null;n&&!(n.getName()=="body"||n.getName()=="html");){a=a+(n.$.offsetLeft-n.$.scrollLeft);c=c+(n.$.offsetTop-n.$.scrollTop);if(!n.equals(this)){a=a+(n.$.clientLeft||0);c=c+(n.$.clientTop||0)}for(;r&&!r.equals(n);){a=a-r.$.scrollLeft;c=c-r.$.scrollTop;r=r.getParent()}r=n;n=(k=n.$.offsetParent)?new CKEDITOR.dom.element(k):null}}if(b){k=this.getWindow();n=b.getWindow();if(!k.equals(n)&&
k.$.frameElement){b=(new CKEDITOR.dom.element(k.$.frameElement)).getDocumentPosition(b);a=a+b.x;c=c+b.y}}if(!document.documentElement.getBoundingClientRect&&CKEDITOR.env.gecko&&!f){a=a+(this.$.clientLeft?1:0);c=c+(this.$.clientTop?1:0)}return{x:a,y:c}},scrollIntoView:function(b){var a=this.getParent();if(a){do{(a.$.clientWidth&&a.$.clientWidth<a.$.scrollWidth||a.$.clientHeight&&a.$.clientHeight<a.$.scrollHeight)&&!a.is("body")&&this.scrollIntoParent(a,b,1);if(a.is("html")){var c=a.getWindow();try{var d=
c.$.frameElement;d&&(a=new CKEDITOR.dom.element(d))}catch(e){}}}while(a=a.getParent())}},scrollIntoParent:function(a,c,e){var d,h,f,k;function l(c,d){if(/body|html/.test(a.getName()))a.getWindow().$.scrollBy(c,d);else{a.$.scrollLeft=a.$.scrollLeft+c;a.$.scrollTop=a.$.scrollTop+d}}function n(a,b){var c={x:0,y:0};if(!a.is(o?"body":"html")){var d=a.$.getBoundingClientRect();c.x=d.left;c.y=d.top}d=a.getWindow();if(!d.equals(b)){d=n(CKEDITOR.dom.element.get(d.$.frameElement),b);c.x=c.x+d.x;c.y=c.y+d.y}return c}
function r(a,b){return parseInt(a.getComputedStyle("margin-"+b)||0,10)||0}!a&&(a=this.getWindow());f=a.getDocument();var o=f.$.compatMode=="BackCompat";a instanceof CKEDITOR.dom.window&&(a=o?f.getBody():f.getDocumentElement());f=a.getWindow();h=n(this,f);var m=n(a,f),p=this.$.offsetHeight;d=this.$.offsetWidth;var q=a.$.clientHeight,t=a.$.clientWidth;f=h.x-r(this,"left")-m.x||0;k=h.y-r(this,"top")-m.y||0;d=h.x+d+r(this,"right")-(m.x+t)||0;h=h.y+p+r(this,"bottom")-(m.y+q)||0;if(k<0||h>0)l(0,c===true?
...
"click",function(a){a.data.getTarget().is("input","select")&&a.data.preventDefault()});this.attachListener(this,"mouseup",function(a){a.data.getTarget().is("input","textarea")&&a.data.preventDefault()})}CKEDITOR.env.webkit&&this.attachListener(a,"key",function(b){if(a.readOnly)return true;b=b.data.domEvent.getKey();if(b in h){var c=b==8,d=a.getSelection().getRanges()[0],b=d.startPath();if(d.collapsed){var e;a:{var f=b.block;if(f)if(d[c?"checkStartOfBlock":"checkEndOfBlock"]())if(!d.moveToClosestEditablePosition(f,
!c)||!d.collapsed)e=false;else{if(d.startContainer.type==CKEDITOR.NODE_ELEMENT){var g=d.startContainer.getChild(d.startOffset-(c?1:0));if(g&&g.type==CKEDITOR.NODE_ELEMENT&&g.is("hr")){a.fire("saveSnapshot");g.remove();e=true;break a}}if((d=d.startPath().block)&&(!d||!d.contains(f))){a.fire("saveSnapshot");var i;(i=(c?d:f).getBogus())&&i.remove();e=a.getSelection();i=e.createBookmarks();(c?f:d).moveChildren(c?d:f,false);b.lastElement.mergeSiblings();j(f,d,!c);e.selectBookmarks(i);e=true}}else e=false;
...
10);this._.contentSize={width:a,height:b}}}}(),getSize:function(){var a=this._.element.getFirst();return{width:a.$.offsetWidth||0,height:a.$.offsetHeight||0}},move:function(a,b,c){var d=this._.element.getFirst(),e=this._.editor.lang.dir=="rtl",f=d.getComputedStyle("position")=="fixed";CKEDITOR.env.ie&&d.setStyle("zoom","100%");if(!f||!this._.position||!(this._.position.x==a&&this._.position.y==b)){this._.position={x:a,y:b};if(!f){f=CKEDITOR.document.getWindow().getScrollPosition();a=a+f.x;b=b+f.y}if(e){f=
this.getSize();a=CKEDITOR.document.getWindow().getViewPaneSize().width-f.width-a}b={top:(b>0?b:0)+"px"};b[e?"right":"left"]=(a>0?a:0)+"px";d.setStyles(b);c&&(this._.moved=1)}},getPosition:function(){return CKEDITOR.tools.extend({},this._.position)},show:function(){var a=this._.element,b=this.definition;!a.getParent()||!a.getParent().equals(CKEDITOR.document.getBody())?a.appendTo(CKEDITOR.document.getBody()):a.setStyle("display","block");this.resize(this._.contentSize&&this._.contentSize.width||b.width||
...
this.allowedContent={"div h1 h2 h3 h4 h5 h6 ol p pre ul":{propertiesOnly:true,styles:!j?"margin-left,margin-right":null,classes:j||null}};if(this.enterBr)this.allowedContent.div=true;this.requiredContent=(this.enterBr?"div":"p")+(j?"("+j.join(",")+")":"{margin-left}");this.jobs={20:{refresh:function(a,d){var e=d.block||d.blockLimit;if(!e.is(c))var h=e.getAscendant(c),e=h&&d.contains(h)||e;e.is(c)&&(e=e.getParent());if(!this.enterBr&&!this.getContext(d))return b;if(j){var h=j,e=e.$.className.match(this.classNameRegex),
...
if((s=j.contains(d))&&h.checkBoundaryOfElement(s,CKEDITOR.START)&&(s=s.getParent())&&s.is("li")&&(s=i(s))){f=s;s=s.getPrevious(k);e.moveToPosition(s&&l(s)?s:f,CKEDITOR.POSITION_BEFORE_START)}else{w.range.setStartAt(n,CKEDITOR.POSITION_AFTER_START);w.range.setEnd(h.startContainer,h.startOffset);if((s=w.previous())&&s.type==CKEDITOR.NODE_ELEMENT&&(s.getName()in d||s.is("li"))){if(!s.is("li")){w.range.selectNodeContents(s);w.reset();w.evaluator=b;s=w.previous()}f=s;e.moveToElementEditEnd(f);e.moveToPosition(e.endPath().block,
CKEDITOR.POSITION_BEFORE_END)}}if(f){g(a,e,h);c.cancel()}else if((e=j.contains(d))&&h.checkBoundaryOfElement(e,CKEDITOR.START)){f=e.getFirst(k);if(h.checkBoundaryOfElement(f,CKEDITOR.START)){s=e.getPrevious(k);if(i(f)){if(s){h.moveToElementEditEnd(s);h.select()}}else a.execCommand("outdent");c.cancel()}}}else if(f=j.contains("li")){w.range.setEndAt(n,CKEDITOR.POSITION_BEFORE_END);n=(j=f.getLast(k))&&b(j)?j:f;f=0;if((s=w.next())&&s.type==CKEDITOR.NODE_ELEMENT&&s.getName()in d&&s.equals(j)){f=1;s=w.next()}else h.checkBoundaryOfElement(n,
CKEDITOR.END)&&(f=2);if(f&&s){h=h.clone();h.moveToElementEditStart(s);if(f==2){e.moveToPosition(e.endPath().block,CKEDITOR.POSITION_BEFORE_END);h.endPath().block&&h.moveToPosition(h.endPath().block,CKEDITOR.POSITION_AFTER_START)}g(a,e,h);c.cancel()}}else{w.range.setEndAt(n,CKEDITOR.POSITION_BEFORE_END);if((s=w.next())&&s.type==CKEDITOR.NODE_ELEMENT&&s.is(d)){s=s.getFirst(k);if(j.block&&h.checkStartOfBlock()&&h.checkEndOfBlock()){j.block.remove();h.moveToElementEditStart(s);h.select()}else if(i(s)){h.moveToElementEditStart(s);
...
c.unselectable();c.lineChildren[0].on("mouseup",function(b){c.detach();d(a,function(b){var c=a.line.trigger;b[c.is(J)?"insertBefore":"insertAfter"](c.is(J)?c.lower:c.upper)},true);a.editor.focus();!B.ie&&a.enterMode!=CKEDITOR.ENTER_BR&&a.hotNode.scrollIntoView();b.data.preventDefault(true)});c.on("mousedown",function(a){a.data.preventDefault(true)});a.line=c}function d(a,b,c){var d=new CKEDITOR.dom.range(a.doc),e=a.editor,f;if(B.ie&&a.enterMode==CKEDITOR.ENTER_BR)f=a.doc.createText(O);else{f=(f=g(a.element,
...
c[e?"insertAfter":"insertBefore"](b);c.setAttributes({"data-cke-magicline-hot":1,"data-cke-magicline-dir":!!e});a.lastCmdDirection=!!e});!B.ie&&a.enterMode!=CKEDITOR.ENTER_BR&&a.hotNode.scrollIntoView();a.line.detach()}return function(d){var d=d.getSelection().getStartElement(),h,d=d.getAscendant(N,1);if(!o(a,d)&&d&&!d.equals(a.editable)&&!d.contains(a.editable)){if((h=g(d))&&h.getAttribute("contenteditable")=="false")d=h;a.element=d;h=b(a,d,!e);var i;if(k(h)&&h.is(a.triggers)&&h.is(R)&&(!b(a,h,!e)||
...
c.y>b.size.bottom-e&&c.y<d.pane.height){a=a.inInlineMode||b.size.bottom>d.pane.height-e&&b.size.bottom<d.pane.height?H:Q;return new f([b,null,G,D,a])}return null}function q(a){var d=a.mouse,e=a.view,g=a.triggerOffset,h=c(a);if(!h)return null;u(a,h);var g=Math.min(g,0|h.size.outerHeight/2),i=[],j,o;if(d.y>h.size.top-1&&d.y<h.size.top+g)o=false;else if(d.y>h.size.bottom-g&&d.y<h.size.bottom+1)o=true;else return null;if(l(h)||m(a,h,o)||h.getParent().is(M))return null;var q=b(a,h,!o);if(q){if(q&&q.type==
CKEDITOR.NODE_TEXT)return null;if(k(q)){if(l(q)||!r(a,q)||q.getParent().is(M))return null;i=[q,h][o?"reverse":"concat"]().concat([E,D])}}else{if(h.equals(a.editable[o?"getLast":"getFirst"](a.isRelevant))){v(a);o&&d.y>h.size.bottom-g&&d.y<e.pane.height&&h.size.bottom>e.pane.height-g&&h.size.bottom<e.pane.height?j=H:d.y>0&&d.y<h.size.top+g&&(j=L)}else j=Q;i=[null,h][o?"reverse":"concat"]().concat([o?G:J,D,j,h.equals(a.editable[o?"getLast":"getFirst"](a.isRelevant))?o?H:L:Q])}return 0 in i?new f(i):
...
t(a,b,c),{date:+new Date},true)}function v(a,b){a.view.editable=t(a,a.editable,b,true)}function x(a,b){if(!a.view)a.view={};var c=a.view;if(b||!(c&&c.date>new Date-T)){var d=a.win,c=d.getScrollPosition(),d=d.getViewPaneSize();s(a.view,{scroll:{x:c.x,y:c.y,width:a.doc.$.documentElement.scrollWidth-d.width,height:a.doc.$.documentElement.scrollHeight-d.height},pane:{width:d.width,height:d.height,bottom:d.height+c.y},date:+new Date},true)}}function w(a,b,c,d){for(var e=d,g=d,h=0,i=false,j=false,k=a.view.pane.height,
o=a.mouse;o.y+h<k&&o.y-h>0;){i||(i=b(e,d));j||(j=b(g,d));!i&&o.y-h>0&&(e=c(a,{x:o.x,y:o.y-h}));!j&&o.y+h<k&&(g=c(a,{x:o.x,y:o.y+h}));if(i&&j)break;h=h+2}return new f([e,g,null,null])}CKEDITOR.plugins.add("magicline",{init:function(a){var e=a.config,g=e.magicline_triggerOffset||30,m={editor:a,enterMode:e.enterMode,triggerOffset:g,holdDistance:0|g*(e.magicline_holdDistance||0.5),boxColor:e.magicline_color||"#ff0000",rtl:e.contentsLangDirection=="rtl",tabuList:["data-cke-hidden-sel"].concat(e.magicline_tabuList||
[]),triggers:e.magicline_everywhere?N:{table:1,hr:1,div:1,ul:1,ol:1,dl:1,form:1,blockquote:1}},r,u,w;m.isRelevant=function(a){return k(a)&&!j(m,a)&&!l(a)};a.on("contentDom",function(){var g=a.editable(),k=a.document,l=a.window;s(m,{editable:g,inInlineMode:g.isInline(),doc:k,win:l,hotNode:null},true);m.boundary=m.inInlineMode?m.editable:m.doc.getDocumentElement();if(!g.is(F.$inline)){m.inInlineMode&&!n(g)&&g.setStyles({position:"relative",top:null,left:null});i.call(this,m);x(m);g.attachListener(a,
...
w=null;m.line.detach()}}else{clearTimeout(w);w=null;m.line.detach()}});g.attachListener(g,"keyup",function(){m.hiddenMode=0});g.attachListener(g,"keydown",function(b){if(a.mode=="wysiwyg")switch(b.data.getKeystroke()){case 2228240:case 16:m.hiddenMode=1;m.line.detach()}});g.attachListener(m.inInlineMode?g:k,"mousemove",function(b){u=true;if(!(a.mode!="wysiwyg"||a.readOnly||w)){var c={x:b.data.$.clientX,y:b.data.$.clientY};w=setTimeout(function(){m.mouse=c;w=m.trigger=null;x(m);if(u&&!m.hiddenMode&&
a.focusManager.hasFocus&&!m.line.mouseNear()&&(m.element=S(m,true))){if((m.trigger=p(m)||q(m)||ba(m))&&!o(m,m.trigger.upper||m.trigger.lower))m.line.attach().place();else{m.trigger=null;m.line.detach()}u=false}},30)}});g.attachListener(l,"scroll",function(){if(a.mode=="wysiwyg"){m.line.detach();if(B.webkit){m.hiddenMode=1;clearTimeout(r);r=setTimeout(function(){if(!m.mouseDown)m.hiddenMode=0},50)}}});g.attachListener(A?k:l,"mousedown",function(){if(a.mode=="wysiwyg"){m.line.detach();m.hiddenMode=
1;m.mouseDown=1}});g.attachListener(A?k:l,"mouseup",function(){m.hiddenMode=0;m.mouseDown=0});a.addCommand("accessPreviousSpace",h(m));a.addCommand("accessNextSpace",h(m,true));a.setKeystroke([[e.magicline_keystrokePrevious,"accessPreviousSpace"],[e.magicline_keystrokeNext,"accessNextSpace"]]);a.on("loadSnapshot",function(){var b,c,d,e;for(e in{p:1,br:1,div:1}){b=a.document.getElementsByTag(e);for(d=b.count();d--;)if((c=b.getItem(d)).data("cke-magicline-hot")){m.hotNode=c;m.lastCmdDirection=c.data("cke-magicline-dir")===
"true"?true:false;return}}});this.backdoor={accessFocusSpace:d,boxTrigger:f,isLine:j,getAscendantTrigger:c,getNonEmptyNeighbour:b,getSize:t,that:m,triggerEdge:q,triggerEditable:p,triggerExpand:ba}}},this)}});var s=CKEDITOR.tools.extend,y=CKEDITOR.dom.element,z=y.createFromHtml,B=CKEDITOR.env,A=CKEDITOR.env.ie&&CKEDITOR.env.version<9,F=CKEDITOR.dtd,C={},J=128,G=64,E=32,D=16,I=8,L=4,H=2,Q=1,O=" ",M=F.$listItem,K=F.$tableContent,R=s({},F.$nonEditable,F.$empty),N=F.$block,T=100,P="width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;",
V=P+"border-color:transparent;display:block;border-style:solid;",W="<span>"+O+"</span>";C[CKEDITOR.ENTER_BR]="br";C[CKEDITOR.ENTER_P]="p";C[CKEDITOR.ENTER_DIV]="div";f.prototype={set:function(a,b,c){this.properties=a+b+(c||Q);return this},is:function(a){return(this.properties&a)==a}};var S=function(){function a(b,c){var d=b.$.elementFromPoint(c.x,c.y);return d&&d.nodeType?new CKEDITOR.dom.element(d):null}return function(b,c,d){if(!b.mouse)return null;var e=b.doc,f=b.line.wrap,d=d||b.mouse,g=a(e,d);
if(c&&j(b,g)){f.hide();g=a(e,d);f.show()}return!g||!(g.type==CKEDITOR.NODE_ELEMENT&&g.$)||B.ie&&B.version<9&&!b.boundary.equals(g)&&!b.boundary.contains(g)?null:g}}(),Y=CKEDITOR.dom.walker.whitespaces(),Z=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),ba=function(){function b(d){var f=d.element,g,h,i;if(!k(f)||f.contains(d.editable)||f.isReadOnly())return null;i=w(d,function(a,b){return!b.equals(a)},function(a,b){return S(a,true,b)},f);g=i.upper;h=i.lower;if(a(d,g,h))return i.set(E,I);if(g&&
f.contains(g))for(;!g.getParent().equals(f);)g=g.getParent();else g=f.getFirst(function(a){return c(d,a)});if(h&&f.contains(h))for(;!h.getParent().equals(f);)h=h.getParent();else h=f.getLast(function(a){return c(d,a)});if(!g||!h)return null;u(d,g);u(d,h);if(!(d.mouse.y>g.size.top&&d.mouse.y<h.size.bottom))return null;for(var f=Number.MAX_VALUE,j,o,m,q;h&&!h.equals(g);){if(!(o=g.getNext(d.isRelevant)))break;j=Math.abs(e(d,g,o)-d.mouse.y);if(j<f){f=j;m=g;q=o}g=o;u(d,g)}if(!m||!q||!(d.mouse.y>m.size.top&&
d.mouse.y<q.size.bottom))return null;i.upper=m;i.lower=q;return i.set(E,I)}function c(a,b){return!(b&&b.type==CKEDITOR.NODE_TEXT||Z(b)||l(b)||j(a,b)||b.type==CKEDITOR.NODE_ELEMENT&&b.$&&b.is("br"))}return function(c){var d=b(c),e;if(e=d){e=d.upper;var f=d.lower;e=!e||!f||l(f)||l(e)||f.equals(e)||e.equals(f)||f.contains(e)||e.contains(f)?false:r(c,e)&&r(c,f)&&a(c,e,f)?true:false}return e?d:null}}(),X=["top","left","right","bottom"]}(),CKEDITOR.config.magicline_keystrokePrevious=CKEDITOR.CTRL+CKEDITOR.SHIFT+
51,CKEDITOR.config.magicline_keystrokeNext=CKEDITOR.CTRL+CKEDITOR.SHIFT+52,function(){function a(a){if(!a||a.type!=CKEDITOR.NODE_ELEMENT||a.getName()!="form")return[];for(var b=[],c=["style","className"],e=0;e<c.length;e++){var f=a.$.elements.namedItem(c[e]);if(f){f=new CKEDITOR.dom.element(f);b.push([f,f.nextSibling]);f.remove()}}return b}function f(a,b){if(a&&!(a.type!=CKEDITOR.NODE_ELEMENT||a.getName()!="form")&&b.length>0)for(var c=b.length-1;c>=0;c--){var e=b[c][0],f=b[c][1];f?e.insertBefore(f):
e.appendTo(a)}}function c(b,c){var d=a(b),e={},j=b.$;if(!c){e["class"]=j.className||"";j.className=""}e.inline=j.style.cssText||"";if(!c)j.style.cssText="position: static; overflow: visible";f(d);return e}function e(b,c){var d=a(b),e=b.$;if("class"in c)e.className=c["class"];if("inline"in c)e.style.cssText=c.inline;f(d)}function b(a){if(!a.editable().isInline()){var b=CKEDITOR.instances,c;for(c in b){var e=b[c];if(e.mode=="wysiwyg"&&!e.readOnly){e=e.document.getBody();e.setAttribute("contentEditable",
false);e.setAttribute("contentEditable",true)}}if(a.editable().hasFocus){a.toolbox.focus();a.focus()}}}CKEDITOR.plugins.add("maximize",{init:function(a){function f(){var b=j.getViewPaneSize();a.resize(b.width,b.height,null,true)}if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){var d=a.lang,h=CKEDITOR.document,j=h.getWindow(),k,l,n,r=CKEDITOR.TRISTATE_OFF;a.addCommand("maximize",{modes:{wysiwyg:!CKEDITOR.env.iOS,source:!CKEDITOR.env.iOS},readOnly:1,editorFocus:false,exec:function(){var o=a.container.getFirst(function(a){return a.type==
CKEDITOR.NODE_ELEMENT&&a.hasClass("cke_inner")}),m=a.ui.space("contents");if(a.mode=="wysiwyg"){var p=a.getSelection();k=p&&p.getRanges();l=j.getScrollPosition()}else{var q=a.editable().$;k=!CKEDITOR.env.ie&&[q.selectionStart,q.selectionEnd];l=[q.scrollLeft,q.scrollTop]}if(this.state==CKEDITOR.TRISTATE_OFF){j.on("resize",f);n=j.getScrollPosition();for(p=a.container;p=p.getParent();){p.setCustomData("maximize_saved_styles",c(p));p.setStyle("z-index",a.config.baseFloatZIndex-5)}m.setCustomData("maximize_saved_styles",
c(m,true));o.setCustomData("maximize_saved_styles",c(o,true));m={overflow:CKEDITOR.env.webkit?"":"hidden",width:0,height:0};h.getDocumentElement().setStyles(m);!CKEDITOR.env.gecko&&h.getDocumentElement().setStyle("position","fixed");(!CKEDITOR.env.gecko||!CKEDITOR.env.quirks)&&h.getBody().setStyles(m);CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(0,0)},0):j.$.scrollTo(0,0);o.setStyle("position",CKEDITOR.env.gecko&&CKEDITOR.env.quirks?"fixed":"absolute");o.$.offsetLeft;o.setStyles({"z-index":a.config.baseFloatZIndex-
5,left:"0px",top:"0px"});o.addClass("cke_maximized");f();m=o.getDocumentPosition();o.setStyles({left:-1*m.x+"px",top:-1*m.y+"px"});CKEDITOR.env.gecko&&b(a)}else if(this.state==CKEDITOR.TRISTATE_ON){j.removeListener("resize",f);m=[m,o];for(p=0;p<m.length;p++){e(m[p],m[p].getCustomData("maximize_saved_styles"));m[p].removeCustomData("maximize_saved_styles")}for(p=a.container;p=p.getParent();){e(p,p.getCustomData("maximize_saved_styles"));p.removeCustomData("maximize_saved_styles")}CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(n.x,
n.y)},0):j.$.scrollTo(n.x,n.y);o.removeClass("cke_maximized");if(CKEDITOR.env.webkit){o.setStyle("display","inline");setTimeout(function(){o.setStyle("display","block")},0)}a.fire("resize")}this.toggleState();if(p=this.uiItems[0]){m=this.state==CKEDITOR.TRISTATE_OFF?d.maximize.maximize:d.maximize.minimize;p=CKEDITOR.document.getById(p._.id);p.getChild(1).setHtml(m);p.setAttribute("title",m);p.setAttribute("href",'javascript:void("'+m+'");')}if(a.mode=="wysiwyg")if(k){CKEDITOR.env.gecko&&b(a);a.getSelection().selectRanges(k);
(q=a.getSelection().getStartElement())&&q.scrollIntoView(true)}else j.$.scrollTo(l.x,l.y);else{if(k){q.selectionStart=k[0];q.selectionEnd=k[1]}q.scrollLeft=l[0];q.scrollTop=l[1]}k=l=null;r=this.state;a.fire("maximize",this.state)},canUndo:false});a.ui.addButton&&a.ui.addButton("Maximize",{label:d.maximize.maximize,command:"maximize",toolbar:"tools,10"});a.on("mode",function(){var b=a.getCommand("maximize");b.setState(b.state==CKEDITOR.TRISTATE_DISABLED?CKEDITOR.TRISTATE_DISABLED:r)},null,null,100)}}})}(),
CKEDITOR.plugins.add("newpage",{init:function(a){a.addCommand("newpage",{modes:{wysiwyg:1,source:1},exec:function(a){var c=this;a.setData(a.config.newpage_html||"",function(){a.focus();setTimeout(function(){a.fire("afterCommandExec",{name:"newpage",command:c});a.selectionChange()},200)})},async:true});a.ui.addButton&&a.ui.addButton("NewPage",{label:a.lang.newpage.toolbar,command:"newpage",toolbar:"document,20"})}}),"use strict",function(){function a(a){return{"aria-label":a,"class":"cke_pagebreak",
...
dataValue:c.dataValue});a.fire("afterCommandExec",{name:"pastefromword",command:b,returnValue:!!c})})}});c.ui.addButton&&c.ui.addButton("PasteFromWord",{label:c.lang.pastefromword.toolbar,command:"pastefromword",toolbar:"clipboard,50"});c.on("pasteState",function(a){c.getCommand("pastefromword").setState(a.data)});c.on("paste",function(f){var i=f.data,d=i.dataValue;if(d&&(e||/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(d))){var h=a(c,b,function(){if(h)c.fire("paste",i);else if(!c.config.pasteFromWordPromptCleanup||
...
{label:f.lang.pastetext.button,command:"pastetext",toolbar:"clipboard,40"});if(f.config.forcePasteAsPlainText)f.on("beforePaste",function(a){if(a.data.type!="html")a.data.type="text"});f.on("pasteState",function(a){f.getCommand("pastetext").setState(a.data)})}})}(),function(){var a,f={modes:{wysiwyg:1,source:1},canUndo:false,readOnly:1,exec:function(c){var e,b=c.config,f=b.baseHref?'<base href="'+b.baseHref+'"/>':"";if(b.fullPage)e=c.getData().replace(/<head>/,"$&"+f).replace(/[^>]*(?=<\/title>)/,
"$& &mdash; "+c.lang.preview.preview);else{var b="<body ",i=c.document&&c.document.getBody();if(i){i.getAttribute("id")&&(b=b+('id="'+i.getAttribute("id")+'" '));i.getAttribute("class")&&(b=b+('class="'+i.getAttribute("class")+'" '))}e=c.config.docType+'<html dir="'+c.config.contentsLangDirection+'"><head>'+f+"<title>"+c.lang.preview.preview+"</title>"+CKEDITOR.tools.buildStyleHtml(c.config.contentsCss)+"</head>"+(b+">")+c.getData()+"</body></html>"}f=640;b=420;i=80;try{var d=window.screen,f=Math.round(d.width*
0.8),b=Math.round(d.height*0.7),i=Math.round(d.width*0.1)}catch(h){}if(c.fire("contentPreview",c={dataValue:e})===false)return false;var d="",j;if(CKEDITOR.env.ie){window._cke_htmlToLoad=c.dataValue;j="javascript:void( (function(){document.open();"+("("+CKEDITOR.tools.fixDomain+")();").replace(/\/\/.*?\n/g,"").replace(/parent\./g,"window.opener.")+"document.write( window.opener._cke_htmlToLoad );document.close();window.opener._cke_htmlToLoad = null;})() )";d=""}if(CKEDITOR.env.gecko){window._cke_htmlToLoad=
c.dataValue;d=CKEDITOR.getUrl(a+"preview.html")}d=window.open(d,null,"toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width="+f+",height="+b+",left="+i);if(CKEDITOR.env.ie&&d)d.location=j;if(!CKEDITOR.env.ie&&!CKEDITOR.env.gecko){j=d.document;j.open();j.write(c.dataValue);j.close()}return true}};CKEDITOR.plugins.add("preview",{init:function(c){if(c.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){a=this.path;c.addCommand("preview",f);c.ui.addButton&&c.ui.addButton("Preview",
{label:c.lang.preview.preview,command:"preview",toolbar:"document,40"})}}})}(),CKEDITOR.plugins.add("print",{init:function(a){if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){a.addCommand("print",CKEDITOR.plugins.print);a.ui.addButton&&a.ui.addButton("Print",{label:a.lang.print.toolbar,command:"print",toolbar:"document,50"})}}}),CKEDITOR.plugins.print={exec:function(a){CKEDITOR.env.gecko?a.window.$.print():a.document.$.execCommand("Print")},canUndo:!1,readOnly:1,modes:{wysiwyg:1}},CKEDITOR.plugins.add("removeformat",
{init:function(a){a.addCommand("removeFormat",CKEDITOR.plugins.removeformat.commands.removeformat);a.ui.addButton&&a.ui.addButton("RemoveFormat",{label:a.lang.removeformat.toolbar,command:"removeFormat",toolbar:"cleanup,10"})}}),CKEDITOR.plugins.removeformat={commands:{removeformat:{exec:function(a){for(var f=a._.removeFormatRegex||(a._.removeFormatRegex=RegExp("^(?:"+a.config.removeFormatTags.replace(/,/g,"|")+")$","i")),c=a._.removeAttributes||(a._.removeAttributes=a.config.removeFormatAttributes.split(",")),
e=CKEDITOR.plugins.removeformat.filter,b=a.getSelection().getRanges(),g=b.createIterator(),i=function(a){return a.type==CKEDITOR.NODE_ELEMENT},d;d=g.getNextRange();){d.collapsed||d.enlarge(CKEDITOR.ENLARGE_ELEMENT);var h=d.createBookmark(),j=h.startNode,k=h.endNode,l=function(b){for(var c=a.elementPath(b),d=c.elements,g=1,h;h=d[g];g++){if(h.equals(c.block)||h.equals(c.blockLimit))break;f.test(h.getName())&&e(a,h)&&b.breakParent(h)}};l(j);if(k){l(k);for(j=j.getNextSourceNode(true,CKEDITOR.NODE_ELEMENT);j;){if(j.equals(k))break;
if(j.isReadOnly()){if(j.getPosition(k)&CKEDITOR.POSITION_CONTAINS)break;j=j.getNext(i)}else{l=j.getNextSourceNode(false,CKEDITOR.NODE_ELEMENT);if(!(j.getName()=="img"&&j.data("cke-realelement"))&&e(a,j))if(f.test(j.getName()))j.remove(1);else{j.removeAttributes(c);a.fire("removeFormatCleanup",j)}j=l}}}d.moveToBookmark(h)}a.forceNextSelectionCheck();a.getSelection().selectRanges(b)}}},filter:function(a,f){for(var c=a._.removeFormatFilters||[],e=0;e<c.length;e++)if(c[e](f)===false)return false;return true}},
CKEDITOR.editor.prototype.addRemoveFormatFilter=function(a){if(!this._.removeFormatFilters)this._.removeFormatFilters=[];this._.removeFormatFilters.push(a)},CKEDITOR.config.removeFormatTags="b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var",CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign",CKEDITOR.plugins.add("resize",{init:function(a){var f,c,e,b;function g(g){var h=f,i=c,k=h+(g.data.$.screenX-e)*(j=="rtl"?-1:1),
g=i+(g.data.$.screenY-b);l&&(h=Math.max(d.resize_minWidth,Math.min(k,d.resize_maxWidth)));n&&(i=Math.max(d.resize_minHeight,Math.min(g,d.resize_maxHeight)));a.resize(l?h:null,i)}function i(){CKEDITOR.document.removeListener("mousemove",g);CKEDITOR.document.removeListener("mouseup",i);if(a.document){a.document.removeListener("mousemove",g);a.document.removeListener("mouseup",i)}}var d=a.config,h=a.ui.spaceId("resizer"),j=a.element?a.element.getDirection(1):"ltr";!d.resize_dir&&(d.resize_dir="vertical");
d.resize_maxWidth===void 0&&(d.resize_maxWidth=3E3);d.resize_maxHeight===void 0&&(d.resize_maxHeight=3E3);d.resize_minWidth===void 0&&(d.resize_minWidth=750);d.resize_minHeight===void 0&&(d.resize_minHeight=250);if(d.resize_enabled!==false){var k=null,l=(d.resize_dir=="both"||d.resize_dir=="horizontal")&&d.resize_minWidth!=d.resize_maxWidth,n=(d.resize_dir=="both"||d.resize_dir=="vertical")&&d.resize_minHeight!=d.resize_maxHeight,r=CKEDITOR.tools.addFunction(function(h){k||(k=a.getResizable());f=
k.$.offsetWidth||0;c=k.$.offsetHeight||0;e=h.screenX;b=h.screenY;d.resize_minWidth>f&&(d.resize_minWidth=f);d.resize_minHeight>c&&(d.resize_minHeight=c);CKEDITOR.document.on("mousemove",g);CKEDITOR.document.on("mouseup",i);if(a.document){a.document.on("mousemove",g);a.document.on("mouseup",i)}h.preventDefault&&h.preventDefault()});a.on("destroy",function(){CKEDITOR.tools.removeFunction(r)});a.on("uiSpace",function(b){if(b.data.space=="bottom"){var c="";l&&!n&&(c=" cke_resizer_horizontal");!l&&n&&
(c=" cke_resizer_vertical");var d='<span id="'+h+'" class="cke_resizer'+c+" cke_resizer_"+j+'" title="'+CKEDITOR.tools.htmlEncode(a.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+r+', event)">'+(j=="ltr"?"◢":"◣")+"</span>";j=="ltr"&&c=="ltr"?b.data.html=b.data.html+d:b.data.html=d+b.data.html}},a,null,100);a.on("maximize",function(b){a.ui.space("resizer")[b.data==CKEDITOR.TRISTATE_ON?"hide":"show"]()})}}}),function(){var a={readOnly:1,exec:function(a){if(a.fire("save"))if(a=a.element.$.form)try{a.submit()}catch(c){a.submit.click&&
a.submit.click()}}};CKEDITOR.plugins.add("save",{init:function(f){if(f.elementMode==CKEDITOR.ELEMENT_MODE_REPLACE){f.addCommand("save",a).modes={wysiwyg:!!f.element.$.form};f.ui.addButton&&f.ui.addButton("Save",{label:f.lang.save.toolbar,command:"save",toolbar:"document,10"})}}})}(),function(){CKEDITOR.plugins.add("selectall",{init:function(a){a.addCommand("selectAll",{modes:{wysiwyg:1,source:1},exec:function(a){var c=a.editable();if(c.is("textarea")){a=c.$;if(CKEDITOR.env.ie)a.createTextRange().execCommand("SelectAll");
else{a.selectionStart=0;a.selectionEnd=a.value.length}a.focus()}else{if(c.is("body"))a.document.$.execCommand("SelectAll",false,null);else{var e=a.createRange();e.selectNodeContents(c);e.select()}a.forceNextSelectionCheck();a.selectionChange()}},canUndo:false});a.ui.addButton&&a.ui.addButton("SelectAll",{label:a.lang.selectall.toolbar,command:"selectAll",toolbar:"selection,10"})}})}(),function(){var a={readOnly:1,preserveState:true,editorFocus:false,exec:function(a){this.toggleState();this.refresh(a)},
refresh:function(a){if(a.document){var c=this.state==CKEDITOR.TRISTATE_ON&&(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE||a.focusManager.hasFocus)?"attachClass":"removeClass";a.editable()[c]("cke_show_blocks")}}};CKEDITOR.plugins.add("showblocks",{onLoad:function(){var a=["p","div","pre","address","blockquote","h1","h2","h3","h4","h5","h6"],c,e,b,g,i=CKEDITOR.getUrl(this.path),d=!(CKEDITOR.env.ie&&CKEDITOR.env.version<9),h=d?":not([contenteditable=false]):not(.cke_show_blocks_off)":"",j,k;for(c=e=
