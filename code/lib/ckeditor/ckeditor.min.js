...
*/
(function(){if(!window.CKEDITOR||!window.CKEDITOR.dom)window.CKEDITOR||(window.CKEDITOR=function(){var a=/(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,f={timestamp:"F1OL",version:"4.4.8 DEV",revision:"7fbfb40",rnd:Math.floor(900*Math.random())+100,_:{pending:[],basePathSrcPattern:a},status:"unloaded",basePath:function(){var b=window.CKEDITOR_BASEPATH||"";if(!b)for(var g=document.getElementsByTagName("script"),c=0;c<g.length;c++){var d=g[c].src.match(a);if(d){b=d[1];break}}-1==b.indexOf(":/")&&"//"!=b.slice(0,
...
f(this);return b[a]||(b[a]=new c(a))}var f=function(a){a=a.getPrivate&&a.getPrivate()||a._||(a._={});return a.events||(a.events={})},c=function(a){this.name=a;this.listeners=[]};c.prototype={getListenerIndex:function(a){for(var b=0,g=this.listeners;b<g.length;b++)if(g[b].fn==a)return b;return-1}};return{define:function(c,b){var g=a.call(this,c);CKEDITOR.tools.extend(g,b,true)},on:function(c,b,g,i,d){function h(k,a,d,l){k={name:c,sender:this,editor:k,data:a,listenerData:i,stop:d,cancel:l,removeListener:f};
return b.call(g,k)===false?false:k.data}function f(){l.removeListener(c,b)}var k=a.call(this,c);if(k.getListenerIndex(b)<0){k=k.listeners;g||(g=this);isNaN(d)&&(d=10);var l=this;h.fn=b;h.priority=d;for(var n=k.length-1;n>=0;n--)if(k[n].priority<=d){k.splice(n+1,0,h);return{removeListener:f}}k.unshift(h)}return{removeListener:f}},once:function(){var a=Array.prototype.slice.call(arguments),b=a[1];a[1]=function(a){a.removeListener();return b.apply(this,arguments)};return this.on.apply(this,a)},capture:function(){CKEDITOR.event.useCapture=
1;var a=this.on.apply(this,arguments);CKEDITOR.event.useCapture=0;return a},fire:function(){var a=0,b=function(){a=1},g=0,c=function(){g=1};return function(d,h,j){var k=f(this)[d],d=a,l=g;a=g=0;if(k){var n=k.listeners;if(n.length)for(var n=n.slice(0),r,o=0;o<n.length;o++){if(k.errorProof)try{r=n[o].call(this,j,h,b,c)}catch(m){}else r=n[o].call(this,j,h,b,c);r===false?g=1:typeof r!="undefined"&&(h=r);if(a||g)break}}h=g?false:typeof h=="undefined"?true:h;a=d;g=l;return h}}(),fireOnce:function(a,b,g){b=
...
"static")return b;b=b.getParent()}return null},getDocumentPosition:function(b){var a=0,c=0,d=this.getDocument(),e=d.getBody(),f=CKEDITOR.env.quirks;if(document.documentElement.getBoundingClientRect){var k=this.$.getBoundingClientRect(),l=d.$.documentElement,n=l.clientTop||e.$.clientTop||0,r=l.clientLeft||e.$.clientLeft||0,o=true;if(CKEDITOR.env.ie){o=d.getDocumentElement().contains(this);d=d.getBody().contains(this);o=f&&d||!f&&o}if(o){if(CKEDITOR.env.webkit){a=e.$.scrollLeft||l.scrollLeft;c=e.$.scrollTop||
l.scrollTop}else{c=f?e.$:l;a=c.scrollLeft;c=c.scrollTop}a=k.left+a-r;c=k.top+c-n}}else{n=this;for(r=null;n&&!(n.getName()=="body"||n.getName()=="html");){a=a+(n.$.offsetLeft-n.$.scrollLeft);c=c+(n.$.offsetTop-n.$.scrollTop);if(!n.equals(this)){a=a+(n.$.clientLeft||0);c=c+(n.$.clientTop||0)}for(;r&&!r.equals(n);){a=a-r.$.scrollLeft;c=c-r.$.scrollTop;r=r.getParent()}r=n;n=(k=n.$.offsetParent)?new CKEDITOR.dom.element(k):null}}if(b){k=this.getWindow();n=b.getWindow();if(!k.equals(n)&&k.$.frameElement){b=
...
d&&(a=new CKEDITOR.dom.element(d))}catch(e){}}}while(a=a.getParent())}},scrollIntoParent:function(a,c,e){var d,f,j,k;function l(c,d){if(/body|html/.test(a.getName()))a.getWindow().$.scrollBy(c,d);else{a.$.scrollLeft=a.$.scrollLeft+c;a.$.scrollTop=a.$.scrollTop+d}}function n(a,b){var c={x:0,y:0};if(!a.is(o?"body":"html")){var d=a.$.getBoundingClientRect();c.x=d.left;c.y=d.top}d=a.getWindow();if(!d.equals(b)){d=n(CKEDITOR.dom.element.get(d.$.frameElement),b);c.x=c.x+d.x;c.y=c.y+d.y}return c}function r(a,
b){return parseInt(a.getComputedStyle("margin-"+b)||0,10)||0}!a&&(a=this.getWindow());j=a.getDocument();var o=j.$.compatMode=="BackCompat";a instanceof CKEDITOR.dom.window&&(a=o?j.getBody():j.getDocumentElement());j=a.getWindow();f=n(this,j);var m=n(a,j),p=this.$.offsetHeight;d=this.$.offsetWidth;var q=a.$.clientHeight,t=a.$.clientWidth;j=f.x-r(this,"left")-m.x||0;k=f.y-r(this,"top")-m.y||0;d=f.x+d+r(this,"right")-(m.x+t)||0;f=f.y+p+r(this,"bottom")-(m.y+q)||0;if(k<0||f>0)l(0,c===true?k:c===false?
f:k<0?k:f);if(e&&(j<0||d>0))l(j<0?j:d,0)},setState:function(a,c,e){c=c||"cke";switch(a){case CKEDITOR.TRISTATE_ON:this.addClass(c+"_on");this.removeClass(c+"_off");this.removeClass(c+"_disabled");e&&this.setAttribute("aria-pressed",true);e&&this.removeAttribute("aria-disabled");break;case CKEDITOR.TRISTATE_DISABLED:this.addClass(c+"_disabled");this.removeClass(c+"_off");this.removeClass(c+"_on");e&&this.setAttribute("aria-disabled",true);e&&this.removeAttribute("aria-pressed");break;default:this.addClass(c+
"_off");this.removeClass(c+"_on");this.removeClass(c+"_disabled");e&&this.removeAttribute("aria-pressed");e&&this.removeAttribute("aria-disabled")}},getFrameDocument:function(){var a=this.$;try{a.contentWindow.document}catch(c){a.src=a.src}return a&&new CKEDITOR.dom.document(a.contentWindow.document)},copyAttributes:function(a,c){for(var e=this.$.attributes,c=c||{},d=0;d<e.length;d++){var f=e[d],j=f.nodeName.toLowerCase(),k;if(!(j in c))if(j=="checked"&&(k=this.getAttribute(j)))a.setAttribute(j,k);
...
if(this._.end)return null;if(!this._.start){this._.start=1;if(c.collapsed){this.end();return null}c.optimize()}var d,e=c.startContainer;d=c.endContainer;var k=c.startOffset,g=c.endOffset,f,h=this.guard,i=this.type,j=a?"getPreviousSourceNode":"getNextSourceNode";if(!a&&!this._.guardLTR){var w=d.type==CKEDITOR.NODE_ELEMENT?d:d.getParent(),s=d.type==CKEDITOR.NODE_ELEMENT?d.getChild(g):d.getNext();this._.guardLTR=function(a,b){return(!b||!w.equals(a))&&(!s||!a.equals(s))&&(a.type!=CKEDITOR.NODE_ELEMENT||
...
a.data("cke-bookmark")}return function(d){var e,k;e=d&&d.type!=CKEDITOR.NODE_ELEMENT&&(k=d.getParent())&&c(k);e=a?e:e||c(d);return!!(b^e)}};CKEDITOR.dom.walker.whitespaces=function(a){return function(b){var c;b&&b.type==CKEDITOR.NODE_TEXT&&(c=!CKEDITOR.tools.trim(b.getText())||CKEDITOR.env.webkit&&b.getText()=="​");return!!(a^c)}};CKEDITOR.dom.walker.invisible=function(a){var b=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.env.webkit?1:0;return function(d){if(b(d))d=1;else{d.type==CKEDITOR.NODE_TEXT&&
(d=d.getParent());d=d.$.offsetWidth<=c}return!!(a^d)}};CKEDITOR.dom.walker.nodeType=function(a,b){return function(c){return!!(b^c.type==a)}};CKEDITOR.dom.walker.bogus=function(a){function b(a){return!i(a)&&!d(a)}return function(c){var d=CKEDITOR.env.needsBrFiller?c.is&&c.is("br"):c.getText&&g.test(c.getText());if(d){d=c.getParent();c=c.getNext(b);d=d.isBlockBoundary()&&(!c||c.type==CKEDITOR.NODE_ELEMENT&&c.isBlockBoundary())}return!!(a^d)}};CKEDITOR.dom.walker.temp=function(a){return function(b){b.type!=
CKEDITOR.NODE_ELEMENT&&(b=b.getParent());b=b&&b.hasAttribute("data-cke-temp");return!!(a^b)}};var g=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/,i=CKEDITOR.dom.walker.whitespaces(),d=CKEDITOR.dom.walker.bookmark(),h=CKEDITOR.dom.walker.temp();CKEDITOR.dom.walker.ignored=function(a){return function(b){b=i(b)||d(b)||h(b);return!!(a^b)}};var j=CKEDITOR.dom.walker.ignored(),k=function(a){var b={},c;for(c in a)CKEDITOR.dtd[c]["#"]&&(b[c]=1);return b}(CKEDITOR.dtd.$block);CKEDITOR.dom.walker.editable=function(a){return function(b){return!!(a^
c(b))}};CKEDITOR.dom.element.prototype.getBogus=function(){var a=this;do a=a.getPreviousSourceNode();while(d(a)||i(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.is(CKEDITOR.dtd.$inline)&&!a.is(CKEDITOR.dtd.$empty));return a&&(CKEDITOR.env.needsBrFiller?a.is&&a.is("br"):a.getText&&g.test(a.getText()))?a:false}}(),CKEDITOR.dom.range=function(a){this.endOffset=this.endContainer=this.startOffset=this.startContainer=null;this.collapsed=true;var f=a instanceof CKEDITOR.dom.document;this.document=f?a:a.getDocument();
...
b(d)?true:!a&&i(d)||d.type==CKEDITOR.NODE_ELEMENT&&d.is(CKEDITOR.dtd.$removeEmpty)}}function c(a){return function(){var b;return this[a?"getPreviousNode":"getNextNode"](function(a){!b&&j(a)&&(b=a);return h(a)&&!(i(a)&&a.equals(b))})}}var e=function(a){a.collapsed=a.startContainer&&a.endContainer&&a.startContainer.equals(a.endContainer)&&a.startOffset==a.endOffset},b=function(a,b,c,d){a.optimizeBookmark();var e=a.startContainer,g=a.endContainer,f=a.startOffset,h=a.endOffset,i,j;if(g.type==CKEDITOR.NODE_TEXT)g=
g.split(h);else if(g.getChildCount()>0)if(h>=g.getChildCount()){g=g.append(a.document.createText(""));j=true}else g=g.getChild(h);if(e.type==CKEDITOR.NODE_TEXT){e.split(f);e.equals(g)&&(g=e.getNext())}else if(f)if(f>=e.getChildCount()){e=e.append(a.document.createText(""));i=true}else e=e.getChild(f).getPrevious();else{e=e.append(a.document.createText(""),1);i=true}var f=e.getParents(),h=g.getParents(),v,x,w;for(v=0;v<f.length;v++){x=f[v];w=h[v];if(!x.equals(w))break}for(var s=c,y,z,B,A=v;A<f.length;A++){y=
f[A];s&&!y.equals(e)&&(z=s.append(y.clone()));for(y=y.getNext();y;){if(y.equals(h[A])||y.equals(g))break;B=y.getNext();if(b==2)s.append(y.clone(true));else{y.remove();b==1&&s.append(y)}y=B}s&&(s=z)}s=c;for(c=v;c<h.length;c++){y=h[c];b>0&&!y.equals(g)&&(z=s.append(y.clone()));if(!f[c]||y.$.parentNode!=f[c].$.parentNode)for(y=y.getPrevious();y;){if(y.equals(f[c])||y.equals(e))break;B=y.getPrevious();if(b==2)s.$.insertBefore(y.$.cloneNode(true),s.$.firstChild);else{y.remove();b==1&&s.$.insertBefore(y.$,
s.$.firstChild)}y=B}s&&(s=z)}if(b==2){x=a.startContainer;if(x.type==CKEDITOR.NODE_TEXT){x.$.data=x.$.data+x.$.nextSibling.data;x.$.parentNode.removeChild(x.$.nextSibling)}a=a.endContainer;if(a.type==CKEDITOR.NODE_TEXT&&a.$.nextSibling){a.$.data=a.$.data+a.$.nextSibling.data;a.$.parentNode.removeChild(a.$.nextSibling)}}else{if(x&&w&&(e.$.parentNode!=x.$.parentNode||g.$.parentNode!=w.$.parentNode)){b=w.getIndex();i&&w.$.parentNode==e.$.parentNode&&b--;if(d&&x.type==CKEDITOR.NODE_ELEMENT){d=CKEDITOR.dom.element.createFromHtml('<span data-cke-bookmark="1" style="display:none">&nbsp;</span>',
a.document);d.insertAfter(x);x.mergeSiblings(false);a.moveToBookmark({startNode:d})}else a.setStart(w.getParent(),b)}a.collapse(true)}i&&e.remove();j&&g.$.parentNode&&g.remove()},g={abbr:1,acronym:1,b:1,bdo:1,big:1,cite:1,code:1,del:1,dfn:1,em:1,font:1,i:1,ins:1,label:1,kbd:1,q:1,samp:1,small:1,span:1,strike:1,strong:1,sub:1,sup:1,tt:1,u:1,"var":1},i=CKEDITOR.dom.walker.bogus(),d=/^[\t\r\n ]*(?:&nbsp;|\xa0)$/,h=CKEDITOR.dom.walker.editable(),j=CKEDITOR.dom.walker.ignored(true);CKEDITOR.dom.range.prototype=
...
a&&c.setAttribute("id",d+"E");e=this.clone();e.collapse();e.insertNode(c)}e=this.clone();e.collapse(true);e.insertNode(b);if(c){this.setStartAfter(b);this.setEndBefore(c)}else this.moveToPosition(b,CKEDITOR.POSITION_AFTER_END);return{startNode:a?d+(g?"C":"S"):b,endNode:a?d+"E":c,serializable:a,collapsed:g}},createBookmark2:function(){function a(c){var d=c.container,e=c.offset,k;k=d;var g=e;k=k.type!=CKEDITOR.NODE_ELEMENT||g===0||g==k.getChildCount()?0:k.getChild(g-1).type==CKEDITOR.NODE_TEXT&&k.getChild(g).type==
CKEDITOR.NODE_TEXT;if(k){d=d.getChild(e-1);e=d.getLength()}d.type==CKEDITOR.NODE_ELEMENT&&e>1&&(e=d.getChild(e-1).getIndex(true)+1);if(d.type==CKEDITOR.NODE_TEXT){k=d;for(g=0;(k=k.getPrevious())&&k.type==CKEDITOR.NODE_TEXT;)g=g+k.getLength();k=g;if(d.getText())e=e+k;else{g=d.getPrevious(b);if(k){e=k;d=g?g.getNext():d.getParent().getFirst()}else{d=d.getParent();e=g?g.getIndex(true)+1:0}}}c.container=d;c.offset=e}var b=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_TEXT,true);return function(b){var c=this.collapsed,
...
this.setStartAt(a,CKEDITOR.POSITION_BEFORE_START);b&&(b.is&&b.is("span")&&b.data("cke-bookmark"))&&this.setEndAt(b,CKEDITOR.POSITION_AFTER_END)},trim:function(a,b){var c=this.startContainer,d=this.startOffset,e=this.collapsed;if((!a||e)&&c&&c.type==CKEDITOR.NODE_TEXT){if(d)if(d>=c.getLength()){d=c.getIndex()+1;c=c.getParent()}else{var g=c.split(d),d=c.getIndex()+1,c=c.getParent();if(this.startContainer.equals(this.endContainer))this.setEnd(g,this.endOffset-this.startOffset);else if(c.equals(this.endContainer))this.endOffset=
...
var g=this.getCommonAncestor(),f=this.root,h,i,j,v,x,w=false,s,y;s=this.startContainer;var z=this.startOffset;if(s.type==CKEDITOR.NODE_TEXT){if(z){s=!CKEDITOR.tools.trim(s.substring(0,z)).length&&s;w=!!s}if(s&&!(v=s.getPrevious()))j=s.getParent()}else{z&&(v=s.getChild(z-1)||s.getLast());v||(j=s)}for(j=c(j);j||v;){if(j&&!v){!x&&j.equals(g)&&(x=true);if(e?j.isBlockBoundary():!f.contains(j))break;if(!w||j.getComputedStyle("display")!="inline"){w=false;x?h=j:this.setStartBefore(j)}v=j.getPrevious()}for(;v;){s=
false;if(v.type==CKEDITOR.NODE_COMMENT)v=v.getPrevious();else{if(v.type==CKEDITOR.NODE_TEXT){y=v.getText();d.test(y)&&(v=null);s=/[\s\ufeff]$/.test(y)}else if((v.$.offsetWidth>(CKEDITOR.env.webkit?1:0)||b&&v.is("br"))&&!v.data("cke-bookmark"))if(w&&CKEDITOR.dtd.$removeEmpty[v.getName()]){y=v.getText();if(d.test(y))v=null;else for(var z=v.$.getElementsByTagName("*"),B=0,A;A=z[B++];)if(!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]){v=null;break}v&&(s=!!y.length)}else v=null;s&&(w?x?h=j:j&&this.setStartBefore(j):
w=true);if(v){s=v.getPrevious();if(!j&&!s){j=v;v=null;break}v=s}else j=null}}j&&(j=c(j.getParent()))}s=this.endContainer;z=this.endOffset;j=v=null;x=w=false;var F=function(a,b){var c=new CKEDITOR.dom.range(f);c.setStart(a,b);c.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);var c=new CKEDITOR.dom.walker(c),e;for(c.guard=function(a){return!(a.type==CKEDITOR.NODE_ELEMENT&&a.isBlockBoundary())};e=c.next();){if(e.type!=CKEDITOR.NODE_TEXT)return false;y=e!=a?e.getText():e.substring(b);if(d.test(y))return false}return true};
if(s.type==CKEDITOR.NODE_TEXT)if(CKEDITOR.tools.trim(s.substring(z)).length)w=true;else{w=!s.getLength();if(z==s.getLength()){if(!(v=s.getNext()))j=s.getParent()}else F(s,z)&&(j=s.getParent())}else(v=s.getChild(z))||(j=s);for(;j||v;){if(j&&!v){!x&&j.equals(g)&&(x=true);if(e?j.isBlockBoundary():!f.contains(j))break;if(!w||j.getComputedStyle("display")!="inline"){w=false;x?i=j:j&&this.setEndAfter(j)}v=j.getNext()}for(;v;){s=false;if(v.type==CKEDITOR.NODE_TEXT){y=v.getText();F(v,0)||(v=null);s=/^[\s\ufeff]/.test(y)}else if(v.type==
CKEDITOR.NODE_ELEMENT){if((v.$.offsetWidth>0||b&&v.is("br"))&&!v.data("cke-bookmark"))if(w&&CKEDITOR.dtd.$removeEmpty[v.getName()]){y=v.getText();if(d.test(y))v=null;else{z=v.$.getElementsByTagName("*");for(B=0;A=z[B++];)if(!CKEDITOR.dtd.$removeEmpty[A.nodeName.toLowerCase()]){v=null;break}}v&&(s=!!y.length)}else v=null}else s=1;s&&w&&(x?i=j:this.setEndAfter(j));if(v){s=v.getNext();if(!j&&!s){j=v;v=null;break}v=s}else j=null}j&&(j=c(j.getParent()))}if(h&&i){g=h.contains(i)?i:h;this.setStartBefore(g);
this.setEndAfter(g)}break;case CKEDITOR.ENLARGE_BLOCK_CONTENTS:case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:j=new CKEDITOR.dom.range(this.root);f=this.root;j.setStartAt(f,CKEDITOR.POSITION_AFTER_START);j.setEnd(this.startContainer,this.startOffset);j=new CKEDITOR.dom.walker(j);var C,J,G=CKEDITOR.dom.walker.blockBoundary(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?{br:1}:null),E=null,D=function(a){if(a.type==CKEDITOR.NODE_ELEMENT&&a.getAttribute("contenteditable")=="false")if(E){if(E.equals(a)){E=null;return}}else E=
a;else if(E)return;var b=G(a);b||(C=a);return b},e=function(a){var b=D(a);!b&&(a.is&&a.is("br"))&&(J=a);return b};j.guard=D;j=j.lastBackward();C=C||f;this.setStartAt(C,!C.is("br")&&(!j&&this.checkStartOfBlock()||j&&C.contains(j))?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_AFTER_END);if(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS){j=this.clone();j=new CKEDITOR.dom.walker(j);var I=CKEDITOR.dom.walker.whitespaces(),L=CKEDITOR.dom.walker.bookmark();j.evaluator=function(a){return!I(a)&&!L(a)};if((j=j.previous())&&
j.type==CKEDITOR.NODE_ELEMENT&&j.is("br"))break}j=this.clone();j.collapse();j.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);j=new CKEDITOR.dom.walker(j);j.guard=a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?e:D;C=E=J=null;j=j.lastForward();C=C||f;this.setEndAt(C,!j&&this.checkEndOfBlock()||j&&C.contains(j)?CKEDITOR.POSITION_BEFORE_END:CKEDITOR.POSITION_BEFORE_START);J&&this.setEndAfter(J)}},shrink:function(a,b,c){if(!this.collapsed){var a=a||CKEDITOR.SHRINK_TEXT,d=this.clone(),e=this.startContainer,g=this.endContainer,
f=this.startOffset,h=this.endOffset,j=1,i=1;if(e&&e.type==CKEDITOR.NODE_TEXT)if(f)if(f>=e.getLength())d.setStartAfter(e);else{d.setStartBefore(e);j=0}else d.setStartBefore(e);if(g&&g.type==CKEDITOR.NODE_TEXT)if(h)if(h>=g.getLength())d.setEndAfter(g);else{d.setEndAfter(g);i=0}else d.setEndBefore(g);var d=new CKEDITOR.dom.walker(d),v=CKEDITOR.dom.walker.bookmark();d.evaluator=function(b){return b.type==(a==CKEDITOR.SHRINK_ELEMENT?CKEDITOR.NODE_ELEMENT:CKEDITOR.NODE_TEXT)};var x;d.guard=function(b,d){if(v(b))return true;
if(a==CKEDITOR.SHRINK_ELEMENT&&b.type==CKEDITOR.NODE_TEXT||d&&b.equals(x)||c===false&&b.type==CKEDITOR.NODE_ELEMENT&&b.isBlockBoundary()||b.type==CKEDITOR.NODE_ELEMENT&&b.hasAttribute("contenteditable"))return false;!d&&b.type==CKEDITOR.NODE_ELEMENT&&(x=b);return true};if(j)(e=d[a==CKEDITOR.SHRINK_ELEMENT?"lastForward":"next"]())&&this.setStartAt(e,b?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_BEFORE_START);if(i){d.reset();(d=d[a==CKEDITOR.SHRINK_ELEMENT?"lastBackward":"previous"]())&&this.setEndAt(d,
...
case CKEDITOR.POSITION_AFTER_END:this.setEndAfter(a)}e(this)},fixBlock:function(a,b){var c=this.createBookmark(),d=this.document.createElement(b);this.collapse(a);this.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS);this.extractContents().appendTo(d);d.trim();d.appendBogus();this.insertNode(d);this.moveToBookmark(c);return d},splitBlock:function(a){var b=new CKEDITOR.dom.elementPath(this.startContainer,this.root),c=new CKEDITOR.dom.elementPath(this.endContainer,this.root),d=b.block,e=c.block,g=null;if(!b.blockLimit.equals(c.blockLimit))return null;
...
this.splitElement(d);d.is("ul","ol")||d.appendBogus()}return{previousBlock:d,nextBlock:e,wasStartOfBlock:a,wasEndOfBlock:b,elementPath:g}},splitElement:function(a){if(!this.collapsed)return null;this.setEndAt(a,CKEDITOR.POSITION_BEFORE_END);var b=this.extractContents(),c=a.clone(false);b.appendTo(c);c.insertAfter(a);this.moveToPosition(a,CKEDITOR.POSITION_AFTER_END);return c},removeEmptyBlocksAtEnd:function(){function a(d){return function(a){return b(a)||(c(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.isEmptyInlineRemoveable())||
...
h={dd:1,dt:1,li:1};a.prototype={getNextParagraph:function(a){var f,i,n,r,o,a=a||"p";if(this._.nestedEditable){if(f=this._.nestedEditable.iterator.getNextParagraph(a)){this.activeFilter=this._.nestedEditable.iterator.activeFilter;return f}this.activeFilter=this.filter;if(c(this,a,this._.nestedEditable.container,this._.nestedEditable.remaining)){this.activeFilter=this._.nestedEditable.iterator.activeFilter;return this._.nestedEditable.iterator.getNextParagraph(a)}this._.nestedEditable=null}if(!this.range.root.getDtd()[a])return null;
if(!this._.started){var m=this.range.clone();i=m.startPath();var p=m.endPath(),q=!m.collapsed&&e(m,i.block),t=!m.collapsed&&e(m,p.block,1);m.shrink(CKEDITOR.SHRINK_ELEMENT,true);q&&m.setStartAt(i.block,CKEDITOR.POSITION_BEFORE_END);t&&m.setEndAt(p.block,CKEDITOR.POSITION_AFTER_START);i=m.endContainer.hasAscendant("pre",true)||m.startContainer.hasAscendant("pre",true);m.enlarge(this.forceBrBreak&&!i||!this.enlargeBr?CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:CKEDITOR.ENLARGE_BLOCK_CONTENTS);if(!m.collapsed){i=
new CKEDITOR.dom.walker(m.clone());p=CKEDITOR.dom.walker.bookmark(true,true);i.evaluator=p;this._.nextNode=i.next();i=new CKEDITOR.dom.walker(m.clone());i.evaluator=p;i=i.previous();this._.lastNode=i.getNextSourceNode(true,null,m.root);if(this._.lastNode&&this._.lastNode.type==CKEDITOR.NODE_TEXT&&!CKEDITOR.tools.trim(this._.lastNode.getText())&&this._.lastNode.getParent().isBlockBoundary()){p=this.range.clone();p.moveToPosition(this._.lastNode,CKEDITOR.POSITION_AFTER_END);if(p.checkEndOfBlock()){p=
new CKEDITOR.dom.elementPath(p.endContainer,p.root);this._.lastNode=(p.block||p.blockLimit).getNextSourceNode(true)}}if(!this._.lastNode||!m.root.contains(this._.lastNode)){this._.lastNode=this._.docEndMarker=m.document.createText("");this._.lastNode.insertAfter(i)}m=null}this._.started=1;i=m}p=this._.nextNode;m=this._.lastNode;for(this._.nextNode=null;p;){var q=0,t=p.hasAscendant("pre"),u=p.type!=CKEDITOR.NODE_ELEMENT,v=0;if(u)p.type==CKEDITOR.NODE_TEXT&&b.test(p.getText())&&(u=0);else{var x=p.getName();
if(CKEDITOR.dtd.$block[x]&&p.getAttribute("contenteditable")=="false"){f=p;c(this,a,f);break}else if(p.isBlockBoundary(this.forceBrBreak&&!t&&{br:1})){if(x=="br")u=1;else if(!i&&!p.getChildCount()&&x!="hr"){f=p;n=p.equals(m);break}if(i){i.setEndAt(p,CKEDITOR.POSITION_BEFORE_START);if(x!="br")this._.nextNode=p}q=1}else{if(p.getFirst()){if(!i){i=this.range.clone();i.setStartAt(p,CKEDITOR.POSITION_BEFORE_START)}p=p.getFirst();continue}u=1}}if(u&&!i){i=this.range.clone();i.setStartAt(p,CKEDITOR.POSITION_BEFORE_START)}n=
(!q||u)&&p.equals(m);if(i&&!q)for(;!p.getNext(d)&&!n;){x=p.getParent();if(x.isBlockBoundary(this.forceBrBreak&&!t&&{br:1})){q=1;u=0;n||x.equals(m);i.setEndAt(x,CKEDITOR.POSITION_BEFORE_END);break}p=x;u=1;n=p.equals(m);v=1}u&&i.setEndAt(p,CKEDITOR.POSITION_AFTER_END);p=this._getNextSourceNode(p,v,m);if((n=!p)||q&&i)break}if(!f){if(!i){this._.docEndMarker&&this._.docEndMarker.remove();return this._.nextNode=null}f=new CKEDITOR.dom.elementPath(i.startContainer,i.root);p=f.blockLimit;q={div:1,th:1,td:1};
f=f.block;if(!f&&p&&!this.enforceRealBlocks&&q[p.getName()]&&i.checkStartOfBlock()&&i.checkEndOfBlock()&&!p.equals(i.root))f=p;else if(!f||this.enforceRealBlocks&&f.is(h)){f=this.range.document.createElement(a);i.extractContents().appendTo(f);f.trim();i.insertNode(f);r=o=true}else if(f.getName()!="li"){if(!i.checkStartOfBlock()||!i.checkEndOfBlock()){f=f.clone(false);i.extractContents().appendTo(f);f.trim();o=i.splitBlock();r=!o.wasStartOfBlock;o=!o.wasEndOfBlock;i.insertNode(f)}}else if(!n)this._.nextNode=
f.equals(m)?null:this._getNextSourceNode(i.getBoundaryNodes().endNode,1,m)}if(r)(r=f.getPrevious())&&r.type==CKEDITOR.NODE_ELEMENT&&(r.getName()=="br"?r.remove():r.getLast()&&r.getLast().$.nodeName.toLowerCase()=="br"&&r.getLast().remove());if(o)(r=f.getLast())&&r.type==CKEDITOR.NODE_ELEMENT&&r.getName()=="br"&&(!CKEDITOR.env.needsBrFiller||r.getPrevious(g)||r.getNext(g))&&r.remove();if(!this._.nextNode)this._.nextNode=n||f.equals(m)||!m?null:this._getNextSourceNode(f,1,m);return f},_getNextSourceNode:function(a,
...
/\s+/)||null;h.propertiesOnly=h.propertiesOnly||h.elements===true;var j=/\s*,\s*/,p=void 0;for(p in E){h[p]=i(h[p],j)||null;var k=h,o=D[p],x=i(h[D[p]],j),t=h[p],l=[],m=true,v=void 0;x?m=false:x={};for(v in t)if(v.charAt(0)=="!"){v=v.slice(1);l.push(v);x[v]=true;m=false}for(;v=l.pop();){t[v]=t["!"+v];delete t["!"+v]}k[o]=(m?false:x)||null}h.match=h.match||null;d.push(f);a.push(f)}for(var b=e.elements,e=e.generic,G,c=0,d=a.length;c<d;++c){g=F(a[c]);f=g.classes===true||g.styles===true||g.attributes===
true;h=g;p=o=j=void 0;for(j in E)h[j]=q(h[j]);k=true;for(p in D){j=D[p];o=h[j];x=[];t=void 0;for(t in o)t.indexOf("*")>-1?x.push(RegExp("^"+t.replace(/\*/g,".*")+"$")):x.push(t);o=x;if(o.length){h[j]=o;k=false}}h.nothingRequired=k;h.noProperties=!(h.attributes||h.classes||h.styles);if(g.elements===true||g.elements===null)e[f?"unshift":"push"](g);else{h=g.elements;delete g.elements;for(G in h)if(b[G])b[G][f?"unshift":"push"](g);else b[G]=[g]}}}function f(a,b,e,g){if(!a.match||a.match(b))if(g||d(a,
...
e,g={},f=1,a=C(a);b=a.match(I);){if(c=b[2]){d=l(c,"styles");e=l(c,"attrs");c=l(c,"classes")}else d=e=c=null;g["$"+f++]={elements:b[1],classes:c,styles:d,attributes:e};a=a.slice(b[0].length)}return g}function l(a,b){var c=a.match(L[b]);return c?C(c[1]):null}function n(a){var b=a.styleBackup=a.attributes.style,c=a.classBackup=a.attributes["class"];if(!a.styles)a.styles=CKEDITOR.tools.parseCssText(b||"",1);if(!a.classes)a.classes=c?c.split(/\s+/):[]}function r(a,b,c,d){var g=0,h;if(d.toHtml)b.name=b.name.replace(H,
"$1");if(d.doCallbacks&&a.elementCallbacks){a:for(var i=a.elementCallbacks,j=0,k=i.length,o;j<k;++j)if(o=i[j](b)){h=o;break a}if(h)return h}if(d.doTransform)if(h=a._.transformations[b.name]){n(b);for(i=0;i<h.length;++i)x(a,b,h[i]);m(b)}if(d.doFilter){a:{i=b.name;j=a._;a=j.allowedRules.elements[i];h=j.allowedRules.generic;i=j.disallowedRules.elements[i];j=j.disallowedRules.generic;k=d.skipRequired;o={valid:false,validAttributes:{},validClasses:{},validStyles:{},allAttributes:false,allClasses:false,
allStyles:false,hadInvalidAttribute:false,hadInvalidClass:false,hadInvalidStyle:false};var q,t;if(!a&&!h)a=null;else{n(b);if(i){q=0;for(t=i.length;q<t;++q)if(e(i[q],b,o)===false){a=null;break a}}if(j){q=0;for(t=j.length;q<t;++q)e(j[q],b,o)}if(a){q=0;for(t=a.length;q<t;++q)f(a[q],b,o,k)}if(h){q=0;for(t=h.length;q<t;++q)f(h[q],b,o,k)}a=o}}if(!a){c.push(b);return A}if(!a.valid){c.push(b);return A}t=a.validAttributes;var l=a.validStyles;h=a.validClasses;var i=b.attributes,v=b.styles,j=b.classes,k=b.classBackup,
G=b.styleBackup,w,E,u=[];o=[];var s=/^data-cke-/;q=false;delete i.style;delete i["class"];delete b.classBackup;delete b.styleBackup;if(!a.allAttributes)for(w in i)if(!t[w])if(s.test(w)){if(w!=(E=w.replace(/^data-cke-saved-/,""))&&!t[E]){delete i[w];q=true}}else{delete i[w];q=true}if(!a.allStyles||a.hadInvalidStyle){for(w in v)a.allStyles||l[w]?u.push(w+":"+v[w]):q=true;if(u.length)i.style=u.sort().join("; ")}else if(G)i.style=G;if(!a.allClasses||a.hadInvalidClass){for(w=0;w<j.length;++w)(a.allClasses||
h[j[w]])&&o.push(j[w]);o.length&&(i["class"]=o.sort().join(" "));k&&o.length<k.split(/\s+/).length&&(q=true)}else k&&(i["class"]=k);q&&(g=A);if(!d.skipFinalValidation&&!p(b)){c.push(b);return A}}if(d.toHtml)b.name=b.name.replace(Q,"cke:$1");return g}function o(a){var b=[],c;for(c in a)c.indexOf("*")>-1&&b.push(c.replace(/\*/g,".*"));return b.length?RegExp("^(?:"+b.join("|")+")$"):null}function m(a){var b=a.attributes,c;delete b.style;delete b["class"];if(c=CKEDITOR.tools.writeCssText(a.styles,true))b.style=
c;a.classes.length&&(b["class"]=a.classes.sort().join(" "))}function p(a){switch(a.name){case "a":if(!a.children.length&&!a.attributes.name)return false;break;case "img":if(!a.attributes.src)return false}return true}function q(a){if(!a)return false;if(a===true)return true;var b=o(a);return function(c){return c in a||b&&c.match(b)}}function t(){return new CKEDITOR.htmlParser.element("br")}function u(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.name=="br"||B.$block[a.name])}function v(a,b,c){var d=a.name;
if(B.$empty[d]||!a.children.length)if(d=="hr"&&b=="br")a.replaceWith(t());else{a.parent&&c.push({check:"it",el:a.parent});a.remove()}else if(B.$block[d]||d=="tr")if(b=="br"){if(a.previous&&!u(a.previous)){b=t();b.insertBefore(a)}if(a.next&&!u(a.next)){b=t();b.insertAfter(a)}a.replaceWithChildren()}else{var d=a.children,e;b:{e=B[b];for(var g=0,f=d.length,h;g<f;++g){h=d[g];if(h.type==CKEDITOR.NODE_ELEMENT&&!e[h.name]){e=false;break b}}e=true}if(e){a.name=b;a.attributes={};c.push({check:"parent-down",
...
a.toFeature&&(a=a.toFeature(this.editor));this.allow(a.allowedContent,a.name);this.addTransformations(a.contentTransformations);this.addContentForms(a.contentForms);return a.requiredContent&&(this.customConfig||this.disallowedContent.length)?this.check(a.requiredContent):true},addTransformations:function(a){var b,c;if(!this.disabled&&a){var d=this._.transformations,e;for(e=0;e<a.length;++e){b=a[e];var g=void 0,f=void 0,h=void 0,i=void 0,j=void 0,p=void 0;c=[];for(f=0;f<b.length;++f){h=b[f];if(typeof h==
"string"){h=h.split(/\s*:\s*/);i=h[0];j=null;p=h[1]}else{i=h.check;j=h.left;p=h.right}if(!g){g=h;g=g.element?g.element:i?i.match(/^([a-z0-9]+)/i)[0]:g.left.getDefinition().element}j instanceof CKEDITOR.style&&(j=y(j));c.push({check:i==g?null:i,left:j,right:typeof p=="string"?z(p):p})}b=g;d[b]||(d[b]=[]);d[b].push(c)}}},check:function(a,b,c){if(this.disabled)return true;if(CKEDITOR.tools.isArray(a)){for(var d=a.length;d--;)if(this.check(a[d],b,c))return true;return false}var e,g;if(typeof a=="string"){g=
...
lengthToAttribute:function(a,b,c){c=c||b;if(!(c in a.attributes)){var d=a.styles[b],e=d&&d.match(/^(\d+)(?:\.\d*)?px$/);e?a.attributes[c]=e[1]:d==J&&(a.attributes[c]=J)}delete a.styles[b]},alignmentToStyle:function(a){if(!("float"in a.styles)){var b=a.attributes.align;if(b=="left"||b=="right")a.styles["float"]=b}delete a.attributes.align},alignmentToAttribute:function(a){if(!("align"in a.attributes)){var b=a.styles["float"];if(b=="left"||b=="right")a.attributes.align=b}delete a.styles["float"]},matchesStyle:w,
...
b||(b=CKEDITOR);var d=c.length,h=[],j=[],k=function(a){e&&(i?e.call(b,a):e.call(b,h,j))};if(d===0)k(true);else{var l=function(a,b){(b?h:j).push(a);if(--d<=0){g&&CKEDITOR.document.getDocumentElement().removeStyle("cursor");k(b)}},n=function(b,c){a[b]=1;var d=f[b];delete f[b];for(var e=0;e<d.length;e++)d[e](b,c)},r=function(b){if(a[b])l(b,true);else{var c=f[b]||(f[b]=[]);c.push(l);if(!(c.length>1)){var d=new CKEDITOR.dom.element("script");d.setAttributes({type:"text/javascript",src:b});if(e)if(CKEDITOR.env.ie&&
CKEDITOR.env.version<11)d.$.onreadystatechange=function(){if(d.$.readyState=="loaded"||d.$.readyState=="complete"){d.$.onreadystatechange=null;n(b,true)}};else{d.$.onload=function(){setTimeout(function(){n(b,true)},0)};d.$.onerror=function(){n(b,false)}}d.appendTo(CKEDITOR.document.getHead())}}};g&&CKEDITOR.document.getDocumentElement().setStyle("cursor","wait");for(var o=0;o<d;o++)r(c[o])}},queue:function(){function a(){var b;(b=e[0])&&this.load(b.scriptUrl,b.callback,CKEDITOR,0)}var e=[];return function(b,
...
j=0;j<h.length;j++){var p=h[j];d[p]=this.get(p);e[p]=1}f.call(c,d)},this)}},CKEDITOR.plugins=new CKEDITOR.resourceManager("plugins/","plugin"),CKEDITOR.plugins.load=CKEDITOR.tools.override(CKEDITOR.plugins.load,function(a){var f={};return function(c,e,b){var g={},i=function(c){a.call(this,c,function(a){CKEDITOR.tools.extend(g,a);var c=[],d;for(d in a){var l=a[d],n=l&&l.requires;if(!f[d]){if(l.icons)for(var r=l.icons.split(","),o=r.length;o--;)CKEDITOR.skin.addIcon(r[o],l.path+"icons/"+(CKEDITOR.env.hidpi&&
l.hidpi?"hidpi/":"")+r[o]+".png");f[d]=1}if(n){n.split&&(n=n.split(","));for(l=0;l<n.length;l++)g[n[l]]||c.push(n[l])}}if(c.length)i.call(this,c);else{for(d in g){l=g[d];if(l.onLoad&&!l.onLoad._called){l.onLoad()===false&&delete g[d];l.onLoad._called=1}}e&&e.call(b||window,g)}},this)};i.call(this,c)}}),CKEDITOR.plugins.setLang=function(a,f,c){var e=this.get(a),a=e.langEntries||(e.langEntries={}),e=e.lang||(e.lang=[]);e.split&&(e=e.split(","));CKEDITOR.tools.indexOf(e,f)==-1&&e.push(f);a[f]=c},CKEDITOR.ui=
...
this.on("mode",c);this.on("instanceReady",function(){this.config.startupFocus&&this.focus()});CKEDITOR.fire("instanceCreated",null,this);CKEDITOR.add(this);CKEDITOR.tools.setTimeout(function(){i(this,a)},0,this)}function f(){do var a="editor"+ ++n;while(CKEDITOR.instances[a]);return a}function c(){var a=this.commands,b;for(b in a)e(this,a[b])}function e(a,b){b[b.startDisabled?"disable":a.readOnly&&!b.readOnly?"disable":b.modes[a.mode]?"enable":"disable"]()}function b(a,b,c){if(b){var d,e,g=a.commands;
for(e in g){d=g[e];(c||d.contextSensitive)&&d.refresh(a,b)}}}function g(a){var b=a.config.customConfig;if(!b)return false;var b=CKEDITOR.getUrl(b),c=r[b]||(r[b]={});if(c.fn){c.fn.call(a,a.config);(CKEDITOR.getUrl(a.config.customConfig)==b||!g(a))&&a.fireOnce("customConfigLoaded")}else CKEDITOR.scriptLoader.queue(b,function(){c.fn=CKEDITOR.editorConfig?CKEDITOR.editorConfig:function(){};g(a)});return true}function i(a,b){a.on("customConfigLoaded",function(){if(b){if(b.on)for(var c in b.on)a.on(c,b.on[c]);
...
null,a)})})}function l(){var a=this.element;if(a&&this.elementMode!=CKEDITOR.ELEMENT_MODE_APPENDTO){var b=this.getData();this.config.htmlEncodeOutput&&(b=CKEDITOR.tools.htmlEncode(b));a.is("textarea")?a.setValue(b):a.setHtml(b);return true}return false}a.prototype=CKEDITOR.editor.prototype;CKEDITOR.editor=a;var n=0,r={};CKEDITOR.tools.extend(CKEDITOR.editor.prototype,{addCommand:function(a,b){b.name=a.toLowerCase();var c=new CKEDITOR.command(this,b);this.mode&&e(this,c);return this.commands[a]=c},
...
!a&&l.call(this);this.editable(null);this.filter.destroy();delete this.filter;delete this.activeFilter;this.status="destroyed";this.fire("destroy");this.removeAllListeners();CKEDITOR.remove(this);CKEDITOR.fire("instanceDestroyed",null,this)},elementPath:function(a){if(!a){a=this.getSelection();if(!a)return null;a=a.getStartElement()}return a?new CKEDITOR.dom.elementPath(a,this.editable()):null},createRange:function(){var a=this.editable();return a?new CKEDITOR.dom.range(a):null},execCommand:function(a,
...
function(g,i,d){function h(a){var b;if(p.length>0)for(var c=0;c<p.length;c++){var d=p[c],e=d.name,g=CKEDITOR.dtd[e],f=t.name&&CKEDITOR.dtd[t.name];if((!f||f[e])&&(!a||!g||g[a]||!CKEDITOR.dtd[a])){if(!b){j();b=1}d=d.clone();d.parent=t;t=d;p.splice(c,1);c--}else if(e==t.name){l(t,t.parent,1);c--}}}function j(){for(;q.length;)l(q.shift(),t)}function k(a){if(a._.isBlockLike&&a.name!="pre"&&a.name!="textarea"){var b=a.children.length,c=a.children[b-1],d;if(c&&c.type==CKEDITOR.NODE_TEXT)(d=CKEDITOR.tools.rtrim(c.value))?
c.value=d:a.children.length=b-1}}function l(b,c,e){var c=c||t||m,g=t;if(b.previous===void 0){if(n(c,b)){t=c;o.onTagOpen(d,{});b.returnPoint=c=t}k(b);(!a(b)||b.children.length)&&c.add(b);b.name=="pre"&&(v=false);b.name=="textarea"&&(u=false)}if(b.returnPoint){t=b.returnPoint;delete b.returnPoint}else t=e?c:g}function n(a,b){if((a==m||a.name=="body")&&d&&(!a.name||CKEDITOR.dtd[a.name][d])){var c,e;return(c=b.attributes&&(e=b.attributes["data-cke-real-element-type"])?e:b.name)&&c in CKEDITOR.dtd.$inline&&
!(c in CKEDITOR.dtd.head)&&!b.isOrphan||b.type==CKEDITOR.NODE_TEXT}}function r(a,b){return a in CKEDITOR.dtd.$listItem||a in CKEDITOR.dtd.$tableContent?a==b||a=="dt"&&b=="dd"||a=="dd"&&b=="dt":false}var o=new CKEDITOR.htmlParser,m=i instanceof CKEDITOR.htmlParser.element?i:typeof i=="string"?new CKEDITOR.htmlParser.element(i):new CKEDITOR.htmlParser.fragment,p=[],q=[],t=m,u=m.name=="textarea",v=m.name=="pre";o.onTagOpen=function(b,d,g,i){d=new CKEDITOR.htmlParser.element(b,d);if(d.isUnknown&&g)d.isEmpty=
true;d.isOptionalClose=i;if(a(d))p.push(d);else{if(b=="pre")v=true;else{if(b=="br"&&v){t.add(new CKEDITOR.htmlParser.text("\n"));return}b=="textarea"&&(u=true)}if(b=="br")q.push(d);else{for(;;){i=(g=t.name)?CKEDITOR.dtd[g]||(t._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):e;if(!d.isUnknown&&!t.isUnknown&&!i[b])if(t.isOptionalClose)o.onTagClose(g);else if(b in c&&g in c){g=t.children;(g=g[g.length-1])&&g.name=="li"||l(g=new CKEDITOR.htmlParser.element("li"),t);!d.returnPoint&&(d.returnPoint=t);
t=g}else if(b in CKEDITOR.dtd.$listItem&&!r(b,g))o.onTagOpen(b=="li"?"ul":"dl",{},0,1);else if(g in f&&!r(b,g)){!d.returnPoint&&(d.returnPoint=t);t=t.parent}else{g in CKEDITOR.dtd.$inline&&p.unshift(t);if(t.parent)l(t,t.parent,1);else{d.isOrphan=1;break}}else break}h(b);j();d.parent=t;d.isEmpty?l(d):t=d}}};o.onTagClose=function(a){for(var b=p.length-1;b>=0;b--)if(a==p[b].name){p.splice(b,1);return}for(var c=[],e=[],g=t;g!=m&&g.name!=a;){g._.isBlockLike||e.unshift(g);c.push(g);g=g.returnPoint||g.parent}if(g!=
m){for(b=0;b<c.length;b++){var f=c[b];l(f,f.parent)}t=g;g._.isBlockLike&&j();l(g,g.parent);if(g==t)t=t.parent;p=p.concat(e)}a=="body"&&(d=false)};o.onText=function(a){if((!t._.hasInlineStarted||q.length)&&!v&&!u){a=CKEDITOR.tools.ltrim(a);if(a.length===0)return}var c=t.name,g=c?CKEDITOR.dtd[c]||(t._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):e;if(!u&&!g["#"]&&c in f){o.onTagOpen(b[c]||"");o.onText(a)}else{j();h();!v&&!u&&(a=a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g," "));a=new CKEDITOR.htmlParser.text(a);
if(n(t,a))this.onTagOpen(d,{},0,1);t.add(a)}};o.onCDATA=function(a){t.add(new CKEDITOR.htmlParser.cdata(a))};o.onComment=function(a){j();h();t.add(new CKEDITOR.htmlParser.comment(a))};o.parse(g);for(j();t!=m;)l(t,t.parent,1);k(m);return m};CKEDITOR.htmlParser.fragment.prototype={type:CKEDITOR.NODE_DOCUMENT_FRAGMENT,add:function(a,b){isNaN(b)&&(b=this.children.length);var c=b>0?this.children[b-1]:null;if(c){if(a._.isBlockLike&&c.type==CKEDITOR.NODE_TEXT){c.value=CKEDITOR.tools.rtrim(c.value);if(c.value.length===
...
options:b})},addMany:function(a,e,b){for(var g=[this.findIndex(e),0],f=0,d=a.length;f<d;f++)g.push({value:a[f],priority:e,options:b});this.rules.splice.apply(this.rules,g)},findIndex:function(a){for(var e=this.rules,b=e.length-1;b>=0&&a<e[b].priority;)b--;return b+1},exec:function(a,e){var b=e instanceof CKEDITOR.htmlParser.node||e instanceof CKEDITOR.htmlParser.fragment,g=Array.prototype.slice.call(arguments,1),f=this.rules,d=f.length,h,j,k,l;for(l=0;l<d;l++){if(b){h=e.type;j=e.name}k=f[l];if(!(a.nonEditable&&
...
new CKEDITOR.htmlParser.element("br",{"data-cke-bogus":1})}function h(a,b){return function(d){if(d.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var h=[],i=c(d),k,p;if(i)for(j(i,1)&&h.push(i);i;){if(g(i)&&(k=e(i))&&j(k))if((p=e(k))&&!g(p))h.push(k);else{f(q).insertAfter(k);k.remove()}i=i.previous}for(i=0;i<h.length;i++)h[i].remove();if(h=!a||(typeof b=="function"?b(d):b)!==false)if(!q&&!CKEDITOR.env.needsBrFiller&&d.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT)h=false;else if(!q&&!CKEDITOR.env.needsBrFiller&&(document.documentMode>
7||d.name in CKEDITOR.dtd.tr||d.name in CKEDITOR.dtd.$listItem))h=false;else{h=c(d);h=!h||d.name=="form"&&h.name=="input"}h&&d.add(f(a))}}}function j(a,b){if((!q||CKEDITOR.env.needsBrFiller)&&a.type==CKEDITOR.NODE_ELEMENT&&a.name=="br"&&!a.attributes["data-cke-eol"])return true;var c;if(a.type==CKEDITOR.NODE_TEXT&&(c=a.value.match(p))){if(c.index){(new CKEDITOR.htmlParser.text(a.value.substring(0,c.index))).insertBefore(a);a.value=c[0]}if(!CKEDITOR.env.needsBrFiller&&q&&(!b||a.parent.name in o))return true;
if(!q)if((c=a.previous)&&c.name=="br"||!c||g(c))return true}return false}var k={elements:{}},q=d=="html",o=CKEDITOR.tools.extend({},v),l;for(l in o)"#"in t[l]||delete o[l];for(l in o)k.elements[l]=h(q,a.config.fillEmptyBlocks);k.root=h(q,false);k.elements.br=function(a){return function(c){if(c.parent.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var d=c.attributes;if("data-cke-bogus"in d||"data-cke-eol"in d)delete d["data-cke-bogus"];else{for(d=c.next;d&&b(d);)d=d.next;var h=e(c);!d&&g(c.parent)?i(c.parent,
f(a)):g(d)&&(h&&!g(h))&&f(a).insertBefore(d)}}}}(q);return k}function f(a,b){return a!=CKEDITOR.ENTER_BR&&b!==false?a==CKEDITOR.ENTER_DIV?"div":"p":false}function c(a){for(a=a.children[a.children.length-1];a&&b(a);)a=a.previous;return a}function e(a){for(a=a.previous;a&&b(a);)a=a.previous;return a}function b(a){return a.type==CKEDITOR.NODE_TEXT&&!CKEDITOR.tools.trim(a.value)||a.type==CKEDITOR.NODE_ELEMENT&&a.attributes["data-cke-bookmark"]}function g(a){return a&&(a.type==CKEDITOR.NODE_ELEMENT&&a.name in
...
function(a,b){return A.test(b)&&c.indexOf("data-cke-saved-"+b)==-1?" data-cke-saved-"+a+" data-cke-"+CKEDITOR.rnd+"-"+a:a})+">"})}function k(a,b){return a.replace(b,function(a,b,c){a.indexOf("<textarea")===0&&(a=b+r(c).replace(/</g,"&lt;").replace(/>/g,"&gt;")+"</textarea>");return"<cke:encoded>"+encodeURIComponent(a)+"</cke:encoded>"})}function l(a){return a.replace(J,function(a,b){return decodeURIComponent(b)})}function n(a){return a.replace(/<\!--(?!{cke_protected})[\s\S]+?--\>/g,function(a){return"<\!--"+
q+"{C}"+encodeURIComponent(a).replace(/--/g,"%2D%2D")+"--\>"})}function r(a){return a.replace(/<\!--\{cke_protected\}\{C\}([\s\S]+?)--\>/g,function(a,b){return decodeURIComponent(b)})}function o(a,b){var c=b._.dataStore;return a.replace(/<\!--\{cke_protected\}([\s\S]+?)--\>/g,function(a,b){return decodeURIComponent(b)}).replace(/\{cke_protected_(\d+)\}/g,function(a,b){return c&&c[b]||""})}function m(a,b){for(var c=[],d=b.config.protectedSource,e=b._.dataStore||(b._.dataStore={id:1}),g=/<\!--\{cke_temp(comment)?\}(\d*?)--\>/g,
...
function(a){return a.toLowerCase()})};var z=/<(a|area|img|input|source)\b([^>]*)>/gi,B=/([\w-]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,A=/^(href|src|name)$/i,F=/(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi,C=/(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,J=/<cke:encoded>([^<]*)<\/cke:encoded>/gi,G=/(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi,E=/(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi,D=/<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi}(),
...
j=1;a.cancel()}}j&&h.select()}function f(a,b){if(a.isFake)return 0;var c=b.block||b.blockLimit,d=c&&c.getLast(e);if(c&&c.isBlockBoundary()&&(!d||!(d.type==CKEDITOR.NODE_ELEMENT&&d.isBlockBoundary()))&&!c.is("pre")&&!c.getBogus())return c}function c(a){var b=a.data.getTarget();if(b.is("input")){b=b.getAttribute("type");(b=="submit"||b=="reset")&&a.data.preventDefault()}}function e(a){return n(a)&&r(a)}function b(a,b){return function(c){var d=CKEDITOR.dom.element.get(c.data.$.toElement||c.data.$.fromElement||
...
if(b.checkReadOnly())return false;b.deleteContents(1);b.startContainer.type==CKEDITOR.NODE_ELEMENT&&b.startContainer.is({tr:1,table:1,tbody:1,thead:1,tfoot:1})&&m(b);var g,h;if(f)for(;(g=b.getCommonAncestor(0,1))&&(h=CKEDITOR.dtd[g.getName()])&&(!h||!h[e]);)if(g.getName()in CKEDITOR.dtd.span)b.splitElement(g);else if(b.checkStartOfBlock()&&b.checkEndOfBlock()){b.setStartBefore(g);b.collapse(true);g.remove()}else b.splitBlock(d==CKEDITOR.ENTER_DIV?"div":"p",c.editable());b.insertNode(a);return true},
...
d;if(c in h){var b=a.getSelection(),e,f=b.getRanges()[0],j=f.startPath(),i,k,o,c=c==8;if(CKEDITOR.env.ie&&CKEDITOR.env.version<11&&(e=b.getSelectedElement())||(e=g(b))){a.fire("saveSnapshot");f.moveToPosition(e,CKEDITOR.POSITION_BEFORE_START);e.remove();f.select();a.fire("saveSnapshot");d=1}else if(f.collapsed)if((i=j.block)&&(o=i[c?"getPrevious":"getNext"](n))&&o.type==CKEDITOR.NODE_ELEMENT&&o.is("table")&&f[c?"checkStartOfBlock":"checkEndOfBlock"]()){a.fire("saveSnapshot");f[c?"checkEndOfBlock":
"checkStartOfBlock"]()&&i.remove();f["moveToElementEdit"+(c?"End":"Start")](o);f.select();a.fire("saveSnapshot");d=1}else if(j.blockLimit&&j.blockLimit.is("td")&&(k=j.blockLimit.getAscendant("table"))&&f.checkBoundaryOfElement(k,c?CKEDITOR.START:CKEDITOR.END)&&(o=k[c?"getPrevious":"getNext"](n))){a.fire("saveSnapshot");f["moveToElementEdit"+(c?"End":"Start")](o);f.checkStartOfBlock()&&f.checkEndOfBlock()?o.remove():f.select();a.fire("saveSnapshot");d=1}else if((k=j.contains(["td","th","caption"]))&&
...
this._.editable=a?a instanceof CKEDITOR.editable?a:new CKEDITOR.editable(this,a):(b&&b.detach(),null);return b};var k=CKEDITOR.dom.walker.bogus(),l=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,n=CKEDITOR.dom.walker.whitespaces(true),r=CKEDITOR.dom.walker.bookmark(false,true);CKEDITOR.on("instanceLoaded",function(b){var c=b.editor;c.on("insertElement",function(a){a=a.data;if(a.type==CKEDITOR.NODE_ELEMENT&&(a.is("input")||
...
var o=function(){function a(b){return b.type==CKEDITOR.NODE_ELEMENT}function b(c,d){var e,f,g,h,i=[],k=d.range.startContainer;e=d.range.startPath();for(var k=j[k.getName()],o=0,l=c.getChildren(),v=l.count(),t=-1,x=-1,m=0,r=e.contains(j.$list);o<v;++o){e=l.getItem(o);if(a(e)){g=e.getName();if(r&&g in CKEDITOR.dtd.$list)i=i.concat(b(e,d));else{h=!!k[g];if(g=="br"&&e.data("cke-eol")&&(!o||o==v-1)){m=(f=o?i[o-1].node:l.getItem(o+1))&&(!a(f)||!f.is("br"));f=f&&a(f)&&j.$block[f.getName()]}t==-1&&!h&&(t=
o);h||(x=o);i.push({isElement:1,isLineBreak:m,isBlock:e.isBlockBoundary(),hasBlockSibling:f,node:e,name:g,allowed:h});f=m=0}}else i.push({isElement:0,node:e,allowed:1})}if(t>-1)i[t].firstNotAllowed=1;if(x>-1)i[x].lastNotAllowed=1;return i}function c(b,d){var e=[],f=b.getChildren(),g=f.count(),h,i=0,k=j[d],o=!b.is(j.$inline)||b.is("br");for(o&&e.push(" ");i<g;i++){h=f.getItem(i);a(h)&&!h.is(k)?e=e.concat(c(h,d)):e.push(h)}o&&e.push(" ");return e}function d(b){return b&&a(b)&&(b.is(j.$removeEmpty)||
...
1);e&&d(e,b[b.length-1]);if(f&&d(f,b[0])){c.setEnd(c.endContainer,c.endOffset-1);c.collapse()}}var j=CKEDITOR.dtd,k={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,ul:1,ol:1,li:1,pre:1,dl:1,blockquote:1},o={p:1,div:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1},l=CKEDITOR.tools.extend({},j.$inline);delete l.br;return function(k,m,r){var n=k.editor,s=n.getSelection().getRanges()[0],G=false;if(m=="unfiltered_html"){m="html";G=true}if(!s.checkReadOnly()){var E=(new CKEDITOR.dom.elementPath(s.startContainer,s.root)).blockLimit||
s.root,m={type:m,dontFilter:G,editable:k,editor:n,range:s,blockLimit:E,mergeCandidates:[],zombies:[]},n=m.range,G=m.mergeCandidates,D,I,L,H;if(m.type=="text"&&n.shrink(CKEDITOR.SHRINK_ELEMENT,true,false)){D=CKEDITOR.dom.element.createFromHtml("<span>&nbsp;</span>",n.document);n.insertNode(D);n.setStartAfter(D)}I=new CKEDITOR.dom.elementPath(n.startContainer);m.endPath=L=new CKEDITOR.dom.elementPath(n.endContainer);if(!n.collapsed){var E=L.block||L.blockLimit,Q=n.getCommonAncestor();E&&(!E.equals(Q)&&
!E.contains(Q)&&n.checkEndOfBlock())&&m.zombies.push(E);n.deleteContents()}for(;(H=a(n.startContainer)&&n.startContainer.getChild(n.startOffset-1))&&a(H)&&H.isBlockBoundary()&&I.contains(H);)n.moveToPosition(H,CKEDITOR.POSITION_BEFORE_END);f(n,m.blockLimit,I,L);if(D){n.setEndBefore(D);n.collapse();D.remove()}D=n.startPath();if(E=D.contains(d,false,1)){n.splitElement(E);m.inlineStylesRoot=E;m.inlineStylesPeak=D.lastElement}D=n.createBookmark();(E=D.startNode.getPrevious(e))&&a(E)&&d(E)&&G.push(E);
(E=D.startNode.getNext(e))&&a(E)&&d(E)&&G.push(E);for(E=D.startNode;(E=E.getParent())&&d(E);)G.push(E);n.moveToBookmark(D);if(D=r){D=m.range;if(m.type=="text"&&m.inlineStylesRoot){H=m.inlineStylesPeak;n=H.getDocument().createText("{cke-peak}");for(G=m.inlineStylesRoot.getParent();!H.equals(G);){n=n.appendTo(H.clone());H=H.getParent()}r=n.getOuterHtml().split("{cke-peak}").join(r)}H=m.blockLimit.getName();if(/^\s+|\s+$/.test(r)&&"span"in CKEDITOR.dtd[H])var O='<span data-cke-marker="1">&nbsp;</span>',
r=O+r+O;r=m.editor.dataProcessor.toHtml(r,{context:null,fixForBody:false,dontFilter:m.dontFilter,filter:m.editor.activeFilter,enterMode:m.editor.activeEnterMode});H=D.document.createElement("body");H.setHtml(r);if(O){H.getFirst().remove();H.getLast().remove()}if((O=D.startPath().block)&&!(O.getChildCount()==1&&O.getBogus()))a:{var M;if(H.getChildCount()==1&&a(M=H.getFirst())&&M.is(o)){O=M.getElementsByTag("*");D=0;for(G=O.count();D<G;D++){n=O.getItem(D);if(!n.is(l))break a}M.moveChildren(M.getParent(1));
M.remove()}}m.dataWrapper=H;D=r}if(D){M=m.range;var O=M.document,K,r=m.blockLimit;D=0;var R;H=[];var N,T,G=n=0,P,V;I=M.startContainer;var E=m.endPath.elements[0],W;L=E.getPosition(I);Q=!!E.getCommonAncestor(I)&&L!=CKEDITOR.POSITION_IDENTICAL&&!(L&CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED);I=b(m.dataWrapper,m);for(g(I,M);D<I.length;D++){L=I[D];if(K=L.isLineBreak){K=M;P=r;var S=void 0,Y=void 0;if(L.hasBlockSibling)K=1;else{S=K.startContainer.getAscendant(j.$block,1);if(!S||!S.is({div:1,
p:1}))K=0;else{Y=S.getPosition(P);if(Y==CKEDITOR.POSITION_IDENTICAL||Y==CKEDITOR.POSITION_CONTAINS)K=0;else{P=K.splitElement(S);K.moveToPosition(P,CKEDITOR.POSITION_AFTER_START);K=1}}}}if(K)G=D>0;else{K=M.startPath();if(!L.isBlock&&i(m.editor,K.block,K.blockLimit)&&(T=m.editor.activeEnterMode!=CKEDITOR.ENTER_BR&&m.editor.config.autoParagraph!==false?m.editor.activeEnterMode==CKEDITOR.ENTER_DIV?"div":"p":false)){T=O.createElement(T);T.appendBogus();M.insertNode(T);CKEDITOR.env.needsBrFiller&&(R=T.getBogus())&&
R.remove();M.moveToPosition(T,CKEDITOR.POSITION_BEFORE_END)}if((K=M.startPath().block)&&!K.equals(N)){if(R=K.getBogus()){R.remove();H.push(K)}N=K}L.firstNotAllowed&&(n=1);if(n&&L.isElement){K=M.startContainer;for(P=null;K&&!j[K.getName()][L.name];){if(K.equals(r)){K=null;break}P=K;K=K.getParent()}if(K){if(P){V=M.splitElement(P);m.zombies.push(V);m.zombies.push(P)}}else{P=r.getName();W=!D;K=D==I.length-1;P=c(L.node,P);for(var S=[],Y=P.length,Z=0,ba=void 0,X=0,aa=-1;Z<Y;Z++){ba=P[Z];if(ba==" "){if(!X&&
(!W||Z)){S.push(new CKEDITOR.dom.text(" "));aa=S.length}X=1}else{S.push(ba);X=0}}K&&aa==S.length&&S.pop();W=S}}if(W){for(;K=W.pop();)M.insertNode(K);W=0}else M.insertNode(L.node);if(L.lastNotAllowed&&D<I.length-1){(V=Q?E:V)&&M.setEndAt(V,CKEDITOR.POSITION_AFTER_START);n=0}M.collapse()}}m.dontMoveCaret=G;m.bogusNeededBlocks=H}R=m.range;var U;V=m.bogusNeededBlocks;for(W=R.createBookmark();N=m.zombies.pop();)if(N.getParent()){T=R.clone();T.moveToElementEditStart(N);T.removeEmptyBlocksAtEnd()}if(V)for(;N=
V.pop();)CKEDITOR.env.needsBrFiller?N.appendBogus():N.append(R.document.createText(" "));for(;N=m.mergeCandidates.pop();)N.mergeSiblings();R.moveToBookmark(W);if(!m.dontMoveCaret){for(N=a(R.startContainer)&&R.startContainer.getChild(R.startOffset-1);N&&a(N)&&!N.is(j.$empty);){if(N.isBlockBoundary())R.moveToPosition(N,CKEDITOR.POSITION_BEFORE_END);else{if(d(N)&&N.getHtml().match(/(\s|&nbsp;)$/g)){U=null;break}U=R.clone();U.moveToPosition(N,CKEDITOR.POSITION_BEFORE_END)}N=N.getLast(e)}U&&R.moveToRange(U)}s.select();
h(k)}}}(),m=function(){function a(b){b=new CKEDITOR.dom.walker(b);b.guard=function(a,b){if(b)return false;if(a.type==CKEDITOR.NODE_ELEMENT)return a.is(CKEDITOR.dtd.$tableContent)};b.evaluator=function(a){return a.type==CKEDITOR.NODE_ELEMENT};return b}function b(a,c,d){c=a.getDocument().createElement(c);a.append(c,d);return c}function c(a){var b=a.count(),d;for(b;b-- >0;){d=a.getItem(b);if(!CKEDITOR.tools.trim(d.getHtml())){d.appendBogus();CKEDITOR.env.ie&&(CKEDITOR.env.version<9&&d.getChildCount())&&
...
b;this.fire("selectionChange",{selection:a,path:b})}}function f(){o=true;if(!r){c.call(this);r=CKEDITOR.tools.setTimeout(c,200,this)}}function c(){r=null;if(o){CKEDITOR.tools.setTimeout(a,0,this);o=false}}function e(a){return m(a)||a.type==CKEDITOR.NODE_ELEMENT&&!a.is(CKEDITOR.dtd.$empty)?true:false}function b(a){function b(c,d){return!c||c.type==CKEDITOR.NODE_TEXT?false:a.clone()["moveToElementEdit"+(d?"End":"Start")](c)}if(!(a.root instanceof CKEDITOR.editable))return false;var c=a.startContainer,
...
c.data.getKeystroke();if(b[d]){var e=a.getSelection().getRanges(),f=e[0];if(e.length==1&&f.collapsed)if((d=f[d<38?"getPreviousEditableNode":"getNextEditableNode"]())&&d.type==CKEDITOR.NODE_ELEMENT&&d.getAttribute("contenteditable")=="false"){a.getSelection().fake(d);c.data.preventDefault();c.cancel()}}}}function n(a){for(var b=0;b<a.length;b++){var c=a[b];c.getCommonAncestor().isReadOnly()&&a.splice(b,1);if(!c.collapsed){if(c.startContainer.isReadOnly())for(var d=c.startContainer,e;d;){if((e=d.type==
CKEDITOR.NODE_ELEMENT)&&d.is("body")||!d.isReadOnly())break;e&&d.getAttribute("contentEditable")=="false"&&c.setStartAfter(d);d=d.getParent()}d=c.startContainer;e=c.endContainer;var f=c.startOffset,g=c.endOffset,h=c.clone();d&&d.type==CKEDITOR.NODE_TEXT&&(f>=d.getLength()?h.setStartAfter(d):h.setStartBefore(d));e&&e.type==CKEDITOR.NODE_TEXT&&(g?h.setEndAfter(e):h.setEndBefore(e));d=new CKEDITOR.dom.walker(h);d.evaluator=function(d){if(d.type==CKEDITOR.NODE_ELEMENT&&d.isReadOnly()){var e=c.clone();
c.setEndBefore(d);c.collapsed&&a.splice(b--,1);if(!(d.getPosition(h.endContainer)&CKEDITOR.POSITION_CONTAINS)){e.setStartAfter(d);e.collapsed||a.splice(b+1,0,e)}return true}return false};d.next()}}return a}var r,o,m=CKEDITOR.dom.walker.invisible(1),p=function(){function a(b){return function(a){var c=a.editor.createRange();c.moveToClosestEditablePosition(a.selected,b)&&a.editor.getSelection().selectRanges([c]);return false}}function b(a){return function(b){var c=b.editor,d=c.createRange(),e;if(!(e=
...
new CKEDITOR.dom.selection(d.getSelection());t.lock()}function c(){g.removeListener("mouseup",c);k.removeListener("mouseup",c);var a=CKEDITOR.document.$.selection,b=a.createRange();a.type!="None"&&b.parentElement().ownerDocument==e.$&&b.select()}var e=d.document,g=CKEDITOR.document,h=d.editable(),j=e.getBody(),k=e.getDocumentElement(),o=h.isInline(),p,t;CKEDITOR.env.gecko&&h.attachListener(h,"focus",function(a){a.removeListener();if(p!==0)if((a=d.getSelection().getNative())&&a.isCollapsed&&a.anchorNode==
h.$){a=d.createRange();a.moveToElementEditStart(h);a.select()}},null,null,-2);h.attachListener(h,CKEDITOR.env.webkit?"DOMFocusIn":"focus",function(){p&&CKEDITOR.env.webkit&&(p=d._.previousActive&&d._.previousActive.equals(e.getActive()));d.unlockSelection(p);p=0},null,null,-1);h.attachListener(h,"mousedown",function(){p=0});if(CKEDITOR.env.ie||o){q?h.attachListener(h,"beforedeactivate",b,null,null,-1):h.attachListener(d,"selectionCheck",b,null,null,-1);h.attachListener(h,CKEDITOR.env.webkit?"DOMFocusOut":
"blur",function(){d.lockSelection(t);p=1},null,null,-1);h.attachListener(h,"mousedown",function(){p=0})}if(CKEDITOR.env.ie&&!o){var m;h.attachListener(h,"mousedown",function(a){if(a.data.$.button==2){a=d.document.getSelection();if(!a||a.getType()==CKEDITOR.SELECTION_NONE)m=d.window.getScrollPosition()}});h.attachListener(h,"mouseup",function(a){if(a.data.$.button==2&&m){d.document.$.documentElement.scrollLeft=m.x;d.document.$.documentElement.scrollTop=m.y}m=null});if(e.$.compatMode!="BackCompat"){if(CKEDITOR.env.ie7Compat||
...
td:1,th:1,embed:1,object:1,ol:1,ul:1,a:1,input:1,form:1,select:1,textarea:1,button:1,fieldset:1,thead:1,tfoot:1};CKEDITOR.dom.selection.prototype={getNative:function(){return this._.cache.nativeSel!==void 0?this._.cache.nativeSel:this._.cache.nativeSel=q?this.document.$.selection:this.document.getWindow().$.getSelection()},getType:q?function(){var a=this._.cache;if(a.type)return a.type;var b=CKEDITOR.SELECTION_NONE;try{var c=this.getNative(),d=c.type;if(d=="Text")b=CKEDITOR.SELECTION_TEXT;if(d=="Control")b=
CKEDITOR.SELECTION_ELEMENT;if(c.createRange().parentElement())b=CKEDITOR.SELECTION_TEXT}catch(e){}return a.type=b}:function(){var a=this._.cache;if(a.type)return a.type;var b=CKEDITOR.SELECTION_TEXT,c=this.getNative();if(!c||!c.rangeCount)b=CKEDITOR.SELECTION_NONE;else if(c.rangeCount==1){var c=c.getRangeAt(0),d=c.startContainer;if(d==c.endContainer&&d.nodeType==1&&c.endOffset-c.startOffset==1&&u[d.childNodes[c.startOffset].nodeName.toLowerCase()])b=CKEDITOR.SELECTION_ELEMENT}return a.type=b},getRanges:function(){var a=
q?function(){function a(b){return(new CKEDITOR.dom.node(b)).getIndex()}var b=function(b,c){b=b.duplicate();b.collapse(c);var d=b.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var e=d.children,f,g,h=b.duplicate(),j=0,i=e.length-1,k=-1,o,l;j<=i;){k=Math.floor((j+i)/2);f=e[k];h.moveToElementText(f);o=h.compareEndPoints("StartToStart",b);if(o>0)i=k-1;else if(o<0)j=k+1;else return{container:d,offset:a(f)}}if(k==-1||k==e.length-1&&o<0){h.moveToElementText(d);h.setEndPoint("StartToStart",
b);h=h.text.replace(/(\r\n|\r)/g,"\n").length;e=d.childNodes;if(!h){f=e[e.length-1];return f.nodeType!=CKEDITOR.NODE_TEXT?{container:d,offset:e.length}:{container:f,offset:f.nodeValue.length}}for(d=e.length;h>0&&d>0;){g=e[--d];if(g.nodeType==CKEDITOR.NODE_TEXT){l=g;h=h-g.nodeValue.length}}return{container:l,offset:-h}}h.collapse(o>0?true:false);h.setEndPoint(o>0?"StartToStart":"EndToStart",b);h=h.text.replace(/(\r\n|\r)/g,"\n").length;if(!h)return{container:d,offset:a(f)+(o>0?0:1)};for(;h>0;)try{g=
f[o>0?"previousSibling":"nextSibling"];if(g.nodeType==CKEDITOR.NODE_TEXT){h=h-g.nodeValue.length;l=g}f=g}catch(p){return{container:d,offset:a(f)}}return{container:l,offset:o>0?-h:l.nodeValue.length+h}};return function(){var a=this.getNative(),c=a&&a.createRange(),d=this.getType();if(!a)return[];if(d==CKEDITOR.SELECTION_TEXT){a=new CKEDITOR.dom.range(this.root);d=b(c,true);a.setStart(new CKEDITOR.dom.node(d.container),d.offset);d=b(c);a.setEnd(new CKEDITOR.dom.node(d.container),d.offset);a.endContainer.getPosition(a.startContainer)&
...
1&&!(j=a[0]).collapsed&&(g=j.getEnclosedNode())&&g.type==CKEDITOR.NODE_ELEMENT){j=j.clone();j.shrink(CKEDITOR.SHRINK_ELEMENT,true);if((h=j.getEnclosedNode())&&h.type==CKEDITOR.NODE_ELEMENT)g=h;if(g.getAttribute("contenteditable")=="false")break a}g=void 0}if(g)this.fake(g);else{if(q){j=CKEDITOR.dom.walker.whitespaces(true);h=/\ufeff|\u00a0/;c={table:1,tbody:1,tr:1};if(a.length>1){g=a[a.length-1];a[0].setEnd(g.endContainer,g.endOffset)}g=a[0];var a=g.collapsed,k,o,l;if((d=g.getEnclosedNode())&&d.type==
CKEDITOR.NODE_ELEMENT&&d.getName()in u&&(!d.is("a")||!d.getText()))try{l=d.$.createControlRange();l.addElement(d.$);l.select();return}catch(p){}if(g.startContainer.type==CKEDITOR.NODE_ELEMENT&&g.startContainer.getName()in c||g.endContainer.type==CKEDITOR.NODE_ELEMENT&&g.endContainer.getName()in c){g.shrink(CKEDITOR.NODE_ELEMENT,true);a=g.collapsed}l=g.createBookmark();c=l.startNode;if(!a)f=l.endNode;l=g.document.$.body.createTextRange();l.moveToElementText(c.$);l.moveStart("character",1);if(f){h=
g.document.$.body.createTextRange();h.moveToElementText(f.$);l.setEndPoint("EndToEnd",h);l.moveEnd("character",-1)}else{k=c.getNext(j);o=c.hasAscendant("pre");k=!(k&&k.getText&&k.getText().match(h))&&(o||!c.hasPrevious()||c.getPrevious().is&&c.getPrevious().is("br"));o=g.document.createElement("span");o.setHtml("&#65279;");o.insertBefore(c);k&&g.document.createText("﻿").insertBefore(c)}g.setStartBefore(c);c.remove();if(a){if(k){l.moveStart("character",-1);l.select();g.document.$.selection.clear()}else l.select();
g.moveToPosition(o,CKEDITOR.POSITION_BEFORE_START);o.remove()}else{g.setEndBefore(f);f.remove();l.select()}}else{f=this.getNative();if(!f)return;this.removeAllRanges();for(l=0;l<a.length;l++){if(l<a.length-1){k=a[l];o=a[l+1];h=k.clone();h.setStart(k.endContainer,k.endOffset);h.setEnd(o.startContainer,o.startOffset);if(!h.collapsed){h.shrink(CKEDITOR.NODE_ELEMENT,true);g=h.getCommonAncestor();h=h.getEnclosedNode();if(g.isReadOnly()||h&&h.isReadOnly()){o.setStart(k.startContainer,k.startOffset);a.splice(l--,
1);continue}}}g=a[l];o=this.document.$.createRange();if(g.collapsed&&CKEDITOR.env.webkit&&b(g)){k=this.root;i(k,false);h=k.getDocument().createText("​");k.setCustomData("cke-fillingChar",h);g.insertNode(h);if((k=h.getNext())&&!h.getPrevious()&&k.type==CKEDITOR.NODE_ELEMENT&&k.getName()=="br"){i(this.root);g.moveToPosition(k,CKEDITOR.POSITION_BEFORE_START)}else g.moveToPosition(h,CKEDITOR.POSITION_AFTER_END)}o.setStart(g.startContainer.$,g.startOffset);try{o.setEnd(g.endContainer.$,g.endOffset)}catch(t){if(t.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")>=
0){g.collapse(1);o.setEnd(g.endContainer.$,g.endOffset)}else throw t;}f.addRange(o)}}this.reset();this.root.fire("selectionchange")}}},fake:function(a){var b=this.root.editor;this.reset();k(b);var c=this._.cache,d=new CKEDITOR.dom.range(this.root);d.setStartBefore(a);d.setEndAfter(a);c.ranges=new CKEDITOR.dom.rangeList(d);c.selectedElement=c.startElement=a;c.type=CKEDITOR.SELECTION_ELEMENT;c.selectedText=c.nativeSel=null;this.isFake=1;this.rev=t++;b._.fakeSelection=this;this.root.fire("selectionchange")},
...
if(!k){h=true;k=CKEDITOR.dtd.span}b.enlarge(CKEDITOR.ENLARGE_INLINE,1);b.trim();var o=b.createBookmark(),l=o.startNode,q=o.endNode,t=l,m;if(!j){var n=b.getCommonAncestor(),j=a(l,n),n=a(q,n);j&&(t=j.getNextSourceNode(true));n&&(q=n)}for(t.getPosition(q)==CKEDITOR.POSITION_FOLLOWING&&(t=0);t;){j=false;if(t.equals(q)){t=null;j=true}else{var u=t.type==CKEDITOR.NODE_ELEMENT?t.getName():null,n=u&&t.getAttribute("contentEditable")=="false",v=u&&t.getAttribute("data-nostyle");if(u&&t.data("cke-bookmark")){t=
t.getNextSourceNode(true);continue}if(n&&i&&CKEDITOR.dtd.$block[u])for(var x=t,s=e(x),w=void 0,z=s.length,y=0,x=z&&new CKEDITOR.dom.range(x.getDocument());y<z;++y){var w=s[y],A=CKEDITOR.filter.instances[w.data("cke-filter")];if(A?A.check(this):1){x.selectNodeContents(w);f.call(this,x)}}s=u?!k[u]||v?0:n&&!i?0:(t.getPosition(q)|F)==F&&(!g.childRule||g.childRule(t)):1;if(s)if((s=t.getParent())&&((s.getDtd()||CKEDITOR.dtd.span)[d]||h)&&(!g.parentRule||g.parentRule(s))){if(!m&&(!u||!CKEDITOR.dtd.$removeEmpty[u]||
(t.getPosition(q)|F)==F)){m=b.clone();m.setStartBefore(t)}u=t.type;if(u==CKEDITOR.NODE_TEXT||n||u==CKEDITOR.NODE_ELEMENT&&!t.getChildCount()){for(var u=t,aa;(j=!u.getNext(B))&&(aa=u.getParent(),k[aa.getName()])&&(aa.getPosition(l)|C)==C&&(!g.childRule||g.childRule(aa));)u=aa;m.setEndAfter(u)}}else j=true;else j=true;t=t.getNextSourceNode(v||n)}if(j&&m&&!m.collapsed){for(var j=p(this,c),n=j.hasAttributes(),v=m.getCommonAncestor(),u={},s={},w={},z={},U,$,ca;j&&v;){if(v.getName()==d){for(U in g.attributes)if(!z[U]&&
(ca=v.getAttribute($)))j.getAttribute(U)==ca?s[U]=1:z[U]=1;for($ in g.styles)if(!w[$]&&(ca=v.getStyle($)))j.getStyle($)==ca?u[$]=1:w[$]=1}v=v.getParent()}for(U in s)j.removeAttribute(U);for($ in u)j.removeStyle($);n&&!j.hasAttributes()&&(j=null);if(j){m.extractContents().appendTo(j);m.insertNode(j);r.call(this,j);j.mergeSiblings();CKEDITOR.env.ie||j.$.normalize()}else{j=new CKEDITOR.dom.element("span");m.extractContents().appendTo(j);m.insertNode(j);r.call(this,j);j.remove(true)}m=null}}b.moveToBookmark(o);
...
a.removeStyle(e)}}function i(a){var b=a.createBookmark(true),c=a.createIterator();c.enforceRealBlocks=true;if(this._.enterMode)c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,e=a.document,f;d=c.getNextParagraph();)if(!d.isReadOnly()&&(c.activeFilter?c.activeFilter.check(this):1)){f=p(this,e,d);h(d,f)}a.moveToBookmark(b)}function d(a){var b=a.createBookmark(1),c=a.createIterator();c.enforceRealBlocks=true;c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,e;d=c.getNextParagraph();)if(this.checkElementRemovable(d))if(d.is("pre")){(e=
this._.enterMode==CKEDITOR.ENTER_BR?null:a.document.createElement(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))&&d.copyAttributes(e);h(d,e)}else n.call(this,d);a.moveToBookmark(b)}function h(a,b){var c=!b;if(c){b=a.getDocument().createElement("div");a.copyAttributes(b)}var d=b&&b.is("pre"),e=a.is("pre"),f=!d&&e;if(d&&!e){e=b;(f=a.getBogus())&&f.remove();f=a.getHtml();f=k(f,/(?:^[ \t\n\r]+)|(?:[ \t\n\r]+$)/g,"");f=f.replace(/[ \t\r\n]*(<br[^>]*>)[ \t\r\n]*/gi,"$1");f=f.replace(/([ \t\n\r]+|&nbsp;)/g,
...
CKEDITOR.ENTER_BR&&!a.hasAttributes()?m(a):a.renameNode(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))}function r(a){for(var b=u(this),c=a.getElementsByTag(this.element),d,e=c.count();--e>=0;){d=c.getItem(e);d.isReadOnly()||n.call(this,d,true)}for(var f in b)if(f!=this.element){c=a.getElementsByTag(f);for(e=c.count()-1;e>=0;e--){d=c.getItem(e);d.isReadOnly()||o(d,b[f])}}}function o(a,b,c){if(b=b&&b.attributes)for(var d=0;d<b.length;d++){var e=b[d][0],f;if(f=a.getAttribute(e)){var g=b[d][1];(g===null||
g.test&&g.test(f)||typeof g=="string"&&f==g)&&a.removeAttribute(e)}}c||m(a)}function m(a,b){if(!a.hasAttributes()||b)if(CKEDITOR.dtd.$block[a.getName()]){var c=a.getPrevious(A),d=a.getNext(A);c&&(c.type==CKEDITOR.NODE_TEXT||!c.isBlockBoundary({br:1}))&&a.append("br",1);d&&(d.type==CKEDITOR.NODE_TEXT||!d.isBlockBoundary({br:1}))&&a.append("br");a.remove(true)}else{c=a.getFirst();d=a.getLast();a.remove(true);if(c){c.type==CKEDITOR.NODE_ELEMENT&&c.mergeSiblings();d&&(!c.equals(d)&&d.type==CKEDITOR.NODE_ELEMENT)&&
d.mergeSiblings()}}}function p(a,b,c){var d;d=a.element;d=="*"&&(d="span");d=new CKEDITOR.dom.element(d,b);c&&c.copyAttributes(d);d=q(d,a);b.getCustomData("doc_processing_style")&&d.hasAttribute("id")?d.removeAttribute("id"):b.setCustomData("doc_processing_style",1);return d}function q(a,b){var c=b._.definition,d=c.attributes,c=CKEDITOR.style.getStyleText(c);if(d)for(var e in d)a.setAttribute(e,d[e]);c&&a.setAttribute("style",c);return a}function t(a,b){for(var c in a)a[c]=a[c].replace(z,function(a,
...
{getUiColor:function(){return this.uiColor},setUiColor:function(a){var c=e(CKEDITOR.document);return(this.setUiColor=function(a){this.uiColor=a;var e=CKEDITOR.skin.chameleon,f="",g="";if(typeof e=="function"){f=e(this,"editor");g=e(this,"panel")}a=[[h,a]];b([c],f,a);b(d,g,a)}).call(this,a)}});var i="cke_ui_color",d=[],h=/\$color/g;CKEDITOR.on("instanceLoaded",function(a){if(!CKEDITOR.env.ie||!CKEDITOR.env.quirks){var c=a.editor,a=function(a){a=(a.data[0]||a.data).element.getElementsByTag("iframe").getItem(0).getFrameDocument();
...
e+'" id="'+g.labelId+'" for="'+g.inputId+'"'+(c.labelStyle?' style="'+c.labelStyle+'"':"")+">"+CKEDITOR.tools.htmlEncode(c.label)+"</label>"},{type:"html",html:'<span class="cke_dialog_ui_labeled_content"'+(c.controlStyle?' style="'+c.controlStyle+'"':"")+">"+f.call(this,b,c)+"</span>"}]};CKEDITOR.dialog._.uiElementBuilders.hbox.build(b,e,a)}return a.join("")})}},textInput:function(b,c,e){if(!(arguments.length<3)){a.call(this,c);var f=this._.inputId=CKEDITOR.tools.getNextId()+"_textInput",g={"class":"cke_dialog_ui_input_"+
...
c.includeLabel=true;CKEDITOR.ui.dialog.labeledElement.call(this,b,c,e,function(){for(var a=[],e=[],j=(c.id?c.id:CKEDITOR.tools.getNextId())+"_radio",m=0;m<c.items.length;m++){var p=c.items[m],q=p[2]!==void 0?p[2]:p[0],t=p[1]!==void 0?p[1]:p[0],u=CKEDITOR.tools.getNextId()+"_radio_input",v=u+"_label",u=CKEDITOR.tools.extend({},c,{id:u,title:null,type:null},true),q=CKEDITOR.tools.extend({},u,{title:q},true),x={type:"radio","class":"cke_dialog_ui_radio_input",name:j,value:t,"aria-labelledby":v},w=[];
if(g._["default"]==t)x.checked="checked";i(u);i(q);if(typeof u.inputStyle!="undefined")u.style=u.inputStyle;u.keyboardFocusable=true;f.push(new CKEDITOR.ui.dialog.uiElement(b,u,w,"input",null,x));w.push(" ");new CKEDITOR.ui.dialog.uiElement(b,q,w,"label",null,{id:v,"for":x.id},p[0]);a.push(w.join(""))}new CKEDITOR.ui.dialog.hbox(b,f,a,e);return e.join("")});this._.children=f}},button:function(b,c,e){if(arguments.length){typeof c=="function"&&(c=c(b.getParentEditor()));a.call(this,c,{disabled:c.disabled||
...
"aria-labelledby":this._.labelId};e.push('<div class="cke_dialog_ui_input_',c.type,'" role="presentation"');c.width&&e.push('style="width:'+c.width+'" ');e.push(">");if(c.size!==void 0)j.size=c.size;if(c.multiple!==void 0)j.multiple=c.multiple;i(a);for(var m=0,p;m<c.items.length&&(p=c.items[m]);m++)g.push('<option value="',CKEDITOR.tools.htmlEncode(p[1]!==void 0?p[1]:p[0]).replace(/"/g,"&quot;"),'" /> ',CKEDITOR.tools.htmlEncode(p[0]));if(typeof a.inputStyle!="undefined")a.style=a.inputStyle;f.select=
...
o=f.html;o.charAt(0)!="<"&&(o="<span>"+o+"</span>");var m=f.focus;if(m){var p=this.focus;this.focus=function(){(typeof m=="function"?m:p).call(this);this.fire("focus")};if(f.isFocusable)this.isFocusable=this.isFocusable;this.keyboardFocusable=true}CKEDITOR.ui.dialog.uiElement.call(this,e,f,i,"span",null,null,"");i=i.join("").match(a);o=o.match(b)||["","",""];if(c.test(o[1])){o[1]=o[1].slice(0,-1);o[2]="/"+o[2]}g.push([o[1]," ",i[1]||"",o[2]].join(""))}}}(),fieldset:function(a,b,c,e,f){var g=f.label;
...
c[1].toLowerCase(),a[f]);return this},reset:function(){function a(){c.$.open();var d="";e.size&&(d=e.size-(CKEDITOR.env.ie?7:0));var q=b.frameId+"_input";c.$.write(['<html dir="'+o+'" lang="'+m+'"><head><title></title></head><body style="margin: 0; overflow: hidden; background: transparent;">','<form enctype="multipart/form-data" method="POST" dir="'+o+'" lang="'+m+'" action="',CKEDITOR.tools.htmlEncode(e.action),'"><label id="',b.labelId,'" for="',q,'" style="display:none">',CKEDITOR.tools.htmlEncode(e.label),
...
this._,c=CKEDITOR.document.getById(b.frameId).getFrameDocument(),e=b.definition,f=b.buttons,g=this.formLoadedNumber,i=this.formUnloadNumber,o=b.dialog._.editor.lang.dir,m=b.dialog._.editor.langCode;if(!g){g=this.formLoadedNumber=CKEDITOR.tools.addFunction(function(){this.fire("formLoaded")},this);i=this.formUnloadNumber=CKEDITOR.tools.addFunction(function(){this.getInputElement().clearCustomData()},this);this.getDialog()._.editor.on("destroy",function(){CKEDITOR.tools.removeFunction(g);CKEDITOR.tools.removeFunction(i)})}CKEDITOR.env.gecko?
...
{32:1,13:1}&&this.fire("click")});b.on("focus",function(){this.fire("mouseover")});b.on("blur",function(){this.fire("mouseout")})}function d(a){function b(){a.layout()}var c=CKEDITOR.document.getWindow();c.on("resize",b);a.on("hide",function(){c.removeListener("resize",b)})}function h(a,b){this._={dialog:a};CKEDITOR.tools.extend(this,b)}function j(a){function b(c){var i=a.getSize(),j=CKEDITOR.document.getWindow().getViewPaneSize(),k=c.data.$.screenX,o=c.data.$.screenY,t=k-d.x,p=o-d.y;d={x:k,y:o};
e.x=e.x+t;e.y=e.y+p;a.move(e.x+h[3]<g?-h[3]:e.x-h[1]>j.width-i.width-g?j.width-i.width+(f.lang.dir=="rtl"?0:h[1]):e.x,e.y+h[0]<g?-h[0]:e.y-h[2]>j.height-i.height-g?j.height-i.height+h[2]:e.y,1);c.data.preventDefault()}function c(){CKEDITOR.document.removeListener("mousemove",b);CKEDITOR.document.removeListener("mouseup",c);if(CKEDITOR.env.ie6Compat){var a=s.getChild(0).getFrameDocument();a.removeListener("mousemove",b);a.removeListener("mouseup",c)}}var d=null,e=null,f=a.getParentEditor(),g=f.config.dialog_magnetDistance,
h=CKEDITOR.skin.margins||[0,0,0,0];typeof g=="undefined"&&(g=20);a.parts.title.on("mousedown",function(f){d={x:f.data.$.screenX,y:f.data.$.screenY};CKEDITOR.document.on("mousemove",b);CKEDITOR.document.on("mouseup",c);e=a.getPosition();if(CKEDITOR.env.ie6Compat){var g=s.getChild(0).getFrameDocument();g.on("mousemove",b);g.on("mouseup",c)}f.data.preventDefault()},a)}function k(a){var b,c;function d(e){var t=h.lang.dir=="rtl",p=o.width,q=o.height,l=p+(e.data.$.screenX-b)*(t?-1:1)*(a._.moved?1:2),m=
q+(e.data.$.screenY-c)*(a._.moved?1:2),u=a._.element.getFirst(),u=t&&u.getComputedStyle("right"),r=a.getPosition();r.y+m>k.height&&(m=k.height-r.y);if((t?u:r.x)+l>k.width)l=k.width-(t?u:r.x);if(g==CKEDITOR.DIALOG_RESIZE_WIDTH||g==CKEDITOR.DIALOG_RESIZE_BOTH)p=Math.max(f.minWidth||0,l-i);if(g==CKEDITOR.DIALOG_RESIZE_HEIGHT||g==CKEDITOR.DIALOG_RESIZE_BOTH)q=Math.max(f.minHeight||0,m-j);a.resize(p,q);a._.moved||a.layout();e.data.preventDefault()}function e(){CKEDITOR.document.removeListener("mouseup",
e);CKEDITOR.document.removeListener("mousemove",d);if(t){t.remove();t=null}if(CKEDITOR.env.ie6Compat){var a=s.getChild(0).getFrameDocument();a.removeListener("mouseup",e);a.removeListener("mousemove",d)}}var f=a.definition,g=f.resizable;if(g!=CKEDITOR.DIALOG_RESIZE_NONE){var h=a.getParentEditor(),i,j,k,o,t,p=CKEDITOR.tools.addFunction(function(f){o=a.getSize();var g=a.parts.contents;if(g.$.getElementsByTagName("iframe").length){t=CKEDITOR.dom.element.createFromHtml('<div class="cke_dialog_resize_cover" style="height: 100%; position: absolute; width: 100%;"></div>');
g.append(t)}j=o.height-a.parts.contents.getSize("height",!(CKEDITOR.env.gecko||CKEDITOR.env.ie&&CKEDITOR.env.quirks));i=o.width-a.parts.contents.getSize("width",1);b=f.screenX;c=f.screenY;k=CKEDITOR.document.getWindow().getViewPaneSize();CKEDITOR.document.on("mousemove",d);CKEDITOR.document.on("mouseup",e);if(CKEDITOR.env.ie6Compat){g=s.getChild(0).getFrameDocument();g.on("mousemove",d);g.on("mouseup",e)}f.preventDefault&&f.preventDefault()});a.on("load",function(){var b="";g==CKEDITOR.DIALOG_RESIZE_WIDTH?
b=" cke_resizer_horizontal":g==CKEDITOR.DIALOG_RESIZE_HEIGHT&&(b=" cke_resizer_vertical");b=CKEDITOR.dom.element.createFromHtml('<div class="cke_resizer'+b+" cke_resizer_"+h.lang.dir+'" title="'+CKEDITOR.tools.htmlEncode(h.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+p+', event )">'+(h.lang.dir=="ltr"?"◢":"◣")+"</div>");a.parts.footer.append(b,1)});h.on("destroy",function(){CKEDITOR.tools.removeFunction(p)})}}function l(a){a.data.preventDefault(1)}function n(a){var b=CKEDITOR.document.getWindow(),
...
window.onscroll||function(){};window.onscroll=i},0);h()}}function r(a){if(s){a.focusManager.remove(s);a=CKEDITOR.document.getWindow();s.hide();a.removeListener("resize",x);CKEDITOR.env.ie6Compat&&a.$.setTimeout(function(){window.onscroll=window.onscroll&&window.onscroll.prevScrollHandler||null},0);x=null}}var o=CKEDITOR.tools.cssLength,m='<div class="cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir="{langDir}" lang="{langCode}" role="dialog" aria-labelledby="cke_dialog_title_{id}"><table class="cke_dialog '+
...
CKEDITOR.dialog=function(c,d){function h(){var a=w._.focusList;a.sort(function(a,b){return a.tabIndex!=b.tabIndex?b.tabIndex-a.tabIndex:a.focusIndex-b.focusIndex});for(var b=a.length,c=0;c<b;c++)a[c].focusIndex=c}function i(a){var b=w._.focusList,a=a||0;if(!(b.length<1)){var c=w._.currentFocusIndex;try{b[c].getInputElement().$.blur()}catch(d){}for(var e=c=(c+a+b.length)%b.length;a&&!b[e].isFocusable();){e=(e+a+b.length)%b.length;if(e==c)break}b[e].focus();b[e].type=="text"&&b[e].select()}}function o(b){if(w==
CKEDITOR.dialog._.currentTop){var d=b.data.getKeystroke(),e=c.lang.dir=="rtl";n=x=0;if(d==9||d==CKEDITOR.SHIFT+9){d=d==CKEDITOR.SHIFT+9;if(w._.tabBarMode){d=d?a.call(w):f.call(w);w.selectPage(d);w._.tabs[d][0].focus()}else i(d?-1:1);n=1}else if(d==CKEDITOR.ALT+121&&!w._.tabBarMode&&w.getPageCount()>1){w._.tabBarMode=true;w._.tabs[w._.currentTabId][0].focus();n=1}else if((d==37||d==39)&&w._.tabBarMode){d=d==(e?39:37)?a.call(w):f.call(w);w.selectPage(d);w._.tabs[d][0].focus();n=1}else if((d==13||d==
32)&&w._.tabBarMode){this.selectPage(this._.currentTabId);this._.tabBarMode=false;this._.currentFocusIndex=-1;i(1);n=1}else if(d==13){d=b.data.getTarget();if(!d.is("a","button","select","textarea")&&(!d.is("input")||d.$.type!="button")){(d=this.getButton("ok"))&&CKEDITOR.tools.setTimeout(d.click,0,d);n=1}x=1}else if(d==27){(d=this.getButton("cancel"))?CKEDITOR.tools.setTimeout(d.click,0,d):this.fire("cancel",{hide:true}).hide!==false&&this.hide();x=1}else return;t(b)}}function t(a){n?a.data.preventDefault(1):
x&&a.data.stopPropagation()}var q=CKEDITOR.dialog._.dialogDefinitions[d],l=CKEDITOR.tools.clone(p),m=c.config.dialog_buttonsOrder||"OS",u=c.lang.dir,r={},n,x;(m=="OS"&&CKEDITOR.env.mac||m=="rtl"&&u=="ltr"||m=="ltr"&&u=="rtl")&&l.buttons.reverse();q=CKEDITOR.tools.extend(q(c),l);q=CKEDITOR.tools.clone(q);q=new v(this,q);l=g(c);this._={editor:c,element:l.element,name:d,contentSize:{width:0,height:0},size:{width:0,height:0},contents:{},buttons:{},accessKeyMap:{},tabs:{},tabIdList:[],currentTabId:null,
currentTabIndex:null,pageCount:0,lastTab:null,tabBarMode:false,focusList:[],currentFocusIndex:0,hasFocus:false};this.parts=l.parts;CKEDITOR.tools.setTimeout(function(){c.fire("ariaWidget",this.parts.contents)},0,this);l={position:CKEDITOR.env.ie6Compat?"absolute":"fixed",top:0,visibility:"hidden"};l[u=="rtl"?"right":"left"]=0;this.parts.dialog.setStyles(l);CKEDITOR.event.call(this);this.definition=q=CKEDITOR.fire("dialogDefinition",{name:d,definition:q},c).definition;if(!("removeDialogTabs"in c._)&&
c.config.removeDialogTabs){l=c.config.removeDialogTabs.split(";");for(u=0;u<l.length;u++){m=l[u].split(":");if(m.length==2){var s=m[0];r[s]||(r[s]=[]);r[s].push(m[1])}}c._.removeDialogTabs=r}if(c._.removeDialogTabs&&(r=c._.removeDialogTabs[d]))for(u=0;u<r.length;u++)q.removeContents(r[u]);if(q.onLoad)this.on("load",q.onLoad);if(q.onShow)this.on("show",q.onShow);if(q.onHide)this.on("hide",q.onHide);if(q.onOk)this.on("ok",function(a){c.fire("saveSnapshot");setTimeout(function(){c.fire("saveSnapshot")},
0);if(q.onOk.call(this,a)===false)a.data.hide=false});if(q.onCancel)this.on("cancel",function(a){if(q.onCancel.call(this,a)===false)a.data.hide=false});var w=this,z=function(a){var b=w._.contents,c=false,d;for(d in b)for(var e in b[d])if(c=a.call(this,b[d][e]))return};this.on("ok",function(a){z(function(b){if(b.validate){var c=b.validate(this),d=typeof c=="string"||c===false;if(d){a.data.hide=false;a.stop()}e.call(b,!d,typeof c=="string"?c:void 0);return d}})},this,null,0);this.on("cancel",function(a){z(function(b){if(b.isChanged()){if(!c.config.dialog_noConfirmCancel&&
!confirm(c.lang.common.confirmCancel))a.data.hide=false;return true}})},this,null,0);this.parts.close.on("click",function(a){this.fire("cancel",{hide:true}).hide!==false&&this.hide();a.data.preventDefault()},this);this.changeFocus=i;var y=this._.element;c.focusManager.add(y,1);this.on("show",function(){y.on("keydown",o,this);if(CKEDITOR.env.gecko)y.on("keypress",t,this)});this.on("hide",function(){y.removeListener("keydown",o);CKEDITOR.env.gecko&&y.removeListener("keypress",t);z(function(a){b.apply(a)})});
this.on("iframeAdded",function(a){(new CKEDITOR.dom.document(a.data.iframe.$.contentWindow.document)).on("keydown",o,this,null,0)});this.on("show",function(){h();if(c.config.dialog_startupFocusTab&&w._.pageCount>1){w._.tabBarMode=true;w._.tabs[w._.currentTabId][0].focus()}else if(!this._.hasFocus){this._.currentFocusIndex=-1;if(q.onFocus){var a=q.onFocus.call(this);a&&a.focus()}else i(1)}},this,null,4294967295);if(CKEDITOR.env.ie6Compat)this.on("load",function(){var a=this.getElement(),b=a.getFirst();
b.remove();b.appendTo(a)},this);j(this);k(this);(new CKEDITOR.dom.text(q.title,CKEDITOR.document)).appendTo(this.parts.title);for(u=0;u<q.contents.length;u++)(r=q.contents[u])&&this.addPage(r);this.parts.tabs.on("click",function(a){var b=a.data.getTarget();if(b.hasClass("cke_dialog_tab")){b=b.$.id;this.selectPage(b.substring(4,b.lastIndexOf("_")));if(this._.tabBarMode){this._.tabBarMode=false;this._.currentFocusIndex=-1;i(1)}a.data.preventDefault()}},this);u=[];r=CKEDITOR.dialog._.uiElementBuilders.hbox.build(this,
{type:"hbox",className:"cke_dialog_footer_buttons",widths:[],children:q.buttons},u).getChild();this.parts.footer.setHtml(u.join(""));for(u=0;u<r.length;u++)this._.buttons[r[u].id]=r[u]};CKEDITOR.dialog.prototype={destroy:function(){this.hide();this._.element.remove()},resize:function(){return function(a,b){if(!this._.contentSize||!(this._.contentSize.width==a&&this._.contentSize.height==b)){CKEDITOR.dialog.fire("resize",{dialog:this,width:a,height:b},this._.editor);this.fire("resize",{width:a,height:b},
...
b){return t(this.buttons,a,b)},removeContents:function(a){u(this.contents,a)},removeButton:function(a){u(this.buttons,a)}};h.prototype={get:function(a){return q(this.elements,a,"children")},add:function(a,b){return t(this.elements,a,b,"children")},remove:function(a){u(this.elements,a,"children")}};var x,w={},s,y={},z=function(a){var b=a.data.$.ctrlKey||a.data.$.metaKey,c=a.data.$.altKey,d=a.data.$.shiftKey,e=String.fromCharCode(a.data.$.keyCode);if((b=y[(b?"CTRL+":"")+(c?"ALT+":"")+(d?"SHIFT+":"")+
...
keydown:d||a.accessKeyDown})},F=function(a){for(var b in y){for(var c=y[b],d=c.length-1;d>=0;d--)(c[d].dialog==a||c[d].uiElement==a)&&c.splice(d,1);c.length===0&&delete y[b]}},C=function(a,b){a._.accessKeyMap[b]&&a.selectPage(a._.accessKeyMap[b])},J=function(){};(function(){CKEDITOR.ui.dialog={uiElement:function(a,b,c,d,e,f,g){if(!(arguments.length<4)){var h=(d.call?d(b):d)||"div",i=["<",h," "],j=(e&&e.call?e(b):e)||{},k=(f&&f.call?f(b):f)||{},o=(g&&g.call?g.call(this,a,b):g)||"",q=this.domId=k.id||
CKEDITOR.tools.getNextId()+"_uiElement";if(b.requiredContent&&!a.getParentEditor().filter.check(b.requiredContent)){j.display="none";this.notAllowed=true}k.id=q;var t={};b.type&&(t["cke_dialog_ui_"+b.type]=1);b.className&&(t[b.className]=1);if(b.disabled)t.cke_disabled=1;for(var p=k["class"]&&k["class"].split?k["class"].split(" "):[],q=0;q<p.length;q++)p[q]&&(t[p[q]]=1);p=[];for(q in t)p.push(q);k["class"]=p.join(" ");if(b.title)k.title=b.title;t=(b.style||"").split(";");if(b.align){p=b.align;j["margin-left"]=
p=="left"?0:"auto";j["margin-right"]=p=="right"?0:"auto"}for(q in j)t.push(q+":"+j[q]);b.hidden&&t.push("display:none");for(q=t.length-1;q>=0;q--)t[q]===""&&t.splice(q,1);if(t.length>0)k.style=(k.style?k.style+"; ":"")+t.join("; ");for(q in k)i.push(q+'="'+CKEDITOR.tools.htmlEncode(k[q])+'" ');i.push(">",o,"</",h,">");c.push(i.join(""));(this._||(this._={})).dialog=a;if(typeof b.isChanged=="boolean")this.isChanged=function(){return b.isChanged};if(typeof b.isChanged=="function")this.isChanged=b.isChanged;
...
4)){this._||(this._={});var f=this._.children=b,g=e&&e.widths||null,h=e&&e.height||null,i,j={role:"presentation"};e&&e.align&&(j.align=e.align);CKEDITOR.ui.dialog.uiElement.call(this,a,e||{type:"hbox"},d,"table",{},j,function(){var a=['<tbody><tr class="cke_dialog_ui_hbox">'];for(i=0;i<c.length;i++){var b="cke_dialog_ui_hbox_child",d=[];i===0&&(b="cke_dialog_ui_hbox_first");i==c.length-1&&(b="cke_dialog_ui_hbox_last");a.push('<td class="',b,'" role="presentation" ');g?g[i]&&d.push("width:"+o(g[i])):
d.push("width:"+Math.floor(100/c.length)+"%");h&&d.push("height:"+o(h));e&&e.padding!==void 0&&d.push("padding:"+o(e.padding));CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&f[i].align)&&d.push("text-align:"+f[i].align);d.length>0&&a.push('style="'+d.join("; ")+'" ');a.push(">",c[i],"</td>")}a.push("</tr></tbody>");return a.join("")})}},vbox:function(a,b,c,d,e){if(!(arguments.length<3)){this._||(this._={});var f=this._.children=b,g=e&&e.width||null,h=e&&e.heights||null;CKEDITOR.ui.dialog.uiElement.call(this,
...
w={}}var a=a.editor._.storedDialogs,d;for(d in a)a[d].destroy()})})();CKEDITOR.tools.extend(CKEDITOR.editor.prototype,{openDialog:function(a,b){var c=null,d=CKEDITOR.dialog._.dialogDefinitions[a];CKEDITOR.dialog._.currentTop===null&&n(this);if(typeof d=="function"){c=this._.storedDialogs||(this._.storedDialogs={});c=c[a]||(c[a]=new CKEDITOR.dialog(this,a));b&&b.call(c,c);c.show()}else{if(d=="failed"){r(this);throw Error('[CKEDITOR.dialog.openDialog] Dialog "'+a+'" failed when loading definition.');
...
CKEDITOR.TRISTATE_OFF)},context:"blockquote",allowedContent:"blockquote",requiredContent:"blockquote"};CKEDITOR.plugins.add("blockquote",{init:function(f){if(!f.blockless){f.addCommand("blockquote",a);f.ui.addButton&&f.ui.addButton("Blockquote",{label:f.lang.blockquote.toolbar,command:"blockquote",toolbar:"blocks,10"})}}})}(),"use strict",function(){function a(a){function b(){var c=a.editable();c.on(y,function(a){(!CKEDITOR.env.ie||!x)&&t(a)});CKEDITOR.env.ie&&c.on("paste",function(b){if(!w){f();
b.data.preventDefault();t(b);n("paste")||a.openDialog("paste")}});if(CKEDITOR.env.ie){c.on("contextmenu",g,null,null,0);c.on("beforepaste",function(a){a.data&&(!a.data.$.ctrlKey&&!a.data.$.shiftKey)&&g()},null,null,0)}c.on("beforecut",function(){!x&&o(a)});var d;c.attachListener(CKEDITOR.env.ie?c:a.document.getDocumentElement(),"mouseup",function(){d=setTimeout(function(){u()},0)});a.on("destroy",function(){clearTimeout(d)});c.on("keyup",u)}function c(b){return{type:b,canUndo:b=="cut",startDisabled:true,
...
k.setStyles(CKEDITOR.tools.cssVendorPrefix("user-select","text"));if(q=k.getParent().isReadOnly()){k.setOpacity(0);k.setAttribute("contenteditable",true)}else k.setStyle(a.config.contentsLangDirection=="ltr"?"left":"right","-1000px");a.on("selectionChange",f,null,null,0);if(CKEDITOR.env.webkit||CKEDITOR.env.gecko)g=e.once("blur",f,null,null,-100);q&&k.focus();q=new CKEDITOR.dom.range(k);q.selectNodeContents(k);var t=q.select();CKEDITOR.env.ie&&(g=e.once("blur",function(){a.lockSelection(t)}));var o=
CKEDITOR.document.getWindow().getScrollPosition().y;setTimeout(function(){if(CKEDITOR.env.webkit)CKEDITOR.document.getBody().$.scrollTop=o;g&&g.removeListener();CKEDITOR.env.ie&&e.focus();h.selectBookmarks(j);k.remove();var b;if(CKEDITOR.env.webkit&&(b=k.getFirst())&&b.is&&b.hasClass("Apple-style-span"))k=b;a.removeListener("selectionChange",f);c(k.getHtml())},0)}}function p(){if(CKEDITOR.env.ie){a.focus();f();var b=a.focusManager;b.lock();if(a.editable().fire(y)&&!n("paste")){b.unlock();return false}b.unlock()}else try{if(a.editable().fire(y)&&
...
w=0,s=0,y=CKEDITOR.env.ie?"beforepaste":"paste";(function(){a.on("key",q);a.on("contentDom",b);a.on("selectionChange",function(a){s=a.data.selection.getRanges()[0].checkReadOnly();u()});a.contextMenu&&a.contextMenu.addListener(function(a,b){s=b.getRanges()[0].checkReadOnly();return{cut:v("cut"),copy:v("copy"),paste:v("paste")}})})();(function(){function b(c,d,e,f,g){var h=a.lang.clipboard[d];a.addCommand(d,e);a.ui.addButton&&a.ui.addButton(c,{label:h,command:d,toolbar:"clipboard,"+f});a.addMenuItems&&
a.addMenuItem(d,{label:h,command:d,group:"clipboard",order:g})}b("Cut","cut",c("cut"),10,1);b("Copy","copy",c("copy"),20,4);b("Paste","paste",e(),30,8)})();a.getClipboardData=function(b,c){function d(a){a.removeListener();a.cancel();c(a.data)}function e(a){a.removeListener();a.cancel();j=true;c({type:h,dataValue:a.data})}function f(){this.customTitle=b&&b.title}var g=false,h="auto",j=false;if(!c){c=b;b=null}a.on("paste",d,null,null,0);a.on("beforePaste",function(a){a.removeListener();g=true;h=a.data.type},
null,null,1E3);if(p()===false){a.removeListener("paste",d);if(g&&a.fire("pasteDialog",f)){a.on("pasteDialogCommit",e);a.on("dialogHide",function(a){a.removeListener();a.data.removeListener("pasteDialogCommit",e);setTimeout(function(){j||c(null)},10)})}else c(null)}}}function f(a){if(CKEDITOR.env.webkit){if(!a.match(/^[^<]*$/g)&&!a.match(/^(<div><br( ?\/)?><\/div>|<div>[^<]*<\/div>)*$/gi))return"html"}else if(CKEDITOR.env.ie){if(!a.match(/^([^<]|<br( ?\/)?>)*$/gi)&&!a.match(/^(<p>([^<]|<br( ?\/)?>)*<\/p>|(\r\n))*$/gi))return"html"}else if(CKEDITOR.env.gecko){if(!a.match(/^([^<]|<br( ?\/)?>)*$/gi))return"html"}else return"html";
...
ol:1,p:1,table:1,ul:1},c=CKEDITOR.tools.extend({br:0},CKEDITOR.dtd.$inline),e={p:1,br:1,"cke:br":1},f=CKEDITOR.dtd,g=CKEDITOR.tools.extend({area:1,basefont:1,embed:1,iframe:1,map:1,object:1,param:1},CKEDITOR.dtd.$nonBodyContent,CKEDITOR.dtd.$cdata),n=function(a){delete a.name;a.add(new CKEDITOR.htmlParser.text(" "))},r=function(a){for(var b=a,c;(b=b.next)&&b.name&&b.name.match(/^h\d$/);){c=new CKEDITOR.htmlParser.element("cke:br");c.isEmpty=true;for(a.add(c);c=b.children.shift();)a.add(c)}};a.addRules({elements:{h1:r,
h2:r,h3:r,h4:r,h5:r,h6:r,img:function(a){var a=CKEDITOR.tools.trim(a.attributes.alt||""),b=" ";a&&!a.match(/(^http|\.(jpe?g|gif|png))/i)&&(b=" ["+a+"] ");return new CKEDITOR.htmlParser.text(b)},td:n,th:n,$:function(a){var i=a.name,p;if(g[i])return false;a.attributes={};if(i=="br")return a;if(b[i])a.name="p";else if(c[i])delete a.name;else if(f[i]){p=new CKEDITOR.htmlParser.element("cke:br");p.isEmpty=true;if(CKEDITOR.dtd.$empty[i])return p;a.add(p,0);p=p.clone();p.isEmpty=true;a.add(p);delete a.name}e[a.name]||
...
CKEDITOR.env.gecko&&(b=b.replace(/(\s)<br>$/,"$1"));a.data.dataValue=b},null,null,3);g.on("paste",function(a){var a=a.data,j=a.type,k=a.dataValue,l,n=g.config.clipboard_defaultContentType||"html";l=j=="html"||a.preSniffing=="html"?"html":f(k);l=="htmlifiedtext"?k=c(g.config,k):j=="text"&&l=="html"&&(k=b(g.config,k,d||(d=e(g))));a.startsWithEOL&&(k='<br data-cke-eol="1">'+k);a.endsWithEOL&&(k=k+'<br data-cke-eol="1">');j=="auto"&&(j=l=="html"||n=="html"?"html":"text");a.type=j;a.dataValue=k;delete a.preSniffing;
...
click:a.click||function(b){b.execCommand(a.command)}});this._={}};CKEDITOR.ui.button.handler={create:function(a){return new CKEDITOR.ui.button(a)}};CKEDITOR.ui.button.prototype={render:function(a,b){function g(){var b=a.mode;if(b){b=this.modes[b]?m[b]!==void 0?m[b]:CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED;b=a.readOnly&&!this.readOnly?CKEDITOR.TRISTATE_DISABLED:b;this.setState(b);this.refresh&&this.refresh()}}var i=CKEDITOR.env,d=this._.id=CKEDITOR.tools.getNextId(),h="",j=this.command,k;this._.editor=
a;var l={id:d,button:this,editor:a,focus:function(){CKEDITOR.document.getById(d).focus()},execute:function(){this.button.click(a)},attach:function(a){this.button.attach(a)}},n=CKEDITOR.tools.addFunction(function(a){if(l.onkey){a=new CKEDITOR.dom.event(a);return l.onkey(l,a.getKeystroke())!==false}}),r=CKEDITOR.tools.addFunction(function(a){var b;l.onfocus&&(b=l.onfocus(l,new CKEDITOR.dom.event(a))!==false);return b}),o=0;l.clickFn=k=CKEDITOR.tools.addFunction(function(){if(o){a.unlockSelection(1);
o=0}l.execute();i.iOS&&a.focus()});if(this.modes){var m={};a.on("beforeModeUnload",function(){if(a.mode&&this._.state!=CKEDITOR.TRISTATE_DISABLED)m[a.mode]=this._.state},this);a.on("activeFilterChange",g,this);a.on("mode",g,this);!this.readOnly&&a.on("readOnly",g,this)}else if(j)if(j=a.getCommand(j)){j.on("state",function(){this.setState(j.state)},this);h=h+(j.state==CKEDITOR.TRISTATE_ON?"on":j.state==CKEDITOR.TRISTATE_DISABLED?"disabled":"off")}if(this.directional)a.on("contentDirChanged",function(b){var c=
CKEDITOR.document.getById(this._.id),d=c.getFirst(),b=b.data;b!=a.lang.dir?c.addClass("cke_"+b):c.removeClass("cke_ltr").removeClass("cke_rtl");d.setAttribute("style",CKEDITOR.skin.getIconStyle(q,b=="rtl",this.icon,this.iconOffset))},this);j||(h=h+"off");var p=this.name||this.command,q=p;if(this.icon&&!/\./.test(this.icon)){q=this.icon;this.icon=null}h={id:d,name:p,iconName:q,label:this.label,cls:this.className||"",state:h,ariaDisabled:h=="disabled"?"true":"false",title:this.title,titleJs:i.gecko&&
!i.hc?"":(this.title||"").replace("'",""),hasArrow:this.hasArrow?"true":"false",keydownFn:n,focusFn:r,clickFn:k,style:CKEDITOR.skin.getIconStyle(q,a.lang.dir=="rtl",this.icon,this.iconOffset),arrowHtml:this.hasArrow?f.output():""};c.output(h,b);if(this.onRender)this.onRender();return l},setState:function(a){if(this._.state==a)return false;this._.state=a;var b=CKEDITOR.document.getById(this._.id);if(b){b.setState(a,"cke_button");a==CKEDITOR.TRISTATE_DISABLED?b.setAttribute("aria-disabled",true):b.removeAttribute("aria-disabled");
...
3));k.setStyle("width",a+10+"px");a=j.element.$.scrollHeight;CKEDITOR.env.ie&&(CKEDITOR.env.quirks&&a>0)&&(a=a+((k.$.offsetHeight||0)-(k.$.clientHeight||0)+3));k.setStyle("height",a+"px");h._.currentBlock.element.setStyle("display","none").removeStyle("display")}else k.removeStyle("height");o&&(m=m-k.$.offsetWidth);k.setStyle("left",m+"px");var b=h.element.getWindow(),a=k.$.getBoundingClientRect(),b=b.getViewPaneSize(),c=a.width||a.right-a.left,e=a.height||a.bottom-a.top,f=o?a.right:b.width-a.left,
g=o?b.width-a.right:a.left;o?f<c&&(m=g>c?m+c:b.width>c?m-a.left:m-a.right+b.width):f<c&&(m=g>c?m-c:b.width>c?m-a.right+b.width:m-a.left);c=a.top;b.height-a.top<e&&(p=c>e?p-e:b.height>e?p-a.bottom+b.height:p-a.top);if(CKEDITOR.env.ie){b=a=new CKEDITOR.dom.element(k.$.offsetParent);b.getName()=="html"&&(b=b.getDocument().getBody());b.getComputedStyle("direction")=="rtl"&&(m=CKEDITOR.env.ie8Compat?m-k.getDocument().getDocumentElement().$.scrollLeft*2:m-(a.$.scrollWidth-a.$.clientWidth))}var a=k.getFirst(),
i;(i=a.getCustomData("activePanel"))&&i.onHide&&i.onHide.call(this,1);a.setCustomData("activePanel",this);k.setStyles({top:p+"px",left:m+"px"});k.setOpacity(1);d&&d()},this);h.isLoaded?a():h.onLoad=a;CKEDITOR.tools.setTimeout(function(){var a=CKEDITOR.env.webkit&&CKEDITOR.document.getWindow().getScrollPosition().y;this.focus();j.element.focus();if(CKEDITOR.env.webkit)CKEDITOR.document.getBody().$.scrollTop=a;this.allowBlur(true);this._.editor.fire("panelShow",this)},0,this)},CKEDITOR.env.air?200:
...
b&&b.getComputedStyle(d=="back"?"background-color":"color")||"transparent";while(d=="back"&&c=="transparent"&&b&&(b=b.getParent()));if(!c||c=="transparent")c="#ffffff";this._.panel._.iframe.getFrameDocument().getById(l).setStyle("background-color",c);return c}}})}function c(c,d,f){var j=[],k=b.colorButton_colors.split(","),l=a.plugins.colordialog&&b.colorButton_enableMore!==false,n=k.length+(l?2:1),r=CKEDITOR.tools.addFunction(function(d,f){function g(a){this.removeListener("ok",g);this.removeListener("cancel",
g);a.name=="ok"&&h(this.getContentElement("picker","selectedColor").getValue(),f)}var h=arguments.callee;if(d=="?")a.openDialog("colordialog",function(){this.on("ok",g);this.on("cancel",g)});else{a.focus();c.hide();a.fire("saveSnapshot");a.removeStyle(new CKEDITOR.style(b["colorButton_"+f+"Style"],{color:"inherit"}));if(d){var j=b["colorButton_"+f+"Style"];j.childRule=f=="back"?function(a){return e(a)}:function(a){return!(a.is("a")||a.getElementsByTag("a").count())||e(a)};a.applyStyle(new CKEDITOR.style(j,
...
for(f=0;f<k.length;f++){f%8===0&&j.push("</tr><tr>");var o=k[f].split("/"),m=o[0],p=o[1]||m;o[1]||(m="#"+m.replace(/^(.)(.)(.)$/,"$1$1$2$2$3$3"));o=a.lang.colorbutton.colors[p]||p;j.push('<td><a class="cke_colorbox" _cke_focus=1 hidefocus=true title="',o,'" onclick="CKEDITOR.tools.callFunction(',r,",'",m,"','",d,"'); return false;\" href=\"javascript:void('",o,'\')" role="option" aria-posinset="',f+2,'" aria-setsize="',n,'"><span class="cke_colorbox" style="background-color:#',p,'"></span></a></td>')}l&&
j.push('</tr><tr><td colspan=8 align=center><a class="cke_colormore" _cke_focus=1 hidefocus=true title="',g.more,'" onclick="CKEDITOR.tools.callFunction(',r,",'?','",d,"');return false;\" href=\"javascript:void('",g.more,"')\"",' role="option" aria-posinset="',n,'" aria-setsize="',n,'">',g.more,"</a></td>");j.push("</tr></table>");return j.join("")}function e(a){return a.getAttribute("contentEditable")=="false"||a.getAttribute("data-nostyle")}var b=a.config,g=a.lang.colorbutton;if(!CKEDITOR.env.hc){f("TextColor",
...
this._.itemClickFn=CKEDITOR.tools.addFunction(function(a){var b=this.items[a];if(b.state==CKEDITOR.TRISTATE_DISABLED)this.hide(1);else if(b.getItems)this._.showSubMenu(a);else this._.onClick(b)},this)}a(f);for(var n=j.elementPath(),n=['<div class="cke_menu'+(n&&n.direction()!=j.lang.dir?" cke_mixed_dir_content":"")+'" role="presentation">'],r=f.length,o=r&&f[0].group,m=0;m<r;m++){var p=f[m];if(o!=p.group){n.push('<div class="cke_menuseparator" role="separator"></div>');o=p.group}p.render(this,m,n)}n.push("</div>");
...
c},proto:{render:function(a,f,i){var d=a.id+(""+f),h=typeof this.state=="undefined"?CKEDITOR.TRISTATE_OFF:this.state,j="",k=h==CKEDITOR.TRISTATE_ON?"on":h==CKEDITOR.TRISTATE_DISABLED?"disabled":"off";this.role in{menuitemcheckbox:1,menuitemradio:1}&&(j=' aria-checked="'+(h==CKEDITOR.TRISTATE_ON?"true":"false")+'"');var l=this.getItems,n="&#"+(this.editor.lang.dir=="rtl"?"9668":"9658")+";",r=this.name;if(this.icon&&!/\./.test(this.icon))r=this.icon;a={id:d,name:this.name,iconName:r,label:this.label,
cls:this.className||"",state:k,hasPopup:l?"true":"false",disabled:h==CKEDITOR.TRISTATE_DISABLED,title:this.label,href:"javascript:void('"+(this.label||"").replace("'")+"')",hoverFn:a._.itemOverFn,moveOutFn:a._.itemOutFn,clickFn:a._.itemClickFn,index:f,iconStyle:CKEDITOR.skin.getIconStyle(r,this.editor.lang.dir=="rtl",r==this.icon?null:this.icon,this.iconOffset),arrowHtml:l?e.output({label:n}):"",role:this.role?this.role:"menuitem",ariaChecked:j};c.output(a,i)}}})}(),CKEDITOR.config.menu_groups="clipboard,form,tablecell,tablecellproperties,tablerow,tablecolumn,table,anchor,link,image,flash,checkbox,radio,textfield,hiddenfield,imagebutton,button,select,textarea,div",
...
1)));f.focus();return false;case 27:e.focus();return false;case 13:case 32:d(a);return false}return true});e.on("selectionChange",function(){for(var a=[],d=l.list=[],f=[],h=l.filters,i=true,v=e.elementPath().elements,x,w=v.length;w--;){var s=v[w],y=0;x=s.data("cke-display-name")?s.data("cke-display-name"):s.data("cke-real-element-type")?s.data("cke-real-element-type"):s.getName();i=s.hasAttribute("contenteditable")?s.getAttribute("contenteditable")=="true":i;!i&&!s.hasAttribute("contenteditable")&&
(y=1);for(var z=0;z<h.length;z++){var B=h[z](s,x);if(B===false){y=1;break}x=B||x}if(!y){d.unshift(s);f.unshift(x)}}d=d.length;for(h=0;h<d;h++){x=f[h];i=e.lang.elementspath.eleTitle.replace(/%1/,x);x=b.output({id:n+h,label:i,text:x,jsTitle:"javascript:void('"+x+"')",index:h,keyDownFn:o,clickFn:r});a.unshift(x)}k||(k=CKEDITOR.document.getById(j));f=k;f.setHtml(a.join("")+c);e.fire("elementsPathUpdate",{space:f})});e.on("readOnly",h);e.on("contentDomUnload",h);e.addCommand("elementsPathFocus",a);e.setKeystroke(CKEDITOR.ALT+
...
b.moveToRange(a);return b}CKEDITOR.plugins.add("enterkey",{init:function(b){b.addCommand("enter",{modes:{wysiwyg:1},editorFocus:false,exec:function(b){a(b)}});b.addCommand("shiftEnter",{modes:{wysiwyg:1},editorFocus:false,exec:function(b){a(b,b.activeShiftEnterMode,1)}});b.setKeystroke([[13,"enter"],[CKEDITOR.SHIFT+13,"shiftEnter"]])}});var e=CKEDITOR.dom.walker.whitespaces(),b=CKEDITOR.dom.walker.bookmark();CKEDITOR.plugins.enterkey={enterBlock:function(a,d,g,n){if(g=g||f(a)){var g=c(g),r=g.document,
o=g.checkStartOfBlock(),m=g.checkEndOfBlock(),p=a.elementPath(g.startContainer),q=p.block,t=d==CKEDITOR.ENTER_DIV?"div":"p",u;if(o&&m){if(q&&(q.is("li")||q.getParent().is("li"))){q.is("li")||(q=q.getParent());g=q.getParent();u=g.getParent();var n=!q.hasPrevious(),v=!q.hasNext(),t=a.getSelection(),x=t.createBookmarks(),o=q.getDirection(1),m=q.getAttribute("class"),w=q.getAttribute("style"),s=u.getDirection(1)!=o,a=a.enterMode!=CKEDITOR.ENTER_BR||s||w||m;if(u.is("li"))if(n||v){n&&v&&g.remove();q[v?
"insertAfter":"insertBefore"](u)}else q.breakParent(u);else{if(a){if(p.block.is("li")){u=r.createElement(d==CKEDITOR.ENTER_P?"p":"div");s&&u.setAttribute("dir",o);w&&u.setAttribute("style",w);m&&u.setAttribute("class",m);q.moveChildren(u)}else u=p.block;if(n||v)u[n?"insertBefore":"insertAfter"](g);else{q.breakParent(g);u.insertAfter(g)}}else{q.appendBogus(true);if(n||v)for(;r=q[n?"getFirst":"getLast"]();)r[n?"insertBefore":"insertAfter"](g);else for(q.breakParent(g);r=q.getLast();)r.insertAfter(g)}q.remove()}t.selectBookmarks(x);
return}if(q&&q.getParent().is("blockquote")){q.breakParent(q.getParent());q.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1))||q.getPrevious().remove();q.getNext().getFirst(CKEDITOR.dom.walker.invisible(1))||q.getNext().remove();g.moveToElementEditStart(q);g.select();return}}else if(q&&q.is("pre")&&!m){i(a,d,g,n);return}if(o=g.splitBlock(t)){d=o.previousBlock;q=o.nextBlock;p=o.wasStartOfBlock;a=o.wasEndOfBlock;if(q){x=q.getParent();if(x.is("li")){q.breakParent(x);q.move(q.getNext(),1)}}else if(d&&
...
g.moveToElementEditStart(q)}else{if(d){if(d.is("li")||!h.test(d.getName())&&!d.is("pre"))u=d.clone()}else q&&(u=q.clone());if(u)n&&!u.is("li")&&u.renameNode(t);else if(x&&x.is("li"))u=x;else{u=r.createElement(t);d&&(v=d.getDirection())&&u.setAttribute("dir",v)}if(r=o.elementPath){n=0;for(t=r.elements.length;n<t;n++){x=r.elements[n];if(x.equals(r.block)||x.equals(r.blockLimit))break;if(CKEDITOR.dtd.$removeEmpty[x.getName()]){x=x.clone();u.moveChildren(x);u.append(x)}}}u.appendBogus();u.getParent()||
g.insertNode(u);u.is("li")&&u.removeAttribute("value");if(CKEDITOR.env.ie&&p&&(!a||!d.getChildCount())){g.moveToElementEditStart(a?d:u);g.select()}g.moveToElementEditStart(p&&!a?q:u)}g.select();g.scrollIntoView()}}},enterBr:function(a,b,c,e){if(c=c||f(a)){var g=c.document,i=c.checkEndOfBlock(),m=new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),p=m.block,q=p&&m.block.getName();if(!e&&q=="li")d(a,b,c,e);else{if(!e&&i&&h.test(q))if(i=p.getDirection()){g=g.createElement("div");g.setAttribute("dir",
i);g.insertAfter(p);c.setStart(g,0)}else{g.createElement("br").insertAfter(p);CKEDITOR.env.gecko&&g.createText("").insertAfter(p);c.setStartAt(p.getNext(),CKEDITOR.env.ie?CKEDITOR.POSITION_BEFORE_START:CKEDITOR.POSITION_AFTER_START)}else{a=q=="pre"&&CKEDITOR.env.ie&&CKEDITOR.env.version<8?g.createText("\r"):g.createElement("br");c.deleteContents();c.insertNode(a);if(CKEDITOR.env.needsBrFiller){g.createText("﻿").insertAfter(a);i&&(p||m.blockLimit).appendBogus();a.getNext().$.nodeValue="";c.setStartAt(a.getNext(),
...
d;i.innerHTML="&"+a.join(";&")+";";d=i.innerHTML;i=null;for(i=0;i<d.length;i++){var h=d.charAt(i);e[h]="&"+a[i]+";";b.push(h)}}e.regex=b.join(c?"|":"");return e}CKEDITOR.plugins.add("entities",{afterInit:function(f){function c(a){return h[a]}function e(a){return b.entities_processNumerical=="force"||!i[a]?"&#"+a.charCodeAt(0)+";":i[a]}var b=f.config;if(f=(f=f.dataProcessor)&&f.htmlFilter){var g=[];b.basicEntities!==false&&g.push("nbsp,gt,lt,amp");if(b.entities){g.length&&g.push("quot,iexcl,cent,pound,curren,yen,brvbar,sect,uml,copy,ordf,laquo,not,shy,reg,macr,deg,plusmn,sup2,sup3,acute,micro,para,middot,cedil,sup1,ordm,raquo,frac14,frac12,frac34,iquest,times,divide,fnof,bull,hellip,prime,Prime,oline,frasl,weierp,image,real,trade,alefsym,larr,uarr,rarr,darr,harr,crarr,lArr,uArr,rArr,dArr,hArr,forall,part,exist,empty,nabla,isin,notin,ni,prod,sum,minus,lowast,radic,prop,infin,ang,and,or,cap,cup,int,there4,sim,cong,asymp,ne,equiv,le,ge,sub,sup,nsub,sube,supe,oplus,otimes,perp,sdot,lceil,rceil,lfloor,rfloor,lang,rang,loz,spades,clubs,hearts,diams,circ,tilde,ensp,emsp,thinsp,zwnj,zwj,lrm,rlm,ndash,mdash,lsquo,rsquo,sbquo,ldquo,rdquo,bdquo,dagger,Dagger,permil,lsaquo,rsaquo,euro");
...
b.entities_additional&&g.push(b.entities_additional)}var i=a(g.join(",")),d=i.regex?"["+i.regex+"]":"a^";delete i.regex;b.entities&&b.entities_processNumerical&&(d="[^ -~]|"+d);var d=RegExp(d,"g"),h=a("nbsp,gt,lt,amp,shy",true),j=RegExp(h.regex,"g");f.addRules({text:function(a){return a.replace(j,c).replace(d,e)}},{applyToAll:true,excludeNestedEditable:true})}}})}(),CKEDITOR.config.basicEntities=!0,CKEDITOR.config.entities=!0,CKEDITOR.config.entities_latin=!0,CKEDITOR.config.entities_greek=!0,CKEDITOR.config.entities_additional=
"#39",CKEDITOR.plugins.add("popup"),CKEDITOR.tools.extend(CKEDITOR.editor.prototype,{popup:function(a,f,c,e){f=f||"80%";c=c||"70%";typeof f=="string"&&(f.length>1&&f.substr(f.length-1,1)=="%")&&(f=parseInt(window.screen.width*parseInt(f,10)/100,10));typeof c=="string"&&(c.length>1&&c.substr(c.length-1,1)=="%")&&(c=parseInt(window.screen.height*parseInt(c,10)/100,10));f<640&&(f=640);c<420&&(c=420);var b=parseInt((window.screen.height-c)/2,10),g=parseInt((window.screen.width-f)/2,10),e=(e||"location=no,menubar=no,toolbar=no,dependent=yes,minimizable=no,modal=yes,alwaysRaised=yes,resizable=yes,scrollbars=yes")+
",width="+f+",height="+c+",top="+b+",left="+g,i=window.open("",null,e,true);if(!i)return false;try{if(navigator.userAgent.toLowerCase().indexOf(" chrome/")==-1){i.moveTo(g,b);i.resizeTo(f,c)}i.focus();i.location.href=a}catch(d){window.open(a,null,e,true)}return true}}),function(){function a(a,b){var c=[];if(b)for(var d in b)c.push(d+"="+encodeURIComponent(b[d]));else return a;return a+(a.indexOf("?")!=-1?"&":"?")+c.join("&")}function f(a){a=a+"";return a.charAt(0).toUpperCase()+a.substr(1)}function c(){var b=
...
this.getDialog();a.getParentEditor()._.filebrowserSe=this;return!a.getContentElement(this["for"][0],this["for"][1]).getInputElement().$.value||!a.getContentElement(this["for"][0],this["for"][1]).getAction()?false:true}function b(b,c,d){var e=d.params||{};e.CKEditor=b.name;e.CKEditorFuncNum=b._.filebrowserFn;if(!e.langCode)e.langCode=b.langCode;c.action=a(d.url,e);c.filebrowser=d}function g(a,d,i,l){if(l&&l.length)for(var n,r=l.length;r--;){n=l[r];(n.type=="hbox"||n.type=="vbox"||n.type=="fieldset")&&
g(a,d,i,n.children);if(n.filebrowser){if(typeof n.filebrowser=="string")n.filebrowser={action:n.type=="fileButton"?"QuickUpload":"Browse",target:n.filebrowser};if(n.filebrowser.action=="Browse"){var o=n.filebrowser.url;if(o===void 0){o=a.config["filebrowser"+f(d)+"BrowseUrl"];if(o===void 0)o=a.config.filebrowserBrowseUrl}if(o){n.onClick=c;n.filebrowser.url=o;n.hidden=false}}else if(n.filebrowser.action=="QuickUpload"&&n["for"]){o=n.filebrowser.url;if(o===void 0){o=a.config["filebrowser"+f(d)+"UploadUrl"];
if(o===void 0)o=a.config.filebrowserUploadUrl}if(o){var m=n.onClick;n.onClick=function(a){var b=a.sender;return m&&m.call(b,a)===false?false:e.call(b,a)};n.filebrowser.url=o;n.hidden=false;b(a,i.getContents(n["for"][0]).get(n["for"][1]),n.filebrowser)}}}}}function i(a,b,c){if(c.indexOf(";")!==-1){for(var c=c.split(";"),d=0;d<c.length;d++)if(i(a,b,c[d]))return true;return false}return(a=a.getContents(b).get(c).filebrowser)&&a.url}function d(a,b){var c=this._.filebrowserSe.getDialog(),d=this._.filebrowserSe["for"],
...
e.exec(b);if(c){if(!c[2]&&f[2]=="px")return f[1];if(c[2]=="px"&&!f[2])return f[1]+"px"}return b}var f=CKEDITOR.htmlParser.cssStyle,c=CKEDITOR.tools.cssLength,e=/^((?:\d*(?:\.\d+))|(?:\d+))(.*)?$/i,b={elements:{$:function(b){var c=b.attributes;if((c=(c=(c=c&&c["data-cke-realelement"])&&new CKEDITOR.htmlParser.fragment.fromHtml(decodeURIComponent(c)))&&c.children[0])&&b.attributes["data-cke-resizable"]){var d=(new f(b)).rules,b=c.attributes,e=d.width,d=d.height;e&&(b.width=a(b.width,e));d&&(b.height=
a(b.height,d))}return c}}};CKEDITOR.plugins.add("fakeobjects",{init:function(a){a.filter.allow("img[!data-cke-realelement,src,alt,title](*){*}","fakeobjects")},afterInit:function(a){(a=(a=a.dataProcessor)&&a.htmlFilter)&&a.addRules(b,{applyToAll:true})}});CKEDITOR.editor.prototype.createFakeElement=function(a,b,d,e){var j=this.lang.fakeobjects,j=j[d]||j.unknown,b={"class":b,"data-cke-realelement":encodeURIComponent(a.getOuterHtml()),"data-cke-real-node-type":a.type,alt:j,title:j,align:a.getAttribute("align")||
""};if(!CKEDITOR.env.hc)b.src=CKEDITOR.tools.transparentImageData;d&&(b["data-cke-real-element-type"]=d);if(e){b["data-cke-resizable"]=e;d=new f;e=a.getAttribute("width");a=a.getAttribute("height");e&&(d.rules.width=c(e));a&&(d.rules.height=c(a));d.populate(b)}return this.document.createElement("img",{attributes:b})};CKEDITOR.editor.prototype.createFakeParserElement=function(a,b,d,e){var j=this.lang.fakeobjects,j=j[d]||j.unknown,k;k=new CKEDITOR.htmlParser.basicWriter;a.writeHtml(k);k=k.getHtml();
b={"class":b,"data-cke-realelement":encodeURIComponent(k),"data-cke-real-node-type":a.type,alt:j,title:j,align:a.attributes.align||""};if(!CKEDITOR.env.hc)b.src=CKEDITOR.tools.transparentImageData;d&&(b["data-cke-real-element-type"]=d);if(e){b["data-cke-resizable"]=e;e=a.attributes;a=new f;d=e.width;e=e.height;d!==void 0&&(a.rules.width=c(d));e!==void 0&&(a.rules.height=c(e));a.populate(b)}return new CKEDITOR.htmlParser.element("img",b)};CKEDITOR.editor.prototype.restoreRealElement=function(b){if(b.data("cke-real-node-type")!=
...
"flash",true)}var c=/\.swf(?:$|\?)/i;CKEDITOR.plugins.add("flash",{requires:"dialog,fakeobjects",onLoad:function(){CKEDITOR.addCss("img.cke_flash{background-image: url("+CKEDITOR.getUrl(this.path+"images/placeholder.png")+");background-position: center center;background-repeat: no-repeat;border: 1px solid #a9a9a9;width: 80px;height: 80px;}")},init:function(a){var b="object[classid,codebase,height,hspace,vspace,width];param[name,value];embed[height,hspace,pluginspage,src,type,vspace,width]";CKEDITOR.dialog.isTabEnabled(a,
...
command:"flash",group:"flash"}});a.on("doubleclick",function(a){var b=a.data.element;if(b.is("img")&&b.data("cke-real-element-type")=="flash")a.data.dialog="flash"});a.contextMenu&&a.contextMenu.addListener(function(a){if(a&&a.is("img")&&!a.isReadOnly()&&a.data("cke-real-element-type")=="flash")return{flash:CKEDITOR.TRISTATE_OFF}})},afterInit:function(c){var b=c.dataProcessor;(b=b&&b.dataFilter)&&b.addRules({elements:{"cke:object":function(b){var i=b.attributes;if((!i.classid||!(""+i.classid).toLowerCase())&&
!a(b)){for(i=0;i<b.children.length;i++)if(b.children[i].name=="cke:embed"){if(!a(b.children[i]))break;return f(c,b)}return null}return f(c,b)},"cke:embed":function(b){return!a(b)?null:f(c,b)}}},5)}})}(),CKEDITOR.tools.extend(CKEDITOR.config,{flashEmbedTagOnly:!1,flashAddEmbedTag:!0,flashConvertOnEdit:!1}),function(){function a(a){var b=a.config,g=a.fire("uiSpace",{space:"top",html:""}).html,i=function(){function d(a,b,e){h.setStyle(b,c(e));h.setStyle("position",a)}function g(a){var b=k.getDocumentPosition();
switch(a){case "top":d("absolute","top",b.y-t-x);break;case "pin":d("fixed","top",s);break;case "bottom":d("absolute","top",b.y+(p.height||p.bottom-p.top)+x)}j=a}var j,k,m,p,q,t,u,v=b.floatSpaceDockedOffsetX||0,x=b.floatSpaceDockedOffsetY||0,w=b.floatSpacePinnedOffsetX||0,s=b.floatSpacePinnedOffsetY||0;return function(b){if(k=a.editable()){b&&b.name=="focus"&&h.show();h.removeStyle("left");h.removeStyle("right");m=h.getClientRect();p=k.getClientRect();q=f.getViewPaneSize();t=m.height;u="pageXOffset"in
f.$?f.$.pageXOffset:CKEDITOR.document.$.documentElement.scrollLeft;if(j){t+x<=p.top?g("top"):t+x>q.height-p.bottom?g("pin"):g("bottom");var b=q.width/2,b=p.left>0&&p.right<q.width&&p.width>m.width?a.config.contentsLangDirection=="rtl"?"right":"left":b-p.left>p.right-b?"left":"right",d;if(m.width>q.width){b="left";d=0}else{d=b=="left"?p.left>0?p.left:0:p.right<q.width?q.width-p.right:0;if(d+m.width>q.width){b=b=="left"?"right":"left";d=0}}h.setStyle(b,c((j=="pin"?w:v)+d+(j=="pin"?0:b=="left"?u:-u)))}else{j=
"pin";g("pin");i(b)}}}}();if(g){var d=new CKEDITOR.template('<div id="cke_{name}" class="cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} '+CKEDITOR.env.cssClass+'" dir="{langDir}" title="'+(CKEDITOR.env.gecko?" ":"")+'" lang="{langCode}" role="application" style="{style}"'+(a.title?' aria-labelledby="cke_{name}_arialbl"':" ")+">"+(a.title?'<span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span>':" ")+'<div class="cke_inner"><div id="{topId}" class="cke_top" role="presentation">{content}</div></div></div>'),
h=CKEDITOR.document.getBody().append(CKEDITOR.dom.element.createFromHtml(d.output({content:g,id:a.id,langDir:a.lang.dir,langCode:a.langCode,name:a.name,style:"display:none;z-index:"+(b.baseFloatZIndex-1),topId:a.ui.spaceId("top"),voiceLabel:a.title}))),j=CKEDITOR.tools.eventsBuffer(500,i),k=CKEDITOR.tools.eventsBuffer(100,i);h.unselectable();h.on("mousedown",function(a){a=a.data;a.getTarget().hasAscendant("a",1)||a.preventDefault()});a.on("focus",function(b){i(b);a.on("change",j.input);f.on("scroll",
k.input);f.on("resize",k.input)});a.on("blur",function(){h.hide();a.removeListener("change",j.input);f.removeListener("scroll",k.input);f.removeListener("resize",k.input)});a.on("destroy",function(){f.removeListener("scroll",k.input);f.removeListener("resize",k.input);h.clearCustomData();h.remove()});a.focusManager.hasFocus&&h.show();a.focusManager.add(h,1)}}var f=CKEDITOR.document.getWindow(),c=CKEDITOR.tools.cssLength;CKEDITOR.plugins.add("floatingspace",{init:function(c){c.on("loaded",function(){a(this)},
null,null,20)}})}(),CKEDITOR.plugins.add("listblock",{requires:"panel",onLoad:function(){var a=CKEDITOR.addTemplate("panel-list",'<ul role="presentation" class="cke_panel_list">{items}</ul>'),f=CKEDITOR.addTemplate("panel-list-item",'<li id="{id}" class="cke_panel_listItem" role=presentation><a id="{id}_option" _cke_focus=1 hidefocus=true title="{title}" href="javascript:void(\'{val}\')"  {onclick}="CKEDITOR.tools.callFunction({clickFn},\'{val}\'); return false;" role="option">{text}</a></li>'),c=
CKEDITOR.addTemplate("panel-list-group",'<h1 id="{id}" class="cke_panel_grouptitle" role="presentation" >{label}</h1>'),e=/\'/g;CKEDITOR.ui.panel.prototype.addListBlock=function(a,c){return this.addBlock(a,new CKEDITOR.ui.listBlock(this.getHolderElement(),c))};CKEDITOR.ui.listBlock=CKEDITOR.tools.createClass({base:CKEDITOR.ui.panel.block,$:function(a,c){var c=c||{},e=c.attributes||(c.attributes={});(this.multiSelect=!!c.multiSelect)&&(e["aria-multiselectable"]=true);!e.role&&(e.role="listbox");this.base.apply(this,
arguments);this.element.setAttribute("role",e.role);e=this.keys;e[40]="next";e[9]="next";e[38]="prev";e[CKEDITOR.SHIFT+9]="prev";e[32]=CKEDITOR.env.ie?"mouseup":"click";CKEDITOR.env.ie&&(e[13]="mouseup");this._.pendingHtml=[];this._.pendingList=[];this._.items={};this._.groups={}},_:{close:function(){if(this._.started){var b=a.output({items:this._.pendingList.join("")});this._.pendingList=[];this._.pendingHtml.push(b);delete this._.started}},getClick:function(){if(!this._.click)this._.click=CKEDITOR.tools.addFunction(function(a){var c=
this.toggle(a);if(this.onClick)this.onClick(a,c)},this);return this._.click}},proto:{add:function(a,c,i){var d=CKEDITOR.tools.getNextId();if(!this._.started){this._.started=1;this._.size=this._.size||0}this._.items[a]=d;var h;h=CKEDITOR.tools.htmlEncodeAttr(a).replace(e,"\\'");a={id:d,val:h,onclick:CKEDITOR.env.ie?'onclick="return false;" onmouseup':"onclick",clickFn:this._.getClick(),title:CKEDITOR.tools.htmlEncodeAttr(i||a),text:c||a};this._.pendingList.push(f.output(a))},startGroup:function(a){this._.close();
...
"none")},showAll:function(){var a=this._.items,c=this._.groups,e=this.element.getDocument(),d;for(d in a)e.getById(a[d]).setStyle("display","");for(var f in c){a=e.getById(c[f]);d=a.getNext();a.setStyle("display","");d&&d.getName()=="ul"&&d.setStyle("display","")}},mark:function(a){this.multiSelect||this.unmarkAll();var a=this._.items[a],c=this.element.getDocument().getById(a);c.addClass("cke_selected");this.element.getDocument().getById(a+"_option").setAttribute("aria-selected",true);this.onMark&&
this.onMark(c)},unmark:function(a){var c=this.element.getDocument(),a=this._.items[a],e=c.getById(a);e.removeClass("cke_selected");c.getById(a+"_option").removeAttribute("aria-selected");this.onUnmark&&this.onUnmark(e)},unmarkAll:function(){var a=this._.items,c=this.element.getDocument(),e;for(e in a){var d=a[e];c.getById(d).removeClass("cke_selected");c.getById(d+"_option").removeAttribute("aria-selected")}this.onUnmark&&this.onUnmark()},isMarked:function(a){return this.element.getDocument().getById(this._.items[a]).hasClass("cke_selected")},
...
editorFocus:1});a=this.panel||{};delete this.panel;this.id=CKEDITOR.tools.getNextNumber();this.document=a.parent&&a.parent.getDocument()||CKEDITOR.document;a.className="cke_combopanel";a.block={multiSelect:a.multiSelect,attributes:a.attributes};a.toolbarRelated=true;this._={panelDefinition:a,items:{}}},proto:{renderHtml:function(a){var e=[];this.render(a,e);return e.join("")},render:function(a,e){function b(){if(this.getState()!=CKEDITOR.TRISTATE_ON){var b=this.modes[a.mode]?CKEDITOR.TRISTATE_OFF:
CKEDITOR.TRISTATE_DISABLED;if(a.readOnly&&!this.readOnly)b=CKEDITOR.TRISTATE_DISABLED;this.setState(b);this.setValue("");b!=CKEDITOR.TRISTATE_DISABLED&&this.refresh&&this.refresh()}}var g=CKEDITOR.env,i="cke_"+this.id,d=CKEDITOR.tools.addFunction(function(b){if(n){a.unlockSelection(1);n=0}j.execute(b)},this),h=this,j={id:i,combo:this,focus:function(){CKEDITOR.document.getById(i).getChild(1).focus()},execute:function(b){var d=h._;if(d.state!=CKEDITOR.TRISTATE_DISABLED){h.createPanel(a);if(d.on)d.panel.hide();
else{h.commit();var e=h.getValue();e?d.list.mark(e):d.list.unmarkAll();d.panel.showBlock(h.id,new CKEDITOR.dom.element(b),4)}}},clickFn:d};a.on("activeFilterChange",b,this);a.on("mode",b,this);a.on("selectionChange",b,this);!this.readOnly&&a.on("readOnly",b,this);var k=CKEDITOR.tools.addFunction(function(b,e){var b=new CKEDITOR.dom.event(b),f=b.getKeystroke();if(f==40)a.once("panelShow",function(a){a.data._.panel._.currentBlock.onKeyDown(40)});switch(f){case 13:case 32:case 40:CKEDITOR.tools.callFunction(d,
e);break;default:j.onkey(j,f)}b.preventDefault()}),l=CKEDITOR.tools.addFunction(function(){j.onfocus&&j.onfocus()}),n=0;j.keyDownFn=k;g={id:i,name:this.name||this.command,label:this.label,title:this.title,cls:this.className||"",titleJs:g.gecko&&!g.hc?"":(this.title||"").replace("'",""),keydownFn:k,focusFn:l,clickFn:d};f.output(g,e);if(this.onRender)this.onRender();return j},createPanel:function(a){if(!this._.panel){var e=this._.panelDefinition,b=this._.panelDefinition.block,f=e.parent||CKEDITOR.document.getBody(),
i="cke_combopanel__"+this.name,d=new CKEDITOR.ui.floatPanel(a,f,e),h=d.addListBlock(this.id,b),j=this;d.onShow=function(){this.element.addClass(i);j.setState(CKEDITOR.TRISTATE_ON);j._.on=1;j.editorFocus&&!a.focusManager.hasFocus&&a.focus();if(j.onOpen)j.onOpen();a.once("panelShow",function(){h.focus(!h.multiSelect&&j.getValue())})};d.onHide=function(b){this.element.removeClass(i);j.setState(j.modes&&j.modes[a.mode]?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);j._.on=0;if(!b&&j.onClose)j.onClose()};
d.onEscape=function(){d.hide(1)};h.onClick=function(a,b){j.onClick&&j.onClick.call(j,a,b);d.hide()};this._.panel=d;this._.list=h;d.getBlock(this.id).onHide=function(){j._.on=0;j.setState(CKEDITOR.TRISTATE_OFF)};this.init&&this.init()}},setValue:function(a,e){this._.value=a;var b=this.document.getById("cke_"+this.id+"_text");if(b){if(!a&&!e){e=this.label;b.addClass("cke_combo_inlinelabel")}else b.removeClass("cke_combo_inlinelabel");b.setText(typeof e!="undefined"?e:a)}},getValue:function(){return this._.value||
...
CKEDITOR.ui.prototype.addRichCombo=function(a,e){this.add(a,CKEDITOR.UI_RICHCOMBO,e)}}(),function(){function a(a,e,b,g,i,d,h,j){for(var k=a.config,l=new CKEDITOR.style(h),n=i.split(";"),i=[],r={},o=0;o<n.length;o++){var m=n[o];if(m){var m=m.split("/"),p={},q=n[o]=m[0];p[b]=i[o]=m[1]||q;r[q]=new CKEDITOR.style(h,p);r[q]._.definition.name=q}else n.splice(o--,1)}a.ui.addRichCombo(e,{label:g.label,title:g.panelTitle,toolbar:"styles,"+j,allowedContent:l,requiredContent:l,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(k.contentsCss),
multiSelect:false,attributes:{"aria-label":g.panelTitle}},init:function(){this.startGroup(g.panelTitle);for(var a=0;a<n.length;a++){var b=n[a];this.add(b,r[b].buildPreview(),b)}},onClick:function(b){a.focus();a.fire("saveSnapshot");var d=this.getValue(),e=r[b];if(d&&b!=d){var g=r[d],h=a.getSelection().getRanges()[0];if(h.collapsed){var j=a.elementPath(),i=j.contains(function(a){return g.checkElementRemovable(a)});if(i){var k=h.checkBoundaryOfElement(i,CKEDITOR.START),q=h.checkBoundaryOfElement(i,
CKEDITOR.END);if(k&&q){for(k=h.createBookmark();j=i.getFirst();)j.insertBefore(i);i.remove();h.moveToBookmark(k)}else if(k)h.moveToPosition(i,CKEDITOR.POSITION_BEFORE_START);else if(q)h.moveToPosition(i,CKEDITOR.POSITION_AFTER_END);else{h.splitElement(i);h.moveToPosition(i,CKEDITOR.POSITION_AFTER_END);f(h,j.elements.slice(),i)}a.getSelection().selectRanges([h])}}else a.removeStyle(g)}a[d==b?"removeStyle":"applyStyle"](e);a.fire("saveSnapshot")},onRender:function(){a.on("selectionChange",function(b){for(var e=
this.getValue(),b=b.data.path.elements,f=0,g;f<b.length;f++){g=b[f];for(var h in r)if(r[h].checkElementMatch(g,true,a)){h!=e&&this.setValue(h);return}}this.setValue("",d)},this)},refresh:function(){a.activeFilter.check(l)||this.setState(CKEDITOR.TRISTATE_DISABLED)}})}function f(a,e,b){var g=e.pop();if(g){if(b)return f(a,e,g.equals(b)?null:b);b=g.clone();a.insertNode(b);a.moveToPosition(b,CKEDITOR.POSITION_AFTER_START);f(a,e)}}CKEDITOR.plugins.add("font",{requires:"richcombo",init:function(c){var e=
c.config;a(c,"Font","family",c.lang.font,e.font_names,e.font_defaultLabel,e.font_style,30);a(c,"FontSize","size",c.lang.font.fontSize,e.fontSize_sizes,e.fontSize_defaultLabel,e.fontSize_style,40)}})}(),CKEDITOR.config.font_names="Arial/Arial, Helvetica, sans-serif;Comic Sans MS/Comic Sans MS, cursive;Courier New/Courier New, Courier, monospace;Georgia/Georgia, serif;Lucida Sans Unicode/Lucida Sans Unicode, Lucida Grande, sans-serif;Tahoma/Tahoma, Geneva, sans-serif;Times New Roman/Times New Roman, Times, serif;Trebuchet MS/Trebuchet MS, Helvetica, sans-serif;Verdana/Verdana, Geneva, sans-serif",
...
function(){function a(a){function b(f){for(var h=r.startContainer,o=r.endContainer;h&&!h.getParent().equals(f);)h=h.getParent();for(;o&&!o.getParent().equals(f);)o=o.getParent();if(!h||!o)return false;for(var m=h,h=[],n=false;!n;){m.equals(o)&&(n=true);h.push(m);m=m.getNext()}if(h.length<1)return false;m=f.getParents(true);for(o=0;o<m.length;o++)if(m[o].getName&&i[m[o].getName()]){f=m[o];break}for(var m=e.isIndent?1:-1,o=h[0],h=h[h.length-1],n=CKEDITOR.plugins.list.listToArray(f,g),x=n[h.getCustomData("listarray_index")].indent,
o=o.getCustomData("listarray_index");o<=h.getCustomData("listarray_index");o++){n[o].indent=n[o].indent+m;if(m>0){var w=n[o].parent;n[o].parent=new CKEDITOR.dom.element(w.getName(),w.getDocument())}}for(o=h.getCustomData("listarray_index")+1;o<n.length&&n[o].indent>x;o++)n[o].indent=n[o].indent+m;h=CKEDITOR.plugins.list.arrayToList(n,g,null,a.config.enterMode,f.getDirection());if(!e.isIndent){var s;if((s=f.getParent())&&s.is("li"))for(var m=h.listNode.getChildren(),y=[],z,o=m.count()-1;o>=0;o--)(z=
m.getItem(o))&&(z.is&&z.is("li"))&&y.push(z)}h&&h.listNode.replace(f);if(y&&y.length)for(o=0;o<y.length;o++){for(z=f=y[o];(z=z.getNext())&&z.is&&z.getName()in i;){CKEDITOR.env.needsNbspFiller&&!f.getFirst(c)&&f.append(r.document.createText(" "));f.append(z)}f.insertAfter(s)}h&&a.fire("contentDomInvalidated");return true}for(var e=this,g=this.database,i=this.context,n=a.getSelection(),n=(n&&n.getRanges()).createIterator(),r;r=n.getNextRange();){for(var o=r.getCommonAncestor();o&&!(o.type==CKEDITOR.NODE_ELEMENT&&
i[o.getName()]);){if(a.editable().equals(o)){o=false;break}o=o.getParent()}o||(o=r.startPath().contains(i))&&r.setEndAt(o,CKEDITOR.POSITION_BEFORE_END);if(!o){var m=r.getEnclosedNode();if(m&&m.type==CKEDITOR.NODE_ELEMENT&&m.getName()in i){r.setStartAt(m,CKEDITOR.POSITION_AFTER_START);r.setEndAt(m,CKEDITOR.POSITION_BEFORE_END);o=m}}if(o&&r.startContainer.type==CKEDITOR.NODE_ELEMENT&&r.startContainer.getName()in i){m=new CKEDITOR.dom.walker(r);m.evaluator=f;r.startContainer=m.next()}if(o&&r.endContainer.type==
CKEDITOR.NODE_ELEMENT&&r.endContainer.getName()in i){m=new CKEDITOR.dom.walker(r);m.evaluator=f;r.endContainer=m.previous()}if(o)return b(o)}return 0}function f(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.is("li")}function c(a){return e(a)&&b(a)}var e=CKEDITOR.dom.walker.whitespaces(true),b=CKEDITOR.dom.walker.bookmark(false,true),g=CKEDITOR.TRISTATE_DISABLED,i=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentlist",{requires:"indent",init:function(b){function c(b){e.specificDefinition.apply(this,
arguments);this.requiredContent=["ul","ol"];b.on("key",function(a){if(b.mode=="wysiwyg"&&a.data.keyCode==this.indentKey){var c=this.getContext(b.elementPath());if(c&&(!this.isIndent||!CKEDITOR.plugins.indentList.firstItemInPath(this.context,b.elementPath(),c))){b.execCommand(this.relatedGlobal);a.cancel()}}},this);this.jobs[this.isIndent?10:30]={refresh:this.isIndent?function(a,b){var c=this.getContext(b),d=CKEDITOR.plugins.indentList.firstItemInPath(this.context,b,c);return!c||!this.isIndent||d?
g:i}:function(a,b){return!this.getContext(b)||this.isIndent?g:i},exec:CKEDITOR.tools.bind(a,this)}}var e=CKEDITOR.plugins.indent;e.registerCommands(b,{indentlist:new c(b,"indentlist",true),outdentlist:new c(b,"outdentlist")});CKEDITOR.tools.extend(c.prototype,e.specificDefinition.prototype,{context:{ol:1,ul:1}})}});CKEDITOR.plugins.indentList={};CKEDITOR.plugins.indentList.firstItemInPath=function(a,b,c){var e=b.contains(f);c||(c=b.contains(a));return c&&e&&e.equals(c.getFirst(f))}}(),function(){function a(a,
b,c){if(!a.getCustomData("indent_processed")){var e=this.editor,g=this.isIndent;if(b){e=a.$.className.match(this.classNameRegex);c=0;if(e){e=e[1];c=CKEDITOR.tools.indexOf(b,e)+1}if((c=c+(g?1:-1))<0)return;c=Math.min(c,b.length);c=Math.max(c,0);a.$.className=CKEDITOR.tools.ltrim(a.$.className.replace(this.classNameRegex,""));c>0&&a.addClass(b[c-1])}else{var b=f(a,c),c=parseInt(a.getStyle(b),10),l=e.config.indentOffset||40;isNaN(c)&&(c=0);c=c+(g?1:-1)*l;if(c<0)return;c=Math.max(c,0);c=Math.ceil(c/l)*
l;a.setStyle(b,c?c+(e.config.indentUnit||"px"):"");a.getAttribute("style")===""&&a.removeAttribute("style")}CKEDITOR.dom.element.setMarker(this.database,a,"indent_processed",1)}}function f(a,b){return(b||a.getComputedStyle("direction"))=="ltr"?"margin-left":"margin-right"}var c=CKEDITOR.dtd.$listItem,e=CKEDITOR.dtd.$list,b=CKEDITOR.TRISTATE_DISABLED,g=CKEDITOR.TRISTATE_OFF;CKEDITOR.plugins.add("indentblock",{requires:"indent",init:function(i){function d(){h.specificDefinition.apply(this,arguments);
this.allowedContent={"div h1 h2 h3 h4 h5 h6 ol p pre ul":{propertiesOnly:true,styles:!j?"margin-left,margin-right":null,classes:j||null}};if(this.enterBr)this.allowedContent.div=true;this.requiredContent=(this.enterBr?"div":"p")+(j?"("+j.join(",")+")":"{margin-left}");this.jobs={20:{refresh:function(a,d){var e=d.block||d.blockLimit;e.is(c)||(e=e.getAscendant(c)||e);e.is(c)&&(e=e.getParent());if(!this.enterBr&&!this.getContext(d))return b;if(j){var h;h=j;var e=e.$.className.match(this.classNameRegex),
i=this.isIndent;h=e?i?e[1]!=h.slice(-1):true:i;return h?g:b}return this.isIndent?g:e?CKEDITOR[(parseInt(e.getStyle(f(e)),10)||0)<=0?"TRISTATE_DISABLED":"TRISTATE_OFF"]:b},exec:function(b){var c=b.getSelection(),c=c&&c.getRanges()[0],d;if(d=b.elementPath().contains(e))a.call(this,d,j);else{c=c.createIterator();b=b.config.enterMode;c.enforceRealBlocks=true;for(c.enlargeBr=b!=CKEDITOR.ENTER_BR;d=c.getNextParagraph(b==CKEDITOR.ENTER_P?"p":"div");)d.isReadOnly()||a.call(this,d,j)}return true}}}}var h=
CKEDITOR.plugins.indent,j=i.config.indentClasses;h.registerCommands(i,{indentblock:new d(i,"indentblock",true),outdentblock:new d(i,"outdentblock")});CKEDITOR.tools.extend(d.prototype,h.specificDefinition.prototype,{context:{div:1,dl:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,ul:1,ol:1,p:1,pre:1,table:1},classNameRegex:j?RegExp("(?:^|\\s+)("+j.join("|")+")(?=$|\\s)"):null})}})}(),function(){function a(a,b){var b=b===void 0||b,c;if(b)c=a.getComputedStyle("text-align");else{for(;!a.hasAttribute||!a.hasAttribute("align")&&
!a.getStyle("text-align");){c=a.getParent();if(!c)break;a=c}c=a.getStyle("text-align")||a.getAttribute("align")||""}c&&(c=c.replace(/(?:-(?:moz|webkit)-)?(?:start|auto)/i,""));!c&&b&&(c=a.getComputedStyle("direction")=="rtl"?"right":"left");return c}function f(a,b,c){this.editor=a;this.name=b;this.value=c;this.context="p";var b=a.config.justifyClasses,f=a.config.enterMode==CKEDITOR.ENTER_P?"p":"div";if(b){switch(c){case "left":this.cssClassName=b[0];break;case "center":this.cssClassName=b[1];break;
case "right":this.cssClassName=b[2];break;case "justify":this.cssClassName=b[3]}this.cssClassRegex=RegExp("(?:^|\\s+)(?:"+b.join("|")+")(?=$|\\s)");this.requiredContent=f+"("+this.cssClassName+")"}else this.requiredContent=f+"{text-align}";this.allowedContent={"caption div h1 h2 h3 h4 h5 h6 p pre td th li":{propertiesOnly:true,styles:this.cssClassName?null:"text-align",classes:this.cssClassName||null}};if(a.config.enterMode==CKEDITOR.ENTER_BR)this.allowedContent.div=true}function c(a){var b=a.editor,
c=b.createRange();c.setStartBefore(a.data.node);c.setEndAfter(a.data.node);for(var f=new CKEDITOR.dom.walker(c),d;d=f.next();)if(d.type==CKEDITOR.NODE_ELEMENT)if(!d.equals(a.data.node)&&d.getDirection()){c.setStartAfter(d);f=new CKEDITOR.dom.walker(c)}else{var h=b.config.justifyClasses;if(h)if(d.hasClass(h[0])){d.removeClass(h[0]);d.addClass(h[2])}else if(d.hasClass(h[2])){d.removeClass(h[2]);d.addClass(h[0])}h=d.getStyle("text-align");h=="left"?d.setStyle("text-align","right"):h=="right"&&d.setStyle("text-align",
"left")}}f.prototype={exec:function(c){var b=c.getSelection(),f=c.config.enterMode;if(b){for(var i=b.createBookmarks(),d=b.getRanges(),h=this.cssClassName,j,k,l=c.config.useComputedState,l=l===void 0||l,n=d.length-1;n>=0;n--){j=d[n].createIterator();for(j.enlargeBr=f!=CKEDITOR.ENTER_BR;k=j.getNextParagraph(f==CKEDITOR.ENTER_P?"p":"div");)if(!k.isReadOnly()){k.removeAttribute("align");k.removeStyle("text-align");var r=h&&(k.$.className=CKEDITOR.tools.ltrim(k.$.className.replace(this.cssClassRegex,
""))),o=this.state==CKEDITOR.TRISTATE_OFF&&(!l||a(k,true)!=this.value);h?o?k.addClass(h):r||k.removeAttribute("class"):o&&k.setStyle("text-align",this.value)}}c.focus();c.forceNextSelectionCheck();b.selectBookmarks(i)}},refresh:function(c,b){var f=b.block||b.blockLimit;this.setState(f.getName()!="body"&&a(f,this.editor.config.useComputedState)==this.value?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF)}};CKEDITOR.plugins.add("justify",{init:function(a){if(!a.blockless){var b=new f(a,"justifyleft","left"),
g=new f(a,"justifycenter","center"),i=new f(a,"justifyright","right"),d=new f(a,"justifyblock","justify");a.addCommand("justifyleft",b);a.addCommand("justifycenter",g);a.addCommand("justifyright",i);a.addCommand("justifyblock",d);if(a.ui.addButton){a.ui.addButton("JustifyLeft",{label:a.lang.justify.left,command:"justifyleft",toolbar:"align,10"});a.ui.addButton("JustifyCenter",{label:a.lang.justify.center,command:"justifycenter",toolbar:"align,20"});a.ui.addButton("JustifyRight",{label:a.lang.justify.right,
command:"justifyright",toolbar:"align,30"});a.ui.addButton("JustifyBlock",{label:a.lang.justify.block,command:"justifyblock",toolbar:"align,40"})}a.on("dirChanged",c)}}})}(),"use strict",function(){function a(a){return a.replace(/'/g,"\\$&")}function f(a){for(var b,c=a.length,d=[],e=0;e<c;e++){b=a.charCodeAt(e);d.push(b)}return"String.fromCharCode("+d.join(",")+")"}function c(b,c){var d=b.plugins.link,e=d.compiledProtectionFunction.params,f,g;g=[d.compiledProtectionFunction.name,"("];for(var h=0;h<
e.length;h++){d=e[h].toLowerCase();f=c[d];h>0&&g.push(",");g.push("'",f?a(encodeURIComponent(c[d])):"","'")}g.push(")");return g.join("")}function e(a){var a=a.config.emailProtection||"",b;if(a&&a!="encode"){b={};a.replace(/^([^(]+)\(([^)]+)\)$/,function(a,c,d){b.name=c;b.params=[];d.replace(/[^,\s]+/g,function(a){b.params.push(a)})})}return b}CKEDITOR.plugins.add("link",{requires:"dialog,fakeobjects",onLoad:function(){function a(b){return c.replace(/%1/g,b=="rtl"?"right":"left").replace(/%2/g,"cke_contents_"+
b)}var b="background:url("+CKEDITOR.getUrl(this.path+"images"+(CKEDITOR.env.hidpi?"/hidpi":"")+"/anchor.png")+") no-repeat %1 center;border:1px dotted #00f;background-size:16px;",c=".%2 a.cke_anchor,.%2 a.cke_anchor_empty,.cke_editable.%2 a[name],.cke_editable.%2 a[data-cke-saved-name]{"+b+"padding-%1:18px;cursor:auto;}.%2 img.cke_anchor{"+b+"width:16px;min-height:15px;height:1.15em;vertical-align:text-bottom;}";CKEDITOR.addCss(a("ltr")+a("rtl"))},init:function(a){var b="a[!href]";CKEDITOR.dialog.isTabEnabled(a,
...
(!b.getAttribute("href")||!b.getChildCount())))return"anchor"})}});var b=/^javascript:/,g=/^mailto:([^?]+)(?:\?(.+))?$/,i=/subject=([^;?:@&=$,\/]*)/,d=/body=([^;?:@&=$,\/]*)/,h=/^#(.*)$/,j=/^((?:http|https|ftp|news):\/\/)?(.*)$/,k=/^(_(?:self|top|parent|blank))$/,l=/^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/,n=/^javascript:([^(]+)\(([^)]+)\)$/,r=/\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/,
...
b){if(b&&b.data("cke-real-element-type")&&b.data("cke-real-element-type")=="anchor"){var c=a.restoreRealElement(b);if(c.data("cke-saved-name"))return c}},parseLinkAttributes:function(a,c){var e=c&&(c.data("cke-saved-href")||c.getAttribute("href"))||"",f=a.plugins.link.compiledProtectionFunction,v=a.config.emailProtection,x,w={};e.match(b)&&(v=="encode"?e=e.replace(l,function(a,b,c){return"mailto:"+String.fromCharCode.apply(String,b.split(","))+(c&&c.replace(/\\'/g,"'"))}):v&&e.replace(n,function(a,
...
(x=e.match(j))){w.type="url";w.url={};w.url.protocol=x[1];w.url.url=x[2]}if(c){if(e=c.getAttribute("target"))w.target={type:e.match(k)?e:"frame",name:e};else if(e=(e=c.data("cke-pa-onclick")||c.getAttribute("onclick"))&&e.match(r))for(w.target={type:"popup",name:e[1]};v=o.exec(e[2]);)(v[2]=="yes"||v[2]=="1")&&!(v[1]in{height:1,width:1,top:1,left:1})?w.target[v[1]]=true:isFinite(v[2])&&(w.target[v[1]]=v[2]);var e={},y;for(y in m)(v=c.getAttribute(y))&&(e[m[y]]=v);if(y=c.data("cke-saved-name")||e.advName)e.advName=
...
""),k=encodeURIComponent(i.body||""),i=[];j&&i.push("subject="+j);k&&i.push("body="+k);i=i.length?"?"+i.join("&"):"";if(e=="encode"){e=["javascript:void(location.href='mailto:'+",f(h)];i&&e.push("+'",a(i),"'");e.push(")")}else e=["mailto:",h,i];break;default:e=h.split("@",2);i.name=e[0];i.domain=e[1];e=["javascript:",c(b,i)]}g["data-cke-saved-href"]=e.join("")}if(d.target)if(d.target.type=="popup"){for(var e=["window.open(this.href, '",d.target.name||"","', '"],o=["resizable","status","location",
"toolbar","menubar","fullscreen","scrollbars","dependent"],h=o.length,j=function(a){d.target[a]&&o.push(a+"="+d.target[a])},i=0;i<h;i++)o[i]=o[i]+(d.target[o[i]]?"=yes":"=no");j("width");j("left");j("height");j("top");e.push(o.join(","),"'); return false;");g["data-cke-pa-onclick"]=e.join("")}else if(d.target.type!="notSet"&&d.target.name)g.target=d.target.name;if(d.advanced){for(var l in m)(e=d.advanced[m[l]])&&(g[l]=e);if(g.name)g["data-cke-saved-name"]=g.name}if(g["data-cke-saved-href"])g.href=
...
CKEDITOR.plugins.list.arrayToList(e,c,null,a.config.enterMode,b.root.getAttribute("dir")).listNode,j,k;d(true);d();i.replace(b.root);a.fire("contentDomInvalidated")}function f(a,b){this.name=a;this.context=this.type=b;this.allowedContent=b+" li";this.requiredContent=b}function c(a,b,c,d){for(var e,f;e=a[d?"getLast":"getFirst"](r);){(f=e.getDirection(1))!==b.getDirection(1)&&e.setAttribute("dir",f);e.remove();c?e[d?"insertBefore":"insertAfter"](c):b.append(e,d)}}function e(a){function b(d){var e=a[d?
"getPrevious":"getNext"](k);if(e&&e.type==CKEDITOR.NODE_ELEMENT&&e.is(a.getName())){c(a,e,null,!d);a.remove();a=e}}b();b(1)}function b(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.getName()in CKEDITOR.dtd.$block||a.getName()in CKEDITOR.dtd.$listItem)&&CKEDITOR.dtd[a.getName()]["#"]}function g(a,b,d){a.fire("saveSnapshot");d.enlarge(CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS);var f=d.extractContents();b.trim(false,true);var g=b.createBookmark(),h=new CKEDITOR.dom.elementPath(b.startContainer),j=h.block,h=
h.lastElement.getAscendant("li",1)||j,n=new CKEDITOR.dom.elementPath(d.startContainer),r=n.contains(CKEDITOR.dtd.$listItem),n=n.contains(CKEDITOR.dtd.$list);if(j)(j=j.getBogus())&&j.remove();else if(n)(j=n.getPrevious(k))&&l(j)&&j.remove();(j=f.getLast())&&(j.type==CKEDITOR.NODE_ELEMENT&&j.is("br"))&&j.remove();(j=b.startContainer.getChild(b.startOffset))?f.insertBefore(j):b.startContainer.append(f);if(r)if(f=i(r))if(h.contains(r)){c(f,r.getParent(),r);f.remove()}else h.append(f);for(;d.checkStartOfBlock()&&
d.checkEndOfBlock();){n=d.startPath();f=n.block;if(!f)break;if(f.is("li")){h=f.getParent();f.equals(h.getLast(k))&&f.equals(h.getFirst(k))&&(f=h)}d.moveToPosition(f,CKEDITOR.POSITION_BEFORE_START);f.remove()}d=d.clone();f=a.editable();d.setEndAt(f,CKEDITOR.POSITION_BEFORE_END);d=new CKEDITOR.dom.walker(d);d.evaluator=function(a){return k(a)&&!l(a)};(d=d.next())&&(d.type==CKEDITOR.NODE_ELEMENT&&d.getName()in CKEDITOR.dtd.$list)&&e(d);b.moveToBookmark(g);b.select();a.fire("saveSnapshot")}function i(a){return(a=
...
b,c,e,f){c||(c=0);if(!a||a.length<c+1)return null;for(var g,h=a[c].parent.getDocument(),i=new CKEDITOR.dom.documentFragment(h),l=null,n=c,r=Math.max(a[c].indent,0),z=null,B,A,F=e==CKEDITOR.ENTER_P?"p":"div";;){var C=a[n];g=C.grandparent;B=C.element.getDirection(1);if(C.indent==r){if(!l||a[n].parent.getName()!=l.getName()){l=a[n].parent.clone(false,1);f&&l.setAttribute("dir",f);i.append(l)}z=l.append(C.element.clone(0,1));B!=l.getDirection(1)&&z.setAttribute("dir",B);for(g=0;g<C.contents.length;g++)z.append(C.contents[g].clone(1,
1));n++}else if(C.indent==Math.max(r,0)+1){C=a[n-1].element.getDirection(1);n=CKEDITOR.plugins.list.arrayToList(a,null,n,e,C!=B?B:null);!z.getChildCount()&&(CKEDITOR.env.needsNbspFiller&&h.$.documentMode<=7)&&z.append(h.createText(" "));z.append(n.listNode);n=n.nextIndex}else if(C.indent==-1&&!c&&g){if(d[g.getName()]){z=C.element.clone(false,true);B!=g.getDirection(1)&&z.setAttribute("dir",B)}else z=new CKEDITOR.dom.documentFragment(h);var l=g.getDirection(1)!=B,J=C.element,G=J.getAttribute("class"),
E=J.getAttribute("style"),D=z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&(e!=CKEDITOR.ENTER_BR||l||E||G),I,L=C.contents.length,H;for(g=0;g<L;g++){I=C.contents[g];if(j(I)&&L>1)D?H=I.clone(1,1):z.append(I.clone(1,1));else if(I.type==CKEDITOR.NODE_ELEMENT&&I.isBlockBoundary()){l&&!I.getDirection()&&I.setAttribute("dir",B);A=I;var Q=J.getAttribute("style");Q&&A.setAttribute("style",Q.replace(/([^;])$/,"$1;")+(A.getAttribute("style")||""));G&&I.addClass(G);A=null;if(H){z.append(H);H=null}z.append(I.clone(1,
1))}else if(D){if(!A){A=h.createElement(F);z.append(A);l&&A.setAttribute("dir",B)}E&&A.setAttribute("style",E);G&&A.setAttribute("class",G);if(H){A.append(H);H=null}A.append(I.clone(1,1))}else z.append(I.clone(1,1))}if(H){(A||z).append(H);H=null}if(z.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&n!=a.length-1){if(CKEDITOR.env.needsBrFiller)(B=z.getLast())&&(B.type==CKEDITOR.NODE_ELEMENT&&B.is("br"))&&B.remove();B=z.getLast(k);(!B||!(B.type==CKEDITOR.NODE_ELEMENT&&B.is(CKEDITOR.dtd.$block)))&&z.append(h.createElement("br"))}B=
z.$.nodeName.toLowerCase();(B=="div"||B=="p")&&z.appendBogus();i.append(z);l=null;n++}else return null;A=null;if(a.length<=n||Math.max(a[n].indent,0)<r)break}if(b)for(a=i.getFirst();a;){if(a.type==CKEDITOR.NODE_ELEMENT){CKEDITOR.dom.element.clearMarkers(b,a);if(a.getName()in CKEDITOR.dtd.$listItem){c=a;h=f=e=void 0;if(e=c.getDirection()){for(f=c.getParent();f&&!(h=f.getDirection());)f=f.getParent();e==h&&c.removeAttribute("dir")}}}a=a.getNextSourceNode()}return{listNode:i,nextIndex:n}}};var n=/^h[1-6]$/,
...
f.createBookmarks(true),h=[],j={},g=g.createIterator(),l=0;(i=g.getNextRange())&&++l;){var r=i.getBoundaryNodes(),s=r.startNode,y=r.endNode;s.type==CKEDITOR.NODE_ELEMENT&&s.getName()=="td"&&i.setStartAt(r.startNode,CKEDITOR.POSITION_AFTER_START);y.type==CKEDITOR.NODE_ELEMENT&&y.getName()=="td"&&i.setEndAt(r.endNode,CKEDITOR.POSITION_BEFORE_END);i=i.createIterator();for(i.forceBrBreak=this.state==CKEDITOR.TRISTATE_OFF;r=i.getNextParagraph();)if(!r.getCustomData("list_block")){CKEDITOR.dom.element.setMarker(j,
r,"list_block",1);for(var z=b.elementPath(r),s=z.elements,y=0,z=z.blockLimit,B,A=s.length-1;A>=0&&(B=s[A]);A--)if(d[B.getName()]&&z.contains(B)){z.removeCustomData("list_group_object_"+l);if(s=B.getCustomData("list_group_object"))s.contents.push(r);else{s={root:B,contents:[r]};h.push(s);CKEDITOR.dom.element.setMarker(j,B,"list_group_object",s)}y=1;break}if(!y){y=z;if(y.getCustomData("list_group_object_"+l))y.getCustomData("list_group_object_"+l).contents.push(r);else{s={root:y,contents:[r]};CKEDITOR.dom.element.setMarker(j,
y,"list_group_object_"+l,s);h.push(s)}}}}for(B=[];h.length>0;){s=h.shift();if(this.state==CKEDITOR.TRISTATE_OFF)if(d[s.root.getName()]){g=b;l=s;s=j;i=B;y=CKEDITOR.plugins.list.listToArray(l.root,s);z=[];for(r=0;r<l.contents.length;r++){A=l.contents[r];if((A=A.getAscendant("li",true))&&!A.getCustomData("list_item_processed")){z.push(A);CKEDITOR.dom.element.setMarker(s,A,"list_item_processed",true)}}for(var A=l.root.getDocument(),F=void 0,C=void 0,r=0;r<z.length;r++){var J=z[r].getCustomData("listarray_index"),
F=y[J].parent;if(!F.is(this.type)){C=A.createElement(this.type);F.copyAttributes(C,{start:1,type:1});C.removeStyle("list-style-type");y[J].parent=C}}s=CKEDITOR.plugins.list.arrayToList(y,s,null,g.config.enterMode);y=void 0;z=s.listNode.getChildCount();for(r=0;r<z&&(y=s.listNode.getChild(r));r++)y.getName()==this.type&&i.push(y);s.listNode.replace(l.root);g.fire("contentDomInvalidated")}else{y=b;r=s;i=B;z=r.contents;g=r.root.getDocument();l=[];if(z.length==1&&z[0].equals(r.root)){s=g.createElement("div");
z[0].moveChildren&&z[0].moveChildren(s);z[0].append(s);z[0]=s}r=r.contents[0].getParent();for(A=0;A<z.length;A++)r=r.getCommonAncestor(z[A].getParent());F=y.config.useComputedState;y=s=void 0;F=F===void 0||F;for(A=0;A<z.length;A++)for(C=z[A];J=C.getParent();){if(J.equals(r)){l.push(C);!y&&C.getDirection()&&(y=1);C=C.getDirection(F);s!==null&&(s=s&&s!=C?null:C);break}C=J}if(!(l.length<1)){z=l[l.length-1].getNext();A=g.createElement(this.type);i.push(A);for(F=i=void 0;l.length;){i=l.shift();F=g.createElement("li");
if(i.is("pre")||n.test(i.getName())||i.getAttribute("contenteditable")=="false")i.appendTo(F);else{i.copyAttributes(F);if(s&&i.getDirection()){F.removeStyle("direction");F.removeAttribute("dir")}i.moveChildren(F);i.remove()}F.appendTo(A)}s&&y&&A.setAttribute("dir",s);z?A.insertBefore(z):A.appendTo(r)}}else this.state==CKEDITOR.TRISTATE_ON&&d[s.root.getName()]&&a.call(this,b,s,j)}for(A=0;A<B.length;A++)e(B[A]);CKEDITOR.dom.element.clearAllMarkers(j);f.selectBookmarks(c);b.focus()},refresh:function(a,
...
a.ui.addButton("BulletedList",{label:a.lang.list.bulletedlist,command:"bulletedlist",directional:true,toolbar:"list,20"})}a.on("key",function(c){var e=c.data.domEvent.getKey(),f;if(a.mode=="wysiwyg"&&e in{8:1,46:1}){var h=a.getSelection().getRanges()[0],j=h&&h.startPath();if(h&&h.collapsed){var r=e==8,n=a.editable(),w=new CKEDITOR.dom.walker(h.clone());w.evaluator=function(a){return k(a)&&!l(a)};w.guard=function(a,b){return!(b&&a.type==CKEDITOR.NODE_ELEMENT&&a.is("table"))};e=h.clone();if(r){var s;
if((s=j.contains(d))&&h.checkBoundaryOfElement(s,CKEDITOR.START)&&(s=s.getParent())&&s.is("li")&&(s=i(s))){f=s;s=s.getPrevious(k);e.moveToPosition(s&&l(s)?s:f,CKEDITOR.POSITION_BEFORE_START)}else{w.range.setStartAt(n,CKEDITOR.POSITION_AFTER_START);w.range.setEnd(h.startContainer,h.startOffset);if((s=w.previous())&&s.type==CKEDITOR.NODE_ELEMENT&&(s.getName()in d||s.is("li"))){if(!s.is("li")){w.range.selectNodeContents(s);w.reset();w.evaluator=b;s=w.previous()}f=s;e.moveToElementEditEnd(f)}}if(f){g(a,
e,h);c.cancel()}else if((e=j.contains(d))&&h.checkBoundaryOfElement(e,CKEDITOR.START)){f=e.getFirst(k);if(h.checkBoundaryOfElement(f,CKEDITOR.START)){s=e.getPrevious(k);if(i(f)){if(s){h.moveToElementEditEnd(s);h.select()}}else a.execCommand("outdent");c.cancel()}}}else if(f=j.contains("li")){w.range.setEndAt(n,CKEDITOR.POSITION_BEFORE_END);f=(j=f.getLast(k))&&b(j)?j:f;n=0;if((s=w.next())&&s.type==CKEDITOR.NODE_ELEMENT&&s.getName()in d&&s.equals(j)){n=1;s=w.next()}else h.checkBoundaryOfElement(f,CKEDITOR.END)&&
(n=1);if(n&&s){h=h.clone();h.moveToElementEditStart(s);g(a,e,h);c.cancel()}}else{w.range.setEndAt(n,CKEDITOR.POSITION_BEFORE_END);if((s=w.next())&&s.type==CKEDITOR.NODE_ELEMENT&&s.is(d)){s=s.getFirst(k);if(j.block&&h.checkStartOfBlock()&&h.checkEndOfBlock()){j.block.remove();h.moveToElementEditStart(s);h.select()}else if(i(s)){h.moveToElementEditStart(s);h.select()}else{h=h.clone();h.moveToElementEditStart(s);g(a,e,h)}c.cancel()}}setTimeout(function(){a.selectionChange(1)})}}})}}})}(),function(){CKEDITOR.plugins.liststyle=
...
CKEDITOR.plugins.add("liststyle",CKEDITOR.plugins.liststyle)}(),"use strict",function(){function a(a,b,c){return k(b)&&k(c)&&c.equals(b.getNext(function(a){return!(Y(a)||Z(a)||l(a))}))}function f(a){this.upper=a[0];this.lower=a[1];this.set.apply(this,a.slice(2))}function c(a){var b=a.element;if(b&&k(b))if((b=b.getAscendant(a.triggers,true))&&a.editable.contains(b)){var c=g(b);if(c.getAttribute("contenteditable")=="true")return b;if(c.is(a.triggers))return c}return null}function e(a,b,c){u(a,b);u(a,
c);a=b.size.bottom;c=c.size.top;return a&&c?0|(a+c)/2:a||c}function b(a,b,c){return b=b[c?"getPrevious":"getNext"](function(b){return b&&b.type==CKEDITOR.NODE_TEXT&&!Y(b)||k(b)&&!l(b)&&!j(a,b)})}function g(a,b){if(a.data("cke-editable"))return null;for(b||(a=a.getParent());a;){if(a.data("cke-editable"))break;if(a.hasAttribute("contenteditable"))return a;a=a.getParent()}return null}function i(a){var b=a.doc,c=z('<span contenteditable="false" style="'+P+"position:absolute;border-top:1px dashed "+a.boxColor+
'"></span>',b),e=CKEDITOR.getUrl(this.path+"images/"+(B.hidpi?"hidpi/":"")+"icon"+(a.rtl?"-rtl":"")+".png");s(c,{attach:function(){this.wrap.getParent()||this.wrap.appendTo(a.editable,true);return this},lineChildren:[s(z('<span title="'+a.editor.lang.magicline.title+'" contenteditable="false">&#8629;</span>',b),{base:P+"height:17px;width:17px;"+(a.rtl?"left":"right")+":17px;background:url("+e+") center no-repeat "+a.boxColor+";cursor:pointer;"+(B.hc?"font-size: 15px;line-height:14px;border:1px solid #fff;text-align:center;":
"")+(B.hidpi?"background-size: 9px 10px;":""),looks:["top:-8px;"+CKEDITOR.tools.cssVendorPrefix("border-radius","2px",1),"top:-17px;"+CKEDITOR.tools.cssVendorPrefix("border-radius","2px 2px 0px 0px",1),"top:-1px;"+CKEDITOR.tools.cssVendorPrefix("border-radius","0px 0px 2px 2px",1)]}),s(z(W,b),{base:V+"left:0px;border-left-color:"+a.boxColor+";",looks:["border-width:8px 0 8px 8px;top:-8px","border-width:8px 0 0 8px;top:-8px","border-width:0 0 8px 8px;top:0px"]}),s(z(W,b),{base:V+"right:0px;border-right-color:"+
...
e.size.margin.bottom-f.size.margin.top;else if(e){if(!f)i.top=e.size.bottom+e.size.margin.bottom}else i.top=f.size.top-f.size.margin.top;if(d.is(L)||i.top>b.scroll.y-15&&i.top<b.scroll.y+5){i.top=a.inInlineMode?0:b.scroll.y;this.look(L)}else if(d.is(H)||i.top>b.pane.bottom-5&&i.top<b.pane.bottom+15){i.top=a.inInlineMode?b.editable.height+b.editable.padding.top+b.editable.padding.bottom:b.pane.bottom-1;this.look(H)}else{if(a.inInlineMode)i.top=i.top-(b.editable.top+b.editable.border.top);this.look(Q)}if(a.inInlineMode){i.top--;
i.top=i.top+b.editable.scroll.top;i.left=i.left+b.editable.scroll.left}for(var j in i)i[j]=CKEDITOR.tools.cssLength(i[j]);this.setStyles(i)},look:function(a){if(this.oldLook!=a){for(var b=this.lineChildren.length,c;b--;)(c=this.lineChildren[b]).setAttribute("style",c.base+c.looks[0|a/2]);this.oldLook=a}},wrap:new y("span",a.doc)});for(b=c.lineChildren.length;b--;)c.lineChildren[b].appendTo(c);c.look(Q);c.appendTo(c.wrap);c.unselectable();c.lineChildren[0].on("mouseup",function(b){c.detach();d(a,function(b){var c=
a.line.trigger;b[c.is(J)?"insertBefore":"insertAfter"](c.is(J)?c.lower:c.upper)},true);a.editor.focus();!B.ie&&a.enterMode!=CKEDITOR.ENTER_BR&&a.hotNode.scrollIntoView();b.data.preventDefault(true)});c.on("mousedown",function(a){a.data.preventDefault(true)});a.line=c}function d(a,b,c){var d=new CKEDITOR.dom.range(a.doc),e=a.editor,f;if(B.ie&&a.enterMode==CKEDITOR.ENTER_BR)f=a.doc.createText(O);else{f=(f=g(a.element,true))&&f.data("cke-enter-mode")||a.enterMode;f=new y(C[f],a.doc);f.is("br")||a.doc.createText(O).appendTo(f)}c&&
e.fire("saveSnapshot");b(f);d.moveToPosition(f,CKEDITOR.POSITION_AFTER_START);e.getSelection().selectRanges([d]);a.hotNode=f;c&&e.fire("saveSnapshot")}function h(a,e){return{canUndo:true,modes:{wysiwyg:1},exec:function(){function f(b){var c=B.ie&&B.version<9?" ":O,g=a.hotNode&&a.hotNode.getText()==c&&a.element.equals(a.hotNode)&&a.lastCmdDirection===!!e;d(a,function(c){g&&a.hotNode&&a.hotNode.remove();c[e?"insertAfter":"insertBefore"](b);c.setAttributes({"data-cke-magicline-hot":1,"data-cke-magicline-dir":!!e});
a.lastCmdDirection=!!e});!B.ie&&a.enterMode!=CKEDITOR.ENTER_BR&&a.hotNode.scrollIntoView();a.line.detach()}return function(d){var d=d.getSelection().getStartElement(),h,d=d.getAscendant(N,1);if(!o(a,d)&&d&&!d.equals(a.editable)&&!d.contains(a.editable)){if((h=g(d))&&h.getAttribute("contenteditable")=="false")d=h;a.element=d;h=b(a,d,!e);var i;if(k(h)&&h.is(a.triggers)&&h.is(R)&&(!b(a,h,!e)||(i=b(a,h,!e))&&k(i)&&i.is(a.triggers)))f(h);else{i=c(a,d);if(k(i))if(b(a,i,!e))(d=b(a,i,!e))&&(k(d)&&d.is(a.triggers))&&
f(i);else f(i)}}}}()}}function j(a,b){if(!b||!(b.type==CKEDITOR.NODE_ELEMENT&&b.$))return false;var c=a.line;return c.wrap.equals(b)||c.wrap.contains(b)}function k(a){return a&&a.type==CKEDITOR.NODE_ELEMENT&&a.$}function l(a){if(!k(a))return false;var b;if(!(b=n(a)))if(k(a)){b={left:1,right:1,center:1};b=!(!b[a.getComputedStyle("float")]&&!b[a.getAttribute("align")])}else b=false;return b}function n(a){return!!{absolute:1,fixed:1}[a.getComputedStyle("position")]}function r(a,b){return k(b)?b.is(a.triggers):
null}function o(a,b){if(!b)return false;for(var c=b.getParents(1),d=c.length;d--;)for(var e=a.tabuList.length;e--;)if(c[d].hasAttribute(a.tabuList[e]))return true;return false}function m(a,b,c){b=b[c?"getLast":"getFirst"](function(b){return a.isRelevant(b)&&!b.is(K)});if(!b)return false;u(a,b);return c?b.size.top>a.mouse.y:b.size.bottom<a.mouse.y}function p(a){var b=a.editable,c=a.mouse,d=a.view,e=a.triggerOffset;v(a);var g=c.y>(a.inInlineMode?d.editable.top+d.editable.height/2:Math.min(d.editable.height,
d.pane.height)/2),b=b[g?"getLast":"getFirst"](function(a){return!(Y(a)||Z(a))});if(!b)return null;j(a,b)&&(b=a.line.wrap[g?"getPrevious":"getNext"](function(a){return!(Y(a)||Z(a))}));if(!k(b)||l(b)||!r(a,b))return null;u(a,b);if(!g&&b.size.top>=0&&c.y>0&&c.y<b.size.top+e){a=a.inInlineMode||d.scroll.y===0?L:Q;return new f([null,b,J,D,a])}if(g&&b.size.bottom<=d.pane.height&&c.y>b.size.bottom-e&&c.y<d.pane.height){a=a.inInlineMode||b.size.bottom>d.pane.height-e&&b.size.bottom<d.pane.height?H:Q;return new f([b,
null,G,D,a])}return null}function q(a){var d=a.mouse,e=a.view,g=a.triggerOffset,h=c(a);if(!h)return null;u(a,h);var g=Math.min(g,0|h.size.outerHeight/2),i=[],j,o;if(d.y>h.size.top-1&&d.y<h.size.top+g)o=false;else if(d.y>h.size.bottom-g&&d.y<h.size.bottom+1)o=true;else return null;if(l(h)||m(a,h,o)||h.getParent().is(M))return null;var q=b(a,h,!o);if(q){if(q&&q.type==CKEDITOR.NODE_TEXT)return null;if(k(q)){if(l(q)||!r(a,q)||q.getParent().is(M))return null;i=[q,h][o?"reverse":"concat"]().concat([E,D])}}else{if(h.equals(a.editable[o?
"getLast":"getFirst"](a.isRelevant))){v(a);o&&d.y>h.size.bottom-g&&d.y<e.pane.height&&h.size.bottom>e.pane.height-g&&h.size.bottom<e.pane.height?j=H:d.y>0&&d.y<h.size.top+g&&(j=L)}else j=Q;i=[null,h][o?"reverse":"concat"]().concat([o?G:J,D,j,h.equals(a.editable[o?"getLast":"getFirst"](a.isRelevant))?o?H:L:Q])}return 0 in i?new f(i):null}function t(a,b,c,d){for(var e=function(){var c=B.ie?b.$.currentStyle:a.win.$.getComputedStyle(b.$,"");return B.ie?function(a){return c[CKEDITOR.tools.cssStyleToDomStyle(a)]}:
...
j.top+j.outerHeight;j.right=j.left+j.outerWidth;if(a.inInlineMode)j.scroll={top:b.$.scrollTop,left:b.$.scrollLeft};return s({border:g,padding:i,margin:h,ignoreScroll:c},j,true)}function u(a,b,c){if(!k(b))return b.size=null;if(b.size){if(b.size.ignoreScroll==c&&b.size.date>new Date-T)return null}else b.size={};return s(b.size,t(a,b,c),{date:+new Date},true)}function v(a,b){a.view.editable=t(a,a.editable,b,true)}function x(a,b){if(!a.view)a.view={};var c=a.view;if(b||!(c&&c.date>new Date-T)){var d=
a.win,c=d.getScrollPosition(),d=d.getViewPaneSize();s(a.view,{scroll:{x:c.x,y:c.y,width:a.doc.$.documentElement.scrollWidth-d.width,height:a.doc.$.documentElement.scrollHeight-d.height},pane:{width:d.width,height:d.height,bottom:d.height+c.y},date:+new Date},true)}}function w(a,b,c,d){for(var e=d,g=d,h=0,i=false,j=false,k=a.view.pane.height,o=a.mouse;o.y+h<k&&o.y-h>0;){i||(i=b(e,d));j||(j=b(g,d));!i&&o.y-h>0&&(e=c(a,{x:o.x,y:o.y-h}));!j&&o.y+h<k&&(g=c(a,{x:o.x,y:o.y+h}));if(i&&j)break;h=h+2}return new f([e,
g,null,null])}CKEDITOR.plugins.add("magicline",{init:function(a){var e=a.config,g=e.magicline_triggerOffset||30,m={editor:a,enterMode:e.enterMode,triggerOffset:g,holdDistance:0|g*(e.magicline_holdDistance||0.5),boxColor:e.magicline_color||"#ff0000",rtl:e.contentsLangDirection=="rtl",tabuList:["data-cke-hidden-sel"].concat(e.magicline_tabuList||[]),triggers:e.magicline_everywhere?N:{table:1,hr:1,div:1,ul:1,ol:1,dl:1,form:1,blockquote:1}},r,u,w;m.isRelevant=function(a){return k(a)&&!j(m,a)&&!l(a)};
a.on("contentDom",function(){var g=a.editable(),k=a.document,l=a.window;s(m,{editable:g,inInlineMode:g.isInline(),doc:k,win:l,hotNode:null},true);m.boundary=m.inInlineMode?m.editable:m.doc.getDocumentElement();if(!g.is(F.$inline)){m.inInlineMode&&!n(g)&&g.setStyles({position:"relative",top:null,left:null});i.call(this,m);x(m);g.attachListener(a,"beforeUndoImage",function(){m.line.detach()});g.attachListener(a,"beforeGetData",function(){if(m.line.wrap.getParent()){m.line.detach();a.once("getData",
function(){m.line.attach()},null,null,1E3)}},null,null,0);g.attachListener(m.inInlineMode?k:k.getWindow().getFrame(),"mouseout",function(b){if(a.mode=="wysiwyg")if(m.inInlineMode){var c=b.data.$.clientX,b=b.data.$.clientY;x(m);v(m,true);var d=m.view.editable,e=m.view.scroll;if(!(c>d.left-e.x&&c<d.right-e.x)||!(b>d.top-e.y&&b<d.bottom-e.y)){clearTimeout(w);w=null;m.line.detach()}}else{clearTimeout(w);w=null;m.line.detach()}});g.attachListener(g,"keyup",function(){m.hiddenMode=0});g.attachListener(g,
"keydown",function(b){if(a.mode=="wysiwyg")switch(b.data.getKeystroke()){case 2228240:case 16:m.hiddenMode=1;m.line.detach()}});g.attachListener(m.inInlineMode?g:k,"mousemove",function(b){u=true;if(!(a.mode!="wysiwyg"||a.readOnly||w)){var c={x:b.data.$.clientX,y:b.data.$.clientY};w=setTimeout(function(){m.mouse=c;w=m.trigger=null;x(m);if(u&&!m.hiddenMode&&a.focusManager.hasFocus&&!m.line.mouseNear()&&(m.element=S(m,true))){if((m.trigger=p(m)||q(m)||ba(m))&&!o(m,m.trigger.upper||m.trigger.lower))m.line.attach().place();
else{m.trigger=null;m.line.detach()}u=false}},30)}});g.attachListener(l,"scroll",function(){if(a.mode=="wysiwyg"){m.line.detach();if(B.webkit){m.hiddenMode=1;clearTimeout(r);r=setTimeout(function(){if(!m.mouseDown)m.hiddenMode=0},50)}}});g.attachListener(A?k:l,"mousedown",function(){if(a.mode=="wysiwyg"){m.line.detach();m.hiddenMode=1;m.mouseDown=1}});g.attachListener(A?k:l,"mouseup",function(){m.hiddenMode=0;m.mouseDown=0});a.addCommand("accessPreviousSpace",h(m));a.addCommand("accessNextSpace",
h(m,true));a.setKeystroke([[e.magicline_keystrokePrevious,"accessPreviousSpace"],[e.magicline_keystrokeNext,"accessNextSpace"]]);a.on("loadSnapshot",function(){var b,c,d,e;for(e in{p:1,br:1,div:1}){b=a.document.getElementsByTag(e);for(d=b.count();d--;)if((c=b.getItem(d)).data("cke-magicline-hot")){m.hotNode=c;m.lastCmdDirection=c.data("cke-magicline-dir")==="true"?true:false;return}}});this.backdoor={accessFocusSpace:d,boxTrigger:f,isLine:j,getAscendantTrigger:c,getNonEmptyNeighbour:b,getSize:t,that:m,
triggerEdge:q,triggerEditable:p,triggerExpand:ba}}},this)}});var s=CKEDITOR.tools.extend,y=CKEDITOR.dom.element,z=y.createFromHtml,B=CKEDITOR.env,A=CKEDITOR.env.ie&&CKEDITOR.env.version<9,F=CKEDITOR.dtd,C={},J=128,G=64,E=32,D=16,I=8,L=4,H=2,Q=1,O=" ",M=F.$listItem,K=F.$tableContent,R=s({},F.$nonEditable,F.$empty),N=F.$block,T=100,P="width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;",V=P+"border-color:transparent;display:block;border-style:solid;",
W="<span>"+O+"</span>";C[CKEDITOR.ENTER_BR]="br";C[CKEDITOR.ENTER_P]="p";C[CKEDITOR.ENTER_DIV]="div";f.prototype={set:function(a,b,c){this.properties=a+b+(c||Q);return this},is:function(a){return(this.properties&a)==a}};var S=function(){function a(b,c){var d=b.$.elementFromPoint(c.x,c.y);return d&&d.nodeType?new CKEDITOR.dom.element(d):null}return function(b,c,d){if(!b.mouse)return null;var e=b.doc,f=b.line.wrap,d=d||b.mouse,g=a(e,d);if(c&&j(b,g)){f.hide();g=a(e,d);f.show()}return!g||!(g.type==CKEDITOR.NODE_ELEMENT&&
g.$)||B.ie&&B.version<9&&!b.boundary.equals(g)&&!b.boundary.contains(g)?null:g}}(),Y=CKEDITOR.dom.walker.whitespaces(),Z=CKEDITOR.dom.walker.nodeType(CKEDITOR.NODE_COMMENT),ba=function(){function b(d){var f=d.element,g,h,i;if(!k(f)||f.contains(d.editable)||f.isReadOnly())return null;i=w(d,function(a,b){return!b.equals(a)},function(a,b){return S(a,true,b)},f);g=i.upper;h=i.lower;if(a(d,g,h))return i.set(E,I);if(g&&f.contains(g))for(;!g.getParent().equals(f);)g=g.getParent();else g=f.getFirst(function(a){return c(d,
a)});if(h&&f.contains(h))for(;!h.getParent().equals(f);)h=h.getParent();else h=f.getLast(function(a){return c(d,a)});if(!g||!h)return null;u(d,g);u(d,h);if(!(d.mouse.y>g.size.top&&d.mouse.y<h.size.bottom))return null;for(var f=Number.MAX_VALUE,j,o,m,q;h&&!h.equals(g);){if(!(o=g.getNext(d.isRelevant)))break;j=Math.abs(e(d,g,o)-d.mouse.y);if(j<f){f=j;m=g;q=o}g=o;u(d,g)}if(!m||!q||!(d.mouse.y>m.size.top&&d.mouse.y<q.size.bottom))return null;i.upper=m;i.lower=q;return i.set(E,I)}function c(a,b){return!(b&&
b.type==CKEDITOR.NODE_TEXT||Z(b)||l(b)||j(a,b)||b.type==CKEDITOR.NODE_ELEMENT&&b.$&&b.is("br"))}return function(c){var d=b(c),e;if(e=d){e=d.upper;var f=d.lower;e=!e||!f||l(f)||l(e)||f.equals(e)||e.equals(f)||f.contains(e)||e.contains(f)?false:r(c,e)&&r(c,f)&&a(c,e,f)?true:false}return e?d:null}}(),X=["top","left","right","bottom"]}(),CKEDITOR.config.magicline_keystrokePrevious=CKEDITOR.CTRL+CKEDITOR.SHIFT+51,CKEDITOR.config.magicline_keystrokeNext=CKEDITOR.CTRL+CKEDITOR.SHIFT+52,function(){function a(a){if(!a||
a.type!=CKEDITOR.NODE_ELEMENT||a.getName()!="form")return[];for(var b=[],c=["style","className"],e=0;e<c.length;e++){var f=a.$.elements.namedItem(c[e]);if(f){f=new CKEDITOR.dom.element(f);b.push([f,f.nextSibling]);f.remove()}}return b}function f(a,b){if(a&&!(a.type!=CKEDITOR.NODE_ELEMENT||a.getName()!="form")&&b.length>0)for(var c=b.length-1;c>=0;c--){var e=b[c][0],f=b[c][1];f?e.insertBefore(f):e.appendTo(a)}}function c(b,c){var d=a(b),e={},j=b.$;if(!c){e["class"]=j.className||"";j.className=""}e.inline=
j.style.cssText||"";if(!c)j.style.cssText="position: static; overflow: visible";f(d);return e}function e(b,c){var d=a(b),e=b.$;if("class"in c)e.className=c["class"];if("inline"in c)e.style.cssText=c.inline;f(d)}function b(a){if(!a.editable().isInline()){var b=CKEDITOR.instances,c;for(c in b){var e=b[c];if(e.mode=="wysiwyg"&&!e.readOnly){e=e.document.getBody();e.setAttribute("contentEditable",false);e.setAttribute("contentEditable",true)}}if(a.editable().hasFocus){a.toolbox.focus();a.focus()}}}CKEDITOR.plugins.add("maximize",
{init:function(a){function f(){var b=j.getViewPaneSize();a.resize(b.width,b.height,null,true)}if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){var d=a.lang,h=CKEDITOR.document,j=h.getWindow(),k,l,n,r=CKEDITOR.TRISTATE_OFF;a.addCommand("maximize",{modes:{wysiwyg:!CKEDITOR.env.iOS,source:!CKEDITOR.env.iOS},readOnly:1,editorFocus:false,exec:function(){var o=a.container.getFirst(function(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasClass("cke_inner")}),m=a.ui.space("contents");if(a.mode=="wysiwyg"){var p=
a.getSelection();k=p&&p.getRanges();l=j.getScrollPosition()}else{var q=a.editable().$;k=!CKEDITOR.env.ie&&[q.selectionStart,q.selectionEnd];l=[q.scrollLeft,q.scrollTop]}if(this.state==CKEDITOR.TRISTATE_OFF){j.on("resize",f);n=j.getScrollPosition();for(p=a.container;p=p.getParent();){p.setCustomData("maximize_saved_styles",c(p));p.setStyle("z-index",a.config.baseFloatZIndex-5)}m.setCustomData("maximize_saved_styles",c(m,true));o.setCustomData("maximize_saved_styles",c(o,true));m={overflow:CKEDITOR.env.webkit?
"":"hidden",width:0,height:0};h.getDocumentElement().setStyles(m);!CKEDITOR.env.gecko&&h.getDocumentElement().setStyle("position","fixed");(!CKEDITOR.env.gecko||!CKEDITOR.env.quirks)&&h.getBody().setStyles(m);CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(0,0)},0):j.$.scrollTo(0,0);o.setStyle("position",CKEDITOR.env.gecko&&CKEDITOR.env.quirks?"fixed":"absolute");o.$.offsetLeft;o.setStyles({"z-index":a.config.baseFloatZIndex-5,left:"0px",top:"0px"});o.addClass("cke_maximized");f();m=o.getDocumentPosition();
o.setStyles({left:-1*m.x+"px",top:-1*m.y+"px"});CKEDITOR.env.gecko&&b(a)}else if(this.state==CKEDITOR.TRISTATE_ON){j.removeListener("resize",f);m=[m,o];for(p=0;p<m.length;p++){e(m[p],m[p].getCustomData("maximize_saved_styles"));m[p].removeCustomData("maximize_saved_styles")}for(p=a.container;p=p.getParent();){e(p,p.getCustomData("maximize_saved_styles"));p.removeCustomData("maximize_saved_styles")}CKEDITOR.env.ie?setTimeout(function(){j.$.scrollTo(n.x,n.y)},0):j.$.scrollTo(n.x,n.y);o.removeClass("cke_maximized");
if(CKEDITOR.env.webkit){o.setStyle("display","inline");setTimeout(function(){o.setStyle("display","block")},0)}a.fire("resize")}this.toggleState();if(p=this.uiItems[0]){m=this.state==CKEDITOR.TRISTATE_OFF?d.maximize.maximize:d.maximize.minimize;p=CKEDITOR.document.getById(p._.id);p.getChild(1).setHtml(m);p.setAttribute("title",m);p.setAttribute("href",'javascript:void("'+m+'");')}if(a.mode=="wysiwyg")if(k){CKEDITOR.env.gecko&&b(a);a.getSelection().selectRanges(k);(q=a.getSelection().getStartElement())&&
q.scrollIntoView(true)}else j.$.scrollTo(l.x,l.y);else{if(k){q.selectionStart=k[0];q.selectionEnd=k[1]}q.scrollLeft=l[0];q.scrollTop=l[1]}k=l=null;r=this.state;a.fire("maximize",this.state)},canUndo:false});a.ui.addButton&&a.ui.addButton("Maximize",{label:d.maximize.maximize,command:"maximize",toolbar:"tools,10"});a.on("mode",function(){var b=a.getCommand("maximize");b.setState(b.state==CKEDITOR.TRISTATE_DISABLED?CKEDITOR.TRISTATE_DISABLED:r)},null,null,100)}}})}(),CKEDITOR.plugins.add("newpage",
{init:function(a){a.addCommand("newpage",{modes:{wysiwyg:1,source:1},exec:function(a){var c=this;a.setData(a.config.newpage_html||"",function(){a.focus();setTimeout(function(){a.fire("afterCommandExec",{name:"newpage",command:c});a.selectionChange()},200)})},async:true});a.ui.addButton&&a.ui.addButton("NewPage",{label:a.lang.newpage.toolbar,command:"newpage",toolbar:"document,20"})}}),"use strict",function(){function a(a){return{"aria-label":a,"class":"cke_pagebreak",contenteditable:"false","data-cke-display-name":"pagebreak",
...
i=/display\s*:\s*none/i;e&&e.addRules({attributes:{"class":function(a,b){var c=a.replace("cke_pagebreak","");if(c!=a){var e=CKEDITOR.htmlParser.fragment.fromHtml('<span style="display: none;">&nbsp;</span>').children[0];b.children.length=0;b.add(e);e=b.attributes;delete e["aria-label"];delete e.contenteditable;delete e.title}return c}}},{applyToAll:true,priority:5});b&&b.addRules({elements:{div:function(a){if(a.attributes["data-cke-pagebreak"])c(a);else if(g.test(a.attributes.style)){var b=a.children[0];
b&&(b.name=="span"&&i.test(b.attributes.style))&&c(a)}}}})}});CKEDITOR.plugins.pagebreakCmd={exec:function(f){var c=f.document.createElement("div",{attributes:a(f.lang.pagebreak.alt)});f.insertElement(c)},context:"div",allowedContent:{div:{styles:"!page-break-after"},span:{match:function(a){return(a=a.parent)&&a.name=="div"&&a.styles&&a.styles["page-break-after"]},styles:"display"}},requiredContent:"div{page-break-after}"}}(),function(){function a(a,e,b){var f=CKEDITOR.cleanWord;if(f)b();else{a=CKEDITOR.getUrl(a.config.pasteFromWordCleanupFile||
e+"filter/default.js");CKEDITOR.scriptLoader.load(a,b,null,true)}return!f}function f(a){a.data.type="html"}CKEDITOR.plugins.add("pastefromword",{requires:"clipboard",init:function(c){var e=0,b=this.path;c.addCommand("pastefromword",{canUndo:false,async:true,exec:function(a){var b=this;e=1;a.once("beforePaste",f);a.getClipboardData({title:a.lang.pastefromword.title},function(c){c&&a.fire("paste",{type:"html",dataValue:c.dataValue});a.fire("afterCommandExec",{name:"pastefromword",command:b,returnValue:!!c})})}});
c.ui.addButton&&c.ui.addButton("PasteFromWord",{label:c.lang.pastefromword.toolbar,command:"pastefromword",toolbar:"clipboard,50"});c.on("pasteState",function(a){c.getCommand("pastefromword").setState(a.data)});c.on("paste",function(f){var i=f.data,d=i.dataValue;if(d&&(e||/(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(d))){var h=a(c,b,function(){if(h)c.fire("paste",i);else if(!c.config.pasteFromWordPromptCleanup||e||confirm(c.lang.pastefromword.confirmCleanup))i.dataValue=CKEDITOR.cleanWord(d,
...
if(f.config.forcePasteAsPlainText)f.on("beforePaste",function(a){if(a.data.type!="html")a.data.type="text"});f.on("pasteState",function(a){f.getCommand("pastetext").setState(a.data)})}})}(),function(){var a,f={modes:{wysiwyg:1,source:1},canUndo:false,readOnly:1,exec:function(c){var e,b=c.config,f=b.baseHref?'<base href="'+b.baseHref+'"/>':"";if(b.fullPage)e=c.getData().replace(/<head>/,"$&"+f).replace(/[^>]*(?=<\/title>)/,"$& &mdash; "+c.lang.preview.preview);else{var b="<body ",i=c.document&&c.document.getBody();
if(i){i.getAttribute("id")&&(b=b+('id="'+i.getAttribute("id")+'" '));i.getAttribute("class")&&(b=b+('class="'+i.getAttribute("class")+'" '))}e=c.config.docType+'<html dir="'+c.config.contentsLangDirection+'"><head>'+f+"<title>"+c.lang.preview.preview+"</title>"+CKEDITOR.tools.buildStyleHtml(c.config.contentsCss)+"</head>"+(b+">")+c.getData()+"</body></html>"}f=640;b=420;i=80;try{var d=window.screen,f=Math.round(d.width*0.8),b=Math.round(d.height*0.7),i=Math.round(d.width*0.1)}catch(h){}if(c.fire("contentPreview",
c={dataValue:e})===false)return false;var d="",j;if(CKEDITOR.env.ie){window._cke_htmlToLoad=c.dataValue;j="javascript:void( (function(){document.open();"+("("+CKEDITOR.tools.fixDomain+")();").replace(/\/\/.*?\n/g,"").replace(/parent\./g,"window.opener.")+"document.write( window.opener._cke_htmlToLoad );document.close();window.opener._cke_htmlToLoad = null;})() )";d=""}if(CKEDITOR.env.gecko){window._cke_htmlToLoad=c.dataValue;d=CKEDITOR.getUrl(a+"preview.html")}d=window.open(d,null,"toolbar=yes,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width="+
f+",height="+b+",left="+i);if(CKEDITOR.env.ie&&d)d.location=j;if(!CKEDITOR.env.ie&&!CKEDITOR.env.gecko){j=d.document;j.open();j.write(c.dataValue);j.close()}return true}};CKEDITOR.plugins.add("preview",{init:function(c){if(c.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){a=this.path;c.addCommand("preview",f);c.ui.addButton&&c.ui.addButton("Preview",{label:c.lang.preview.preview,command:"preview",toolbar:"document,40"})}}})}(),CKEDITOR.plugins.add("print",{init:function(a){if(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){a.addCommand("print",
...
command:"removeFormat",toolbar:"cleanup,10"})}}),CKEDITOR.plugins.removeformat={commands:{removeformat:{exec:function(a){for(var f=a._.removeFormatRegex||(a._.removeFormatRegex=RegExp("^(?:"+a.config.removeFormatTags.replace(/,/g,"|")+")$","i")),c=a._.removeAttributes||(a._.removeAttributes=a.config.removeFormatAttributes.split(",")),e=CKEDITOR.plugins.removeformat.filter,b=a.getSelection().getRanges(),g=b.createIterator(),i=function(a){return a.type==CKEDITOR.NODE_ELEMENT},d;d=g.getNextRange();){d.collapsed||
d.enlarge(CKEDITOR.ENLARGE_ELEMENT);var h=d.createBookmark(),j=h.startNode,k=h.endNode,l=function(b){for(var c=a.elementPath(b),d=c.elements,g=1,h;h=d[g];g++){if(h.equals(c.block)||h.equals(c.blockLimit))break;f.test(h.getName())&&e(a,h)&&b.breakParent(h)}};l(j);if(k){l(k);for(j=j.getNextSourceNode(true,CKEDITOR.NODE_ELEMENT);j;){if(j.equals(k))break;if(j.isReadOnly()){if(j.getPosition(k)&CKEDITOR.POSITION_CONTAINS)break;j=j.getNext(i)}else{l=j.getNextSourceNode(false,CKEDITOR.NODE_ELEMENT);if(!(j.getName()==
"img"&&j.data("cke-realelement"))&&e(a,j))if(f.test(j.getName()))j.remove(1);else{j.removeAttributes(c);a.fire("removeFormatCleanup",j)}j=l}}}d.moveToBookmark(h)}a.forceNextSelectionCheck();a.getSelection().selectRanges(b)}}},filter:function(a,f){for(var c=a._.removeFormatFilters||[],e=0;e<c.length;e++)if(c[e](f)===false)return false;return true}},CKEDITOR.editor.prototype.addRemoveFormatFilter=function(a){if(!this._.removeFormatFilters)this._.removeFormatFilters=[];this._.removeFormatFilters.push(a)},
CKEDITOR.config.removeFormatTags="b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var",CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign",CKEDITOR.plugins.add("resize",{init:function(a){var f,c,e,b;function g(g){var h=f,i=c,k=h+(g.data.$.screenX-e)*(j=="rtl"?-1:1),g=i+(g.data.$.screenY-b);l&&(h=Math.max(d.resize_minWidth,Math.min(k,d.resize_maxWidth)));n&&(i=Math.max(d.resize_minHeight,Math.min(g,d.resize_maxHeight)));
a.resize(l?h:null,i)}function i(){CKEDITOR.document.removeListener("mousemove",g);CKEDITOR.document.removeListener("mouseup",i);if(a.document){a.document.removeListener("mousemove",g);a.document.removeListener("mouseup",i)}}var d=a.config,h=a.ui.spaceId("resizer"),j=a.element?a.element.getDirection(1):"ltr";!d.resize_dir&&(d.resize_dir="vertical");d.resize_maxWidth===void 0&&(d.resize_maxWidth=3E3);d.resize_maxHeight===void 0&&(d.resize_maxHeight=3E3);d.resize_minWidth===void 0&&(d.resize_minWidth=
750);d.resize_minHeight===void 0&&(d.resize_minHeight=250);if(d.resize_enabled!==false){var k=null,l=(d.resize_dir=="both"||d.resize_dir=="horizontal")&&d.resize_minWidth!=d.resize_maxWidth,n=(d.resize_dir=="both"||d.resize_dir=="vertical")&&d.resize_minHeight!=d.resize_maxHeight,r=CKEDITOR.tools.addFunction(function(h){k||(k=a.getResizable());f=k.$.offsetWidth||0;c=k.$.offsetHeight||0;e=h.screenX;b=h.screenY;d.resize_minWidth>f&&(d.resize_minWidth=f);d.resize_minHeight>c&&(d.resize_minHeight=c);
CKEDITOR.document.on("mousemove",g);CKEDITOR.document.on("mouseup",i);if(a.document){a.document.on("mousemove",g);a.document.on("mouseup",i)}h.preventDefault&&h.preventDefault()});a.on("destroy",function(){CKEDITOR.tools.removeFunction(r)});a.on("uiSpace",function(b){if(b.data.space=="bottom"){var c="";l&&!n&&(c=" cke_resizer_horizontal");!l&&n&&(c=" cke_resizer_vertical");var d='<span id="'+h+'" class="cke_resizer'+c+" cke_resizer_"+j+'" title="'+CKEDITOR.tools.htmlEncode(a.lang.common.resize)+'" onmousedown="CKEDITOR.tools.callFunction('+
r+', event)">'+(j=="ltr"?"◢":"◣")+"</span>";j=="ltr"&&c=="ltr"?b.data.html=b.data.html+d:b.data.html=d+b.data.html}},a,null,100);a.on("maximize",function(b){a.ui.space("resizer")[b.data==CKEDITOR.TRISTATE_ON?"hide":"show"]()})}}}),function(){var a={readOnly:1,exec:function(a){if(a.fire("save"))if(a=a.element.$.form)try{a.submit()}catch(c){a.submit.click&&a.submit.click()}}};CKEDITOR.plugins.add("save",{init:function(f){if(f.elementMode==CKEDITOR.ELEMENT_MODE_REPLACE){f.addCommand("save",a).modes=
{wysiwyg:!!f.element.$.form};f.ui.addButton&&f.ui.addButton("Save",{label:f.lang.save.toolbar,command:"save",toolbar:"document,10"})}}})}(),function(){CKEDITOR.plugins.add("selectall",{init:function(a){a.addCommand("selectAll",{modes:{wysiwyg:1,source:1},exec:function(a){var c=a.editable();if(c.is("textarea")){a=c.$;if(CKEDITOR.env.ie)a.createTextRange().execCommand("SelectAll");else{a.selectionStart=0;a.selectionEnd=a.value.length}a.focus()}else{if(c.is("body"))a.document.$.execCommand("SelectAll",
false,null);else{var e=a.createRange();e.selectNodeContents(c);e.select()}a.forceNextSelectionCheck();a.selectionChange()}},canUndo:false});a.ui.addButton&&a.ui.addButton("SelectAll",{label:a.lang.selectall.toolbar,command:"selectAll",toolbar:"selection,10"})}})}(),function(){var a={readOnly:1,preserveState:true,editorFocus:false,exec:function(a){this.toggleState();this.refresh(a)},refresh:function(a){if(a.document){var c=this.state==CKEDITOR.TRISTATE_ON&&(a.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE||
a.focusManager.hasFocus)?"attachClass":"removeClass";a.editable()[c]("cke_show_blocks")}}};CKEDITOR.plugins.add("showblocks",{onLoad:function(){var a=["p","div","pre","address","blockquote","h1","h2","h3","h4","h5","h6"],c,e,b,g,i=CKEDITOR.getUrl(this.path),d=!(CKEDITOR.env.ie&&CKEDITOR.env.version<9),h=d?":not([contenteditable=false]):not(.cke_show_blocks_off)":"",j,k;for(c=e=b=g="";j=a.pop();){k=a.length?",":"";c=c+(".cke_show_blocks "+j+h+k);b=b+(".cke_show_blocks.cke_contents_ltr "+j+h+k);g=g+
(".cke_show_blocks.cke_contents_rtl "+j+h+k);e=e+(".cke_show_blocks "+j+h+"{background-image:url("+CKEDITOR.getUrl(i+"images/block_"+j+".png")+")}")}CKEDITOR.addCss((c+"{background-repeat:no-repeat;border:1px dotted gray;padding-top:8px}").concat(e,b+"{background-position:top left;padding-left:8px}",g+"{background-position:top right;padding-right:8px}"));d||CKEDITOR.addCss(".cke_show_blocks [contenteditable=false],.cke_show_blocks .cke_show_blocks_off{border:none;padding-top:0;background-image:none}.cke_show_blocks.cke_contents_rtl [contenteditable=false],.cke_show_blocks.cke_contents_rtl .cke_show_blocks_off{padding-right:0}.cke_show_blocks.cke_contents_ltr [contenteditable=false],.cke_show_blocks.cke_contents_ltr .cke_show_blocks_off{padding-left:0}")},
...
a[b]==c.$)return b;if(b==c)return new CKEDITOR.dom.element(a[b])}return c.is?-1:null}function j(b,c,d){var e=a(b),f;if((c?e.length!=1:e.length<2)||(f=b.getCommonAncestor())&&f.type==CKEDITOR.NODE_ELEMENT&&f.is("table"))return false;var g,b=e[0];f=b.getAscendant("table");var j=CKEDITOR.tools.buildTableMap(f),i=j.length,k=j[0].length,l=b.getParent().$.rowIndex,n=h(j,l,b);if(c){var y;try{var z=parseInt(b.getAttribute("rowspan"),10)||1;g=parseInt(b.getAttribute("colspan"),10)||1;y=j[c=="up"?l-z:c=="down"?
l+z:l][c=="left"?n-g:c=="right"?n+g:n]}catch(B){return false}if(!y||b.$==y)return false;e[c=="up"||c=="left"?"unshift":"push"](new CKEDITOR.dom.element(y))}for(var c=b.getDocument(),A=l,z=y=0,F=!d&&new CKEDITOR.dom.documentFragment(c),C=0,c=0;c<e.length;c++){g=e[c];var J=g.getParent(),G=g.getFirst(),E=g.$.colSpan,D=g.$.rowSpan,J=J.$.rowIndex,I=h(j,J,g),C=C+E*D,z=Math.max(z,I-n+E);y=Math.max(y,J-l+D);if(!d){E=g;(D=E.getBogus())&&D.remove();E.trim();if(g.getChildren().count()){if(J!=A&&G&&(!G.isBlockBoundary||
!G.isBlockBoundary({br:1})))(A=F.getLast(CKEDITOR.dom.walker.whitespaces(true)))&&(!A.is||!A.is("br"))&&F.append("br");g.moveChildren(F)}c?g.remove():g.setHtml("")}A=J}if(d)return y*z==C;F.moveChildren(b);b.appendBogus();z>=k?b.removeAttribute("rowSpan"):b.$.rowSpan=y;y>=i?b.removeAttribute("colSpan"):b.$.colSpan=z;d=new CKEDITOR.dom.nodeList(f.$.rows);e=d.count();for(c=e-1;c>=0;c--){f=d.getItem(c);if(!f.$.cells.length){f.remove();e++}}return b}function k(b,c){var d=a(b);if(d.length>1)return false;
if(c)return true;var d=d[0],e=d.getParent(),f=e.getAscendant("table"),g=CKEDITOR.tools.buildTableMap(f),j=e.$.rowIndex,i=h(g,j,d),k=d.$.rowSpan,l;if(k>1){l=Math.ceil(k/2);for(var k=Math.floor(k/2),e=j+l,f=new CKEDITOR.dom.element(f.$.rows[e]),g=h(g,e),n,e=d.clone(),j=0;j<g.length;j++){n=g[j];if(n.parentNode==f.$&&j>i){e.insertBefore(new CKEDITOR.dom.element(n));break}else n=null}n||f.append(e)}else{k=l=1;f=e.clone();f.insertAfter(e);f.append(e=d.clone());n=h(g,j);for(i=0;i<n.length;i++)n[i].rowSpan++}e.appendBogus();
...
f.insertAfter(d);f.appendBogus();d.$.colSpan=e;f.$.colSpan=j;e==1&&d.removeAttribute("colSpan");j==1&&f.removeAttribute("colSpan");return f}var n=/^(?:td|th)$/;CKEDITOR.plugins.tabletools={requires:"table,dialog,contextmenu",init:function(e){function h(a){return CKEDITOR.tools.extend(a||{},{contextSensitive:1,refresh:function(a,b){this.setState(b.contains({td:1,th:1},1)?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED)}})}function m(a,b){var c=e.addCommand(a,b);e.addFeature(c)}var n=e.lang.table;
...
exec:function(a){a=a.getSelection();f(a)}}));m("columnDelete",h({requiredContent:"table",exec:function(b){for(var b=b.getSelection(),b=a(b),c=b[0],e=b[b.length-1],b=c.getAscendant("table"),f=CKEDITOR.tools.buildTableMap(b),g,h,j=[],i=0,k=f.length;i<k;i++)for(var l=0,o=f[i].length;l<o;l++){f[i][l]==c.$&&(g=l);f[i][l]==e.$&&(h=l)}for(i=g;i<=h;i++)for(l=0;l<f.length;l++){e=f[l];c=new CKEDITOR.dom.element(b.$.rows[l]);e=new CKEDITOR.dom.element(e[i]);if(e.$){e.$.colSpan==1?e.remove():e.$.colSpan=e.$.colSpan-
...
h({allowedContent:"td[colspan]",requiredContent:"td[colspan]",exec:function(a){d(l(a.getSelection()))}}));m("cellInsertBefore",h({requiredContent:"table",exec:function(a){a=a.getSelection();g(a,true)}}));m("cellInsertAfter",h({requiredContent:"table",exec:function(a){a=a.getSelection();g(a)}}));e.addMenuItems&&e.addMenuItems({tablecell:{label:n.cell.menu,group:"tablecell",order:1,getItems:function(){var b=e.getSelection(),c=a(b);return{tablecell_insertBefore:CKEDITOR.TRISTATE_OFF,tablecell_insertAfter:CKEDITOR.TRISTATE_OFF,
...
n=k?37:39,k=k?39:37,l=l===void 0||l;switch(c){case 9:case CKEDITOR.SHIFT+9:for(;!e||!e.items.length;){e=c==9?(e?e.next:a.toolbar.next)||b.toolbox.toolbars[0]:(e?e.previous:a.toolbar.previous)||b.toolbox.toolbars[b.toolbox.toolbars.length-1];if(e.items.length)for(a=e.items[f?e.items.length-1:0];a&&!a.focus;)(a=f?a.previous:a.next)||(e=0)}a&&a.focus();return false;case n:e=a;do{e=e.next;!e&&l&&(e=a.toolbar.items[0])}while(e&&!e.focus);e?e.focus():i(a,9);return false;case 40:if(a.button&&a.button.hasArrow){b.once("panelShow",
function(a){a.data._.panel._.currentBlock.onKeyDown(40)});a.execute()}else i(a,c==40?n:k);return false;case k:case 38:e=a;do{e=e.previous;!e&&l&&(e=a.toolbar.items[a.toolbar.items.length-1])}while(e&&!e.focus);if(e)e.focus();else{f=1;i(a,CKEDITOR.SHIFT+9);f=0}return false;case 27:b.focus();return false;case 13:case 32:a.execute();return false}return true};b.on("uiSpace",function(d){if(d.data.space==b.config.toolbarLocation){d.removeListener();b.toolbox=new c;var e=CKEDITOR.tools.getNextId(),f=['<span id="',
e,'" class="cke_voice_label">',b.lang.toolbar.toolbars,"</span>",'<span id="'+b.ui.spaceId("toolbox")+'" class="cke_toolbox" role="group" aria-labelledby="',e,'" onmousedown="return false;">'],e=b.config.toolbarStartupExpanded!==false,g,l;b.config.toolbarCanCollapse&&b.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE&&f.push('<span class="cke_toolbox_main"'+(e?">":' style="display:none">'));for(var n=b.toolbox.toolbars,r=a(b),o=0;o<r.length;o++){var m,p=0,q,t=r[o],u;if(t){if(g){f.push("</span>");l=g=0}if(t===
"/")f.push('<span class="cke_toolbar_break"></span>');else{u=t.items||t;for(var v=0;v<u.length;v++){var x=u[v],w;if(x)if(x.type==CKEDITOR.UI_SEPARATOR)l=g&&x;else{w=x.canGroup!==false;if(!p){m=CKEDITOR.tools.getNextId();p={id:m,items:[]};q=t.name&&(b.lang.toolbar.toolbarGroups[t.name]||t.name);f.push('<span id="',m,'" class="cke_toolbar"',q?' aria-labelledby="'+m+'_label"':"",' role="toolbar">');q&&f.push('<span id="',m,'_label" class="cke_voice_label">',q,"</span>");f.push('<span class="cke_toolbar_start"></span>');
var s=n.push(p)-1;if(s>0){p.previous=n[s-1];p.previous.next=p}}if(w){if(!g){f.push('<span class="cke_toolgroup" role="presentation">');g=1}}else if(g){f.push("</span>");g=0}m=function(a){a=a.render(b,f);s=p.items.push(a)-1;if(s>0){a.previous=p.items[s-1];a.previous.next=a}a.toolbar=p;a.onkey=i;a.onfocus=function(){b.toolbox.focusCommandExecuted||b.focus()}};if(l){m(l);l=0}m(x)}}if(g){f.push("</span>");l=g=0}p&&f.push('<span class="cke_toolbar_end"></span></span>')}}}b.config.toolbarCanCollapse&&f.push("</span>");
...
{8:1,46:1};CKEDITOR.plugins.add("undo",{init:function(b){function e(a){i.enabled&&a.data.command.canUndo!==false&&i.save()}function f(){i.enabled=b.readOnly?false:b.mode=="wysiwyg";i.onChange()}var i=b.undoManager=new c(b),l=i.editingHandler=new g(i),n=b.addCommand("undo",{exec:function(){if(i.undo()){b.selectionChange();this.fire("afterUndo")}},startDisabled:true,canUndo:false}),r=b.addCommand("redo",{exec:function(){if(i.redo()){b.selectionChange();this.fire("afterRedo")}},startDisabled:true,canUndo:false});
b.setKeystroke([[a[0],"undo"],[a[1],"redo"],[a[2],"redo"]]);i.onChange=function(){n.setState(i.undoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);r.setState(i.redoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED)};b.on("beforeCommandExec",e);b.on("afterCommandExec",e);b.on("saveSnapshot",function(a){i.save(a.data&&a.data.contentOnly)});b.on("contentDom",l.attachListeners,l);b.on("instanceReady",function(){b.fire("saveSnapshot")});b.on("beforeModeUnload",function(){b.mode=="wysiwyg"&&
...
height:"100%"});h.addClass("cke_wysiwyg_frame cke_reset");var j=a.ui.space("contents");j.append(h);if(d=CKEDITOR.env.ie||CKEDITOR.env.gecko)h.on("load",f);var k=a.title,l=a.fire("ariaEditorHelpLabel",{}).label;if(k){CKEDITOR.env.ie&&l&&(k=k+(", "+l));h.setAttribute("title",k)}if(l){var k=CKEDITOR.tools.getNextId(),n=CKEDITOR.dom.element.createFromHtml('<span id="'+k+'" class="cke_voice_label">'+l+"</span>");j.append(n,1);h.setAttribute("aria-describedby",k)}a.on("beforeModeUnload",function(a){a.removeListener();
n&&n.remove()});h.setAttributes({tabIndex:a.tabIndex,allowTransparency:"true"});!d&&f();if(CKEDITOR.env.webkit){d=function(){j.setStyle("width","100%");h.hide();h.setSize("width",j.getSize("width"));j.removeStyle("width");h.show()};h.setCustomData("onResize",d);CKEDITOR.document.getWindow().on("resize",d)}a.fire("ariaWidget",h)})}});CKEDITOR.editor.prototype.addContentsCss=function(a){var c=this.config,e=c.contentsCss;if(!CKEDITOR.tools.isArray(e))c.contentsCss=e?[e]:[];c.contentsCss.push(a)};var e=
...
'<style data-cke-temp="1">');h||(k=k+CKEDITOR.tools.buildStyleHtml(f.config.contentsCss));var l=d.baseHref?'<base href="'+d.baseHref+'" data-cke-temp="1" />':"";h&&(a=a.replace(/<!DOCTYPE[^>]*>/i,function(a){f.docType=j=a;return""}).replace(/<\?xml\s[^\?]*\?>/i,function(a){f.xmlDeclaration=a;return""}));a=f.dataProcessor.toHtml(a);if(h){/<body[\s|>]/.test(a)||(a="<body>"+a);/<html[\s|>]/.test(a)||(a="<html>"+a+"</html>");/<head[\s|>]/.test(a)?/<title[\s|>]/.test(a)||(a=a.replace(/<head[^>]*>/,"$&<title></title>")):
a=a.replace(/<html[^>]*>/,"$&<head><title></title></head>");l&&(a=a.replace(/<head[^>]*?>/,"$&"+l));a=a.replace(/<\/head\s*>/,k+"$&");a=j+a}else a=d.docType+'<html dir="'+d.contentsLangDirection+'" lang="'+(d.contentsLanguage||f.langCode)+'"><head><title>'+this._.docTitle+"</title>"+l+k+"</head><body"+(d.bodyId?' id="'+d.bodyId+'"':"")+(d.bodyClass?' class="'+d.bodyClass+'"':"")+">"+a+"</body></html>";if(CKEDITOR.env.gecko){a=a.replace(/<body/,'<body contenteditable="true" ');CKEDITOR.env.version<
...
l&&(CKEDITOR.env.ie&&CKEDITOR.env.version<10)&&(d=d+'<script id="cke_basetagscrpt">var baseTag = document.querySelector( "base" );baseTag.href = baseTag.href;<\/script>');a=a.replace(/(?=\s*<\/(:?head)>)/,d);this.clearCustomData();this.clearListeners();f.fire("contentDomUnload");var n=this.getDocument();try{n.write(a)}catch(r){setTimeout(function(){n.write(a)},0)}}},getData:function(a){if(a)return this.getHtml();var a=this.editor,c=a.config,e=c.fullPage,d=e&&a.docType,f=e&&a.xmlDeclaration,j=this.getDocument(),
