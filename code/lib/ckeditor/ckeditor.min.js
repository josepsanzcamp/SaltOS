...
b=CKEDITOR.dom.element.createFromHtml(c.output({id:a.id,name:b,langDir:a.lang.dir,langCode:a.langCode,voiceLabel:"",topHtml:i?'<span id="'+a.ui.spaceId("top")+'" class="cke_top cke_reset_all" role="presentation" style="height:auto">'+i+"</span>":"",contentId:a.ui.spaceId("contents"),bottomHtml:j?'<span id="'+a.ui.spaceId("bottom")+'" class="cke_bottom cke_reset_all" role="presentation">'+j+"</span>":"",outerEl:CKEDITOR.env.ie?"span":"div"}));if(n==CKEDITOR.ELEMENT_MODE_REPLACE){e.hide();
...
"dialogs/div.js");CKEDITOR.dialog.add("editdiv",this.path+"dialogs/div.js")}}});CKEDITOR.plugins.div={getSurroundDiv:function(a,c){var b=a.elementPath(c);return a.elementPath(b.blockLimit).contains(function(a){return a.is("div")&&!a.isReadOnly()},1)}}})();(function(){function w(a){function d(){for(var b=g(),e=CKEDITOR.tools.clone(a.config.toolbarGroups)||n(a),f=0;f<e.length;f++){var k=e[f];if("/"!=k){"string"==typeof k&&(k=e[f]={name:k});var i,d=k.groups;if(d)for(var h=0;h<d.length;h++)i=d[h],(i=b[i])&&c(k,i);(i=b[k.name])&&c(k,i)}}return e}function g(){var b={},c,f,e;for(c in a.ui.items)f=a.ui.items[c],e=f.toolbar||"others",e=e.split(","),f=e[0],e=parseInt(e[1]||-1,10),b[f]||(b[f]=[]),b[f].push({name:c,order:e});for(f in b)b[f]=b[f].sort(function(b,
...
8>CKEDITOR.env.version?f.createText("\r"):f.createElement("br"),b.deleteContents(),b.insertNode(a),CKEDITOR.env.needsBrFiller?(f.createText("﻿").insertAfter(a),j&&a.getParent().appendBogus(),a.getNext().$.nodeValue="",b.setStartAt(a.getNext(),CKEDITOR.POSITION_AFTER_START)):b.setStartAt(a,CKEDITOR.POSITION_AFTER_END)),b.collapse(!0),b.select(),b.scrollIntoView())}}};var s=CKEDITOR.plugins.enterkey,o=s.enterBr,p=s.enterBlock,r=/^h[1-6]$/})();CKEDITOR.plugins.add("popup");
...
filter:function(a,h){for(var e=a._.removeFormatFilters||[],f=0;f<e.length;f++)if(!1===e[f](h))return!1;return!0}};CKEDITOR.editor.prototype.addRemoveFormatFilter=function(a){this._.removeFormatFilters||(this._.removeFormatFilters=[]);this._.removeFormatFilters.push(a)};CKEDITOR.config.removeFormatTags="b,big,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var";CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign";(function(){CKEDITOR.plugins.add("selectall",{init:function(b){b.addCommand("selectAll",{modes:{wysiwyg:1,source:1},exec:function(a){var b=a.editable();if(b.is("textarea"))a=b.$,CKEDITOR.env.ie?a.createTextRange().execCommand("SelectAll"):(a.selectionStart=0,a.selectionEnd=a.value.length),a.focus();else{if(b.is("body"))a.document.$.execCommand("SelectAll",!1,null);else{var c=a.createRange();c.selectNodeContents(b);c.select()}a.forceNextSelectionCheck();a.selectionChange()}},canUndo:!1});b.ui.addButton&&
...
this.currentImage.equalsContent(a)?a:null,level:1})},unlock:function(){if(this.locked&&!--this.locked.level){var a=this.locked.update,c=a&&new f(this.editor,!0);this.locked=null;a&&!a.equalsContent(c)&&this.update()}}}})();CKEDITOR.plugins.add("menubutton",{requires:"button,menu",onLoad:function(){var d=function(c){var a=this._,b=a.menu;a.state!==CKEDITOR.TRISTATE_DISABLED&&(a.on&&b?b.hide():(a.previousState=a.state,b||(b=a.menu=new CKEDITOR.menu(c,{panel:{className:"cke_menu_panel",attributes:{"aria-label":c.lang.common.options}}}),b.onHide=CKEDITOR.tools.bind(function(){var b=this.command?c.getCommand(this.command).modes:this.modes;this.setState(!b||b[c.mode]?a.previousState:CKEDITOR.TRISTATE_DISABLED);a.on=0},this),
this.onMenu&&b.addListener(this.onMenu)),this.setState(CKEDITOR.TRISTATE_ON),a.on=1,setTimeout(function(){b.show(CKEDITOR.document.getById(a.id),4)},0)))};CKEDITOR.ui.menuButton=CKEDITOR.tools.createClass({base:CKEDITOR.ui.button,$:function(c){delete c.panel;this.base(c);this.hasArrow=!0;this.click=d},statics:{handler:{create:function(c){return new CKEDITOR.ui.menuButton(c)}}}})},beforeInit:function(d){d.ui.addHandler(CKEDITOR.UI_MENUBUTTON,CKEDITOR.ui.menuButton.handler)}});
CKEDITOR.UI_MENUBUTTON="menubutton";CKEDITOR.plugins.add("iframedialog",{requires:"dialog",onLoad:function(){CKEDITOR.dialog.addIframe=function(e,d,a,j,f,l,g){a={type:"iframe",src:a,width:"100%",height:"100%"};a.onContentLoad="function"==typeof l?l:function(){var a=this.getElement().$.contentWindow;if(a.onDialogEvent){var b=this.getDialog(),c=function(b){return a.onDialogEvent(b)};b.on("ok",c);b.on("cancel",c);b.on("resize",c);b.on("hide",function(a){b.removeListener("ok",c);b.removeListener("cancel",c);b.removeListener("resize",c);
...
a.responseXML;return new CKEDITOR.xml(b&&b.firstChild?b:a.responseText)}return null},g=function(a,b,d){var e=!!b,c=h();if(!c)return null;c.open("GET",a,e);e&&(c.onreadystatechange=function(){4==c.readyState&&(b(d(c)),c=null)});c.send(null);return e?"":d(c)};return{load:function(a,b){return g(a,b,i)},loadXml:function(a,b){return g(a,b,j)}}}()})();(function(){function n(a,f,d,b){if(!a.isReadOnly()&&!a.equals(d.editable())){CKEDITOR.dom.element.setMarker(b,a,"bidi_processed",1);for(var b=a,c=d.editable();(b=b.getParent())&&!b.equals(c);)if(b.getCustomData("bidi_processed")){a.removeStyle("direction");a.removeAttribute("dir");return}b="useComputedState"in d.config?d.config.useComputedState:1;if((b?a.getComputedStyle("direction"):a.getStyle("direction")||a.hasAttribute("dir"))!=f)a.removeStyle("direction"),b?(a.removeAttribute("dir"),f!=a.getComputedStyle("direction")&&
...
vbox:1})){var e=d.getElement();if(e){e.on("mouseover",function(){k(f,this,c,b,d,b._.currentTabId)});e.on("mouseout",function(){a.hide()})}}})})}})})();CKEDITOR.plugins.add("docprops",{requires:"wysiwygarea,dialog",init:function(a){var b=new CKEDITOR.dialogCommand("docProps");b.modes={wysiwyg:a.config.fullPage};b.allowedContent={body:{styles:"*",attributes:"dir"},html:{attributes:"lang,xml:lang"}};b.requiredContent="body";a.addCommand("docProps",b);CKEDITOR.dialog.add("docProps",this.path+"dialogs/docprops.js");a.ui.addButton&&a.ui.addButton("DocProps",{label:a.lang.docprops.label,command:"docProps",toolbar:"document,30"})}});(function(){function k(a,d){CKEDITOR.tools.extend(this,{editor:a,editable:a.editable(),doc:a.document,win:a.window},d,!0);this.frame=this.win.getFrame();this.inline=this.editable.isInline();this.target=this[this.inline?"editable":"doc"]}function l(a,d){CKEDITOR.tools.extend(this,d,{editor:a},!0)}function m(a,d){var b=a.editable();CKEDITOR.tools.extend(this,{editor:a,editable:b,doc:a.document,win:a.window,container:CKEDITOR.document.getBody(),winTop:CKEDITOR.document.getWindow()},d,!0);this.hidden=
...
cleanup:function(){var a,d;for(d in this.visible)a=this.visible[d],a.getCustomData("hash")!==this.hash&&this.hideLine(a)},queryViewport:function(){this.winPane=this.win.getViewPaneSize();this.winTopScroll=this.winTop.getScrollPosition();this.winTopPane=this.winTop.getViewPaneSize();this.rect=this.inline?this.editable.getClientRect():this.frame.getClientRect()}};var o={left:1,right:1,center:1},r={absolute:1,fixed:1};CKEDITOR.plugins.lineutils={finder:k,locator:l,liner:m}})();(function(){function o(a){this.editor=a;this.registered={};this.instances={};this.selected=[];this.widgetHoldingFocusedEditable=this.focused=null;this._={nextId:0,upcasts:[],filters:{}};H(this);I(this);this.on("checkWidgets",J);this.editor.on("contentDomInvalidated",this.checkWidgets,this);K(this);L(this);M(this);N(this);O(this)}function j(a,b,c,d,e){var g=a.editor;CKEDITOR.tools.extend(this,d,{editor:g,id:b,inline:"span"==c.getParent().getName(),element:c,data:CKEDITOR.tools.extend({},"function"==
typeof d.defaults?d.defaults():d.defaults),dataReady:!1,inited:!1,ready:!1,edit:j.prototype.edit,focusedEditable:null,definition:d,repository:a,draggable:!1!==d.draggable,_:{downcastFn:d.downcast&&"string"==typeof d.downcast?d.downcasts[d.downcast]:d.downcast}},!0);this.inline&&(CKEDITOR.env.ie&&9>CKEDITOR.env.version)&&(this.draggable=!1);a.fire("instanceCreated",this);P(this,d);this.init&&this.init();this.inited=!0;(a=this.element.data("cke-widget-data"))&&this.setData(JSON.parse(a));e&&this.setData(e);
this.dataReady=!0;r(this);this.fire("data",this.data);this.isInited()&&g.editable().contains(this.wrapper)&&(this.ready=!0,this.fire("ready"))}function p(a,b,c){CKEDITOR.dom.element.call(this,b.$);this.editor=a;b=this.filter=c.filter;CKEDITOR.dtd[this.getName()].p?(this.enterMode=b?b.getAllowedEnterMode(a.enterMode):a.enterMode,this.shiftEnterMode=b?b.getAllowedEnterMode(a.shiftEnterMode,!0):a.shiftEnterMode):this.enterMode=this.shiftEnterMode=CKEDITOR.ENTER_BR}function Q(a,b){a.addCommand(b.name,
{exec:function(){function c(){a.widgets.finalizeCreation(f)}var d=a.widgets.focused;if(d&&d.name==b.name)d.edit();else if(b.insert)b.insert();else if(b.template){var d="function"==typeof b.defaults?b.defaults():b.defaults,d=CKEDITOR.dom.element.createFromHtml(b.template.output(d)),e,g=a.widgets.wrapElement(d,b.name),f=new CKEDITOR.dom.documentFragment(g.getDocument());f.append(g);(e=a.widgets.initOn(d,b))?(d=e.once("edit",function(b){if(b.data.dialog)e.once("dialog",function(b){var b=b.data,d,g;d=
b.once("ok",c,null,null,20);g=b.once("cancel",function(){a.widgets.destroy(e,!0)});b.once("hide",function(){d.removeListener();g.removeListener()})});else c()},null,null,999),e.edit(),d.removeListener()):c()}},refresh:function(a,b){this.setState(l(a.editable(),b.blockLimit)?CKEDITOR.TRISTATE_DISABLED:CKEDITOR.TRISTATE_OFF)},context:"div",allowedContent:b.allowedContent,requiredContent:b.requiredContent,contentForms:b.contentForms,contentTransformations:b.contentTransformations})}function s(a,b){a.focused=
null;b.isInited()&&(a.fire("widgetBlurred",{widget:b}),b.setFocused(!1))}function J(a){a=a.data;if("wysiwyg"==this.editor.mode){var b=this.editor.editable(),c=this.instances,d,e;if(b){for(d in c)b.contains(c[d].wrapper)||this.destroy(c[d],!0);if(a&&a.initOnlyNew)b=this.initOnAll();else{var g=b.find(".cke_widget_wrapper"),b=[];d=0;for(c=g.count();d<c;d++){e=g.getItem(d);var f;if(f=!this.getByElement(e,!0)){a:{f=R;for(var h=e;h=h.getParent();)if(f(h)){f=!0;break a}f=!1}f=!f}f&&(e.addClass("cke_widget_new"),
b.push(this.initOn(e.getFirst(q))))}}a&&(a.focusInited&&1==b.length)&&b[0].focus()}}}function t(a,b,c){if(!c.allowedContent)return null;var d=this._.filters[a];d||(this._.filters[a]=d={});(a=d[b])||(d[b]=a=new CKEDITOR.filter(c.allowedContent));return a}function S(a){var b=[],c=a._.upcasts;return{toBeWrapped:b,iterator:function(a){if("data-cke-widget-wrapper"in a.attributes)return(a=a.getFirst(u))&&b.push([a]),!1;if("data-widget"in a.attributes)return b.push([a]),!1;if(c.length)for(var e,g,f,h=0,
i=c.length;h<i;++h)if(e=c[h],f={},g=e[0](a,f))return g instanceof CKEDITOR.htmlParser.element&&(a=g),a.attributes["data-cke-widget-data"]=JSON.stringify(f),b.push([a,e[1]]),!1}}}function l(a,b){return!b||b.equals(a)?null:v(b)?b:l(a,b.getParent())}function w(a){return{tabindex:-1,contenteditable:"false","data-cke-widget-wrapper":1,"data-cke-filter":"off","class":"cke_widget_wrapper cke_widget_new cke_widget_"+(a?"inline":"block")}}function x(a,b,c){if(a.type==CKEDITOR.NODE_ELEMENT){var d=CKEDITOR.dtd[a.name];
if(d&&!d[c.name]){var d=a.split(b),e=a.parent,b=d.getIndex();a.children.length||(b-=1,a.remove());d.children.length||d.remove();return x(e,b,c)}}a.add(c,b)}function u(a){return a.type==CKEDITOR.NODE_ELEMENT&&!!a.attributes["data-widget"]}function q(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasAttribute("data-widget")}function y(a,b){return"boolean"==typeof a.inline?a.inline:!!CKEDITOR.dtd.$inline[b]}function z(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.hasAttribute("data-cke-widget-wrapper")}function v(a){return a.type==
...
function N(a){var b=a.editor,c=CKEDITOR.plugins.lineutils;b.on("contentDom",function(){var d=b.editable();d.attachListener(d.isInline()?d:b.document,"drop",function(c){var d=c.data.$.dataTransfer.getData("text"),f,h;if(d){try{f=JSON.parse(d)}catch(i){return}if("cke-widget"==f.type&&(c.data.preventDefault(),f.editor==b.name&&(h=a.instances[f.id]))){a:if(f=c.data.$,d=b.createRange(),c.data.testRange)d=c.data.testRange;else if(document.caretRangeFromPoint)c=b.document.$.caretRangeFromPoint(f.clientX,
f.clientY),d.setStart(CKEDITOR.dom.node(c.startContainer),c.startOffset),d.collapse(!0);else if(f.rangeParent)d.setStart(CKEDITOR.dom.node(f.rangeParent),f.rangeOffset),d.collapse(!0);else if(document.body.createTextRange)c=b.document.getBody().$.createTextRange(),c.moveToPoint(f.clientX,f.clientY),f="cke-temp-"+(new Date).getTime(),c.pasteHTML('<span id="'+f+'">​</span>'),c=b.document.getById(f),d.moveToPosition(c,CKEDITOR.POSITION_BEFORE_START),c.remove();else{d=null;break a}d&&(CKEDITOR.env.gecko?
setTimeout(A,0,b,h,d):A(b,h,d))}}});CKEDITOR.tools.extend(a,{finder:new c.finder(b,{lookups:{"default":function(a){if(!a.is(CKEDITOR.dtd.$listItem)&&a.is(CKEDITOR.dtd.$block)){for(;a;){if(v(a))return;a=a.getParent()}return CKEDITOR.LINEUTILS_BEFORE|CKEDITOR.LINEUTILS_AFTER}}}}),locator:new c.locator(b),liner:new c.liner(b,{lineStyle:{cursor:"move !important","border-top-color":"#666"},tipLeftStyle:{"border-left-color":"#666"},tipRightStyle:{"border-right-color":"#666"}})},!0)})}function L(a){var b=
a.editor;b.on("contentDom",function(){var c=b.editable(),d=c.isInline()?c:b.document,e,g;c.attachListener(d,"mousedown",function(c){var b=c.data.getTarget();if(!b.type)return!1;e=a.getByElement(b);g=0;e&&(e.inline&&b.type==CKEDITOR.NODE_ELEMENT&&b.hasAttribute("data-cke-widget-drag-handler")?g=1:l(e.wrapper,b)?e=null:(c.data.preventDefault(),CKEDITOR.env.ie||e.focus()))});c.attachListener(d,"mouseup",function(){e&&g&&(g=0,e.focus())});CKEDITOR.env.ie&&c.attachListener(d,"mouseup",function(){e&&setTimeout(function(){e.focus();
e=null})})});b.on("doubleclick",function(c){var b=a.getByElement(c.data.element);if(b&&!l(b.wrapper,c.data.element))return b.fire("doubleclick",{element:c.data.element})},null,null,1)}function M(a){a.editor.on("key",function(b){var c=a.focused,d=a.widgetHoldingFocusedEditable,e;c?e=c.fire("key",{keyCode:b.data.keyCode}):d&&(c=b.data.keyCode,b=d.focusedEditable,c==CKEDITOR.CTRL+65?(c=b.getBogus(),d=d.editor.createRange(),d.selectNodeContents(b),c&&d.setEndAt(c,CKEDITOR.POSITION_BEFORE_START),d.select(),
...
a);b.on("selectionChange",function(c){var d=(c=l(b.editable(),c.data.selection.getStartElement()))&&a.getByElement(c),e=a.widgetHoldingFocusedEditable;if(e){if(e!==d||!e.focusedEditable.equals(c))n(a,e,null),d&&c&&n(a,d,c)}else d&&c&&n(a,d,c)});b.on("dataReady",function(){C(a).commit()});b.on("blur",function(){var b;(b=a.focused)&&s(a,b);(b=a.widgetHoldingFocusedEditable)&&n(a,b,null)})}function I(a){var b=a.editor,c={};b.on("toDataFormat",function(b){var e=CKEDITOR.tools.getNextNumber(),g=[];b.data.downcastingSessionId=
e;c[e]=g;b.data.dataValue.forEach(function(b){var c=b.attributes,d;if("data-cke-widget-id"in c){if(c=a.instances[c["data-cke-widget-id"]])d=b.getFirst(u),g.push({wrapper:b,element:d,widget:c}),"1"!=d.attributes["data-cke-widget-keep-attr"]&&delete d.attributes["data-widget"]}else if("data-cke-widget-editable"in c)return delete c.contenteditable,b.setHtml(g[g.length-1].widget.editables[c["data-cke-widget-editable"]].getData()),!1},CKEDITOR.NODE_ELEMENT)},null,null,8);b.on("toDataFormat",function(a){if(a.data.downcastingSessionId)for(var a=
c[a.data.downcastingSessionId],b,g,f;b=a.shift();)g=b.widget,f=b.element,(g=g._.downcastFn&&g._.downcastFn.call(g,f))||(g=f),b.wrapper.replaceWith(g)},null,null,13);b.on("contentDomUnload",function(){a.destroyAll(!0)})}function H(a){function b(){c.fire("lockSnapshot");a.checkWidgets({initOnlyNew:!0,focusInited:d});c.fire("unlockSnapshot")}var c=a.editor,d,e;c.on("toHtml",function(b){var c=S(a),e;for(b.data.dataValue.forEach(c.iterator,CKEDITOR.NODE_ELEMENT);e=c.toBeWrapped.pop();){var i=e[0],k=i.parent;
k.type==CKEDITOR.NODE_ELEMENT&&k.attributes["data-cke-widget-wrapper"]&&k.replaceWith(i);a.wrapElement(e[0],e[1])}d=1==b.data.dataValue.children.length&&b.data.dataValue.children[0].type==CKEDITOR.NODE_ELEMENT&&b.data.dataValue.children[0].attributes["data-cke-widget-wrapper"]},null,null,8);c.on("dataReady",function(){if(e)for(var b=a,d=c.editable().find(".cke_widget_wrapper"),h,i,k=0,j=d.count();k<j;++k)h=d.getItem(k),i=h.getFirst(q),i.type==CKEDITOR.NODE_ELEMENT&&i.data("widget")?(i.replace(h),
b.wrapElement(i)):h.remove();e=0;a.destroyAll(!0);a.initOnAll()});c.on("loadSnapshot",function(b){/data-cke-widget/.test(b.data)&&(e=1);a.destroyAll(!0)},null,null,9);c.on("paste",function(a){a.data.dataValue=a.data.dataValue.replace(V,U)});c.on("insertText",b,null,null,999);c.on("insertHtml",b,null,null,999)}function C(a){var b=a.selected,c=[],d=b.slice(0),e=null;return{select:function(a){0>CKEDITOR.tools.indexOf(b,a)&&c.push(a);a=CKEDITOR.tools.indexOf(d,a);0<=a&&d.splice(a,1);return this},focus:function(a){e=
a;return this},commit:function(){var g=a.focused!==e,f;a.editor.fire("lockSnapshot");for(g&&(f=a.focused)&&s(a,f);f=d.pop();)b.splice(CKEDITOR.tools.indexOf(b,f),1),f.isInited()&&f.setSelected(!1);g&&e&&(a.focused=e,a.fire("widgetFocused",{widget:e}),e.setFocused(!0));for(;f=c.pop();)b.push(f),f.setSelected(!0);a.editor.fire("unlockSnapshot")}}}function D(a){a.cancel()}function B(a,b){var c=a.editor,d=c.document;if(!d.getById("cke_copybin")){var e=c.blockless||CKEDITOR.env.ie?"span":"div",g=d.createElement(e),
f=d.createElement(e),e=CKEDITOR.env.ie&&9>CKEDITOR.env.version;f.setAttributes({id:"cke_copybin","data-cke-temp":"1"});g.setStyles({position:"absolute",width:"1px",height:"1px",overflow:"hidden"});g.setStyle("ltr"==c.config.contentsLangDirection?"left":"right","-5000px");g.setHtml('<span data-cke-copybin-start="1">​</span>'+a.wrapper.getOuterHtml()+'<span data-cke-copybin-end="1">​</span>');c.fire("saveSnapshot");c.fire("lockSnapshot");f.append(g);c.editable().append(f);var h=c.on("selectionChange",
D,null,null,0),i=a.repository.on("checkSelection",D,null,null,0);if(e)var k=d.getDocumentElement().$,j=k.scrollTop;d=c.createRange();d.selectNodeContents(g);d.select();e&&(k.scrollTop=j);setTimeout(function(){b||a.focus();f.remove();h.removeListener();i.removeListener();c.fire("unlockSnapshot");if(b){a.repository.del(a);c.fire("saveSnapshot")}},100)}}function E(){var a=CKEDITOR.document.getActive(),b=this.editor,c=b.editable();(c.isInline()?c:b.document.getWindow().getFrame()).equals(a)&&b.focusManager.focus(c)}
function F(){CKEDITOR.env.gecko&&this.editor.unlockSelection();CKEDITOR.env.webkit||(this.editor.forceNextSelectionCheck(),this.editor.selectionChange(1))}function W(a){if(a.draggable){var b=a.editor;b.editable();var c=new CKEDITOR.dom.element("img",b.document),d=new CKEDITOR.dom.element("span",b.document);d.setAttributes({"class":"cke_reset cke_widget_drag_handler_container",style:"background:rgba(220,220,220,0.5);background-image:url("+b.plugins.widget.path+"images/handle.png)"});c.setAttributes({"class":"cke_reset cke_widget_drag_handler",
"data-cke-widget-drag-handler":"1",src:G,width:m,title:b.lang.widget.move,height:m});if(a.inline)c.setAttribute("draggable","true"),c.on("dragstart",function(c){c.data.$.dataTransfer.setData("text",JSON.stringify({type:"cke-widget",editor:b.name,id:a.id}))});else c.on("mousedown",X,a);d.append(c);a.wrapper.append(d);a.dragHandlerContainer=d}}function X(){function a(){var a;for(k.reset();a=f.pop();)a.removeListener();var b=h,c=this.repository.finder;a=this.repository.liner;var d=this.editor,e=this.editor.editable();
CKEDITOR.tools.isEmpty(a.visible)||(b=c.getRange(b[0]),this.focus(),d.fire("saveSnapshot"),d.fire("lockSnapshot",{dontUpdate:1}),d.getSelection().reset(),e.insertElementIntoRange(this.wrapper,b),this.focus(),d.fire("unlockSnapshot"),d.fire("saveSnapshot"));e.removeClass("cke_widget_dragging");a.hideVisible()}var b=this.repository.finder,c=this.repository.locator,d=this.repository.liner,e=this.editor,g=e.editable(),f=[],h=[],i=b.greedySearch(),k=CKEDITOR.tools.eventsBuffer(50,function(){j=c.locate(i);
h=c.sort(l,1);h.length&&(d.prepare(i,j),d.placeLine(h[0]),d.cleanup())}),j,l;g.addClass("cke_widget_dragging");f.push(g.on("mousemove",function(a){l=a.data.$.clientY;k.input()}));f.push(e.document.once("mouseup",a,this));f.push(CKEDITOR.document.once("mouseup",a,this))}function Y(a){var b,c,d=a.editables;a.editables={};if(a.editables)for(b in d)c=d[b],a.initEditable(b,"string"==typeof c?{selector:c}:c)}function Z(a){if(a.mask){var b=new CKEDITOR.dom.element("img",a.editor.document);b.setAttributes({src:G,
"class":"cke_reset cke_widget_mask"});a.wrapper.append(b);a.mask=b}}function $(a){if(a.parts){var b={},c,d;for(d in a.parts)c=a.wrapper.findOne(a.parts[d]),b[d]=c;a.parts=b}}function P(a,b){aa(a);$(a);Y(a);Z(a);W(a);if(CKEDITOR.env.ie&&9>CKEDITOR.env.version)a.wrapper.on("dragstart",function(b){l(a,b.data.getTarget())||b.data.preventDefault()});a.wrapper.removeClass("cke_widget_new");a.element.addClass("cke_widget_element");a.on("key",function(b){b=b.data.keyCode;if(13==b)a.edit();else{if(b==CKEDITOR.CTRL+
67||b==CKEDITOR.CTRL+88){B(a,b==CKEDITOR.CTRL+88);return}if(b in ba||CKEDITOR.CTRL&b||CKEDITOR.ALT&b)return}return!1},null,null,999);a.on("doubleclick",function(b){a.edit();b.cancel()});if(b.data)a.on("data",b.data);if(b.edit)a.on("edit",b.edit);if(a.draggable)a.on("data",function(){var b=a.dragHandlerContainer;b.setStyle("top",a.element.$.offsetTop-m+"px");b.setStyle("left",a.element.$.offsetLeft+"px")},null,null,999)}function aa(a){(a.wrapper=a.element.getParent()).setAttribute("data-cke-widget-id",
a.id)}function r(a){a.element.data("cke-widget-data",JSON.stringify(a.data))}var m=15;CKEDITOR.plugins.add("widget",{requires:"lineutils,clipboard",onLoad:function(){CKEDITOR.addCss(".cke_widget_wrapper{position:relative;outline:none}.cke_widget_inline{display:inline-block}.cke_widget_wrapper:hover>.cke_widget_element{outline:2px solid yellow;cursor:default}.cke_widget_wrapper:hover .cke_widget_editable{outline:2px solid yellow}.cke_widget_wrapper.cke_widget_focused>.cke_widget_element,.cke_widget_wrapper .cke_widget_editable.cke_widget_editable_focused{outline:2px solid #ace}.cke_widget_editable{cursor:text}.cke_widget_drag_handler_container{position:absolute;width:"+
...
d.split(",");d.length;)this._.upcasts.push([c.upcasts[d.pop()],c.name]);else this._.upcasts.push([d,c.name]);b.button||this.editor.addFeature(b);return this.registered[a]=b},checkSelection:function(){var a=this.editor.getSelection(),b=a.getSelectedElement(),c=C(this),d;if(b&&(d=this.getByElement(b,!0)))return c.focus(d).select(d).commit();a=a.getRanges()[0];if(!a||a.collapsed)return c.commit();a=new CKEDITOR.dom.walker(a);for(a.evaluator=z;b=a.next();)c.select(this.getByElement(b));c.commit()},checkWidgets:function(a){this.fire("checkWidgets",
...
a)},finalizeCreation:function(a){if((a=a.getFirst())&&z(a))this.editor.insertElement(a),a=this.getByElement(a),a.ready=!0,a.fire("ready"),a.focus()},getByElement:function(a,b){if(!a)return null;var c,d;for(d in this.instances)if(c=this.instances[d].wrapper,c.equals(a)||!b&&c.contains(a))return this.instances[d];return null},initOn:function(a,b,c){b?"string"==typeof b&&(b=this.registered[b]):b=this.registered[a.data("widget")];if(!b)return null;var d=this.wrapElement(a,b.name);return d?d.hasClass("cke_widget_new")?
(a=new j(this,this._.nextId++,a,b,c),a.isInited()?this.instances[a.id]=a:null):this.getByElement(a):null},initOnAll:function(a){for(var a=(a||this.editor.editable()).find(".cke_widget_new"),b=[],c,d=a.count();d--;)(c=this.initOn(a.getItem(d).getFirst(q)))&&b.push(c);return b},wrapElement:function(a,b){var c=null,d,e;if(a instanceof CKEDITOR.dom.element){d=this.registered[b||a.data("widget")];if(!d)return null;if((c=a.getParent())&&c.type==CKEDITOR.NODE_ELEMENT&&c.data("cke-widget-wrapper"))return c;
a.hasAttribute("data-cke-widget-keep-attr")||a.data("cke-widget-keep-attr",a.data("widget")?1:0);b&&a.data("widget",b);e=y(d,a.getName());c=new CKEDITOR.dom.element(e?"span":"div");c.setAttributes(w(e));c.data("cke-display-name",d.pathName?d.pathName:a.getName());a.getParent(!0)&&c.replace(a);a.appendTo(c)}else if(a instanceof CKEDITOR.htmlParser.element){d=this.registered[b||a.attributes["data-widget"]];if(!d)return null;if((c=a.parent)&&c.type==CKEDITOR.NODE_ELEMENT&&c.attributes["data-cke-widget-wrapper"])return c;
"data-cke-widget-keep-attr"in a.attributes||(a.attributes["data-cke-widget-keep-attr"]=a.attributes["data-widget"]?1:0);b&&(a.attributes["data-widget"]=b);e=y(d,a.name);c=new CKEDITOR.htmlParser.element(e?"span":"div",w(e));c.attributes["data-cke-display-name"]=d.pathName?d.pathName:a.name;d=a.parent;var g;d&&(g=a.getIndex(),a.remove());c.add(a);d&&x(d,g,c)}return c},_tests_getNestedEditable:l,_tests_createEditableFilter:t};CKEDITOR.event.implementOn(o.prototype);j.prototype={destroy:function(a){this.fire("destroy");
if(this.editables)for(var b in this.editables)this.destroyEditable(b,a);a||("0"==this.element.data("cke-widget-keep-attr")&&this.element.removeAttribute("data-widget"),this.element.removeAttributes(["data-cke-widget-data","data-cke-widget-keep-attr"]),this.element.removeClass("cke_widget_element"),this.element.replace(this.wrapper));this.wrapper=null},destroyEditable:function(a,b){var c=this.editables[a];c.removeListener("focus",F);c.removeListener("blur",E);this.editor.focusManager.remove(c);b||
(c.removeClass("cke_widget_editable"),c.removeClass("cke_widget_editable_focused"),c.removeAttributes(["contenteditable","data-cke-widget-editable","data-cke-enter-mode"]));delete this.editables[a]},edit:function(){var a={dialog:this.dialog},b=this;this.fire("edit",a)&&a.dialog&&this.editor.openDialog(a.dialog,function(a){var d,e;b.fire("dialog",a)&&(d=a.on("show",function(){a.setupContent(b)}),e=a.on("ok",function(){var d,e=b.on("data",function(a){d=1;a.cancel()},null,null,0);b.editor.fire("saveSnapshot");
a.commitContent(b);e.removeListener();d&&(b.fire("data",b.data),b.editor.fire("saveSnapshot"))}),a.once("hide",function(){d.removeListener();e.removeListener()}))})},initEditable:function(a,b){var c=this.wrapper.findOne(b.selector);return c&&c.is(CKEDITOR.dtd.$editable)?(c=new p(this.editor,c,{filter:t.call(this.repository,this.name,a,b)}),this.editables[a]=c,c.setAttributes({contenteditable:"true","data-cke-widget-editable":a,"data-cke-enter-mode":c.enterMode}),c.filter&&c.data("cke-filter",c.filter.id),
c.addClass("cke_widget_editable"),c.removeClass("cke_widget_editable_focused"),b.pathName&&c.data("cke-display-name",b.pathName),this.editor.focusManager.add(c),c.on("focus",F,this),CKEDITOR.env.ie&&c.on("blur",E,this),c.setData(c.getHtml()),!0):!1},isInited:function(){return!(!this.wrapper||!this.inited)},isReady:function(){return this.isInited()&&this.ready},focus:function(){var a=this.editor.getSelection();a&&a.fake(this.wrapper);this.editor.focus()},setData:function(a,b){var c=this.data,d=0;if("string"==
typeof a)c[a]!==b&&(c[a]=b,d=1);else{var e=a;for(a in e)c[a]!==e[a]&&(d=1,c[a]=e[a])}d&&this.dataReady&&(r(this),this.fire("data",c));return this},setFocused:function(a){this.wrapper[a?"addClass":"removeClass"]("cke_widget_focused");this.fire(a?"focus":"blur");return this},setSelected:function(a){this.wrapper[a?"addClass":"removeClass"]("cke_widget_selected");this.fire(a?"select":"deselect");return this}};CKEDITOR.event.implementOn(j.prototype);p.prototype=CKEDITOR.tools.extend(CKEDITOR.tools.prototypedCopy(CKEDITOR.dom.element.prototype),
...
G="data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D",ba={37:1,38:1,39:1,40:1,8:1,46:1};CKEDITOR.plugins.widget=j;j.repository=o;j.nestedEditable=p})();(function(){CKEDITOR.plugins.add("placeholder",{requires:"widget,dialog",onLoad:function(){CKEDITOR.addCss(".cke_placeholder{background-color:#ff0}")},init:function(a){var b=a.lang.placeholder;CKEDITOR.dialog.add("placeholder",this.path+"dialogs/placeholder.js");a.widgets.add("placeholder",{dialog:"placeholder",pathName:b.pathName,template:'<span class="cke_placeholder">[[]]</span>',downcast:function(){return new CKEDITOR.htmlParser.text("[["+this.data.name+"]]")},init:function(){this.setData("name",
this.element.getText().slice(2,-2))},data:function(){this.element.setText("[["+this.data.name+"]]")}});a.ui.addButton&&a.ui.addButton("CreatePlaceholder",{label:b.toolbar,command:"placeholder",toolbar:"insert,5",icon:"placeholder"})},afterInit:function(a){var b=/\[\[([^\[\]])+\]\]/g;a.dataProcessor.dataFilter.addRules({text:function(d){return d.replace(b,function(b){var c=null,c=new CKEDITOR.htmlParser.element("span",{"class":"cke_placeholder"});c.add(new CKEDITOR.htmlParser.text(b));c=a.widgets.wrapElement(c,
"placeholder");return c.getOuterHtml()})}})}})})();(function(){function h(b,e,c){var i=[],g=[],a;for(a=0;a<b.styleSheets.length;a++){var d=b.styleSheets[a];if(!(d.ownerNode||d.owningElement).getAttribute("data-cke-temp")&&!(d.href&&"chrome://"==d.href.substr(0,9)))try{for(var f=d.cssRules||d.rules,d=0;d<f.length;d++)g.push(f[d].selectorText)}catch(h){}}a=g.join(" ");a=a.replace(/(,|>|\+|~)/g," ");a=a.replace(/\[[^\]]*/g,"");a=a.replace(/#[^\s]*/g,"");a=a.replace(/\:{1,2}[^\s]*/g,"");a=a.replace(/\s+/g," ");a=a.split(" ");b=[];for(g=0;g<a.length;g++)f=
...
g<=e.x+e.width){g=e;break a}}g=null}g&&(!i&&(i=new z(b)),i.attachTo(g))}}})})}})})();CKEDITOR.plugins.add("uicolor",{requires:"dialog",init:function(a){CKEDITOR.env.ie6Compat||(a.addCommand("uicolor",new CKEDITOR.dialogCommand("uicolor")),a.ui.addButton&&a.ui.addButton("UIColor",{label:a.lang.uicolor.title,command:"uicolor",toolbar:"tools,1"}),CKEDITOR.dialog.add("uicolor",this.path+"dialogs/uicolor.js"),CKEDITOR.scriptLoader.load(CKEDITOR.getUrl("plugins/uicolor/yui/yui.js")),CKEDITOR.document.appendStyleSheet(CKEDITOR.getUrl("plugins/uicolor/yui/assets/yui.css")))}});(function(){CKEDITOR.plugins.add("codemirror",{icons:"SearchCode,AutoFormat,CommentSelectedRange,UncommentSelectedRange,AutoComplete",lang:"af,ar,bg,bn,bs,ca,cs,cy,da,de,el,en-au,en-ca,en-gb,en,eo,es,et,eu,fa,fi,fo,fr-ca,fr,gl,gu,he,hi,hr,hu,is,it,ja,ka,km,ko,ku,lt,lv,mk,mn,ms,nb,nl,no,pl,pt-br,pt,ro,ru,sk,sl,sr-latn,sr,sv,th,tr,ug,uk,vi,zh-cn,zh",version:1.1,init:function(b){function f(){var a=[e+"js/codemirror.addons.min.js"];switch(c.mode){case "htmlmixed":a.push(e+"js/codemirror.mode.htmlmixed.min.js");
break;case "text/html":a.push(e+"js/codemirror.mode.htmlmixed.min.js");break;case "application/x-httpd-php":a.push(e+"js/codemirror.mode.php.min.js");break;case "text/javascript":a.push(e+"js/codemirror.mode.javascript.min.js");break;default:a.push(e+"js/codemirror.mode.htmlmixed.min.js")}c.useBeautify&&a.push(e+"js/beautify.min.js");c.enableSearchTools&&a.push(e+"js/codemirror.addons.search.min.js");return a}function j(a){var b=a.ui.space("contents").getDocument().createElement("textarea");b.setStyles(CKEDITOR.tools.extend({width:CKEDITOR.env.ie7Compat?
"99%":"100%",height:"100%",resize:"none",outline:"none","text-align":"left"},CKEDITOR.tools.cssVendorPrefix("tab-size",a.config.sourceAreaTabSize||4)));var e=[a.lang.editor,a.name].join();b.setAttributes({dir:"ltr",tabIndex:CKEDITOR.env.webkit?-1:a.tabIndex,role:"textbox","aria-label":e});b.addClass("cke_source cke_reset cke_enable_context_menu");a.ui.space("contents").append(b);window["editable_"+a.id]=a.editable(new d(a,b));window["editable_"+a.id].setData(a.getData(1));window["editable_"+a.id].editorID=
a.id;a.fire("ariaWidget",this);var f,b=window["editable_"+a.id],e=b.getParent();c.lineNumbers&&c.enableCodeFolding&&(window["foldFunc_"+a.id]=CodeMirror.newFoldFunction(CodeMirror.tagRangeFinder));window["codemirror_"+a.id]=CodeMirror.fromTextArea(b.$,{mode:c.mode,matchBrackets:c.matchBrackets,matchTags:c.matchTags,workDelay:300,workTime:35,readOnly:a.config.readOnly,lineNumbers:c.lineNumbers,lineWrapping:c.lineWrapping,autoCloseTags:c.autoCloseTags,autoCloseBrackets:c.autoCloseBrackets,highlightSelectionMatches:c.highlightMatches,
continueComments:c.continueComments,indentWithTabs:c.indentWithTabs,theme:c.theme,showTrailingSpace:c.showTrailingSpace,showCursorWhenSelecting:!0,extraKeys:{"Ctrl-Q":function(b){window["foldFunc_"+a.id](b,b.getCursor().line)}},onKeyEvent:function(b,g){if(c.enableCodeFormatting){var d=window["codemirror_"+a.id].getCursor(!0),e=window["codemirror_"+a.id].getCursor(!1);"keydown"===g.type&&g.ctrlKey&&75===g.keyCode&&!g.shiftKey&&!g.altKey?window["codemirror_"+a.id].commentRange(!0,d,e):"keydown"===g.type&&
g.ctrlKey&&75===g.keyCode&&g.shiftKey&&!g.altKey?(window["codemirror_"+a.id].commentRange(!1,d,e),c.autoFormatOnUncomment&&window["codemirror_"+a.id].autoFormatRange(d,e)):"keydown"===g.type&&(g.ctrlKey&&75===g.keyCode&&!g.shiftKey&&g.altKey)&&window["codemirror_"+a.id].autoFormatRange(d,e)}}});b=e.$.clientHeight+"px";e=e.$.clientWidth+"px";window["codemirror_"+a.id].config=c;if(c.autoFormatOnStart)if(c.useBeautify){var h=window["codemirror_"+a.id].getValue();window["codemirror_"+a.id].setValue(html_beautify(h,
4," ",120,"collapse"))}else window["codemirror_"+a.id].autoFormatAll({line:0,ch:0},{line:window["codemirror_"+a.id].lineCount(),ch:0});window["codemirror_"+a.id].on("change",function(){clearTimeout(f);f=setTimeout(function(){var b=window["codemirror_"+a.id];b&&b.save()},300)});window["codemirror_"+a.id].setSize(e,b);if(c.lineNumbers&&c.enableCodeFolding)window["codemirror_"+a.id].on("gutterClick",window["foldFunc_"+a.id]);c.highlightActiveLine&&(window["codemirror_"+a.id].hlLine=window["codemirror_"+
a.id].addLineClass(0,"background","activeline"),window["codemirror_"+a.id].on("cursorActivity",function(){try{var b=window["codemirror_"+a.id].getLineHandle(window["codemirror_"+a.id].getCursor().line)}catch(c){b=null}finally{null!=b&&b!=window["codemirror_"+a.id].hlLine&&(window["codemirror_"+a.id].removeLineClass(window["codemirror_"+a.id].hlLine,"background","activeline"),window["codemirror_"+a.id].hlLine=window["codemirror_"+a.id].addLineClass(b,"background","activeline"))}}));if("function"===
typeof c.onLoad)c.onLoad(window["codemirror_"+a.id],a)}var e=this.path,c=CKEDITOR.tools.extend({autoCloseBrackets:!0,autoCloseTags:!0,autoFormatOnStart:!1,autoFormatOnUncomment:!0,continueComments:!0,enableCodeFolding:!0,enableCodeFormatting:!0,enableSearchTools:!0,highlightActiveLine:!0,highlightMatches:!0,indentWithTabs:!1,lineNumbers:!0,lineWrapping:!0,mode:"htmlmixed",matchBrackets:!0,matchTags:!0,showAutoCompleteButton:!0,showCommentButton:!0,showFormatButton:!0,showSearchButton:!0,showTrailingSpace:!0,
showUncommentButton:!0,theme:"default",useBeautify:!1},b.config.codemirror||{},!0),h=b.lang.codemirror;b.config.codemirror_theme&&(c.theme=b.config.codemirror_theme);b.config.codemirror_autoFormatOnStart&&(c.autoFormatOnStart=b.config.codemirror_autoFormatOnStart);if(b.elementMode===CKEDITOR.ELEMENT_MODE_INLINE)CKEDITOR.dialog.add("sourcedialog",function(a){function b(a,d){var e;window["codemirror_"+a.id]=CodeMirror.fromTextArea(d,{mode:c.mode,matchBrackets:c.matchBrackets,matchTags:c.matchTags,workDelay:300,
workTime:35,readOnly:a.config.readOnly,lineNumbers:c.lineNumbers,lineWrapping:c.lineWrapping,autoCloseTags:c.autoCloseTags,autoCloseBrackets:c.autoCloseBrackets,highligctionMatches:c.highlightMatches,continueComments:c.continueComments,indentWithTabs:c.indentWithTabs,theme:c.theme,showTrailingSpace:c.showTrailingSpace,showCursorWhenSelecting:true,viewportMargin:Infinity,extraKeys:{"Ctrl-Q":function(b){window["foldFunc_"+a.id](b,b.getCursor().line)}},onKeyEvent:function(b,d){if(c.enableCodeFormatting){var e=
window["codemirror_"+a.id].getCursor(true),f=window["codemirror_"+a.id].getCursor(false);if(d.type==="keydown"&&d.ctrlKey&&d.keyCode===75&&!d.shiftKey&&!d.altKey)window["codemirror_"+a.id].commentRange(true,e,f);else if(d.type==="keydown"&&d.ctrlKey&&d.keyCode===75&&d.shiftKey&&!d.altKey){window["codemirror_"+a.id].commentRange(false,e,f);c.autoFormatOnUncomment&&window["codemirror_"+a.id].autoFormatRange(e,f)}else d.type==="keydown"&&(d.ctrlKey&&d.keyCode===75&&!d.shiftKey&&d.altKey)&&window["codemirror_"+
a.id].autoFormatRange(e,f)}}});var f=k+"px",m=j+"px";window["codemirror_"+a.id].config=c;if(c.autoFormatOnStart)if(c.useBeautify){var h=window["codemirror_"+a.id].getValue();window["codemirror_"+a.id].setValue(html_beautify(h,4," ",120,"collapse"))}else window["codemirror_"+a.id].autoFormatAll({line:0,ch:0},{line:window["codemirror_"+a.id].lineCount(),ch:0});window["codemirror_"+a.id].on("change",function(){clearTimeout(e);e=setTimeout(function(){var b=window["codemirror_"+a.id];b&&b.save()},300)});
window["codemirror_"+a.id].setSize(m,f);if(c.lineNumbers&&c.enableCodeFolding)window["codemirror_"+a.id].on("gutterClick",window["foldFunc_"+a.id]);if(c.highlightActiveLine){window["codemirror_"+a.id].hlLine=window["codemirror_"+a.id].addLineClass(0,"background","activeline");window["codemirror_"+a.id].on("cursorActivity",function(){var b=window["codemirror_"+a.id].getLineHandle(window["codemirror_"+a.id].getCursor().line);if(b!=window["codemirror_"+a.id].hlLine){window["codemirror_"+a.id].removeLineClass(window["codemirror_"+
a.id].hlLine,"background","activeline");window["codemirror_"+a.id].hlLine=window["codemirror_"+a.id].addLineClass(b,"background","activeline")}})}if(typeof c.onLoad==="function")c.onLoad(window["codemirror_"+a.id],a)}var d=CKEDITOR.document.getWindow().getViewPaneSize(),j=Math.min(d.width-70,800),k=d.height/1.5,l;return{title:a.lang.sourcedialog.title,minWidth:j,minHeight:k,resizable:CKEDITOR.DIALOG_RESIZE_NONE,onShow:function(){this.getContentElement("main","data").focus();this.getContentElement("main",
"AutoComplete").setValue(c.autoCloseTags,true);var d=this.getContentElement("main","data").getInputElement().$;this.setValueOf("main","data",l=a.getData());if(typeof CodeMirror=="undefined"){CKEDITOR.document.appendStyleSheet(e+"css/codemirror.min.css");c.theme.length&&c.theme!="default"&&CKEDITOR.document.appendStyleSheet(e+"theme/"+c.theme+".css");CKEDITOR.scriptLoader.load(e+"js/codemirror.min.js",function(){CKEDITOR.scriptLoader.load(f(),function(){b(a,d)})})}else b(a,d)},onCancel:function(b){if(b.data.hide){window["codemirror_"+
a.id].toTextArea();window["codemirror_"+a.id]=null}},onOk:function(){function b(c){var d=this;a.setData(c,function(){d.hide();var b=a.createRange();b.moveToElementEditStart(a.editable());b.select()})}return function(){window["codemirror_"+a.id].toTextArea();window["codemirror_"+a.id]=null;var c=this.getValueOf("main","data").replace(/\r/g,"");if(c===l)return true;CKEDITOR.env.ie?CKEDITOR.tools.setTimeout(b,0,this,c):b.call(this,c);return false}}(),contents:[{id:"main",label:a.lang.sourcedialog.title,
elements:[{type:"hbox",style:"width: 80px;margin:0;",widths:["20px","20px","20px","20px"],children:[{type:"button",id:"searchCode",label:"",title:h.searchCode,"class":"searchCodeButton",onClick:function(){CodeMirror.commands.find(window["codemirror_"+a.id])}},{type:"button",id:"autoFormat",label:"",title:h.autoFormat,"class":"autoFormat",onClick:function(){var b=window["codemirror_"+a.id].getCursor(true),c=window["codemirror_"+a.id].getCursor(false);window["codemirror_"+a.id].autoFormatRange(b,c)}},
{type:"button",id:"CommentSelectedRange",label:"",title:h.commentSelectedRange,"class":"CommentSelectedRange",onClick:function(){var b=window["codemirror_"+a.id].getCursor(true),c=window["codemirror_"+a.id].getCursor(false);window["codemirror_"+a.id].commentRange(true,b,c)}},{type:"button",id:"UncommentSelectedRange",label:"",title:h.uncommentSelectedRange,"class":"UncommentSelectedRange",onClick:function(){var b=window["codemirror_"+a.id].getCursor(true),c=window["codemirror_"+a.id].getCursor(false);
window["codemirror_"+a.id].commentRange(false,b,c);window["codemirror_"+a.id].config.autoFormatOnUncomment&&window["codemirror_"+a.id].autoFormatRange(b,c)}}]},{type:"checkbox",id:"AutoComplete",label:h.autoCompleteToggle,title:h.autoCompleteToggle,onChange:function(){window["codemirror_"+a.id].setOption("autoCloseTags",this.getValue())}},{type:"textarea",id:"data",dir:"ltr",inputStyle:"cursor:auto;width:"+j+"px;height:"+k+"px;tab-size:4;text-align:left;","class":"cke_source cke_enable_context_menu"}]}]}});
else{var k=CKEDITOR.plugins.sourcearea;k.commands.searchCode||(CKEDITOR.plugins.sourcearea.commands={source:{modes:{wysiwyg:1,source:1},editorFocus:!1,readOnly:1,exec:function(a){a.mode==="wysiwyg"&&a.fire("saveSnapshot");a.getCommand("source").setState(CKEDITOR.TRISTATE_DISABLED);a.setMode(a.mode==="source"?"wysiwyg":"source")},canUndo:!1},searchCode:{modes:{wysiwyg:0,source:1},editorFocus:!1,readOnly:1,exec:function(a){CodeMirror.commands.find(window["codemirror_"+a.id])},canUndo:!0},autoFormat:{modes:{wysiwyg:0,
...
CKEDITOR.TRISTATE_OFF&&window["codemirror_"+a.id].setOption("autoCloseTags",true);this.toggleState()},canUndo:!0}});b.addMode("source",function(a){if(typeof CodeMirror=="undefined"){CKEDITOR.document.appendStyleSheet(e+"css/codemirror.min.css");c.theme.length&&c.theme!="default"&&CKEDITOR.document.appendStyleSheet(e+"theme/"+c.theme+".css");CKEDITOR.scriptLoader.load(e+"js/codemirror.min.js",function(){CKEDITOR.scriptLoader.load(f(),function(){j(b);a()})})}else{j(b);a()}});b.addCommand("source",k.commands.source);
b.ui.addButton&&b.ui.addButton("Source",{label:b.lang.codemirror.toolbar,command:"source",toolbar:"mode,10"});c.enableCodeFormatting&&(b.addCommand("searchCode",k.commands.searchCode),b.addCommand("autoFormat",k.commands.autoFormat),b.addCommand("commentSelectedRange",k.commands.commentSelectedRange),b.addCommand("uncommentSelectedRange",k.commands.uncommentSelectedRange),b.addCommand("autoCompleteToggle",k.commands.autoCompleteToggle),b.ui.addButton&&((c.showFormatButton||c.showCommentButton||c.showUncommentButton||
c.showSearchButton)&&b.ui.add("-",CKEDITOR.UI_SEPARATOR,{toolbar:"mode,30"}),c.showSearchButton&&c.enableSearchTools&&b.ui.addButton("searchCode",{label:h.searchCode,command:"searchCode",toolbar:"mode,40"}),c.showFormatButton&&b.ui.addButton("autoFormat",{label:h.autoFormat,command:"autoFormat",toolbar:"mode,50"}),c.showCommentButton&&b.ui.addButton("CommentSelectedRange",{label:h.commentSelectedRange,command:"commentSelectedRange",toolbar:"mode,60"}),c.showUncommentButton&&b.ui.addButton("UncommentSelectedRange",
{label:h.uncommentSelectedRange,command:"uncommentSelectedRange",toolbar:"mode,70"}),c.showAutoCompleteButton&&b.ui.addButton("AutoComplete",{label:h.autoCompleteToggle,command:"autoCompleteToggle",toolbar:"mode,80"})));b.on("beforeModeUnload",function(a){if(b.mode==="source"&&b.plugins.textselection){var c=b.getTextSelection();c.startOffset=LineChanngelToOffSet(window["codemirror_"+b.id],window["codemirror_"+b.id].getCursor(true));c.endOffset=LineChanngelToOffSet(window["codemirror_"+b.id],window["codemirror_"+
b.id].getCursor(false));delete c.element;c.createBookmark();sourceBookmark=true;a.data=c.content}});b.on("mode",function(){b.getCommand("source").setState(b.mode==="source"?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF);if(b.mode==="source"){b.getCommand("autoCompleteToggle").setState(window["codemirror_"+b.id].config.autoCloseTags?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF);if(b.plugins.textselection&&textRange){textRange.element=new CKEDITOR.dom.element(b._.editable.$);textRange.select();var a,c;a=
OffSetToLineChannel(window["codemirror_"+b.id],textRange.startOffset);if(typeof textRange.endOffset=="undefined")window["codemirror_"+b.id].setCursor(a);else{c=OffSetToLineChannel(window["codemirror_"+b.id],textRange.endOffset);window["codemirror_"+b.id].setSelection(a,c)}}}});b.on("resize",function(){if(window["editable_"+b.id]&&b.mode==="source"){var a=window["editable_"+b.id].getParent();window["codemirror_"+b.id].setSize(a.$.clientWidth+"px",a.$.clientHeight+"px")}});b.on("readOnly",function(){window["editable_"+
b.id]&&b.mode==="source"&&window["codemirror_"+b.id].setOption("readOnly",this.readOnly)});b.on("instanceReady",function(){var a=b.commands.selectAll;if(a!=null)a.exec=function(){if(b.mode==="source")window["codemirror_"+b.id].setSelection({line:0,ch:0},{line:window["codemirror_"+b.id].lineCount(),ch:0});else{var a=b.editable();if(a.is("body"))b.document.$.execCommand("SelectAll",false,null);else{var c=b.createRange();c.selectNodeContents(a);c.select()}b.forceNextSelectionCheck();b.selectionChange()}}});
b.on("setData",function(a){window["editable_"+b.id]&&b.mode==="source"&&window["codemirror_"+b.id].setValue(a.data.dataValue)})}}});var d=CKEDITOR.tools.createClass({base:CKEDITOR.editable,proto:{setData:function(b){this.setValue(b);null!=this.codeMirror&&this.codeMirror.setValue(b);this.editor.fire("dataReady")},getData:function(){return this.getValue()},insertHtml:function(){},insertElement:function(){},insertText:function(){},setReadOnly:function(b){this[(b?"set":"remove")+"Attribute"]("readOnly",
"readonly")},editorID:null,detach:function(){window["codemirror_"+this.editorID].toTextArea();window["editable_"+this.editorID]=null;window["codemirror_"+this.editorID]=null;d.baseProto.detach.call(this);this.clearCustomData();this.remove()}}})})();
...
this.toggleState()},canUndo:!0}}};function LineChanngelToOffSet(d,b){var f=b.line,j=f+b.ch;for(i=0;i<f;i++)j+=d.getLine(i).length;return j}function OffSetToLineChannel(d,b){var f=0,j=0,e=0;for(i=0;i<d.lineCount();i++){len=d.getLine(i).length;if(b<e+len){f=i;j=b-e;break}len++;e+=len}return{line:f,ch:j}};CKEDITOR.config.plugins='dialogui,dialog,about,autogrow,a11yhelp,dialogadvtab,basicstyles,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,toolbar,enterkey,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,forms,format,htmlwriter,horizontalrule,iframe,wysiwygarea,image,indent,smiley,justify,link,indentlist,list,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,selectall,showblocks,showborders,sourcearea,specialchar,stylescombo,tab,table,tabletools,undo,menubutton,iframedialog,xml,ajax,bidi,devtools,docprops,lineutils,widget,placeholder,stylesheetparser,tableresize,uicolor,codemirror';CKEDITOR.config.skin='kama';(function() {var setIcons = function(icons, strip) {var path = CKEDITOR.getUrl( 'plugins/' + strip );icons = icons.split( ',' );for ( var i = 0; i < icons.length; i++ )CKEDITOR.skin.icons[ icons[ i ] ] = { path: path, offset: -icons[ ++i ], bgsize : icons[ ++i ] };};if (CKEDITOR.env.hidpi) setIcons('about,0,,bold,24,,italic,48,,strike,72,,subscript,96,,superscript,120,,underline,144,,blockquote,168,,copy-rtl,192,,copy,216,,cut-rtl,240,,cut,264,,paste-rtl,288,,paste,312,,bgcolor,336,,textcolor,360,,templates-rtl,384,,templates,408,,creatediv,432,,find-rtl,456,,find,480,,replace,504,,flash,528,,button,552,,checkbox,576,,form,600,,hiddenfield,624,,imagebutton,648,,radio,672,,select-rtl,696,,select,720,,textarea-rtl,744,,textarea,768,,textfield-rtl,792,,textfield,816,,horizontalrule,840,,iframe,864,,image,888,,indent-rtl,912,,indent,936,,outdent-rtl,960,,outdent,984,,smiley,1008,,justifyblock,1032,,justifycenter,1056,,justifyleft,1080,,justifyright,1104,,anchor-rtl,1128,,anchor,1152,,link,1176,,unlink,1200,,bulletedlist-rtl,1224,,bulletedlist,1248,,numberedlist-rtl,1272,,numberedlist,1296,,maximize,1320,,newpage-rtl,1344,,newpage,1368,,pagebreak-rtl,1392,,pagebreak,1416,,pastetext-rtl,1440,,pastetext,1464,,pastefromword-rtl,1488,,pastefromword,1512,,preview-rtl,1536,,preview,1560,,print,1584,,removeformat,1608,,selectall,1632,,showblocks-rtl,1656,,showblocks,1680,,source-rtl,1704,,source,1728,,specialchar,1752,,table,1776,,redo-rtl,1800,,redo,1824,,undo-rtl,1848,,undo,1872,,bidiltr,1896,,bidirtl,1920,,docprops-rtl,1944,,docprops,1968,,placeholder,1992,,uicolor,2016,,AutoComplete,4080,auto,AutoFormat,4128,auto,CommentSelectedRange,4176,auto,SearchCode,4224,auto,UncommentSelectedRange,4272,auto','icons_hidpi.png');else setIcons('about,0,auto,bold,24,auto,italic,48,auto,strike,72,auto,subscript,96,auto,superscript,120,auto,underline,144,auto,blockquote,168,auto,copy-rtl,192,auto,copy,216,auto,cut-rtl,240,auto,cut,264,auto,paste-rtl,288,auto,paste,312,auto,bgcolor,336,auto,textcolor,360,auto,templates-rtl,384,auto,templates,408,auto,creatediv,432,auto,find-rtl,456,auto,find,480,auto,replace,504,auto,flash,528,auto,button,552,auto,checkbox,576,auto,form,600,auto,hiddenfield,624,auto,imagebutton,648,auto,radio,672,auto,select-rtl,696,auto,select,720,auto,textarea-rtl,744,auto,textarea,768,auto,textfield-rtl,792,auto,textfield,816,auto,horizontalrule,840,auto,iframe,864,auto,image,888,auto,indent-rtl,912,auto,indent,936,auto,outdent-rtl,960,auto,outdent,984,auto,smiley,1008,auto,justifyblock,1032,auto,justifycenter,1056,auto,justifyleft,1080,auto,justifyright,1104,auto,anchor-rtl,1128,auto,anchor,1152,auto,link,1176,auto,unlink,1200,auto,bulletedlist-rtl,1224,auto,bulletedlist,1248,auto,numberedlist-rtl,1272,auto,numberedlist,1296,auto,maximize,1320,auto,newpage-rtl,1344,auto,newpage,1368,auto,pagebreak-rtl,1392,auto,pagebreak,1416,auto,pastetext-rtl,1440,auto,pastetext,1464,auto,pastefromword-rtl,1488,auto,pastefromword,1512,auto,preview-rtl,1536,auto,preview,1560,auto,print,1584,auto,removeformat,1608,auto,selectall,1632,auto,showblocks-rtl,1656,auto,showblocks,1680,auto,source-rtl,1704,auto,source,1728,auto,specialchar,1752,auto,table,1776,auto,redo-rtl,1800,auto,redo,1824,auto,undo-rtl,1848,auto,undo,1872,auto,bidiltr,1896,auto,bidirtl,1920,auto,docprops-rtl,1944,auto,docprops,1968,auto,placeholder,1992,auto,uicolor,2016,auto,AutoComplete,2040,auto,AutoFormat,2064,auto,CommentSelectedRange,2088,auto,SearchCode,2112,auto,UncommentSelectedRange,2136,auto','icons.png');})();CKEDITOR.lang.languages={"ar":1,"ca":1,"en":1,"fr":1,"de":1,"pt-br":1,"pt":1,"es":1};}());