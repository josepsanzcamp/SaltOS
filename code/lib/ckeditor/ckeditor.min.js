...
*/
(function(){window.CKEDITOR&&window.CKEDITOR.dom||(window.CKEDITOR||(window.CKEDITOR=function(){var a=/(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i,e={timestamp:"G14K",version:"4.5.6",revision:"91e81fe",rnd:Math.floor(900*Math.random())+100,_:{pending:[],basePathSrcPattern:a},status:"unloaded",basePath:function(){var b=window.CKEDITOR_BASEPATH||"";if(!b)for(var c=document.getElementsByTagName("script"),e=0;e<c.length;e++){var f=c[e].src.match(a);if(f){b=f[1];break}}-1==b.indexOf(":/")&&"//"!=b.slice(0,
...
CKEDITOR.event.prototype=function(){function a(a){var d=e(this);return d[a]||(d[a]=new b(a))}var e=function(a){a=a.getPrivate&&a.getPrivate()||a._||(a._={});return a.events||(a.events={})},b=function(a){this.name=a;this.listeners=[]};b.prototype={getListenerIndex:function(a){for(var b=0,e=this.listeners;b<e.length;b++)if(e[b].fn==a)return b;return-1}};return{define:function(b,d){var e=a.call(this,b);CKEDITOR.tools.extend(e,d,!0)},on:function(b,d,e,l,f){function h(g,a,f,h){g={name:b,sender:this,editor:g,
data:a,listenerData:l,stop:f,cancel:h,removeListener:k};return!1===d.call(e,g)?!1:g.data}function k(){n.removeListener(b,d)}var g=a.call(this,b);if(0>g.getListenerIndex(d)){g=g.listeners;e||(e=this);isNaN(f)&&(f=10);var n=this;h.fn=d;h.priority=f;for(var u=g.length-1;0<=u;u--)if(g[u].priority<=f)return g.splice(u+1,0,h),{removeListener:k};g.unshift(h)}return{removeListener:k}},once:function(){var a=Array.prototype.slice.call(arguments),b=a[1];a[1]=function(a){a.removeListener();return b.apply(this,
arguments)};return this.on.apply(this,a)},capture:function(){CKEDITOR.event.useCapture=1;var a=this.on.apply(this,arguments);CKEDITOR.event.useCapture=0;return a},fire:function(){var a=0,b=function(){a=1},m=0,l=function(){m=1};return function(f,h,k){var g=e(this)[f];f=a;var n=m;a=m=0;if(g){var u=g.listeners;if(u.length)for(var u=u.slice(0),t,r=0;r<u.length;r++){if(g.errorProof)try{t=u[r].call(this,k,h,b,l)}catch(q){}else t=u[r].call(this,k,h,b,l);!1===t?m=1:"undefined"!=typeof t&&(h=t);if(a||m)break}}h=
...
a.getComputedStyle("position"))return a;a=a.getParent()}return null},getDocumentPosition:function(a){var b=0,c=0,g=this.getDocument(),d=g.getBody(),e="BackCompat"==g.$.compatMode;if(document.documentElement.getBoundingClientRect){var m=this.$.getBoundingClientRect(),l=g.$.documentElement,q=l.clientTop||d.$.clientTop||0,p=l.clientLeft||d.$.clientLeft||0,w=!0;CKEDITOR.env.ie&&(w=g.getDocumentElement().contains(this),g=g.getBody().contains(this),w=e&&g||!e&&w);w&&(CKEDITOR.env.webkit||CKEDITOR.env.ie&&
12<=CKEDITOR.env.version?(b=d.$.scrollLeft||l.scrollLeft,c=d.$.scrollTop||l.scrollTop):(c=e?d.$:l,b=c.scrollLeft,c=c.scrollTop),b=m.left+b-p,c=m.top+c-q)}else for(q=this,p=null;q&&"body"!=q.getName()&&"html"!=q.getName();){b+=q.$.offsetLeft-q.$.scrollLeft;c+=q.$.offsetTop-q.$.scrollTop;q.equals(this)||(b+=q.$.clientLeft||0,c+=q.$.clientTop||0);for(;p&&!p.equals(q);)b-=p.$.scrollLeft,c-=p.$.scrollTop,p=p.getParent();p=q;q=(m=q.$.offsetParent)?new CKEDITOR.dom.element(m):null}a&&(m=this.getWindow(),
q=a.getWindow(),!m.equals(q)&&m.$.frameElement&&(a=(new CKEDITOR.dom.element(m.$.frameElement)).getDocumentPosition(a),b+=a.x,c+=a.y));document.documentElement.getBoundingClientRect||!CKEDITOR.env.gecko||e||(b+=this.$.clientLeft?1:0,c+=this.$.clientTop?1:0);return{x:b,y:c}},scrollIntoView:function(a){var b=this.getParent();if(b){do if((b.$.clientWidth&&b.$.clientWidth<b.$.scrollWidth||b.$.clientHeight&&b.$.clientHeight<b.$.scrollHeight)&&!b.is("body")&&this.scrollIntoParent(b,a,1),b.is("html")){var c=
b.getWindow();try{var g=c.$.frameElement;g&&(b=new CKEDITOR.dom.element(g))}catch(d){}}while(b=b.getParent())}},scrollIntoParent:function(a,b,c){var g,d,e,m;function l(b,g){/body|html/.test(a.getName())?a.getWindow().$.scrollBy(b,g):(a.$.scrollLeft+=b,a.$.scrollTop+=g)}function q(a,b){var g={x:0,y:0};if(!a.is(w?"body":"html")){var c=a.$.getBoundingClientRect();g.x=c.left;g.y=c.top}c=a.getWindow();c.equals(b)||(c=q(CKEDITOR.dom.element.get(c.$.frameElement),b),g.x+=c.x,g.y+=c.y);return g}function p(a,
b){return parseInt(a.getComputedStyle("margin-"+b)||0,10)||0}!a&&(a=this.getWindow());e=a.getDocument();var w="BackCompat"==e.$.compatMode;a instanceof CKEDITOR.dom.window&&(a=w?e.getBody():e.getDocumentElement());e=a.getWindow();d=q(this,e);var z=q(a,e),B=this.$.offsetHeight;g=this.$.offsetWidth;var v=a.$.clientHeight,y=a.$.clientWidth;e=d.x-p(this,"left")-z.x||0;m=d.y-p(this,"top")-z.y||0;g=d.x+g+p(this,"right")-(z.x+y)||0;d=d.y+B+p(this,"bottom")-(z.y+v)||0;(0>m||0<d)&&l(0,!0===b?m:!1===b?d:0>
...
this._.guardLTR;k=n?function(a,b){return!1===F(a,b)?!1:n(a,b)}:F;this.current?c=this.current[m](!1,h,k):(a?c.type==CKEDITOR.NODE_ELEMENT&&(c=0<e?c.getChild(e-1):!1===k(c,!0)?null:c.getPreviousSourceNode(!0,h,k)):(c=d,c.type==CKEDITOR.NODE_ELEMENT&&((c=c.getChild(f))||(c=!1===k(d,!0)?null:d.getNextSourceNode(!0,h,k)))),c&&!1===k(c)&&(c=null));for(;c&&!this._.end;){this.current=c;if(!this.evaluator||!1!==this.evaluator(c)){if(!b)return c}else if(b&&this.evaluator)return!1;c=c[m](!1,h,k)}this.end();
...
CKEDITOR.dom.range=function(a){this.endOffset=this.endContainer=this.startOffset=this.startContainer=null;this.collapsed=!0;var e=a instanceof CKEDITOR.dom.document;this.document=e?a:a.getDocument();this.root=e?a.getBody():a},function(){function a(a){a.collapsed=a.startContainer&&a.endContainer&&a.startContainer.equals(a.endContainer)&&a.startOffset==a.endOffset}function e(a,b,c,d,f){function e(a,b,g,c){var d=g?a.getPrevious():a.getNext();if(c&&m)return d;v||c?b.append(a.clone(!0,f),g):(a.remove(),
l&&b.append(a));return d}function k(){var a,b,g,c=Math.min(E.length,N.length);for(a=0;a<c;a++)if(b=E[a],g=N[a],!b.equals(g))return a;return a-1}function h(){var b=R-1,c=F&&I&&!y.equals(C);b<P-1||b<T-1||c?(c?a.moveToPosition(C,CKEDITOR.POSITION_BEFORE_START):T==b+1&&G?a.moveToPosition(N[b],CKEDITOR.POSITION_BEFORE_END):a.moveToPosition(N[b+1],CKEDITOR.POSITION_BEFORE_START),d&&(b=E[b+1])&&b.type==CKEDITOR.NODE_ELEMENT&&(c=CKEDITOR.dom.element.createFromHtml('\x3cspan data-cke-bookmark\x3d"1" style\x3d"display:none"\x3e\x26nbsp;\x3c/span\x3e',
a.document),c.insertAfter(b),b.mergeSiblings(!1),a.moveToBookmark({startNode:c}))):a.collapse(!0)}a.optimizeBookmark();var m=0===b,l=1==b,v=2==b;b=v||l;var y=a.startContainer,C=a.endContainer,x=a.startOffset,A=a.endOffset,D,G,F,I,H,K;if(v&&C.type==CKEDITOR.NODE_TEXT&&y.equals(C))y=a.document.createText(y.substring(x,A)),c.append(y);else{C.type==CKEDITOR.NODE_TEXT?v?K=!0:C=C.split(A):0<C.getChildCount()?A>=C.getChildCount()?(C=C.getChild(A-1),G=!0):C=C.getChild(A):I=G=!0;y.type==CKEDITOR.NODE_TEXT?
v?H=!0:y.split(x):0<y.getChildCount()?0===x?(y=y.getChild(x),D=!0):y=y.getChild(x-1):F=D=!0;for(var E=y.getParents(),N=C.getParents(),R=k(),P=E.length-1,T=N.length-1,O=c,Y,M,W,U=-1,J=R;J<=P;J++){M=E[J];W=M.getNext();for(J!=P||M.equals(N[J])&&P<T?b&&(Y=O.append(M.clone(0,f))):D?e(M,O,!1,F):H&&O.append(a.document.createText(M.substring(x)));W;){if(W.equals(N[J])){U=J;break}W=e(W,O)}O=Y}O=c;for(J=R;J<=T;J++)if(c=N[J],W=c.getPrevious(),c.equals(E[J]))b&&(O=O.getChild(0));else{J!=T||c.equals(E[J])&&T<
P?b&&(Y=O.append(c.clone(0,f))):G?e(c,O,!1,I):K&&O.append(a.document.createText(c.substring(0,A)));if(J>U)for(;W;)W=e(W,O,!0);O=Y}v||h()}}function b(){var a=!1,b=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.dom.walker.bookmark(!0),d=CKEDITOR.dom.walker.bogus();return function(f){return c(f)||b(f)?!0:d(f)&&!a?a=!0:f.type==CKEDITOR.NODE_TEXT&&(f.hasAscendant("pre")||CKEDITOR.tools.trim(f.getText()).length)||f.type==CKEDITOR.NODE_ELEMENT&&!f.is(m)?!1:!0}}function c(a){var b=CKEDITOR.dom.walker.whitespaces(),
...
optimizeBookmark:function(){var a=this.startContainer,b=this.endContainer;a.is&&a.is("span")&&a.data("cke-bookmark")&&this.setStartAt(a,CKEDITOR.POSITION_BEFORE_START);b&&b.is&&b.is("span")&&b.data("cke-bookmark")&&this.setEndAt(b,CKEDITOR.POSITION_AFTER_END)},trim:function(a,b){var c=this.startContainer,d=this.startOffset,f=this.collapsed;if((!a||f)&&c&&c.type==CKEDITOR.NODE_TEXT){if(d)if(d>=c.getLength())d=c.getIndex()+1,c=c.getParent();else{var e=c.split(d),d=c.getIndex()+1,c=c.getParent();this.startContainer.equals(this.endContainer)?
this.setEnd(e,this.endOffset-this.startOffset):c.equals(this.endContainer)&&(this.endOffset+=1)}else d=c.getIndex(),c=c.getParent();this.setStart(c,d);if(f){this.collapse(!0);return}}c=this.endContainer;d=this.endOffset;b||f||!c||c.type!=CKEDITOR.NODE_TEXT||(d?(d>=c.getLength()||c.split(d),d=c.getIndex()+1):d=c.getIndex(),c=c.getParent(),this.setEnd(c,d))},enlarge:function(a,b){function c(a){return a&&a.type==CKEDITOR.NODE_ELEMENT&&a.hasAttribute("contenteditable")?null:a}var d=new RegExp(/[^\s\ufeff]/);
switch(a){case CKEDITOR.ENLARGE_INLINE:var f=1;case CKEDITOR.ENLARGE_ELEMENT:var e=function(a,b){var c=new CKEDITOR.dom.range(h);c.setStart(a,b);c.setEndAt(h,CKEDITOR.POSITION_BEFORE_END);var c=new CKEDITOR.dom.walker(c),g;for(c.guard=function(a){return!(a.type==CKEDITOR.NODE_ELEMENT&&a.isBlockBoundary())};g=c.next();){if(g.type!=CKEDITOR.NODE_TEXT)return!1;D=g!=a?g.getText():g.substring(b);if(d.test(D))return!1}return!0};if(this.collapsed)break;var k=this.getCommonAncestor(),h=this.root,m,l,v,y,
C,x=!1,A,D;A=this.startContainer;var G=this.startOffset;A.type==CKEDITOR.NODE_TEXT?(G&&(A=!CKEDITOR.tools.trim(A.substring(0,G)).length&&A,x=!!A),A&&((y=A.getPrevious())||(v=A.getParent()))):(G&&(y=A.getChild(G-1)||A.getLast()),y||(v=A));for(v=c(v);v||y;){if(v&&!y){!C&&v.equals(k)&&(C=!0);if(f?v.isBlockBoundary():!h.contains(v))break;x&&"inline"==v.getComputedStyle("display")||(x=!1,C?m=v:this.setStartBefore(v));y=v.getPrevious()}for(;y;)if(A=!1,y.type==CKEDITOR.NODE_COMMENT)y=y.getPrevious();else{if(y.type==
CKEDITOR.NODE_TEXT)D=y.getText(),d.test(D)&&(y=null),A=/[\s\ufeff]$/.test(D);else if((y.$.offsetWidth>(CKEDITOR.env.webkit?1:0)||b&&y.is("br"))&&!y.data("cke-bookmark"))if(x&&CKEDITOR.dtd.$removeEmpty[y.getName()]){D=y.getText();if(d.test(D))y=null;else for(var G=y.$.getElementsByTagName("*"),F=0,I;I=G[F++];)if(!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]){y=null;break}y&&(A=!!D.length)}else y=null;A&&(x?C?m=v:v&&this.setStartBefore(v):x=!0);if(y){A=y.getPrevious();if(!v&&!A){v=y;y=null;break}y=
A}else v=null}v&&(v=c(v.getParent()))}A=this.endContainer;G=this.endOffset;v=y=null;C=x=!1;A.type==CKEDITOR.NODE_TEXT?CKEDITOR.tools.trim(A.substring(G)).length?x=!0:(x=!A.getLength(),G==A.getLength()?(y=A.getNext())||(v=A.getParent()):e(A,G)&&(v=A.getParent())):(y=A.getChild(G))||(v=A);for(;v||y;){if(v&&!y){!C&&v.equals(k)&&(C=!0);if(f?v.isBlockBoundary():!h.contains(v))break;x&&"inline"==v.getComputedStyle("display")||(x=!1,C?l=v:v&&this.setEndAfter(v));y=v.getNext()}for(;y;){A=!1;if(y.type==CKEDITOR.NODE_TEXT)D=
y.getText(),e(y,0)||(y=null),A=/^[\s\ufeff]/.test(D);else if(y.type==CKEDITOR.NODE_ELEMENT){if((0<y.$.offsetWidth||b&&y.is("br"))&&!y.data("cke-bookmark"))if(x&&CKEDITOR.dtd.$removeEmpty[y.getName()]){D=y.getText();if(d.test(D))y=null;else for(G=y.$.getElementsByTagName("*"),F=0;I=G[F++];)if(!CKEDITOR.dtd.$removeEmpty[I.nodeName.toLowerCase()]){y=null;break}y&&(A=!!D.length)}else y=null}else A=1;A&&x&&(C?l=v:this.setEndAfter(v));if(y){A=y.getNext();if(!v&&!A){v=y;y=null;break}y=A}else v=null}v&&(v=
c(v.getParent()))}m&&l&&(k=m.contains(l)?l:m,this.setStartBefore(k),this.setEndAfter(k));break;case CKEDITOR.ENLARGE_BLOCK_CONTENTS:case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:v=new CKEDITOR.dom.range(this.root);h=this.root;v.setStartAt(h,CKEDITOR.POSITION_AFTER_START);v.setEnd(this.startContainer,this.startOffset);v=new CKEDITOR.dom.walker(v);var H,K,E=CKEDITOR.dom.walker.blockBoundary(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS?{br:1}:null),N=null,R=function(a){if(a.type==CKEDITOR.NODE_ELEMENT&&"false"==
a.getAttribute("contenteditable"))if(N){if(N.equals(a)){N=null;return}}else N=a;else if(N)return;var b=E(a);b||(H=a);return b},f=function(a){var b=R(a);!b&&a.is&&a.is("br")&&(K=a);return b};v.guard=R;v=v.lastBackward();H=H||h;this.setStartAt(H,!H.is("br")&&(!v&&this.checkStartOfBlock()||v&&H.contains(v))?CKEDITOR.POSITION_AFTER_START:CKEDITOR.POSITION_AFTER_END);if(a==CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS){v=this.clone();v=new CKEDITOR.dom.walker(v);var P=CKEDITOR.dom.walker.whitespaces(),T=CKEDITOR.dom.walker.bookmark();
...
c(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.isEmptyInlineRemoveable()||g.is("table")&&a.is("caption")?!1:!0}}var b=CKEDITOR.dom.walker.whitespaces(),c=CKEDITOR.dom.walker.bookmark(!1);return function(b){for(var c=this.createBookmark(),d=this[b?"endPath":"startPath"](),f=d.block||d.blockLimit,e;f&&!f.equals(d.root)&&!f.getFirst(a(f));)e=f.getParent(),this[b?"setEndAt":"setStartAt"](f,CKEDITOR.POSITION_AFTER_END),f.remove(1),f=e;this.moveToBookmark(c)}}(),startPath:function(){return new CKEDITOR.dom.elementPath(this.startContainer,
...
return 1}function c(a,b,c){if(!b)return!1;a=a.clone();a.collapse(!c);return a.checkBoundaryOfElement(b,c?CKEDITOR.START:CKEDITOR.END)}var d=/^[\r\n\t ]+$/,m=CKEDITOR.dom.walker.bookmark(!1,!0),l=CKEDITOR.dom.walker.whitespaces(!0),f=function(a){return m(a)&&l(a)},h={dd:1,dt:1,li:1};a.prototype={getNextParagraph:function(a){var g,e,l,t,r;a=a||"p";if(this._.nestedEditable){if(g=this._.nestedEditable.iterator.getNextParagraph(a))return this.activeFilter=this._.nestedEditable.iterator.activeFilter,g;
this.activeFilter=this.filter;if(b(this,a,this._.nestedEditable.container,this._.nestedEditable.remaining))return this.activeFilter=this._.nestedEditable.iterator.activeFilter,this._.nestedEditable.iterator.getNextParagraph(a);this._.nestedEditable=null}if(!this.range.root.getDtd()[a])return null;if(!this._.started){var q=this.range.clone();e=q.startPath();var p=q.endPath(),w=!q.collapsed&&c(q,e.block),z=!q.collapsed&&c(q,p.block,1);q.shrink(CKEDITOR.SHRINK_ELEMENT,!0);w&&q.setStartAt(e.block,CKEDITOR.POSITION_BEFORE_END);
z&&q.setEndAt(p.block,CKEDITOR.POSITION_AFTER_START);e=q.endContainer.hasAscendant("pre",!0)||q.startContainer.hasAscendant("pre",!0);q.enlarge(this.forceBrBreak&&!e||!this.enlargeBr?CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:CKEDITOR.ENLARGE_BLOCK_CONTENTS);q.collapsed||(e=new CKEDITOR.dom.walker(q.clone()),p=CKEDITOR.dom.walker.bookmark(!0,!0),e.evaluator=p,this._.nextNode=e.next(),e=new CKEDITOR.dom.walker(q.clone()),e.evaluator=p,e=e.previous(),this._.lastNode=e.getNextSourceNode(!0,null,q.root),this._.lastNode&&
this._.lastNode.type==CKEDITOR.NODE_TEXT&&!CKEDITOR.tools.trim(this._.lastNode.getText())&&this._.lastNode.getParent().isBlockBoundary()&&(p=this.range.clone(),p.moveToPosition(this._.lastNode,CKEDITOR.POSITION_AFTER_END),p.checkEndOfBlock()&&(p=new CKEDITOR.dom.elementPath(p.endContainer,p.root),this._.lastNode=(p.block||p.blockLimit).getNextSourceNode(!0))),this._.lastNode&&q.root.contains(this._.lastNode)||(this._.lastNode=this._.docEndMarker=q.document.createText(""),this._.lastNode.insertAfter(e)),
q=null);this._.started=1;e=q}p=this._.nextNode;q=this._.lastNode;for(this._.nextNode=null;p;){var w=0,z=p.hasAscendant("pre"),B=p.type!=CKEDITOR.NODE_ELEMENT,v=0;if(B)p.type==CKEDITOR.NODE_TEXT&&d.test(p.getText())&&(B=0);else{var y=p.getName();if(CKEDITOR.dtd.$block[y]&&"false"==p.getAttribute("contenteditable")){g=p;b(this,a,g);break}else if(p.isBlockBoundary(this.forceBrBreak&&!z&&{br:1})){if("br"==y)B=1;else if(!e&&!p.getChildCount()&&"hr"!=y){g=p;l=p.equals(q);break}e&&(e.setEndAt(p,CKEDITOR.POSITION_BEFORE_START),
"br"!=y&&(this._.nextNode=p));w=1}else{if(p.getFirst()){e||(e=this.range.clone(),e.setStartAt(p,CKEDITOR.POSITION_BEFORE_START));p=p.getFirst();continue}B=1}}B&&!e&&(e=this.range.clone(),e.setStartAt(p,CKEDITOR.POSITION_BEFORE_START));l=(!w||B)&&p.equals(q);if(e&&!w)for(;!p.getNext(f)&&!l;){y=p.getParent();if(y.isBlockBoundary(this.forceBrBreak&&!z&&{br:1})){w=1;B=0;l||y.equals(q);e.setEndAt(y,CKEDITOR.POSITION_BEFORE_END);break}p=y;B=1;l=p.equals(q);v=1}B&&e.setEndAt(p,CKEDITOR.POSITION_AFTER_END);
p=this._getNextSourceNode(p,v,q);if((l=!p)||w&&e)break}if(!g){if(!e)return this._.docEndMarker&&this._.docEndMarker.remove(),this._.nextNode=null;g=new CKEDITOR.dom.elementPath(e.startContainer,e.root);p=g.blockLimit;w={div:1,th:1,td:1};g=g.block;!g&&p&&!this.enforceRealBlocks&&w[p.getName()]&&e.checkStartOfBlock()&&e.checkEndOfBlock()&&!p.equals(e.root)?g=p:!g||this.enforceRealBlocks&&g.is(h)?(g=this.range.document.createElement(a),e.extractContents().appendTo(g),g.trim(),e.insertNode(g),t=r=!0):
"li"!=g.getName()?e.checkStartOfBlock()&&e.checkEndOfBlock()||(g=g.clone(!1),e.extractContents().appendTo(g),g.trim(),r=e.splitBlock(),t=!r.wasStartOfBlock,r=!r.wasEndOfBlock,e.insertNode(g)):l||(this._.nextNode=g.equals(q)?null:this._getNextSourceNode(e.getBoundaryNodes().endNode,1,q))}t&&(t=g.getPrevious())&&t.type==CKEDITOR.NODE_ELEMENT&&("br"==t.getName()?t.remove():t.getLast()&&"br"==t.getLast().$.nodeName.toLowerCase()&&t.getLast().remove());r&&(t=g.getLast())&&t.type==CKEDITOR.NODE_ELEMENT&&
"br"==t.getName()&&(!CKEDITOR.env.needsBrFiller||t.getPrevious(m)||t.getNext(m))&&t.remove();this._.nextNode||(this._.nextNode=l||g.equals(q)||!q?null:this._getNextSourceNode(g,1,q));return g},_getNextSourceNode:function(a,b,c){function d(a){return!(a.equals(c)||a.equals(f))}var f=this.range.root;for(a=a.getNextSourceNode(b,null,d);!m(a);)a=a.getNextSourceNode(b,null,d);return a}};CKEDITOR.dom.range.prototype.createIterator=function(){return new a(this)}}(),CKEDITOR.command=function(a,e){this.uiItems=
...
c,d,g,f={},e=1;for(a=I(a);b=a.match(N);)(c=b[2])?(d=n(c,"styles"),g=n(c,"attrs"),c=n(c,"classes")):d=g=c=null,f["$"+e++]={elements:b[1],classes:c,styles:d,attributes:g},a=a.slice(b[0].length);return f}function n(a,b){var c=a.match(R[b]);return c?I(c[1]):null}function u(a){var b=a.styleBackup=a.attributes.style,c=a.classBackup=a.attributes["class"];a.styles||(a.styles=CKEDITOR.tools.parseCssText(b||"",1));a.classes||(a.classes=c?c.split(/\s+/):[])}function t(a,b,d,g){var f=0,k;g.toHtml&&(b.name=b.name.replace(P,
"$1"));if(g.doCallbacks&&a.elementCallbacks){a:{k=a.elementCallbacks;for(var h=0,m=k.length,l;h<m;++h)if(l=k[h](b)){k=l;break a}k=void 0}if(k)return k}if(g.doTransform&&(k=a._.transformations[b.name])){u(b);for(h=0;h<k.length;++h)y(a,b,k[h]);q(b)}if(g.doFilter){a:{h=b.name;m=a._;a=m.allowedRules.elements[h];k=m.allowedRules.generic;h=m.disallowedRules.elements[h];m=m.disallowedRules.generic;l=g.skipRequired;var v={valid:!1,validAttributes:{},validClasses:{},validStyles:{},allAttributes:!1,allClasses:!1,
allStyles:!1,hadInvalidAttribute:!1,hadInvalidClass:!1,hadInvalidStyle:!1},E,n;if(a||k){u(b);if(h)for(E=0,n=h.length;E<n;++E)if(!1===c(h[E],b,v)){a=null;break a}if(m)for(E=0,n=m.length;E<n;++E)c(m[E],b,v);if(a)for(E=0,n=a.length;E<n;++E)e(a[E],b,v,l);if(k)for(E=0,n=k.length;E<n;++E)e(k[E],b,v,l);a=v}else a=null}if(!a||!a.valid)return d.push(b),1;n=a.validAttributes;var B=a.validStyles;k=a.validClasses;var h=b.attributes,w=b.styles,m=b.classes;l=b.classBackup;var C=b.styleBackup,r,t,A=[],v=[],x=/^data-cke-/;
E=!1;delete h.style;delete h["class"];delete b.classBackup;delete b.styleBackup;if(!a.allAttributes)for(r in h)n[r]||(x.test(r)?r==(t=r.replace(/^data-cke-saved-/,""))||n[t]||(delete h[r],E=!0):(delete h[r],E=!0));if(!a.allStyles||a.hadInvalidStyle){for(r in w)a.allStyles||B[r]?A.push(r+":"+w[r]):E=!0;A.length&&(h.style=A.sort().join("; "))}else C&&(h.style=C);if(!a.allClasses||a.hadInvalidClass){for(r=0;r<m.length;++r)(a.allClasses||k[m[r]])&&v.push(m[r]);v.length&&(h["class"]=v.sort().join(" "));
l&&v.length<l.split(/\s+/).length&&(E=!0)}else l&&(h["class"]=l);E&&(f=1);if(!g.skipFinalValidation&&!p(b))return d.push(b),1}g.toHtml&&(b.name=b.name.replace(T,"cke:$1"));return f}function r(a){var b=[],c;for(c in a)-1<c.indexOf("*")&&b.push(c.replace(/\*/g,".*"));return b.length?new RegExp("^(?:"+b.join("|")+")$"):null}function q(a){var b=a.attributes,c;delete b.style;delete b["class"];if(c=CKEDITOR.tools.writeCssText(a.styles,!0))b.style=c;a.classes.length&&(b["class"]=a.classes.sort().join(" "))}
function p(a){switch(a.name){case "a":if(!(a.children.length||a.attributes.name||a.attributes.id))return!1;break;case "img":if(!a.attributes.src)return!1}return!0}function w(a){if(!a)return!1;if(!0===a)return!0;var b=r(a);return function(c){return c in a||b&&c.match(b)}}function z(){return new CKEDITOR.htmlParser.element("br")}function B(a){return a.type==CKEDITOR.NODE_ELEMENT&&("br"==a.name||G.$block[a.name])}function v(a,b,c){var d=a.name;if(G.$empty[d]||!a.children.length)"hr"==d&&"br"==b?a.replaceWith(z()):
...
this.check(a.requiredContent):!0},addTransformations:function(a){var b,c;if(!this.disabled&&a){var d=this._.transformations,g;for(g=0;g<a.length;++g){b=a[g];var f=void 0,e=void 0,k=void 0,h=void 0,m=void 0,l=void 0;c=[];for(e=0;e<b.length;++e)k=b[e],"string"==typeof k?(k=k.split(/\s*:\s*/),h=k[0],m=null,l=k[1]):(h=k.check,m=k.left,l=k.right),f||(f=k,f=f.element?f.element:h?h.match(/^([a-z0-9]+)/i)[0]:f.left.getDefinition().element),m instanceof CKEDITOR.style&&(m=A(m)),c.push({check:h==f?null:h,left:m,
right:"string"==typeof l?D(l):l});b=f;d[b]||(d[b]=[]);d[b].push(c)}}},check:function(a,b,c){if(this.disabled)return!0;if(CKEDITOR.tools.isArray(a)){for(var d=a.length;d--;)if(this.check(a[d],b,c))return!0;return!1}var f,e;if("string"==typeof a){e=a+"\x3c"+(!1===b?"0":"1")+(c?"1":"0")+"\x3e";if(e in this._.cachedChecks)return this._.cachedChecks[e];d=g(a).$1;f=d.styles;var h=d.classes;d.name=d.elements;d.classes=h=h?h.split(/\s*,\s*/):[];d.styles=k(f);d.attributes=k(d.attributes);d.children=[];h.length&&
(d.attributes["class"]=h.join(" "));f&&(d.attributes.style=CKEDITOR.tools.writeCssText(d.styles));f=d}else d=a.getDefinition(),f=d.styles,h=d.attributes||{},f?(f=F(f),h.style=CKEDITOR.tools.writeCssText(f,!0)):f={},f={name:d.element,attributes:h,classes:h["class"]?h["class"].split(/\s+/):[],styles:f,children:[]};var h=CKEDITOR.tools.clone(f),m=[],l;if(!1!==b&&(l=this._.transformations[f.name])){for(d=0;d<l.length;++d)y(this,f,l[d]);q(f)}t(this,h,m,{doFilter:!0,doTransform:!1!==b,skipRequired:!c,skipFinalValidation:!c});
...
a.styles)){var b=a.attributes.align;if("left"==b||"right"==b)a.styles["float"]=b}delete a.attributes.align},alignmentToAttribute:function(a){if(!("align"in a.attributes)){var b=a.styles["float"];if("left"==b||"right"==b)a.attributes.align=b}delete a.styles["float"]},matchesStyle:C,transform:function(a,b){if("string"==typeof b)a.name=b;else{var c=b.getDefinition(),d=c.styles,f=c.attributes,g,e,k,h;a.name=c.element;for(g in f)if("class"==g)for(c=a.classes.join("|"),k=f[g].split(/\s+/);h=k.pop();)-1==
c.indexOf(h)&&a.classes.push(h);else a.attributes[g]=f[g];for(e in d)a.styles[e]=d[e]}}}}(),function(){CKEDITOR.focusManager=function(a){if(a.focusManager)return a.focusManager;this.hasFocus=!1;this.currentActive=null;this._={editor:a};return this};CKEDITOR.focusManager._={blurDelay:200};CKEDITOR.focusManager.prototype={focus:function(a){this._.timer&&clearTimeout(this._.timer);a&&(this.currentActive=a);this.hasFocus||this._.locked||((a=CKEDITOR.currentInstance)&&a.focusManager.blur(1),this.hasFocus=
...
d=c[1],c=c[2];b[d+"-"+c]?d=d+"-"+c:b[d]||(d=null);CKEDITOR.lang.detect=d?function(){return d}:function(a){return a};return d||a}}}(),CKEDITOR.scriptLoader=function(){var a={},e={};return{load:function(b,c,d,m){var l="string"==typeof b;l&&(b=[b]);d||(d=CKEDITOR);var f=b.length,h=[],k=[],g=function(a){c&&(l?c.call(d,a):c.call(d,h,k))};if(0===f)g(!0);else{var n=function(a,b){(b?h:k).push(a);0>=--f&&(m&&CKEDITOR.document.getDocumentElement().removeStyle("cursor"),g(b))},u=function(b,c){a[b]=1;var d=e[b];
delete e[b];for(var f=0;f<d.length;f++)d[f](b,c)},t=function(b){if(a[b])n(b,!0);else{var d=e[b]||(e[b]=[]);d.push(n);if(!(1<d.length)){var f=new CKEDITOR.dom.element("script");f.setAttributes({type:"text/javascript",src:b});c&&(CKEDITOR.env.ie&&11>CKEDITOR.env.version?f.$.onreadystatechange=function(){if("loaded"==f.$.readyState||"complete"==f.$.readyState)f.$.onreadystatechange=null,u(b,!0)}:(f.$.onload=function(){setTimeout(function(){u(b,!0)},0)},f.$.onerror=function(){u(b,!1)}));f.appendTo(CKEDITOR.document.getHead())}}};
m&&CKEDITOR.document.getDocumentElement().setStyle("cursor","wait");for(var r=0;r<f;r++)t(b[r])}},queue:function(){function a(){var b;(b=c[0])&&this.load(b.scriptUrl,b.callback,CKEDITOR,0)}var c=[];return function(d,e){var l=this;c.push({scriptUrl:d,callback:function(){e&&e.apply(this,arguments);c.shift();a.call(l)}});1==c.length&&a.call(this)}}()}}(),CKEDITOR.resourceManager=function(a,e){this.basePath=a;this.fileName=e;this.registered={};this.loaded={};this.externals={};this._={waitingList:{}}},
...
[]);l[g].push(k)}}CKEDITOR.scriptLoader.load(m,function(a,d){if(d.length)throw Error('[CKEDITOR.resourceManager.load] Resource name "'+l[d[0]].join(",")+'" was not found at "'+d[0]+'".');for(var g=0;g<a.length;g++)for(var k=l[a[g]],h=0;h<k.length;h++){var m=k[h];f[m]=this.get(m);c[m]=1}e.call(b,f)},this)}},CKEDITOR.plugins=new CKEDITOR.resourceManager("plugins/","plugin"),CKEDITOR.plugins.load=CKEDITOR.tools.override(CKEDITOR.plugins.load,function(a){var e={};return function(b,c,d){var m={},l=function(b){a.call(this,
b,function(a){CKEDITOR.tools.extend(m,a);var b=[],f;for(f in a){var n=a[f],u=n&&n.requires;if(!e[f]){if(n.icons)for(var t=n.icons.split(","),r=t.length;r--;)CKEDITOR.skin.addIcon(t[r],n.path+"icons/"+(CKEDITOR.env.hidpi&&n.hidpi?"hidpi/":"")+t[r]+".png");e[f]=1}if(u)for(u.split&&(u=u.split(",")),n=0;n<u.length;n++)m[u[n]]||b.push(u[n])}if(b.length)l.call(this,b);else{for(f in m)n=m[f],n.onLoad&&!n.onLoad._called&&(!1===n.onLoad()&&delete m[f],n.onLoad._called=1);c&&c.call(d||window,m)}},this)};l.call(this,
...
function(a){m(this,a.data.path)});this.on("activeFilterChange",function(){m(this,this.elementPath(),!0)});this.on("mode",c);this.on("instanceReady",function(){this.config.startupFocus&&this.focus()});CKEDITOR.fire("instanceCreated",null,this);CKEDITOR.add(this);CKEDITOR.tools.setTimeout(function(){"destroyed"!==this.status?f(this,a):CKEDITOR.warn("editor-incorrect-destroy")},0,this)}function e(){do var a="editor"+ ++t;while(CKEDITOR.instances[a]);return a}function b(a,b){return b==CKEDITOR.ELEMENT_MODE_INLINE?
a.is(CKEDITOR.dtd.$editable)||a.is("textarea"):b==CKEDITOR.ELEMENT_MODE_REPLACE?!a.is(CKEDITOR.dtd.$nonBodyContent):1}function c(){var a=this.commands,b;for(b in a)d(this,a[b])}function d(a,b){b[b.startDisabled?"disable":a.readOnly&&!b.readOnly?"disable":b.modes[a.mode]?"enable":"disable"]()}function m(a,b,c){if(b){var d,f,g=a.commands;for(f in g)d=g[f],(c||d.contextSensitive)&&d.refresh(a,b)}}function l(a){var b=a.config.customConfig;if(!b)return!1;var b=CKEDITOR.getUrl(b),c=r[b]||(r[b]={});c.fn?
...
")(?\x3d,|$)","g"),c=c.replace(g,""),c=c+(","+d);if(f)var e=new RegExp("(?:^|,)(?:"+f.replace(/\s*,\s*/g,"|")+")(?\x3d,|$)","g"),c=c.replace(e,"");CKEDITOR.env.air&&(c+=",adobeair");CKEDITOR.plugins.load(c.split(","),function(c){var d=[],f=[],g=[];a.plugins=c;for(var k in c){var h=c[k],m=h.lang,l=null,v=h.requires,E;CKEDITOR.tools.isArray(v)&&(v=v.join(","));if(v&&(E=v.match(e)))for(;v=E.pop();)CKEDITOR.error("editor-plugin-required",{plugin:v.replace(",",""),requiredBy:k});m&&!a.lang[k]&&(m.split&&
(m=m.split(",")),0<=CKEDITOR.tools.indexOf(m,a.langCode)?l=a.langCode:(l=a.langCode.replace(/-.*/,""),l=l!=a.langCode&&0<=CKEDITOR.tools.indexOf(m,l)?l:0<=CKEDITOR.tools.indexOf(m,"en")?"en":m[0]),h.langEntries&&h.langEntries[l]?(a.lang[k]=h.langEntries[l],l=null):g.push(CKEDITOR.getUrl(h.path+"lang/"+l+".js")));f.push(l);d.push(h)}CKEDITOR.scriptLoader.load(g,function(){for(var c=["beforeInit","init","afterInit"],g=0;g<c.length;g++)for(var e=0;e<d.length;e++){var k=d[e];0===g&&f[e]&&k.lang&&k.langEntries&&
(a.lang[k.name]=k.langEntries[f[e]]);if(k[c[g]])k[c[g]](a)}a.fireOnce("pluginsLoaded");b.keystrokes&&a.setKeystroke(a.config.keystrokes);for(e=0;e<a.config.blockedKeystrokes.length;e++)a.keystrokeHandler.blockedKeystrokes[a.config.blockedKeystrokes[e]]=1;a.status="loaded";a.fireOnce("loaded");CKEDITOR.fire("instanceLoaded",null,a)})})}function u(){var a=this.element;if(a&&this.elementMode!=CKEDITOR.ELEMENT_MODE_APPENDTO){var b=this.getData();this.config.htmlEncodeOutput&&(b=CKEDITOR.tools.htmlEncode(b));
a.is("textarea")?a.setValue(b):a.setHtml(b);return!0}return!1}a.prototype=CKEDITOR.editor.prototype;CKEDITOR.editor=a;var t=0,r={};CKEDITOR.tools.extend(CKEDITOR.editor.prototype,{addCommand:function(a,b){b.name=a.toLowerCase();var c=new CKEDITOR.command(this,b);this.mode&&d(this,c);return this.commands[a]=c},_attachToForm:function(){function a(b){c.updateElement();c._.required&&!d.getValue()&&!1===c.fire("required")&&b.data.preventDefault()}function b(a){return!!(a&&a.call&&a.apply)}var c=this,d=
c.element,f=new CKEDITOR.dom.element(d.$.form);d.is("textarea")&&f&&(f.on("submit",a),b(f.$.submit)&&(f.$.submit=CKEDITOR.tools.override(f.$.submit,function(b){return function(){a();b.apply?b.apply(this):b()}})),c.on("destroy",function(){f.removeListener("submit",a)}))},destroy:function(a){this.fire("beforeDestroy");!a&&u.call(this);this.editable(null);this.filter&&(this.filter.destroy(),delete this.filter);delete this.activeFilter;this.status="destroyed";this.fire("destroy");this.removeAllListeners();
...
a.children.length,c=a.children[b-1],d;c&&c.type==CKEDITOR.NODE_TEXT&&((d=CKEDITOR.tools.rtrim(c.value))?c.value=d:a.children.length=b-1)}}function n(b,c,d){c=c||z||q;var e=z;void 0===b.previous&&(u(c,b)&&(z=c,r.onTagOpen(f,{}),b.returnPoint=c=z),g(b),a(b)&&!b.children.length||c.add(b),"pre"==b.name&&(v=!1),"textarea"==b.name&&(B=!1));b.returnPoint?(z=b.returnPoint,delete b.returnPoint):z=d?c:e}function u(a,b){if((a==q||"body"==a.name)&&f&&(!a.name||CKEDITOR.dtd[a.name][f])){var c,d;return(c=b.attributes&&
(d=b.attributes["data-cke-real-element-type"])?d:b.name)&&c in CKEDITOR.dtd.$inline&&!(c in CKEDITOR.dtd.head)&&!b.isOrphan||b.type==CKEDITOR.NODE_TEXT}}function t(a,b){return a in CKEDITOR.dtd.$listItem||a in CKEDITOR.dtd.$tableContent?a==b||"dt"==a&&"dd"==b||"dd"==a&&"dt"==b:!1}var r=new CKEDITOR.htmlParser,q=l instanceof CKEDITOR.htmlParser.element?l:"string"==typeof l?new CKEDITOR.htmlParser.element(l):new CKEDITOR.htmlParser.fragment,p=[],w=[],z=q,B="textarea"==q.name,v="pre"==q.name;r.onTagOpen=
function(d,f,g,m){f=new CKEDITOR.htmlParser.element(d,f);f.isUnknown&&g&&(f.isEmpty=!0);f.isOptionalClose=m;if(a(f))p.push(f);else{if("pre"==d)v=!0;else{if("br"==d&&v){z.add(new CKEDITOR.htmlParser.text("\n"));return}"textarea"==d&&(B=!0)}if("br"==d)w.push(f);else{for(;!(m=(g=z.name)?CKEDITOR.dtd[g]||(z._.isBlockLike?CKEDITOR.dtd.div:CKEDITOR.dtd.span):c,f.isUnknown||z.isUnknown||m[d]);)if(z.isOptionalClose)r.onTagClose(g);else if(d in b&&g in b)g=z.children,(g=g[g.length-1])&&"li"==g.name||n(g=new CKEDITOR.htmlParser.element("li"),
z),!f.returnPoint&&(f.returnPoint=z),z=g;else if(d in CKEDITOR.dtd.$listItem&&!t(d,g))r.onTagOpen("li"==d?"ul":"dl",{},0,1);else if(g in e&&!t(d,g))!f.returnPoint&&(f.returnPoint=z),z=z.parent;else if(g in CKEDITOR.dtd.$inline&&p.unshift(z),z.parent)n(z,z.parent,1);else{f.isOrphan=1;break}h(d);k();f.parent=z;f.isEmpty?n(f):z=f}}};r.onTagClose=function(a){for(var b=p.length-1;0<=b;b--)if(a==p[b].name){p.splice(b,1);return}for(var c=[],d=[],g=z;g!=q&&g.name!=a;)g._.isBlockLike||d.unshift(g),c.push(g),
...
new CKEDITOR.htmlParser.text(a);if(u(z,a))this.onTagOpen(f,{},0,1);z.add(a)}};r.onCDATA=function(a){z.add(new CKEDITOR.htmlParser.cdata(a))};r.onComment=function(a){k();h();z.add(new CKEDITOR.htmlParser.comment(a))};r.parse(m);for(k();z!=q;)n(z,z.parent,1);g(q);return q};CKEDITOR.htmlParser.fragment.prototype={type:CKEDITOR.NODE_DOCUMENT_FRAGMENT,add:function(a,b){isNaN(b)&&(b=this.children.length);var c=0<b?this.children[b-1]:null;if(c){if(a._.isBlockLike&&c.type==CKEDITOR.NODE_TEXT&&(c.value=CKEDITOR.tools.rtrim(c.value),
...
f){function g(a){return a||CKEDITOR.env.needsNbspFiller?new CKEDITOR.htmlParser.text(" "):new CKEDITOR.htmlParser.element("br",{"data-cke-bogus":1})}function e(a,d){return function(f){if(f.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var e=[],h=b(f),l,v;if(h)for(k(h,1)&&e.push(h);h;)m(h)&&(l=c(h))&&k(l)&&((v=c(l))&&!m(v)?e.push(l):(g(E).insertAfter(l),l.remove())),h=h.previous;for(h=0;h<e.length;h++)e[h].remove();if(e=!a||!1!==("function"==typeof d?d(f):d))E||CKEDITOR.env.needsBrFiller||f.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT?
...
E&&(!b||a.parent.name in n)||!E&&((c=a.previous)&&"br"==c.name||!c||m(c)))?!0:!1}var h={elements:{}},E="html"==f,n=CKEDITOR.tools.extend({},v),B;for(B in n)"#"in z[B]||delete n[B];for(B in n)h.elements[B]=e(E,a.config.fillEmptyBlocks);h.root=e(E,!1);h.elements.br=function(a){return function(b){if(b.parent.type!=CKEDITOR.NODE_DOCUMENT_FRAGMENT){var f=b.attributes;if("data-cke-bogus"in f||"data-cke-eol"in f)delete f["data-cke-bogus"];else{for(f=b.next;f&&d(f);)f=f.next;var e=c(b);!f&&m(b.parent)?l(b.parent,
...
v||a.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT)}function l(a,b){var c=a.children[a.children.length-1];a.children.push(b);b.parent=a;c&&(c.next=b,b.previous=c)}function f(a){a=a.attributes;"false"!=a.contenteditable&&(a["data-cke-editable"]=a.contenteditable?"true":1);a.contenteditable="false"}function h(a){a=a.attributes;switch(a["data-cke-editable"]){case "true":a.contenteditable="true";break;case "1":delete a.contenteditable}}function k(a){return a.replace(D,function(a,b,c){return"\x3c"+b+c.replace(G,
function(a,b){return F.test(b)&&-1==c.indexOf("data-cke-saved-"+b)?" data-cke-saved-"+a+" data-cke-"+CKEDITOR.rnd+"-"+a:a})+"\x3e"})}function g(a,b){return a.replace(b,function(a,b,c){0===a.indexOf("\x3ctextarea")&&(a=b+t(c).replace(/</g,"\x26lt;").replace(/>/g,"\x26gt;")+"\x3c/textarea\x3e");return"\x3ccke:encoded\x3e"+encodeURIComponent(a)+"\x3c/cke:encoded\x3e"})}function n(a){return a.replace(K,function(a,b){return decodeURIComponent(b)})}function u(a){return a.replace(/\x3c!--(?!{cke_protected})[\s\S]+?--\x3e/g,
function(a){return"\x3c!--"+w+"{C}"+encodeURIComponent(a).replace(/--/g,"%2D%2D")+"--\x3e"})}function t(a){return a.replace(/\x3c!--\{cke_protected\}\{C\}([\s\S]+?)--\x3e/g,function(a,b){return decodeURIComponent(b)})}function r(a,b){var c=b._.dataStore;return a.replace(/\x3c!--\{cke_protected\}([\s\S]+?)--\x3e/g,function(a,b){return decodeURIComponent(b)}).replace(/\{cke_protected_(\d+)\}/g,function(a,b){return c&&c[b]||""})}function q(a,b){var c=[],d=b.config.protectedSource,f=b._.dataStore||(b._.dataStore=
...
(d=d&&d.nodeType==CKEDITOR.NODE_ELEMENT?new CKEDITOR.dom.element(d):null)&&(b.equals(d)||b.contains(d))||a.call(this,c)}}function m(a){function b(a){return function(b,f){f&&b.type==CKEDITOR.NODE_ELEMENT&&b.is(g)&&(d=b);if(!(f||!c(b)||a&&t(b)))return!1}}var d,f=a.getRanges()[0];a=a.root;var g={table:1,ul:1,ol:1,dl:1};if(f.startPath().contains(g)){var e=f.clone();e.collapse(1);e.setStartAt(a,CKEDITOR.POSITION_AFTER_START);a=new CKEDITOR.dom.walker(e);a.guard=b();a.checkBackward();if(d)return e=f.clone(),
...
c.fixUneditableRangePosition(a);c.list.merge(d,this);c.table.purge(d,this);c.block.merge(d,this);if(b){c=a.startPath();if(d=a.checkStartOfBlock()&&a.checkEndOfBlock()&&c.block&&!a.root.equals(c.block)){a:{var d=c.block.getElementsByTag("span"),g=0,e;if(d)for(;e=d.getItem(g++);)if(!n(e)){d=!0;break a}d=!1}d=!d}d&&(a.moveToPosition(c.block,CKEDITOR.POSITION_BEFORE_START),c.block.remove())}else c.autoParagraph(this.editor,a),u(a.startContainer)&&a.startContainer.appendBogus();a.startContainer.mergeSiblings();
...
h){b=a.getSelection();var f,e=b.getRanges()[0],k=e.startPath(),l,E,n,c=8==c;CKEDITOR.env.ie&&11>CKEDITOR.env.version&&(f=b.getSelectedElement())||(f=m(b))?(a.fire("saveSnapshot"),e.moveToPosition(f,CKEDITOR.POSITION_BEFORE_START),f.remove(),e.select(),a.fire("saveSnapshot"),d=1):e.collapsed&&((l=k.block)&&(n=l[c?"getPrevious":"getNext"](g))&&n.type==CKEDITOR.NODE_ELEMENT&&n.is("table")&&e[c?"checkStartOfBlock":"checkEndOfBlock"]()?(a.fire("saveSnapshot"),e[c?"checkEndOfBlock":"checkStartOfBlock"]()&&
l.remove(),e["moveToElementEdit"+(c?"End":"Start")](n),e.select(),a.fire("saveSnapshot"),d=1):k.blockLimit&&k.blockLimit.is("td")&&(E=k.blockLimit.getAscendant("table"))&&e.checkBoundaryOfElement(E,c?CKEDITOR.START:CKEDITOR.END)&&(n=E[c?"getPrevious":"getNext"](g))?(a.fire("saveSnapshot"),e["moveToElementEdit"+(c?"End":"Start")](n),e.checkStartOfBlock()&&e.checkEndOfBlock()?n.remove():e.select(),a.fire("saveSnapshot"),d=1):(E=k.contains(["td","th","caption"]))&&e.checkBoundaryOfElement(E,c?CKEDITOR.START:
...
t=CKEDITOR.dom.walker.bogus(),r=/(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi,q=function(){function a(b){return b.type==CKEDITOR.NODE_ELEMENT}function b(c,d){var f,g,e,k,h=[],l=d.range.startContainer;f=d.range.startPath();for(var l=m[l.getName()],n=0,r=c.getChildren(),w=r.count(),p=-1,t=-1,y=0,q=f.contains(m.$list);n<w;++n)f=r.getItem(n),a(f)?(e=f.getName(),q&&e in CKEDITOR.dtd.$list?h=h.concat(b(f,d)):(k=!!l[e],
"br"!=e||!f.data("cke-eol")||n&&n!=w-1||(y=(g=n?h[n-1].node:r.getItem(n+1))&&(!a(g)||!g.is("br")),g=g&&a(g)&&m.$block[g.getName()]),-1!=p||k||(p=n),k||(t=n),h.push({isElement:1,isLineBreak:y,isBlock:f.isBlockBoundary(),hasBlockSibling:g,node:f,name:e,allowed:k}),g=y=0)):h.push({isElement:0,node:f,allowed:1});-1<p&&(h[p].firstNotAllowed=1);-1<t&&(h[t].lastNotAllowed=1);return h}function d(b,c){var f=[],g=b.getChildren(),e=g.count(),k,h=0,l=m[c],n=!b.is(m.$inline)||b.is("br");for(n&&f.push(" ");h<e;h++)k=
g.getItem(h),a(k)&&!k.is(l)?f=f.concat(d(k,c)):f.push(k);n&&f.push(" ");return f}function g(b){return a(b.startContainer)&&b.startContainer.getChild(b.startOffset-1)}function e(b){return b&&a(b)&&(b.is(m.$removeEmpty)||b.is("a")&&!b.isBlockBoundary())}function k(b,c,d,f){var g=b.clone(),e,h;g.setEndAt(c,CKEDITOR.POSITION_BEFORE_END);(e=(new CKEDITOR.dom.walker(g)).next())&&a(e)&&n[e.getName()]&&(h=e.getPrevious())&&a(h)&&!h.getParent().equals(b.startContainer)&&d.contains(h)&&f.contains(e)&&e.isIdentical(h)&&
...
m.$inline);delete w.br;return function(n,E,p,t){var q=n.editor,u=!1;"unfiltered_html"==E&&(E="html",u=!0);if(!t.checkReadOnly()){var z=(new CKEDITOR.dom.elementPath(t.startContainer,t.root)).blockLimit||t.root;n={type:E,dontFilter:u,editable:n,editor:q,range:t,blockLimit:z,mergeCandidates:[],zombies:[]};E=n.range;t=n.mergeCandidates;var F,M;"text"==n.type&&E.shrink(CKEDITOR.SHRINK_ELEMENT,!0,!1)&&(F=CKEDITOR.dom.element.createFromHtml("\x3cspan\x3e\x26nbsp;\x3c/span\x3e",E.document),E.insertNode(F),
E.setStartAfter(F));u=new CKEDITOR.dom.elementPath(E.startContainer);n.endPath=z=new CKEDITOR.dom.elementPath(E.endContainer);if(!E.collapsed){var q=z.block||z.blockLimit,W=E.getCommonAncestor();q&&!q.equals(W)&&!q.contains(W)&&E.checkEndOfBlock()&&n.zombies.push(q);E.deleteContents()}for(;(M=g(E))&&a(M)&&M.isBlockBoundary()&&u.contains(M);)E.moveToPosition(M,CKEDITOR.POSITION_BEFORE_END);k(E,n.blockLimit,u,z);F&&(E.setEndBefore(F),E.collapse(),F.remove());F=E.startPath();if(q=F.contains(e,!1,1))E.splitElement(q),
n.inlineStylesRoot=q,n.inlineStylesPeak=F.lastElement;F=E.createBookmark();(q=F.startNode.getPrevious(c))&&a(q)&&e(q)&&t.push(q);(q=F.startNode.getNext(c))&&a(q)&&e(q)&&t.push(q);for(q=F.startNode;(q=q.getParent())&&e(q);)t.push(q);E.moveToBookmark(F);if(F=p){F=n.range;if("text"==n.type&&n.inlineStylesRoot){M=n.inlineStylesPeak;E=M.getDocument().createText("{cke-peak}");for(t=n.inlineStylesRoot.getParent();!M.equals(t);)E=E.appendTo(M.clone()),M=M.getParent();p=E.getOuterHtml().split("{cke-peak}").join(p)}M=
...
M.getChildCount()&&a(J=M.getFirst())&&J.is(r)&&!J.hasAttribute("contenteditable")){U=J.getElementsByTag("*");F=0;for(t=U.count();F<t;F++)if(E=U.getItem(F),!E.is(w))break a;J.moveChildren(J.getParent(1));J.remove()}}n.dataWrapper=M;F=p}if(F){J=n.range;F=J.document;var L;M=n.blockLimit;t=0;var S,U=[],Q,aa;p=q=0;var V,da;E=J.startContainer;var u=n.endPath.elements[0],ba,z=u.getPosition(E),W=!!u.getCommonAncestor(E)&&z!=CKEDITOR.POSITION_IDENTICAL&&!(z&CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED);
E=b(n.dataWrapper,n);for(h(E,J);t<E.length;t++){z=E[t];if(L=z.isLineBreak){L=J;V=M;var X=void 0,ea=void 0;z.hasBlockSibling?L=1:(X=L.startContainer.getAscendant(m.$block,1))&&X.is({div:1,p:1})?(ea=X.getPosition(V),ea==CKEDITOR.POSITION_IDENTICAL||ea==CKEDITOR.POSITION_CONTAINS?L=0:(V=L.splitElement(X),L.moveToPosition(V,CKEDITOR.POSITION_AFTER_START),L=1)):L=0}if(L)p=0<t;else{L=J.startPath();!z.isBlock&&l(n.editor,L.block,L.blockLimit)&&(aa=f(n.editor))&&(aa=F.createElement(aa),aa.appendBogus(),J.insertNode(aa),
CKEDITOR.env.needsBrFiller&&(S=aa.getBogus())&&S.remove(),J.moveToPosition(aa,CKEDITOR.POSITION_BEFORE_END));if((L=J.startPath().block)&&!L.equals(Q)){if(S=L.getBogus())S.remove(),U.push(L);Q=L}z.firstNotAllowed&&(q=1);if(q&&z.isElement){L=J.startContainer;for(V=null;L&&!m[L.getName()][z.name];){if(L.equals(M)){L=null;break}V=L;L=L.getParent()}if(L)V&&(da=J.splitElement(V),n.zombies.push(da),n.zombies.push(V));else{V=M.getName();ba=!t;L=t==E.length-1;V=d(z.node,V);for(var X=[],ea=V.length,ca=0,ga=
void 0,fa=0,ia=-1;ca<ea;ca++)ga=V[ca]," "==ga?(fa||ba&&!ca||(X.push(new CKEDITOR.dom.text(" ")),ia=X.length),fa=1):(X.push(ga),fa=0);L&&ia==X.length&&X.pop();ba=X}}if(ba){for(;L=ba.pop();)J.insertNode(L);ba=0}else J.insertNode(z.node);z.lastNotAllowed&&t<E.length-1&&((da=W?u:da)&&J.setEndAt(da,CKEDITOR.POSITION_AFTER_START),q=0);J.collapse()}}1!=E.length?S=!1:(S=E[0],S=S.isElement&&"false"==S.node.getAttribute("contenteditable"));S&&(p=!0,L=E[0].node,J.setStartAt(L,CKEDITOR.POSITION_BEFORE_START),
...
CKEDITOR.dom.element.setMarker(l,a,m,1)}if(e&&k&&a.equals(k))g=c.clone(),g.setEndAt(k,CKEDITOR.POSITION_BEFORE_END),f.push(g);else if(!e&&h&&a.equals(h))g=c.clone(),g.setStartAt(h,CKEDITOR.POSITION_AFTER_START),f.push(g);else{if(m=!e)m=a.type==CKEDITOR.NODE_ELEMENT&&a.is(d)&&(!k||b(a,k))&&(!h||b(a,h));m&&(g=c.clone(),g.selectNodeContents(a),f.push(g))}};e.lastForward();CKEDITOR.dom.element.clearAllMarkers(l);return f}function b(a,c){var d=CKEDITOR.POSITION_CONTAINS+CKEDITOR.POSITION_IS_CONTAINED,
...
b.setStartBefore(c),b.setEndAfter(g),a.purgeTableBookmark=b.createBookmark())}},detectRanges:function(f,g){var e=c(g,f.bookmark),k=e.clone(),h,l,m=e.getCommonAncestor();m.is(CKEDITOR.dtd.$tableContent)&&!m.is(d)&&(m=m.getAscendant("table",!0));l=m;m=new CKEDITOR.dom.elementPath(e.startContainer,l);l=new CKEDITOR.dom.elementPath(e.endContainer,l);m=m.contains("table");l=l.contains("table");if(m||l)m&&l&&b(m,l)?(f.tableSurroundingRange=k,k.setStartAt(m,CKEDITOR.POSITION_AFTER_END),k.setEndAt(l,CKEDITOR.POSITION_BEFORE_START),
k=e.clone(),k.setEndAt(m,CKEDITOR.POSITION_AFTER_END),h=e.clone(),h.setStartAt(l,CKEDITOR.POSITION_BEFORE_START),h=a(k).concat(a(h))):m?l||(f.tableSurroundingRange=k,k.setStartAt(m,CKEDITOR.POSITION_AFTER_END),e.setEndAt(m,CKEDITOR.POSITION_AFTER_END)):(f.tableSurroundingRange=k,k.setEndAt(l,CKEDITOR.POSITION_BEFORE_START),e.setStartAt(l,CKEDITOR.POSITION_AFTER_START)),f.tableContentsRanges=h?h:a(e)},deleteRanges:function(a){for(var b;b=a.tableContentsRanges.pop();)b.extractContents(),u(b.startContainer)&&
...
this.fire("selectionCheck",a);b=this.elementPath();b.compare(this._.selectionPreviousPath)||(CKEDITOR.env.webkit&&(this._.previousActive=this.document.getActive()),this._.selectionPreviousPath=b,this.fire("selectionChange",{selection:a,path:b}))}function e(){r=!0;t||(b.call(this),t=CKEDITOR.tools.setTimeout(b,200,this))}function b(){t=null;r&&(CKEDITOR.tools.setTimeout(a,0,this),r=!1)}function c(a){return q(a)||a.type==CKEDITOR.NODE_ELEMENT&&!a.is(CKEDITOR.dtd.$empty)?!0:!1}function d(a){function b(c,
...
f.getDocumentElement(),r=k.isInline(),E,p;CKEDITOR.env.gecko&&k.attachListener(k,"focus",function(a){a.removeListener();0!==E&&(a=d.getSelection().getNative())&&a.isCollapsed&&a.anchorNode==k.$&&(a=d.createRange(),a.moveToElementEditStart(k),a.select())},null,null,-2);k.attachListener(k,CKEDITOR.env.webkit?"DOMFocusIn":"focus",function(){E&&CKEDITOR.env.webkit&&(E=d._.previousActive&&d._.previousActive.equals(f.getActive()));d.unlockSelection(E);E=0},null,null,-1);k.attachListener(k,"mousedown",function(){E=
0});if(CKEDITOR.env.ie||r)w?k.attachListener(k,"beforedeactivate",b,null,null,-1):k.attachListener(d,"selectionCheck",b,null,null,-1),k.attachListener(k,CKEDITOR.env.webkit?"DOMFocusOut":"blur",function(){d.lockSelection(p);E=1},null,null,-1),k.attachListener(k,"mousedown",function(){E=0});if(CKEDITOR.env.ie&&!r){var t;k.attachListener(k,"mousedown",function(a){2==a.data.$.button&&((a=d.document.getSelection())&&a.getType()!=CKEDITOR.SELECTION_NONE||(t=d.window.getScrollPosition()))});k.attachListener(k,
"mouseup",function(a){2==a.data.$.button&&t&&(d.document.$.documentElement.scrollLeft=t.x,d.document.$.documentElement.scrollTop=t.y);t=null});if("BackCompat"!=f.$.compatMode){if(CKEDITOR.env.ie7Compat||CKEDITOR.env.ie6Compat)m.on("mousedown",function(a){function b(a){a=a.data.$;if(d){var c=h.$.createTextRange();try{c.moveToPoint(a.clientX,a.clientY)}catch(f){}d.setEndPoint(0>e.compareEndPoints("StartToStart",c)?"EndToEnd":"StartToStart",c);d.select()}}function c(){m.removeListener("mousemove",b);
...
(b=CKEDITOR.SELECTION_ELEMENT)}return a.type=b},getRanges:function(){var a=w?function(){function a(b){return(new CKEDITOR.dom.node(b)).getIndex()}var b=function(b,c){b=b.duplicate();b.collapse(c);var d=b.parentElement();if(!d.hasChildNodes())return{container:d,offset:0};for(var f=d.children,g,e,k=b.duplicate(),h=0,l=f.length-1,m=-1,n,r;h<=l;)if(m=Math.floor((h+l)/2),g=f[m],k.moveToElementText(g),n=k.compareEndPoints("StartToStart",b),0<n)l=m-1;else if(0>n)h=m+1;else return{container:d,offset:a(g)};
if(-1==m||m==f.length-1&&0>n){k.moveToElementText(d);k.setEndPoint("StartToStart",b);k=k.text.replace(/(\r\n|\r)/g,"\n").length;f=d.childNodes;if(!k)return g=f[f.length-1],g.nodeType!=CKEDITOR.NODE_TEXT?{container:d,offset:f.length}:{container:g,offset:g.nodeValue.length};for(d=f.length;0<k&&0<d;)e=f[--d],e.nodeType==CKEDITOR.NODE_TEXT&&(r=e,k-=e.nodeValue.length);return{container:r,offset:-k}}k.collapse(0<n?!0:!1);k.setEndPoint(0<n?"StartToStart":"EndToStart",b);k=k.text.replace(/(\r\n|\r)/g,"\n").length;
if(!k)return{container:d,offset:a(g)+(0<n?0:1)};for(;0<k;)try{e=g[0<n?"previousSibling":"nextSibling"],e.nodeType==CKEDITOR.NODE_TEXT&&(k-=e.nodeValue.length,r=e),g=e}catch(p){return{container:d,offset:a(g)}}return{container:r,offset:0<n?-k:r.nodeValue.length+k}};return function(){var a=this.getNative(),c=a&&a.createRange(),d=this.getType();if(!a)return[];if(d==CKEDITOR.SELECTION_TEXT)return a=new CKEDITOR.dom.range(this.root),d=b(c,!0),a.setStart(new CKEDITOR.dom.node(d.container),d.offset),d=b(c),
...
1],a[0].setEnd(e.endContainer,e.endOffset));e=a[0];a=e.collapsed;var m,n,r;if((c=e.getEnclosedNode())&&c.type==CKEDITOR.NODE_ELEMENT&&c.getName()in B&&(!c.is("a")||!c.getText()))try{r=c.$.createControlRange();r.addElement(c.$);r.select();return}catch(E){}if(e.startContainer.type==CKEDITOR.NODE_ELEMENT&&e.startContainer.getName()in b||e.endContainer.type==CKEDITOR.NODE_ELEMENT&&e.endContainer.getName()in b)e.shrink(CKEDITOR.NODE_ELEMENT,!0),a=e.collapsed;r=e.createBookmark();b=r.startNode;a||(g=r.endNode);
r=e.document.$.body.createTextRange();r.moveToElementText(b.$);r.moveStart("character",1);g?(k=e.document.$.body.createTextRange(),k.moveToElementText(g.$),r.setEndPoint("EndToEnd",k),r.moveEnd("character",-1)):(m=b.getNext(h),n=b.hasAscendant("pre"),m=!(m&&m.getText&&m.getText().match(k))&&(n||!b.hasPrevious()||b.getPrevious().is&&b.getPrevious().is("br")),n=e.document.createElement("span"),n.setHtml("\x26#65279;"),n.insertBefore(b),m&&e.document.createText("﻿").insertBefore(b));e.setStartBefore(b);
b.remove();a?(m?(r.moveStart("character",-1),r.select(),e.document.$.selection.clear()):r.select(),e.moveToPosition(n,CKEDITOR.POSITION_BEFORE_START),n.remove()):(e.setEndBefore(g),g.remove(),r.select())}else{g=this.getNative();if(!g)return;this.removeAllRanges();for(r=0;r<a.length;r++){if(r<a.length-1&&(m=a[r],n=a[r+1],k=m.clone(),k.setStart(m.endContainer,m.endOffset),k.setEnd(n.startContainer,n.startOffset),!k.collapsed&&(k.shrink(CKEDITOR.NODE_ELEMENT,!0),e=k.getCommonAncestor(),k=k.getEnclosedNode(),
e.isReadOnly()||k&&k.isReadOnly()))){n.setStart(m.startContainer,m.startOffset);a.splice(r--,1);continue}e=a[r];n=this.document.$.createRange();e.collapsed&&CKEDITOR.env.webkit&&d(e)&&(m=this.root,l(m,!1),k=m.getDocument().createText("​"),m.setCustomData("cke-fillingChar",k),e.insertNode(k),(m=k.getNext())&&!k.getPrevious()&&m.type==CKEDITOR.NODE_ELEMENT&&"br"==m.getName()?(l(this.root),e.moveToPosition(m,CKEDITOR.POSITION_BEFORE_START)):e.moveToPosition(k,CKEDITOR.POSITION_AFTER_END));n.setStart(e.startContainer.$,
e.startOffset);try{n.setEnd(e.endContainer.$,e.endOffset)}catch(p){if(0<=p.toString().indexOf("NS_ERROR_ILLEGAL_VALUE"))e.collapse(1),n.setEnd(e.endContainer.$,e.endOffset);else throw p;}g.addRange(n)}}this.reset();this.root.fire("selectionchange")}}},fake:function(a){var b=this.root.editor;this.reset();g(b);var c=this._.cache,d=new CKEDITOR.dom.range(this.root);d.setStartBefore(a);d.setEndAfter(a);c.ranges=new CKEDITOR.dom.rangeList(d);c.selectedElement=c.startElement=a;c.type=CKEDITOR.SELECTION_ELEMENT;
...
(!c.childRule||c.childRule(a))}function b(c){var f=c.document;if(c.collapsed)f=w(this,f),c.insertNode(f),c.moveToPosition(f,CKEDITOR.POSITION_BEFORE_END);else{var g=this.element,k=this._.definition,h,m=k.ignoreReadonly,l=m||k.includeReadonly;null==l&&(l=c.root.getCustomData("cke_includeReadonly"));var n=CKEDITOR.dtd[g];n||(h=!0,n=CKEDITOR.dtd.span);c.enlarge(CKEDITOR.ENLARGE_INLINE,1);c.trim();var p=c.createBookmark(),t=p.startNode,q=p.endNode,u=t,z;if(!m){var v=c.getCommonAncestor(),m=a(t,v),v=a(q,
v);m&&(u=m.getNextSourceNode(!0));v&&(q=v)}for(u.getPosition(q)==CKEDITOR.POSITION_FOLLOWING&&(u=0);u;){m=!1;if(u.equals(q))u=null,m=!0;else{var B=u.type==CKEDITOR.NODE_ELEMENT?u.getName():null,v=B&&"false"==u.getAttribute("contentEditable"),y=B&&u.getAttribute("data-nostyle");if(B&&u.data("cke-bookmark")){u=u.getNextSourceNode(!0);continue}if(v&&l&&CKEDITOR.dtd.$block[B])for(var C=u,x=d(C),A=void 0,D=x.length,G=0,C=D&&new CKEDITOR.dom.range(C.getDocument());G<D;++G){var A=x[G],ga=CKEDITOR.filter.instances[A.data("cke-filter")];
if(ga?ga.check(this):1)C.selectNodeContents(A),b.call(this,C)}x=B?!n[B]||y?0:v&&!l?0:e(u,q,k,H):1;if(x)if(A=u.getParent(),x=k,D=g,G=h,!A||!(A.getDtd()||CKEDITOR.dtd.span)[D]&&!G||x.parentRule&&!x.parentRule(A))m=!0;else{if(z||B&&CKEDITOR.dtd.$removeEmpty[B]&&(u.getPosition(q)|H)!=H||(z=c.clone(),z.setStartBefore(u)),B=u.type,B==CKEDITOR.NODE_TEXT||v||B==CKEDITOR.NODE_ELEMENT&&!u.getChildCount()){for(var B=u,fa;(m=!B.getNext(F))&&(fa=B.getParent(),n[fa.getName()])&&e(fa,t,k,K);)B=fa;z.setEndAfter(B)}}else m=
!0;u=u.getNextSourceNode(y||v)}if(m&&z&&!z.collapsed){for(var m=w(this,f),v=m.hasAttributes(),y=z.getCommonAncestor(),B={},x={},A={},D={},I,Z,ha;m&&y;){if(y.getName()==g){for(I in k.attributes)!D[I]&&(ha=y.getAttribute(Z))&&(m.getAttribute(I)==ha?x[I]=1:D[I]=1);for(Z in k.styles)!A[Z]&&(ha=y.getStyle(Z))&&(m.getStyle(Z)==ha?B[Z]=1:A[Z]=1)}y=y.getParent()}for(I in x)m.removeAttribute(I);for(Z in B)m.removeStyle(Z);v&&!m.hasAttributes()&&(m=null);m?(z.extractContents().appendTo(m),z.insertNode(m),r.call(this,
m),m.mergeSiblings(),CKEDITOR.env.ie||m.$.normalize()):(m=new CKEDITOR.dom.element("span"),z.extractContents().appendTo(m),z.insertNode(m),r.call(this,m),m.remove(!0));z=null}}c.moveToBookmark(p);c.shrink(CKEDITOR.SHRINK_TEXT);c.shrink(CKEDITOR.NODE_ELEMENT,!0)}}function c(a){function b(){for(var a=new CKEDITOR.dom.elementPath(d.getParent()),c=new CKEDITOR.dom.elementPath(m.getParent()),f=null,g=null,e=0;e<a.elements.length;e++){var k=a.elements[e];if(k==a.block||k==a.blockLimit)break;l.checkElementRemovable(k,
...
1)&&(g=w(this,f,d),k(d,g));a.moveToBookmark(b)}function h(a){var b=a.createBookmark(1),c=a.createIterator();c.enforceRealBlocks=!0;c.enlargeBr=this._.enterMode!=CKEDITOR.ENTER_BR;for(var d,f;d=c.getNextParagraph();)this.checkElementRemovable(d)&&(d.is("pre")?((f=this._.enterMode==CKEDITOR.ENTER_BR?null:a.document.createElement(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))&&d.copyAttributes(f),k(d,f)):t.call(this,d));a.moveToBookmark(b)}function k(a,b){var c=!b;c&&(b=a.getDocument().createElement("div"),
...
"data-"==e.slice(0,5)||(g=a.hasAttribute(e),a.removeAttribute(e));for(var k in c)this._.definition.fullMatch&&a.getStyle(k)!=y(k,c[k],!0)||(g=g||!!a.getStyle(k),a.removeStyle(k));q(a,f,x[a.getName()]);g&&(this._.definition.alwaysRemoveElement?p(a,1):!CKEDITOR.dtd.$block[a.getName()]||this._.enterMode==CKEDITOR.ENTER_BR&&!a.hasAttributes()?p(a):a.renameNode(this._.enterMode==CKEDITOR.ENTER_P?"p":"div"))}function r(a){for(var b=v(this),c=a.getElementsByTag(this.element),d,f=c.count();0<=--f;)d=c.getItem(f),
d.isReadOnly()||t.call(this,d,!0);for(var g in b)if(g!=this.element)for(c=a.getElementsByTag(g),f=c.count()-1;0<=f;f--)d=c.getItem(f),d.isReadOnly()||q(d,b[g])}function q(a,b,c){if(b=b&&b.attributes)for(var d=0;d<b.length;d++){var f=b[d][0],g;if(g=a.getAttribute(f)){var e=b[d][1];(null===e||e.test&&e.test(g)||"string"==typeof e&&g==e)&&a.removeAttribute(f)}}c||p(a)}function p(a,b){if(!a.hasAttributes()||b)if(CKEDITOR.dtd.$block[a.getName()]){var c=a.getPrevious(I),d=a.getNext(I);!c||c.type!=CKEDITOR.NODE_TEXT&&
...
function m(a){var b=CKEDITOR.dom.element.createFromHtml(CKEDITOR.addTemplate("dialog",q).output({id:CKEDITOR.tools.getNextNumber(),editorId:a.id,langDir:a.lang.dir,langCode:a.langCode,editorDialogClass:"cke_editor_"+a.name.replace(/\./g,"\\.")+"_dialog",closeTitle:a.lang.common.close,hidpi:CKEDITOR.env.hidpi?"cke_hidpi":""})),c=b.getChild([0,0,0,0,0]),d=c.getChild(0),f=c.getChild(1);a.plugins.clipboard&&CKEDITOR.plugins.clipboard.preventDefaultDropOnElement(c);!CKEDITOR.env.ie||CKEDITOR.env.quirks||
...
x.getChild(0).getFrameDocument();g.on("mousemove",b);g.on("mouseup",c)}e.data.preventDefault()},a)}function g(a){function b(c){var n="rtl"==e.lang.dir,p=l.width,w=l.height,r=p+(c.data.$.screenX-m.x)*(n?-1:1)*(a._.moved?1:2),z=w+(c.data.$.screenY-m.y)*(a._.moved?1:2),t=a._.element.getFirst(),t=n&&t.getComputedStyle("right"),q=a.getPosition();q.y+z>h.height&&(z=h.height-q.y);(n?t:q.x)+r>h.width&&(r=h.width-(n?t:q.x));if(f==CKEDITOR.DIALOG_RESIZE_WIDTH||f==CKEDITOR.DIALOG_RESIZE_BOTH)p=Math.max(d.minWidth||
0,r-g);if(f==CKEDITOR.DIALOG_RESIZE_HEIGHT||f==CKEDITOR.DIALOG_RESIZE_BOTH)w=Math.max(d.minHeight||0,z-k);a.resize(p,w);a._.moved||a.layout();c.data.preventDefault()}function c(){CKEDITOR.document.removeListener("mouseup",c);CKEDITOR.document.removeListener("mousemove",b);n&&(n.remove(),n=null);if(CKEDITOR.env.ie6Compat){var a=x.getChild(0).getFrameDocument();a.removeListener("mouseup",c);a.removeListener("mousemove",b)}}var d=a.definition,f=d.resizable;if(f!=CKEDITOR.DIALOG_RESIZE_NONE){var e=a.getParentEditor(),
...
"px"})};var k=function(){var a=b.getScrollPosition(),c=CKEDITOR.dialog._.currentTop;g.setStyles({left:a.x+"px",top:a.y+"px"});if(c){do a=c.getPosition(),c.move(a.x,a.y);while(c=c._.parentDialog)}};y=a;b.on("resize",a);a();CKEDITOR.env.mac&&CKEDITOR.env.webkit||g.focus();if(CKEDITOR.env.ie6Compat){var h=function(){k();arguments.callee.prevScrollHandler.apply(this,arguments)};b.$.setTimeout(function(){h.prevScrollHandler=window.onscroll||function(){};window.onscroll=h},0);k()}}function t(a){x&&(a.focusManager.remove(x),
...
x._.currentFocusIndex=-1;return}f=(f+b.length)%b.length;if(f==c)break}while(a&&!b[f].isFocusable());b[f].focus();"text"==b[f].type&&b[f].select()}}function n(c){if(x==CKEDITOR.dialog._.currentTop){var d=c.data.getKeystroke(),f="rtl"==b.lang.dir,g=[37,38,39,40];B=y=0;if(9==d||d==CKEDITOR.SHIFT+9)l(d==CKEDITOR.SHIFT+9?-1:1),B=1;else if(d==CKEDITOR.ALT+121&&!x._.tabBarMode&&1<x.getPageCount())x._.tabBarMode=!0,x._.tabs[x._.currentTabId][0].focus(),x._.currentFocusIndex=-1,B=1;else if(-1!=CKEDITOR.tools.indexOf(g,
...
this._.tabBarMode=!1,this._.currentFocusIndex=-1,l(1),B=1;w(c)}}function w(a){B?a.data.preventDefault(1):y&&a.data.stopPropagation()}var r=CKEDITOR.dialog._.dialogDefinitions[f],z=CKEDITOR.tools.clone(p),t=b.config.dialog_buttonsOrder||"OS",q=b.lang.dir,u={},B,y;("OS"==t&&CKEDITOR.env.mac||"rtl"==t&&"ltr"==q||"ltr"==t&&"rtl"==q)&&z.buttons.reverse();r=CKEDITOR.tools.extend(r(b),z);r=CKEDITOR.tools.clone(r);r=new v(this,r);z=m(b);this._={editor:b,element:z.element,name:f,contentSize:{width:0,height:0},
...
{name:f,definition:r},b).definition;if(!("removeDialogTabs"in b._)&&b.config.removeDialogTabs){z=b.config.removeDialogTabs.split(";");for(q=0;q<z.length;q++)if(t=z[q].split(":"),2==t.length){var C=t[0];u[C]||(u[C]=[]);u[C].push(t[1])}b._.removeDialogTabs=u}if(b._.removeDialogTabs&&(u=b._.removeDialogTabs[f]))for(q=0;q<u.length;q++)r.removeContents(u[q]);if(r.onLoad)this.on("load",r.onLoad);if(r.onShow)this.on("show",r.onShow);if(r.onHide)this.on("hide",r.onHide);if(r.onOk)this.on("ok",function(a){b.fire("saveSnapshot");
...
(a=r.onFocus.call(this))&&a.focus():l(1))},this,null,4294967295);if(CKEDITOR.env.ie6Compat)this.on("load",function(){var a=this.getElement(),b=a.getFirst();b.remove();b.appendTo(a)},this);k(this);g(this);(new CKEDITOR.dom.text(r.title,CKEDITOR.document)).appendTo(this.parts.title);for(q=0;q<r.contents.length;q++)(u=r.contents[q])&&this.addPage(u);this.parts.tabs.on("click",function(a){var b=a.data.getTarget();b.hasClass("cke_dialog_tab")&&(b=b.$.id,this.selectPage(b.substring(4,b.lastIndexOf("_"))),
this._.tabBarMode&&(this._.tabBarMode=!1,this._.currentFocusIndex=-1,l(1)),a.data.preventDefault())},this);q=[];u=CKEDITOR.dialog._.uiElementBuilders.hbox.build(this,{type:"hbox",className:"cke_dialog_footer_buttons",widths:[],children:r.buttons},q).getChild();this.parts.footer.setHtml(q.join(""));for(q=0;q<u.length;q++)this._.buttons[u[q].id]=u[q]};CKEDITOR.dialog.prototype={destroy:function(){this.hide();this._.element.remove()},resize:function(){return function(a,b){this._.contentSize&&this._.contentSize.width==
...
h=["\x3c",k," "],m=(f&&f.call?f(b):f)||{},l=(e&&e.call?e(b):e)||{},n=(g&&g.call?g.call(this,a,b):g)||"",p=this.domId=l.id||CKEDITOR.tools.getNextId()+"_uiElement";b.requiredContent&&!a.getParentEditor().filter.check(b.requiredContent)&&(m.display="none",this.notAllowed=!0);l.id=p;var r={};b.type&&(r["cke_dialog_ui_"+b.type]=1);b.className&&(r[b.className]=1);b.disabled&&(r.cke_disabled=1);for(var w=l["class"]&&l["class"].split?l["class"].split(" "):[],p=0;p<w.length;p++)w[p]&&(r[w[p]]=1);w=[];for(p in r)w.push(p);
l["class"]=w.join(" ");b.title&&(l.title=b.title);r=(b.style||"").split(";");b.align&&(w=b.align,m["margin-left"]="left"==w?0:"auto",m["margin-right"]="right"==w?0:"auto");for(p in m)r.push(p+":"+m[p]);b.hidden&&r.push("display:none");for(p=r.length-1;0<=p;p--)""===r[p]&&r.splice(p,1);0<r.length&&(l.style=(l.style?l.style+"; ":"")+r.join("; "));for(p in l)h.push(p+'\x3d"'+CKEDITOR.tools.htmlEncode(l[p])+'" ');h.push("\x3e",n,"\x3c/",k,"\x3e");c.push(h.join(""));(this._||(this._={})).dialog=a;"boolean"==
...
(b="cke_dialog_ui_hbox_first");h==c.length-1&&(b="cke_dialog_ui_hbox_last");a.push('\x3ctd class\x3d"',b,'" role\x3d"presentation" ');g?g[h]&&d.push("width:"+r(g[h])):d.push("width:"+Math.floor(100/c.length)+"%");k&&d.push("height:"+r(k));f&&void 0!==f.padding&&d.push("padding:"+r(f.padding));CKEDITOR.env.ie&&CKEDITOR.env.quirks&&e[h].align&&d.push("text-align:"+e[h].align);0<d.length&&a.push('style\x3d"'+d.join("; ")+'" ');a.push("\x3e",c[h],"\x3c/td\x3e")}a.push("\x3c/tr\x3e\x3c/tbody\x3e");return a.join("")})}},
...
"setAttribute","removeAttribute"],k=0;k<h.length;k++)f[h[k]]=CKEDITOR.tools.override(f[h[k]],c)}(),function(){var a={exec:function(a){var b=a.getCommand("blockquote").state,c=a.getSelection(),d=c&&c.getRanges()[0];if(d){var m=c.createBookmarks();if(CKEDITOR.env.ie){var l=m[0].startNode,f=m[0].endNode,h;if(l&&"blockquote"==l.getParent().getName())for(h=l;h=h.getNext();)if(h.type==CKEDITOR.NODE_ELEMENT&&h.isBlockBoundary()){l.move(h,!0);break}if(f&&"blockquote"==f.getParent().getName())for(h=f;h=h.getPrevious();)if(h.type==
CKEDITOR.NODE_ELEMENT&&h.isBlockBoundary()){f.move(h);break}}var k=d.createIterator();k.enlargeBr=a.config.enterMode!=CKEDITOR.ENTER_BR;if(b==CKEDITOR.TRISTATE_OFF){for(l=[];b=k.getNextParagraph();)l.push(b);1>l.length&&(b=a.document.createElement(a.config.enterMode==CKEDITOR.ENTER_P?"p":"div"),f=m.shift(),d.insertNode(b),b.append(new CKEDITOR.dom.text("﻿",a.document)),d.moveToBookmark(f),d.selectNodeContents(b),d.collapse(!0),f=d.createBookmark(),l.push(b),m.unshift(f));h=l[0].getParent();d=[];for(f=
0;f<l.length;f++)b=l[f],h=h.getCommonAncestor(b.getParent());for(b={table:1,tbody:1,tr:1,ol:1,ul:1};b[h.getName()];)h=h.getParent();for(f=null;0<l.length;){for(b=l.shift();!b.getParent().equals(h);)b=b.getParent();b.equals(f)||d.push(b);f=b}for(;0<d.length;)if(b=d.shift(),"blockquote"==b.getName()){for(f=new CKEDITOR.dom.documentFragment(a.document);b.getFirst();)f.append(b.getFirst().remove()),l.push(f.getLast());f.replace(b)}else l.push(b);d=a.document.createElement("blockquote");for(d.insertBefore(l[0]);0<
l.length;)b=l.shift(),d.append(b)}else if(b==CKEDITOR.TRISTATE_ON){f=[];for(h={};b=k.getNextParagraph();){for(l=d=null;b.getParent();){if("blockquote"==b.getParent().getName()){d=b.getParent();l=b;break}b=b.getParent()}d&&l&&!l.getCustomData("blockquote_moveout")&&(f.push(l),CKEDITOR.dom.element.setMarker(h,l,"blockquote_moveout",!0))}CKEDITOR.dom.element.clearAllMarkers(h);b=[];l=[];for(h={};0<f.length;)k=f.shift(),d=k.getParent(),k.getPrevious()?k.getNext()?(k.breakParent(k.getParent()),l.push(k.getNext())):
k.remove().insertAfter(d):k.remove().insertBefore(d),d.getCustomData("blockquote_processed")||(l.push(d),CKEDITOR.dom.element.setMarker(h,d,"blockquote_processed",!0)),b.push(k);CKEDITOR.dom.element.clearAllMarkers(h);for(f=l.length-1;0<=f;f--){d=l[f];a:{h=d;for(var k=0,g=h.getChildCount(),n=void 0;k<g&&(n=h.getChild(k));k++)if(n.type==CKEDITOR.NODE_ELEMENT&&n.isBlockBoundary()){h=!1;break a}h=!0}h&&d.remove()}if(a.config.enterMode==CKEDITOR.ENTER_BR)for(d=!0;b.length;)if(k=b.shift(),"div"==k.getName()){f=
...
D||y(a)});"beforepaste"==A.mainPasteEvent&&(a.on("paste",function(a){G||(e(),a.data.preventDefault(),y(a),k("paste")||b.openDialog("paste"))}),a.on("contextmenu",h,null,null,0),a.on("beforepaste",function(a){!a.data||a.data.$.ctrlKey||a.data.$.shiftKey||h()},null,null,0));a.on("beforecut",function(){!D&&m(b)});var f;a.attachListener(CKEDITOR.env.ie?a:b.document.getDocumentElement(),"mouseup",function(){f=setTimeout(function(){C()},0)});b.on("destroy",function(){clearTimeout(f)});a.on("keyup",C)}function d(a){return{type:a,
canUndo:"cut"==a,startDisabled:!0,exec:function(){"cut"==this.type&&m();var a;var c=this.type;if(CKEDITOR.env.ie)a=k(c);else try{a=b.document.$.execCommand(c,!1,null)}catch(d){a=!1}a||b.showNotification(b.lang.clipboard[this.type+"Error"]);return a}}}function f(){return{canUndo:!1,async:!0,exec:function(b,c){var d=function(c,d){c&&a(b,c,!!d);b.fire("afterCommandExec",{name:"paste",command:f,returnValue:!!c})},f=this;"string"==typeof c?d({dataValue:c,method:"paste",dataTransfer:A.initPasteDataTransfer()},
1):b.getClipboardData(d)}}}function e(){G=1;setTimeout(function(){G=0},100)}function h(){D=1;setTimeout(function(){D=0},10)}function k(a){var c=b.document,d=c.getBody(),f=!1,e=function(){f=!0};d.on(a,e);7<CKEDITOR.env.version?c.$.execCommand(a):c.$.selection.createRange().execCommand(a);d.removeListener(a,e);return f}function m(){if(CKEDITOR.env.ie&&!CKEDITOR.env.quirks){var a=b.getSelection(),c,d,f;a.getType()==CKEDITOR.SELECTION_ELEMENT&&(c=a.getSelectedElement())&&(d=a.getRanges()[0],f=b.document.createText(""),
f.insertBefore(c),d.setStartBefore(f),d.setEndAfter(c),a.selectRanges([d]),setTimeout(function(){c.getParent()&&(f.remove(),a.selectElement(c))},0))}}function l(a,c){var d=b.document,f=b.editable(),e=function(a){a.cancel()},h;if(!d.getById("cke_pastebin")){var k=b.getSelection(),m=k.createBookmarks();CKEDITOR.env.ie&&k.root.fire("selectionchange");var n=new CKEDITOR.dom.element(!CKEDITOR.env.webkit&&!f.is("body")||CKEDITOR.env.ie?"div":"body",d);n.setAttributes({id:"cke_pastebin","data-cke-temp":"1"});
...
"text"));(p=n.getParent().isReadOnly())?(n.setOpacity(0),n.setAttribute("contenteditable",!0)):n.setStyle("ltr"==b.config.contentsLangDirection?"left":"right","-1000px");b.on("selectionChange",e,null,null,0);if(CKEDITOR.env.webkit||CKEDITOR.env.gecko)h=f.once("blur",e,null,null,-100);p&&n.focus();p=new CKEDITOR.dom.range(n);p.selectNodeContents(n);var w=p.select();CKEDITOR.env.ie&&(h=f.once("blur",function(){b.lockSelection(w)}));var r=CKEDITOR.document.getWindow().getScrollPosition().y;setTimeout(function(){CKEDITOR.env.webkit&&
...
b.addCommand(d,f);b.ui.addButton&&b.ui.addButton(c,{label:k,command:d,toolbar:"clipboard,"+e});b.addMenuItems&&b.addMenuItem(d,{label:k,command:d,group:"clipboard",order:h})}a("Cut","cut",d("cut"),10,1);a("Copy","copy",d("copy"),20,4);a("Paste","paste",f(),30,8)})();b.getClipboardData=function(a,c){function d(a){a.removeListener();a.cancel();c(a.data)}function f(a){a.removeListener();a.cancel();m=!0;c({type:k,dataValue:a.data.dataValue,dataTransfer:a.data.dataTransfer,method:"paste"})}function e(){this.customTitle=
...
"\x3cbr\x3e")),-1<b.indexOf("\x3cbr\x3e\x3cbr\x3e")&&(b="\x3cp\x3e"+b.replace(/(<br>){2,}/g,function(a){return c(a.length/4)})+"\x3c/p\x3e"));return l(a,b)}function d(){function a(){var b={},c;for(c in CKEDITOR.dtd)"$"!=c.charAt(0)&&"div"!=c&&"span"!=c&&(b[c]=1);return b}var b={};return{get:function(c){return"plain-text"==c?b.plainText||(b.plainText=new CKEDITOR.filter("br")):"semantic-content"==c?((c=b.semanticContent)||(c=new CKEDITOR.filter,c.allow({$1:{elements:a(),attributes:!0,styles:!1,classes:!1}}),
...
c&&(f.dragRange=c);d&&(f.dropRange=d);!1===b.fire(a.name,f)&&a.data.preventDefault()}function h(a){a.type!=CKEDITOR.NODE_ELEMENT&&(a=a.getParent());return a.getChildCount()}var k=b.editable(),m=CKEDITOR.plugins.clipboard.getDropTarget(b),l=b.ui.space("top"),B=b.ui.space("bottom");c.preventDefaultDropOnElement(l);c.preventDefaultDropOnElement(B);k.attachListener(m,"dragstart",e);k.attachListener(b,"dragstart",c.resetDragDataTransfer,c,null,1);k.attachListener(b,"dragstart",function(a){c.initDragDataTransfer(a,
b)},null,null,2);k.attachListener(b,"dragstart",function(){var a=c.dragRange=b.getSelection().getRanges()[0];CKEDITOR.env.ie&&10>CKEDITOR.env.version&&(c.dragStartContainerChildCount=a?h(a.startContainer):null,c.dragEndContainerChildCount=a?h(a.endContainer):null)},null,null,100);k.attachListener(m,"dragend",e);k.attachListener(b,"dragend",c.initDragDataTransfer,c,null,1);k.attachListener(b,"dragend",c.resetDragDataTransfer,c,null,100);k.attachListener(m,"dragover",function(a){var b=a.data.getTarget();
...
1);c=f.createRange();c.moveToBookmark(e);a(f,{dataTransfer:d,method:"drop",range:c},1);f.fire("unlockSnapshot")},getRangeAtDropPosition:function(a,b){var c=a.data.$,d=c.clientX,f=c.clientY,e=b.getSelection(!0).getRanges()[0],k=b.createRange();if(a.data.testRange)return a.data.testRange;if(document.caretRangeFromPoint)c=b.document.$.caretRangeFromPoint(d,f),k.setStart(CKEDITOR.dom.node(c.startContainer),c.startOffset),k.collapse(!0);else if(c.rangeParent)k.setStart(CKEDITOR.dom.node(c.rangeParent),
c.rangeOffset),k.collapse(!0);else{if(CKEDITOR.env.ie&&8<CKEDITOR.env.version&&e&&b.editable().hasFocus)return e;if(document.body.createTextRange){b.focus();c=b.document.getBody().$.createTextRange();try{for(var h=!1,m=0;20>m&&!h;m++){if(!h)try{c.moveToPoint(d,f-m),h=!0}catch(l){}if(!h)try{c.moveToPoint(d,f+m),h=!0}catch(v){}}if(h){var y="cke-temp-"+(new Date).getTime();c.pasteHTML('\x3cspan id\x3d"'+y+'"\x3e​\x3c/span\x3e');var C=b.document.getById(y);k.moveToPosition(C,CKEDITOR.POSITION_BEFORE_START);
C.remove()}else{var x=b.document.$.elementFromPoint(d,f),A=new CKEDITOR.dom.element(x),D;if(A.equals(b.editable())||"html"==A.getName())return e&&e.startContainer&&!e.startContainer.equals(b.editable())?e:null;D=A.getClientRect();d<D.left?k.setStartAt(A,CKEDITOR.POSITION_AFTER_START):k.setStartAt(A,CKEDITOR.POSITION_BEFORE_END);k.collapse(!0)}}catch(G){return null}}else return null}return k},initDragDataTransfer:function(a,b){var c=a.data.$?a.data.$.dataTransfer:null,d=new this.dataTransfer(c,b);
...
titleJs:l.gecko&&!l.hc?"":(this.title||"").replace("'",""),hasArrow:this.hasArrow?"true":"false",keydownFn:u,focusFn:t,clickFn:g,style:CKEDITOR.skin.getIconStyle(w,"rtl"==a.lang.dir,this.icon,this.iconOffset),arrowHtml:this.hasArrow?e.output():""};b.output(h,d);if(this.onRender)this.onRender();return n},setState:function(a){if(this._.state==a)return!1;this._.state=a;var b=CKEDITOR.document.getById(this._.id);return b?(b.setState(a,"cke_button"),a==CKEDITOR.TRISTATE_DISABLED?b.setAttribute("aria-disabled",
...
b.parent&&b.parent.getDocument()||CKEDITOR.document;b.block={attributes:b.attributes};this.hasArrow=b.toolbarRelated=!0;this.click=a;this._={panelDefinition:b}},statics:{handler:{create:function(a){return new CKEDITOR.ui.panelButton(a)}}},proto:{createPanel:function(a){var b=this._;if(!b.panel){var c=this._.panelDefinition,d=this._.panelDefinition.block,m=c.parent||CKEDITOR.document.getBody(),l=this._.panel=new CKEDITOR.ui.floatPanel(a,m,c),c=l.addBlock(b.id,d),f=this;l.onShow=function(){f.className&&
this.element.addClass(f.className+"_panel");f.setState(CKEDITOR.TRISTATE_ON);b.on=1;f.editorFocus&&a.focus();if(f.onOpen)f.onOpen()};l.onHide=function(c){f.className&&this.element.getFirst().removeClass(f.className+"_panel");f.setState(f.modes&&f.modes[a.mode]?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);b.on=0;if(!c&&f.onClose)f.onClose()};l.onEscape=function(){l.hide(1);f.document.getById(b.id).focus()};if(this.onBlock)this.onBlock(l,c);c.onHide=function(){b.on=0;f.setState(CKEDITOR.TRISTATE_OFF)}}}}})},
...
"transparent"==c&&b&&(b=b.getParent()));c&&"transparent"!=c||(c="#ffffff");this._.panel._.iframe.getFrameDocument().getById(n).setStyle("background-color",c);return c}}})}function b(b,f,e){var k=[],g=d.colorButton_colors.split(","),n=a.plugins.colordialog&&!1!==d.colorButton_enableMore,u=g.length+(n?2:1),t=CKEDITOR.tools.addFunction(function(f,e){function g(a){this.removeListener("ok",g);this.removeListener("cancel",g);"ok"==a.name&&k(this.getContentElement("picker","selectedColor").getValue(),e)}
var k=arguments.callee;if("?"==f)a.openDialog("colordialog",function(){this.on("ok",g);this.on("cancel",g)});else{a.focus();b.hide();a.fire("saveSnapshot");a.removeStyle(new CKEDITOR.style(d["colorButton_"+e+"Style"],{color:"inherit"}));if(f){var h=d["colorButton_"+e+"Style"];h.childRule="back"==e?function(a){return c(a)}:function(a){return!(a.is("a")||a.getElementsByTag("a").count())||c(a)};a.applyStyle(new CKEDITOR.style(h,{color:f}))}a.fire("saveSnapshot")}});k.push('\x3ca class\x3d"cke_colorauto" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',
m.auto,'" onclick\x3d"CKEDITOR.tools.callFunction(',t,",null,'",f,"');return false;\" href\x3d\"javascript:void('",m.auto,'\')" role\x3d"option" aria-posinset\x3d"1" aria-setsize\x3d"',u,'"\x3e\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e\x3ctr\x3e\x3ctd\x3e\x3cspan class\x3d"cke_colorbox" id\x3d"',e,'"\x3e\x3c/span\x3e\x3c/td\x3e\x3ctd colspan\x3d7 align\x3dcenter\x3e',m.auto,'\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/a\x3e\x3ctable role\x3d"presentation" cellspacing\x3d0 cellpadding\x3d0 width\x3d"100%"\x3e');
for(e=0;e<g.length;e++){0===e%8&&k.push("\x3c/tr\x3e\x3ctr\x3e");var r=g[e].split("/"),q=r[0],p=r[1]||q;r[1]||(q="#"+q.replace(/^(.)(.)(.)$/,"$1$1$2$2$3$3"));r=a.lang.colorbutton.colors[p]||p;k.push('\x3ctd\x3e\x3ca class\x3d"cke_colorbox" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',r,'" onclick\x3d"CKEDITOR.tools.callFunction(',t,",'",q,"','",f,"'); return false;\" href\x3d\"javascript:void('",r,'\')" role\x3d"option" aria-posinset\x3d"',e+2,'" aria-setsize\x3d"',u,'"\x3e\x3cspan class\x3d"cke_colorbox" style\x3d"background-color:#',
p,'"\x3e\x3c/span\x3e\x3c/a\x3e\x3c/td\x3e')}n&&k.push('\x3c/tr\x3e\x3ctr\x3e\x3ctd colspan\x3d8 align\x3dcenter\x3e\x3ca class\x3d"cke_colormore" _cke_focus\x3d1 hidefocus\x3dtrue title\x3d"',m.more,'" onclick\x3d"CKEDITOR.tools.callFunction(',t,",'?','",f,"');return false;\" href\x3d\"javascript:void('",m.more,"')\"",' role\x3d"option" aria-posinset\x3d"',u,'" aria-setsize\x3d"',u,'"\x3e',m.more,"\x3c/a\x3e\x3c/td\x3e");k.push("\x3c/tr\x3e\x3c/table\x3e");return k.join("")}function c(a){return"false"==
a.getAttribute("contentEditable")||a.getAttribute("data-nostyle")}var d=a.config,m=a.lang.colorbutton;CKEDITOR.env.hc||(e("TextColor","fore",m.textColorTitle,10),e("BGColor","back",m.bgColorTitle,20))}}),CKEDITOR.config.colorButton_colors="000,800000,8B4513,2F4F4F,008080,000080,4B0082,696969,B22222,A52A2A,DAA520,006400,40E0D0,0000CD,800080,808080,F00,FF8C00,FFD700,008000,0FF,00F,EE82EE,A9A9A9,FFA07A,FFA500,FFFF00,00FF00,AFEEEE,ADD8E6,DDA0DD,D3D3D3,FFF0F5,FAEBD7,FFFFE0,F0FFF0,F0FFFF,F0F8FF,E6E6FA,FFF",
...
b.activeShiftEnterMode,1)}});b.setKeystroke([[13,"enter"],[CKEDITOR.SHIFT+13,"shiftEnter"]])}});var c=CKEDITOR.dom.walker.whitespaces(),d=CKEDITOR.dom.walker.bookmark();CKEDITOR.plugins.enterkey={enterBlock:function(a,f,m,u){if(m=m||e(a)){m=b(m);var t=m.document,r=m.checkStartOfBlock(),q=m.checkEndOfBlock(),p=a.elementPath(m.startContainer),w=p.block,z=f==CKEDITOR.ENTER_DIV?"div":"p",B;if(r&&q){if(w&&(w.is("li")||w.getParent().is("li"))){w.is("li")||(w=w.getParent());m=w.getParent();B=m.getParent();
u=!w.hasPrevious();var v=!w.hasNext(),z=a.getSelection(),y=z.createBookmarks(),r=w.getDirection(1),q=w.getAttribute("class"),C=w.getAttribute("style"),x=B.getDirection(1)!=r;a=a.enterMode!=CKEDITOR.ENTER_BR||x||C||q;if(B.is("li"))u||v?(u&&v&&m.remove(),w[v?"insertAfter":"insertBefore"](B)):w.breakParent(B);else{if(a)if(p.block.is("li")?(B=t.createElement(f==CKEDITOR.ENTER_P?"p":"div"),x&&B.setAttribute("dir",r),C&&B.setAttribute("style",C),q&&B.setAttribute("class",q),w.moveChildren(B)):B=p.block,
u||v)B[u?"insertBefore":"insertAfter"](m);else w.breakParent(m),B.insertAfter(m);else if(w.appendBogus(!0),u||v)for(;t=w[u?"getFirst":"getLast"]();)t[u?"insertBefore":"insertAfter"](m);else for(w.breakParent(m);t=w.getLast();)t.insertAfter(m);w.remove()}z.selectBookmarks(y);return}if(w&&w.getParent().is("blockquote")){w.breakParent(w.getParent());w.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1))||w.getPrevious().remove();w.getNext().getFirst(CKEDITOR.dom.walker.invisible(1))||w.getNext().remove();
m.moveToElementEditStart(w);m.select();return}}else if(w&&w.is("pre")&&!q){l(a,f,m,u);return}if(r=m.splitBlock(z)){f=r.previousBlock;w=r.nextBlock;p=r.wasStartOfBlock;a=r.wasEndOfBlock;w?(y=w.getParent(),y.is("li")&&(w.breakParent(y),w.move(w.getNext(),1))):f&&(y=f.getParent())&&y.is("li")&&(f.breakParent(y),y=f.getNext(),m.moveToElementEditStart(y),f.move(f.getPrevious()));if(p||a){if(f){if(f.is("li")||!h.test(f.getName())&&!f.is("pre"))B=f.clone()}else w&&(B=w.clone());B?u&&!B.is("li")&&B.renameNode(z):
y&&y.is("li")?B=y:(B=t.createElement(z),f&&(v=f.getDirection())&&B.setAttribute("dir",v));if(t=r.elementPath)for(u=0,z=t.elements.length;u<z;u++){y=t.elements[u];if(y.equals(t.block)||y.equals(t.blockLimit))break;CKEDITOR.dtd.$removeEmpty[y.getName()]&&(y=y.clone(),B.moveChildren(y),B.append(y))}B.appendBogus();B.getParent()||m.insertNode(B);B.is("li")&&B.removeAttribute("value");!CKEDITOR.env.ie||!p||a&&f.getChildCount()||(m.moveToElementEditStart(a?f:B),m.select());m.moveToElementEditStart(p&&!a?
w:B)}else w.is("li")&&(B=m.clone(),B.selectNodeContents(w),B=new CKEDITOR.dom.walker(B),B.evaluator=function(a){return!(d(a)||c(a)||a.type==CKEDITOR.NODE_ELEMENT&&a.getName()in CKEDITOR.dtd.$inline&&!(a.getName()in CKEDITOR.dtd.$empty))},(y=B.next())&&y.type==CKEDITOR.NODE_ELEMENT&&y.is("ul","ol")&&(CKEDITOR.env.needsBrFiller?t.createElement("br"):t.createText(" ")).insertBefore(y)),w&&m.moveToElementEditStart(w);m.select();m.scrollIntoView()}}},enterBr:function(a,b,c,d){if(c=c||e(a)){var m=c.document,
l=c.checkEndOfBlock(),q=new CKEDITOR.dom.elementPath(a.getSelection().getStartElement()),p=q.block,w=p&&q.block.getName();d||"li"!=w?(!d&&l&&h.test(w)?(l=p.getDirection())?(m=m.createElement("div"),m.setAttribute("dir",l),m.insertAfter(p),c.setStart(m,0)):(m.createElement("br").insertAfter(p),CKEDITOR.env.gecko&&m.createText("").insertAfter(p),c.setStartAt(p.getNext(),CKEDITOR.env.ie?CKEDITOR.POSITION_BEFORE_START:CKEDITOR.POSITION_AFTER_START)):(a="pre"==w&&CKEDITOR.env.ie&&8>CKEDITOR.env.version?
m.createText("\r"):m.createElement("br"),c.deleteContents(),c.insertNode(a),CKEDITOR.env.needsBrFiller?(m.createText("﻿").insertAfter(a),l&&(p||q.blockLimit).appendBogus(),a.getNext().$.nodeValue="",c.setStartAt(a.getNext(),CKEDITOR.POSITION_AFTER_START)):c.setStartAt(a,CKEDITOR.POSITION_AFTER_END)),c.collapse(!0),c.select(),c.scrollIntoView()):f(a,b,c,d)}}};var m=CKEDITOR.plugins.enterkey,l=m.enterBr,f=m.enterBlock,h=/^h[1-6]$/}(),function(){function a(a,b){var c={},d=[],m={nbsp:" ",shy:"­",gt:"\x3e",
...
d.entities_processNumerical&&l[a]?l[a]:"\x26#"+a.charCodeAt(0)+";"}var d=e.config;if(e=(e=e.dataProcessor)&&e.htmlFilter){var m=[];!1!==d.basicEntities&&m.push("nbsp,gt,lt,amp");d.entities&&(m.length&&m.push("quot,iexcl,cent,pound,curren,yen,brvbar,sect,uml,copy,ordf,laquo,not,shy,reg,macr,deg,plusmn,sup2,sup3,acute,micro,para,middot,cedil,sup1,ordm,raquo,frac14,frac12,frac34,iquest,times,divide,fnof,bull,hellip,prime,Prime,oline,frasl,weierp,image,real,trade,alefsym,larr,uarr,rarr,darr,harr,crarr,lArr,uArr,rArr,dArr,hArr,forall,part,exist,empty,nabla,isin,notin,ni,prod,sum,minus,lowast,radic,prop,infin,ang,and,or,cap,cup,int,there4,sim,cong,asymp,ne,equiv,le,ge,sub,sup,nsub,sube,supe,oplus,otimes,perp,sdot,lceil,rceil,lfloor,rfloor,lang,rang,loz,spades,clubs,hearts,diams,circ,tilde,ensp,emsp,thinsp,zwnj,zwj,lrm,rlm,ndash,mdash,lsquo,rsquo,sbquo,ldquo,rdquo,bdquo,dagger,Dagger,permil,lsaquo,rsaquo,euro"),
...
(f.langCode=b.langCode);c.action=a(d.url,f);c.filebrowser=d}function m(a,f,g,l){if(l&&l.length)for(var u,t=l.length;t--;)if(u=l[t],"hbox"!=u.type&&"vbox"!=u.type&&"fieldset"!=u.type||m(a,f,g,u.children),u.filebrowser)if("string"==typeof u.filebrowser&&(u.filebrowser={action:"fileButton"==u.type?"QuickUpload":"Browse",target:u.filebrowser}),"Browse"==u.filebrowser.action){var r=u.filebrowser.url;void 0===r&&(r=a.config["filebrowser"+e(f)+"BrowseUrl"],void 0===r&&(r=a.config.filebrowserBrowseUrl));
r&&(u.onClick=b,u.filebrowser.url=r,u.hidden=!1)}else if("QuickUpload"==u.filebrowser.action&&u["for"]&&(r=u.filebrowser.url,void 0===r&&(r=a.config["filebrowser"+e(f)+"UploadUrl"],void 0===r&&(r=a.config.filebrowserUploadUrl)),r)){var q=u.onClick;u.onClick=function(a){var b=a.sender;if(q&&!1===q.call(b,a))return!1;if(c.call(b,a)){a=b.getDialog().getContentElement(this["for"][0],this["for"][1]).getInputElement();if(b=new CKEDITOR.dom.element(a.$.form))(a=b.$.elements.ckCsrfToken)?a=new CKEDITOR.dom.element(a):
(a=new CKEDITOR.dom.element("input"),a.setAttributes({name:"ckCsrfToken",type:"hidden"}),b.append(a)),a.setAttribute("value",CKEDITOR.tools.getCsrfToken());return!0}return!1};u.filebrowser.url=r;u.hidden=!1;d(a,g.getContents(u["for"][0]).get(u["for"][1]),u.filebrowser)}}function l(a,b,c){if(-1!==c.indexOf(";")){c=c.split(";");for(var d=0;d<c.length;d++)if(l(a,b,c[d]))return!0;return!1}return(a=a.getContents(b).get(c).filebrowser)&&a.url}function f(a,b){var c=this._.filebrowserSe.getDialog(),d=this._.filebrowserSe["for"],
...
command:"flash",group:"flash"}});a.on("doubleclick",function(a){var b=a.data.element;b.is("img")&&"flash"==b.data("cke-real-element-type")&&(a.data.dialog="flash")});a.contextMenu&&a.contextMenu.addListener(function(a){if(a&&a.is("img")&&!a.isReadOnly()&&"flash"==a.data("cke-real-element-type"))return{flash:CKEDITOR.TRISTATE_OFF}})},afterInit:function(b){var d=b.dataProcessor;(d=d&&d.dataFilter)&&d.addRules({elements:{"cke:object":function(d){var l=d.attributes;if(!(l.classid&&String(l.classid).toLowerCase()||
a(d))){for(l=0;l<d.children.length;l++)if("cke:embed"==d.children[l].name){if(!a(d.children[l]))break;return e(b,d)}return null}return e(b,d)},"cke:embed":function(d){return a(d)?e(b,d):null}}},5)}})}(),CKEDITOR.tools.extend(CKEDITOR.config,{flashEmbedTagOnly:!1,flashAddEmbedTag:!0,flashConvertOnEdit:!1}),function(){function a(a){var d=a.config,m=a.fire("uiSpace",{space:"top",html:""}).html,l=function(){function f(a,c,d){h.setStyle(c,b(d));h.setStyle("position",a)}function g(a){var b=m.getDocumentPosition();
switch(a){case "top":f("absolute","top",b.y-z-y);break;case "pin":f("fixed","top",x);break;case "bottom":f("absolute","top",b.y+(p.height||p.bottom-p.top)+y)}k=a}var k,m,q,p,w,z,B,v=d.floatSpaceDockedOffsetX||0,y=d.floatSpaceDockedOffsetY||0,C=d.floatSpacePinnedOffsetX||0,x=d.floatSpacePinnedOffsetY||0;return function(f){if(m=a.editable()){var n=f&&"focus"==f.name;n&&h.show();a.fire("floatingSpaceLayout",{show:n});h.removeStyle("left");h.removeStyle("right");q=h.getClientRect();p=m.getClientRect();
...
h.setStyle(f,b(("pin"==k?C:v)+n+("pin"==k?0:"left"==f?B:-B)))):(k="pin",g("pin"),l(f))}}}();if(m){var f=new CKEDITOR.template('\x3cdiv id\x3d"cke_{name}" class\x3d"cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} '+CKEDITOR.env.cssClass+'" dir\x3d"{langDir}" title\x3d"'+(CKEDITOR.env.gecko?" ":"")+'" lang\x3d"{langCode}" role\x3d"application" style\x3d"{style}"'+(a.title?' aria-labelledby\x3d"cke_{name}_arialbl"':" ")+"\x3e"+(a.title?'\x3cspan id\x3d"cke_{name}_arialbl" class\x3d"cke_voice_label"\x3e{voiceLabel}\x3c/span\x3e':
...
a}},getState:function(){return this._.state},enable:function(){this._.state==CKEDITOR.TRISTATE_DISABLED&&this.setState(this._.lastState)},disable:function(){this._.state!=CKEDITOR.TRISTATE_DISABLED&&(this._.lastState=this._.state,this.setState(CKEDITOR.TRISTATE_DISABLED))}},statics:{handler:{create:function(a){return new CKEDITOR.ui.richCombo(a)}}}});CKEDITOR.ui.prototype.addRichCombo=function(a,c){this.add(a,CKEDITOR.UI_RICHCOMBO,c)}}(),function(){function a(a,c,d,m,l,f,h,k){var g=a.config,n=new CKEDITOR.style(h),
u=l.split(";");l=[];for(var t={},r=0;r<u.length;r++){var q=u[r];if(q){var q=q.split("/"),p={},w=u[r]=q[0];p[d]=l[r]=q[1]||w;t[w]=new CKEDITOR.style(h,p);t[w]._.definition.name=w}else u.splice(r--,1)}a.ui.addRichCombo(c,{label:m.label,title:m.panelTitle,toolbar:"styles,"+k,allowedContent:n,requiredContent:n,panel:{css:[CKEDITOR.skin.getPath("editor")].concat(g.contentsCss),multiSelect:!1,attributes:{"aria-label":m.panelTitle}},init:function(){this.startGroup(m.panelTitle);for(var a=0;a<u.length;a++){var b=
u[a];this.add(b,t[b].buildPreview(),b)}},onClick:function(c){a.focus();a.fire("saveSnapshot");var d=this.getValue(),f=t[c];if(d&&c!=d){var g=t[d],k=a.getSelection().getRanges()[0];if(k.collapsed){var h=a.elementPath(),l=h.contains(function(a){return g.checkElementRemovable(a)});if(l){var m=k.checkBoundaryOfElement(l,CKEDITOR.START),p=k.checkBoundaryOfElement(l,CKEDITOR.END);if(m&&p){for(m=k.createBookmark();h=l.getFirst();)h.insertBefore(l);l.remove();k.moveToBookmark(m)}else m?k.moveToPosition(l,
CKEDITOR.POSITION_BEFORE_START):p?k.moveToPosition(l,CKEDITOR.POSITION_AFTER_END):(k.splitElement(l),k.moveToPosition(l,CKEDITOR.POSITION_AFTER_END),e(k,h.elements.slice(),l));a.getSelection().selectRanges([k])}}else a.removeStyle(g)}a[d==c?"removeStyle":"applyStyle"](f);a.fire("saveSnapshot")},onRender:function(){a.on("selectionChange",function(c){var d=this.getValue();c=c.data.path.elements;for(var e=0,g;e<c.length;e++){g=c[e];for(var k in t)if(t[k].checkElementMatch(g,!0,a)){k!=d&&this.setValue(k);
...
k.getDirection())d.setStartAfter(k),e=new CKEDITOR.dom.walker(d);else{var g=b.config.indentClasses;if(g)for(var n="ltr"==a.data.dir?["_rtl",""]:["","_rtl"],u=0;u<g.length;u++)k.hasClass(g[u]+n[0])&&(k.removeClass(g[u]+n[0]),k.addClass(g[u]+n[1]));g=k.getStyle("margin-right");n=k.getStyle("margin-left");g?k.setStyle("margin-left",g):k.removeStyle("margin-left");n?k.setStyle("margin-right",n):k.removeStyle("margin-right")}})}});CKEDITOR.plugins.indent={genericDefinition:function(a){this.isIndent=!!a;
...
!0),a.fire("unlockSnapshot"),CKEDITOR.dom.element.clearAllMarkers(b.database))},this,null,d),c.on("refresh",function(c){c.data.states||(c.data.states={});c.data.states[b.name+"@"+d]=b.refreshJob(a,d,c.data.path)},this,null,d);a.addFeature(b)})(this,b[a])})}};CKEDITOR.plugins.indent.genericDefinition.prototype={context:"p",exec:function(){}};CKEDITOR.plugins.indent.specificDefinition.prototype={execJob:function(a,b){var m=this.jobs[b];if(m.state!=e)return m.exec.call(this,a)},refreshJob:function(a,
...
l[r[m].getName()]){e=r[m];break}for(var r=d.isIndent?1:-1,m=h[0],h=h[h.length-1],q=CKEDITOR.plugins.list.listToArray(e,g),y=q[h.getCustomData("listarray_index")].indent,m=m.getCustomData("listarray_index");m<=h.getCustomData("listarray_index");m++)if(q[m].indent+=r,0<r){var u=q[m].parent;q[m].parent=new CKEDITOR.dom.element(u.getName(),u.getDocument())}for(m=h.getCustomData("listarray_index")+1;m<q.length&&q[m].indent>y;m++)q[m].indent+=r;h=CKEDITOR.plugins.list.arrayToList(q,g,null,a.config.enterMode,
e.getDirection());if(!d.isIndent){var x;if((x=e.getParent())&&x.is("li"))for(var r=h.listNode.getChildren(),A=[],D,m=r.count()-1;0<=m;m--)(D=r.getItem(m))&&D.is&&D.is("li")&&A.push(D)}h&&h.listNode.replace(e);if(A&&A.length)for(m=0;m<A.length;m++){for(D=e=A[m];(D=D.getNext())&&D.is&&D.getName()in l;)CKEDITOR.env.needsNbspFiller&&!e.getFirst(b)&&e.append(t.document.createText(" ")),e.append(D);e.insertAfter(x)}h&&a.fire("contentDomInvalidated");return!0}for(var d=this,g=this.database,l=this.context,
m=a.getSelection(),m=(m&&m.getRanges()).createIterator(),t;t=m.getNextRange();){for(var r=t.getCommonAncestor();r&&(r.type!=CKEDITOR.NODE_ELEMENT||!l[r.getName()]);){if(a.editable().equals(r)){r=!1;break}r=r.getParent()}r||(r=t.startPath().contains(l))&&t.setEndAt(r,CKEDITOR.POSITION_BEFORE_END);if(!r){var q=t.getEnclosedNode();q&&q.type==CKEDITOR.NODE_ELEMENT&&q.getName()in l&&(t.setStartAt(q,CKEDITOR.POSITION_AFTER_START),t.setEndAt(q,CKEDITOR.POSITION_BEFORE_END),r=q)}r&&t.startContainer.type==
CKEDITOR.NODE_ELEMENT&&t.startContainer.getName()in l&&(q=new CKEDITOR.dom.walker(t),q.evaluator=e,t.startContainer=q.next());r&&t.endContainer.type==CKEDITOR.NODE_ELEMENT&&t.endContainer.getName()in l&&(q=new CKEDITOR.dom.walker(t),q.evaluator=e,t.endContainer=q.previous());if(r)return c(r)}return 0}function e(a){return a.type==CKEDITOR.NODE_ELEMENT&&a.is("li")}function b(a){return c(a)&&d(a)}var c=CKEDITOR.dom.walker.whitespaces(!0),d=CKEDITOR.dom.walker.bookmark(!1,!0),m=CKEDITOR.TRISTATE_DISABLED,
...
if(this.enterBr||this.getContext(c)){if(k){var h=k,f=f.$.className.match(this.classNameRegex),l=this.isIndent,h=f?l?f[1]!=h.slice(-1):!0:l;return h?m:d}return this.isIndent?m:f?CKEDITOR[0>=(parseInt(f.getStyle(e(f)),10)||0)?"TRISTATE_DISABLED":"TRISTATE_OFF"]:d}return d},exec:function(b){var d=b.getSelection(),d=d&&d.getRanges()[0],f;if(f=b.elementPath().contains(c))a.call(this,f,k);else for(d=d.createIterator(),b=b.config.enterMode,d.enforceRealBlocks=!0,d.enlargeBr=b!=CKEDITOR.ENTER_BR;f=d.getNextParagraph(b==
CKEDITOR.ENTER_P?"p":"div");)f.isReadOnly()||a.call(this,f,k);return!0}}}}var h=CKEDITOR.plugins.indent,k=l.config.indentClasses;h.registerCommands(l,{indentblock:new f(l,"indentblock",!0),outdentblock:new f(l,"outdentblock")});CKEDITOR.tools.extend(f.prototype,h.specificDefinition.prototype,{context:{div:1,dl:1,h1:1,h2:1,h3:1,h4:1,h5:1,h6:1,ul:1,ol:1,p:1,pre:1,table:1},classNameRegex:k?new RegExp("(?:^|\\s+)("+k.join("|")+")(?\x3d$|\\s)"):null})}})}(),function(){function a(a,b){b=void 0===b||b;var e;
...
(this.allowedContent.div=!0)}function b(a){var b=a.editor,e=b.createRange();e.setStartBefore(a.data.node);e.setEndAfter(a.data.node);for(var l=new CKEDITOR.dom.walker(e),f;f=l.next();)if(f.type==CKEDITOR.NODE_ELEMENT)if(!f.equals(a.data.node)&&f.getDirection())e.setStartAfter(f),l=new CKEDITOR.dom.walker(e);else{var h=b.config.justifyClasses;h&&(f.hasClass(h[0])?(f.removeClass(h[0]),f.addClass(h[2])):f.hasClass(h[2])&&(f.removeClass(h[2]),f.addClass(h[0])));h=f.getStyle("text-align");"left"==h?f.setStyle("text-align",
"right"):"right"==h&&f.setStyle("text-align","left")}}e.prototype={exec:function(b){var d=b.getSelection(),e=b.config.enterMode;if(d){for(var l=d.createBookmarks(),f=d.getRanges(),h=this.cssClassName,k,g,n=b.config.useComputedState,n=void 0===n||n,u=f.length-1;0<=u;u--)for(k=f[u].createIterator(),k.enlargeBr=e!=CKEDITOR.ENTER_BR;g=k.getNextParagraph(e==CKEDITOR.ENTER_P?"p":"div");)if(!g.isReadOnly()){g.removeAttribute("align");g.removeStyle("text-align");var t=h&&(g.$.className=CKEDITOR.tools.ltrim(g.$.className.replace(this.cssClassRegex,
""))),r=this.state==CKEDITOR.TRISTATE_OFF&&(!n||a(g,!0)!=this.value);h?r?g.addClass(h):t||g.removeAttribute("class"):r&&g.setStyle("text-align",this.value)}b.focus();b.forceNextSelectionCheck();d.selectBookmarks(l)}},refresh:function(b,d){var e=d.block||d.blockLimit;this.setState("body"!=e.getName()&&a(e,this.editor.config.useComputedState)==this.value?CKEDITOR.TRISTATE_ON:CKEDITOR.TRISTATE_OFF)}};CKEDITOR.plugins.add("justify",{init:function(a){if(!a.blockless){var d=new e(a,"justifyleft","left"),
m=new e(a,"justifycenter","center"),l=new e(a,"justifyright","right"),f=new e(a,"justifyblock","justify");a.addCommand("justifyleft",d);a.addCommand("justifycenter",m);a.addCommand("justifyright",l);a.addCommand("justifyblock",f);a.ui.addButton&&(a.ui.addButton("JustifyLeft",{label:a.lang.justify.left,command:"justifyleft",toolbar:"align,10"}),a.ui.addButton("JustifyCenter",{label:a.lang.justify.center,command:"justifycenter",toolbar:"align,20"}),a.ui.addButton("JustifyRight",{label:a.lang.justify.right,
...
b)||b.getAttribute("name")&&(!b.getAttribute("href")||!b.getChildCount())))return"anchor"})}});var d=/^javascript:/,m=/^mailto:([^?]+)(?:\?(.+))?$/,l=/subject=([^;?:@&=$,\/]*)/i,f=/body=([^;?:@&=$,\/]*)/i,h=/^#(.*)$/,k=/^((?:http|https|ftp|news):\/\/)?(.*)$/,g=/^(_(?:self|top|parent|blank))$/,n=/^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/,u=/^javascript:([^(]+)\(([^)]+)\)$/,t=/\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/,
...
"anchor"==b.data("cke-real-element-type")){var c=a.restoreRealElement(b);if(c.data("cke-saved-name"))return c}},parseLinkAttributes:function(a,b){var c=b&&(b.data("cke-saved-href")||b.getAttribute("href"))||"",e=a.plugins.link.compiledProtectionFunction,v=a.config.emailProtection,y,C={};c.match(d)&&("encode"==v?c=c.replace(n,function(a,b,c){c=c||"";return"mailto:"+String.fromCharCode.apply(String,b.split(","))+c.replace(/\\'/g,"'")}):v&&c.replace(u,function(a,b,c){if(b==e.name){C.type="email";a=C.email=
{};b=/(^')|('$)/g;c=c.match(/[^,\s]+/g);for(var d=c.length,f,g,h=0;h<d;h++)f=decodeURIComponent,g=c[h].replace(b,"").replace(/\\'/g,"'"),g=f(g),f=e.params[h].toLowerCase(),a[f]=g;a.address=[a.name,a.domain].join("@")}}));if(!C.type)if(v=c.match(h))C.type="anchor",C.anchor={},C.anchor.name=C.anchor.id=v[1];else if(v=c.match(m)){y=c.match(l);c=c.match(f);C.type="email";var x=C.email={};x.address=v[1];y&&(x.subject=decodeURIComponent(y[1]));c&&(x.body=decodeURIComponent(c[1]))}else c&&(y=c.match(k))&&
...
(b(a,f,null,!d),a.remove(),a=f)}c();c(1)}function d(a){return a.type==CKEDITOR.NODE_ELEMENT&&(a.getName()in CKEDITOR.dtd.$block||a.getName()in CKEDITOR.dtd.$listItem)&&CKEDITOR.dtd[a.getName()]["#"]}function m(a,d,f){a.fire("saveSnapshot");f.enlarge(CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS);var e=f.extractContents();d.trim(!1,!0);var h=d.createBookmark(),k=new CKEDITOR.dom.elementPath(d.startContainer),m=k.block,k=k.lastElement.getAscendant("li",1)||m,t=new CKEDITOR.dom.elementPath(f.startContainer),u=
t.contains(CKEDITOR.dtd.$listItem),t=t.contains(CKEDITOR.dtd.$list);m?(m=m.getBogus())&&m.remove():t&&(m=t.getPrevious(g))&&n(m)&&m.remove();(m=e.getLast())&&m.type==CKEDITOR.NODE_ELEMENT&&m.is("br")&&m.remove();(m=d.startContainer.getChild(d.startOffset))?e.insertBefore(m):d.startContainer.append(e);u&&(e=l(u))&&(k.contains(u)?(b(e,u.getParent(),u),e.remove()):k.append(e));for(;f.checkStartOfBlock()&&f.checkEndOfBlock();){t=f.startPath();e=t.block;if(!e)break;e.is("li")&&(k=e.getParent(),e.equals(k.getLast(g))&&
...
n=null,t=c,u=Math.max(a[c].indent,0),D=null,G,F,I=d==CKEDITOR.ENTER_P?"p":"div";;){var H=a[t];h=H.grandparent;G=H.element.getDirection(1);if(H.indent==u){n&&a[t].parent.getName()==n.getName()||(n=a[t].parent.clone(!1,1),e&&n.setAttribute("dir",e),m.append(n));D=n.append(H.element.clone(0,1));G!=n.getDirection(1)&&D.setAttribute("dir",G);for(h=0;h<H.contents.length;h++)D.append(H.contents[h].clone(1,1));t++}else if(H.indent==Math.max(u,0)+1)H=a[t-1].element.getDirection(1),t=CKEDITOR.plugins.list.arrayToList(a,
null,t,d,H!=G?G:null),!D.getChildCount()&&CKEDITOR.env.needsNbspFiller&&7>=l.$.documentMode&&D.append(l.createText(" ")),D.append(t.listNode),t=t.nextIndex;else if(-1==H.indent&&!c&&h){f[h.getName()]?(D=H.element.clone(!1,!0),G!=h.getDirection(1)&&D.setAttribute("dir",G)):D=new CKEDITOR.dom.documentFragment(l);var n=h.getDirection(1)!=G,K=H.element,E=K.getAttribute("class"),N=K.getAttribute("style"),R=D.type==CKEDITOR.NODE_DOCUMENT_FRAGMENT&&(d!=CKEDITOR.ENTER_BR||n||N||E),P,T=H.contents.length,O;
for(h=0;h<T;h++)if(P=H.contents[h],k(P)&&1<T)R?O=P.clone(1,1):D.append(P.clone(1,1));else if(P.type==CKEDITOR.NODE_ELEMENT&&P.isBlockBoundary()){n&&!P.getDirection()&&P.setAttribute("dir",G);F=P;var Y=K.getAttribute("style");Y&&F.setAttribute("style",Y.replace(/([^;])$/,"$1;")+(F.getAttribute("style")||""));E&&P.addClass(E);F=null;O&&(D.append(O),O=null);D.append(P.clone(1,1))}else R?(F||(F=l.createElement(I),D.append(F),n&&F.setAttribute("dir",G)),N&&F.setAttribute("style",N),E&&F.setAttribute("class",
...
I=void 0===I||I;for(F=0;F<D.length;F++)for(H=D[F];K=H.getParent();){if(K.equals(l)){n.push(H);!A&&H.getDirection()&&(A=1);H=H.getDirection(I);null!==x&&(x=x&&x!=H?null:H);break}H=K}if(!(1>n.length)){D=n[n.length-1].getNext();F=h.createElement(this.type);t.push(F);for(I=t=void 0;n.length;)t=n.shift(),I=h.createElement("li"),H=t,H.is("pre")||u.test(H.getName())||"false"==H.getAttribute("contenteditable")?t.appendTo(I):(t.copyAttributes(I),x&&t.getDirection()&&(I.removeStyle("direction"),I.removeAttribute("dir")),
...
c in{8:1,46:1}){var h=a.getSelection().getRanges()[0],k=h&&h.startPath();if(h&&h.collapsed){var t=8==c,u=a.editable(),C=new CKEDITOR.dom.walker(h.clone());C.evaluator=function(a){return g(a)&&!n(a)};C.guard=function(a,b){return!(b&&a.type==CKEDITOR.NODE_ELEMENT&&a.is("table"))};c=h.clone();if(t){var x;(x=k.contains(f))&&h.checkBoundaryOfElement(x,CKEDITOR.START)&&(x=x.getParent())&&x.is("li")&&(x=l(x))?(e=x,x=x.getPrevious(g),c.moveToPosition(x&&n(x)?x:e,CKEDITOR.POSITION_BEFORE_START)):(C.range.setStartAt(u,
CKEDITOR.POSITION_AFTER_START),C.range.setEnd(h.startContainer,h.startOffset),(x=C.previous())&&x.type==CKEDITOR.NODE_ELEMENT&&(x.getName()in f||x.is("li"))&&(x.is("li")||(C.range.selectNodeContents(x),C.reset(),C.evaluator=d,x=C.previous()),e=x,c.moveToElementEditEnd(e),c.moveToPosition(c.endPath().block,CKEDITOR.POSITION_BEFORE_END)));if(e)m(a,c,h),b.cancel();else{var A=k.contains(f);A&&h.checkBoundaryOfElement(A,CKEDITOR.START)&&(e=A.getFirst(g),h.checkBoundaryOfElement(e,CKEDITOR.START)&&(x=A.getPrevious(g),
l(e)?x&&(h.moveToElementEditEnd(x),h.select()):a.execCommand("outdent"),b.cancel()))}}else if(e=k.contains("li")){if(C.range.setEndAt(u,CKEDITOR.POSITION_BEFORE_END),t=(u=e.getLast(g))&&d(u)?u:e,k=0,(x=C.next())&&x.type==CKEDITOR.NODE_ELEMENT&&x.getName()in f&&x.equals(u)?(k=1,x=C.next()):h.checkBoundaryOfElement(t,CKEDITOR.END)&&(k=2),k&&x){h=h.clone();h.moveToElementEditStart(x);if(1==k&&(c.optimize(),!c.startContainer.equals(e))){for(e=c.startContainer;e.is(CKEDITOR.dtd.$inline);)A=e,e=e.getParent();
A&&c.moveToPosition(A,CKEDITOR.POSITION_AFTER_END)}2==k&&(c.moveToPosition(c.endPath().block,CKEDITOR.POSITION_BEFORE_END),h.endPath().block&&h.moveToPosition(h.endPath().block,CKEDITOR.POSITION_AFTER_START));m(a,c,h);b.cancel()}}else C.range.setEndAt(u,CKEDITOR.POSITION_BEFORE_END),(x=C.next())&&x.type==CKEDITOR.NODE_ELEMENT&&x.is(f)&&(x=x.getFirst(g),k.block&&h.checkStartOfBlock()&&h.checkEndOfBlock()?(k.block.remove(),h.moveToElementEditStart(x),h.select()):l(x)?(h.moveToElementEditStart(x),h.select()):
...
a.getName();if("ol"==c)return{numberedlist:CKEDITOR.TRISTATE_OFF};if("ul"==c)return{bulletedlist:CKEDITOR.TRISTATE_OFF};a=a.getParent()}return null})}}};CKEDITOR.plugins.add("liststyle",CKEDITOR.plugins.liststyle)}(),"use strict",function(){function a(a,b,c){return n(b)&&n(c)&&c.equals(b.getNext(function(a){return!(ba(a)||X(a)||u(a))}))}function e(a){this.upper=a[0];this.lower=a[1];this.set.apply(this,a.slice(2))}function b(a){var b=a.element;if(b&&n(b)&&(b=b.getAscendant(a.triggers,!0))&&a.editable.contains(b)){var c=
l(b);if("true"==c.getAttribute("contenteditable"))return b;if(c.is(a.triggers))return c}return null}function c(a,b,c){v(a,b);v(a,c);a=b.size.bottom;c=c.size.top;return a&&c?0|(a+c)/2:a||c}function d(a,b,c){return b=b[c?"getPrevious":"getNext"](function(b){return b&&b.type==CKEDITOR.NODE_TEXT&&!ba(b)||n(b)&&!u(b)&&!g(a,b)})}function m(a,b,c){return a>b&&a<c}function l(a,b){if(a.data("cke-editable"))return null;for(b||(a=a.getParent());a&&!a.data("cke-editable");){if(a.hasAttribute("contenteditable"))return a;
...
a.view,c=a.editable,d=a.trigger,f=d.upper,e=d.lower,g=f||e,h=g.getParent(),k={};this.trigger=d;f&&v(a,f,!0);e&&v(a,e,!0);v(a,h,!0);a.inInlineMode&&y(a,!0);h.equals(c)?(k.left=b.scroll.x,k.right=-b.scroll.x,k.width=""):(k.left=g.size.left-g.size.margin.left+b.scroll.x-(a.inInlineMode?b.editable.left+b.editable.border.left:0),k.width=g.size.outerWidth+g.size.margin.left+g.size.margin.right+b.scroll.x,k.right="");f&&e?k.top=f.size.margin.bottom===e.size.margin.top?0|f.size.bottom+f.size.margin.bottom/
2:f.size.margin.bottom<e.size.margin.top?f.size.bottom+f.size.margin.bottom:f.size.bottom+f.size.margin.bottom-e.size.margin.top:f?e||(k.top=f.size.bottom+f.size.margin.bottom):k.top=e.size.top-e.size.margin.top;d.is(T)||m(k.top,b.scroll.y-15,b.scroll.y+5)?(k.top=a.inInlineMode?0:b.scroll.y,this.look(T)):d.is(O)||m(k.top,b.pane.bottom-5,b.pane.bottom+15)?(k.top=a.inInlineMode?b.editable.height+b.editable.padding.top+b.editable.padding.bottom:b.pane.bottom-1,this.look(O)):(a.inInlineMode&&(k.top-=
...
c.lineChildren[0].on("mouseup",function(b){c.detach();h(a,function(b){var c=a.line.trigger;b[c.is(E)?"insertBefore":"insertAfter"](c.is(E)?c.lower:c.upper)},!0);a.editor.focus();F.ie||a.enterMode==CKEDITOR.ENTER_BR||a.hotNode.scrollIntoView();b.data.preventDefault(!0)});c.on("mousedown",function(a){a.data.preventDefault(!0)});a.line=c}function h(a,b,c){var d=new CKEDITOR.dom.range(a.doc),f=a.editor,e;F.ie&&a.enterMode==CKEDITOR.ENTER_BR?e=a.doc.createText(M):(e=(e=l(a.element,!0))&&e.data("cke-enter-mode")||
a.enterMode,e=new D(K[e],a.doc),e.is("br")||a.doc.createText(M).appendTo(e));c&&f.fire("saveSnapshot");b(e);d.moveToPosition(e,CKEDITOR.POSITION_AFTER_START);f.getSelection().selectRanges([d]);a.hotNode=e;c&&f.fire("saveSnapshot")}function k(a,c){return{canUndo:!0,modes:{wysiwyg:1},exec:function(){function f(b){var d=F.ie&&9>F.version?" ":M,e=a.hotNode&&a.hotNode.getText()==d&&a.element.equals(a.hotNode)&&a.lastCmdDirection===!!c;h(a,function(d){e&&a.hotNode&&a.hotNode.remove();d[c?"insertAfter":
"insertBefore"](b);d.setAttributes({"data-cke-magicline-hot":1,"data-cke-magicline-dir":!!c});a.lastCmdDirection=!!c});F.ie||a.enterMode==CKEDITOR.ENTER_BR||a.hotNode.scrollIntoView();a.line.detach()}return function(e){e=e.getSelection().getStartElement();var g;e=e.getAscendant(L,1);if(!q(a,e)&&e&&!e.equals(a.editable)&&!e.contains(a.editable)){(g=l(e))&&"false"==g.getAttribute("contenteditable")&&(e=g);a.element=e;g=d(a,e,!c);var h;n(g)&&g.is(a.triggers)&&g.is(J)&&(!d(a,g,!c)||(h=d(a,g,!c))&&n(h)&&
...
2:Math.min(d.editable.height,d.pane.height)/2),b=b[h?"getLast":"getFirst"](function(a){return!(ba(a)||X(a))});if(!b)return null;g(a,b)&&(b=a.line.wrap[h?"getPrevious":"getNext"](function(a){return!(ba(a)||X(a))}));if(!n(b)||u(b)||!r(a,b))return null;v(a,b);return!h&&0<=b.size.top&&m(c.y,0,b.size.top+f)?(a=a.inInlineMode||0===d.scroll.y?T:Y,new e([null,b,E,P,a])):h&&b.size.bottom<=d.pane.height&&m(c.y,b.size.bottom-f,d.pane.height)?(a=a.inInlineMode||m(b.size.bottom,d.pane.height-f,d.pane.height)?
O:Y,new e([b,null,N,P,a])):null}function z(a){var c=a.mouse,f=a.view,g=a.triggerOffset,h=b(a);if(!h)return null;v(a,h);var g=Math.min(g,0|h.size.outerHeight/2),k=[],l,q;if(m(c.y,h.size.top-1,h.size.top+g))q=!1;else if(m(c.y,h.size.bottom-g,h.size.bottom+1))q=!0;else return null;if(u(h)||p(a,h,q)||h.getParent().is(W))return null;var t=d(a,h,!q);if(t){if(t&&t.type==CKEDITOR.NODE_TEXT)return null;if(n(t)){if(u(t)||!r(a,t)||t.getParent().is(W))return null;k=[t,h][q?"reverse":"concat"]().concat([R,P])}}else h.equals(a.editable[q?
"getLast":"getFirst"](a.isRelevant))?(y(a),q&&m(c.y,h.size.bottom-g,f.pane.height)&&m(h.size.bottom,f.pane.height-g,f.pane.height)?l=O:m(c.y,0,h.size.top+g)&&(l=T)):l=Y,k=[null,h][q?"reverse":"concat"]().concat([q?N:E,P,l,h.equals(a.editable[q?"getLast":"getFirst"](a.isRelevant))?q?O:T:Y]);return 0 in k?new e(k):null}function B(a,b,c,d){for(var f=b.getDocumentPosition(),e={},g={},h={},k={},l=ca.length;l--;)e[ca[l]]=parseInt(b.getComputedStyle.call(b,"border-"+ca[l]+"-width"),10)||0,h[ca[l]]=parseInt(b.getComputedStyle.call(b,
...
d.height},pane:{width:d.width,height:d.height,bottom:d.height+c.y},date:+new Date},!0)}}function x(a,b,c,d){for(var f=d,g=d,h=0,k=!1,l=!1,m=a.view.pane.height,n=a.mouse;n.y+h<m&&0<n.y-h;){k||(k=b(f,d));l||(l=b(g,d));!k&&0<n.y-h&&(f=c(a,{x:n.x,y:n.y-h}));!l&&n.y+h<m&&(g=c(a,{x:n.x,y:n.y+h}));if(k&&l)break;h+=2}return new e([f,g,null,null])}CKEDITOR.plugins.add("magicline",{init:function(a){var c=a.config,l=c.magicline_triggerOffset||30,m={editor:a,enterMode:c.enterMode,triggerOffset:l,holdDistance:0|
l*(c.magicline_holdDistance||.5),boxColor:c.magicline_color||"#ff0000",rtl:"rtl"==c.contentsLangDirection,tabuList:["data-cke-hidden-sel"].concat(c.magicline_tabuList||[]),triggers:c.magicline_everywhere?L:{table:1,hr:1,div:1,ul:1,ol:1,dl:1,form:1,blockquote:1}},r,p,v;m.isRelevant=function(a){return n(a)&&!g(m,a)&&!u(a)};a.on("contentDom",function(){var l=a.editable(),n=a.document,u=a.window;A(m,{editable:l,inInlineMode:l.isInline(),doc:n,win:u,hotNode:null},!0);m.boundary=m.inInlineMode?m.editable:
m.doc.getDocumentElement();l.is(H.$inline)||(m.inInlineMode&&!t(l)&&l.setStyles({position:"relative",top:null,left:null}),f.call(this,m),C(m),l.attachListener(a,"beforeUndoImage",function(){m.line.detach()}),l.attachListener(a,"beforeGetData",function(){m.line.wrap.getParent()&&(m.line.detach(),a.once("getData",function(){m.line.attach()},null,null,1E3))},null,null,0),l.attachListener(m.inInlineMode?n:n.getWindow().getFrame(),"mouseout",function(b){if("wysiwyg"==a.mode)if(m.inInlineMode){var c=b.data.$.clientX;
b=b.data.$.clientY;C(m);y(m,!0);var d=m.view.editable,f=m.view.scroll;c>d.left-f.x&&c<d.right-f.x&&b>d.top-f.y&&b<d.bottom-f.y||(clearTimeout(v),v=null,m.line.detach())}else clearTimeout(v),v=null,m.line.detach()}),l.attachListener(l,"keyup",function(){m.hiddenMode=0}),l.attachListener(l,"keydown",function(b){if("wysiwyg"==a.mode)switch(b.data.getKeystroke()){case 2228240:case 16:m.hiddenMode=1,m.line.detach()}}),l.attachListener(m.inInlineMode?l:n,"mousemove",function(b){p=!0;if("wysiwyg"==a.mode&&
!a.readOnly&&!v){var c={x:b.data.$.clientX,y:b.data.$.clientY};v=setTimeout(function(){m.mouse=c;v=m.trigger=null;C(m);p&&!m.hiddenMode&&a.focusManager.hasFocus&&!m.line.mouseNear()&&(m.element=da(m,!0))&&((m.trigger=w(m)||z(m)||ea(m))&&!q(m,m.trigger.upper||m.trigger.lower)?m.line.attach().place():(m.trigger=null,m.line.detach()),p=!1)},30)}}),l.attachListener(u,"scroll",function(){"wysiwyg"==a.mode&&(m.line.detach(),F.webkit&&(m.hiddenMode=1,clearTimeout(r),r=setTimeout(function(){m.mouseDown||
(m.hiddenMode=0)},50)))}),l.attachListener(I?n:u,"mousedown",function(){"wysiwyg"==a.mode&&(m.line.detach(),m.hiddenMode=1,m.mouseDown=1)}),l.attachListener(I?n:u,"mouseup",function(){m.hiddenMode=0;m.mouseDown=0}),a.addCommand("accessPreviousSpace",k(m)),a.addCommand("accessNextSpace",k(m,!0)),a.setKeystroke([[c.magicline_keystrokePrevious,"accessPreviousSpace"],[c.magicline_keystrokeNext,"accessNextSpace"]]),a.on("loadSnapshot",function(){var b,c,d,f;for(f in{p:1,br:1,div:1})for(b=a.document.getElementsByTag(f),
...
for(p=a.container;p=p.getParent();)p.setCustomData("maximize_saved_styles",b(p)),p.setStyle("z-index",a.config.baseFloatZIndex-5);q.setCustomData("maximize_saved_styles",b(q,!0));r.setCustomData("maximize_saved_styles",b(r,!0));q={overflow:CKEDITOR.env.webkit?"":"hidden",width:0,height:0};h.getDocumentElement().setStyles(q);!CKEDITOR.env.gecko&&h.getDocumentElement().setStyle("position","fixed");CKEDITOR.env.gecko&&CKEDITOR.env.quirks||h.getBody().setStyles(q);CKEDITOR.env.ie?setTimeout(function(){k.$.scrollTo(0,
0)},0):k.$.scrollTo(0,0);r.setStyle("position",CKEDITOR.env.gecko&&CKEDITOR.env.quirks?"fixed":"absolute");r.$.offsetLeft;r.setStyles({"z-index":a.config.baseFloatZIndex-5,left:"0px",top:"0px"});r.addClass("cke_maximized");e();q=r.getDocumentPosition();r.setStyles({left:-1*q.x+"px",top:-1*q.y+"px"});CKEDITOR.env.gecko&&d(a)}else if(this.state==CKEDITOR.TRISTATE_ON){k.removeListener("resize",e);for(var p=[q,r],z=0;z<p.length;z++)c(p[z],p[z].getCustomData("maximize_saved_styles")),p[z].removeCustomData("maximize_saved_styles");
for(p=a.container;p=p.getParent();)c(p,p.getCustomData("maximize_saved_styles")),p.removeCustomData("maximize_saved_styles");CKEDITOR.env.ie?setTimeout(function(){k.$.scrollTo(u.x,u.y)},0):k.$.scrollTo(u.x,u.y);r.removeClass("cke_maximized");CKEDITOR.env.webkit&&(r.setStyle("display","inline"),setTimeout(function(){r.setStyle("display","block")},0));a.fire("resize",{outerHeight:a.container.$.offsetHeight,contentsHeight:q.$.offsetHeight,outerWidth:a.container.$.offsetWidth})}this.toggleState();if(p=
this.uiItems[0])q=this.state==CKEDITOR.TRISTATE_OFF?f.maximize.maximize:f.maximize.minimize,p=CKEDITOR.document.getById(p._.id),p.getChild(1).setHtml(q),p.setAttribute("title",q),p.setAttribute("href",'javascript:void("'+q+'");');"wysiwyg"==a.mode?g?(CKEDITOR.env.gecko&&d(a),a.getSelection().selectRanges(g),(w=a.getSelection().getStartElement())&&w.scrollIntoView(!0)):k.$.scrollTo(n.x,n.y):(g&&(w.selectionStart=g[0],w.selectionEnd=g[1]),w.scrollLeft=n[0],w.scrollTop=n[1]);g=n=null;t=this.state;a.fire("maximize",
...
l=b.document&&b.document.getBody();l&&(l.getAttribute("id")&&(d+='id\x3d"'+l.getAttribute("id")+'" '),l.getAttribute("class")&&(d+='class\x3d"'+l.getAttribute("class")+'" '));d+="\x3e";c=b.config.docType+'\x3chtml dir\x3d"'+b.config.contentsLangDirection+'"\x3e\x3chead\x3e'+e+"\x3ctitle\x3e"+b.lang.preview.preview+"\x3c/title\x3e"+CKEDITOR.tools.buildStyleHtml(b.config.contentsCss)+"\x3c/head\x3e"+d+b.getData()+"\x3c/body\x3e\x3c/html\x3e"}e=640;d=420;l=80;try{var f=window.screen,e=Math.round(.8*
f.width),d=Math.round(.7*f.height),l=Math.round(.1*f.width)}catch(h){}if(!1===b.fire("contentPreview",b={dataValue:c}))return!1;var f="",k;CKEDITOR.env.ie&&(window._cke_htmlToLoad=b.dataValue,k="javascript:void( (function(){document.open();"+("("+CKEDITOR.tools.fixDomain+")();").replace(/\/\/.*?\n/g,"").replace(/parent\./g,"window.opener.")+"document.write( window.opener._cke_htmlToLoad );document.close();window.opener._cke_htmlToLoad \x3d null;})() )",f="");CKEDITOR.env.gecko&&(window._cke_htmlToLoad=
b.dataValue,f=CKEDITOR.getUrl(a+"preview.html"));f=window.open(f,null,"toolbar\x3dyes,location\x3dno,status\x3dyes,menubar\x3dyes,scrollbars\x3dyes,resizable\x3dyes,width\x3d"+e+",height\x3d"+d+",left\x3d"+l);CKEDITOR.env.ie&&f&&(f.location=k);CKEDITOR.env.ie||CKEDITOR.env.gecko||(k=f.document,k.open(),k.write(b.dataValue),k.close());return!0}};CKEDITOR.plugins.add("preview",{init:function(b){b.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE&&(a=this.path,b.addCommand("preview",e),b.ui.addButton&&b.ui.addButton("Preview",
...
!k.equals(g);)if(k.isReadOnly()){if(k.getPosition(g)&CKEDITOR.POSITION_CONTAINS)break;k=k.getNext(l)}else n=k.getNextSourceNode(!1,CKEDITOR.NODE_ELEMENT),"img"==k.getName()&&k.data("cke-realelement")||!c(a,k)||(e.test(k.getName())?k.remove(1):(k.removeAttributes(b),a.fire("removeFormatCleanup",k))),k=n;f.moveToBookmark(h)}a.forceNextSelectionCheck();a.getSelection().selectRanges(d)}}},filter:function(a,e){for(var b=a._.removeFormatFilters||[],c=0;c<b.length;c++)if(!1===b[c](e))return!1;return!0}},
CKEDITOR.editor.prototype.addRemoveFormatFilter=function(a){this._.removeFormatFilters||(this._.removeFormatFilters=[]);this._.removeFormatFilters.push(a)},CKEDITOR.config.removeFormatTags="b,big,cite,code,del,dfn,em,font,i,ins,kbd,q,s,samp,small,span,strike,strong,sub,sup,tt,u,var",CKEDITOR.config.removeFormatAttributes="class,style,lang,width,height,align,hspace,valign",CKEDITOR.plugins.add("resize",{init:function(a){function e(b){var d=h.width,e=h.height,l=d+(b.data.$.screenX-f.x)*("rtl"==m?-1:
1);b=e+(b.data.$.screenY-f.y);k&&(d=Math.max(c.resize_minWidth,Math.min(l,c.resize_maxWidth)));g&&(e=Math.max(c.resize_minHeight,Math.min(b,c.resize_maxHeight)));a.resize(k?d:null,e)}function b(){CKEDITOR.document.removeListener("mousemove",e);CKEDITOR.document.removeListener("mouseup",b);a.document&&(a.document.removeListener("mousemove",e),a.document.removeListener("mouseup",b))}var c=a.config,d=a.ui.spaceId("resizer"),m=a.element?a.element.getDirection(1):"ltr";!c.resize_dir&&(c.resize_dir="vertical");
void 0===c.resize_maxWidth&&(c.resize_maxWidth=3E3);void 0===c.resize_maxHeight&&(c.resize_maxHeight=3E3);void 0===c.resize_minWidth&&(c.resize_minWidth=750);void 0===c.resize_minHeight&&(c.resize_minHeight=250);if(!1!==c.resize_enabled){var l=null,f,h,k=("both"==c.resize_dir||"horizontal"==c.resize_dir)&&c.resize_minWidth!=c.resize_maxWidth,g=("both"==c.resize_dir||"vertical"==c.resize_dir)&&c.resize_minHeight!=c.resize_maxHeight,n=CKEDITOR.tools.addFunction(function(d){l||(l=a.getResizable());h=
...
tr:1,tt:1,ug:1,uk:1,vi:1,zh:1,"zh-cn":1},requires:"dialog",init:function(a){var e=this;CKEDITOR.dialog.add("specialchar",this.path+"dialogs/specialchar.js");a.addCommand("specialchar",{exec:function(){var b=a.langCode,b=e.availableLangs[b]?b:e.availableLangs[b.replace(/-.*/,"")]?b.replace(/-.*/,""):"en";CKEDITOR.scriptLoader.load(CKEDITOR.getUrl(e.path+"dialogs/lang/"+b+".js"),function(){CKEDITOR.tools.extend(a.lang.specialchar,e.langEntries[b]);a.openDialog("specialchar")})},modes:{wysiwyg:1},canUndo:!1});
...
e.type==CKEDITOR.NODE_ELEMENT&&e.is("table"))return!1;var g;b=f[0];e=b.getAscendant("table");var k=CKEDITOR.tools.buildTableMap(e),l=k.length,m=k[0].length,n=b.getParent().$.rowIndex,u=h(k,n,b);if(c){var A;try{var D=parseInt(b.getAttribute("rowspan"),10)||1;g=parseInt(b.getAttribute("colspan"),10)||1;A=k["up"==c?n-D:"down"==c?n+D:n]["left"==c?u-g:"right"==c?u+g:u]}catch(G){return!1}if(!A||b.$==A)return!1;f["up"==c||"left"==c?"unshift":"push"](new CKEDITOR.dom.element(A))}c=b.getDocument();var F=n,
D=A=0,I=!d&&new CKEDITOR.dom.documentFragment(c),H=0;for(c=0;c<f.length;c++){g=f[c];var K=g.getParent(),E=g.getFirst(),N=g.$.colSpan,R=g.$.rowSpan,K=K.$.rowIndex,P=h(k,K,g),H=H+N*R,D=Math.max(D,P-u+N);A=Math.max(A,K-n+R);d||(N=g,(R=N.getBogus())&&R.remove(),N.trim(),g.getChildren().count()&&(K==F||!E||E.isBlockBoundary&&E.isBlockBoundary({br:1})||(F=I.getLast(CKEDITOR.dom.walker.whitespaces(!0)),!F||F.is&&F.is("br")||I.append("br")),g.moveChildren(I)),c?g.remove():g.setHtml(""));F=K}if(d)return A*
...
readOnly:1,exec:function(a){a.toolbox&&(a.toolbox.focusCommandExecuted=!0,CKEDITOR.env.ie||CKEDITOR.env.air?setTimeout(function(){a.toolbox.focus()},100):a.toolbox.focus())}};CKEDITOR.plugins.add("toolbar",{requires:"button",init:function(d){var e,l=function(a,b){var c,g="rtl"==d.lang.dir,n=d.config.toolbarGroupCycling,u=g?37:39,g=g?39:37,n=void 0===n||n;switch(b){case 9:case CKEDITOR.SHIFT+9:for(;!c||!c.items.length;)if(c=9==b?(c?c.next:a.toolbar.next)||d.toolbox.toolbars[0]:(c?c.previous:a.toolbar.previous)||
d.toolbox.toolbars[d.toolbox.toolbars.length-1],c.items.length)for(a=c.items[e?c.items.length-1:0];a&&!a.focus;)(a=e?a.previous:a.next)||(c=0);a&&a.focus();return!1;case u:c=a;do c=c.next,!c&&n&&(c=a.toolbar.items[0]);while(c&&!c.focus);c?c.focus():l(a,9);return!1;case 40:return a.button&&a.button.hasArrow?(d.once("panelShow",function(a){a.data._.panel._.currentBlock.onKeyDown(40)}),a.execute()):l(a,40==b?u:g),!1;case g:case 38:c=a;do c=c.previous,!c&&n&&(c=a.toolbar.items[a.toolbar.items.length-
1]);while(c&&!c.focus);c?c.focus():(e=1,l(a,CKEDITOR.SHIFT+9),e=0);return!1;case 27:return d.focus(),!1;case 13:case 32:return a.execute(),!1}return!0};d.on("uiSpace",function(c){if(c.data.space==d.config.toolbarLocation){c.removeListener();d.toolbox=new b;var e=CKEDITOR.tools.getNextId(),k=['\x3cspan id\x3d"',e,'" class\x3d"cke_voice_label"\x3e',d.lang.toolbar.toolbars,"\x3c/span\x3e",'\x3cspan id\x3d"'+d.ui.spaceId("toolbox")+'" class\x3d"cke_toolbox" role\x3d"group" aria-labelledby\x3d"',e,'" onmousedown\x3d"return false;"\x3e'],
e=!1!==d.config.toolbarStartupExpanded,g,m;d.config.toolbarCanCollapse&&d.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE&&k.push('\x3cspan class\x3d"cke_toolbox_main"'+(e?"\x3e":' style\x3d"display:none"\x3e'));for(var u=d.toolbox.toolbars,t=a(d),r=0;r<t.length;r++){var q,p=0,w,z=t[r],B;if(z)if(g&&(k.push("\x3c/span\x3e"),m=g=0),"/"===z)k.push('\x3cspan class\x3d"cke_toolbar_break"\x3e\x3c/span\x3e');else{B=z.items||z;for(var v=0;v<B.length;v++){var y=B[v],C;if(y){var x=function(a){a=a.render(d,k);A=p.items.push(a)-
1;0<A&&(a.previous=p.items[A-1],a.previous.next=a);a.toolbar=p;a.onkey=l;a.onfocus=function(){d.toolbox.focusCommandExecuted||d.focus()}};if(y.type==CKEDITOR.UI_SEPARATOR)m=g&&y;else{C=!1!==y.canGroup;if(!p){q=CKEDITOR.tools.getNextId();p={id:q,items:[]};w=z.name&&(d.lang.toolbar.toolbarGroups[z.name]||z.name);k.push('\x3cspan id\x3d"',q,'" class\x3d"cke_toolbar"',w?' aria-labelledby\x3d"'+q+'_label"':"",' role\x3d"toolbar"\x3e');w&&k.push('\x3cspan id\x3d"',q,'_label" class\x3d"cke_voice_label"\x3e',
w,"\x3c/span\x3e");k.push('\x3cspan class\x3d"cke_toolbar_start"\x3e\x3c/span\x3e');var A=u.push(p)-1;0<A&&(p.previous=u[A-1],p.previous.next=p)}C?g||(k.push('\x3cspan class\x3d"cke_toolgroup" role\x3d"presentation"\x3e'),g=1):g&&(k.push("\x3c/span\x3e"),g=0);m&&(x(m),m=0);x(y)}}}g&&(k.push("\x3c/span\x3e"),m=g=0);p&&k.push('\x3cspan class\x3d"cke_toolbar_end"\x3e\x3c/span\x3e\x3c/span\x3e')}}d.config.toolbarCanCollapse&&k.push("\x3c/span\x3e");if(d.config.toolbarCanCollapse&&d.elementMode!=CKEDITOR.ELEMENT_MODE_INLINE){var D=
...
[CKEDITOR.CTRL+90,CKEDITOR.CTRL+89,CKEDITOR.CTRL+CKEDITOR.SHIFT+90],e={8:1,46:1};CKEDITOR.plugins.add("undo",{init:function(c){function d(a){g.enabled&&!1!==a.data.command.canUndo&&g.save()}function e(){g.enabled=c.readOnly?!1:"wysiwyg"==c.mode;g.onChange()}var g=c.undoManager=new b(c),l=g.editingHandler=new m(g),u=c.addCommand("undo",{exec:function(){g.undo()&&(c.selectionChange(),this.fire("afterUndo"))},startDisabled:!0,canUndo:!1}),t=c.addCommand("redo",{exec:function(){g.redo()&&(c.selectionChange(),
this.fire("afterRedo"))},startDisabled:!0,canUndo:!1});c.setKeystroke([[a[0],"undo"],[a[1],"redo"],[a[2],"redo"]]);g.onChange=function(){u.setState(g.undoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED);t.setState(g.redoable()?CKEDITOR.TRISTATE_OFF:CKEDITOR.TRISTATE_DISABLED)};c.on("beforeCommandExec",d);c.on("afterCommandExec",d);c.on("saveSnapshot",function(a){g.save(a.data&&a.data.contentOnly)});c.on("contentDom",l.attachListeners,l);c.on("instanceReady",function(){c.fire("saveSnapshot")});
...
k=a;return""}).replace(/<\?xml\s[^\?]*\?>/i,function(a){e.xmlDeclaration=a;return""}));a=e.dataProcessor.toHtml(a);h?(/<body[\s|>]/.test(a)||(a="\x3cbody\x3e"+a),/<html[\s|>]/.test(a)||(a="\x3chtml\x3e"+a+"\x3c/html\x3e"),/<head[\s|>]/.test(a)?/<title[\s|>]/.test(a)||(a=a.replace(/<head[^>]*>/,"$\x26\x3ctitle\x3e\x3c/title\x3e")):a=a.replace(/<html[^>]*>/,"$\x26\x3chead\x3e\x3ctitle\x3e\x3c/title\x3e\x3c/head\x3e"),n&&(a=a.replace(/<head[^>]*?>/,"$\x26"+n)),a=a.replace(/<\/head\s*>/,g+"$\x26"),a=
k+a):a=f.docType+'\x3chtml dir\x3d"'+f.contentsLangDirection+'" lang\x3d"'+(f.contentsLanguage||e.langCode)+'"\x3e\x3chead\x3e\x3ctitle\x3e'+this._.docTitle+"\x3c/title\x3e"+n+g+"\x3c/head\x3e\x3cbody"+(f.bodyId?' id\x3d"'+f.bodyId+'"':"")+(f.bodyClass?' class\x3d"'+f.bodyClass+'"':"")+"\x3e"+a+"\x3c/body\x3e\x3c/html\x3e";CKEDITOR.env.gecko&&(a=a.replace(/<body/,'\x3cbody contenteditable\x3d"true" '),2E4>CKEDITOR.env.version&&(a=a.replace(/<body[^>]*>/,"$\x26\x3c!-- cke-content-start --\x3e")));
