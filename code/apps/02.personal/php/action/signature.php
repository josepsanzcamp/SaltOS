...
require_once "php/getmail.php";
if ($type == "text/html") {
    echo __HTML_PAGE_OPEN__ . __HTML_TEXT_OPEN__;
}
if ($type == "text/plain") {
    echo __HTML_PAGE_OPEN__ . __PLAIN_TEXT_OPEN__;
}
echo $file["data"];
if ($type == "text/html") {
    echo __HTML_TEXT_CLOSE__ . __HTML_PAGE_CLOSE__;
}
if ($type == "text/plain") {
    echo __PLAIN_TEXT_CLOSE__ . __HTML_PAGE_CLOSE__;
}
$buffer = ob_get_clean();
// SEND OUTPUT
output_handler(array(
