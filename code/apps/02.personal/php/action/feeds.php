    ...
    if ($ids) {
        ...
        if ($numresult == $numids) {
            ...
            if ($action2[0] == "leidos") {
                ...
                // MOSTRAR RESULTADO
                session_alert(
                    LANG($action2[1] ? "msgnumnoleidos" : "msgnumsileidos", "feeds") . $numids . LANG("message" . min($numids, 2), "feeds")
                );
                ...
                // MOSTRAR RESULTADO
                session_alert(
                    LANG($action2[1] ? "msgnumsiwait" : "msgnumnowait", "feeds") . $numids . LANG("message" . min($numids, 2), "feeds")
                );
                ...
                // MOSTRAR RESULTADO
                session_alert(
                    LANG($action2[1] ? "msgnumsicool" : "msgnumnocool", "feeds") . $numids . LANG("message" . min($numids, 2), "feeds")
                );
