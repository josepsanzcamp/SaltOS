...
function capture_next_error()
{
    ...
    if (!isset($_ERROR_HANDLER["level"])) {
        show_php_error(array("phperror" => "error_handler without levels availables"));
    }
...
function show_php_error($array = null)
{
    ...
    if (isset($array["die"]) && !eval_bool($array["die"])) {
        return;
    }
    while (ob_get_level()) {
