...
class database_mysql
{
    ...
    public function __construct($args)
    {
        if (!function_exists("mysql_connect")) {
            show_php_error(array(
                "phperror" => "mysql_connect not found",
        ...
        if ($this->link === false) {
            show_php_error(array("dberror" => mysql_error()));
        }
        if (!mysql_select_db($args["name"], $this->link)) {
            show_php_error(array("dberror" => mysql_error($this->link)));
        }
        if ($this->link) {
    ...
    public function db_query($query, $fetch = "query")
    {
        ...
        if ($stmt === false) {
            show_php_error(array("dberror" => mysql_error($this->link),"query" => $query));
        }
