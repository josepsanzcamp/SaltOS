...
if (!eval_bool(getDefault("enableindexing"))) {
    die();
}
...
// INDEXING FILES
$query = "SELECT id,id_aplicacion,id_registro,fichero_file,fichero_hash,retries
    FROM tbl_ficheros
    WHERE indexed=0
        AND retries<3 LIMIT 1000";
...
// SEND RESPONSE
if ($total) {
    javascript_alert($total . LANG("msgfilesindexed" . min($total, 2)));
}
