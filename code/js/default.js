...
if (typeof __default__ == "undefined" && typeof parent.__default__ == "undefined") {
    ...
    function make_tabs2(obj)
    {
        ...
        if (!border) {
            border = $(".tabs2 li",obj).css("border-top-width") + " " + $(".tabs2 li",obj).css("border-top-style") + " " + $(".tabs2 li",obj).css("border-top-color");
        }
    ...
    function make_extras(obj)
    {
        ...
        $(master,obj).on("click",function () {
            ...
            if (value) {
                $(".tbody",table).removeClass("ui-state-highlight");
            }
        });
        // PROGRAM CHECK ENTER
    ...
    function make_ckeditors(obj)
    {
        ...
        $("div.excel",obj).each(function () {
            ...
            if (data != "") {
                ...
                data = JSON.parse($(this).attr("rows"));
            }
            ...
            if (minSpareRows != "") {
                minSpareRows = eval(minSpareRows);
            } else {
                minSpareRows = 0;
            }
            ...
            if (rowHeaderWidth != "") {
                rowHeaderWidth = eval(rowHeaderWidth);
            } else {
                rowHeaderWidth = undefined;
            }
            var colWidths = $(this).attr("colWidths");
            if (colWidths != "") {
                colWidths = eval(colWidths);
            } else {
                colWidths = undefined;
            }
            var input = $(this).prev();
            ...
            if ($(".thead",this).length > 0) {
                ...
                $(trs).each(function () {
                    ...
                    if (tdshead == null && numhead > 0) {
                        ...
                        $(tds).each(function () {
                            if (count == 1) {
                                $(this).addClass(rtl[dir]["ui-corner-tl"]);
                            }
                            if (count == total) {
                                $(this).addClass(rtl[dir]["ui-corner-tr"]);
                            }
                            count++;
                        });
                        tdshead = null;
                        ...
                        $(tds).each(function () {
                            if (count == 1) {
                                $(this).addClass(rtl[dir]["ui-corner-bl"]);
                            }
                            if (count == total) {
                                $(this).addClass(rtl[dir]["ui-corner-br"]);
                            }
                            count++;
                        });
                        tdsbody = null;
                    ...
                    if (numbody > 0 && numcell == 0) {
                        ...
                        $(this).on("mouseover",function () {
                            ...
                            var value = $(slave,this).prop("checked");
                            if (!value) {
                                $(".tbody",this).removeClass("ui-state-highlight");
                            }
    ...
    function make_contextmenu()
    {
        ...
        $(document).on("keydown",function (event) {
            ...
            // FOR CANCEL IN THEAD
            if ($(event.target).is("td.ui-widget-header")) {
                return false;
            }
